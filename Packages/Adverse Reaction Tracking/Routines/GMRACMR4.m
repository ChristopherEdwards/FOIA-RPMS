GMRACMR4 ;HIRMFO/WAA-PATIENT NOT ASKED ABOUT ALLERGIES ; 10/1/92 [ 05/02/2002  1:57 PM ]
...
PRINT ;PRINT THE DATE
 ...
 ...I GMRA("M") Q
 ...S GMRACNT=GMRACNT+1
 ...;IHS/ITSC/ENM 05/02/02 HRN CALL
 ...W ! I GMRAFLG'=GMRADFN W $E($P(^DPT(GMRADFN,0),U),1,30) S (DFN,GMRAFLG)=GMRADFN S GMRAPID="",APSPHRN=$$HRCN^APSGFUNC D VAD^GMRAUTL1(GMRADFN,"","","","","","","",.GMRAPID) W ?30,APSPHRN K GMRAPID
...
HEAD ;HEADER PAGE FOR PRINTOUT
 ...
 Q
EXIT ;
 K ^TMP($J,"GMRAWC"),APSPHRN ;IHS/ITSC/ENM 05/02/02
 D KILL^XUSCLEAN
 Q
