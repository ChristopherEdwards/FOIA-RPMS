GMRADSP1 ;HIRMFO/WAA-DISPLAY ALLERGY ;04-Nov-2010 10:02;DU
 ;;4.0;Adverse Reaction Tracking;**1002**;Mar 29, 1996;Build 32
 ;IHS/MSC/MGH Data added for source and inactivation data
DISBLD(IEN,ARRAY) ; This subroutine will bulid the array that will
 ...
 I $L(GMRANAME)>35 S ARRAY(CNT)=$E(GMRANAME,1,35),CNT=CNT+1,ARRAY(CNT)=$E(GMRANAME,35,999)
...
SIGN ;Get all the patient Sign/Symptoms
 ...
 .N GMRAFST,GMRALST,GMRAOTH,GMRAREAC,GMRAREAN,GMRATONS,GMRASCR,GMRAIN
