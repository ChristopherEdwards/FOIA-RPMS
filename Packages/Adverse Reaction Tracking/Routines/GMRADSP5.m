GMRADSP5 ;HIRMFO/YMP,RM,WAA-LISTING OF ALLERGIES TO SIGNED OFF ALLERGIES ; 8/16/92 [ 05/02/2002  3:08 PM ]
...
EN2A S GMRATEMP=$G(^GMR(120.8,GMRAREC,0)) Q:GMRATEMP=""
 ...
 S DFN=$P(GMRATEMP,U) D PID^VADPT6 S APSPHRN=$$HRCN^APSGFUNC,GMRASSN=APSPHRN D KVA^VADPT
...
EXIT ;Quit and kill
 D CLOSE^GMRAUTL
 K ^TMP($J,"GMRADSP"),X,Y,Z,APSPHRN ;IHS/ITSC/ENM 05/02/02
 D KILL^XUSCLEAN
 Q
