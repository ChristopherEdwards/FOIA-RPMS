GMRAEF ;HIRMFO/WAA-PRINT FDA EXCEPTION REPORT ;11/29/95  14:40 [ 05/02/2002  10:45 AM ]
...
PRINT ;Central Print
 ...
 ;IHS/ITSC/ENM 04/30/02 HRN CALL ADDED, HRCN VAR SET IN VADPT6
 D HDR1 S GMRDFN=0 F  S GMRDFN=$O(^TMP($J,"GMRAEF",GMRDFN)) Q:GMRDFN<1!(GMRAOUT)  S GMRABGDT=0 S DFN=GMRDFN D PID^VADPT6 W !,?5,"Patient: ",$P(^DPT(GMRDFN,0),U)," (HRN: ",HRCN,")" K VA D PRT
