GMRAPST7 ;HIRMFO/WAA- ADVERSE DRUG REACTION REPORT ;3/5/97  15:17 [ 04/29/2002  8:29 AM ]
...
PRINT ;Queue point for report
 ...
 ..S DFN=$P(GMRAPA(0),U),APSPHRN=$$HRCN^APSGFUNC,GMRACA=$E(GMRACA,1,22)_"-"_APSPHRN ;IHS/ITSC/ENM 04/29/02 HRN ADDED
