USRLM ; SLC/JER - User Class Membership functions and proc's ;05-Dec-2012 10:26;DU
 ;;1.0;AUTHORIZATION/SUBSCRIPTION;**2,3,6,7,8,13,16,25,28,1004**;Jun 20, 1997;Build 15
 ...
 ;                by subscriber name.
 ; IHS/MSC/MGH Patch 1004 IHS mod added back in
...
WHOISTMP(CLASS) ; Given a Class, return list of CURRENT members into ^TMP
 ...
 ;  -- used by whois2 call
 N USER,USRNM,USRCLNM,USRCNT,USRDA,EFFCTV,EXPIRES,USRI,TITLE,SRMC,USRTIT,USRX
 S USER=0,USRCNT=+$P($G(@MEMBER@(0)),U,3)
 F  S USER=$O(^USR(8930.3,"ACU",CLASS,USER)) Q:+USER'>0  D
...
WHATIS(USER,CLASS) ; Given a User, return list of class memberships
 ...
 N IND,GROUP,CLASSNM,CLASSCNT,USRCUR,USRDA,EFFCTV,EXPIRES,EFFCTV1,TITLE
 K ^TMP("USRWHATIS",$J)
 ...
 .. S TITLE=$$GET1^DIQ(8930.3,+USRDA,9999999.01)  ;IHS/MSC/MGH Patch 1004 IHS mod added in
 .. I EFFCTV'>DT,EXPIRES'<DT S USRCUR="C"
 .. I EFFCTV>DT S USRCUR="F"
 .. S CLASSNM=$$CLNAME(+GROUP)
 .. S ^TMP("USRWHATIS",$J,CLASSNM,USRCUR,$S(EFFCTV="":EFFCTV1,1:EFFCTV),EXPIRES)=GROUP_U_USRDA_U_CLASSNM_U_EFFCTV_U_$S(EXPIRES=9999999:"",1:EXPIRES)_U_TITLE
