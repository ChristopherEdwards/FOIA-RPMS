LA7VMSG1 ;VA/DALOI/JMC - LAB ORU (Observation Result) message builder cont'd;JUL 06, 2010 3:14 PM
 ;;5.2;AUTOMATED LAB INSTRUMENTS;**56,46,61,64,1027**;NOV 01, 1997
 ;
...
SORTPAT ; Sort all results for tranmsission
 ...
 ; BEGIN -- IHS/OIT/MKK -- LR*5.2*1027 -- Adding changed line from Patch 1016 back in
 F  S LA7ROOT=$Q(@LA7ROOT) Q:LA7END!(LA7ROOT="")  D   ; IHS/ITSC/TPF 04/21/03 *1016*
...
PROCESS ; Process and build messages to be sent
 ...
 ; BEGIN -- IHS/OIT/MKK -- LR*5.2*1027 -- Adding changed line from Patch 1016 back in
 F  S LA7ROOT=$Q(@LA7ROOT) Q:LA7END!($G(LA7ROOT)="")  D    ; IHS/ITSC/TPF 04/21/03 *1016*
 . ; END -- IHS/OIT/MKK -- LR*5.2*1027
