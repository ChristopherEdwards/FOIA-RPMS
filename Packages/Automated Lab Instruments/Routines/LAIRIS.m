LAIRIS ;SLC/RWF- IRIS ;7/20/90  09:22 ;
 ;;5.2;LA;;NOV 01, 1997
...
LA2 K TV,TY S TOUT=0,RMK="",TY(0)="" D IN G QUIT:TOUT,LA2:IN'["URINALYSIS REPORT" F A=1:1:2 S TOUT=0 D IN G QUIT:TOUT
 S V=$P(IN,"RUN",2) D NUM S TRAY=1,(ID,CUP)=+V,TOUT=0 D IN G QUIT:TOUT S V=$P(IN,":",2) D NUM S IDE=+V
 F A=1:1:33 S TOUT=0 D IN G QUIT:TOUT Q:$E(IN,1,2)="V-"  I IN[":" S TEST=$P(IN,":"),V=$P(IN,":",2) F I=0:0 S I=$O(TC(I)) Q:I<1  X:'$D(TY(I)) TC(I,2) I TEST=TC(I,4) S V=$P(V,"/"),V=$P(V," mg"),V=$P(V," g") D NUM S @TC(I,1)=V Q
