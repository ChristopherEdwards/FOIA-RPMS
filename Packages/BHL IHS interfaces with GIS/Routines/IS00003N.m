IS00003N ;Compiled from script 'Generated: X1 IHS 835 IN-I' on DEC 03, 2002
 ;Part 15
 ;Copyright 2002 SAIC
EN S @INV@("CAS3",INI(1))=$G(X) I '$D(X) D ERROR^INHS("Variable 'CAS3' failed input transform in iteration #"_INI(1)_". Processing continues.",0),ERROR^INHS("  Value = '"_INX_"'",0)
 Q
k2 K DXS
