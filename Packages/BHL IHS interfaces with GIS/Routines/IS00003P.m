IS00003P ;Compiled from script 'Generated: X1 IHS 835 IN-I' on DEC 03, 2002
 ;Part 17
 ;Copyright 2002 SAIC
EN I '$D(X) D ERROR^INHS("Variable 'NM11' failed input transform. Processing continues.",0),ERROR^INHS("  Value = '"_INX_"'",0)
 K DXS
 S (INX,X)=$G(@INV@("NM12"))
