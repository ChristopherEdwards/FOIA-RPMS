IS00011D ;Compiled from script 'Generated: HL IHS IZV04 OUT-O' on FEB 05, 2014
 ;Part 5
 ;Copyright 2014 SAIC
EN S @INV@("IN112")=X K DXS,D0
 ...
 SET INSETID=0
 ;SET IN21 = INSGX\^INTHL7F(17065,5)\\250\"OUTPUT TRANSFORM"
 S D0=INDA S X="OUTPUT TRANSFORM"
 S X1="^INTHL7F(17065,5)" X:$L($G(@X1)) $G(@X1) S X=$E(X,1,250)
