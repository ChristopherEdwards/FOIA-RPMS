IS00011E ;Compiled from script 'Generated: HL IHS IZV04 OUT-O' on FEB 05, 2014
 ;Part 6
 ;Copyright 2014 SAIC
EN S L1=$G(@INV@("IN113")) S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,14,L1,.CP) S L1=$G(@INV@("IN143")) S:$TR(L1,$G(SUBDELIM))="" L1=""
