IS00011E ;Compiled from script 'Generated: HL IHS IZV04 OUT-O' on DEC 05, 2014
 ;Part 6
 ;Copyright 2014 SAIC
EN S INDA0=INDA,INI(1)=0  F  S INI(1)=$O(INDA(9000010.11,INI(1))) Q:'INI(1)  S INDA=$S(INDA(9000010.11,INI(1)):INDA(9000010.11,INI(1)),1:INI(1)) D
 .Q:'$D(^AUPNVIMM(INDA,0))
