IS00011F ;Compiled from script 'Generated: HL IHS IZV04 OUT-O' on FEB 05, 2014
 ;Part 7
 ;Copyright 2014 SAIC
EN S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,17,L1,.CP) S L1=$G(@INV@("RXA17")) S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,18,L1,.CP)
