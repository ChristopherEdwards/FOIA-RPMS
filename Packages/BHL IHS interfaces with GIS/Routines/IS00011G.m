IS00011G ;Compiled from script 'Generated: HL IHS IZV04 OUT-O' on FEB 05, 2014
 ;Part 8
 ;Copyright 2014 SAIC
EN S L1=$G(@INV@("OBX5")) S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,6,L1,.CP) S L1=$G(@INV@("OBX11")) S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,12,L1,.CP)
