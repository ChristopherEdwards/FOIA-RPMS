IS00017E ;Compiled from script 'Generated: HL IHS LAB R01 LABCORP IN-I' on AUG 14, 2006
 ;Part 6
 ;Copyright 2006 SAIC
EN I '$D(X) D ERROR^INHS("Variable 'PV131' failed input transform. Processing continues.",0),ERROR^INHS("  Value = '"_INX_"'",0)
 K DXS
 S (INX,X)=$G(@INV@("PV132"))
