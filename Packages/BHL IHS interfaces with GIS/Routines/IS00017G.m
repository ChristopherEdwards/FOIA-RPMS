IS00017G ;Compiled from script 'Generated: HL IHS LAB R01 LABCORP IN-I' on AUG 14, 2006
 ;Part 8
 ;Copyright 2006 SAIC
EN S @INV@("OBR8",INI(1))=$G(X) I '$D(X) D ERROR^INHS("Variable 'OBR8' failed input transform in iteration #"_INI(1)_". Processing continues.",0),ERROR^INHS("  Value = '"_INX_"'",0)
 Q
H3 K DXS
