IS00017J ;Compiled from script 'Generated: HL IHS LAB R01 LABCORP IN-I' on AUG 14, 2006
 ;Part 11
 ;Copyright 2006 SAIC
EN S INI(1)=0 F  S INI(1)=$O(@INV@("OBX16",INI(1))) Q:'INI(1)  S INI=INI(1) D
...
H1 ;Entering REQUIRED section.
 ...
 Q:$G(INSTERR) $S($G(INREQERR)>INSTERR:INREQERR,1:INSTERR)  D MAIN^BHLRLABL
