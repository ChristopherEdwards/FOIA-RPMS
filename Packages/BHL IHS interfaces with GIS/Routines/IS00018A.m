IS00018A ;Compiled from script 'Generated: HL IHS LAB R01 UNILAB IN-I' on AUG 14, 2006
 ;Part 2
 ;Copyright 2006 SAIC
EN S:DO @("@INV@(""PV136"")")=$$PIECE^INHU(.LINE,DELIM,37)
...
C1 ;WHILE $P(DATA,DELIM)="OBR"
 ...
 .S INI(2)=1 F  S DATA=$$GL^INHOU(UIF,LCT) Q:'$$CHECKSEG^INHOU("NTE",0,2)  D  S INI(2)=INI(2)+1
 ..D:'INVS MC^INHS
 ..D GET^INHOU(UIF,0) S LINE=$G(LINE),DO=1
 ..S:DO @("@INV@(""NTE1"",INI(1),INI(2))")=$$PIECE^INHU(.LINE,DELIM,2)
 ..S:DO @("@INV@(""NTE2"",INI(1),INI(2))")=$$PIECE^INHU(.LINE,DELIM,3)
 ..S:DO @("@INV@(""NTE3"",INI(1),INI(2))")=$$PIECE^INHU(.LINE,DELIM,4)
 ..S:DO @("@INV@(""NTE4"",INI(1),INI(2))")=$$PIECE^INHU(.LINE,DELIM,5)
 ..Q
