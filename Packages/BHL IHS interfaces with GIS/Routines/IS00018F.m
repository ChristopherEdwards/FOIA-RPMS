IS00018F ;Compiled from script 'Generated: HL IHS LAB R01 UNILAB IN-I' on AUG 14, 2006
 ;Part 7
 ;Copyright 2006 SAIC
EN I '$D(X) D ERROR^INHS("Variable 'ORC6' failed input transform. Processing continues.",0),ERROR^INHS("  Value = '"_INX_"'",0)
 K DXS
 S (INX,X)=$G(@INV@("ORC7"))
