IS00030(INTT,INDA,INA,INDEST,INQUE,INORDUZ,INORDIV) ;Compiled from script 'Generated: HL IHS IZV04 QBP OUT-O' on FEB 28, 2013
 ;Part 1
 ;Copyright 2013 SAIC
...
START ;Initialize variables
 ...
 ;SET MSH4 = INSGX\^INTHL7F(17008,5)\\180\@MSH5
 S D0=INDA S X=$G(INA("MSH5"))
 S X1="^INTHL7F(17008,5)" X:$L($G(@X1)) $G(@X1) S X=$E(X,1,180)
 ...
 ;SET QPD4 = INSGX\^INTHL7FT(7,3)\\250\#.01
