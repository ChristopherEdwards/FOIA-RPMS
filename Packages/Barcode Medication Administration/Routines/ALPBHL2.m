ALPBHL2 ;OIFO-DALLAS MW,SED,KC - BCBU main HL7 message processor ;01/01/03
 ;;3.0;BAR CODE MED ADMIN;**7,8,1018**;Mar 2004;Build 27
 ;
 S ALPBECH=HL("ECH")
 S ALPBCS=$E(ALPBECH)
 S ALPBFS=HL("FS")
 ...
 S I=0 F  S I=$O(HLA("HLS",I)) Q:I'>0  S HLNODE=$G(HLA("HLS",I)) Q:HLNODE=""  D  ;VAOIT FOXK
