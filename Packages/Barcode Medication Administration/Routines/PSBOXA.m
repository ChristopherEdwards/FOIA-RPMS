PSBOXA ;BIRMINGHAM/EFC-MEDICATION LOG ;26-Feb-2013 11:53;PLS
 ;;3.0;BAR CODE MED ADMIN;**13,1015**;Mar 2004;Build 62
 ;
 ; Reference/IA
 ;
 ; File 4/10090
 ;
 ; Modified - IHS/MSC/PLS - 02/26/13 - Line BLDRPT+12
 ;
...
BLDRPT ;
 ...
 .;IHS/MSC/PLS - 02/26/13 - IHS DISPLAY HRN KCF VAIOT CPR2=2-13
 .;S PSBOUTP($$PGTOT,PSBLNTOT)="W !,?5,""Patient.........: ("_$$GET1^DIQ(2,PSBDFN_",",.09)_") "_$$GET1^DIQ(2,PSBDFN_",",.01)_""""
 .S PSBOUTP($$PGTOT,PSBLNTOT)="W !,?5,""Patient.........: ("_$S(DUZ("AG")="I":$$HRN^AUPNPAT(PSBDFN,DUZ(2)),1:$$GET1^DIQ(2,PSBDFN_",",.09))_") "_$$GET1^DIQ(2,PSBDFN_",",.01)_""""
