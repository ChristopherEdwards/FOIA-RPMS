PSBVDLPA ;BIRMINGHAM/EFC-BCMA UNIT DOSE VIRTUAL DUE LIST FUNCTIONS ;06-Dec-2006 14:25;SM
 ;;3.0;BAR CODE MED ADMIN;**5,16,1005**;Mar 2004
 ;
 ; called by PSBVDLUD to find patches not removed
 ;
 ; Modified - IHS/MSC/PLS - 12/06/2006 - Line EN+2 - BCMA Fix
EN ;
