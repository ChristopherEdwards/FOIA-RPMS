...
STUFF ;  stuff departure=home address, destination=division(ins) address, and attendant/payee=patient        
 ...
 I $D(^DIC(4,DGBTDIV,1))#10=1 S DGBTTO2=$P(^DIC(4,DGBTDIV,1),"^"),DGBTTO3=$P(^(1),"^",2),X=$P(^(1),"^",3) D UP^DGHELP S DGBTTO4=X ; ref file #4, institution file by selected div
 Q
DED ;
