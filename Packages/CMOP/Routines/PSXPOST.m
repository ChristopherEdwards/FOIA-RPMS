...
HOST F FILE=552,552.1,552.2,552.3,552.4,552.5,553,553.1,554,555 S ^DD(FILE,0,"VR")="2.0"
 ...
 S PSX=^XMB("NETNAME")
 S CMOP=$S($G(PSX)["-L":"LEAVENWORTH",$G(PSX)["-W":"WEST LA",$G(PSX)["-B":"BEDFORD",$G(PSX)["-D":"DALLAS",$G(PSX)["-M":"MURFREESBORO",$G(PSX)["-H":"HINES",$G(PSX)["-T":"TEST",1:"UNKNOWN")
...
SYS ;Setup CMOP System entry for new sites
 ...
 S PSX=$S($G(PSX1)["-L":"LEAVENWORTH",$G(PSX1)["-B":"BEDFORD",$G(PSX1)["-W":"WEST LA",$G(PSX1)["-D":"DALLAS",$G(PSX1)["-M":"MURFREESBORO",$G(PSX1)["-H":"HINES",$G(PSX1)["-T":"TEST",1:"UNKNOWN")
