...
CKDT I '$D(DT) S %DT="",X="T" D ^%DT S DT=Y
 ...
 S DIR(0)="SX^B:BEDFORD;D:DALLAS;L:LEAVENWORTH;W:WEST LA;M:MURFREESBORO;H:HINES;T:TEST",DIR("A")="Select the CMOP to RECEIVE YOUR DATA " D ^DIR K DIR
 I "BDLWMHT"'[$E(X) S XPDABORT=2 Q
 S ^TMP("PSXCMOP",$J)="CMOP-TEST.IHS.GOV"  ;"CMOP-"_$S($E(X)="L":"LEAV",$E(X)="B":"BED",$E(X)="D":"DAL",$E(X)="W":"WLA",$E(X)="M":"MURF",$E(X)="H":"HINES")_".MED.VA.GOV"
