PXRMINDX ;SLC/PKR - Routines for utilizing the index. ;10-Jun-2015 12:10;du
 ;;2.0;CLINICAL REMINDERS;**4,6,1001,12,17,18,26,1005**;Feb 04, 2005;Build 23
...
FPDAT(FILENUM,SNODE,DFN,ITEM,NGET,SDIR,BDT,EDT,NFOUND,FLIST) ;Find patient
 ...
 ;IHS/MSC/MGH modified to not save entered in error vitals
 ...
 . S DAS=""
 . F  S DAS=$O(^PXRMINDX(FILENUM,SNODE,DFN,ITEM,DATE,DAS),-1) Q:DAS=""!(DONE)  D
 .. I FILENUM=9000010.01 D  Q:+EIE
 ... S EIE=$P($G(^AUPNVMSR(DAS,2)),U,1)=1
 .. S NFOUND=NFOUND+1
