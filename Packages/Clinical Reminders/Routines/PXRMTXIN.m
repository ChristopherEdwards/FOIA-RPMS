PXRMTXIN ;SLC/PKR - Taxonomy inquiry for general use. ;15-Apr-2015 04:35;du
...
BTAXALL ;Taxonomy inquiry, return the formatted text OUTPUT.
 ...
 .;IHS/MSC/MGH added N IOSTBM,IORI
 . I BOP="B" N IOSTBM,IORI D BROWSE^DDBR("OUTPUT","NR","Taxonomy Inquiry")
...
BTAXINQ(IEN) ;Display a Taxonomy inquiry, defaults to the Browswer.
 ...
 I BOP="" Q
 ;IHS/MSC/MGH added N IOSTBM,IORI
 I BOP="B" N IOSTBM,IORI D BROWSE^DDBR("OUTPUT","NR",TITLE)
 I BOP="P" D GPRINT^PXRMUTIL("OUTPUT")
 Q
 ;
 ;==========================================
