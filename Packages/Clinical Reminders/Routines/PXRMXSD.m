PXRMXSD ; SLC/PJH - Reminder Reports DIR Prompts;23-Mar-2015 10:42;DU
 ;;2.0;CLINICAL REMINDERS;**4,1001,12,1005**;Feb 04, 2005;Build 23
...
SELECT(TYPE) ;Patient Sample Selection
 ...
 ;IHS/MSC/MGH Patch 1001 Add IHS primary provider
...
SSN(YESNO) ;Option to print full SSN.
 ...
 K DIROUT,DIRUT,DTOUT,DUOUT
 S DIR(0)="YA"
 ;IHS/MSC/MGH Patch 1001 Modifed to use HRCN instead of SSN
