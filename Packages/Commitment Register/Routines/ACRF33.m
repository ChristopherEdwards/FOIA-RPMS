ACRF33 ;IHS/OIRM/DSD/THL,AEF - SOLICITATION, OFFER AND AWARD; [ 09/22/2005   9:44 AM ]
...
GATHER ;GATHER ALL INFO REQUIRED TO PRINT THE DOCUMENT
 ...
 S ACRDET=$P(ACR33,U,10)
 S X=$P(ACR33,U,11)
 S ACRDATE=$E(X,4,5)_"/"_$E(X,6,7)_"/"_$E(X,2,3)
 S Y=X
 X ^DD("DD")
 S ACRHOUR=$P(Y,"@",2)
