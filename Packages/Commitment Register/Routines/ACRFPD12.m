ACRFPD12 ;IHS/OIRM/DSD/AEF - UPDATE ARMS PER DIEM CITY FILE [ 10/15/2004  10:01 AM ]
 ;;2.1;ADMIN RESOURCE MGMT SYSTEM;**12**;JAN 01, 2003
 ;
 ;     ROUTINE FOR PATCH ACR*2.1*12
 ;
...
EN ;EP -- MAIN ENTRY POINT
 ...
 S UPDATE=3041001                       ;CHANGE THIS EVERY YEAR
 S INSTALL=DT
 D ^XBKVAR
 D MSG(3,">>>Installing ARMS patch ACR*2.1*12...")
 H 2
 D BLD
 D UPDATE
 D CLEAN
...
LOOP(UPDATE,INSTALL) ;-- LOOP THROUGH ALL CITIES NOT UPDATED AND SET TO STANDARD RATE
 ...
 .. I STATE=2 S DR=".03////80;.04////55"   ;ALASKA STAND RATE FY04,FY05
 ..;I STATE'=2 S DR=".03////55;.04////30"  ;CONUS STAND RATE FY03
 .. I STATE=12 S DR=".03////72;.04////61"  ;HAWAII STAND RATE FY04,FY05
