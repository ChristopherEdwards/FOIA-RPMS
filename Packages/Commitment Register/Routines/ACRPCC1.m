ACRPCC1 ; GENERATED FROM 'ACR COMMERCIAL CONTRACT' PRINT TEMPLATE (#3971) ; 09/29/09 ; (continued)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>0 Q:'DN  W ?0 X DXS(15,9) K DIP K:DN Y
 ...
 D N:$X>59 Q:'DN  W ?59 W "|"
 D N:$X>4 Q:'DN  W ?4 X DXS(16,9.2) S X=$P(DIP(101),U,1) S D0=I(0,0) K DIP K:DN Y W X
 D N:$X>59 Q:'DN  W ?59 W "|"
 ...
 D N:$X>59 Q:'DN  W ?59 W "|"
 D N:$X>4 Q:'DN  W ?4 X DXS(18,9.2) S X=$P(DIP(101),U,3) S D0=I(0,0) K DIP K:DN Y W X
 W ", "
 X DXS(19,9.3) S X=$P(DIP(201),U,2) S D0=I(0,0) K DIP K:DN Y W X
 W "  "
 X DXS(20,9.2) S X=$P(DIP(101),U,5) S D0=I(0,0) K DIP K:DN Y W X
 D N:$X>59 Q:'DN  W ?59 W "|"
 D N:$X>4 Q:'DN  W ?4 W "PHONE:"
 W ?12 X DXS(21,9.2) S X=$P(DIP(101),U,6) S D0=I(0,0) K DIP K:DN Y W X
 D N:$X>59 Q:'DN  W ?59 W "|"
