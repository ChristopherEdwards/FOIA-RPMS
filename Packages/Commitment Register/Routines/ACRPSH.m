ACRPSH ; GENERATED FROM 'ACR ORDER FOR SUP HEAD' PRINT TEMPLATE (#3919) ; 09/30/09 ; (FILE 9002196, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 I $D(DXS)<9 M DXS=^DIPT(3919,"DXS")
 S I(0)="^ACRDOC(",J(0)=9002196
 W ?0 K ACRX I '$D(^ACROBL(D0,"APV")) S ACRX="" K DIP K:DN Y
 W ?11 I '$D(ACRX),$D(^ACROBL(D0,"APV")),$P(^("APV"),U,3)'="A" S ACRX="" K DIP K:DN Y
 D N:$X>0 Q:'DN  W ?0 W "--------------------------------------------------------------------------------"
 D T Q:'DN  W ?2 X DXS(1,9) K DIP K:DN Y
