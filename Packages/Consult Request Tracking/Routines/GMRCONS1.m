GMRCONS1 ;ALB/MRY - Consult/Scheduling link report ;25-Jul-2012 11:04;DU
 ;;3.0;CONSULT/REQUEST TRACKING;**52,62,1003**;DEC 27, 1997;Build 14
EN ;
 K GMRNOSRV,GMRTST D SERV Q:$D(GMRNOSRV)
...
START D WAIT^DICD K ^TMP($J),^TMP("GMRCR",$J)  S CS=RS,CNT=CNT+1,^TMP("GMRCCS",$J,CNT)=CS,^TMP("GMRCCS",$J,"B",CS)="" D SERVICE
 ...
 .Q:$$TESTPAT^VADPT(PTIEN)&(GMRTST="E")
 .Q:'$$TESTPAT^VADPT(PTIEN)&(GMRTST="D")
