GMRCP5A ;SLC/DCM,RJS,MA - Print Consult form 513 (Gather Data - TIU Results) ;15-Mar-2012 10:40;PLS
 ;;3.0;CONSULT/REQUEST TRACKING;**4,13,12,15,21,22,1001,53,1003**;Dec 27, 1997;Build 14
 ; Patch #21 added PRNTAUDT to this routine.
 ;Modified - IHS/CIA/MGH - 11/29/2005 - Line FORMAT+8 Added code to use HRCN instead of SSN
 ;
...
FORMAT(PAGEWID) ;
 ...
 N GMRCSN,GMRCHRCN,GMRCSR,GMRCSVC,GMRCTO,GMRCUL,GMRCWARD,GMRCWLI,GMRCX,LN,MCFILE,MCPROC
 N ND,ND1,ND2,NDS,ORACTION,SEX,TAB,X,Y
 N GMRCHRCN  ;IHS/MSC/MGH
 ;
