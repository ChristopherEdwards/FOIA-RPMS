GMRCPC ;SLC/DCM,dee,MA - List Manager Routine: Collect and display consults by service and status ;23-Sep-2011 09:17;PLS
 ;;3.0;CONSULT/REQUEST TRACKING;**1,7,21,23,22,1002**;DEC 27, 1997;Build 1
...
EXIT ; -- exit code
 ...
 K GMRCEDT1,GMRCEDT2,GMRCSVNM,GMRTST
...
PRNTONLY(GMRCCTRL) ;Option to just send the report to a device.
 ...
 E  D ENOR^GMRCSTLM(.RETURN,GMRCDG,GMRCDT1,GMRCDT2,GMRCSTAT,GMRCCTRL,"CP",GMRTST)
 ;Print the report
...
PRNTQ ;Print Queued report from ^TMP global then kill off ^TMP & ^XTMP
 ;Create the report
 N RETURN,INDEX
 D ENOR^GMRCSTLM(.RETURN,GMRCDG,GMRCDT1,GMRCDT2,GMRCSTAT,GMRCCTRL,"CP",GMRTST)
 U IO
 S INDEX=""
