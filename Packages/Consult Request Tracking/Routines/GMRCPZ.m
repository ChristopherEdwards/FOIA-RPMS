GMRCPZ ;SLC/DCM - GMRC List Manager Routine -- Main menu actions for Pharmacy consults request tracking ;15-Mar-2012 10:41;PLS
 ;;3.0;CONSULT/REQUEST TRACKING;**1,1001,1003**;DEC 27, 1997;Build 14
 ;Modified - IHS/CIA/MGH - 11/29/2005 - Line INIT+3, EXIT+5  - Code change to use HRCN instead of SSN
...
INIT ; -- init variables and list array
 ...
 S GMRCHRCN=$$HRCN^GMRCMP(DFN,+$G(DUZ(2))),GMRCSSN=GMRCHRCN
...
HELP ; -- help code
 ...
 ;
EXIT ; -- exit code
 K BLK,CDT,CNT,LNCT,CTRLCOL,DFN,TAB,DFNS,SEX,LNCT,GMRCCT,GMRCDT,GMRCND,GMRCNO,GMRCRB,GMRCDT1,GMRCDT2,GMRCSEX,GMRCSN,GMRCAGE,GMRCDOB,GMRCPNM,GMRCQUT,GMRCPTN,GMRCSSN,GMRCHRCN,GMRCSSNM,GMRCSVCN
