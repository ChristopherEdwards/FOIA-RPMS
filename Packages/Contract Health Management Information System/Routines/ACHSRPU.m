ACHSRPU ; IHS/ITSC/PMF - PRINT UNIVERSAL 843 FORMS ;JUL 10, 2008
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**6,7,11,12,13,14,15,16,18,19,20,22**;JUN 11,2001;Build 13
...
TESTPRNT ;EP.  (For test print.)
 ;ACHS*3.1*16 10/26/09;ACHS*3.1*19 CHG FORM FEED SECTION;ACHS*3.1*22 ADDED TEST FOR 585101
...
PONUM ; -- Field 1 : DCR #, Document type, PDO number.
 ...
 ;I $G(ACHSDIEN) W ?ACHSTAB+61,$E($P(^ACHSF(DUZ(2),"D",ACHSDIEN,0),U,27),3),ACHSORDN,ACHSSF  ;ACHS*3.1*19 ;ACHS*3.1*20 ? IN NXT LINE;ACHS*3.1*22 ADDED 585101
