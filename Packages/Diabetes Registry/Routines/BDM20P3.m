BDM20P3 ; IHS/CMI/LAB - PCC Suite v1.0 patch 1 environment check ; [ 02/05/2009 2:37 PM ]
 ...
 I '$$INSTALLD("BDM*2.0*2") D SORRY(2)
 ;
 Q
 ;
PRE ;
...
POST ;
 ...
 ..I ^BDMLET(X,1,Y,0)["|PPD EDUCATION|"!(^BDMLET(X,1,Y,0)["|ppd education|") D
 ...S Z=$P(^BDMLET(X,1,Y,0),"|PPD EDUCATION|",1)_"|TB TEST EDUCATION|"_$P(^BDMLET(X,1,Y,0),"|PPD EDUCATION|",2)
 ...S ^BDMLET(X,1,Y,0)=Z
 D MEDTAX
 D LABTAX
 D ^BDM2TX
