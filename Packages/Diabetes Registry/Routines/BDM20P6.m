BDM20P6 ; IHS/CMI/LAB - BDM V2.0 patch 5 environment check ; 
 ...
 I '$$INSTALLD("BDM*2.0*5") D SORRY(2)
 ;
 Q
 ;
PRE ;
 ...
 Q
POST ;
 S X=$$ADD^XPDMENU("BDM M MAIN DM MENU","BDM DM2013 AUDIT MENU","DM13",4)
 I 'X W !,"Attempt to add BDM DM2013 AUDIT MENU option failed.." H 3
 S X=$$ADD^XPDMENU("BDM REPORTS","BDM TB TREATMENT","TB",65)
 I 'X W !,"Attempt to add BDM DM2012 AUDIT MENU option failed.." H 3
 S X=$$DELETE^XPDMENU("BDM M MAIN DM MENU","BDM DM99 AUDIT MENU")
 S X=$$DELETE^XPDMENU("BDM M MAIN DM MENU","BDM DM2000 AUDIT MENU")
 S X=$$DELETE^XPDMENU("BDM M MAIN DM MENU","BDM DM2001 AUDIT MENU")
 S X=$$DELETE^XPDMENU("BDM M MAIN DM MENU","BDM DM2003 AUDIT MENU")
 S X=$$DELETE^XPDMENU("BDM M MAIN DM MENU","BDM DM2005 AUDIT MENU")
 S X=$$DELETE^XPDMENU("BDM M MAIN DM MENU","BDM DM2006 AUDIT MENU")
 D MEDTAX
 D LABTAX
