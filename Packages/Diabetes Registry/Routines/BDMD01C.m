BDMD01C ; IHS/CMI/LAB - 2010 DIABETES AUDIT ;
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMD018(R,8,1) I R="" Q  ;no numeric result 
...
LPROF ;
 K BDM,BDMX S BDMX=""
 Q  ;no longer count lipid profile because there is no result  2010 per Ray.
