BDMD114 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ; 22 Feb 2011  3:43 PM
...
TOB ;
 ...
 W !?9,"Counseled - Refused",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,3),$P(V,U,6))  ;cmi/maw 12/26/2007 DM2011
...
TX ;
 I $Y>(BDMIOSL-17) D HEADER Q:BDMQUIT
 ...
 W !?7,"Incretin mimetics (Byetta)",?53,$$C($P(V,U,10)),?65,$$P($P(V,U,2),$P(V,U,10))  ;cmi/maw 12/26/2007 DM2011
 ...
 W !!?7,"Any Oral med combination",?53,$$C($P(V,U,16)),?65,$$P($P(V,U,2),$P(V,U,16))
 W !?7,"Any Insulin + other med combination",?53,$$C($P(V,U,17)),?65,$$P($P(V,U,2),$P(V,U,17))
 W !!?7,"Refused or Undetermined",?53,$$C($P(V,U,15)),?65,$$P($P(V,U,2),$P(V,U,15))
 D ^BDMD11A
 Q
EXIT ;
...
HEADER1 ;
 ...
 W !,$$CTR("***  IHS/RPMS CARE & OUTCOMES AUDIT 2011  ***",80),!
