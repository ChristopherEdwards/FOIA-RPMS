BDMD11C ; IHS/CMI/LAB - 2011 DIABETES AUDIT ;
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMD118(R,8,1) I R="" Q  ;no numeric result 
...
LPROF ;
 K BDM,BDMX S BDMX=""
 Q  ;no longer count lipid profile because there is no result  2011 per Ray.
