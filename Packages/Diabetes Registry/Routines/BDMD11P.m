BDMD11P ; IHS/CMI/LAB - 2011 DIABETES AUDIT PRINT ;
 ...
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM11",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .S BDMGUIC=1
 .W:$D(IOF) @IOF
 .S BDMPG=BDMPG+1 W:$G(BDMGUI) !! W $$CTR("ASSESSMENT OF DIABETES CARE, 2011       DATE AUDIT RUN: "_$$FMTE^XLFDT(DT)_"  Page: "_BDMPG,80)
 ...
 .W !,"TRIBAL AFFIL: ",$P($$I(120),U,1)," ",$E($P($$I(120),U,2),1,25),"   STATE of Residence: ",$P($$I(121),U)  ;cmi/maw 12/17/2007 DM2011
 ...
 .W !?3,$$I(58),?6,"8 Incretin Mimetics (Byetta)"  ;cmi/maw 12/18/2007 DM2011
 .W !?3,$$I(59),?6,"9 DPP4 inhibitors (Januvia, Onglyza)"  ;cmi/maw 12/18/2007 DM2011
 .W !?3,$P($$I(99),U),?6,"10 Amylin Analogues (Symlin)"
 .W !?3,$$I(100),?6,"11 GLP-1 analog (Victoza)"  ;cmi/maw 12/18/2007 DM2011
 .W !?3,$P($$I(101),U),?6,"12 Bromocriptine (Cycloset)"
 .W !?3,$P($$I(57),U),?6,"13 Refused/Unknown" I $$I(57)]"" W "  ",$P($$I(57),U,2)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !?3,$P($$I(307),U,1),?6,"8 None or refused"  ;cmi/maw 12/18/2007 DM2011
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !!,"TB Testing"
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .I $E($$I(79))="1" W !?28,"eGFR value: ",$P($$I(79),U,2)  ;documented in the"  ;cmi/maw 12/18/2007 DM2011
 ...
 .W !!,"Local Option question:  ",$$LOCN^BDMD110(BDMPD,BDMDMRG)
 .W !,"Extended Local Option question:  ",$$LOCT^BDMD110(BDMPD,BDMDMRG)
 .W !
 .I $E(IOST,1,2)'="P-" W !! S DIR(0)="E" D ^DIR K DIR ;CMI/GRL 1/18/07
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMD114
DONE ;
 K ^TMP($J)
 K ^XTMP("BDMDM11",BDMJOB,BDMBTH),BDMJOB,BDMBTH
 Q
I(I) ;
 Q $G(^XTMP("BDMDM11",BDMJOB,BDMBTH,"AUDIT",BDMPD,I))
 ;
PAGE ;
 Q:$G(BDMDSP)
 ...
 I $G(BDMGUI) W !!
 S BDMPG=BDMPG+1
 W $$CTR("ASSESSMENT OF DIABETES CARE, 2011         DATE AUDIT RUN: "_$$FMTE^XLFDT(DT)_"  Page: "_BDMPG,80)
