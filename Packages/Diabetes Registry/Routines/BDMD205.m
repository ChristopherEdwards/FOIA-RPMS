BDMD205 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
TYPE ;
 ...
 S X=$$TYPE^BDMD206(BDMPD,BDMDMRG,BDMADAT)
...
DURDMC ;
 ...
 S V=$$DURDM^BDMD204(BDMPD,BDMDMRG,BDMADAT)
...
BMI ;
 ...
 .I $$OW^BDMD204(BDMPD,V,BDMADAT) S $P(BDMCUML(40),U,3)=$P(BDMCUML(40),U,3)+1
 .I $$OB^BDMD204(BDMPD,V,BDMADAT) S $P(BDMCUML(40),U,4)=$P(BDMCUML(40),U,4)+1
HGB ;
 ;use last hgba1c value only
 ;BDMCUML(50)=
 S $P(BDMCUML(50),U,2)=$P(BDMCUML(50),U,2)+1
 S V=$P($G(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,78)),U)
...
TBSTAT ;
 ...
 S V=$$TBCODE^BDMD206(BDMPD,BDMRED,BDMDMRG)
...
DMTX ;diabetes treatment
 ...
 S V=$$THERAPY^BDMD206(BDMPD,BDM6MBD,BDMRED)
...
ACE ;110 title^total pts^total pts with protein^# of those on ace^# with htn^# of those on ace"
 ...
 S P=$G(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,94))
 S H=$G(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,34))
 S A=$G(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,60))
...
LIPID ;115
 ...
 S L=$$LDL^BDMD208(BDMPD,BDMRBD,BDMRED,"I"),L=$P(L,U)
 S T=$$CHOL^BDMD208(BDMPD,BDMRBD,BDMRED,"I"),T=$P(T,U)
