BDMD20P ; IHS/CMI/LAB - 2000 DIABETES AUDIT PRINT ;
 ...
 S BDMPD=0 F  S BDMPD=$O(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .W:$D(IOF) @IOF
...
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMD204
DONE ;
 K ^TMP($J)
 K ^XTMP("BDMDM20",BDMJOB,BDMBTH),BDMJOB,BDMBTH
 Q
I(I) ;
 Q ^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,I)
 ;
PAGE ;
