BDMD21 ; IHS/CMI/LAB - IHS Diabetes Audit 2001 ;
...
ZIS ;
 I BDMPREP'=2 S XBRP="^BDMD21P",XBRC="^BDMD210",XBRX="XIT^BDMD21",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="^BDMD210",XBRX="XIT^BDMD21",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
WRITEF ;EP write flat file
 ...
 S (X,N)=0 F  S X=$O(^BDMRECD(16,13,X)) Q:X'=+X  S N=N+1,^BDMDATA($J,N)=^BDMRECD(16,13,X,0)
