BDMD212 ; IHS/CMI/LAB - 2001 DIABETES AUDIT ;
...
PAP(P,BDATE,EDATE) ; EP
 ...
 K BDM I T S BDM(1)=$$CPT^BDMD212(P,,ED,T,4) I $G(BDM(1))]"" Q "Yes  "_BDM(1)
 NEW G S G=0
...
EKG(P,EDATE,F) ;EP
 ...
 K BDM I T S BDM(1)=$$CPT^BDMD212(P,,ED,T,3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
 K BDM I T S BDM(1)=$$RAD^BDMD212(P,,ED,T,3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
