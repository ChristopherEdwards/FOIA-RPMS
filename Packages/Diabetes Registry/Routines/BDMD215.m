BDMD215 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
CUML ;EP
 ...
 S BDMCUML(100)="CHRONIC ASPIRIN THERAPY"
...
TYPE ;
 ...
 S X=$$TYPE^BDMD216(BDMPD,BDMDMRG,BDMADAT)
...
DURDMC ;
 ...
 S V=$$DURDM^BDMD214(BDMPD,BDMDMRG,BDMADAT)
...
BMI ;
 ...
 .I $$OW^BDMD214(BDMPD,V,BDMADAT) S $P(BDMCUML(40),U,3)=$P(BDMCUML(40),U,3)+1
 .I $$OB^BDMD214(BDMPD,V,BDMADAT) S $P(BDMCUML(40),U,4)=$P(BDMCUML(40),U,4)+1
HGB ;
 ;use last hgba1c value only
 ;BDMCUML(50)=
 S $P(BDMCUML(50),U,2)=$P(BDMCUML(50),U,2)+1
 S V=$P($G(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,78)),U)
...
BPC ;blood pressure control
 ...
 .I S<130&(D<85) S $P(BDMCUML(60),U,4)=$P(BDMCUML(60),U,4)+1 Q
...
TBSTAT ;
 ...
 S V=$$TBCODE^BDMD216(BDMPD,BDMRED,BDMDMRG)
...
DMTX ;diabetes treatment
 ...
 S V=$$THERAPY^BDMD216(BDMPD,BDM6MBD,BDMRED)
...
ACE ;110 title^total pts^total pts with protein^# of those on ace^# with htn^# of those on ace"
 ...
 S P=$G(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,94))
 S H=$G(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,34))
 S A=$G(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,60))
...
LIPID ;115
 ...
 S L=$$LDL^BDMD218(BDMPD,BDMRBD,BDMRED,"I"),L=$P(L,U)
 S T=$$CHOL^BDMD218(BDMPD,BDMRBD,BDMRED,"I"),T=$P(T,U)
 I T]"",T'<240 S $P(BDMCUML(115),U,3)=$P(BDMCUML(115),U,3)+1 I $E(V)="Y" S $P(BDMCUML(115),U,4)=$P(BDMCUML(115),U,4)+1
 I L]"",L>160 S $P(BDMCUML(115),U,5)=$P(BDMCUML(115),U,5)+1 I $E(V)="Y" S $P(BDMCUML(115),U,6)=$P(BDMCUML(115),U,6)+1
EXAMS ;
