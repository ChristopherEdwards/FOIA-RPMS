BDMD21P ; IHS/CMI/LAB - 2001 DIABETES AUDIT PRINT ;
 ...
 S BDMPD=0 F  S BDMPD=$O(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .W:$D(IOF) @IOF
 .W !,$$CTR("ASSESSMENT OF DIABETES CARE, 2001         DATE AUDIT RUN: "_$$FMTE^XLFDT(BDMRED),80)
...
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMD214
DONE ;
 K ^TMP($J)
 K ^XTMP("BDMDM21",BDMJOB,BDMBTH),BDMJOB,BDMBTH
 Q
I(I) ;
 Q ^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,I)
 ;
PAGE ;
