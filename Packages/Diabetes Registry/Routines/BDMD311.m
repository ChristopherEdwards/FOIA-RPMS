BDMD311 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
URIN ;
 ...
 S V=$G(^XTMP("BDMDM31",BDMJOB,BDMBTH,"AUDIT",BDMPD,92))
 S A=$G(^XTMP("BDMDM31",BDMJOB,BDMBTH,"AUDIT",BDMPD,94))
 ...
 .S V=$G(^XTMP("BDMDM31",BDMJOB,BDMBTH,"AUDIT",BDMPD,96))
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^BDMD312(BDMPD,BDMRED,"I")
 I V]"" D
...
CREAT ;
 ...
 S V=$$CREAT^BDMD318(BDMPD,BDMRBD,BDMRED,"I")
...
TCHOL ;
 ...
 S V=$$CHOL^BDMD318(BDMPD,BDMRBD,BDMRED,"I")
...
LDL ;
 ...
 S V=$$LDL^BDMD318(BDMPD,BDMRBD,BDMRED,"I")
...
HDL ;
 ...
 S V=$$HDL^BDMD318(BDMPD,BDMRBD,BDMRED,"I")
...
TRIG ;
 ...
 S V=$$TRIG^BDMD318(BDMPD,BDMRBD,BDMRED,"I")
...
SELF ;
 ...
 S V=$G(^XTMP("BDMDM31",BDMJOB,BDMBTH,"AUDIT",BDMPD,98))
...
SDM  ;
 ...
 S V=$G(^XTMP("BDMDM31",BDMJOB,BDMBTH,"AUDIT",BDMPD,100))
 S P=$S($E(V)="Y":3,1:4)
...
CESS(P,B,D) ;EP - find any cessation hf in 12 months before E
 ...
 I 'T Q "No"
 S (X,G)=0 F  S X=$O(^ATXAX(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^BDMD317(P,9999999.09,$P(^ATXAX(T,21,X,0),U),B,D) S G=1
 I G Q "Refused"
 Q "No"
 ;
