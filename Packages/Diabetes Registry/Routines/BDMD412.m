BDMD412 ; IHS/CMI/LAB - 2012 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**5**;JUN 14, 2007
 ;
 ;cmi/anch/maw 9/12/2012 code set versioning in DEPDX
 ;
SETN ;
...
EKG(P,EDATE,F) ;EP
 ...
 K BDM I T S BDM(1)=$$CPT^BDMD412(P,$$DOB^AUPNPAT(P),ED,T,3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
 K BDM I T S BDM(1)=$$RAD^BDMD412(P,$$DOB^AUPNPAT(P),ED,T,3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
 K BDM I T S BDM(1)=$$TRAN^BDMD4DU(P,$$DOB^AUPNPAT(P),ED,T,3) D
 .I BDM(1)="" Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
...
TROG(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 Q ""
INCR(P,BDATE,EDATE) ;EP  cmi/maw 12/18/2007 DM2012
 NEW X,BDM,E
 S X=P_"^LAST MEDS [DM AUDIT INCRETIN MIMETIC"_";DURING "_BDATE_"-"_EDATE S E=$$START1^APCLDF(X,"BDM(")
 I $D(BDM(1)) Q "X"
 Q ""
 ;
DPP4(P,BDATE,EDATE) ;EP  cmi/maw 12/18/2012 DM2012
 NEW X,BDM,E
...
DEPSCR(P,BDATE,EDATE,F,R) ;EP
 ...
 ;refusal
 NEW G S G=$$REFUSAL^BDMD417(P,9999999.15,$O(^AUTTEXAM("B","DEPRESSION SCREENING",0)),BDATE,EDATE)
 ...
 .I $P($G(^AMHREC(V,14)),U,5)]"",($P(^AMHREC(V,14),U,5)="UAS"!($P(^AMHREC(V,14),U,5)'="REF")) S BDMC="3  Refused BH Exam 36 "_$$DATE^BDMD410(9999999-D) Q
 I BDMC]"" Q BDMC
 Q "2  No"
 ;
LOINC(A,B) ;
