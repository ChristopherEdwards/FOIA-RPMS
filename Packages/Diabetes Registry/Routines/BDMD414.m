...
TOB ;
 ...
 W !?9,"Counseled - Refused",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,3),$P(V,U,6))  ;cmi/maw 12/26/2007 DM2012
...
TX ;
 ...
 W !?7,"Incretin mimetics (Byetta)",?53,$$C($P(V,U,10)),?65,$$P($P(V,U,2),$P(V,U,10))  ;cmi/maw 12/26/2007 DM2012
 ...
 W !!?7,"Any Oral med combination",?53,$$C($P(V,U,17)),?65,$$P($P(V,U,2),$P(V,U,17))
 W !?7,"Any Insulin + other med combination",?53,$$C($P(V,U,18)),?65,$$P($P(V,U,2),$P(V,U,18))
 W !!?7,"Refused or Undetermined",?53,$$C($P(V,U,16)),?65,$$P($P(V,U,2),$P(V,U,16))
 D ^BDMD41A
 Q
EXIT ;
...
HEADER1 ;
 ...
 W !,$$CTR("***  IHS/RPMS CARE & OUTCOMES AUDIT 2012  ***",80),!
