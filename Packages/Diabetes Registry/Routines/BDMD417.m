BDMD417 ; IHS/CMI/LAB - 2012 DIABETES AUDIT ; 13 Mar 2012  1:52 PM
...
EYE(P,BDATE,EDATE,F,R) ;EP
 ...
 I LASTI]"" S $P(LASTI,U,2)="1  Yes - Diabetic Eye Exam - "_$$DATE^BDMS9B1($P(LASTI,U)) I F="H" Q LASTI
 I F="E",LASTI]"" Q $P(LASTI,U,2)  ; if in audit and has exam display it
 ;
 S X=$$LASTCPTT^BDMAPIU(P,BDATE,EDATE,$O(^ATXAX("B","DM AUDIT EYE EXAM CPTS",0)),"E")
 I $P(X,U)>$P(LASTI,U) S LASTI=$P(X,U)_U_"1  Yes - "_$P(X,U,2)_" - "_$$DATE^BDMS9B1($P(X,U)) I F="H" Q LASTI
 K BDMV,BDMY
 I LASTI]"" Q LASTI
 ;
 K T
