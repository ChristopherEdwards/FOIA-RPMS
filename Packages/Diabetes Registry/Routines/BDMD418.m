BDMD418 ; IHS/CMI/LAB - 2012 DIABETES AUDIT ;
...
PPD(P,EDATE,F) ;EP
 ...
 S X=EDATE,%DT="P" D ^%DT S BDATE=$$FMADD^XLFDT(Y,-365),BDATE=$$FMTE^XLFDT(BDATE),G=0 S X=$$REFUSAL^BDMD417(P,9999999.28,$O(^AUTTSK("B","PPD",0)),BDATE,EDATE) I X S G=X
