BDMD41A ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
IMM ;
 ...
 W !?7,"Flu Vaccine during audit period",?53,$$C($P(V,U,3)),?65,$$P($P(V,U,2),$P(V,U,3)),?71,"( ",$$P($P(V,U,2),$P(V,U,6))," )"
 ...
 W !?7,"Hepatitis B series (complete) - ever",?53,$$C($P(V,U,9)),?65,$$P($P(V,U,2),$P(V,U,9)),?71,"( ",$$P($P(V,U,2),$P(V,U,10))," )"
DEP ;
