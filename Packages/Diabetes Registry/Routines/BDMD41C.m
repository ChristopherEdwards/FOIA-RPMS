BDMD41C ; IHS/CMI/LAB - 2012 DIABETES AUDIT ;
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMD418(R,8,1) I R="" Q  ;no numeric result 
...
LPROF ;
 K BDM,BDMX S BDMX=""
 Q  ;no longer count lipid profile because there is no result  2012 per Ray.
