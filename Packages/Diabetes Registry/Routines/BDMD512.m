BDMD512 ; IHS/CMI/LAB - 2005 DIABETES AUDIT ;
...
EKG(P,EDATE,F) ;EP
 ...
 K BDM I T S BDM(1)=$$CPT^BDMD512(P,,ED,T,3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
 K BDM I T S BDM(1)=$$RAD^BDMD512(P,,ED,T,3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
...
DEPSCR(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "Yes V79.0"_" "_$$DATE^BDMD510($P(BDM(1),U))
 ;check patient education
 S Y="BDM("
 S X=P_"^LAST EXAM 36;DURING "_BDATE_"-"_EDATE S E=$$START1^APCLDF(X,Y)
 I $D(BDM(1)) Q "Yes Exam 36-Dep Screen "_$$DATE^BDMD510($P(BDM(1),U))
 S Y="BDM("
 ...
 .I $P(T,"-",1)="DEP"!($P(T,"-",1)="BH")!($P(T,"-",1)="GAD")!($P(T,"-",1)="SB")!($P(T,"-",1)="PDEP") S D="Yes pt ed "_T_" "_$$DATE^BDMD510($P(BDM(X),U))
 K BDM
 I $P(D,U)]"" Q D
BHSCR ;
 ...
 ..Q:'BDMP
 ..S BDMP=$P($G(^AMHPROB(BDMP,0)),U)
 ..I BDMP=14.1 S BDMC="Yes BH 14.1 "_$$DATE^BDMD510(9999999-D) Q
 ..I '$D(^AMHREDU("AD",V)) Q
 ...
 ...Q:'$D(^AUTTEDT(T,0))
 ...S T=$P(^AUTTEDT(T,0),U,2)
 ...I $P(T,"-",1)="DEP"!($P(T,"-",1)="BH")!($P(T,"-",1)="GAD")!($P(T,"-",1)="SB")!($P(T,"-",1)="PDEP") S BDMC="Yes BH pt ed "_T_" "_$$DATE^BDMD510(9999999-D)
 ...Q
 I BDMC]"" Q BDMC
 Q "No"
LOINC(A,B) ;
