BDMD61P ; IHS/CMI/LAB - 2006 DIABETES AUDIT PRINT ;
 ...
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM61",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .S BDMGUIC=1
 .W:$D(IOF) @IOF
 .W $$CTR("ASSESSMENT OF DIABETES CARE, 2006         DATE AUDIT RUN: "_$$FMTE^XLFDT(BDMRED),80)
 ...
 .;D PAGE Q:BDMQUIT
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMD614
DONE ;
 K ^TMP($J)
 K ^XTMP("BDMDM61",BDMJOB,BDMBTH),BDMJOB,BDMBTH
 Q
I(I) ;
 Q ^XTMP("BDMDM61",BDMJOB,BDMBTH,"AUDIT",BDMPD,I)
 ;
PAGE ;
