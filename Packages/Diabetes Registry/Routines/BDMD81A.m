BDMD81A ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
URIN ;
 ...
 W !,"Quantitative urine protein in the past 12 months",?53,$$C(PTOT),?65,$$P($P(BDMCUML(10),U,2),PTOT)
 ;TODO cmi/maw 12/26/2007 DM2008 how do we want UPCR and other quantitative to look
 W !!,"Albumin:Creatinine ratio (UACR)",?53,$$C($P(V,U,3)),?65,$$P($P(BDMCUML(10),U,2),$P(V,U,3))
 W !,"Protein:Creatinine ratio (UPCR)",?53,$$C($P(V,U,4)),?65,$$P($P(BDMCUML(10),U,2),$P(V,U,4))
 W !,"Other quantitative urine protein test",?53,$$C($P(V,U,5)),?65,$$P($P(BDMCUML(10),U,2),$P(V,U,5))
 W !,"Urine protein testing not done/unknown" S Z=$P(BDMCUML(10),U,2)-(PTOT) W ?53,$$C(Z),?65,$$P($P(BDMCUML(10),U,2),Z)
...
GFR ;cmi/maw 12/26/2007 DM2008
 ...
 W !!,"Estimated GFR documented during audit period",?53,$$C(T),?65,$$P($P(BDMCUML(10),U,2),T)
 ;
TOTAL ;
