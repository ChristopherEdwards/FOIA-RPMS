BDMD81C ; IHS/CMI/LAB - 2008 DIABETES AUDIT ;
...
URIN ;EP
 ...
 S X=0 F  S X=$O(^ATXLAB(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^BDMD817(P,60,$P(^ATXLAB(T,21,X,0),U),BDATE,EDATE) S G=1
 I G Q "Refused"
 S G=0
...
UACR(P,BDATE,EDATE) ;EP - albumin/creatinine ration UACR
 ...
 I '$D(BDM(1)) Q ""
 D SETN
 I $D(BDM(1)) Q "X^"_$P(^AUPNVLAB(+$P(BDM(N),U,4),0),U,4)_$S($P(^AUPNVLAB(+$P(BDM(N),U,4),0),U,4)]"":" mg/g ",1:"")
 Q ""
 ;
