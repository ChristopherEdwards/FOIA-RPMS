BDMD913 ; IHS/CMI/LAB - 2009 DIABETES AUDIT ;
...
FLU(P,BDATE,EDATE,R,F) ;EP
 ...
 S LFLU=$$LASTFLU^APCLAPI4(P,BDATE,EDATE,"D")
 I LFLU]"" Q $S(F="E":"1  Yes  "_$$FMTE^XLFDT(LFLU),1:LFLU)
 ;
 I R Q ""
 NEW G S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:88,1:12),0)),BDATE,EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated"
 S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",15,0)),BDATE,EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",16,0)),BDATE,EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",111,0)),BDATE,EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
...
PNEU(P,EDATE,R,F) ;EP
 ...
 I R Q ""
 S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:33,1:19),0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 I '$$BI Q "2  No"
 S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",100,0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 S G=$$REFUSAL^BDMD917(P,9999999.14,$O(^AUTTIMM("C",109,0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 ...
 .Q:$P(^BIPC(X,0),U,4)>EDATE
 .S G=1_U_D
 I G Q "3  Refused "_$$FMTE^XLFDT($P(D,U,2))
 Q "2  No"
LASTFLUN ;
...
INCHES ;
 NEW F,FI,Z
 S (X,Z)=$$LASTHT^BDMD913(BDMPD,BDMRED,"I")
 Q:X=""
 S X=X/12  ;get feet
 S F=$P(X,".")
