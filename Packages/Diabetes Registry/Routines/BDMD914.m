BDMD914 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
TOB ;
 ...
 W !?9,"Counseled - Refused",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,3),$P(V,U,6))  ;cmi/maw 12/26/2007 DM2009
...
TX ;
 ...
 W !?7,"Acarbose/Miglitol",?53,$$C($P(V,U,7)),?65,$$P($P(V,U,2),$P(V,U,7))
 W !?7,"Glitazone",?53,$$C($P(V,U,8)),?65,$$P($P(V,U,2),$P(V,U,8))
 W !?7,"Incretin mimetics (Byetta)",?53,$$C($P(V,U,9)),?65,$$P($P(V,U,2),$P(V,U,9))
 W !?7,"DPP4 inhibitors (Januvia, Galvus)",?53,$$C($P(V,U,10)),?65,$$P($P(V,U,2),$P(V,U,10))  ;cmi/maw 12/26/2007 DM2009
 W !?7,"Amylin analogues (Symlin)",?53,$$C($P(V,U,11)),?65,$$P($P(V,U,2),$P(V,U,11))
 W !!?7,"Any Oral med combination",?53,$$C($P(V,U,13)),?65,$$P($P(V,U,2),$P(V,U,13))
 W !?7,"Any Insulin + other med combination",?53,$$C($P(V,U,14)),?65,$$P($P(V,U,2),$P(V,U,14))
 W !!?7,"Unknown/Refused",?53,$$C($P(V,U,12)),?65,$$P($P(V,U,2),$P(V,U,12))
 D ^BDMD91A
 Q
EXIT ;
