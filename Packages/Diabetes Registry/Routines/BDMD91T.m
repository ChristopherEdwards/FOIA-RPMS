BDMD91T ; IHS/CMI/LAB - 2009 DIABETES AUDIT ; [ 02/23/2009 12:39 PM ]
...
TOBACCO(P,BDATE,EDATE) ;EP
 I '$G(P) Q ""
 NEW BDMTOB,BDMSDX,BDMXPND,BDM1320,BDMSCPT,BDMALL,D,%,F
 ...
 I F="SMOKER IN HOME"!(F="SMOKE FREE HOME")!(F["CEREMONIAL")!(F["NON-TOBACCO")!(F["PREVIOUS")!(F["EXPOSURE TO") Q "2  Not a Current User "_$P(BDMALL(D),U,1)_"  "_$P(BDMALL(D),U,2)
