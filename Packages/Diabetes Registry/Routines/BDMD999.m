BDMD999 ; IHS/CMI/LAB - 1999 DIABETES AUDIT ; 21 Jan 2014  10:55 AM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**2,6,7**;JUN 14, 2007;Build 24
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 1999 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMD999",XBNS="",XBRX="XIT^BDMD999"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
BANNER ;EP - banner for 1999 audit menu
 S BDMTEXT="TEXTD",BDM("VERSION")="2.0 (Patch 7)"
