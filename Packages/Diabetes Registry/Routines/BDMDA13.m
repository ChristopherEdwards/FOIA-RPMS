...
FLU(P,BDATE,EDATE,R,F) ;EP
 ...
 .S G=$$REFUSAL^BDMDA17(P,9999999.14,$O(^AUTTIMM("C",A,0)),BDATE,EDATE)
...
PNEU(P,EDATE,R,F) ;EP
 ...
 I R Q ""
 S G=$$REFUSAL^BDMDA17(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:33,1:19),0)),$$FMTE^XLFDT($$FMADD^XLFDT(EDATE,-365)),EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 I '$$BI Q "2  No"
 S G=$$REFUSAL^BDMDA17(P,9999999.14,$O(^AUTTIMM("C",100,0)),$$FMTE^XLFDT($$FMADD^XLFDT(EDATE,-365)),EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
 S G=$$REFUSAL^BDMDA17(P,9999999.14,$O(^AUTTIMM("C",109,0)),$$FMTE^XLFDT($$FMADD^XLFDT(EDATE,-365)),EDATE)
 I G,$P(G,U,2)'="N" Q "3  Refused "_$$FMTE^XLFDT($P(G,U,3))
 I G Q "2  No - Not Medically Indicated "_$$FMTE^XLFDT($P(G,U,3))
...
INCHES ;
 NEW F,FI,Z
 S (X,Z)=$$LASTHT^BDMDA13(BDMPD,BDMRED,"I")
 Q:X=""
 S X=X/12  ;get feet
 S F=$P(X,".")
...
I I BDMHEP=2,BDM10743 Q "1  Yes"  ;2 Hep B + 90743"
 ...
 I $$PLTAX^BDMDA12(P,"BGP HEP EVIDENCE") Q "2  No - Evidence of Hep B"
 ;now go to Refusals
 ...
 S R=$$CPTREFT^BDMDADU(P,$$DOB^AUPNPAT(P),EDATE,$O(^ATXAX("B","BGP HEPATITIS CPTS",0)))
