BDMDA17 ; IHS/CMI/LAB - 2013 DIABETES AUDIT ; 13 Mar 2013  1:52 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**6,7,8**;JUN 14, 2007;Build 53
...
DFE(P,BDATE,EDATE,F,R) ;EP - FOOT EXAM
 ...
 I $G(F)="" S F="E"
 Q $$DFE^BDMDC17(P,BDATE,EDATE,F,$G(R))
...
EYE(P,BDATE,EDATE,F,R) ;EP
 ...
 I $G(EDATE)="" S EDATE=DT
 I $G(F)="" S F="E"
 Q $$EYE^BDMDC17(P,BDATE,EDATE,F,$G(R))
...
DENTAL(P,BDATE,EDATE,F,R) ;EP
 ...
 I $G(EDATE)="" S EDATE=DT
 I $G(F)="" S F="E"
 Q $$DENTAL^BDMDC17(P,BDATE,EDATE,F,$G(R))
