BDMDA1H ; IHS/CMI/LAB - 2013 DIABETES AUDIT ;
...
1 ;
 ...
 .S R=$P(BDM(D,C),U,2)
 .I R["<"!(R[">") S R=$$STV^BDMDA18(R,8) I R]"" S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$FMTE^XLFDT($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_R
 .S R=$$STV^BDMDA18(R,8)
 .I R="" D  Q
 ..S (E,X,J,L)=""
