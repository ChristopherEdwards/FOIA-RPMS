BDMDATS ; IHS/CMI/LAB - DISPLAY IND LISTS ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**6,7**;JUN 14, 2007;Build 24
 ;; ;
...
EN ;EP -- main entry point for 
 D EN^VALM("BDMDA TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2013 DIABETES AUDIT REPORTING"
...
INIT ;EP -- init variables and list array
 ...
 .S Y=$P($G(^DIC($P(^BDMTAXS(BDMYR,11,BDMY,0),U,2),0)),U)
