BDMDBPS ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 28 Jan 2005 1:34 PM ;
...
LAB1 ;
 ...
 Q:BDMDB  ;taxonomy already exists
 W !,"Creating ",BDMX," Taxonomy..."
...
LOINC ;EP
 ...
 ;
LOINC1 ;
 S BDMDB=$O(^ATXAX("B",BDMX,0))
 Q:BDMDB  ;taxonomy already exisits
 W !,"Creating ",BDMX," Taxonomy..."
...
MENU ;EP - add items to menu
 F BDMX="BDM DM2014 AUDIT MENU" D
 .S BDMY="DM08"
