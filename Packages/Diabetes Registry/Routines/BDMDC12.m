BDMDC12 ; IHS/CMI/LAB - 2015 DIABETES AUDIT ;
...
DEPDX(P,BDATE,EDATE) ;EP
 ...
 .;Q:'$$ICD^ATXCHK(I,T,9)
 .S G="1  Yes  Problem List ("_$P($$ICDDX^BDMUTL(I),U,2)_") " ;_$E($P($$ICDDX^BDMUTL(I),U,4),1,25)  ;cmi/anch/maw 9/12/2007 csv
 .Q
 I G]"" Q G
 S (G,X,I)=""
 ...
 .S G="1  Yes  BH Problem List ("_$P($$ICDDX^BDMUTL(I),U,2)_")"  ;cmi/anch/maw 9/12/2007 csv
 .Q
 I G]"" Q G
