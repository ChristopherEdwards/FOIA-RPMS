BDMDC13 ; IHS/CMI/LAB - 2015 DIABETES AUDIT ;
...
FLU(P,BDATE,EDATE,R,F) ;EP
 ...
 .S G=$$REFUSAL^BDMDC17(P,9999999.14,$O(^AUTTIMM("C",A,0)),BDATE,EDATE)
...
INCHES ;
 NEW F,FI,Z
 S (X,Z)=$$LASTHT^BDMDC13(BDMPD,BDMRED,"I")
 Q:X=""
 S X=X/12  ;get feet
 S F=$P(X,".")
...
I I BDMHEP=2,BDM10743 Q "1  Yes"  ;2 Hep B + 90743"
 ...
 I $$PLTAX^BDMDC12(P,"BGP HEP EVIDENCE") Q "4  Immune by DX"
 ;now go to Refusals
 ...
 S R=$$CPTREFT^BDMDCDU(P,$$DOB^AUPNPAT(P),EDATE,$O(^ATXAX("B","BGP HEPATITIS CPTS",0)))
