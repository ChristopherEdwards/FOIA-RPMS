BDMDC1H ; IHS/CMI/LAB - 2015 DIABETES AUDIT ;
...
1 ;
 ...
 .S R=$P(BDM(D,C),U,2)
 .S R=$$STV^BDMDC18(R,8) I R]"" S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$FMTE^XLFDT($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_R
 .;S R=$$STV^BDMDC18(R,8)
 .I R="" D  Q
 ..S (E,X,J,L)=""
 ...
 ...Q:'E
 ...I $P(^AUPNVLAB(X,0),U,4)["<"!($$UP^XLFSTR($P(^AUPNVLAB(X,0),U,4))["LESS") S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$FMTE^XLFDT($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_5
 ...I $P(^AUPNVLAB(X,0),U,4)[">"!($$UP^XLFSTR($P(^AUPNVLAB(X,0),U,4))["GREATER") S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$FMTE^XLFDT($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_999
