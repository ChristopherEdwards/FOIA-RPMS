BDMDC1P ; IHS/CMI/LAB - 2015 DIABETES AUDIT PRINT ;
 ...
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM15",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .S BDMGUIC=1
 .W:$D(IOF) @IOF
 .S BDMPG=BDMPG+1 W:$G(BDMGUI) !! W $$CTR("ASSESSMENT OF DIABETES CARE, 2015       DATE AUDIT RUN: "_$$FMTE^XLFDT(DT)_"  Page: "_BDMPG,80)
 ...
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .S X=$$I(30)
 .W !!,"HEIGHT (last ever): ",$J($P(X," "),2,0)_" "_$P(X," ",2,99)  ;ROUND HT KS 1208
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !?3,$P($$I(103),U),?6,"13 SGLT-2 inhibitor (Invokana, Farxiga)"  ;ihs/cmi/maw 08/03/2013 p7 need logic
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !!,"Immunizations"
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?2,"FLU VACCINE during audit period: ",?35,$$I(64)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?2,"PNEUMOVAX - ever: ",?35,$$I(66)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?2,"A1C: ",?28,$P($$I(78),U,2),?43,$$FMTE^XLFDT($P($$I(78),U,1)),?60,$E($$VAL^XBDIQ1(9000010.09,+$P($$I(78),U,4),.01),1,19)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
...
N1 .W !!,"Local Option question:  ",$$LOCN^BDMDC10(BDMPD,BDMDMRG)
 .W !!,"Extended Local Option question:  ",$$LOCT^BDMDC10(BDMPD,BDMDMRG)
 .W ! ;!!,?10,"*UACR is the preferred test.",!?10,"See Audit 2015 Instructions for more information."
 .I $E(IOST,1,2)'="P-" W !! S DIR(0)="E" D ^DIR K DIR
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMDC14
 I BDMPREP=5 D SDPI^BDMDC1Q
DONE ;
 K ^TMP($J)
 ...
 Q
I(I) ;
 Q $G(^XTMP("BDMDM15",BDMJOB,BDMBTH,"AUDIT",BDMPD,I))
 ;
PAGE ;
 Q:$G(BDMDSP)
 ...
 I $G(BDMGUI) W !!
 S BDMPG=BDMPG+1
 W $$CTR("ASSESSMENT OF DIABETES CARE, 2015         DATE AUDIT RUN: "_$$FMTE^XLFDT(DT)_"  Page: "_BDMPG,80)
