BDMDC1T ; IHS/CMI/LAB - 2015 DIABETES AUDIT ;
...
DX(P,BDATE,EDATE) ;EP
 ...
 .I '$$ICD^BDMUTL(Z,"BGP TOBACCO USER DXS",9) S G="2^2  Not a Current User "_$P(BDMG,U,2)_" "_$P(BDMG,U,3)_" "_$$FMTE^XLFDT($P(BDMG,U,1))_U_$P(BDMG,U,1) Q
 ...
 .I '$$ICD^BDMUTL(Z,"BGP TOBACCO USER DXS",9) S G="2^2  Not a Current User "_$P($$ICDDX^BDMUTL(Y),U,2)_" PROBLEM LIST "_" "_$$FMTE^XLFDT($P(^AUPNPROB(X,0),U,3))_U_$P(^AUPNPROB(X,0),U,3)
...
DENT(P,BDATE,EDATE) ;EP
 ...
 K ^TMP($J,"A")
 I G=0 Q ""
 Q "1^1  Current User ADA 1320 "_$$FMTE^XLFDT($P(G,U,2))_U_$P(G,U,2)
 ;
