BDMDCPS ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 28 Jan 2005 1:34 PM ;
...
LAB1 ;
 ...
 Q:BDMDC  ;taxonomy already exists
 W !,"Creating ",BDMX," Taxonomy..."
...
LOINC ;EP
 ...
 ;
LOINC1 ;
 S BDMDC=$O(^ATXAX("B",BDMX,0))
 Q:BDMDC  ;taxonomy already exisits
 W !,"Creating ",BDMX," Taxonomy..."
...
MENU ;EP - add items to menu
 F BDMX="BDM DM2015 AUDIT MENU" D
 .S BDMY="DM08"
