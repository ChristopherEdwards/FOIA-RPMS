BDMDD1H ; IHS/CMI/LAB - 2016 DIABETES AUDIT ;
...
1 ;
 ...
 .S R=$P(BDM(D,C),U,2)
 .I $E(R)=">" S R=999
 .S R=$$STV^BDMDD18(R,8) I R]"" S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$DATE^BDMS9B1($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_R
 .;S R=$$STV^BDMDD18(R,8)
 .I R="" D  Q
 ..S (E,X,J,L)=""
 ...
 ..I 'G S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$DATE^BDMS9B1($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_R
 .S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$DATE^BDMS9B1($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_R
 Q G
 ;OLD STUFF
 I G]"" Q G
 K BDMACRA
