BDMDD1S ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 03 Feb 2014 5:38 PM ; 
...
BMI ;
 ...
 S H=$G(^XTMP("BDMDM16",BDMJOB,BDMBTH,"AUDIT",BDMPD,30))
 S W=$G(^XTMP("BDMDM16",BDMJOB,BDMBTH,"AUDIT",BDMPD,32))
 S $P(BDMCUML(10,3),U,3)=$P($G(BDMCUML(10,3)),U,3)+1  ;DENOM
 I H]"",W]"" S $P(BDMCUML(10,3),U,2)=$P(BDMCUML(10,3),U,2)+1 ;NUMER
PA ;
 S N=$E($G(^XTMP("BDMDM16",BDMJOB,BDMBTH,"AUDIT",BDMPD,44)))
 S P=$E($G(^XTMP("BDMDM16",BDMJOB,BDMBTH,"AUDIT",BDMPD,46)))
...
CHD ;
 ...
 S C=$G(^XTMP("BDMDM16",BDMJOB,BDMBTH,"AUDIT",BDMPD,28))
...
LDL ;
 ...
 I V="" G N1
 S V=$P(V,U)
 S V=$$STV^BDMDD18(V,5,1) I $E(V)'=+$E(V)!(+V=0) G N1
