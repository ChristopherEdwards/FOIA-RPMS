BDMDDPS ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 28 Jan 2005 1:34 PM ;
...
LAB ;EP
 ...
 Q
LAB1 ;
 S BDMDD=$O(^ATXLAB("B",BDMX,0))
 Q:BDMDD  ;taxonomy already exists
 W !,"Creating ",BDMX," Taxonomy..."
...
LOINC ;EP
 ...
 ;
LOINC1 ;
 S BDMDD=$O(^ATXAX("B",BDMX,0))
 Q:BDMDD  ;taxonomy already exisits
 W !,"Creating ",BDMX," Taxonomy..."
...
MENU ;EP - add items to menu
 F BDMX="BDM DM2016 AUDIT MENU" D
 .S BDMY="DM08"
