BDMDDTV ; IHS/CMI/LAB - DISPLAY IND LISTS ;
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2016 DIABETES/PRE-DIABETES AUDIT REPORTING"
...
DISP ;EP - add an item to the selected list - called from a protocol
 ...
 S XBRP="PRINT^BDMDDTV",XBRC="",XBRX="XIT^BDMDDTV",XBNS="BDM"
 D ^XBDBQUE
 D DISPX
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""PRINT^BDMDDTV"")"
 S XBRC="",XBRX="XIT^BDMDDTV",XBIOP=0 D ^XBDBQUE
 Q
PHDR ;
 I 'BDMPG G HEAD1
