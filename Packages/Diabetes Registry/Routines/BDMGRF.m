...
DEBUG(BDMRET,BDMSTR) ;-- debugger
 ...
 Q
 ;
DMA12(RETVAL,BDMSTR) ;-- dm audit 2012
 N P,R
 ...
 .. Q:$P(BDMPATS,R,I)=""
 .. S ^XTMP("BDMDM12",BDMJ,BDMH,"PATS",$P(BDMPATS,R,I))=""
 .. I BDMCALL="DM Audit P 12" D
 ... S ^XTMP("BDMP12",BDMJ,BDMH,"PATS",$P(BDMPATS,R,I))=""
 I BDMTYP="S" D
 ...
 .. S ^XTMP("BDMDM12",BDMJ,BDMH,"PATS",BDMDA)=""
 .. I BDMCALL="DM Audit P 12" D
 ... S ^XTMP("BDMP12",BDMJ,BDMH,"PATS",BDMDA)=""
 I BDMTYP="C" D
 ...
 .. S ^XTMP("BDMDM12",BDMJ,BDMH,"PATS",BDMRPAT)=""
 .. I BDMCALL="DM Audit P 12" D
 ... S ^XTMP("BDMP12",BDMJ,BDMH,"PATS",BDMRPAT)=""
 I BDMRAND="Y" D
 . N X
 ...
 I BDMCALL="DM Audit 2012" D
 . D BDMG^BDMD41(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMPNA,BDMDZ2,BDMDEMO)
 I BDMCALL="DM Audit P 12" D
 . D BDMG^BDMP41(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMPNA,BDMDZ2,BDMDEMO)
 I BDMCALL="DM Audit E 12" D
 . D BDMG^BDMD41E(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMDZ2,BDMDEMO)
 I $G(BDMDSP) S BDMIEN=1 D NOWDMO12 Q
 I '$G(BDMIEN) S BDMERR="Error Queueing DM Audit"
 I '$G(BDMDSP) S ^BDMTMP($J,2)=$C(31)_$G(BDMERR)
 D EN^XBVK("BDM")
 Q
 ;
DMA12P(BDMRET,BDMSTR) ;-- dm audit 2012
 N P,R
 N BDMRG,BDMDAT,BDMTYP,BDMSTMP,BDMPCP,BDMLCOM,BDMRAND,BDMRCNT,BDMDSP,BDMPNA
 N BDMCMS,BDMRGI,BDMSTAT,BDMPREP,BDMFILE,BDMPATS,BDMSTMPE,BDMCMSE,BDMH,BDMJ
 N BDMDZ2,BDMDEMO
 ...
 Q
 ;
NOWDMO12 ;EP - return the output to the screen
 N BDMI,BDMDA
 S BDMI=0
 S ^BDMTMP($J,BDMI)="T00250DATA"_$C(30)
 S BDMDA=0 F  S BDMDA=$O(^TMP($J,"BDMDM12",BDMDA)) Q:'BDMDA  D
 . S BDMI=BDMI+1
 . S ^BDMTMP($J,BDMI)=$G(^TMP($J,"BDMDM12",BDMDA))_$C(30)
