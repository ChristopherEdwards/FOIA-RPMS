BDMP711 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^BDMP712(BDMPD,BDMRED,"I")
 I V]"" D
...
CESS(P,B,D) ;EP - find any cessation hf in 12 months before E
 ...
 I 'T Q "No"
 S (X,G)=0 F  S X=$O(^ATXAX(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^BDMP717(P,9999999.09,$P(^ATXAX(T,21,X,0),U),B,D) S G=1
 I G Q "Refused"
 Q "No"
 ;
