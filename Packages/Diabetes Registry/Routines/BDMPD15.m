BDMPD15 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
CUML ;EP
 ...
 ;
PROCESS ;
 S BDMPD=0 F  S BDMPD=$O(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD  D CUML1
 Q
 ;
CUML1 ;
GENDER ;
 ...
 S V=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,20))
...
BMI ;
 ...
 S V=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,112))
...
TOBACCO ;
 ...
 S V=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,27))
 S V1=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,28))
...
DMTX ;diabetes treatment
 ...
 S V=$$THERAPY^BDMPD16(BDMPD,BDM6MBD,BDMRED)
...
ASPIRIN ;
 ...
 S V=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,62))
...
ACE ;110 title^total pts^total pts with protein^# of those on ace^# with htn^# of those on ace"
 ...
 ;S P=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,94))
 S H=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,34))
 S A=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,60))
...
LIPID ;115
 S V=$G(^XTMP("BDMPD1",BDMJOB,BDMBTH,"AUDIT",BDMPD,61))
...
SYSMEAN(P,BDATE,EDATE) ;EP
 NEW X S X=$$BPS^BDMDD13(P,BDATE,EDATE,"I")
 I X="" Q ""
