...
APCLEXAM ;EP;LAST EXAM
 ...
 .S Z=$$DFE^BDMDB17(DFN,"","","D",1)
 I BDMFU="EYE" D
 .S BDM("FOLLOW-UP TYPE")="EYE EXAM"
 .S Z=$P($$EYE^BDMDB17(DFN,"","","D",1),U,1)
 I BDMFU="DENT" D
 .S BDM("FOLLOW-UP TYPE")="DENTAL EXAM"
 .S Z=$$DENTAL^BDMDB17(DFN,"","","D",1)
 I BDMFU="DEP" D
 .S BDM("FOLLOW-UP TYPE")="DEPRESSION SCR"
 .S Z=$$DEPSCR^BDMDB12(DFN,"","","D",1)
 ;I BDMFU="EKG" D
 ;.S BDM("FOLLOW-UP TYPE")="EKG"
 ;.S Z=$$EKG^BDMDB12(DFN,DT,"D")
...
FLUC ;EP
 ...
 S Z=$$FLU^BDMDB13(DFN,$$DOB^AUPNPAT(DFN),DT,1,"D")
 I Z="" D FUNO^BDMVRL4 Q
 S Z=9999999-Z
 K X2
 D FULAST^BDMVRL4
