...
Q2	W !!,"O:  Current Diet: " G:WARD="" Q21 I $D(^FHPT(DFN,"A",ADM,0)) D CUR^FHORD7 W Y
	S X=$P($G(^DGPM(ADM,0)),"^",10) W !?4,"Adm. Dx: ",$E(X,1,27)
	S DTP=$P($G(^DGPM(ADM,0)),"^",1) D DTP^FH W ?41,"Adm. Date:   ",?59,DTP
Q21	W !?4,"Age: ",AGE,?18,"Sex: ",SEX,?41,"Prior Assessment:" S ASN=$O(^FHPT(DFN,"N",0)) I ASN>0 S DTP=9999999-ASN D DTP^FH W ?59,DTP
	S Y=$S(ASN>0:^FHPT(DFN,"N",ASN,0),1:"")
