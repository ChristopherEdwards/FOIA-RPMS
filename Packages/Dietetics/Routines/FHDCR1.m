FHDCR1	; HISC/REL/NCA - Diet Cards ;4/21/95  10:10
...
P0	S ALL=0 D ^FHDPA G:'DFN KIL S (FHP,W1)="",UPD=0,SORT="R" G F1
...
L0	W ! K IOP,%ZIS S %ZIS("A")="Select LIST Printer: ",%ZIS="MQ" D ^%ZIS K %ZIS,IOP G:POP KIL
	I $D(IO("Q")) S FHPGM="B1^FHDCR1A",FHLST="D1^MEAL^FHX1^FHP^FLG^W1^DFN^UPD^TPP^SORT" D EN2^FH G KIL
