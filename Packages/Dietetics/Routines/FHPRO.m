FHPRO	; HISC/REL - Food Production Manager ;3/8/95  13:28
	;;5.0;Dietetics;;Oct 11, 1995
EN2	; Enter/Edit Dietetics Wards
	K DIC S (DIC,DIE)="^FH(119.6,",DIC(0)="AEQLM",DLAYGO=119.6
	S DIC("DR")=".01" W ! D ^DIC K DIC,DLAYGO G KIL:U[X!$D(DTOUT),EN2:Y<1
	S DA=+Y,DR=".01:3;S:X="""" Y=4;3.5;4;S:X="""" Y=5;4.5;5;S:'X Y=6;5.5;6:99" S:$D(^XUSEC("FHMGR",DUZ)) DIDEL=119.6 D ^DIE,KIL G EN2
