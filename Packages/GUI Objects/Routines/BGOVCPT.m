BGOVCPT ; IHS/BAO/TMD - Manage V CPT ;16-Mar-2012 11:21;DU
 ;;1.1;BGO COMPONENTS;**1,3,4,5,6,8,9,11**;Mar 20, 2007;Build 3
 ;---------------------------------------------
TIUSTR() ;EP
 N X,Y
...
CPTBLD D INIT("CPT")
 ...
 I TYP="SURGICAL",'$$ICD^ATXCHK(CODE,TAX,1) Q  ;Not a CPT on this component
