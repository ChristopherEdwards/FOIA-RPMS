BGOVIMM ;IHS/BAO/TMD - IMMUNIZATION mgt   ;24-Jul-2013 11:30;DU
 ;;1.1;BGO COMPONENTS;**1,3,4,5,6,9,10,11,12**;Mar 20, 2007;Build 5
...
IMMICD(TYPE,VIEN,ACTV) ;EP
 ...
 .I $$AICD^BGOUTL2 D
 ..S ICDIEN=$P($$ICDDX^ICDEX(ICD,$$NOW^XLFDT),U,1)
 .E  D
...
ADDICD(ICDIEN,VIEN,DFN,PRV) ;EP
 ...
 I $$AICD^BGOUTL2 S ICDNAME=$$ICDDX^ICDEX(+ICDIEN,$$NOW^XLFDT)
