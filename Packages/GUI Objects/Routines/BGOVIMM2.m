BGOVIMM2 ;IHS/BAO/TMD  BGO - IMMUNIZATION mgt;03-Jan-2012 13:19;PLS
 ;;1.1;BGO COMPONENTS;**1,3,4,6,10**;Mar 20, 2007;Build 2
 ;---------------------------------------------
 ; Get case data
GETCASE(RET,DFN) ;EP
 K RET
...
SETCONT(RET,INP) ;EP
 N DATE,REFDT,DFN,VACP,RSN,FDA,NEW,IEN,IENX,X
 S DFN=+INP
...
ADDCPT(CPT,ICD,VIEN,DFN,PRV,SITE,DATE,CNSL) ;EP
 ...
 S CPT2=$$ADMINCPT^BGOVIMM(VIEN,CPT,SITE),CPT3=$$SYRCPT(SITE),RET=0
