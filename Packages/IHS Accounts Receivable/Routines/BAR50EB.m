...
NEGBAL(IMPDA,TYPE) ;EP - CHECK FOR NEGATIVE BALANCE W/IN ERA AND IF POSTED AGAINST RPMS
 ...
 ..;
 ..S BARADJ=0
 .. I $$DONOTPR(IMPDA,CLMDA) Q  ;new code - BAR 1.8*24
 .. ;REPLACES OLD CODE
 ...
 ...S BARCATN=$$GET1^DIQ(90056.0208,ADJDA_","_CLMDA_","_IMPDA_",",.04,"I") ;HEAT151948 - BAR 1.8*24
 ...
 ...I '$$IHSNEGB^BARUFUT(DUZ(2)) Q  ;HEAT147572 - BAR 1.8*24
 ...S ERRORS("NEGR")=""
 ..I $D(ERRORS) D
 ...S TCLMDA=""
...
GETITMTO(ERACHECK,ERATOTAL,ERRORS,BRP02) ;EP - GIVEN ERACHECK GET BATCH ITEM TOTALS FOR ERA CHECK ;BAR*1.8*6 SCR119 IHS/SD/TPF
 ...
 . ;DONT SHOW THIS MSG: 10/10/2013 
 . ;;;. S BARMSG="IGNORING COLL. BATCH "_BARCB_" EIN# "_BARCOLDA_" TOO OLD: ("_X_")"
 . ;;;. I $G(BARDBG) W !,BARMSG
 . ;
 . I $G(BARDBG) W !,?2,"CHECKING BATCH: ",BARCB ;SHOW ONLY 'NEW' CB BAR 1.8*23
