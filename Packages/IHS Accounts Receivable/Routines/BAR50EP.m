BAR50EP ; IHS/SD/TPF - AR ERA PAYMENT CHECKER ; 01/30/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**5,6,10,20,21,23**;OCT 26,2005
 ;BAR*1.8*6 IHS/SD/TPF MOVE REVERSAL CHECK TO A FULL CLMDA LOOP
 ;NOV 2012 P.OTTIS HEAT#82698 LEADING ZEROES IN CHKECK # (POS)
REVLOOP(IMPDA) ;EP - REVERSAL LOOP
 ...
 . ;;;I REVERSAL,$$IHSERA^BARUFUT(DUZ(2)),(+$P($G(^BAREDI("I",DUZ(2),IMPDA,30,CLMDA,0)),U,4)<0) D REVCHECK(IMPDA,CLMDA)  ;CHECK FOR PAYMENT AND REVERSALS W/IN ERA FILE
 Q
...
INRPMS(IMPDA,REVDA,MATCHES,NOMATCH) ;EP - LOOK FOR MATCHING PAYMENT IN A/R BILL
 ...
 .. I '$D(^BARCOL(DUZ(2),"D",REVCHECK,COLDA,ITEMDA)),'$D(^BARCOL(DUZ(2),"D",+REVCHECK,COLDA,ITEMDA)) Q  ;P.OTT
