BAR50IT ; IHS/SD/LSL - CREATE ENTRY IN A/R EDI TRANSPORT FILE (1) ; 
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**21**;OCT 26, 2005
 ;
 ; THE 50IT RTNS ARE NOT REALLY IN USE FOR CREATING A TRANSPORT ENTRY
 ; IHS/SD/tpf - 08/01/2011 - V1.8 Patch 21
...
START ; EP
 ...
 . D XIT
 . Q
 D SEGMENT^BAR50IT2        ; Create Segment Table (and element)
