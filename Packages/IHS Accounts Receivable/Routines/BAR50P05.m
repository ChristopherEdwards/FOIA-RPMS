BAR50P05 ; IHS/SD/LSL - REVIEW CLAIM STATUS ;
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,4,5,6,20,21,23**;OCT 26,2005
 ;
...
AUTOREV ;EP - AUTO REVIEW ;BAR*1.8*6 SCR120 ADD LIST MANAGER PROMPT FOR AUTO-REVIEW
 ...
 ;;;D:$$IHSERA^BARUFUT(DUZ(2)) NEGBAL^BAR50EB(IMPDA,"ERA")  ;CHECK FOR NEGATIVE BALANCE IN RPMS BILLS
 ;;;D:$$IHSERA^BARUFUT(DUZ(2)) NONPAYCH^BAR50EP1(IMPDA)  ;CHECK FOR PAYMENTS NOT MATCHED TO A REVERSAL TO SEE IF THEY ARE BEING POSTED TO A 'NONPAYMENT' BATCH ;BAR*1.8*6 SAC RTN TOO BIG
 D GATHER(IMPDA)
 Q
VIEW ;EP
 S VALMLST=""
