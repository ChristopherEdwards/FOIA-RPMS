BAR50P05 ; IHS/SD/LSL - REVIEW CLAIM STATUS ;
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,4,5,6,20,21,24**;OCT 26,2005;Build 69
 ;
 ; IHS/SD/LSL - V1.7 Patch 4 - HIPAA
 ;
 ; IHS/SD/LSL - 02/26/04 - V1.7 Patch 5 Changed check to chk/eft
 ;
 ; IHS/SD/POT  HEAT147572 P.OTT ALLOW TRIBAL SITES ERA POSTING OF NEG BAL & CANCELLED BILLS 1/15/2014 & 2/5/2014- BAR 1.8*24
 ;
 D CLEAR^VALM1
 ;
EN ; EP
...
AUTOREV ;EP - AUTO REVIEW ;BAR*1.8*6 SCR120 ADD LIST MANAGER PROMPT FOR AUTO-REVIEW
 ...
 ;;old code D:$$IHS^BARUFUT(DUZ(2)) NEGBAL^BAR50EB(IMPDA,"ERA")  ;CHECK FOR NEGATIVE BALANCE IN RPMS BILLS - BAR 1.8*24
 ...
 D:$$IHSNEGB^BARUFUT(DUZ(2)) NONPAYCH^BAR50EP1(IMPDA)  ;CHECK FOR PAYMENTS NOT MATCHED TO A REVERSAL TO SEE IF THEY ARE BEING POSTED TO A 'NONPAYMENT' BATCH ;HEAT147572 - BAR 1.8*24
 D GATHER(IMPDA)
 Q
VIEW ;EP
 S VALMLST=""
