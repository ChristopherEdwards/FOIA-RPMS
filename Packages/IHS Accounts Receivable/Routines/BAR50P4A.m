BAR50P4A ; IHS/SD/SDR - MATCH REASONS AND CLAIMS - 2 ; 01/09/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**20,21,23**;OCT 26, 2005
 ;CLM/CLM2 split BARFROM BAREDP04 due to size
 ;P.OTTIS HEAT#82698  NOV 2012,JAN 2013 LEADING/MISSING ZEROES IN BILL #
 ;P.OTTIS BETA TEST SEP 2013 YAK: SWAPPED CHK001 AND CHK002 (FIXED POS CLAIMS)
 ;P.OTTIS 12/2/2012 RECORD ONLY UNMATCHED ITEMS (deactivated ->p24)
PAYER ;EP
...
CLM3(BARFROM,BARBIEN,IMPDA,CLMDA,BARMMTYP) ;
 ...
 ; ---- NOT MATCHED - OTHER REASON FALL THRU 
 Q 0
BLHDR I $G(BARDBG) D  ;P.OTT 12/2/2013
 . D NOMATCH^BAR50DET
