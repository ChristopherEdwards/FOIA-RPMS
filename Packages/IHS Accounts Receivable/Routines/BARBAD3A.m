BARBAD3A ; IHS/SD/LSL - PAYMENT COMMAND CNT. ; 05/07/2008
 ...
 Q
 ;
SETTMP(BARTYP,BARAMT,BARLIN,BARCAT,BARATYP,BAROAMT,BARCOM1) ;EP - store & check amounts;
...
B1 ;
 ...
 .D CKNEG^BARBAD4(BARBBAL,BAROAMT,BARAMT)      ;CHECK FOR NEGATIVE BALANCES
 Q:BARSTOP
 ...
 S BARJ=BARJ+1
 S BARTR(BARLIN,BARJ)=BARTYP_U_BARAMT_U_BARCAT_U_$G(BARATYP)_U_BARCOM1_U_BARCAM
 K BAROAMT,BARBBAL
 Q
 ; *********************************************************************
HELP ;
 ...
 D EOP^BARUTL(1)
 D HIT1^BARBAD2(BARPASS),EOP^BARUTL(2)
 Q
 ;
 ; *********************************************************************
