BARDMRE ;IHS/OIT/FCJ - DEBT MANAGEMENT-ERROR REPORT ; 11 Jul 2012  1:34 PM
 ...
 ;SEP 2012 P.OTTIS IGNORE DUPLICATE BILL / NONEX CLAIM # (SAME LOGIC AS IN BARDMLP)
 ;MAY 2013 FIXED COUNT OF 'L'ETTERS (LINE 64)
 ;         FIXED <READ> ERRORS: MAKE CALL OF ^DIR CONDITIONAL
 ;MAY 2013 CHK / SET STATUS 'PAID'
