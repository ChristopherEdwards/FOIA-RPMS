BARDYSV1 ; IHS/SD/TPF - DAYS IN A/R REPORT CALLS ; 06 Feb 2012  10:04 AM
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,16,22,23**;OCT 26, 2005
 ;P.OTT FEB 2013 CHANGED PTR TO INSURER TYPE
 ;P.OTT APR 2013 RESOLVED NIL VALUES OF INSTYP AND ACTINS 
 Q
...
TPBDAYS(VISITIEN,VSITADMT) ;EP -TOTAL DAYS FOR BILL
 ...
 . . ;W $$GET1^DIQ(9002274.4,BILLIEN_",",.08,"I")-->441
 . . ;W $$GET1^DIQ(9002274.4,BILLIEN_",",.08,"E")-->NORTH DAKOTA MEDICAID
 . ;WAS: S ACTINS=$$GET1^DIQ(9002274.4,BILLIEN_",",.17,"I")
 . S ACTINS=$$GET1^DIQ(9002274.4,BILLIEN_",",.08,"I")
 . I ACTINS="" D  Q
 . . W !,"3PB BILLIEN ",BILLIEN,"  MISSING POINTER TO INSURER FILE 9999999.18 (^AUTNINS) - VARIABLE ACTINS : ",ACTINS ;R ASD
 . . Q  ;
 . ;S INSTYP=$$GET1^DIQ(9999999.18,ACTINS_",",.21,"I") ;W !,"BILLIEN=",BILLIEN," INSTYP.21=",INSTYP
 . S INSTYP=$$GET1^DIQ(9999999.18,ACTINS_",",.211,"I") ;W " INSTYP.211=",INSTYP
 . S INSTYP=$P($G(^AUTTINTY(INSTYP,0)),U,2) ; W " INSTYP3=",INSTYP R ASD ;NUMBER-->"INDIAN PATIENT^I" P.OTT
 . I INSTYP="" D  Q
 . . W !,"INSTYP IS MISSING FOR BILLIEN ",BILLIEN,"  ACTINS: ",ACTINS ;R ASD
 . . Q  ;
