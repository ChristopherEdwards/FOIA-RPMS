BAREDEP1 ; IHS/SD/TPF - AR ERA NONPAYMENT CHECKER ; 01/30/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**5,6,10,22**;OCT 26,2005;Build 38
 Q
...
NONPAY(ERACHECK,IMPDA,CLMDA,BPR02) ;EP - SEE IF TDN/IPAC = NONPAYMENT  ;BAR*1.8*6 SCR119 IHS/SD/TPF
 ...
 .;I TDNIPAC="NONPAYMENT" S ERRORS("P NP")="" Q  ;bar*1.8*22 HEAT62479
 .I TDNIPAC="NONPAYMENT",(CLMPYMT'=0) S ERRORS("P NP")="" Q  ;bar*1.8*22 HEAT62479
 .S BARITMDA=""
 ...
 ..;I TDNIPAC="NONPAYMENT" S ERRORS("P NP")=""  ;bar*1.8*22 SDR
 ..I TDNIPAC="NONPAYMENT",(CLMPYMT'=0) S ERRORS("P NP")=""  ;bar*1.8*22 SDR
