BAREDP04 ; IHS/SD/LSL - MATCH REASONS AND CLAIMS ; 01/09/2009
 ...
 ;P.OTTIS APR 2012 HEAT#62015 BUG FIX: DO NOT CALL ^%DT IF DOS=""
 ;P.OTTIS HEAT#82698  NOV 2012 LEADING ZEROES IN BILL #
 Q
...
INDEX    ;EP
 ...
 D:$$IHS^BARUFUT(DUZ(2)) NEGBAL^BAREDEB(IMPDA,"ERA")  ;CHK FOR NEG BAL IN RPMS BILLS
 ;;;D:$$IHSERA^BARUFUT(DUZ(2)) NEGBAL^BAREDEB(IMPDA,"ERA")  ;CHK FOR NEG BAL IN RPMS BILLS
 ...
 D:$$IHS^BARUFUT(DUZ(2)) NONPAYCH^BAREDEP1(IMPDA)  ;CHK FOR PYMTS NOT MATCHED TO REV TO SEE IF BEING POSTED TO 'NONPYMT' BATCH
 ;;;D:$$IHSERA^BARUFUT(DUZ(2)) NONPAYCH^BAREDEP1(IMPDA)  ;CHK FOR PYMTS NOT MATCHED TO REV TO SEE IF BEING POSTED TO 'NONPYMT' BATCH
 K ERRORS
 Q
 ;-------------- 
CLMFLG(CLMDA,ERRORS) ;
 ...
 I $$OVERIDE^BAREDEP1(CLMDA) D  Q   ;MRS:BAR*1.8*10 D159-1 & 2
  . I $G(BARDBG) D INS^BAR50DET(" OVERRIDE - SKIPP",1)
...
HIPAACLM(IMPDA,CLMDA,ERRORS) ;BAR*1.8*5 SRS-80 TPF ERRORS CAN BE MULTIPLE
 ...
 S (BARBIEN,BARBILL)=$$GETBBILL(BARTEST) ;P.OTT
 I BARBILL="" D  Q
 . S CLMTYP="CF"
 ...
 I $G(BARDBG) ;I BARMMFLG=1 D INS^BAR50DET(" PARTIAL MATCH FOUND FOR BILL "_BARBILL_": DOS "_BARMMVAL,1) D NOMATCH^BAR50DET ;INDICATE NOT MATCH
 	I $G(BARDBG) ;I BARMMFLG=2 D INS^BAR50DET(" PARTIAL MATCH FOUND FOR BILL "_BARBILL_": AMOUNT "_BARMMVAL,1) D NOMATCH^BAR50DET ;INDICATE NOT MATCH
 I BARFND=0 D
...
CLM2     ;
 ...
 ;Match DOS
 S (BARRADT,X)=$$GET1^DIQ(90056.0205,BAREIENS,.08) ;P.OTT
