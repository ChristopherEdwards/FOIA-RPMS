BAREDP08 ; IHS/SD/LSL - POST HIPAA CLAIMS ; 12/01/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,4,5,6,10,19,20,23**;OCT 26,2005
 Q
...
POSTEM ; LOOP Claims with this chk
 ...
 ..;;;I $$IHSERA^BARUFUT(DUZ(2)) S BARCHK=BARCHECK D NEGBAL^BAREDEB(IMPDA,"ERA")  ;bar*1.8*20
 ..D:$$IHS^BARUFUT(DUZ(2)) NONPAYCH^BAREDEP1(IMPDA)  ;bar*1.8*20
 ..;;;D:$$IHSERA^BARUFUT(DUZ(2)) NONPAYCH^BAREDEP1(IMPDA)  ;bar*1.8*20
