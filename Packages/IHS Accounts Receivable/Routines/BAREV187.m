BAREV187 ; IHS/SD/LSL - ENVIRONMENT CHECK V1.8 PATCH 7; 09/17/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**7**;APR 27,2007
 ;NEW ROUTINE BAR*1.8*7
 ;
 I '$G(DUZ) D  Q
 ...
 I $P(BARXU,"*",3)'=1011 S BARXU=0        ;RLT
 ...
 . Q
 ;
P7 ;DATA REMOVED FROM FILES TO PREVENT OVERRIDES
 ;A/R IS NO LONGER CUMULATIVE AFTER PATCH 6
 ;ALL SITES MUST HAVE AT LEAST PATCH 6
 N BAR
 S BAR=$$INSTALLD("BAR","1.8",6)
 I $P(BAR,"*",3)'=6 S BAR=0 D
 .W !,$$CJ^XLFSTR("Need Accounts Receivable v1.8 Patch 6..... "_$S(BAR=0:"NOT ",1:"")_"Present",IOM)
 I BAR=0 D SORRY(2)
 ;
 I $G(XPDQUIT) W !,$$CJ^XLFSTR("FIX IT! Before Proceeding.",IOM),!!,*7,*7,*7 Q
 ;
 W !!,$$CJ^XLFSTR("ENVIRONMENT OK.",IOM)
 D HELP^XBHELP("INTROE","BAREV187")
 ;
 I $G(XPDENV)=1 D
 . ; The following line prevents the "Disable Options..." and "Move
 . ; Routines..." questions from being asked during the install.
 . S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 . D HELP^XBHELP("INTROI","BAREV187")
 . Q
 ;
