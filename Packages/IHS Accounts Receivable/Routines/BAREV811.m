BAREV811 ; IHS/SD/LSL - ENVIRONMENT CHECK V1.8 PATCH 11; 03/18/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**11**;APR 27,2007
 ;NEW ROUTINE BAR*1.8*11
 ;
 ...
 N BAR,I
 F I=6:1:7,9,10 D                           ;BAR*1.8*8 WAS REPLACED WITH BAR*1.8*9
