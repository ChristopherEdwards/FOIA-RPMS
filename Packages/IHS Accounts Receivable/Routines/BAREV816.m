BAREV816 ; IHS/SD/LSL - ENVIRONMENT CHECK V1.8 PATCH 16; 01/29/2010
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**16**;JAN 29,2010
 ;
 ...
 N BAR,I
 F I=6:1:7,9,10,11,12,13,14,15 D           ;NOTE: BAR*1.8*8 WAS REPLACED WITH BAR*1.8*9
...
POST ;EP - POST INSTALL
 S ZTRTN="INSTALL^BARDYSV4"        ;BAR*1.8*15 auto create 12 month OMB file when patch installed
 D NOW^%DTC
 S BARTMP1=+%H
 S BARTMP2=$P(%H,",",2)+60         ;run in 5 minutes
 ;S BARTMP2=72000                  ;run off hours 8pm
 S ZTDTH=BARTMP1_","_BARTMP2
 S ZTDESC="OMB REPORT - YEAR "_%               ;ZTDTH
 S ZTIO=""
 S ZTPRI=5
 K ZTSK
 D ^%ZTLOAD
