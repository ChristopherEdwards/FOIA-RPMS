BAREV817 ; IHS/SD/TMM - ENVIRONMENT CHECK V1.8 PATCH 17; 12/22/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**17**;DEC 22,2009
 ;
 ...
 N BAR,I,BARQ
 ; F I=6:1:7,9,10,11,12,13,14,15,16,17 D  ;BAR*1.8*8 WAS REPLACED WITH BAR*1.8*9
 F I=6,7,9,10,12,13,14,15,16 D  ; Patch 11 was dropped, don't check  BAR*1.8.17
 .S BAR=$$INSTALLD("BAR","1.8",I)
 . ; I $P(BAR,"*",3)'=I S BAR=0 D  ; BAR*1.8*17 - BAR variable getting stepped on
 .I $P(BAR,"*",3)'=I S (BAR,BARQ)=0 D
 ..W !,$$CJ^XLFSTR("Need Accounts Receivable v1.8 Patch "_I_"..... "_$S(BAR=0:"NOT ",1:"")_"Present",IOM)
 ;I BAR=0 D SORRY(2)
 I $G(BARQ)=0 D SORRY(2)
 ;
