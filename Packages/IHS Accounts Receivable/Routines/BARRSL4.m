BARRSL4 ; IHS/SD/LSL - Selective Report Parameters-PART 2 ; 12/19/2008
 ...
 ; DEC 2012 P.OTTIS ADDED SELECTION OF CODING DX VERSION ICD-9 / ICD-10
 ; MAR 2013 P.OTTIS ADDED NEW VA billing
 ; JUN 2013 P.OTTIS - MOD FOR ICD9/10 DX
 ; JUL 2013 P.OTTIS - BLOCK DX SELECTION OF ICD10 WHEN INFRASTRUCTURE NOT PRESENT
 ;*******************************************************************************
 Q
TRANTYP ; EP
