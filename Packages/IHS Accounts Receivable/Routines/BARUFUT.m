BARUFUT ; IHS/SD/TPF - UTILITIES FOR UFMS ; 09/19/2007
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,6,7,13,21**;OCT 26, 2005
 Q
 ;
NOTLOGIN() ;EP - DISPLAY NOT LOGGED IN MESSAGE
 ...
 ;Q:$G(UFMSESID)'="" 0  ;bar*1.8*21 SDR
 Q:($$CURSTAT(DUZ,+$G(UFMSESID),"E")="OPEN") 0  ;bar*1.8*21 SDR
 W !!,"* * YOU MUST SIGN IN TO BE ABLE TO PERFORM POSTING/COLLECTION FUNCTIONS! * *"
 D ASKFORRT
 ;BAR*1.8*21 BEGIN NEW CODE HEAT43337
 ;CASHIER HAS NOT LOGGED IN TO GET ASSIGNED SESSION ID
 ;I $G(UFMSESID)="" D  Q 1
 ;.W !!,"* * YOU MUST SIGN IN TO BE ABLE TO PERFORM POSTING/COLLECTION FUNCTIONS! * *"
 ;.S CURDUZ2=DUZ(2)
 ;;
 ;;CASHIER HAS AN ASSIGNED SESSION ID. THE SESSION IS STILL OPEN AND
 ;;THEY HAVEN'T CHANGED DUZ(2)
 ;I (CURDUZ2=DUZ(2)),$D(^BARSESS(DUZ(2),"C","OPEN",DUZ,UFMSESID)) S CURDUZ2=DUZ(2) Q 0
 ;;
 ;;CASHIER HAS AN ASSIGNED SESSION ID. SESSION ID IS NOT CURRENTLY OPEN
 ;;AND DUZ(2) HAS NOT CHANGED
 ;I (CURDUZ2=DUZ(2)),'$D(^BARSESS(DUZ(2),"C","OPEN",DUZ,UFMSESID)) D  Q 1
 ;.S CURDUZ2=DUZ(2)
 ;.K UFMSESID
 ;.W !!,"YOUR SESSION HAS BEEN CLOSED"
 ;.W !!,"* * YOU MUST SIGN IN TO BE ABLE TO PERFORM POSTING/COLLECTION FUNCTIONS! * *"
 ;;CASHIER HAS AN ASSIGNED SESSION ID. CASHIER DOES NOT HAVE A SESSION IN OPEN STATUS
 ;;FOR THIS DUZ(2). HAS CHANGED DUZ(2)
 ;I (CURDUZ2'=DUZ(2)),'$D(^BARSESS(DUZ(2),"C","OPEN",DUZ,UFMSESID)) D  Q 1
 ;.S CURDUZ2=DUZ(2)
 ;.K UFMSESID
 ;.W !!,"* *         IT APPEARS YOU HAVE CHANGED YOUR FACILITY * *"
 ;.W !,"* * YOU DO NOT HAVE AN OPEN SESSION UNDER DIVISION ",$P(^DIC(4,DUZ(2),0),U)
 ;.W !,"     YOU MUST SIGN IN UNDER ",$P(^DIC(4,DUZ(2),0),U)," TO BE ABLE"
 ;.W !,"     TO PERFORM POSTING/COLLECTION FUNCTIONS UNDER THIS FACILITY! * *"
 ;;
 ;;CASHIER HAS AN ASSIGNED SESSION ID. THE SESSION IS CURRENTLY OPEN
 ;;FOR THIS DUZ(2). AND THE USER HAS CHANGED DUZ(2)
 ;I (CURDUZ2'=DUZ(2)),$D(^BARSESS(DUZ(2),"C","OPEN",DUZ,UFMSESID)) D  Q 0
 ;.S CURDUZ2=DUZ(2)
 ;.W !!,"* * YOU DO HAVE A OPEN SESSION UNDER DIVISION ",$P(^DIC(4,DUZ(2),0),U)
 ;.;W !,"  YOU MUST SIGN IN UNDER ",$P(^DIC(4,DUZ(2),0),U)," TO BE ABLE"
 ;.;W !,"  TO PERFORM POSTING/COLLECTION FUNCTIONS UNDER THIS FACILITY! * *"
 ;W !!,"* * YOU MUST SIGN IN TO BE ABLE TO PERFORM POSTING/COLLECTION FUNCTIONS! * *"
 ;S CURDUZ2=DUZ(2)
