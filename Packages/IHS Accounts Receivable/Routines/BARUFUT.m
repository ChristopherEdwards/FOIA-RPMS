BARUFUT ; IHS/SD/TPF - UTILITIES FOR UFMS ; 09/19/2007
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,6,7,13,21,22,23**;OCT 26, 2005;Build 38
...
IHS(DUZ2) ;EP - RETURN TRUE IF IHS AFFILIATION
 ...
 ;
IHSERA(DUZ2) ;EP - RETURN TRUE IF:
 ; (1) AFFILIATION=IHS
 ; (2) AFFILIATION'=IHS AND FLAG (DO NOT MANUALLY POST NEG BAL) = "Y"
 ;FLAG: Restrict MANUAL posting of negative balances (Y,N)
 ;Y - will follow Fed rules
 I $$IHS(DUZ2) Q 1 ;FED
 Q $P($G(^BAR(90052.06,DUZ(2),DUZ(2),20)),U,3)="Y" ;P.OTT 46251 ;#1400
 ;
IHSERA2(DUZ2) ;EP - RETURN TRUE IF:
 ; (1) AFFILIATION=IHS
 ; (2) AFFILIATION'=IHS AND FLAG (DO NOT ERA POST NEG BALANCES) = "Y"
 ;FLAG: Restrict ERA posting of negative balances (Y,N)
 ;Y - will follow Fed rules
 I $$IHS(DUZ2) Q 1 ;FED
 Q $P($G(^BAR(90052.06,DUZ(2),DUZ(2),2)),U,5)="Y" ;P.OTT ;#1402
 ;
IHSERA3(DUZ2) ;EP - RETURN TRUE IF:
 ; (1) AFFILIATION=IHS
 ; (2) AFFILIATION'=IHS AND FLAG ("DO NOT ERA POST CLAIMS CANCELLED IN 3P) = "Y"
 ;FLAG: Restrict ERA posting of CLAIMS cancelled in 3PB (Y,N)
 ;Y - will follow Fed rules
 I $$IHS(DUZ2) Q 1 ;FED
 Q $P($G(^BAR(90052.06,DUZ(2),DUZ(2),20)),U,5)="Y" ;P.OTT ;#1403
 ;
