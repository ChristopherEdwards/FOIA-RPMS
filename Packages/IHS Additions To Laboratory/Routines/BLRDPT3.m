BLRDPT3 ; IHS/DIR/FJE - PATIENT VARIABLES ;
 ;;5.2;BLR;;NOV 01, 1997
 ;
 ;;MAS VERSION 5.0;
...
6 ;
 ...
 ;
GO S:'$D(VAX("DT")) VAX("DT")=NOW D ^BLRDPT31 ; setting of VAX("DT") can be removed??
 ;
Q K NOW,NOWI,VAX,VAZ,VAZ2,E,VACC,VAQ,VANN,VASET,^UTILITY("BLRDPTZ",$J,DFN) D KVAR^BLRDPT30 Q
 ;
OK S E=0,VAZ2="^"_(+$P(VAZ,"^",18))_"^"
