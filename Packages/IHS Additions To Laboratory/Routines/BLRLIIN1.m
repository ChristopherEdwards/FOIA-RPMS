BLRLIIN1 ;cmi/anch/maw - Process Incoming UI Msgs, continued 12/3/1997 ;JUL 06, 2010 3:14 PM
 ;;5.2;IHS LABORATORY;**1027**;NOV 01, 1997
 ;
 ;cmi/maw for LABCORP INBOUND HL7 MESSAGE
...
OBR F  S LA762495=$O(^LAHM(62.49,LA76249,150,LA762495)) Q:'LA762495!($E($G(^(+LA762495,0)),1,3)="OBR")  ;find the OBR segment
 ...
 I $P(LA7AA(0),"^",2)="CH" D NTE^BLRLIIN2 ; Process "CH" subscript results - NTE and OBX segments.
