...
FILE(XBDIR,XBFN) ;PEP - pull up a file into the TMP global for display
 ...
 .Q
 D EN^BLRLMR("BLR REFLAB RAW MSG VIEW")
 KILL ^TMP("XBLM",$J,XBNODE)
EFILE ;
 Q
 ;
