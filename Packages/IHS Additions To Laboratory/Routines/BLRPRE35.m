BLRPRE35 ; IHS/MSC/MKK - IHS Lab Patch LR*5.2*1035 Pre/Environment Routine ; 16-Jul-2015 06:30 ; MKK
...
ENVICHEK ; EP - Environment Checker
 ...
 D SAVEOFF
 ;
 D NEEDIT^BLRPRE31(CP,"LR","5.2",1034,.ERRARRAY),BLANK  ; Lab Pre-Requisite
 ;
...
SAVEOFF ; EP - Save off all routines being updated by this patch into the ^rBACKUP global.
 ...
 ;
 F RTN="BLRSGNS2","BLRSGNSP","BLRSGNSU","BLRSGNSY","BLRUTIL4","BLRUTIL6"  D
 . K ERRS,RTNA
