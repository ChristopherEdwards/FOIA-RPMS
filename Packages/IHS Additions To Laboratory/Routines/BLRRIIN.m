BLRRIIN ;cmi/anch/maw - Process Incoming Univ Interface Messages 12/3/1997 ;JUL 06, 2010 3:14 PM
 ;;5.2;IHS LABORATORY;**1021,1027**;NOV 01, 1997
 ;;5.2;LR;**17,23,27,1021,1027**;Oct 20, 2005
 ;cmi/maw
 ;
 ;this is for LABCORP MESSAGING REFERENCE LAB
...
QUE ;call here to queue this processing routine to run in the
 ...
 S ZTRTN="EN^BLRRIIN",ZTDTH=$H,ZTIO=""
