BLRUIIN ;cmi/anch/maw - Process Incoming Univ Interface Messages 12/3/1997 ;JUL 06, 2010 3:14 PM
 ;;5.2;IHS LABORATORY;**1027**;NOV 01, 1997
 ;cmi/maw
 ;
 ;this is for UNILAB MESSAGING REFERENCE LAB
...
QUE ;call here to queue this processing routine to run in the
 ...
 S ZTRTN="EN^BLRUIIN",ZTDTH=$H,ZTIO=""
