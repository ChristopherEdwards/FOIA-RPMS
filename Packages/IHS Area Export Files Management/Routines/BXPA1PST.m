BXPA1PST ;IHS/OIT/FBD -Environment Check and Pre/Post Init Process 21 Nov 2013 7:45 AM ; 
...
PRE ;PATCH 26 PRE-INIT CHECKS AND PROCESSES
 D MES^XPDUTL($$CJ^XLFSTR("Beginning BXPA v1.0 pre-init process.",80))
 ;
 ...
 D MES^XPDUTL($$CJ^XLFSTR("BXPA v1.0 pre-init process complete.",80))
 Q
 ;
 ;
POST ;BXPA v1.0 POST-INIT PROCESSES
 D MES^XPDUTL($$CJ^XLFSTR("Beginning BXPA v1.0 post-init process.",80))
 ;
 ...
 ;
 D MES^XPDUTL($$CJ^XLFSTR("BXPA v1.0 post-init process complete.",80))
 Q
 ;
 ;
