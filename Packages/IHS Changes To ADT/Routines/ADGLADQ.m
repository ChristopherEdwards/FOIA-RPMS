ADGLADQ ; IHS/ADC/PDW/ENM - QUEUE LIST OF ADMISSIONS ;  [ 03/25/1999  11:48 AM ]
 ;;5.0;ADMISSION/DISCHARGE/TRANSFER;;MAR 25, 1999
 ;
 W @IOF W !!!?20,"PRINT LIST OF ADMISSIONS",!!
 ;
 ;***> select date range
...
ONE ;***> choose which ward or service to print
 ...
 ;
 ;***> select print device
DEV S %ZIS="PQ" D ^%ZIS G END:POP,QUE:$D(IO("Q")) U IO G ^ADGLADC
QUE K IO("Q") S ZTRTN="^ADGLADC" S ZTDESC="ADMITS LISTING"
