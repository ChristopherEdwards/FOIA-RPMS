ADGT16 ; GENERATED FROM 'ADGPM TRANSFER' INPUT TEMPLATE(#1598), FILE 405;04/14/04
 D DE G BEGIN
...
BEGIN S DNM="ADGT16",DQ=1
 N DIEZTMP,DIEZAR,DIEZRXR,DIIENS,DIXR K DIEFIRE,DIEBADK S DIEZTMP=$$GETTMP^DIKC1("DIEZ")
 M DIEZAR=^DIE(1598,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1598,U="^"
