APSPEC10 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;19-Jan-2011 06:31;SM
 ;;7.0;IHS PHARMACY MODIFICATIONS;**1010**;Sep 23, 2004
 ;
ENV ;EP
 ;
 S X=$$GET1^DIQ(200,DUZ,.01)
 W !!,$$CJ^XLFSTR("Hello, "_$P(X,",",2)_" "_$P(X,","),IOM)
 W !!,$$CJ^XLFSTR("Checking Environment for "_$P($T(+2),";",4)_" V "_$P($T(+2),";",3)_", Patch 1010.",IOM)
