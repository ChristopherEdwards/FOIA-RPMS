APSPEC12 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;23-Sep-2011 16:52;PLS
 ;;7.0;IHS PHARMACY MODIFICATIONS;**1012**;Sep 23, 2004;Build 5
 ;
ENV ;EP
 ;
 S X=$$GET1^DIQ(200,DUZ,.01)
 W !!,$$CJ^XLFSTR("Hello, "_$P(X,",",2)_" "_$P(X,","),IOM)
 W !!,$$CJ^XLFSTR("Checking Environment for "_$P($T(+2),";",4)_" V "_$P($T(+2),";",3)_", Patch 1012.",IOM)
...
REMXPAR(PAR) ;Remove values stored for a given parameter
 ...
 Q
POST ;EP
 D UPDPAR("SYS","APSP AUTO RX SCHEDULE RESTRICT","2345")
 D UPDPAR("SYS","APSP AUTO RX ERX OF CS II","NO")
 Q
 ;
