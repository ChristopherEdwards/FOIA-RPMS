APSPEC19 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;09-Jul-2015 14:57;DU
 ;;7.0;IHS PHARMACY MODIFICATIONS;**1019**;Sep 23, 2004;Build 4
 ;
ENV ;EP
 ;
 S X=$$GET1^DIQ(200,DUZ,.01)
 W !!,$$CJ^XLFSTR("Hello, "_$P(X,",",2)_" "_$P(X,","),IOM)
 W !!,$$CJ^XLFSTR("Checking Environment for "_$P($T(+2),";",4)_" V "_$P($T(+2),";",3)_", Patch 1019.",IOM)
