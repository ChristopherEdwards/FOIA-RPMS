ADE60P25 ;IHS/OIT/GAB - ADE GENERAL PATCH MODULE P25 [ 11/13/2013  11:38 AM ]
 ;;6.0;ADE*6.0*25;;Nov 14, 2013;Build 4
 ;
 ; This patch contains calls to 3 ADE P25 routines with
 ; 2014 Dental Code Updates.
 ;
...
POST ;EP Post-Install
 ; only post for patch 25 - /IHS/OIT/GAB 11/07/2013
 ; Add new, modify and delete ADA Codes
 N ADED,ADECNT,ADEVALUE
 D BMES^XPDUTL("Adding 2014 ADA Codes...")
 D ADDCDT5^ADE6P251
 D BMES^XPDUTL(" ...DONE")
 D BMES^XPDUTL("Set ^ADEDIT(""AC"" X-Ref for 2014 ADA Codes...")
 D AC^ADE6P251
 D BMES^XPDUTL(" ...DONE")
