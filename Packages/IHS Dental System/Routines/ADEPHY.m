ADEPHY ; IHS/HQT/MJL - HYG/THER MONTHLY REPORT ;07:09 PM  [ 03/24/1999   9:04 AM ]
 ;;6.0;ADE;;APRIL 1999
 ;
 ...
 ;
 D ASKDEV^ADEPSUB("ZTM^ADEPHY","HYGIENIST MONTHLY REPORT PROCESSING")
...
ZTM ;EP - TASKMAN PROCESSING PHASE
 ...
 . I $D(IOT),IOT'="HFS" D  Q
 . . S ZTREQ=$H_U_ADEIOP_U_"HYGIENIST MONTHLY REPORT PRINTING"_U_"PRINT^ADEPHY"
 . D PRINT Q
...
PRINT ;EP - TASKMAN PRINT PHASE
 D PRINT^ADEPSUB("[ADEP-ADEPMON]"," HYGIENIST/THERAPIST MONTHLY REPORT FOR PERIOD")
 Q
