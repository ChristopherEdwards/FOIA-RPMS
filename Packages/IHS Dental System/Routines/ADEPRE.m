ADEPRE ; IHS/OIT/ENM - ADE6.0 PATCH 17 ENVIRONMENT CHECK [ 03/26/2007  9:30 AM ]
 ;;6.0;ADE;**17**;FEB 15, 2007
 S X="ADE6P161" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.16k' MUST be be installed!" D GETUP(ADEMSG,1)
