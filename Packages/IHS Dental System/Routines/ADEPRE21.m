ADEPRE21 ; IHS/OIT/ENM - ADE6.0 PATCH 21 ENVIRONMENT CHECK [ 12/09/2009 9:05 AM ]
 ;;6.0;ADE;**21**;MAR 25, 1999
 S X="ADEPRE20" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.20k' MUST be installed!" D GETUP(ADEMSG,1)
