ADEPRE22 ; IHS/OIT/ENM - ADE6.0 PATCH 22 ENVIRONMENT CHECK [ 12/14/2010 16:43 PM ]
 ;;6.0;ADE;**22**;MAR 25, 1999
 ;
 S X="ADEPRE21" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.21k' MUST be installed!" D GETUP(ADEMSG,1)
