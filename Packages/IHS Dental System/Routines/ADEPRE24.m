ADEPRE24 ; IHS/OIT/GAB - ADE6.0 PATCH 24 ENVIRONMENT CHECK [ 11/25/2012 16:43 PM ]
 ;;6.0;ADE;**24**;NOV 25, 2012
 ;
 S X="ADEPRE23" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.23k' MUST be installed!" D GETUP(ADEMSG,1)
