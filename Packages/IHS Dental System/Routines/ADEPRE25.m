ADEPRE25 ; IHS/OIT/GAB - ADE6.0 PATCH 25 ENVIRONMENT CHECK [ 11/25/2013 16:43 PM ]
 ;;6.0;ADE*6.0*25;;Nov 14, 2013;Build 4
 ;
 S X="ADEPRE24" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.24k' MUST be installed!" D GETUP(ADEMSG,1)
