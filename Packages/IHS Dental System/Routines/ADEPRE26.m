ADEPRE26 ; IHS/OIT/GAB - ADE6.0 PATCH 26 ENVIRONMENT CHECK [ 04/02/2014 16:43 PM ]
 ;;6.0;ADE*6.0*26;;March 25, 1999;Build 13
 ;
 S X="ADEPRE25" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.25k' MUST be installed!" D GETUP(ADEMSG,1)
