ADEPRE28 ; IHS/OIT/GAB - ADE6.0 PATCH 28 ENVIRONMENT CHECK [ 07/02/2015 16:43 PM ]
 ;;6.0;ADE*6.0*28;;March 25, 1999;Build 14
 ;
 S X="ADEPRE27" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.27k' MUST be installed!" D GETUP(ADEMSG,1)
