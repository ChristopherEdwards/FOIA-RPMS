ADEPRE29 ; IHS/OIT/GAB - ADE6.0 PATCH 29 ENVIRONMENT CHECK [ 10/27/2015 13:42 PM ]
 ;;6.0;ADE*6.0*29;;March 25, 1999;Build 16
 ;
 S X="ADEPRE28" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.28k' MUST be installed!" D GETUP(ADEMSG,1)
