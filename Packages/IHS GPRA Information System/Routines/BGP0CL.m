BGP0CL ; IHS/CMI/LAB - IHS GPRA 10 CMS REPORT DRIVER 01 Jul 2009 8:19 PM 30 Mar 2010 6:08 PM ; 
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2010 CRS - RPMS PATIENT DATA FOR ANNUAL CMS HOSPITAL REPORTING",80)
INTRO ;
 D XIT
WARN ;
 W !,"                     ***************************"
 ...
 W !,"                     ***************************"
 W !
 W !,"This report was last updated in April 2008 through the CMS Specifications "
 W !,"Manual for discharges effective 4/1/2008, and the CRS CMS Report was included"
...
SETLIST ;
 ...
 .W !,"within the ",$P(^BGPCMSIT(BGPXX,0),U,3)," topic.",!
 .D PAUSE
 .D EN^BGP0CSII
 .I '$D(BGPPLSTL(BGPXX)) W !!,"No lists selected for topic ",$P(^BGPCMSIT(BGPXX,0),U,3),"." D PAUSE
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP0CL",ZTDTH="",ZTDESC="CRS 09 CMS REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
 ;
XIT ;
...
ENDDATE ;
 ...
 W !,"January 4, 2010 and you type in 6/30/08 the system will assume the year"
 W !,"as 1908 since that is a date in the past.  You must type 6/30/2010 if you"
