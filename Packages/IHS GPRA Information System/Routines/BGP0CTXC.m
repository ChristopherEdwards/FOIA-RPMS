BGP0CTXC ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT 18 Feb 2009 5:31 PM ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2010 CMS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP0CTXC",XBNS="",XBRX="XIT^BGP0CTXC"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
THISRPT ;
 ...
 ..S BGPY=0 F  S BGPY=$O(^BGPCMSMT(BGPI,11,"B",BGPY)) Q:BGPY'=+BGPY  D
 ...S BGPTYPE=$P(^BGPTAXT(BGPY,0),U,2),Y=$G(^BGPTAXT(BGPY,11,1,0)),BGPT=$P(^BGPTAXT(BGPY,0),U)
 ...I BGPTYPE'="L" D
 ....I '$D(^ATXAX("B",BGPT)) S A(BGPT)=Y_"^is Missing" Q
 ....S I=$O(^ATXAX("B",BGPT,0))
 ....I '$D(^ATXAX(I,21,"B")) S A(BGPT)=Y_"^has no entries "
