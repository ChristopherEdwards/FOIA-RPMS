...
DMNA ;EP - called from elder care
 ...
 S BGPBD2=BGPBDATE
I61 ;EP
 S BGPGFR=$$GFR^BGP0D211(DFN,BGPBD1,BGPEDATE)
 S BGPESRD=$$ESRD^BGP0D211(DFN,$P(^DPT(DFN,0),U,3),BGPEDATE)
 S BGPQUP=$$QUANTUP^BGP0D211(DFN,BGPBD2,BGPEDATE)
...
DMEYE ;EP - called from elder care
 ...
 S BGPVALUE=$S(BGPDMD1:"UP",1:"")_$S(BGPDMD2:",AD",1:"")_$S(BGPDMD3:",AAD",1:"")_"|||"_$$DATE^BGP0UTL($P(BGPEYE,U,2))_" "_$P(BGPEYE,U,3)
 K BGPG
 K ^TMP($J,"A")
 Q
 ;
I8 ;EP
 ...
 S BGPVALUE="AD|||"_$$DATE^BGP0UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 Q
I9 ;EP
 K BGPN1,BGPVALUE,BGPN2,BGPN3,BGPN4,BGPN5
 ...
 S BGPN2=0 I $P(BGPVALUE,U)=2 S BGPN2=1
 ;S BGPN3=0 I BGPN1,'BGPN2 S BGPN3=1
 S BGPVALUE="UP|||"_$$DATE^BGP0UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 Q
DENTSRV(P,BDATE,EDATE,FORECAST) ;EP
 ...
 I $G(FORECAST) Q BGPC
 D  Q BGPC
 .S G=$$REFUSAL^BGP0UTL1(P,9999999.15,$O(^AUTTEXAM("C",30,0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 .I G,$P(G,U,2)>$P(BGPC,U,2) S BGPC="2^"_$P(G,U,2)_"^Refused EXAM 30"
 .S G=$$REFUSAL^BGP0UTL1(P,9999999.31,$O(^AUTTADA("B","0000",0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 .I G,$P(G,U,2)>$P(BGPC,U,2) S BGPC="2^"_$P(G,U,2)_"^Refused ADA 0000"
 .S G=$$REFUSAL^BGP0UTL1(P,9999999.31,$O(^AUTTADA("B","0190",0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 .I G,$P(G,U,2)>$P(BGPC,U,2) S BGPC="2^"_$P(G,U,2)_"^Refused ADA 0190"
 S G=$$REFUSAL^BGP0UTL1(P,9999999.15,$O(^AUTTEXAM("C",30,0)),BDATE,EDATE)
 I $P(G,U)=1 Q "2^"_$P(G,U,2)_"^Refused EXAM 30"
 S G=$$REFUSAL^BGP0UTL1(P,9999999.31,$O(^AUTTADA("B","0000",0)),BDATE,EDATE)
 I $P(G,U)=1 Q "2^"_$P(G,U,2)_"^Refused ADA 0000"
 S G=$$REFUSAL^BGP0UTL1(P,9999999.31,$O(^AUTTADA("B","0190",0)),BDATE,EDATE)
...
EYE(P,BDATE,EDATE,REFUSAL) ;EP
 ...
 .S X=$$CPT^BGP0DU(P,BDATE,EDATE,T,5) I X]"" Q
 .S X=$$TRAN^BGP0DU(P,BDATE,EDATE,T,5)
 S X=$$LASTPRCI^BGP0UTL1(P,"95.02",BDATE,EDATE) I X]"" Q 3_U_$P(X,U,3)_U_"PROC: 95.02"
...
GFR(P,BDATE,EDATE) ;EP
 ...
 ...I T,$P(^AUPNVLAB(X,0),U)=T S BGPC=1_U_$$DATE^BGP0UTL((9999999-D)) Q
...
ESRD(P,BDATE,EDATE) ;EP
 ...
 S X=$$LASTPRC^BGP0UTL1(P,"BGP ESRD PROCS",BDATE,EDATE)
