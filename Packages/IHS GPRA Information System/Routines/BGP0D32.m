...
I14 ;EP
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$DTAP^BGP0D34(DFN,BGPEDATE)  ;1 IS had immunizations, 3 is had refusal, 4 is disease or NMI or contraindication
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$OPV^BGP0D33(DFN,BGPEDATE)
 ...
 S BGPVAL=$$MMR^BGP0D33(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$HIB^BGP0D35(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$PNEUMO^BGP0D35(DFN,BGPEDATE,4)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$PNEUMO^BGP0D35(DFN,BGPEDATE,3)
