...
DTAP(P,EDATE) ;EP
 K ^TMP($J,"CPT")
 K BGPC,BGPG,BGPX
 ;first gather up all cpt codes that relate in any way to dtap and store
 ...
 ;get all imms
 S C="20^50^106^107^110^1^22^102^115^120^130"
...
EVIDTET ;
 ...
 ;I $$PLCODE^BGP0DU(P,"037.") S BGPEVTD=1
 D RESETD
...
EVIDPER ;
 ...
 ;I $$PLTAX^BGP0DU(P,"BGP PERTUSSIS EVIDENCE") S BGPEVPER=1
 D RESETD
...
EVIDDIP ;
 ...
 ;I $$PLTAX^BGP0DU(P,"BGP DIPHTHERIA EVIDENCE") S BGPEVDIP=1
 D RESETD
...
REF ;
 ...
 F BGPIMM=20,50,106,107,110,1,22,102,115,120,130  D
 ...
 F BGPIMM=20,50,106,107,110,1,22,102,115,120,130 Q:R  S R=$$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ...
 ;now check refusals in imm pkg
 S (R,BGPNMI)="" F BGPIMM=28 S R=$$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ...
 ;now check refusals in imm pkg
 S (R,BGPNMI)="" F BGPIMM=11 S R=$$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ...
 ;now check refusals in imm pkg
 S R="" F BGPIMM=35,112 S R=$$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I BGPPER>3,BGPD>3,R Q 3_U_"ref dtap"
 ;now check for contraindication
 F BGPZ=20,80,106,107,110,120 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - DTaP"
 F BGPZ=1,22 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - DTP"
 F BGPZ=115 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - Tdap"
 F BGPZ=28 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - DT"
 F BGPZ=9,113 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - td"
 F BGPZ=35,112 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - tetanus"
 F BGPZ=11 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
