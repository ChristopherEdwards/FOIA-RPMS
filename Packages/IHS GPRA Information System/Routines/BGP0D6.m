...
I031 ;EP
 ...
 S BGPXPTV=$$SB^BGP0PDL1($J($P(BGPBMI,U),6,2)) S:BGPXPTV="0.00" BGPXPTV=""
 ...
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP0PDL1($J($P(BGPBMI,U),6,2)),1:"")_$S(BGPN2:" OW",1:"")_$S(BGPN3:" OB",1:"")
...
I031A ;
 ...
 I $P(BGPBMI,U)]"" S BGPVALUE=BGPVALUE_"|||"_$P(BGPBMI,U)_":"_$$DATE^BGP0UTL($P(BGPBMI,U,2))_" Age at BMI: "_A
...
BMIOR(P,BDATE,EDATE,AGE) ;EP
 ...
 .I '$P(X,"^") Q
 .S W=$P(X,"^",2),H=$P(X,"^",3)
 .S W=W*.45359,H=(H*.0254),H=(H*H),BGPBMIH=$$SB^BGP0PDL1($J((W/H),6,2))_U_$P(X,U,1)
 .;S W=$P(X,"^",5),H=$P(X,"^",6)
 .;S W=W*.45359,H=(H*.0254),H=(H*H),$P(BGPBMIH,U,3)=$$SB^BGP0PDL1($J((W/H),6,2))_U_$P(X,U,4)
 .Q
 Q ""
...
REF(P,BDATE,EDATE,AGE) ;EP - get ht/wt refusal in past year, same date for 18 and under
 S R=""
 I AGE<19 G AGE18R
 S X=$$REFUSAL^BGP0UTL1(P,9999999.07,$O(^AUTTMSR("B","HT",0)),BDATE,EDATE) I X S R=1_U_"HT"_U_$P(X,U,2)
 S Y=$$REFUSAL^BGP0UTL1(P,9999999.07,$O(^AUTTMSR("B","WT",0)),BDATE,EDATE) I Y S $P(R,U,4)=1,$P(R,U,5)="WT",$P(R,U,6)=$P(Y,U,2)
 I X="",Y="" Q ""
 Q R
AGE18R ;
 K H,W
