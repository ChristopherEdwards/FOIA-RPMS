BGP0D74 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2009 1:44 PM ;
...
IEDA ;EP
 ...
 S X=0,C=0,J="" F  S X=$O(BGPDAE(X)) Q:X'=+X  S C=C+1,J=J_$S(J]"":";",1:"")_$P(BGPDAE(X),U,2)_"-"_$$DATE^BGP0UTL($P(BGPDAE(X),U,3))_"("_$P(BGPDAE(X),U,4)_")"
 I C>0 S BGPN1=1
 I C>1 S BGPN2=1
...
IBFR ;EP
 ...
 .S Y=BGPBFR(X)
 .I +Y=1!(+Y=2) S BGPN6=1
 .S BGPV2="2 MOS: "_$$EXTSET^XBFUNC(9000010.44,.01,+Y)_"-"_X_" DO-"_$$DATE^BGP0UTL($P(Y,U,2))
 .S G=1
 D
 ...
 .S Y=BGPBFR(X)
 .I +Y=1!(+Y=2) S BGPN7=1
 .S BGPV3="6 MOS: "_$$EXTSET^XBFUNC(9000010.44,.01,+Y)_"-"_X_" DO-"_$$DATE^BGP0UTL($P(Y,U,2))
 .S G=1
 D
 ...
 .S Y=BGPBFR(X)
 .I +Y=1!(+Y=2) S BGPN8=1
 .S BGPV4="9 MOS: "_$$EXTSET^XBFUNC(9000010.44,.01,+Y)_"-"_X_" DO-"_$$DATE^BGP0UTL($P(Y,U,2))
 .S G=1
 D
 ...
 .S Y=BGPBFR(X)
 .I +Y=1!(+Y=2) S BGPN9=1
 .S BGPV5="1 YR: "_$$EXTSET^XBFUNC(9000010.44,.01,+Y)_"-"_X_" DO-"_$$DATE^BGP0UTL($P(Y,U,2))
 .S G=1
...
GETDAE(P,BDATE,EDATE,BGPRET,BGPRET1) ;EP
 ...
 K BGPMEDS1 S BGPXXX="ANTIANXIETY",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ANTIANXIETY MEDS","BGP HEDIS ANTIANXIETY NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(1)=1
 K BGPMEDS1 S BGPXXX="ANTIEMETIC",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ANTIEMETIC MEDS","BGP HEDIS ANTIEMETIC NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(2)=1
 K BGPMEDS1 S BGPXXX="ANALGESIC",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ANALGESIC MEDS","BGP HEDIS ANALGESIC NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(3)=1
 K BGPMEDS1 S BGPXXX="ANTIHISTAMINE",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ANTIHISTAMINE MEDS","BGP HEDIS ANTIHISTAMINE NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(4)=1
 K BGPMEDS1 S BGPXXX=" ANTIPSYCHOTIC",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ANTIPSYCHOTIC MEDS","BGP HEDIS ANTIPSYCHOTIC NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(5)=1
 K BGPMEDS1 S BGPXXX="AMPHETAMINE",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS AMPHETAMINE MEDS","BGP HEDIS AMPHETAMINE NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(6)=1
 K BGPMEDS1 S BGPXXX="BARBITURATE",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS BARBITURATE MEDS","BGP HEDIS BARBITURATE NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(7)=1
 K BGPMEDS1 S BGPXXX="BENZODIAZEPINE",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS BENZODIAZEPINE MEDS","BGP HEDIS BENZODIAZEPINE NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(8)=1
 ;K BGPMEDS1 S BGPXXX="OTHER BENZODIAZEPNE",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS OTHER BENZODIAZEPINE","BGP HEDIS OTHER BENZO NDC",,,.BGPMEDS1)
 ;D ADDINMED
 ;I BGPGOT S BGPRET1(9)=1
 K BGPMEDS1 S BGPXXX="CALCIUM CHANNEL",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS CALCIUM CHANNEL MEDS","BGP HEDIS CALCIUM CHANNEL NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(10)=1
 K BGPMEDS1 S BGPXXX="GASTRO ANTISPASM",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS GASTRO ANTISPASM MED","BGP HEDIS GASTRO ANTISPASM NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(11)=1
 K BGPMEDS1 S BGPXXX="BELLADONNA",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS BELLADONNA ALKA MEDS","BGP HEDIS BELLADONNA ALKA NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(12)=1
 K BGPMEDS1 S BGPXXX="SKL MUSCLE",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS SKL MUSCLE RELAX MED","BGP HEDIS SKL MUSCLE RELAX NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(13)=1
 K BGPMEDS1 S BGPXXX="ORAL ESTROGEN",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ORAL ESTROGEN MEDS","BGP HEDIS ORAL ESTROGEN NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(14)=1
 K BGPMEDS1 S BGPXXX="ORAL HYPOGLYCEMIC",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS ORAL HYPOGLYCEMIC RX","BGP HEDIS ORAL HYPOGLYCEMIC ND",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(15)=1
 K BGPMEDS1 S BGPXXX="NARCOTIC",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS NARCOTIC MEDS","BGP HEDIS NARCOTIC NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(16)=1
 K BGPMEDS1 S BGPXXX="VASODILATOR",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS VASODILATOR MEDS","BGP HEDIS VASODILATOR NDC",,,.BGPMEDS1)
 D ADDINMED
 I BGPGOT S BGPRET1(17)=1
 K BGPMEDS1 S BGPXXX="OTHER MEDS",BGPGOT=0 D GETMEDS^BGP0UTL2(P,BGPBDATE,BGPEDATE,"BGP HEDIS OTHER MEDS AVOID ELD","BGP HEDIS OTHER NDC AVOID ELD",,,.BGPMEDS1)
 D ADDINMED
...
FALLEX(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)) Q 1_"^exam 37^"_$$DATE^BGP0UTL($P(BGPG(1),U))
 Q ""
DHF(P,BDATE,EDATE) ;EP
 K BGPG
 S Y="BGPG("
 S X=P_"^LAST DX V15.88;DURING "_$$FMTE^XLFDT(BDATE)_"-"_$$FMTE^XLFDT(EDATE) S E=$$START1^APCLDF(X,Y)
 I $D(BGPG(1)) Q 1_U_"Hx of Fall DX: "_$P(BGPG(1),U,2)_U_$$DATE^BGP0UTL($P(BGPG(1),U))
 Q ""
FID(P,BDATE,EDATE) ;EP
 ...
 .S E=$P(^AUPNVPOV(Y,0),U,9) I E,$$ICD^ATXCHK(E,T,9) S G=1_U_"Fall Injury: "_$P($$ICDDX^ICDCODE(E),U,2)_U_$$DATE^BGP0UTL($P(BGPG(X),U,1)) Q
 .S E=$P(^AUPNVPOV(Y,0),U,18) I E,$$ICD^ATXCHK(E,T,9) S G=1_U_"Fall Injury: "_$P($$ICDDX^ICDCODE(E),U,2)_U_$$DATE^BGP0UTL($P(BGPG(X),U,1)) Q
 .S E=$P(^AUPNVPOV(Y,0),U,19) I E,$$ICD^ATXCHK(E,T,9) S G=1_U_"Fall Injury: "_$P($$ICDDX^ICDCODE(E),U,2)_U_$$DATE^BGP0UTL($P(BGPG(X),U,1)) Q
 I G Q G
 Q ""
AGM(P,BDATE,EDATE) ;EP
 S BGPG=$$LASTDX^BGP0UTL1(P,"BGP ABNORMAL GAIT OR MOBILITY",BDATE,EDATE)
 I $P(BGPG,U) Q 1_U_"Abnormal Gait: "_$P(BGPG,U,2)_U_$$DATE^BGP0UTL($P(BGPG,U,3))
 Q ""
REFFRE(P,BDATE,EDATE) ;EP
 ;add refusal for exam 37
 S G=$$REFUSAL^BGP0UTL1(P,9999999.15,$O(^AUTTEXAM("C",37,0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 I $P(G,U)=1 Q 1_"^ref exam 37^"_$$DATE^BGP0UTL($P(G,U,2))
 Q ""
