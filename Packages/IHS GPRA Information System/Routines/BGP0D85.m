BGP0D85 ; IHS/CMI/LAB - measure C ; 09 Jun 2010  5:18 PM
...
I28 ;EP
 ...
 S BGPVAL=$$HEP^BGP0D35(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$VAR^BGP0D35(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$TDAP^BGP0D86(DFN,BGPEDATE)
 ...
 ;I DUZ=5634,BGPTIME=1 W !,DFN," ",BGPN10,"  ",BGPN6,"  ",BGPVAL
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$MEN^BGP0D36(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_";"_$P(BGPVAL,U,2)
 S BGPVAL=$$HPV^BGP0D36(DFN,BGPEDATE)
...
MMR(P,EDATE) ;EP
 ...
 S C="3^94"
 K BGPX D GETIMMS^BGP0D32(P,EDATE,C,.BGPMMR)
...
RUBX ;
 ...
 F BGPIMM=6 I $$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE) S BGPMU=3
