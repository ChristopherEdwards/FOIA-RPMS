BGP0D86 ; IHS/CMI/LAB - measure C 06 Nov 2008 2:26 PM ;
...
IRAR ;EP
 ...
 I '$$RHEUAR^BGP0D862(DFN,BGPBDATE,BGPEDATE) S BGPSTOP=1 Q  ;no OSTEOARTHRITIS
 S BGPV=$$MEDSPRE^BGP0D863(DFN,BGPBDATE,BGPEDATE)
 ...
 K BGPIRZ,BGPIRV
 I $P(BGPV,U,2) D
 .S BGPCBC=$$CBC^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPLFT=$$LFT^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPCREAT=$$CREAT^BGP0D22(DFN,BGPBDATE,BGPEDATE)
 .S BGPIRZ("A")=0,BGPIRV("A")="Has NSAID: "
 .I BGPCBC,BGPLFT,BGPCREAT S BGPIRZ("A")=1,BGPIRV("A")=BGPIRV("A")_" CREAT: "_$$DATE^BGP0UTL($P(BGPCREAT,U,2))_"CBC: "_$$DATE^BGP0UTL($P(BGPCBC,U,2))_" LFT: "_$$DATE^BGP0UTL($P(BGPLFT,U,2))  ;NA MEDS AND HAS CBC,LFT
 .I 'BGPCREAT S BGPIRV("A")=BGPIRV("A")_"No CREAT"
 .I 'BGPCBC S BGPIRV("A")=BGPIRV("A")_" No CBC"
 .I 'BGPLFT S BGPIRV("A")=BGPIRV("A")_" No LFT"
 I $P(BGPV,U,3) D
 .S BGPGOLD=$$GOLDLAB^BGP0D864(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,4) D
 .S BGPCBC=$$CBC4^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,5) D
 .S BGPCBC=$$CBC6^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 ...
 .S BGPSERUM=$$SERUM6^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 ...
 .S BGPLFT=$$LFT6^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,7) D
 .S BGPCBC=$$CBC^BGP0D861(DFN,$$FMADD^XLFDT(BGPEDATE,-180),BGPEDATE)
 ...
 .S BGPUP=$$UP4^BGP0D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,12) D
 .S BGPGLU=$$GLUCOSE^BGP0D861(DFN,BGPBDATE,BGPEDATE)
...
TDAP(P,EDATE) ;EP
 ...
 F BGPZ=115 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=115 S R=$$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
TD ;
 ...
 F BGPZ=9,113 S X=$$ANCONT^BGP0D31(P,BGPZ,EDATE) Q:X]""
 ...
 ;now check refusals in imm pkg
 F BGPIMM=9,113 S R=$$IMMREF^BGP0D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
