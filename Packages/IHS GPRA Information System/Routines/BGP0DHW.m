BGP0DHW ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;10.0;IHS CLINICAL REPORTING;**1**;JUN 18, 2010
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2010 National GPRA & PART Height and Weight Local Data File",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
SUM ;display summary of this report
 ...
 S BGPROT="P",BGPDELT="" ;D PT^BGP0DSL
 I BGPROT="" G BEN
ZIS ;call to XBDBQUE
 D REPORT^BGP0UTL
 I $G(BGPQUIT) D XIT Q
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP0DHW",XBRX="XIT^BGP0DHW",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP0DHW",ZTDTH="",ZTDESC="NATIONAL GPRA LOCAL HW DATA" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
