BGP0DL ; IHS/CMI/LAB - IHS GPRA 10 SELECTED REPORT DRIVER 21 May 2009 12:10 PM ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2010 CRS - Clinical Performance Measure Report (Selected Measures)",80)
INTRO ;
 D XIT
...
SUM ;display summary of this report
 ...
 W !!,"These performance measures will be calculated: " S X=0 F  S X=$O(BGPIND(X)) Q:X'=+X  W $P(^BGPINDT(X,0),U,3)," ; "
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP0DL",ZTDTH="",ZTDESC="CRS 09 COM REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP0DL",XBRX="XIT^BGP0DL",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
XIT ;
