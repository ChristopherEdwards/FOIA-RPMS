BGP0DNG9 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM 31 Jul 2010 11:21 AM ; 13 Aug 2010  5:44 PM
...
INTRO ;
 D XIT
 W !!,"This will produce a National GPRA & PART report for the 2011 GPRA year using"
 W !,"the same performance measure definitions from CRS Version 10.0."
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP0DNG9",XBRX="XIT^BGP0DNG9",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP0DNG9",ZTDTH="",ZTDESC="GPRA AND PART REPORT 10 for 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
