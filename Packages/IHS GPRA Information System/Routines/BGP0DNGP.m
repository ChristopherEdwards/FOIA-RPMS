BGP0DNGP ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2010 National GPRA & PART Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
TP ;get time period
 D XIT
 S BGPRTYPE=1,BGP0RPTH="",BGPDESGP=""
DESG ;
 W !!
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP0DNGP",XBRX="XIT^BGP0DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP0DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA & PART REPORT 09 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
