BGP0DP12 ; IHS/CMI/LAB - print ind 19 AGE DIST ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
I1AGE ;EP  special age tallies
 Q:$G(BGPSUMON)
 ;I BGPRTYPE=7 D ^BGP0DP13 Q
...
PR ; 
 I '$G(BGPSUMON) D HEADER^BGP0DPH Q:BGPQUIT  W !,^BGPINDT(BGPIC,53,1,0) W:$D(^BGPINDT(BGPIC,53,2,0)) !,^BGPINDT(BGPIC,53,2,0) D H4^BGP0DPH
