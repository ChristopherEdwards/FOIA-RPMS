BGP0DP60 ; IHS/CMI/LAB - print ind H ;
...
PR ; 
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP0DPH Q:BGPQUIT  W:'$G(BGPSUMON) !,^BGPINDT(BGPIC,53,1,0) W:$D(^BGPINDT(BGPIC,53,2,0)) !,^BGPINDT(BGPIC,53,2,0) D H3
...
PB ;
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP0DPH Q:BGPQUIT  W !,^BGPINDT(BGPIC,53,1,0) W:$D(^BGPINDT(BGPIC,53,2,0)) !,^BGPINDT(BGPIC,53,2,0) D H3
 ;percentage changes
