BGP0EL1Q ; IHS/CMI/LAB - print ind ;
 ;;10.0;IHS CLINICAL REPORTING;**1**;JUN 18, 2010
 ;
I1AGEP ;EP
PR ; 
 D HEADER^BGP0DPH W !,^BGPELIT(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3^BGP0EL1P S X=" " D S(X,1,1)
...
S(Y,F,P) ;set up array
 ;Q:BGPQUIT
 ;I $Y>(IOSL-5) D HEADER^BGP0DPH Q:BGPQUIT
 ;W !,^BGPELIT(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 I $G(F) F J=1:1:F W !
