BGP0EL2 ; IHS/CMI/LAB - measure 1,2,3,4 17 Jan 2009 6:49 AM ;
...
I7 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$DENTSRV^BGP0D21(DFN,BGPBDATE,BGPEDATE)
...
LDL(P,BDATE,EDATE) ;EP
 K BGPG,BGPT,BGPC
 S BGPC=0
 S %="",E=+$$CODEN^ICPTCOD(83721),%=$$CPTI^BGP0DU(P,BDATE,EDATE,E)
 I %]"" S BGPC=BGPC+1,BGPT(9999999-$P(%,U,2),BGPC)=""
 S %="",E=+$$CODEN^ICPTCOD(83721),%=$$TRANI^BGP0DU(P,BDATE,EDATE,E)
 I %]"" S BGPC=BGPC+1,BGPT(9999999-$P(%,U,2),BGPC)=""
 ;now get all loinc/taxonomy tests
