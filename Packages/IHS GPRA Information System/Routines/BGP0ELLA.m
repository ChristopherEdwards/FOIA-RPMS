BGP0ELLA ; IHS/CMI/LAB - print ind ;
...
I1AGEP ;
 ...
 S X="# Total # w/Flu vaccine/contra/NMI Refusal (GPRA)" D S(X,1,1)
 ...
 S X=" " D S(X,1,1) S X="# # w/ Influenza Refusal" D S(X,1,1)
...
PR ; 
 ...
 S X="% # w/ Influenza Refusal" D S(X,1,1)
