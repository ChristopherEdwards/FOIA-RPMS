BGP0ELP1 ; IHS/CMI/LAB - print ind 1 ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
I1 ;EP ; diabetes prevalence
 D H1^BGP0DPH ;column headers
I1A1 ;001.A, 001.B, 001.C
 F BGPPC1="1.1","1.2","1.3" Q:BGPQUIT  D PI
 D I1AGE
 Q
I2 ;EP
 I $Y>(BGPIOSL-13) D HEADER^BGP0DPH Q:BGPQUIT  W !!,^BGPELIT(BGPIC,53,1,0)
 D H1^BGP0DPH
...
EFR ;EP
 D H1^BGP0DPH
 S BGPPC0=$P(^BGPELIT(BGPIC,0),U,6)
...
IRAA ;EP
 D H1^BGP0DPH
 F BGPPC1=$P(^BGPELIT(BGPIC,0),U,6)_".1" Q:BGPQUIT  D PI
 D I1AGE^BGP0EL1N
 Q
PCV ;EP
 D H1^BGP0DPH
 ...
 D HEADER^BGP0DPH Q:BGPQUIT  W !!,^BGPELIT(BGPIC,53,1,0) D H1^BGP0DPH
...
PI ;EP
 S BGPDENP=0
 S BGPPC2=0 F  S BGPPC2=$O(^BGPELIIT("ABC",BGPPC1,BGPPC2)) Q:BGPPC2=""  S BGPPC=$O(^BGPELIIT("ABC",BGPPC1,BGPPC2,0)) D PI1
 Q
PI1 ;
 ...
 .I $Y>(BGPIOSL-13) D HEADER^BGP0DPH Q:BGPQUIT  W !!,^BGPELIT(BGPIC,53,1,0) D H1^BGP0DPH
 .W !!,$P(^BGPELIIT(BGPPC,0),U,17)
 .I $P(^BGPELIIT(BGPPC,0),U,18)]"" D
 ..W !,$P(^BGPELIIT(BGPPC,0),U,18)
 .I $P(^BGPELIIT(BGPPC,0),U,21)]""  D
 ..W !,$P(^BGPELIIT(BGPPC,0),U,21)
 ...
 D SETN
 ;write header
 I $Y>(IOSL-5) D HEADER^BGP0DPH Q:BGPQUIT  W !!,^BGPELIT(BGPIC,53,1,0) D H1^BGP0DPH
 I $P(^BGPELIIT(BGPPC,0),U,22) W !
 W !,$P(^BGPELIIT(BGPPC,0),U,15)
 I $P(^BGPELIIT(BGPPC,0),U,16)]"" W !?1,$P(^BGPELIIT(BGPPC,0),U,16)
 I $P(^BGPELIIT(BGPPC,0),U,19)]"" W !?1,$P(^BGPELIIT(BGPPC,0),U,19)
 D H2^BGP0DPH
 Q
