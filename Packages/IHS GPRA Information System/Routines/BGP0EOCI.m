BGP0EOCI ; IHS/CMI/LAB - calculate HEDIS measures ;
...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPEOMT(BGPIC,1)) X ^BGPEOMT(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPEOMIT("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPEOMIT(BGPI,1)
 ..X ^BGPEOMIT(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPEOMIT(BGPI,0),U,5)
 ..S BGPN=$P(^DD(90379.1,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPEOMIT(BGPI,0),U,4)
 ..S BGPN=$P(^DD(90379.1,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..I BGPDEN'="NO" D S(BGPRPT,BGPGBL,N,P,BGPDEN)
 .K BGPNUMV
 .I $D(BGPLIST(BGPIC)) D STMP^BGP0EOUT
