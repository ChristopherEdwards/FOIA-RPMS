BGP0GDON ; IHS/CMI/LAB - GUI Other National Measurer Report ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 10 OTHER NATIONAL MEASURES REPORT",338,1,3040000,3000000,1,1,"B",$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPGUI=1
 S IOM=80,BGPIOSL=55
 S BGPRTYPE=7,BGP0RPTH=""  ;,BGP0GPU=1
 ...
 S BGPRTC="U"
 I $G(BGPHC) D  ;cmi/maw 6/18/2009 change the dates if they select hard coded
 ...
 S BGPFILEN="" I BGPEXPT S BGPFILEN="BG10"_$P(^AUTTLOC(DUZ(2),0),U,10)_".ONM"_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="OTHONM^BGP0GDON",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI ONM REPORT 09" D ^%ZTLOAD Q
 Q
OTHONM ;
 D ^BGP0D1
 K ^TMP($J,"BGPGUI")
