BGP0GLHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2009 10:56 PM 13 Dec 2006 7:35 AM ; 05 Oct 2010  9:58 AM
 ;;10.0;IHS CLINICAL REPORTING;**1**;JUN 18, 2010
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 10 LOCAL HT/WT",597,"","O","P",$$NOW^XLFDT,"lori ht/wt file")
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLLHW^BGP0GLHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT" D ^%ZTLOAD Q
 Q
NTLLHW ;
 D ^BGP0D1
 K ^TMP($J,"BGPGUI")
 ...
 D HWSF^BGP0DHW
 D KITM^BGP0DHW
 D GUIR^XBLM("PRINT^BGP0DHW","^TMP($J,""BGPGUI"",")
