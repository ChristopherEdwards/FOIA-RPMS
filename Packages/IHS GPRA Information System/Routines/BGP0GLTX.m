BGP0GLTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 10 LAB TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP0GLTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LAB TAXONOMY REPORT" D ^%ZTLOAD Q
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP0DLT",BGPRT=7:"ONM^BGP0DLT",BGPRT=2:"CRS^BGP0DLT",BGPRT=4:"ELDER^BGP0DLT",BGPRT=3:"HEDIS^BGP0DLT",BGPRT=5:"CMS^BGP0DLT",BGPRT=8:"EO^BGP0DLT")  ;cmi/maw added 10/30/2009
 D GUIR^XBLM("PRINT^BGP0DLT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP")  ;done in LABTAXC^BGP0GU
 S:$D(ZTQUEUED) ZTREQ="@"
