BGP0GMTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 10 MED TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP0GMTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI MEDICATION TAXONOMY REPORT" D ^%ZTLOAD Q
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP0DMT",BGPRT=7:"ONM^BGP0DMT",BGPRT=2:"CRS^BGP0DMT",BGPRT=4:"ELDER^BGP0DMT",BGPRT=3:"HEDIS^BGP0DMT",BGPRT=5:"CMS^BGP0DMT",BGPRT=8:"EO^BGP0DMT")  ;cmi/maw added 10/30/2009
 D GUIR^XBLM("PRINT^BGP0DMT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP") done in MEDTAXC^BGP0GU
 S:$D(ZTQUEUED) ZTREQ="@"
