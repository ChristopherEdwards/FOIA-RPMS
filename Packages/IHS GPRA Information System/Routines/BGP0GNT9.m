BGP0GNT9 ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2009 10:56 PM 13 Dec 2006 7:35 AM ;
...
EP1 ;
 ...
 S BGPGUI=1
 S IOM=80,BGPIOSL=55
 S BGPRTYPE=1,BGP0RPTH="",BGPNGR09=1
...
NT ;
 ...
 I $G(BGPEXPT) S BGPFILEN="BG10"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
 I BGPYWCHW=2 D
 .S BGPNOW=$$NOW^XLFDT() S BGPNOW=$P(BGPNOW,".")_"."_$$RZERO^BGP0UTL($P(BGPNOW,".",2),6)
 .S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP0UTL(BGPBD)_$$D^BGP0UTL(BGPED)_$$D^BGP0UTL(BGPNOW)_"_000001"_".TXT"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP0GNT9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATL GPRA RPT 10 FOR 11" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP0D1
 K ^TMP($J,"BGPGUI")
 ...
 ;I $G(BGPYWCHW)=2 D HWSF^BGP0DNG9
 D ENDLOG
 D XIT
 Q
 ;
