BGP0GNTP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2009 10:56 PM 13 Dec 2006 7:35 AM ;
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP0GNTP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 06" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP0D1
 K ^TMP($J,"BGPGUI")
