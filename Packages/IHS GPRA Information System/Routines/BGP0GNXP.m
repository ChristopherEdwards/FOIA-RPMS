BGP0GNXP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2009 10:56 PM ;
 ;;11.0;IHS CLINICAL REPORTING;;JAN 06, 2011;Build 17
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 10 NATL EXPORT",597,1,1,,$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPXPBD=3090701,BGPXPTDT=3100630
 K BGPTAX S X=0
...
HOME ;
 ...
 S BGPGFNM=X
 S DIC="^BGPGUIT(",DIC(0)="L",DIADD=1,DLAYGO=90378.08,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP0GNXP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE0
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D GUIR^XBLM("PRINT^BGP7DNE0","^TMP($J,""BGPGUI"",")
