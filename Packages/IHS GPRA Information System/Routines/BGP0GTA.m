BGP0GTA ; IHS/CMI/LAB - BGPG Gui CRS Tables 2/2/2005 10:24:22 AM ;
...
GIALLC(RETVAL) ;-- get all GPRA measures for comm report
 ...
 S X=0 F  S X=$O(^BGPINDT("AOI",X)) Q:X'=+X  D
 . S Y=0 F  S Y=$O(^BGPINDT("AOI",X,Y)) Q:Y'=+Y  D
 .. Q:$P($G(^BGPINDT(Y,13)),U,1)=1
