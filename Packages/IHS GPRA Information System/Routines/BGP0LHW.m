BGP0LHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2009 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 10 LOCAL HT/WT",597,0,"B",$$NOW^XLFDT,,0)
 W !,ERR
 Q
...
NT ;
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIT(",DIC(0)="L",DIADD=1,DLAYGO=90378.08,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///"_$G(BGPROT)_";.08///"_BGPFILEN
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP0LHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT FILE" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP0D1
 K ^TMP($J,"BGPGUI")
