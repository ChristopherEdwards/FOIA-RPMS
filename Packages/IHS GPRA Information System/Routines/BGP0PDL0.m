BGP0PDL0 ; IHS/CMI/LAB - print ind 1 01 Jul 2009 8:03 PM ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
IC1 ;EP
 S BGPXXX=$P(^BGPINDT(BGPIC,12),U,6)
 I BGPINDT'="D" D:'$G(BGPSUMON) H1^BGP0PDL1
 I BGPINDT'="D" F BGPPC1=BGPXXX_".1",BGPXXX_".2",BGPXXX_".3" D PI^BGP0PDL1
 I BGPINDT'="D" D:'$G(BGPSUMON) H1^BGP0PDL1
 I BGPINDT'="D" F BGPPC1=BGPXXX_".4",BGPXXX_".5",BGPXXX_".6" D PI^BGP0PDL1
 D:'$G(BGPSUMON) H1^BGP0PDL1
 F BGPPC1=BGPXXX_".7",BGPXXX_".8",BGPXXX_".9" D PI^BGP0PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPINDT="D"
