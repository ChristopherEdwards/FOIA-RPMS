BGP0PDL4 ; IHS/CMI/LAB - print ind 1 01 Jul 2009 8:04 PM ;
...
I031 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".7.3D",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".8.3D",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".9.3D",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".7.3E",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".8.3E",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".9.3E",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".7.3F",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".8.3F",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".9.3F",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".7.3G",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".8.3G",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".9.3G",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".7.3H",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".8.3H",0)) D PI1^BGP0PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDTC("OR",BGPORXX_".9.3H",0)) D PI1^BGP0PDL1
 F BGPPC1=BGPORXX_".1",BGPORXX_".2",BGPORXX_".3" D PI^BGP0PDL1
 F BGPPC1=BGPORXX_".4",BGPORXX_".5",BGPORXX_".6" D PI^BGP0PDL1
 D I1AGE
 Q
I1AGE ;EP
 ;Q:BGPRTYPE'=4
...
I1AGEP ;
 ...
 S X="# w/BMI calculated or refusal" D S(X,1,1)
 ...
 S X=" " D S(X,1,1)
 S X="# D. w/refusal in past year" D S(X,1,1)
 F X=1:1:8 S V=$P(BGPDAC(X),U,10) S Y=V D S(Y,,X+1)
 S X="% D. w/refusal in past year w/% Total BMI" D S(X,1,1)
