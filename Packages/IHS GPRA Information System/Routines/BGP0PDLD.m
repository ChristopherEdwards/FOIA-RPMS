BGP0PDLD ; IHS/CMI/LAB - IHS gpra print ;
...
DEVSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDTC(BGPPC,22),U,4)
 ...I $P(^BGPINDTC(BGPPC,22),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDTC(BGPPC,22),U,7)
 ...I $P(^BGPINDTC(BGPPC,22),U,12)]"" D S(X,1,1) S X=" "_$P(^BGPINDTC(BGPPC,22),U,12)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,22),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDTC(BGPPC,22),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDTC(BGPPC,22),U,9)]""!($P(^BGPINDTC(BGPPC,22),U,10)]"")!($P(^BGPINDTC(BGPPC,22),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,22),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDTC(BGPPC,22),U,11)
 ...I X]"" D S(X,1,1)
 S X=" " D S(X,1,1)
...
H1 ;
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="2009" D S(X,1,1)
...
SUMMARY ;
 ...
 ..S X=""
 ..I $P(^BGPINDTC(BGPPC,0),U,4)["014.A"!($P(^BGPINDTC(BGPPC,0),U,4)["023.")!($P(^BGPINDTC(BGPPC,0),U,4)["016")!($P($G(^BGPINDTC(BGPPC,19)),U,13)) D  I 1
 ...S X=$P(^BGPINDTC(BGPPC,22),U,4)
 ...I $P(^BGPINDTC(BGPPC,22),U,7)]"" D S(X,1,1) S X=$P(^BGPINDTC(BGPPC,22),U,7)
 ...I $P(^BGPINDTC(BGPPC,22),U,12)]"" D S(X,1,1) S X=$P(^BGPINDTC(BGPPC,22),U,12)
 ...S $P(X,U,2)=$P(^TMP($J,"SUMMARYDEL DEVEL",BGPC,BGPO,BGPPC),U)
 ...S $P(X,U,3)=$P(^TMP($J,"SUMMARYDEL DEVEL",BGPC,BGPO,BGPPC),U,2)
 ...S $P(X,U,4)=$P(^TMP($J,"SUMMARYDEL DEVEL",BGPC,BGPO,BGPPC),U,3)
 ...S $P(X,U,5)=$P(^BGPINDTC(BGPPC,22),U,P1)
 ...S $P(X,U,6)=$P(^BGPINDTC(BGPPC,22),U,2),$P(X,U,7)=$P(^BGPINDTC(BGPPC,22),U,3)
 ...D S(X,1,1)
 ..E  D
 ...S X=$P(^BGPINDTC(BGPPC,22),U,4)
 ...I $P(^BGPINDTC(BGPPC,22),U,7)]"" D S(X,1,1) S X=$P(^BGPINDTC(BGPPC,22),U,7)
 ...
 ...S $P(X,U,3)=$P(^TMP($J,"SUMMARYDEL DEVEL",BGPC,BGPO,BGPPC),U,2)_"%"
 ...S $P(X,U,4)=$P(^TMP($J,"SUMMARYDEL DEVEL",BGPC,BGPO,BGPPC),U,3)_"%"
 ...S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,22),U,P1),"$","^")
 ...S $P(X,U,6)=$TR($P(^BGPINDTC(BGPPC,22),U,2),"$","^"),$P(X,U,7)=$P(^BGPINDTC(BGPPC,22),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDTC(BGPPC,22),U,9)]""!($P(^BGPINDTC(BGPPC,22),U,10)]"")!($P(^BGPINDTC(BGPPC,22),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,22),U,9),"$","^"),$P(X,U,6)=$TR($P(^BGPINDTC(BGPPC,22),U,10),"$","^") D
 ....S $P(X,U,7)=$P(^BGPINDTC(BGPPC,22),U,11)
 ...I X]"" D S(X,1,1)
 S X=" " D S(X,1,1)
 ;I $G(BGPNGR09) D
 ;.S X=" * PART 2011 target represented here is a preliminary target since it will be" D S(X,2,1)
 ;.S X="adjusted for FY 2010 actual results and FY 2011 appropriations." D S(X,1,1)
 S X=$S($G(BGPNGR09):"*",1:"*")_" Federally Administered Activities measure.  National 2009 rate is for federal" D S(X,1,1)
...
H1P ;
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="Target"_$S($G(BGPNGR09):"",1:""),$P(X,U,6)="2009",$P(X,U,7)="Target" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
H2 ;
 S X=" " D S(X,2,1)
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="Current",$P(X,U,6)="2009" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
SDP ;EP
 I BGPRTYPE'=1 Q  ;national gpra only
 ...
 ..Q:$P($G(^BGPINDTC(BGPPC,22)),U,13)  ;NON-part measures only
 ..S X=" " D S(X,1,1)
 ..S XX=" "_$P(^BGPINDTC(BGPPC,22),U,4)
 ..I $P(^BGPINDTC(BGPPC,22),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,22),U,7)
 ..I $P(^BGPINDTC(BGPPC,22),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,22),U,12)
 ...
 ....;S Y="" I $P(^BGPINDTC(BGPPC,22),U,9)]""!($P(^BGPINDTC(BGPPC,22),U,10)]"") S $P(Y,U,6)=$TR($P(^BGPINDTC(BGPPC,22),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDTC(BGPPC,22),U,10),"$","^")
...
PARTSDP ;
 ...
 .S BGPO="" F  S BGPO=$O(^TMP($J,"SUMMARYDEL DETAIL PAGE DEVEL",BGPC,BGPO)) Q:BGPO=""  D
 ..S BGPPC=$O(^TMP($J,"SUMMARYDEL DETAIL PAGE DEVEL",BGPC,BGPO,0))
 ..Q:'$P($G(^BGPINDTC(BGPPC,22)),U,13)  ;part only
 ..S X=" " D S(X,1,1)
 ..S XX=" "_$P(^BGPINDTC(BGPPC,22),U,4)
 ..I $P(^BGPINDTC(BGPPC,22),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,22),U,7)
 ..I $P(^BGPINDTC(BGPPC,22),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,22),U,12)
 ...
 ..S F=$P(^TMP($J,"SUMMARYDEL DETAIL PAGE DEVEL",BGPC,BGPO,BGPPC,F),U,4)
 ..S $P(XX,U,5)=F_$S($P(^BGPINDTC(BGPPC,0),U,4)["014.A"!($P(^BGPINDTC(BGPPC,0),U,4)["023.")!($P(^BGPINDTC(BGPPC,0),U,4)="016.A.1")!($P($G(^BGPINDTC(BGPPC,19)),U,13)):"",1:"%")
 ..S $P(XX,U,6)=$P(^BGPINDTC(BGPPC,22),U,P1),$P(XX,U,7)=$P(^BGPINDTC(BGPPC,22),U,2),$P(XX,U,8)=$P(^BGPINDTC(BGPPC,22),U,3)
 ..S BGPSN=0,BGPCNT=0 F  S BGPSN=$O(^TMP($J,"SUMMARYDEL DETAIL PAGE DEVEL",BGPC,BGPO,BGPPC,BGPSN)) Q:BGPSN'=+BGPSN  S BGPCNT=BGPCNT+1 D
 ...S BGPSASU=$P(^BGPGPDCT(BGPSN,0),U,9),X=$O(^AUTTLOC("C",BGPSASU,0)),BGPSNAM=$S(X:$P(^DIC(4,X,0),U),1:"?????"),BGPSNAM=$S($P(^BGPGPDCT(BGPSN,0),U,17):"+"_BGPSNAM,1:BGPSNAM)
 ...I $P(^BGPINDTC(BGPPC,0),U,4)["014.A"!($P(^BGPINDTC(BGPPC,0),U,4)["023.")!($P(^BGPINDTC(BGPPC,0),U,4)["016")!($P($G(^BGPINDTC(BGPPC,19)),U,13)) D  I 1
 ....S X="",$P(X,U,1)=BGPSASU_" "_BGPSNAM
 ...
 ...I BGPCNT=1 D S(XX,1,1) D
 ....;S Y="" I $P(^BGPINDTC(BGPPC,22),U,9)]""!($P(^BGPINDTC(BGPPC,22),U,10)]"") S $P(Y,U,6)=$TR($P(^BGPINDTC(BGPPC,22),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDTC(BGPPC,22),U,10),"$","^")
 ....S Y="" I $P(^BGPINDTC(BGPPC,22),U,9)]""!($P(^BGPINDTC(BGPPC,22),U,10)]"")!($P(^BGPINDTC(BGPPC,22),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDTC(BGPPC,22),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDTC(BGPPC,22),U,10),"$","^") D
 .....S $P(Y,U,8)=$P(^BGPINDTC(BGPPC,22),U,11)
 ....I Y]"" D S(Y,1,1)
 ...D S(X,1,1)
 S X=" " D S(X,1,1)
...
H2P ;
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="Current",$P(X,U,6)="Target"_$S($G(BGPNGR09):"",1:""),$P(X,U,7)="2009",$P(X,U,8)="Target" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
