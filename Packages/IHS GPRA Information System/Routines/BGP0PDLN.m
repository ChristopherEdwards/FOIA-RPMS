BGP0PDLN ; IHS/CMI/LAB - IHS gpra print ;
...
NONSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDTC(BGPPC,15),U,4)
 ...I $P(^BGPINDTC(BGPPC,15),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDTC(BGPPC,15),U,7)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,15),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDTC(BGPPC,15),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDTC(BGPPC,15),U,9)]""!($P(^BGPINDTC(BGPPC,15),U,10)]"")!($P(^BGPINDTC(BGPPC,15),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,15),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDTC(BGPPC,15),U,11)
 ...I X]"" D S(X,1,1)
 S X=" " D S(X,1,1)
...
SDP ;EP
 ...
 ..I $P(^BGPINDTC(BGPPC,15),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,15),U,7)
 ..I $P(^BGPINDTC(BGPPC,15),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,15),U,12)
 ...
 ....S Y="" I $P(^BGPINDTC(BGPPC,15),U,9)]""!($P(^BGPINDTC(BGPPC,15),U,10)]"")!($P(^BGPINDTC(BGPPC,15),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDTC(BGPPC,15),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDTC(BGPPC,15),U,10),"$","^") D
