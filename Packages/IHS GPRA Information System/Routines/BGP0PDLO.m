BGP0PDLO ; IHS/CMI/LAB - IHS gpra print ;
...
OTHSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDTC(BGPPC,19),U,4)
 ...I $P(^BGPINDTC(BGPPC,19),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDTC(BGPPC,19),U,7)
 ...
 ...S $P(X,U,5)=$P(^BGPINDTC(BGPPC,19),U,2),$P(X,U,6)=$P(^BGPINDTC(BGPPC,19),U,3)
 ...D S(X,1,1)
 ..E  D
 ...S X=" "_$P(^BGPINDTC(BGPPC,19),U,4)
 ...I $P(^BGPINDTC(BGPPC,19),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDTC(BGPPC,19),U,7)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,19),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDTC(BGPPC,19),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDTC(BGPPC,19),U,9)]""!($P(^BGPINDTC(BGPPC,19),U,10)]"")!($P(^BGPINDTC(BGPPC,19),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDTC(BGPPC,19),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDTC(BGPPC,19),U,11)
 ...I X]"" D S(X,1,1)
 D SDP
 Q
 ;
H1 ;
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="2009",$P(X,U,6)="Target" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
H2 ;
 S X=" " D S(X,2,1)
 S X="SELECTED OTHER NATIONAL MEASURES CLINICAL PERFORMANCE DETAIL" D S(X,2,1)
 S X="",$P(X,U,2)=" Site",$P(X,U,3)=" Site",$P(X,U,4)=" Site",$P(X,U,5)="Area",$P(X,U,6)="National",$P(X,U,7)="2011" D S(X,1,1)
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="Current",$P(X,U,6)="2009",$P(X,U,7)="Target" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
SDPX ;
 I BGPRTYPE'=7 Q  ;national gpra only
 ...
 ..I $P(^BGPINDTC(BGPPC,19),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,19),U,7)
 ..I $P(^BGPINDTC(BGPPC,19),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDTC(BGPPC,19),U,12)
 ..S F=$O(^TMP($J,"SUMMARYDEL DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,0))
 ..S F=$P(^TMP($J,"SUMMARYDEL DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,F),U,4)
 ..S $P(XX,U,5)=$P(^BGPINDTC(BGPPC,19),U,2),$P(XX,U,6)=$P(^BGPINDTC(BGPPC,19),U,3)
 ...
 ....S Y="" I $P(^BGPINDTC(BGPPC,19),U,9)]""!($P(^BGPINDTC(BGPPC,19),U,10)]"")!($P(^BGPINDTC(BGPPC,19),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDTC(BGPPC,19),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDTC(BGPPC,19),U,10),"$","^") D
