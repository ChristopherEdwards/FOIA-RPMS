BGP0PDLT ; IHS/CMI/LAB - print ind 1 03 Jul 2009 7:40 AM ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP0DPH Q:BGPQUIT  W !,^BGPINDT(BGPIC,53,1,0) W:$D(^BGPINDT(BGPIC,53,2,0)) !,^BGPINDT(BGPIC,53,2,0)  D HPA^BGP0DPH
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF=156_"."_BGPPAD_".1"_BGPX S BGPPC=$O(^BGPINDTC("OR",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF=156_"."_BGPPAD_".2"_BGPX  S BGPPC=$O(^BGPINDTC("OR",BGPF,0))
...
PR ; 
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP0DPH Q:BGPQUIT  W !,^BGPINDT(BGPIC,53,1,0) W:$D(^BGPINDT(BGPIC,53,2,0)) !,^BGPINDT(BGPIC,53,2,0) D HPA^BGP0DPH
...
BL ;
 D:'$G(BGPSUMON) HEADER^BGP0DPH Q:BGPQUIT  W !,^BGPINDT(BGPIC,53,1,0) W:$D(^BGPINDT(BGPIC,53,2,0)) !,^BGPINDT(BGPIC,53,2,0) D HPA^BGP0DPH
