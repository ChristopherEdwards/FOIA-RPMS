BGP0UTLC ; IHS/CMI/LAB - 27 Apr 2008 11:01 PM 30 Aug 2008 10:16 AM 30 Jun 2009 4:58 PM ;
...
DEV ;EP - area export file
 ...
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2010",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,22)
...
GNT4 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2010",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,23)
