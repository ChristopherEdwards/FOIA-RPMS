BGP0XTEL ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;10.0;IHS CLINICAL REPORTING;;JUN 18, 2010
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2010 Elder Care Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP0XTEL",XBNS="",XBRX="XIT^BGP0XTEL"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
