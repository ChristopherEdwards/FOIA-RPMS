BGP1CTXC ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT 18 Feb 2010 5:31 PM ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2011 CMS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP1CTXC",XBNS="",XBRX="XIT^BGP1CTXC"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
THISRPT ;
 ...
 ...S BGPTYPE=$P(^BGPTAXB(BGPY,0),U,2),Y=$G(^BGPTAXB(BGPY,11,1,0)),BGPT=$P(^BGPTAXB(BGPY,0),U)
 ...I BGPTYPE'="L" D
 ....I '$D(^ATXAX("B",BGPT)) S A(BGPT)=Y_"^is Missing" Q
 ....S I=$O(^ATXAX("B",BGPT,0))
 ....I '$D(^ATXAX(I,21,"B")) S A(BGPT)=Y_"^has no entries "
