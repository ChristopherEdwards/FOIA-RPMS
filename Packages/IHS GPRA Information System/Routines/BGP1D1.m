...
PROC ;EP
 ...
 D XTMP^BGP1UTL("BGP18CPL","National GPRA Comp List")
 D XTMP^BGP1UTL("BGP1DNP","National GPRA Patient List")
 D XTMP^BGP1UTL("BGP1D","CRS Local Patient List")
 ...
 .;I DUZ=5634,'$D(^DIBT(4759,1,DFN)) Q
 .;I DUZ=5634,DFN'=25361 Q
 .;Q:DFN'=1241
 .;I DUZ=5634 Q:$$HRN^AUPNPAT(DFN,DUZ(2))'=161085
...
N ;
 I BGPRTYPE=1,$G(BGPEXPT),'$G(BGP1GPU) S ^BGPGPDCB(BGPRPT,88888,0)="^90545.0388888A^"_BGPCHWC_"^"_BGPCHWC
 I $G(BGPYWCHW) S ^BGPGPDCB(BGPRPT,88888,0)="^90545.0388888A^"_BGPCHWC_"^"_BGPCHWC
 S BGPET=$H
 Q
 ;
PROCCY ;EP - current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDCB(",BGPRTYPE=5:"^BGPELDCB(",BGPRTYPE=8:"^BGPEOCB(",1:"^BGPGPDCB(")
 S BGP365=BGPBDATE
 ...
 I $G(BGPIISO) D ISS^BGP1DPA1 K ^TMP($J,"A") Q  ;SCHEDULING OPTION
 D CALCIND
 I BGPRTYPE=1,$G(BGPYWCHW),'$G(BGP1GPU) D
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDPB(",BGPRTYPE=5:"^BGPELDPB(",BGPRTYPE=8:"^BGPEOPB(",1:"^BGPGPDPB(")
 S BGP365=BGPBDATE
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDBB(",BGPRTYPE=5:"^BGPELDBB(",BGPRTYPE=8:"^BGPEOBB(",1:"^BGPGPDBB(")
 S BGP365=BGPBDATE
 ...
 Q
CALCIND ;
 I BGPRTYPE=3 D CALCIND^BGP1DCHI Q
 I BGPRTYPE=5 D CALCIND^BGP1DCEI Q
 I BGPRTYPE=8 D CALCIND^BGP1EOCI Q
 D CALCIND^BGP1DCI
 Q
...
URBACTCL ;URBAN
 ...
 .S B=$$CLINIC^APCLV(V,"C")
 .Q:B=""
 .Q:'$D(^BGPCTRL($O(^BGPCTRL("B",2011,0)),1301,"B",B))
 .S F=F+1
 Q $S(F>1:1,1:0)
FIRSTDM(P,EDATE) ;
 I $G(P)="" Q ""
