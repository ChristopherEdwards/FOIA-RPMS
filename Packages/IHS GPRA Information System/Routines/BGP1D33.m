...
OPV(P,EDATE) ;EP
 ...
 I $$PLTAX^BGP1DU(P,"BGP OPV EVID DISEASE") Q 4_U_"evid Polio"
 ...
 I $$PLTAX^BGP1DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"contra Polio"
 F BGPZ=2,89 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - Polio"
 F BGPZ=10,89,110,120,130,132 S X=$$ANNECONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - Polio"
 ;now go to refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
 F BGPIMM=2,89,10,110,120,130,132 D
 ...
 F BGPIMM=2,89,10,110,120,130,132 S R=$$IMMREF^BGP1D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
MRC ;
 F BGPZ=4 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
...
RMC ;
 F BGPZ=38 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
...
MEX ;
 ...
 F BGPZ=5 S X=$$MMRCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPME=4
MUX ;
 ...
 F BGPZ=7 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPMU=4
RUBX ;
 ...
 F BGPIMM=6 I $$IMMREF^BGP1D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE) S BGPRUB=3
 F BGPZ=6 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPRUB=4
