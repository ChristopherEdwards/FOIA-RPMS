BGP1D36 ; IHS/CMI/LAB - measure C 06 Nov 2009 2:03 PM 28 May 2011 4:23 PM ;
...
MEN(P,EDATE) ;EP
 ...
 F BGPZ=32,108,114 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=32,108,114 S R=$$IMMREF^BGP1D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
HPV(P,EDATE) ;EP
 ...
 ;now check refusals in imm pkg
 F BGPIMM=62,118 S R=$$IMMREF^BGP1D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"ref")_" HPV"
 F BGPZ=62,118 S X=$$ANCONT^BGP1D31(P,BGPZ,EDATE) Q:X]""
...
H1N1 ;EP - called from measure
 ...
 I BGPN1!(BGPN2) S BGPVALUE=BGPVALUE_$S($P(BGPH1N1,U,1):$$DATE^BGP1UTL($P(BGPH1N1,U,1))_" "_$P(BGPH1N1,U,2),1:"")
 I $P(BGPH1N1,U,3) S BGPVALUE=BGPVALUE_"; "_$$DATE^BGP1UTL($P(BGPH1N1,U,3))_" "_$P(BGPH1N1,U,4)  ;:"2 doses",$P(BGPH1N1,U,1):"1 dose",1:"")_" "_$$DATE^BGP1UTL($P(BGPH1N1,U))_" "_$$DATE^BGP1UTL($P(BGPH1N1,U,2))
 Q
