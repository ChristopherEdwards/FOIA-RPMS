BGP1D51 ; IHS/CMI/LAB - measure I2 ;
...
ICRSAMM ;EP
 ...
 S BGPN2=$$EAPT^BGP1D52(DFN,$P(BGPC2,U),$$FMADD^XLFDT($P(BGPC2,U),114),84,30,114)
 S BGPN3=$$EAPT^BGP1D52(DFN,$P(BGPC2,U),$$FMADD^XLFDT($P(BGPC2,U),231),180,51,231)
 I BGPACTCL S BGPD1=1
 I BGPACTUP S BGPD2=1
 S BGPVALUE=$S($G(BGPRTYPE)=3:"AC",BGPD1:"UP,AC",1:"UP")
 S BGPV="IESD: "_$$DATE^BGP1UTL($P(BGPC1,U,2))
 ...
 ;S BGPVALUE=BGPVALUE_" IESD: "_$$DATE^BGP1UTL($P(BGPC1,U,2))_"|||"_BGPV
