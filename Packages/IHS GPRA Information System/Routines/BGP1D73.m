BGP1D73 ; IHS/CMI/LAB - measure 31 ;
...
CHEL ;EP - called from elder care
 ...
 S BGPLDL=$$LDL^BGP1D2(DFN,$$FMADD^XLFDT(BGPEDATE,-(5*365)),BGPEDATE) ;date^value
 ...
 I BGPVALUE]"" S V=V_"CHOL: "_$$DATE^BGP1UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 I $P(BGPLDL,U) S V=V_$S(BGPVALUE]"":"; ",1:"") S V=V_"LDL: "_$$DATE^BGP1UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
 S BGPVALUE=V
