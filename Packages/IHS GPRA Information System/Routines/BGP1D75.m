BGP1D75 ; IHS/CMI/LAB - measure 31 ;
...
IAMT ;EP
 ...
 I 'BGPN2 S BGPBETA("REF")=$$BETAREF^BGP1D721(DFN,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPBETA("REF") S BGPN3=1
 I 'BGPN2 S BGPBETA("CONTRA")=$$BETACONT^BGP1D721(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,$P(BGPAMI,U,2),$P(BGPAMI,U,4)) I BGPBETA("CONTRA") S BGPN4=1 ;beta contraindication
 ...
 I 'BGPN6 S BGPASA("REF")=$$ASAREF^BGP1D721(DFN,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPASA("REF") S BGPN7=1
 ...
 I 'BGPN6 S BGPASA("ADR")=$$ASAALLEG^BGP1D721(DFN,BGPEDATE) I BGPASA("ADR") S BGPN8=1
 ...
 I 'BGPN10 S BGPACE("REF")=$$ACEREF^BGP1D722(DFN,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPACE("REF") S BGPN11=1
 ...
 I 'BGPN10 S BGPACE("ADR")=$$ACEALG^BGP1D722(DFN,BGPBDATE,BGPEDATE) I BGPACE("ADR") S BGPN12=1
 ...
 I 'BGPN14 S BGPSTAT("REF")=$$STATREF^BGP1D722(DFN,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPSTAT("REF") S BGPN15=1
 I 'BGPN14 S BGPSTAT("CONTRA")=$$STATCON^BGP1D722(DFN,BGPBDATE,BGPEDATE,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPSTAT("CONTRA") S BGPN16=1 ;beta contraindication
...
ASACONTR(P,BDATE,EDATE,BGPADM,BGPDD) ;does patient have an aspirin allergy
 K BGPMEDS1
 S K=0,R="",BGPG=""
 D GETMEDS^BGP1UTL2(P,$$FMADD^XLFDT(BGPADM,-180),BGPDD,,,,,.BGPMEDS1)
 I '$D(BGPMEDS1) Q ""
...
WAR71 .;
 ...
 .I E=BGPDD S BGPG=1_U_$$DATE^BGP1UTL($P($P(^AUPNVSIT(V,0),U),"."))_U_$P(^PSDRUG(D,0),U) Q
 ...
 I BGPG Q 1_U_$$DATE^BGP1UTL($P(BGPG,U,3))_" Contra POV 459.0 "
 ;
 ...
 ...S BGPG=1_U_$$DATE^BGP1UTL($P(^AUPNPREF(N,0),U,3))_" Contra NMI Aspirin "_$$VAL^XBDIQ1(9000022,N,.04)  ;_" "__" "_$$VAL^XBDIQ1(9000022,X,1101)
 ..Q
 .Q
 I BGPG Q BGPG
 ;now check for CPT code G8008
 S X=$$CPTI^BGP1DU(P,BGPADM,BGPDD,+$$CODEN^ICPTCOD("G8008"))
 I X Q 1_U_$$DATE^BGP1UTL($P(X,U,2))_" Contra CPT code G8008"
 S X=$$TRANI^BGP1DU(P,BGPADM,BGPDD,+$$CODEN^ICPTCOD("G8008"))
 I X Q 1_U_$$DATE^BGP1UTL($P(X,U,2))_" Contra Tran Code G8008"
 Q ""
ACECONT(P,BDATE,EDATE,NMIB,NMIE,RPBD) ;EP does patient have an ACEI contra
 ...
 I BGPG Q BGPG
 ;PREGNANCY
 S X=$$PREG^BGP1D7(P,$S($G(RPBD):RPBD,1:NMIB),EDATE,0,1) I X Q 1_U_"Contra ACEI - pregnant"
 ;breastfeeding
