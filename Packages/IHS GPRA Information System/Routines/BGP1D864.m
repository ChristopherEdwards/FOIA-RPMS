BGP1D864 ; IHS/CMI/LAB - measure C ;
...
GOLDLAB(P,BDATE,EDATE) ;EP
 ...
 ;CBC'S
 K BGPC
 S %="",E=+$$CODEN^ICPTCOD(85025),%=$$CPTI^BGP1DU(P,BDATE,EDATE,E)
 I %]"" S BGPC($P(%,U,2))=""
 S %="",E=+$$CODEN^ICPTCOD(85027),%=$$CPTI^BGP1DU(P,BDATE,EDATE,E)
 I %]"" S BGPC($P(%,U,2))=""
 S %="",E=+$$CODEN^ICPTCOD(85025),%=$$TRANI^BGP1DU(P,BDATE,EDATE,E)
 I %]"" S BGPC($P(%,U,2))=""
 S %="",E=+$$CODEN^ICPTCOD(85027),%=$$TRANI^BGP1DU(P,BDATE,EDATE,E)
 I %]"" S BGPC($P(%,U,2))=""
