BGP1DAR9 ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 09 Apr 2011 10:03 AM ;
 ...
 W !,"2012 GPRA year using the same performance measure definitions from CRS"
 W !,"Version 10.0."
 W !!
INTRO ;
 D EXIT
...
EISSEX ;
 ...
 .S BGPFGNT1="CRSGPRANT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP1UTL(BGPNOW)_"_"_$$LZERO^BGP1UTL(BGPC,6)_".TXT"
 .S BGPFGNT2="CRSGPRANT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP1UTL(BGPNOW)_"_"_$$LZERO^BGP1UTL(BGPC,6)_".TXT"
 .S BGPFDEV1="CRSGPRADEVNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP1UTL(BGPNOW)_"_"_$$LZERO^BGP1UTL(BGPC,6)_".TXT"
 .S BGPFDEV2="CRSGPRADEVNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP1UTL(BGPNOW)_"_"_$$LZERO^BGP1UTL(BGPC,6)_".TXT"
