BGP1DCHA ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 02 Jul 2010 2:14 PM ;
...
GS ;EP - write out file
 ...
 ;.S BGPY=0 F  S BGPY=$O(^BGPGPDCB(BGPX,88888,BGPY)) Q:BGPY'=+BGPY  D
 ;..S BGPC=BGPC+1
 ;..S ^BGPDATA(BGPC)=^BGPGPDCB(BGPX,88888,BGPY,0)
 ;..Q
 ;.Q
 ;S XBGL="BGPDATA"
 ...
 Q
HWSF2 ;
 S BGPX=0 F  S BGPX=$O(^BGPGPDCB(BGPRPT,88888,BGPX)) Q:BGPX'=+BGPX  S BGPTOT=BGPTOT+1,^TMP($J,"HTWTR",BGPTOT)=^BGPGPDCB(BGPRPT,88888,BGPX,0)
 Q
HWSF3 ;
 ...
 S BGPX=0,BGPLX=0
 F BGPZ=1:1:BGPNF D
 .S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D(BGPBD)_$$D(BGPED)_BGPNOW_"_"_$$LZERO^BGP1UTL(BGPZ,3)_"_of_"_$$LZERO^BGP1UTL(BGPNF,3)_".TXT"
 .S BGPFNX(BGPZ)=BGPFN
