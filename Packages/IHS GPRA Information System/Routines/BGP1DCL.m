BGP1DCL ; IHS/CMI/LAB - national patient list 20 Dec 2004 9:24 AM ;
...
SI ;
 ...
 ;get report type
 I $D(DIRUT) G XIT
 D RT^BGP1DSL I '$D(BGPLIST)!($D(BGPQUIT)) G XIT
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1DCL",XBRX="XIT^BGP1DCL",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1DCL",ZTDTH="",ZTDESC="COMPREHENSIVE PT LIST GPRA 06" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
