BGP1DGPU ; IHS/CMI/LAB - IHS AREA CLIN 05 REPORT DRIVER ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS GPRA & PART Performance Report for a User Selected Date Range",80)
INTRO ;
 D XIT
 W !!,"This will produce a GPRA & PART report for a year period you specify."
...
SUM ;display summary of this report
 W:$D(IOF) @IOF
 W !,$$CTR("SUMMARY OF IHS GPRA & PART PERFORMANCE REPORT TO BE GENERATED")
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1DGPU",XBRX="XIT^BGP1DGPU",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1DGPU",ZTDTH="",ZTDESC="NATIONAL GPRA GPU REPORT 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
