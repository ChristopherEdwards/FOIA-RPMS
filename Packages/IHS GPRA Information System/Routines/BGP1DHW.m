BGP1DHW ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2011 National GPRA & PART Height and Weight Local Data File",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
SUM ;display summary of this report
 ...
 S BGPROT="P",BGPDELT="" ;D PT^BGP1DSL
 I BGPROT="" G BEN
ZIS ;call to XBDBQUE
 D REPORT^BGP1UTL
 I $G(BGPQUIT) D XIT Q
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1DHW",XBRX="XIT^BGP1DHW",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1DHW",ZTDTH="",ZTDESC="NATIONAL GPRA LOCAL HW DATA" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
