BGP1DNG9 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM 31 Jul 2011 11:21 AM 13 Aug 2011 5:44 PM ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2012 National GPRA & PART Report",80)
INTRO ;
 D XIT
 W !!,"This will produce a National GPRA & PART report for the 2012 GPRA year using"
 ...
 W !,"will be included.  This report will be run for the Report Period July 1, 2011"
 W !,"through June 30, 2012 with a Baseline Year of July 1, 1999 through"
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1DNG9",XBRX="XIT^BGP1DNG9",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1DNG9",ZTDTH="",ZTDESC="GPRA AND PART REPORT 11 for 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
