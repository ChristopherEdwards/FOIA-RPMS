BGP1DNGS ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2011 National GPRA & PART Report Clinical Performance Summaries",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
TP ;get time period
 D XIT
 S BGPRTYPE=1,BGP1RPTH="",BGPSUMON=1
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1DNGS",XBRX="XIT^BGP1DNGS",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1DNGS",ZTDTH="",ZTDESC="NATIONAL GPRA & PART REPORT 11 SUM ONLY" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
