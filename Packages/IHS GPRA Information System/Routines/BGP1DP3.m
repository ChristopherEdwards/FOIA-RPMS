BGP1DP3 ; IHS/CMI/LAB - print ind 1 ;
...
I023 ;EP
 ...
 D H1 S BGPNODEN=1
 F BGPPC1=BGPORXX_".1" D PI^BGP1DP1C Q:BGPQUIT
 Q:BGPQUIT
...
PI ;EP
 ...
 S BGPPC=$O(^BGPINDBC("OR",BGPPC1,0))
 Q:'$$CHECK^BGP1DP1E(BGPPC)
 S BGPPC=BGPPC D
 .S BGPDF=$P(^BGPINDBC(BGPPC,0),U,9)
 .;I $P(^BGPINDBC(BGPPC,0),U,4)[".3" S BGPDF=23.503
 .;I $P(^BGPINDBC(BGPPC,0),U,4)[".4" S BGPDF=23.504
 ...
 .;I BGPRTYPE'=1 W !!,$P(^BGPINDBC(BGPPC,0),U,15)
 .;I BGPRTYPE=1 W !!
 .W:'$G(BGPSUMON) !! D
 ...
 .;I BGPRTYPE'=4,$P(^BGPINDBC(BGPPC,0),U,19)]"",$P(^BGPINDBC(BGPPC,0),U,19)'["GPRA" W !?1,$P(^BGPINDBC(BGPPC,0),U,19)
 .D H2
 Q
H2 ;EP
 Q:$G(BGPSUMON)
