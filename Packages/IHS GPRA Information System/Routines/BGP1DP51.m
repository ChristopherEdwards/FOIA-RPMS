BGP1DP51 ; IHS/CMI/LAB - print ind H ;
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF="H."_BGPX_".1" S BGPPC=$O(^BGPINDBC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="H."_BGPX_".2" S BGPPC=$O(^BGPINDBC("C",BGPF,0))
...
I1AGE3 ;
 S BGPF="H."_BGPX_".3" S BGPPC=$O(^BGPINDBC("C",BGPF,0))
...
I1AGE4 ;
 S BGPF="H."_BGPX_".4" S BGPPC=$O(^BGPINDBC("C",BGPF,0))
...
I1AGE5 ;
 G I1AGE6
 S BGPF="H."_BGPX_".5" S BGPPC=$O(^BGPINDBC("C",BGPF,0))
...
I1AGE6 ;
 S BGPF="H."_BGPX_".6" S BGPPC=$O(^BGPINDBC("C",BGPF,0))
