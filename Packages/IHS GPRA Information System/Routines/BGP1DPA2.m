BGP1DPA2 ; IHS/CMI/LAB - COMP NATIONAL GPRA FOR PTS W/APPT 03 Jun 2011 8:04 AM ;
...
I017 ;EP - colorectal cancer
 ...
 S BGPLAST=""
 S BGPFOB=$$FOB^BGP1D61(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)  ;last FOB test
 S D=$P(BGPFOB,U,2)
 I D]"",$$FMDIFF^XLFDT(DT,D)<365 S BGPIN=1
 I D>BGPLAST S BGPLAST=D
 S BGPSIG=$$SIG^BGP1D61(DFN,BGPEDATE,$$DOB^AUPNPAT(DFN))  ;last SIG test
 ...
 I D>BGPLAST S BGPLAST=D
 S BGPCOLO=$$COLO^BGP1D61(DFN,BGPEDATE,$$DOB^AUPNPAT(DFN))  ;last COLO test
 ...
 I D>BGPLAST S BGPLAST=D
 S BGPBE=$$BE^BGP1D61(DFN,BGPEDATE,$$DOB^AUPNPAT(DFN))  ;last BE test
 ...
 ;S BGPREF=$$REF^BGP1D61(DFN,BGPBDATE,BGPEDATE) I BGPREF S BGPSKIP=1 Q  ;refusal in past year
 S BGPN1=0
