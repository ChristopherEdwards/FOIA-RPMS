BGP1DPE2 ; IHS/CMI/LAB - calc measures 29 Apr 2010 7:38 PM 14 Nov 2006 5:02 PM 09 Jun 2011 5:18 PM ;
...
5 ;EP
 ...
 Q
SET51 ;
 I '$D(^BGPPEDCB(BGPRPT,15,0)) S ^BGPPEDCB(BGPRPT,15,0)="^90545.1215A^0^0"
 S Z=$O(^BGPPEDCB(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDCB(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDCB(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDCB(BGPRPT,15,0),U,3)+1,$P(^BGPPEDCB(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDCB(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDCB(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDCB(BGPRPT,15,"B",BGPT,Z)=""
 Q
SET52 ;
 I '$D(^BGPPEDPB(BGPRPT,15,0)) S ^BGPPEDPB(BGPRPT,15,0)="^90545.1315A^0^0"
 S Z=$O(^BGPPEDPB(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDPB(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDPB(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDPB(BGPRPT,15,0),U,3)+1,$P(^BGPPEDPB(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDPB(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDPB(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDPB(BGPRPT,15,"B",BGPT,Z)=""
 Q
SET53 ;
 I '$D(^BGPPEDBB(BGPRPT,15,0)) S ^BGPPEDBB(BGPRPT,15,0)="^90545.1515A^0^0"
 S Z=$O(^BGPPEDBB(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDBB(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDBB(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDBB(BGPRPT,15,0),U,3)+1,$P(^BGPPEDBB(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDBB(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDBB(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDBB(BGPRPT,15,"B",BGPT,Z)=""
 Q
6 ;EP
 Q:'$D(^AUPNVPED("AC",DFN))  ;no education so don't bother
 K BGPALLED,BGPEDPRV S BGPVALUE=""
