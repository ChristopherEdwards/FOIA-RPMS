BGP1EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS =>55",BGPHD2="# Active Diabetics"
 D HEADER^BGP1DPH Q:BGPQUIT  W !,^BGPELIB(BGPIC,53,1,0)  D H3^BGP1EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP1DPH Q:BGPQUIT  W !,^BGPELIB(BGPIC,53,1,0) D H3^BGP1EL12
