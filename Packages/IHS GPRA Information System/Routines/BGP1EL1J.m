BGP1EL1J ; IHS/CMI/LAB - print ind 1 ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE CLINICAL PATIENTS",BGPHD2="# Active Clinical"
 ...
 D I1AGEP
MALE ;
 S BGPHD1="MALE ACTIVE CLINICAL PATIENTS =>55",BGPHD2="# Male Active Clin"
 D HEADER^BGP1DPH Q:BGPQUIT  W !,^BGPELIB(BGPIC,53,1,0)  D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="FSE.1","FSE.2","FSE.3","FSE.4" D I1AGE1
 D I1AGEP
FEMALE ;
 S BGPHD1="FEMALE ACTIVE CLINICAL PATIENTS =>55",BGPHD2="# Female Active Clin"
 D HEADER^BGP1DPH Q:BGPQUIT  W !,^BGPELIB(BGPIC,53,1,0)  D H3
