BGP1EL3 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2010 1:44 PM ;
...
I9 ;EP
 ...
 S BGPVALUE=$$FLU^BGP1D3(DFN,,BGPEDATE) ;set to date of flu shot
 ...
 S BGPVALUE="AC"_"|||"_$$DATE^BGP1UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2)
...
I11 ;EP
 ...
 I $$MAS^BGP1D4(DFN,BGPEDATE) S BGPSTOP=1 Q
 S BGPD1=1
 I BGPAGEB>54,BGPAGEB<65 S BGPD2=1
 I BGPAGEB>64,BGPAGEB<75 S BGPD3=1
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPMAM=$$MAM^BGP1D4(DFN,BGPEDATE,2)
 S BGPN1=0 I $P(BGPMAM,U)=1 S BGPN1=1
 S BGPN2=0 I $P(BGPMAM,U,3)["ref" S BGPN2=1
 I BGPN1,'BGPN2 S BGPN3=1
 S BGPVALUE="AC"_"|||"_$$DATE^BGP1UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,J,K,G,I,L,T,BGPLHGB
...
I13 ;EP
 ...
 S BGPVALUE="AC|||"_$P(BGPVALUE,"|||",2)
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,BGPSDX,BGPXPBD,BGP1320
 K BGPX,BGPY,BGPC,BGPG
 Q
I14 ;EP
 S (BGPD1,BGPD2,BGPD3,BGPD4,BGPD5)=0
...
I16 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPBMI=$$BMI^BGP1D6(DFN,BGPEDATE,BGPAGEE),BGPN1=$S(BGPBMI]"":1,1:0)
 S BGPN2=$$OW^BGP1D6(DFN,BGPBMI,BGPAGEE)
 S BGPN3=$$OB^BGP1D6(DFN,BGPBMI,BGPAGEE)
 I BGPN2!(BGPN3) S BGPN4=1
 I 'BGPN1 S BGPREF=$$REF^BGP1D6(DFN,BGP365,BGPEDATE,BGPAGEB) I $P(BGPREF,U)=1 S BGPN5=1
 ;I BGPN5 S BGPN1=1
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP1PDL1($J($P(BGPBMI,U),6,2)),1:"")_" "_$S(BGPN2:"OW",1:"")_" "_$S(BGPN3:"OB",1:"")
 I BGPN5 S BGPVALUE=BGPVALUE_"ref "_$P(BGPREF,U,2)_" "_$$DATE^BGP1UTL($P(BGPREF,U,3))_" "_$P(BGPREF,U,5)_" "_$$DATE^BGP1UTL($P(BGPREF,U,6))
...
I19 ;EP
 ...
 S BGPVALUE=BGPVALUE_"Fracture: "_Y_" on "_$$DATE^BGP1UTL($P(BGPFRAC,U,2))_"|||"_$P(BGPBMD,U,2)
...
IRAO ;EP
 ...
 S BGPPAP=$$OSTEOSCR^BGP1D42(DFN,$$FMADD^XLFDT(BGPBDATE,-(365*2)),BGPEDATE)
 I BGPPAP S BGPN1=1
 I 'BGPN1 S BGPPAP=$$OSTEOREF^BGP1D42(DFN,BGPBDATE,BGPEDATE) I BGPPAP S BGPN2=1  ;refusal
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$$DATE^BGP1UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3) ;$P(BGPPAP,U,2)_" "_$$DATE^BGP1UTL($P(BGPPAP,U,3))_$S($P(BGPPAP,U,1)=3:" (refused)",1:"")
 K BGPPAP,X
 Q
 ;
IRAA ;EP
...
FRACTURE(P,BDATE,EDATE) ;EP
 ...
 K BGPG S Y="BGPG("
 S BGPG=$$FIRSTPRC^BGP1UTL1(P,"BGP FRACTURE PROCEDURES",BDATE,EDATE)
 I $P(BGPG,U)=1 D
 .S D=$P(BGPG,U,3)
 ...
 ;n
 ;
 S BGPX=$$TXBMD^BGP1EL4(P,$$FMADD^XLFDT(BGPISD,-365),$$FMADD^XLFDT(BGPISD,-1)) I $P(BGPX,U) S $P(BGPV(BGPISD,BGPISV),U,5)=$P(BGPX,U,2) Q ""
...
FRACT(P,FBD,FED) ;
 ...
 I BGPG Q 1
 ;
 S BGPG=$$FIRSTPRC^BGP1UTL1(P,"BGP FRACTURE PROCEDURES",FBD,FED)
 I $P(BGPG,U)=1 Q 1
 Q ""
