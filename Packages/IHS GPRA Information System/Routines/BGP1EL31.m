BGP1EL31 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2010 1:44 PM ;
...
IELDFSA ;EP
 ...
 S BGPVALUE=$$FUNCTION^BGP1EL4(DFN,BGPBDATE,BGPEDATE)
...
IELDASA ;EP
 ...
 I BGPAGEB>84 S BGPD5=1
 S BGPHOSPL=""
 S BGPN1=$$V2ASTH^BGP1D31(DFN,BGP365,BGPEDATE)
 I BGPN1 S BGPHOSPL=$$HOSP^BGP1D31(DFN,BGP365,BGPEDATE) I BGPHOSPL S BGPN2=1
 S BGPVALUE="AC"_"|||"_$S(BGPN1:$$LAST^BGP1D31(DFN,BGP365,BGPEDATE),1:"")_" "_$S(BGPHOSPL:"H "_$$DATE^BGP1UTL($P(BGPHOSPL,U,2)),1:"")
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,T,BGPG
 Q
IELDPHA ;EP - PHN
 S (BGPD1,BGPD2,BGPD3,BGPD4,BGPD5)=0
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$PHNV^BGP1EL4(DFN,BGP365,BGPEDATE,BGPHOME)
 S BGPN1=BGPVALUE
