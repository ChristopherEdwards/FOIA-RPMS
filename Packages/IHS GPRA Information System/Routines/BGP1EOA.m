BGP1EOA ; IHS/CMI/LAB - IHS GPRA 10 REPORT DRIVER ;
...
CHOICE ;
 ...
 W !?11,"- June 30, 2011, and AI/AN patients only)"
...
DRIVER ;
 U IO
 S BGPIFTR=0 D PRINT^BGP1EOP
 I $G(BGPIFTR) D EONT1^BGP1EOUT
 D ^%ZISC
 D XIT
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1EOA",XBRX="XIT^BGP1EOA",XBNS="BGP"
 D ^XBDBQUE
 ;D XIT
 Q
 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1EOA",ZTDTH="",ZTDESC="EO 09 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
