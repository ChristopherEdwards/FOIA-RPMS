BGP1EOD ; IHS/CMI/LAB - IHS GPRA 10 REPORT DRIVER ;
...
CHOICE ;
 ...
 W !?11,"July 1, 2010 - June 30, 2011, baseline period of July 1, 1999"
 ...
 S BGPRTC=Y
INTRO ;
 S BGPFYI=$O(^BGPCTRL("B",2011,0))
 I BGPRTC="H" D  G:X COMM I 'X W !!,"Exiting Report....." D PAUSE^BGP1CL,XIT Q
 ...
 .W !,"This report will be run for the Report Period July 1, 2010 through "
 .W !,"June 30, 2011 with a Baseline Year of July 1, 1999 through June 30, 2000."
...
NT .;END TEST STUFF
 ...
 I $D(DIRUT) D XIT Q
 S BGPINDZ=Y
 I BGPINDZ="S" D EN^BGP1EOSI I '$D(BGPIND) W !!,"No measures selected" G CHOICE
...
ZIS ;call to XBDBQUE
 ...
 I BGPRPT="" D XIT Q
 I BGPEXPT D
 .W !!,"A file will be created called BG11",$P(^AUTTLOC(DUZ(2),0),U,10)_".EO"_BGPRPT," and will reside",!,"in the ",BGPUF," directory.",!
 ...
 I POP W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPEOCB(" D ^DIK K DIK D XIT Q
 I POP W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPEOPB(" D ^DIK K DIK D XIT Q
 I POP W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPEOBB(" D ^DIK K DIK D XIT Q
 I $D(IO("Q")) G TSKMN
DRIVER ;
 D ^BGP1D1
 U IO
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP1EOD",XBRX="XIT^BGP1EOD",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP1EOD",ZTDTH="",ZTDESC="EO 2010 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
...
LISTS ;any lists with measures?
 ...
 I $D(BGPLIST) D RT^BGP1EOSL I '$D(BGPLIST)!($D(BGPQUIT)) G LISTS ;get report type for each list
 Q
CHKY ;
