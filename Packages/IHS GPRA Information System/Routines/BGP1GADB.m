BGP1GADB ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
TESTADSH ;
 ...
 S BGPSUL(1)=""
 S BGPSUL(2)=""
 D EP(.ERR,1,2522,"BGP 11 AREA DSH","A",.BGPSUL,"B",$$NOW^XLFDT,"LORITESTAREADASH")
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPRTYPE=1,BGPBEN=1,BGP1RPTH="",BGPDASH=1
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP1GADB",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11" D ^%ZTLOAD Q
 Q
AOAGP ;
 K ^TMP($J,"BGPGUI")
