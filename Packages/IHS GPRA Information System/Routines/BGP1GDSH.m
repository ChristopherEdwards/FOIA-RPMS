BGP1GDSH ; IHS/CMI/LAB - GPRA DASHBOARD GUI
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
TESTDSH ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 11 NATIONAL DASHBOARD",597,"B",$$NOW^XLFDT,,"LORITESTGUI")
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP1GDSH",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP1D1
 K ^TMP($J,"BGPGUI")
