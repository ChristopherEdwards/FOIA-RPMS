BGP1GMTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 11 MED TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIB(",DIC(0)="L",DIADD=1,DLAYGO=90546.08,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP1GMTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI MEDICATION TAXONOMY REPORT" D ^%ZTLOAD Q
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP1DMT",BGPRT=7:"ONM^BGP1DMT",BGPRT=2:"CRS^BGP1DMT",BGPRT=4:"ELDER^BGP1DMT",BGPRT=3:"HEDIS^BGP1DMT",BGPRT=5:"CMS^BGP1DMT",BGPRT=8:"EO^BGP1DMT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP1DMT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP") done in MEDTAXC^BGP1GU
 S:$D(ZTQUEUED) ZTREQ="@"
