BGP1PDL0 ; IHS/CMI/LAB - print ind 1 01 Jul 2010 8:03 PM ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
IC1 ;EP
 S BGPXXX=$P(^BGPINDB(BGPIC,12),U,6)
 I BGPINDB'="D" D:'$G(BGPSUMON) H1^BGP1PDL1
 I BGPINDB'="D" F BGPPC1=BGPXXX_".1",BGPXXX_".2",BGPXXX_".3" D PI^BGP1PDL1
 I BGPINDB'="D" D:'$G(BGPSUMON) H1^BGP1PDL1
 I BGPINDB'="D" F BGPPC1=BGPXXX_".4",BGPXXX_".5",BGPXXX_".6" D PI^BGP1PDL1
 D:'$G(BGPSUMON) H1^BGP1PDL1
 F BGPPC1=BGPXXX_".7",BGPXXX_".8",BGPXXX_".9" D PI^BGP1PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPINDB="D"
 ...
 S X=^BGPINDB(BGPIC,53,1,0) D S(X,1,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
