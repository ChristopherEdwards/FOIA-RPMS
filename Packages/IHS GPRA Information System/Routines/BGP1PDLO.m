BGP1PDLO ; IHS/CMI/LAB - IHS gpra print ;
...
OTHSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDBC(BGPPC,19),U,4)
 ...I $P(^BGPINDBC(BGPPC,19),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDBC(BGPPC,19),U,7)
 ...
 ...S $P(X,U,5)=$P(^BGPINDBC(BGPPC,19),U,2),$P(X,U,6)=$P(^BGPINDBC(BGPPC,19),U,3)
 ...D S(X,1,1)
 ..E  D
 ...S X=" "_$P(^BGPINDBC(BGPPC,19),U,4)
 ...I $P(^BGPINDBC(BGPPC,19),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDBC(BGPPC,19),U,7)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDBC(BGPPC,19),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDBC(BGPPC,19),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDBC(BGPPC,19),U,9)]""!($P(^BGPINDBC(BGPPC,19),U,10)]"")!($P(^BGPINDBC(BGPPC,19),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDBC(BGPPC,19),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDBC(BGPPC,19),U,11)
 ...I X]"" D S(X,1,1)
 D SDP
 Q
 ;
...
SDPX ;
 ...
 ..I $P(^BGPINDBC(BGPPC,19),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDBC(BGPPC,19),U,7)
 ..I $P(^BGPINDBC(BGPPC,19),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDBC(BGPPC,19),U,12)
 ..S F=$O(^TMP($J,"SUMMARYDEL DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,0))
 ..S F=$P(^TMP($J,"SUMMARYDEL DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,F),U,4)
 ..S $P(XX,U,5)=$P(^BGPINDBC(BGPPC,19),U,2),$P(XX,U,6)=$P(^BGPINDBC(BGPPC,19),U,3)
 ...
 ....S Y="" I $P(^BGPINDBC(BGPPC,19),U,9)]""!($P(^BGPINDBC(BGPPC,19),U,10)]"")!($P(^BGPINDBC(BGPPC,19),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDBC(BGPPC,19),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDBC(BGPPC,19),U,10),"$","^") D
