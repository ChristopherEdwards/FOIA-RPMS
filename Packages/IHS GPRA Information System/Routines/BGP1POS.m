BGP1POS ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 08 Dec 2010 3:10 PM ;
 ...
 I $E($$VERSION^XPDUTL("BGP"),1,3)<"11.0" D MES^XPDUTL($$CJ^XLFSTR("Version 11.0 of BGP is required.  Not installed.",80)) D SORRY(2) I 1
 I '$$INSTALLD("BGP*11.0*4") D SORRY(2)
