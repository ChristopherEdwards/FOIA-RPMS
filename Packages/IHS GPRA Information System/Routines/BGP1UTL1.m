BGP1UTL1 ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 02 Jul 2010 2:07 PM ;
...
RADREF(P,BDATE,EDATE,T) ;EP - return ien of CPT entry if patient had this CPT
 ...
 ..Q:'$$ICD^ATXCHK(C,T,1)
 ..S G="1^"_D_"^"_$P(^AUPNPREF(Y,0),U,7)_U_$P(^ICPT(C,0),U)
 .Q
 Q G
I1() ;EP
 I BGPVALUE="" Q 0
 I BGPINDB="E",BGPVALUE]"",BGPAGEB>64 Q 1
 I BGPINDB="E",BGPVALUE]"",BGPAGEB<65 Q 0
 I BGPVALUE]"" Q 1
 Q 0
I12() ;EP
 I BGPINDB="D" Q 1
 I BGPINDB="D",'BGPD4 Q 0
 I BGPINDB="E",(BGPD3+BGPD7) Q 1
 I BGPINDB="E",'(BGPD3+BGPD7) Q 0
 I BGPACTUP Q 1
 Q 0
I13() ;EP
 I BGPINDB="D",BGPD2 Q 1
 I BGPINDB="D",'BGPD2 Q 0
 I BGPINDB="E",(BGPD3+BGPD1) Q 1
 I BGPINDB="E",'(BGPD3+BGPD1) Q 0
...
IA() ;EP
 ...
 NEW X
 S X=BGPN1
 I BGPINDB="D",BGPD7,'X Q 1
 I BGPINDB="D",BGPD7,X Q 1   ;XXXX CHANGE TO Q 0 AFTER TESTING
 I BGPINDB="D",'BGPD7 Q 0
 I BGPINDB="C",BGPD8,'X Q 1
 I BGPINDB="C",BGPD8,X Q 1  ;XXXX CHANGE TO Q 0
 I BGPINDB="C",'BGPD8 Q 0
 I BGPINDB="S" I (BGPD1+BGPD2+BGPD3+BGPD4+BGPD5+BGPD6+BGPD7+BGPD8) Q $S(X:1,1:1)  ;LORI **** CHANGE x:1 TO x:0 AFTER TESTING
 Q 0
I17() ;EP
 I 'BGPD1 Q 0
 I BGPINDB="W" Q $S(BGPSEX="F":1,1:0)
 Q 1
I25() ;EP
 I BGPINDB="D" Q BGPDMD2
 I 'BGPD1 Q 0
 I BGPINDB="W" Q $S(BGPSEX="F":1,1:0)
 Q 1
