BGP1XTHE ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY07 HEDIS REPORT ;
 ;;11.1;IHS CLINICAL REPORTING SYSTEM;;JUN 27, 2011;Build 33
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2011 HEDIS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP1XTHE",XBNS="",XBRX="XIT^BGP1XTHE"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
