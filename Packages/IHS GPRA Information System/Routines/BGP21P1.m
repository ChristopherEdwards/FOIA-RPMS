BGP21P1 ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 08 Dec 2010 3:10 PM ;
 ...
 I +$$VERSION^XPDUTL("BGP")<12.1 D MES^XPDUTL($$CJ^XLFSTR("Version 12.1 of BGP is required.  Not installed.",80)) D SORRY(2) I 1
 Q
 ;
PRE ;EP
 Q
