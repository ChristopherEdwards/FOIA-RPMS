BGP2AU1A ; IHS/CMI/LAB - BUILD CRS* FILES ;
...
EN(BGPBEGDT,BGPENDDT,BGPEND,BGPAUF) ;EP
 ...
 N BGPNODEL,BGPAREAA,BGPEXCEL,BGPRPT,BGPROT,BGPINDW,BGPUF,BGPSUL,BGPF
 ...
 S BGPNODEL=1 ;USED IN BGP2PARP SO IT WON'T DO SAVEDEL^BGP2PDL
 S BGPAREAA=1
 S BGPEXCEL=1
 S BGPRPT=0
 S BGPROT="D"
 ...
 ;
 S BGPNOW=$$NOW^XLFDT()
 S BGPNOW=$P(BGPNOW,".")_"."_$$RZERO^BGP2UTL($P(BGPNOW,".",2),6)
 ;
 ...
 S (BGPAUF(3),BGPFDEV1)="BGPGP"_BGPEND_"CRSGPRADEVNT1"_X
 S (BGPAUF(4),BGPFDEV2)="BGPGP"_BGPEND_"CRSGPRADEVNT2"_X
 S (BGPAUF(5),BGPFDEV3)="BGPGP"_BGPEND_"CRSGPRADEVNT3"_X
 ;
 S BGPAUEX=1
 D SETEXCEL^BGP2DP
 D PRINT^BGP2PARP
 ...
 S BGPFGNT1="CRSGPRANT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 S BGPFGNT2="CRSGPRANT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 S BGPFDEV1="CRSGPRADEVNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 S BGPFDEV2="CRSGPRADEVNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 S BGPFDEV3="CRSGPRADEVNT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 ;
 S BGPAUEX=1
 D SETEXCEL^BGP2DP
 D PRINT^BGP2PARP
...
SUL(BGPBEGDT,BGPEND,BGPSUL) ;
 ...
 ;
 S BGPD0=0
 F  S BGPD0=$O(^BGPGPDCW("B",BGPBEGDT,BGPD0)) Q:'BGPD0  D
 . S BGPSUL(BGPD0)=""
 . S BGPEND=$P($G(^BGPGPDCW(BGPD0,0)),U,2)
 Q
