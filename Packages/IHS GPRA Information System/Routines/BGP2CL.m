BGP2CL ; IHS/CMI/LAB - IHS GPRA 10 CMS REPORT DRIVER 01 Jul 2010 8:19 PM 30 Mar 2012 6:08 PM ;
 ;;12.0;IHS CLINICAL REPORTING;;JAN 9, 2012;Build 51
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2012 CRS - RPMS PATIENT DATA FOR ANNUAL CMS HOSPITAL REPORTING",80)
INTRO ;
 D XIT
WARN ;
 W !,"                     ***************************"
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP2CL",ZTDTH="",ZTDESC="CRS 11 CMS REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
 ;
XIT ;
...
ENDDATE ;
 ...
 W !,"January 4, 2012 and you type in 6/30/08 the system will assume the year"
 W !,"as 1908 since that is a date in the past.  You must type 6/30/2012 if you"
