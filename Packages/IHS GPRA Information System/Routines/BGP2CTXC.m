BGP2CTXC ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT 18 Feb 2010 5:31 PM ;
 ;;12.1;IHS CLINICAL REPORTING;;MAY 17, 2012;Build 66
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2012 CMS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP2CTXC",XBNS="",XBRX="XIT^BGP2CTXC"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
THISRPT ;
 ...
 ...S BGPTYPE=$P(^BGPTAXW(BGPY,0),U,2),Y=$G(^BGPTAXW(BGPY,11,1,0)),BGPT=$P(^BGPTAXW(BGPY,0),U)
 ...I BGPTYPE'="L" D
 ....I '$D(^ATXAX("B",BGPT)) S A(BGPT)=Y_"^is Missing" Q
 ....S I=$O(^ATXAX("B",BGPT,0))
 ....I '$D(^ATXAX(I,21,"B")) S A(BGPT)=Y_"^has no entries "
