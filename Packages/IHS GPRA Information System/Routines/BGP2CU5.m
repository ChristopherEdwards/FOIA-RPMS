...
POSTINF(P,PD,PP) ;EP
 ...
 S X=$$LASTDX^BGP2UTL1(P,"BGP CMS POST-OPERATIVE INF DXS",PD,$$FMADD^XLFDT(PD,DAYS))
 I X Q $P(X,U,2)_" "_$$VAL^XBDIQ1(9000010.07,$P(X,U,5),.04)_"  "_$$DATE^BGP2UTL($P(X,U,3))
 Q ""
