BGP2D10 ; IHS/CMI/LAB - calc measures ;
...
PROCCY ;current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL="^BGPGPDCW("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL="^BGPGPDPW("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPAGEB=$$AGE^AUPNPAT(DFN,BGPBDATE)
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL="^BGPGPDBW("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPAGEB=$$AGE^AUPNPAT(DFN,BGPBDATE)
