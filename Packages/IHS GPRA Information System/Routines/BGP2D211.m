BGP2D211 ; IHS/CMI/LAB - measure 6 ;
...
ESRD(P,BDATE,EDATE) ;EP
 ...
 S X=$$LASTDX^BGP2UTL1(P,"BGP ESRD PMS DXS",BDATE,EDATE)
...
IGOAL ;EP
 ...
 I $G(BGPPROVS("GS")) S BGPVALUE="GS: ",BGPN1=1 F X=1:1 S Y=$P(BGPEDD("GS"),U,X) Q:Y=""  S BGPVALUE=BGPVALUE_$S(X=1:"",1:", ") S BGPVALUE=BGPVALUE_$$DATE^BGP2UTL(Y)
 ;I $G(BGPPROVS("GNS")),'$G(BGPPROVS("GS")) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":", ",1:"")_"GNS"_$G(BGPPROVS("GNS","PROVS"))
 I $G(BGPPROVS("GM")) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":", GM: ",1:"GM: "),BGPN2=1 F X=1:1 S Y=$P(BGPEDD("GM"),U,X) Q:Y=""  S BGPVALUE=BGPVALUE_$S(X=1:"",1:", ") S BGPVALUE=BGPVALUE_$$DATE^BGP2UTL(Y)
 ;I $G(BGPPROVS("GNM")),'$G(BGPPROVS("GM")) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":", ",1:"")_"GNM"_$G(BGPPROVS("GNM","PROVS"))
 S BGPVALUE="UP|||"_BGPVALUE
 Q
 ;
AWV ;EP
 ...
 S BGPVAL=$$AWV1(DFN,$$FMADD^XLFDT(BGPEDATE,-(15*30.5)),BGPEDATE)
 S BGPN1=$P(BGPVAL,U)
 S BGPVALUE="AC|||" I BGPN1 S BGPVALUE=BGPVALUE_$$DATE^BGP2UTL($P(BGPVAL,U,2))_" CPT "_$P(BGPVAL,U,3)
 K BGPVAL
 Q
 ;
AWV1(P,BDATE,EDATE) ;EP
 ...
 I 'T Q ""
 S X=$$CPT^BGP2DU(P,BDATE,EDATE,T,6)
 I 'X S X=$$TRAN^BGP2DU(P,BDATE,EDATE,T,6)
 Q X
