BGP2D3 ; IHS/CMI/LAB - measure 11 17 Oct 2009 12:40 PM ;
...
I10 ;EP
 ...
 S (BGPSEAL,BGPSEALD)=""
 K BGPSEALS,BGPSELDS
 D SEAL^BGP2D3A(DFN,BGPBDATE,BGPEDATE)
...
I101 ;
 ;get new sealant definition 2012 gpra dev
 I BGPAGEB>5,BGPAGEB<16 S BGPD7=1 S BGPSEALD=$$SEALDEV^BGP2D3A(DFN,BGPBDATE,BGPEDATE) I BGPSEALD S BGPN7=1
 S BGPVALUE="UP|||"_+BGPN1_" sealants"
 I 'BGPN1,BGPN5 S BGPVALUE=BGPVALUE_": "_$$DATE^BGP2UTL($P(BGPSEAL,U,2))_" "_$P(BGPSEAL,U,3)
 I BGPN1 S BGPVALUE=BGPVALUE_": " S X=0 F  S X=$O(BGPSEALS(X)) Q:X'=+X  S D=0 F  S D=$O(BGPSEALS(X,D)) Q:D'=+D  S BGPVALUE=BGPVALUE_$S(X=1:"",1:"; ")_$$DATE^BGP2UTL(D)_" "_BGPSEALS(X,D)
 I BGPD7 S BGPVALUD=$S(BGPD7:"UP",1:"")_"|||" I BGPN7 S BGPVALUD=BGPVALUD_$P(BGPSEALD,U,2)
 K BGPSEAL,BGPSEALD
 Q
I11 ;EP
 ...
 S BGPFLUOR=$$TF^BGP2D3A(DFN,BGPBDATE,BGPEDATE)
...
I111 ;
 ...
 I +BGPN1 S BGPVALUE=BGPVALUE_": " F X=2:1:5 I $P(BGPFLUOR,U,X)]"" S BGPVALUE=BGPVALUE_$S(X>2:", ",1:"")_$$DATE^BGP2UTL($P($P(BGPFLUOR,U,X),"|",1))_" "_$P($P(BGPFLUOR,U,X),"|",2)
 I BGPN2 S BGPVALUE=BGPVALUE_": "_$$DATE^BGP2UTL($P(BGPFLUOR,U,2))_" "_$P(BGPFLUOR,U,3)
 S BGPVALUD="UP|||"
 I +BGPN1 S BGPVALUD=BGPVALUD_+BGPN1_" topical fluoride" I +BGPN1 S BGPVALUD=BGPVALUD_": " F X=2:1:5 I $P(BGPFLUOR,U,X)]"" S BGPVALUD=BGPVALUD_$S(X>2:", ",1:"")_$$DATE^BGP2UTL($P($P(BGPFLUOR,U,X),"|",1))_" "_$P($P(BGPFLUOR,U,X),"|",2)
 I BGPN2 S BGPVALUD=BGPVALUD_": "_$$DATE^BGP2UTL($P(BGPFLUOR,U,2))_" "_$P(BGPFLUOR,U,3)
 K ^TMP($J,"A"),BGPFLUOR
 Q
I12 ;EP
 NEW BGPHR,V
 ...
 S BGPHR=$$HIGHR^BGP2D3A(DFN,BGPEDATE)
 ...
 .I BGPD4 S BGPDV=BGPDV_$S(BGPDV]"":",AD",1:"AD")
 .I BGPHR S BGPDV=BGPDV_$S(BGPDV]"":",HR",1:"HR")
 I BGPRTYPE'=1 S BGPVALUE=BGPDV_"|||"_$$DATE^BGP2UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2)
 I BGPRTYPE=1 D
 .S BGPDV=BGPDV_"|||"
 .I BGPN7 S BGPVALUE=BGPDV_$$DATE^BGP2UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2) Q
 .S BGPVALUE=BGPDV
...
I13 ;EP
 ...
 I BGPAGEB>17,BGPAGEB<65,BGPACTCL,$$HIGHRP^BGP2D3A(DFN,BGPEDATE) S BGPD4=1
 I BGPAGEB>17,BGPAGEB<65,BGPACTUP,$$HIGHRP^BGP2D3A(DFN,BGPEDATE) S BGPD5=1
...
PN ;EP - called from elder
 S BGPVALUE=$$PNEU^BGP2D31(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) ;set to date of PNEU shot
 ...
 S BGPVAL=$$PNEU^BGP2D31(DFN,$$FMADD^XLFDT(BGPEDATE,-(5*365)),BGPEDATE)
 ...
 S BGPN7=0,BGPA65="" I BGPAGEB>65 S BGPA65=$$PNEU^BGP2D31(DFN,$$FMADD^XLFDT($$DOB^AUPNPAT(DFN),+(65*365)),BGPEDATE) I $P(BGPA65,U,3)=1!($P(BGPA65,U,3)=3) S BGPN4=1,BGPN7=1 ;over 65 and had one after 65
 ...
 .I BGPN1 S BGPVALH=BGPVALUE,BGPVALUE=BGPDV_"|||" I BGPVALH]"" S BGPVALUE=BGPVALUE_"Pneumo: "_$$DATE^BGP2UTL($P(BGPVALH,U,1))_" "_$P(BGPVALH,U,2)_$S(BGPVALH]""&($P(BGPVALH,U,2)'["Ref"):" (ever)",1:"") Q
 .S BGPVALUE=BGPDV_"|||"
 I BGPRTYPE=4 D
 .S BGPDV="UP"
 .I BGPD6!(BGPD1) S BGPDV=BGPDV_$S(BGPDV]"":",AC",1:"AC")
 ...
 I BGPRTYPE=3!(BGPRTYPE=5) S BGPVALUE="AC"_"|||"_$$DATE^BGP2UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2) I 1
 E  D
 .I BGPRTYPE'=1 S BGPVALH=BGPVALUE,BGPVALUE=BGPDV_"|||" I BGPVALH]"" S BGPVALUE=BGPVALUE_"Pneumo: "_$$DATE^BGP2UTL($P(BGPVALH,U,1))_" "_$P(BGPVALH,U,2)_$S(BGPVALH]""&($P(BGPVALH,U,2)'["Ref"):" (ever)",1:"")_" "_$S(BGPN8:" (up-to-date)",1:"")
 .S BGPVALUD="AC"_"|||"
 .I BGPN4 S BGPVALUD=BGPVALUD_"Pneumo: "_$$DATE^BGP2UTL($P(BGPVALH,U,1))_" "_$P(BGPVALH,U,2)_$S(BGPVALH]""&($P(BGPVALH,U,2)'["Ref"):" (ever)",1:"")_" "
 .S BGPVALUD=BGPVALUD_$S(BGPN8:"(up-to-date)",1:"")
TD ;new tdap and td stuff for v11.1
 S BGPTDAP=$$DTAP^BGP2D3A(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
 I BGPTDAP S BGPN9=1
 S BGPTD=$$DTAPTD^BGP2D3A(DFN,$$FMADD^XLFDT(BGPEDATE,-(10*365)),BGPEDATE)
 I BGPTD S BGPN10=1
 I BGPRTYPE=1 G TDE
...
I15 ;EP
 ...
 I BGPACTCL,BGPI7,BGPAGEB>24,BGPAGEE<65 S BGPI7DC=1  ;2012 GPRA DEV
 ...
 I BGPRTYPE'=3,BGPRTYPE'=1 S BGPVALUE=$S(BGPI7DA:"UP",1:"")_$S(BGPI7DB:",AC",1:"")_"|||"_$$DATE^BGP2UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3)
 I BGPRTYPE=1 S BGPVALUE=$S(BGPI7DA:"UP",1:"")_$S(BGPI7DB:",AC",1:"")_"|||" I BGPN3 S BGPVALUE=BGPVALUE_$$DATE^BGP2UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3)
 I BGPRTYPE=3 S BGPVALUE="AC|||"_$$DATE^BGP2UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3)
 S BGPVALUD="AC|||" I BGPN4 S BGPVALUD=BGPVALUD_$$DATE^BGP2UTL($P(BGPPAP4,U,2))_" "_$P(BGPPAP4,U,3)
 K BGPLPAP
 Q
 ;
FLU(P,BD,ED,FORE) ;EP
...
PAP(P,EDATE,YEARS,REFUSAL) ;EP
 ...
 S X=$$LASTDX^BGP2UTL1(P,T,BDATE,EDATE) I X,$P(BGPLPAP,U,2)<$P(X,U,3) S BGPLPAP="1^"_$P(X,U,3)_"^POV "_$P(X,U,2)
 K BGP S BGP(1)=$$LASTPRC^BGP2UTL1(P,"BGP PAP PROCEDURES",BDATE,EDATE)
 ...
 .S X=$$CPT^BGP2DU(P,$$FMADD^XLFDT(EDATE,-(YEARS*365)),EDATE,T,5) I X]"" Q
 .S X=$$TRAN^BGP2DU(P,$$FMADD^XLFDT(EDATE,-(YEARS*365)),EDATE,T,5)
 S T="PAP SMEAR",T=$O(^BWPN("B",T,0))
 I T D  I X]"",$P(BGPLPAP,U,2)<X S BGPLPAP="1^"_X_"^WH"
 .S X=$$WH^BGP2DU(P,$$FMADD^XLFDT(EDATE,-(YEARS*365)),EDATE,T,3)
 I BGPLPAP]"" Q BGPLPAP
 I $G(REFUSAL) Q ""  ;no Refusals counted
 S T=$$REFUSAL^BGP2UTL1(P,60,$O(^LAB(60,"B","PAP SMEAR",0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 ...
 .Q:'Y
 .S T=$$REFUSAL^BGP2UTL1(P,60,Y,$$FMADD^XLFDT(EDATE,-365),EDATE)
 I T Q 1_"^"_$P(T,U,2)_"^Refused Lab "
 ;add cpt Refusals v11.1
 S T=$$CPTREFT^BGP2UTL1(P,$$FMADD^XLFDT(EDATE,-365),EDATE,$O(^ATXAX("B","BGP CPT PAP",0)))
...
HYSTER(P,EDATE) ;EP 
 I '$G(P) Q ""
 NEW X,T
 S X=$$LASTPRC^BGP2UTL1(P,"BGP HYSTERECTOMY PROCEDURES",$$DOB^AUPNPAT(P),EDATE)
 I X Q 1
 S T="HYSTERECTOMY",T=$O(^BWPN("B",T,0))
 I T D  I X]"" Q 1
 .S X=$$WH^BGP2DU(P,$$DOB^AUPNPAT(P),EDATE,T,2)
 S T=$O(^ATXAX("B","BGP HYSTERECTOMY CPTS",0))
 I T D  I X]"" Q 1
 .S X=$$CPT^BGP2DU(P,$P(^DPT(P,0),U,3),EDATE,T,3) I X]"" Q
 .S X=$$TRAN^BGP2DU(P,$P(^DPT(P,0),U,3),EDATE,T,3)
 S X=$$LASTDX^BGP2UTL1(P,"BGP HYSTERECTOMY DXS",$$DOB^AUPNPAT(P),EDATE)
 I X Q 1
 Q ""
