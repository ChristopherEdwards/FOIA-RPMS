...
PNEU(P,BDATE,EDATE,FORE) ;EP
 ...
 I $D(BGPG(1)),$P(BGPLPNU,U,1)<$P(BGPG(1),U) S BGPLPNU=$P(BGPG(1),U,1)_U_"Proc 99.55"
 K BGPG S %=P_"^LAST DX V03.82;DURING "_BDATE_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 I $D(BGPG(1)),$P(BGPLPNU,U,1)<$P(BGPG(1),U) S BGPLPNU=$P(BGPG(1),U,1)_U_"POV V03.82"
 ...
 I $D(BGPG(1)),$P(BGPLPNU,U,1)<$P(BGPG(1),U) S BGPLPNU=$P(BGPG(1),U,1)_U_"POV V06.6"
 ;S %="",E=+$$CODEN^ICPTCOD(90732),%=$$CPTI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"90732"
 ;S %="",E=+$$CODEN^ICPTCOD(90669),%=$$CPTI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"90669"
 ;S %="",E=+$$CODEN^ICPTCOD(90732),%=$$TRANI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"90732 TRAN"
 ;S %="",E=+$$CODEN^ICPTCOD(90669),%=$$TRANI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"90669 TRAN"
 ;S %="",E=+$$CODEN^ICPTCOD("G0009"),%=$$CPTI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"G0009"
 ;S %="",E=+$$CODEN^ICPTCOD("G8115"),%=$$CPTI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"G8115"
 ;S %="",E=+$$CODEN^ICPTCOD("G0009"),%=$$TRANI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"G0009 TRAN"
 ;S %="",E=+$$CODEN^ICPTCOD("G8115"),%=$$TRANI^BGP2DU(P,BD,ED,E) I %]"",$P(BGPLPNU,U,1)<$P(%,U,2) S BGPLPNU=$P(%,U,2)_U_"G8115 TRAN"
