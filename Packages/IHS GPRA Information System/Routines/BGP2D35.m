...
VAR(P,EDATE) ;EP
 ...
 I $$PLTAX^BGP2DU(P,"BGP VARICELLA EVIDENCE") Q 4_U_"Evid Vari"
 ...
 I $$PLTAX^BGP2DU(P,"BGP VARICELLA CONTRA") Q 4_U_"Contra Vari"
 F BGPZ=21,94 S X=$$MMRCONT^BGP2D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=21,94 S R=$$IMMREF^BGP2D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
I I BGPHEP=2,BGP10743,$G(BGPADOL) Q 1_U_" 2 Hep B + 90743"
 ...
 I $$PLTAX^BGP2DU(P,"BGP HEP EVIDENCE") Q 4_U_"Evid Hep B"
 ;now go to Refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
 ...
 S R=$$CPTREFT^BGP2UTL1(P,$$DOB^AUPNPAT(P),EDATE,$O(^ATXAX("B","BGP HEPATITIS CPTS",0)))
 I R S:$P(R,U,3)="N" BGPNMI=1 Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" Hep B"
 ;now check Refusals in imm pkg
 F BGPIMM=8,42,43,44,45,51,102,104,110,132,146 S R=$$IMMREF^BGP2D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" Hep B"
 F BGPZ=8,42,43,44,45,51,102,104,110,132,146 S X=$$ANCONT^BGP2D31(P,BGPZ,EDATE) Q:X]""  ;cmi/maw 12/17/07 missing edate
...
HIB(P,EDATE) ;EP
 ...
 ;I $$PLTAX^BGP2DU(P,"BGP HIB EVIDENCE") Q 4_U_"Evid Hib"
 ;now go to Refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
 ...
 ;now check Refusals in imm pkg
 F BGPIMM=17,22,46,47,48,49,50,51,102,120,132,146 S R=$$IMMREF^BGP2D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" Hib"
...
PNEUMO(P,EDATE,MINN) ;EP
 ...
 S R=$$CPTREFT^BGP2UTL1(P,$$DOB^AUPNPAT(P),EDATE,$O(^ATXAX("B","BGP PNEUMO IZ CPTS",0)))
 I R S:$P(R,U,3)="N" BGPNMI=1 Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" Pneumo"
 ;now check Refusals in imm pkg
 F BGPIMM=33,100,109,133 S R=$$IMMREF^BGP2D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" Pneumo"
 F BGPZ=33,100,109,133 S X=$$ANCONT^BGP2D31(P,BGPZ,EDATE) Q:X]""  ;cmi/maw 12/17/07 missing edate
