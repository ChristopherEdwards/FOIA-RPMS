...
I16 ;EP
 ...
 I BGPRTYPE'=3 S BGPVALUE=$S(BGPI8DA!(BGPI8DE):"UP",1:"")_$S(BGPI8DB!(BGPI8DD):",AC",1:"")_"|||"_$$DATE^BGP2UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
 ...
 S BGPVALUD="" I BGPI8DD S BGPVALUD="AC|||" I BGPN3 S BGPVALUD=BGPVALUD_$$DATE^BGP2UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
...
MP ;
 ...
 ;I T D  I $P(BGPLMAM,U,2)<X S BGPLMAM="1^"_X_"^WH"
 ;.S X=$$WH^BGP2DU(P,$$FMADD^XLFDT(EDATE,-(2*365)),EDATE,T,3)
 I BGPLMAM]"" Q BGPLMAM
 ;
 I $G(FORECAST) Q ""
