BGP2D4 ; IHS/CMI/LAB - measure 3 11 Dec 2009 5:58 PM 12 Sep 2010 10:17 AM ;
...
I16 ;EP
 ...
 I BGPRTYPE=1 S BGPVALUE=$S(BGPI8DA!(BGPI8DE):"UP",1:"")_$S(BGPI8DB!(BGPI8DD):",AC",1:"")_"|||" I BGPN3 S BGPVALUE=BGPVALUE_$$DATE^BGP2UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
 I BGPRTYPE=3 S BGPVALUE="AC|||"_$$DATE^BGP2UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
 S BGPVALUD="" I BGPI8DD S BGPVALUD="AC 42+|||" I BGPN3 S BGPVALUD=BGPVALUD_$$DATE^BGP2UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
...
MAM(P,EDATE,YEARS,FORECAST) ;EP
 ...
 .Q
 ;I G]"" Q G
 K BGP  ; S BGP(1)=$$LASTDX^BGP2UTL1(P,"BGP MAMMOGRAM ICDS",BDATE,EDATE)
...
MP ;
 K BGP S BGP(1)=$$LASTPRC^BGP2UTL1(P,"BGP MAMMOGRAM PROCEDURES",BDATE,EDATE)
 ...
 ;
 I $G(FORECAST) Q ""
 S T=$$CPTREFT^BGP2UTL1(P,$$FMADD^XLFDT(EDATE,-365),EDATE,$S(BGPRTYPE'=3:$O(^ATXAX("B","BGP CPT MAMMOGRAM",0)),1:$O(^ATXAX("B","BGP CPT MAMMOGRAM HEDIS",0))))
 I T S T="1^"_$P(T,U,2)_"^Refused CPT "_$P(T,U,4) Q T
 S T=$$RADREF^BGP2UTL1(P,$$FMADD^XLFDT(EDATE,-365),EDATE,$S(BGPRTYPE'=3:$O(^ATXAX("B","BGP CPT MAMMOGRAM",0)),1:$O(^ATXAX("B","BGP CPT MAMMOGRAM HEDIS",0))))
 I T S T="1^"_$P(T,U,2)_"^Refused RAD/CPT "_$P(T,U,4)
 Q $S(T:T,1:"")
MAS(P,EDATE) ;EP mastectomy before end of time frame
 NEW BGP,X,Y,Z,G,T,%,D,M,BGPX,E
 K BGP
 S BGP(1)=$$LASTPRC^BGP2UTL1(P,"BGP MASTECTOMY PROCEDURES",$$DOB^AUPNPAT(P),EDATE)
 I $P(BGP(1),U) Q 1
