...
DV ;EP - called from elder care
 ...
 S BGPVALUD="" I BGPD2 S BGPVALUD="AC"_"|||" D
...
DVPED(P,BDATE,EDATE) ;EP
 ...
 .I $P(T,"-",1)="DV"!($P(T,"-",2)="DV")!($P(T,"-")="995.80")!($P(T,"-")="995.81")!($P(T,"-")="995.82")!($P(T,"-")="995.83") S BGPLDV=1_"^"_$P(BGPG(X),U)_"^PED "_T_U_"PED "_T_U_$$DATE^BGP2UTL($P(BGPG(X),U)) Q
 .I $P(T,"-",1)="995.85"!($P(T,"-")="V15.41")!($P(T,"-")="V15.42")!($P(T,"-")="V15.49") S BGPLDV=1_"^"_$P(BGPG(X),U)_"^PED "_T_U_"PED "_T_U_$$DATE^BGP2UTL($P(BGPG(X),U)) Q
BHPED ;
...
DV61(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)) S BGPLDV=1_"^"_$P(BGPG(1),U)_"^V61.11"_U_"POV V61.11"_U_$$DATE^BGP2UTL($P(BGPG(1),U))
 Q BGPLDV
ALHF(P,BDATE,EDATE) ;EP - alcohol hf or screening pov
 ...
 I $D(BGPG(1)),$P(BGPLAL,U,4)<$P(BGPG(1),U,1) S BGPLAL=1_U_"POV V11.3"_U_$$DATE^BGP2UTL($P(BGPG(1),U))_U_$P(BGPG(1),U,1)
 K BGPG
 S %=P_"^LAST DX V79.1;DURING "_BDATE_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 I $D(BGPG(1)),$P(BGPLAL,U,4)<$P(BGPG(1),U,1) S BGPLAL=1_U_"POV V79.1"_U_$$DATE^BGP2UTL($P(BGPG(1),U))_U_$P(BGPG(1),U,1)
