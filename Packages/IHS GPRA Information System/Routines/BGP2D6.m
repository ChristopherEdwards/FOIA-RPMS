...
I031 ;EP
 ...
 S BGPXPWV=$$SB^BGP2PDL1($J($P(BGPBMI,U),6,2)) S:BGPXPWV="0.00" BGPXPWV=""
 ...
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP2PDL1($J($P(BGPBMI,U),6,2)),1:"")_$S(BGPN2:" [OVERWEIGHT]",1:"")_$S(BGPN3:" [OBESE]",1:"")
 I BGPRTYPE'=1,BGPN5 S BGPVALUE=BGPVALUE_"Refused " ;_$P(BGPREF,U,2)_" "_$$DATE^BGP2UTL($P(BGPREF,U,3))_" "_$P(BGPREF,U,5)_" "_$$DATE^BGP2UTL($P(BGPREF,U,6))
...
I031A ;
 ...
 I $P(BGPBMI,U)]"" S BGPVALUE=BGPVALUE_"|||"_" Age at BMI: "_A_"; "_$$DATE^BGP2UTL($P(BGPBMI,U,2))_" "_$P(BGPBMI,U)
...
BMIOR(P,BDATE,EDATE,AGE) ;EP
 ...
 .I '$P(X,"^") Q
 .S W=$P(X,"^",2),H=$P(X,"^",3)
 .S W=W*.45359,H=(H*.0254),H=(H*H),BGPBMIH=$$SB^BGP2PDL1($J((W/H),6,2))_U_$P(X,U,1)
 .;S W=$P(X,"^",5),H=$P(X,"^",6)
 .;S W=W*.45359,H=(H*.0254),H=(H*H),$P(BGPBMIH,U,3)=$$SB^BGP2PDL1($J((W/H),6,2))_U_$P(X,U,4)
 .Q
 Q ""
...
WT(P,BDATE,EDATE) ;EP
 ...
 ...I $$ICD^ATXCHK($P(^AUPNVPOV(BGPLD,0),U,1),$O(^ATXAX("B","BGP PRENATAL BMI DXS",0)),9) Q
 ...;I $E(ICD,1,3)="V22" Q
 ...;I $E(ICD,1,3)="V23" Q
 ...;I $E(ICD,1,3)="V27" Q
 ...;I $E(ICD,1,3)="V28" Q
...
REF(P,BDATE,EDATE,AGE) ;EP - get ht/wt Refusal in past year, same date for 18 and under
 S R=""
 I AGE<19 G AGE18R
 S X=$$REFUSAL^BGP2UTL1(P,9999999.07,$O(^AUTTMSR("B","HT",0)),BDATE,EDATE) I X S R=1_U_"HT"_U_$P(X,U,2)
 S Y=$$REFUSAL^BGP2UTL1(P,9999999.07,$O(^AUTTMSR("B","WT",0)),BDATE,EDATE) I Y S $P(R,U,4)=1,$P(R,U,5)="WT",$P(R,U,6)=$P(Y,U,2)
 I X="",Y="" Q ""
 Q R
AGE18R ;
 K H,W
