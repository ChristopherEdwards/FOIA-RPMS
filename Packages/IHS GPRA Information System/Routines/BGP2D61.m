...
COLO(P,EDATE,BDATE) ;EP
 ...
 I $D(BGPG(1)),$P(BGPLCOLO,U,3)<$P(BGPG(1),U,1) S BGPLCOLO="POV "_$P(BGPG(1),U,2)_"^"_$$DATE^BGP2UTL($P(BGPG(1),U))
...
REF(P,BDATE,EDATE) ;EP
 ...
 S T=$$PRCREFT^BGP2UTL1(P,BDATE,EDATE,$O(^ATXAX("B","BGP COLO/SIG PROCS",0)))
