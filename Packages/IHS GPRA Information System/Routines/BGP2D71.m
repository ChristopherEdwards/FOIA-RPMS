...
QUIT(P,BD,ED) ;
 NEW Y,X,G,T
 S Y=$$LASTDXI^BGP2UTL1(P,"305.13",BD,ED)
 I Y Q 1_U_"QUIT: "_$$DATE^BGP2UTL($P(Y,U,3))_" POV 305.13"
 S Y=$$LASTDXI^BGP2UTL1(P,"V15.82",BD,ED)
 I Y Q 1_U_"QUIT: "_$$DATE^BGP2UTL($P(Y,U,3))_" POV V15.82"
...
POT ;if potential check for 2 codes
 S X=BGPTOBD
 S Y=$$LASTDXI^BGP2UTL1(DFN,"305.13",$$FMADD^XLFDT(X,1),BGPBDATE)
 I Y S BGPTU="" G SET
 S Y=$$LASTDXI^BGP2UTL1(DFN,"V15.82",$$FMADD^XLFDT(X,1),BGPBDATE)
 I Y S BGPTU="" G SET
