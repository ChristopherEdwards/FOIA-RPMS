...
ACECONT(P,BDATE,EDATE,NMIB,NMIE,RPBD) ;EP ACEI Contra
 ...
 I BGPG Q BGPG
 ;PREGNANCY
 S X=$$PREG^BGP2D7(P,$S($G(RPBD):RPBD,1:NMIB),NMIE,0,1) I X Q 1_U_"Contra pregnant"
 ;breastfeeding
...
STATALG(P,BDATE,EDATE,RPB,RPE) ;EP
 ...
 .S Z=$P(^AUPNVPOV(Y,0),U,9) I Z]"",$P($$ICDDX^ICDCODE(Z),U,2)="E942.9" S BGPC=1_U_$$DATE^BGP2UTL($P(BGPG(X),U))_" ADR POV "_$P(BGPG(X),U,2)_" w/E942.9" Q
 .S Z=$P(^AUPNVPOV(Y,0),U,18) I Z]"",$P($$ICDDX^ICDCODE(Z),U,2)="E942.9" S BGPC=1_U_$$DATE^BGP2UTL($P(BGPG(X),U))_" ADR POV "_$P(BGPG(X),U,2)_" w/E942.9" Q
 .S Z=$P(^AUPNVPOV(Y,0),U,19) I Z]"",$P($$ICDDX^ICDCODE(Z),U,2)="E942.9" S BGPC=1_U_$$DATE^BGP2UTL($P(BGPG(X),U))_" ADR POV "_$P(BGPG(X),U,2)_" w/E942.9" Q
 .Q
 I BGPC Q BGPC
 ...
 .I Y="V14.8"!($$ICD^ATXCHK(I,T,9)),N["STATIN"!(N["STATINS") S BGPC=1_U_$$DATE^BGP2UTL($P(^AUPNPROB(X,0),U,8))_" ADR Problem List "_Y  ;_"]"
 .Q
 I BGPC Q BGPC
 ;ART
 S BGPC=0
