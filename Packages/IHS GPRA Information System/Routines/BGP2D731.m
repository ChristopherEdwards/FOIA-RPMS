...
IPAMT ;EP
 ...
 I 'BGPN10 S BGPACE("CONTRA")=$$ACECONT^BGP2D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,$P(BGPAMI,U,2),$$FMADD^XLFDT(BGPADDAT,180),BGPBDATE) I BGPACE("CONTRA") S BGPN12=1 ;beta Contraindication
