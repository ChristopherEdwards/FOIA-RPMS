BGP2DAR9 ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 09 Apr 2012 10:03 AM ;
 ...
 W !,"2013 GPRA year using the same performance measure definitions from CRS"
 W !,"Version 10.0."
 W !!
INTRO ;
 D EXIT
TP ;
 ...
 S BGPPBD=3100701,BGPPBD=3110630
 S BGPPER=3110000
 S BGPNGR09=1
...
EISSEX ;
 ...
 .S BGPFGNT1="CRSGPRANT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2013063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFGNT2="CRSGPRANT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2013063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFDEV1="CRSGPRADEVNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2013063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFDEV2="CRSGPRADEVNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2013063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
