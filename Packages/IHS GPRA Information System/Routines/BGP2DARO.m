BGP2DARO ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 01 Jul 2010 11:43 AM ;
...
EISSEX ;
 ...
 .S BGPFONN1="CRSONMNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFONN2="CRSONMNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFONN3="CRSONMNT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFONN4="CRSONMNT4"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .S BGPFONN5="CRSONMNT5"_$P(^AUTTLOC(DUZ(2),0),U,10)_2012063000000000_$$D^BGP2UTL(BGPNOW)_"_"_$$LZERO^BGP2UTL(BGPC,6)_".TXT"
 .Q
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP2DARO",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP2DARO",XBRX="EXIT^BGP2DARO",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
