BGP2DNG9 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM 31 Jul 2012 11:21 AM 13 Aug 2012 5:44 PM ;
 ...
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2013 National GPRA & PART Report",80)
INTRO ;
 D XIT
 W !!,"This will produce a National GPRA & PART report for the 2013 GPRA year using"
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP2DNG9",XBRX="XIT^BGP2DNG9",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP2DNG9",ZTDTH="",ZTDESC="GPRA AND PART REPORT 11 for 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
