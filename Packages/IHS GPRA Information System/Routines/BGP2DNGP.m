BGP2DNGP ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;12.0;IHS CLINICAL REPORTING;;JAN 9, 2012;Build 51
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2012 National GPRA & PART Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP2DNGP",XBRX="XIT^BGP2DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP2DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA & PART REPORT 11 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
