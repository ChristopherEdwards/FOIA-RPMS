BGP2DP6 ; IHS/CMI/LAB - print ind H ;
 ;;12.0;IHS CLINICAL REPORTING;;JAN 9, 2012;Build 51
 ;
 ;
IC1 ;EP
 S BGPORXX=$P(^BGPINDW(BGPIC,12),U,6)
 I $Y>(BGPIOSL-16),'$G(BGPSUMON) D HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPINDW(BGPIC,53,1,0) W:$D(^BGPINDW(BGPIC,53,2,0)) !,^BGPINDW(BGPIC,53,2,0)
 D H1^BGP2DPH
 ...
 Q:BGPQUIT
 D:'$G(BGPSUMON) HEADER^BGP2DPH
 F BGPPC1=BGPORXX_".7",BGPORXX_".8",BGPORXX_".9" Q:BGPQUIT  D PI^BGP2DP1C
 Q:BGPQUIT
 D I1AGE
 Q
