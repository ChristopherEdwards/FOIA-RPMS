BGP2DP60 ; IHS/CMI/LAB - print ind H ;
...
PR ; 
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP2DPH Q:BGPQUIT  W:'$G(BGPSUMON) !,^BGPINDW(BGPIC,53,1,0) W:$D(^BGPINDW(BGPIC,53,2,0)) !,^BGPINDW(BGPIC,53,2,0) D H3
...
PB ;
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPINDW(BGPIC,53,1,0) W:$D(^BGPINDW(BGPIC,53,2,0)) !,^BGPINDW(BGPIC,53,2,0) D H3
 ;percentage changes
