BGP2DP7 ; IHS/CMI/LAB - print ind 10 ;
...
PI1 ;
 ...
 I BGPRTYPE'=4,BGPINDW="G",$P(^BGPINDWC(BGPPC,0),U,5)'=1 Q
 I BGPRTYPE=4,$P($G(^BGPINDWC(BGPPC,21)),U,2)=1 Q
 I BGPINDW="D",$P(^BGPINDWC(BGPPC,0),U,12)'=1 Q
 I BGPINDW="C",$P(^BGPINDWC(BGPPC,0),U,13)'=1 Q
 I BGPINDW="W",$P($G(^BGPINDWC(BGPPC,12)),U,2)'=1 Q
 I BGPINDW="E",$P($G(^BGPINDWC(BGPPC,12)),U,3)'=1 Q
