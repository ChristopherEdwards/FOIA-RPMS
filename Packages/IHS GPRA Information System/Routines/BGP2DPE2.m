BGP2DPE2 ; IHS/CMI/LAB - calc measures 29 Apr 2010 7:38 PM 14 Nov 2006 5:02 PM 09 Jun 2012 5:18 PM ;
...
5 ;EP
 ...
 Q
SET51 ;
 I '$D(^BGPPEDCW(BGPRPT,15,0)) S ^BGPPEDCW(BGPRPT,15,0)="^90548.1215A^0^0"
 S Z=$O(^BGPPEDCW(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDCW(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDCW(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDCW(BGPRPT,15,0),U,3)+1,$P(^BGPPEDCW(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDCW(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDCW(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDCW(BGPRPT,15,"B",BGPT,Z)=""
 Q
SET52 ;
 I '$D(^BGPPEDPW(BGPRPT,15,0)) S ^BGPPEDPW(BGPRPT,15,0)="^90548.1315A^0^0"
 S Z=$O(^BGPPEDPW(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDPW(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDPW(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDPW(BGPRPT,15,0),U,3)+1,$P(^BGPPEDPW(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDPW(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDPW(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDPW(BGPRPT,15,"B",BGPT,Z)=""
 Q
SET53 ;
 I '$D(^BGPPEDBW(BGPRPT,15,0)) S ^BGPPEDBW(BGPRPT,15,0)="^90548.1515A^0^0"
 S Z=$O(^BGPPEDBW(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDBW(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDBW(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDBW(BGPRPT,15,0),U,3)+1,$P(^BGPPEDBW(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDBW(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDBW(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDBW(BGPRPT,15,"B",BGPT,Z)=""
 Q
6 ;EP
 Q:'$D(^AUPNVPED("AC",DFN))  ;no education so don't bother
 K BGPALLED,BGPEDPRV S BGPVALUE=""
