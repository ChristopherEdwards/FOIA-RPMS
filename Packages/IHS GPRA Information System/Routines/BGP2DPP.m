BGP2DPP ; IHS/CMI/LAB - IHS GPRA 10 SELECTED REPORT DRIVER ALL PATIENTS 29 Apr 2012 8:36 PM ;
 ...
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("2012 Clinical Performance Measure Report (Selected Measures)",80)
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP2DPP",ZTDTH="",ZTDESC="GPRA 10 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP2DPP",XBRX="XIT^BGP2DPP",XBNS="BGP"
 D ^XBDBQUE
 ;D XIT
 Q
 ;
