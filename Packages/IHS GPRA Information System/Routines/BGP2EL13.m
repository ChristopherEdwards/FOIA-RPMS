BGP2EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;12.0;IHS CLINICAL REPORTING;;JAN 9, 2012;Build 51
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS =>55",BGPHD2="# Active Diabetics"
 D HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPELIW(BGPIC,53,1,0)  D H3^BGP2EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPELIW(BGPIC,53,1,0) D H3^BGP2EL12
