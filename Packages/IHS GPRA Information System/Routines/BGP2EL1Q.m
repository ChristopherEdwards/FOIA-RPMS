BGP2EL1Q ; IHS/CMI/LAB - print ind ;
 ;;12.0;IHS CLINICAL REPORTING;;JAN 9, 2012;Build 51
 ;
I1AGEP ;EP
PR ; 
 D HEADER^BGP2DPH W !,^BGPELIW(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3^BGP2EL1P S X=" " D S(X,1,1)
...
S(Y,F,P) ;set up array
 ;Q:BGPQUIT
 ;I $Y>(IOSL-5) D HEADER^BGP2DPH Q:BGPQUIT
 ;W !,^BGPELIW(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 I $G(F) F J=1:1:F W !
