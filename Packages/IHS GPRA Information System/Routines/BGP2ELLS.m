BGP2ELLS ; IHS/CMI/LAB - print ind 01 Jul 2010 7:56 PM 20 May 2012 4:45 PM ;
...
I1AGE1 ;
 S C=C+1
 S BGPF="EDA."_BGPX_"."_BGPZ S BGPPC=$O(^BGPELIIW("C",BGPF,0))
...
I1AGEP ;
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,15) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,17) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,19) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 ;F X=1:1:3 S V=$P(BGPDAC(X),U,21) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,23) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,25) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,27) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,29) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,31) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,33) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,35) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,37) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,39) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,41) S Y=$$SB^BGP2ELL2($J(V,6,1)) D S(Y,,X+1)
 D I1AGEP^BGP2ELLT
 Q
