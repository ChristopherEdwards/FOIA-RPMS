...
NT .;END TEST STUFF
 ...
 I $D(DIRUT) D XIT Q
 S BGPINDZ=Y
 I BGPINDZ="S" D EN^BGP2EOSI I '$D(BGPIND) W !!,"No measures selected" G CHOICE
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP2EOD",XBRX="XIT^BGP2EOD",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP2EOD",ZTDTH="",ZTDESC="EO 2010 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
...
LISTS ;any lists with measures?
 ...
 I $D(BGPLIST) D RT^BGP2EOSL I '$D(BGPLIST)!($D(BGPQUIT)) G LISTS ;get report type for each list
 Q
CHKY ;
