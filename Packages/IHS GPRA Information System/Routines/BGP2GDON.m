BGP2GDON ; IHS/CMI/LAB - GUI Other National Measurer Report ;
 ;;12.1;IHS CLINICAL REPORTING;;MAY 17, 2012;Build 66
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 12 OTHER NATIONAL MEASURES REPORT",338,1,3040000,3000000,1,1,"B",$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 . S BGPPBD=3100701,BGPPBD=3100701
 . S BGPPER=3120000
 . S BGPPED=3110630
 . S BGPBEN=1
 . S BGPRTC="H"
 ...
 S BGPFILEN="" I BGPEXPT S BGPFILEN="BG121"_$P(^AUTTLOC(DUZ(2),0),U,10)_".ONM"_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="OTHONM^BGP2GDON",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI ONM REPORT 11" D ^%ZTLOAD Q
 Q
OTHONM ;
 D ^BGP2D1
 K ^TMP($J,"BGPGUI")
