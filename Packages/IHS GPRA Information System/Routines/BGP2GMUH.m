BGP2GMUH ; IHS/CMI/LAB - GUI MU HOS REPORT ;
...
TESTMU ;
 ...
 S BGPND(1)="",BGPND(3)=""
 S BGPLIST(3)=""
 D EP(.ERR,5459,5217,"BGP 12 ME EP REPORT",338,"C",.BGPND,1,311010,3000000,1,"A",.BGPLIST,"BUTCHER,LORI","5459","P",$$NOW^XLFDT,"","LORITESTMU")
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="MU^BGP2GMUH",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="CRS GUI MU HOS REPORT" D ^%ZTLOAD Q
 Q
MU ;EP
 D ^BGPMUEHD
 K ^TMP($J,"BGPGUI")
