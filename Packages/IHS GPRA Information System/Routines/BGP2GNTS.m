BGP2GNTS ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;12.1;IHS CLINICAL REPORTING;;MAY 17, 2012;Build 66
 ;
 ;
TESTNTL ;
 S ERR=""
 D EPSUM(.ERR,1,2582,"BGP 12 NATIONAL GPRA RPT SUM",597,0,"B",$$NOW^XLFDT)
 W !,ERR
 Q
...
NT ;
 ...
 S BGPFILEN="BG121"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP2GNTS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11 SUM" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP2D1
 K ^TMP($J,"BGPGUI")
