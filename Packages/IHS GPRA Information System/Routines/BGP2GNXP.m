BGP2GNXP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM ;
 ;;12.0;IHS CLINICAL REPORTING;;JAN 9, 2012;Build 51
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 12 NATL EXPORT",597,1,1,,$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPRTYPE=1,BGPXPRP=1,BGPXPFYY=2012,BGPXPFYI=311
 S BGPXPWD=3110701,BGPXPEDT=3120630
 K BGPTAX S X=0
...
HOME ;
 ...
 S BGPFN="CRSCNT"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP2UTL(BGPXPWD)_$$D^BGP2UTL(BGPXPEDT)_$$D^BGP2UTL(BGPNOW)_"_001_of_001.TXT"
 ;CREATE REPORT ENTRY
 K DIC S X=$P(^VA(200,DUZ,0),U)_"-"_$$D^BGP7UTL(BGPNOW),DIC(0)="L",DIC="^BGPXPA(",DLAYGO=90530.11,DIADD=1
 S DIC("DR")=".02////"_BGPXPWD_";.03////"_BGPXPEDT_";.04////"_$P(^ATXAX(BGPTAXI,0),U)_";.05////"_$S(BGPMFITI:$P(^ATXAX(BGPMFITI,0),U),1:"")
 ...
 S BGPGFNM=X
 S DIC="^BGPGUIA(",DIC(0)="L",DIADD=1,DLAYGO=90546.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP2GNXP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT 11" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE1
 K ^TMP($J,"BGPGUI")
 ...
 S ^BGPGUIA(BGPGIEN,11,0)="^90546.1911^"_C_"^"_C_"^"_DT
 K ^TMP($J,"BGPGUI")
 D ENDLOG
 D XIT
 Q
