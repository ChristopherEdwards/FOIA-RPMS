BGP2HEL ; IHS/CMI/LAB - IHS gpra print 01 Jul 2010 8:00 PM ;
...
DEL ;
 ...
 D ^BGP2HEHH
 D DEL1
 D ^BGP2HESL ;print lists to delimited file
 ...
 I '$D(BGPGUI) D
 .S XBFLT=1,XBFN=BGPDELF_".txt",XBMED="F",XBTLE="CRS 2012 HEDIS DELIMITED OUTPUT",XBQ="N"
...
HEADER ;EP
 ...
 I BGPRTYPE=3 S Y="*** IHS 2012 HEDIS Clinical Performance Report***" D S(Y,1,1)
