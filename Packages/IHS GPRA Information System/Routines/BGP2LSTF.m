BGP2LSTF ; IHS/CMI/LAB - List 'BG08' files in pub ;
 ...
 ;
 W:$D(IOF) @IOF
 W !,"This option is used to list all CRS 2012 files that are in a directory.",!,"These files begin with BG121.",!,"You must specify the directory in which the CRS 2012 data files reside.",!
FILE ;
 D HOME^%ZIS
DIR ;
 K DIR
