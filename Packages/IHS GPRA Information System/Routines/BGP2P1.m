BGP2P1 ; IHS/CMI/LAB - v11.0 patch 1 env routine 08 Dec 2010 3:10 PM ;
...
POST ;EP - called from kids build
 ...
 S BGPX=0 F  S BGPX=$O(^BGPGPDCW(BGPX)) Q:BGPX'=+BGPX  D
 .I '$D(^BGPGPDCW(BGPX,1.1)) S DA=BGPX,DIK="^BGPGPDCW(" D ^DIK S DA=BGPX,DIK="^BGPGPDPW(" D ^DIK S DA=BGPX,DIK="^BGPGPDBW(" D ^DIK
 Q
