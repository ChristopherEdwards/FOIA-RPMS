...
I10 ;EP
 ...
 F BGPPC1=$P(^BGPINDW(BGPIC,12),U,6)_".1" D PI
 K BGPNODEN
 F BGPPC1=$P(^BGPINDW(BGPIC,12),U,6)_".2" D PI^BGP2PDL1
 Q
I11 ;EP
 S BGPORXX=$P(^BGPINDW(BGPIC,12),U,6)
 D:'$G(BGPSUMON) H1 S BGPNODEN=1
 ...
 K BGPNODEN
 F BGPPC1=BGPORXX_".3" D PI^BGP2PDL1
 Q
ISTI ;EP
 S BGPORXX=$P(^BGPINDW(BGPIC,12),U,6)
 D:'$G(BGPSUMON) H1 S BGPNODEN=1
 ...
 ;
 K BGPNODEN
 F BGPPC1=BGPORXX_".7",BGPORXX_".8",BGPORXX_".9" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".10",BGPORXX_".11",BGPORXX_".12" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".13",BGPORXX_".14",BGPORXX_".15" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".16",BGPORXX_".17",BGPORXX_".18" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".19",BGPORXX_".20",BGPORXX_".21" D PI^BGP2PDL1 ;
 ;
 ;USER POP
 D S(" ",1,1)
 S BGPNODEN=1
 ...
 K BGPNODEN
 F BGPPC1=BGPORXX_".28",BGPORXX_".29",BGPORXX_".30" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".31",BGPORXX_".32",BGPORXX_".33" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".34",BGPORXX_".35",BGPORXX_".36" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".37",BGPORXX_".38",BGPORXX_".39" D PI^BGP2PDL1 ;
 ;
 F BGPPC1=BGPORXX_".40",BGPORXX_".41",BGPORXX_".42" D PI^BGP2PDL1 ;
 ;
 Q
IPC ;EP
 S BGPORXX=$P(^BGPINDW(BGPIC,12),U,6)
 ...
 S BGPORDP=$P(^BGPINDW(BGPIC,12),U,6) F BGPORDP1=9:1:17 S BGPPC1=BGPORDP_"."_BGPORDP1 D PI^BGP2PDL1
 Q
PI ;EP
 S BGPDENP=0
 K BGPDHOLD
...
PI1 ;EP
 ...
 I BGPROT="D"!(BGPROT="B") D SETSUM^BGP2DP2
