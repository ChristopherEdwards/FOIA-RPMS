BGP2PDLB ; IHS/CMI/LAB - print ind 03 Jul 2010 12:41 PM 07 Dec 2010 12:18 PM ;
...
V(T,R,N,P) ;EP
 I $G(BGPAREAA) G VA
 NEW X
 I T=1 S X=$P($G(^BGPGPDCW(R,N)),U,P) Q $S(X]"":X,1:0)
 I T=2 S X=$P($G(^BGPGPDPW(R,N)),U,P) Q $S(X]"":X,1:0)
 I T=3 S X=$P($G(^BGPGPDBW(R,N)),U,P) Q $S(X]"":X,1:0)
 Q ""
VA ;
