BGP2PDLN ; IHS/CMI/LAB - IHS gpra print ;
...
NONSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDWC(BGPPC,15),U,4)
 ...I $P(^BGPINDWC(BGPPC,15),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDWC(BGPPC,15),U,7)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDWC(BGPPC,15),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDWC(BGPPC,15),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDWC(BGPPC,15),U,9)]""!($P(^BGPINDWC(BGPPC,15),U,10)]"")!($P(^BGPINDWC(BGPPC,15),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDWC(BGPPC,15),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDWC(BGPPC,15),U,11)
 ...I X]"" D S(X,1,1)
 S X=" " D S(X,1,1)
...
H2 ;
 ...
 S X="",$P(X,U,2)=" Site",$P(X,U,3)=" Site",$P(X,U,4)=" Site",$P(X,U,5)="Area",$P(X,U,6)="Nat'l",$P(X,U,7)="2012" D S(X,1,1)
...
SDP ;EP
 ...
 ..I $P(^BGPINDWC(BGPPC,15),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDWC(BGPPC,15),U,7)
 ..I $P(^BGPINDWC(BGPPC,15),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDWC(BGPPC,15),U,12)
 ...
 ....S Y="" I $P(^BGPINDWC(BGPPC,15),U,9)]""!($P(^BGPINDWC(BGPPC,15),U,10)]"")!($P(^BGPINDWC(BGPPC,15),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDWC(BGPPC,15),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDWC(BGPPC,15),U,10),"$","^") D
