BGP2PDLT ; IHS/CMI/LAB - print ind 1 03 Jul 2010 7:40 AM ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPINDW(BGPIC,53,1,0) W:$D(^BGPINDW(BGPIC,53,2,0)) !,^BGPINDW(BGPIC,53,2,0)  D HPA^BGP2DPH
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF=156_"."_BGPPAD_".1"_BGPX S BGPPC=$O(^BGPINDWC("OR",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF=156_"."_BGPPAD_".2"_BGPX  S BGPPC=$O(^BGPINDWC("OR",BGPF,0))
...
PR ; 
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPINDW(BGPIC,53,1,0) W:$D(^BGPINDW(BGPIC,53,2,0)) !,^BGPINDW(BGPIC,53,2,0) D HPA^BGP2DPH
...
BL ;
 D:'$G(BGPSUMON) HEADER^BGP2DPH Q:BGPQUIT  W !,^BGPINDW(BGPIC,53,1,0) W:$D(^BGPINDW(BGPIC,53,2,0)) !,^BGPINDW(BGPIC,53,2,0) D HPA^BGP2DPH
