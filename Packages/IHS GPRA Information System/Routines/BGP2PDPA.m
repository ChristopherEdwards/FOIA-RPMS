BGP2PDPA ; IHS/CMI/LAB - print ind 03 Jul 2010 8:56 AM ;
...
I1AGEP ;
 ...
 S X=" " D S(X,1,1) S X="# w/ exercise educ w/ % of physical activity assessment" D S(X,1,1)
...
PR ; 
 ;S X=^BGPINDW(BGPIC,53,1,0) D S(X,1,1) D H9
