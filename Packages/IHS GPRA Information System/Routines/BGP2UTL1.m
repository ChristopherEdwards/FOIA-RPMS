...
I1() ;EP
 I BGPVALUE="" Q 0
 I BGPINDW="E",BGPVALUE]"",BGPAGEB>64 Q 1
 I BGPINDW="E",BGPVALUE]"",BGPAGEB<65 Q 0
 I BGPVALUE]"" Q 1
 Q 0
I12() ;EP
 I BGPINDW="D" Q 1
 I BGPINDW="D",'BGPD4 Q 0
 I BGPINDW="E",(BGPD3+BGPD7) Q 1
 I BGPINDW="E",'(BGPD3+BGPD7) Q 0
 I BGPACTUP Q 1
 Q 0
I13() ;EP
 I BGPINDW="D",BGPD2 Q 1
 I BGPINDW="D",'BGPD2 Q 0
 I BGPINDW="E",(BGPD3+BGPD1) Q 1
 I BGPINDW="E",'(BGPD3+BGPD1) Q 0
...
IA() ;EP
 ...
 NEW X
 S X=BGPN1
 I BGPINDW="D",BGPD7,'X Q 1
 I BGPINDW="D",BGPD7,X Q 1   ;XXXX CHANGE TO Q 0 AFTER TESTING
 I BGPINDW="D",'BGPD7 Q 0
 I BGPINDW="C",BGPD8,'X Q 1
 I BGPINDW="C",BGPD8,X Q 1  ;XXXX CHANGE TO Q 0
 I BGPINDW="C",'BGPD8 Q 0
 I BGPINDW="S" I (BGPD1+BGPD2+BGPD3+BGPD4+BGPD5+BGPD6+BGPD7+BGPD8) Q $S(X:1,1:1)  ;LORI **** CHANGE x:1 TO x:0 AFTER TESTING
 Q 0
I17() ;EP
 I 'BGPD1 Q 0
 I BGPINDW="W" Q $S(BGPSEX="F":1,1:0)
 Q 1
I25() ;EP
 I BGPINDW="D" Q BGPDMD2
 I 'BGPD1 Q 0
 I BGPINDW="W" Q $S(BGPSEX="F":1,1:0)
 Q 1
