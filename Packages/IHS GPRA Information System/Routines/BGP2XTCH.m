BGP2XTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT 16 Jan 2009 4:02 PM ;
 ;;12.1;IHS CLINICAL REPORTING;;MAY 17, 2012;Build 66
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2012 CRS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 K IOP,%ZIS
 W !! S %ZIS="PQM" D ^%ZIS
 I POP D XIT Q
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="TAXCHK^BGP2XTCH",ZTDTH="",ZTDESC="CRS 11 TAX REPORT" D ^%ZTLOAD D XIT Q
 Q
TAXCHK ;EP
 ;D HOME^%ZIS
 K BGPQUIT
