BGP2XTEO ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;12.1;IHS CLINICAL REPORTING;;MAY 17, 2012;Build 66
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2012 Executive Order Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP2XTEO",XBNS="",XBRX="XIT^BGP2XTEO"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
GUICHK ;EP
 ...
 .Q:'$D(^BGPTAXW(BGPY,12,"B",8))  ;8 IS SET OF CODES FOR EO REPORT
