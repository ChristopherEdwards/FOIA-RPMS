BGP2XTV1 ; IHS/CMI/LAB - DISPLAY IND LISTS ;
...
EN ;EP -- main entry point for 
 D TERM^VALM0
 D EN^VALM("BGP 12 TAXONOMY VIEW ONE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
INIT ; -- init variables and list array
 ...
 .S BGPY=$O(^ATXAX(BGPTAXI,21,"B",BGPX,BGPY)) Q:BGPY'=+BGPY  D
 ..S C=C+1
...
CANDISP ;
 ...
 ..S C=C+1
 ..S BGPITEM(C,0)=C_")  "_$P(^ATXAX(BGPTAXI,21,BGPY,0),U)_" through  "_$P(^ATXAX(BGPTAXI,21,BGPY,0),U,2)
