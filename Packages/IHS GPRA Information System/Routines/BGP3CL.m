BGP3CL ; IHS/CMI/LAB - IHS GPRA 10 CMS REPORT DRIVER 01 Jul 2010 8:19 PM 30 Mar 2013 6:08 PM ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2013 CRS - RPMS PATIENT DATA FOR ANNUAL CMS HOSPITAL REPORTING",80)
INTRO ;
 D XIT
WARN ;
 W !,"                     ***************************"
 ...
 W !,"                     ***************************"
 W !
 W !,"This report was last updated in April 2009 through the CMS Specifications "
 W !,"Manual for discharges effective 4/1/2009, and the CRS CMS Report was included"
 W !,"in CRS Version 8.0."
 W !
 W !,"It is recommended this report NOT be used until it is updated.  OIT "
 W !,"anticipates this report will be updated with CRS Version 11.0."
 W !
...
SETLIST ;
 ...
 .W !,"within the ",$P(^BGPCMSIB(BGPXX,0),U,3)," topic.",!
 .D PAUSE
 .D EN^BGP3CSII
 .I '$D(BGPPLSTL(BGPXX)) W !!,"No lists selected for topic ",$P(^BGPCMSIB(BGPXX,0),U,3),"." D PAUSE
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP3CL",ZTDTH="",ZTDESC="CRS 13 CMS REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
 ;
XIT ;
...
ENDDATE ;
 ...
 W !,"January 4, 2013 and you type in 6/30/08 the system will assume the year"
 W !,"as 1908 since that is a date in the past.  You must type 6/30/2013 if you"
