BGP3D1 ; IHS/CMI/LAB - calc measures 29 Apr 2010 7:38 PM 14 Nov 2006 5:02 PM 12 Nov 2009 11:03 AM 27 May 2013 10:08 AM 12 May 2013 6:04 PM ; 26 Oct 2012  1:41 PM
...
PROC ;EP
 ...
 D XTMP^BGP3UTL("BGP28CPL","National GPRA Comp List")
 D XTMP^BGP3UTL("BGP3DNP","National GPRA Patient List")
 D XTMP^BGP3UTL("BGP3D","CRS Local Patient List")
 ...
 .;I DUZ=5634,'$D(^DIBT(4883,1,DFN)) Q
 .;I DUZ=5634,DFN'=25626 Q
 .;I DUZ=5634 Q:DFN'=132192
 .;I DUZ=5634 Q:$$HRN^AUPNPAT(DFN,DUZ(2))'=203537
 .Q:'$D(^AUPNPAT(DFN,0))
...
PROCCY ;EP - current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDCB(",BGPRTYPE=5:"^BGPELDCH(",BGPRTYPE=8:"^BGPEOCB(",1:"^BGPGPDCH(")
 S BGP365=BGPBDATE
 ...
 I $G(BGPIISO) D ISS^BGP3DPA1 K ^TMP($J,"A") Q  ;SCHEDULING OPTION
 D CALCIND
 K ^TMP($J,"A")
 Q
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDPB(",BGPRTYPE=5:"^BGPELDPH(",BGPRTYPE=8:"^BGPEOPB(",1:"^BGPGPDPH(")
 S BGP365=BGPBDATE
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDBB(",BGPRTYPE=5:"^BGPELDBH(",BGPRTYPE=8:"^BGPEOBB(",1:"^BGPGPDBH(")
 S BGP365=BGPBDATE
 ...
 Q
CALCIND ;
 I BGPRTYPE=5 D CALCIND^BGP3DCEI Q
 D CALCIND^BGP3DCI
 Q
...
ACTCLBH(P,BDATE,EDATE,CHS,URBAN) ;EP - clinical user
 ...
 .Q:B=""
 .I 'G,$D(^BGPCTRL($O(^BGPCTRL("B",2013,0)),11,"B",B)) S G=V  ;must be a primary clinic S G=V
 .I V'=G,$D(^BGPCTRL($O(^BGPCTRL("B",2013,0)),95,"B",B)) S S=1
 .I G,S S F=1
 .Q
 Q $S(F:1,1:0)
 ;
...
URBACTCL ;URBAN
 ...
 .S B=$$CLINIC^APCLV(V,"C")
 .Q:B=""
 .Q:'$D(^BGPCTRL($O(^BGPCTRL("B",2013,0)),1301,"B",B))
 .S F=F+1
 Q $S(F>1:1,1:0)
FIRSTDM(P,EDATE) ;
 I $G(P)="" Q ""
