BGP3D62 ; IHS/CMI/LAB - measure 31 01 Jul 2010 7:47 PM ; 19 Sep 2012  8:13 AM
...
CRCP ;EP - called from elder
 ...
 S BGPREF="" I 'BGPN1 S BGPREF=$$REF^BGP3D61(DFN,$$FMADD^XLFDT(BGPEDATE,-365),BGPEDATE) I BGPREF S BGPN2=1
 S BGPVALUE=""
...
COLO(P,EDATE,BDATE) ;EP
 ...
 ;I $D(BGPG(1)),$P(BGPLCOLO,U,3)<$P(BGPG(1),U,1) S BGPLCOLO="COLO DX V76.51"_"^"_$$DATE^BGP3UTL($P(BGPG(1),U))
