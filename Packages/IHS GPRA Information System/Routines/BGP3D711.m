BGP3D711 ; IHS/CMI/LAB - measure C 30 Jun 2010 12:14 PM ;
...
OTHREL(P,BDATE,EDATE) ;EP
 ...
 I % Q %
 ;NOW CHECK V CPT
  S %=$$CPT^BGP3DU(P,BDATE,EDATE,$O(^ATXAX("B","BGP OTHER REL EDUC CPTS",0)),5)
  Q %
MEDNUTRD(P,BDATE,EDATE) ;EP
 K ^TMP($J)
 NEW E,%,X,Y,D,Z,W,BGPG,BGPC
 K BGPG,BGPC
 S E=+$$CODEN^ICPTCOD(97802),%=$$CPTI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802"
 S E=+$$CODEN^ICPTCOD(97803),%=$$CPTI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97803"
 S E=+$$CODEN^ICPTCOD(97804),%=$$CPTI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$CPTI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$CPTI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271"
 ;TRAN CODES
 S E=+$$CODEN^ICPTCOD(97802),%=$$TRANI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802"
 S E=+$$CODEN^ICPTCOD(97803),%=$$TRANI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)-"^97803"
 S E=+$$CODEN^ICPTCOD(97804),%=$$TRANI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$TRANI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$TRANI^BGP3DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271"
...
PED(P,BDATE,EDATE,FORE) ;EP
 ...
 .Q
 ;I G]"" Q G
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("D1320")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT D1320"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("D1320")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN D1320"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99406)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT 99406"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99406)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 99406"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99407)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT 99407"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99407)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 99407"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0375")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G0375"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0376")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G0376"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4000F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT 4000F"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0375")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G0375"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0376")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G0376"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4000F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 4000F"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4001F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CESSATION MED - CPT 4001F"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4001F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 4001F"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8402")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G8402"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8402")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G8402"
 S G=$$CPTI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8453")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G8453"
 S G=$$TRANI^BGP3DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8453")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G8453"
