BGP3D721 ; IHS/CMI/LAB - measure AHR.A ;
...
IAHRA ;EP
 ...
 S BGPIHD=$$CHD^BGP3D729(DFN,BGPBDATE,BGPEDATE)
 ...
 K BGPACE
 S BGPACE("RX")=$$ACERX^BGP3D722(DFN,BGPBDATE,BGPEDATE,179)  ;get 1_U_# days
 I BGPACE("RX") S BGPN10=1  ;pt has 180 days of ACE
 ;I 'BGPN10 S BGPACE("REF")=$$ACEREF^BGP3D722(DFN,BGPBDATE,BGPEDATE) I BGPACE("REF") S BGPN11=1
 I 'BGPN10 S BGPACE("CONTRA")=$$ACECONT^BGP3D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,BGPBDATE,BGPEDATE,BGPBDATE) I BGPACE("CONTRA") S BGPN12=1 ;beta Contraindication
 I 'BGPN10 S BGPACE("ADR")=$$ACEALG^BGP3D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPACE("ADR") S BGPN12=1
 I (BGPN10+BGPN12) S BGPN9=1
 K BGPSTAT
 S BGPSTAT("RX")=$$STATRX^BGP3D722(DFN,BGPBDATE,BGPEDATE,179)  ;get 1_U_# days
 I BGPSTAT("RX") S BGPN14=1  ;pt has 180 days of STAT
 ;I 'BGPN14 S BGPSTAT("REF")=$$STATREF^BGP3D722(DFN,BGPBDATE,BGPEDATE) I BGPSTAT("REF") S BGPN15=1
 I 'BGPN14 S BGPSTAT("CONTRA")=$$STATCON^BGP3D722(DFN,BGPBDATE,BGPEDATE,BGPBDATE,BGPEDATE) I BGPSTAT("CONTRA") S BGPN16=1 ;beta Contraindication
...
BETAREF(P,BDATE,EDATE) ;EP
 ...
 ...S G=1_U_$$DATE^BGP3UTL(Y)_U_"Refused "_$P(^PSDRUG(X,0),U,1)
 ..Q
 .Q
 Q G
...
ASAALLEG(P,EDATE) ;EP
 K BGPG
 S X=$$ASAALLEG^BGP3CU1(P,$$DOB^AUPNPAT(P),EDATE)
 I 'X Q 0
