BGP3D85 ; IHS/CMI/LAB - measure C 09 Jun 2013 5:18 PM ;
...
I28 ;EP
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$TDAP^BGP3D86(DFN,BGPEDATE)
 ...
 S BGPVAL=$$MMR^BGP3D811(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$MEN^BGP3D36(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$HPV^BGP3D36(DFN,BGPEDATE)
