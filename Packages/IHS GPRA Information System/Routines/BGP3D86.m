BGP3D86 ; IHS/CMI/LAB - measure C 06 Nov 2009 2:26 PM ;
...
IRAR ;EP
 ...
 I '$$RHEUAR^BGP3D862(DFN,BGPBDATE,BGPEDATE) S BGPSTOP=1 Q  ;no OSTEOARTHRITIS
 S BGPV=$$MEDSPRE^BGP3D863(DFN,BGPBDATE,BGPEDATE)
 ...
 K BGPIRZ,BGPIRV
 I $P(BGPV,U,2) D
 .S BGPCBC=$$CBC^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPLFT=$$LFT^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPCREAT=$$CREAT^BGP3D22(DFN,BGPBDATE,BGPEDATE)
 .S BGPIRZ("A")=0,BGPIRV("A")="NSAID: "
 .I BGPCBC,BGPLFT,BGPCREAT S BGPIRZ("A")=1 ;,BGPIRV("A")=BGPIRV("A")_$$DATE^BGP3UTL($P(BGPCREAT,U,2))_" CREAT, "_$$DATE^BGP3UTL($P(BGPCBC,U,2))_" CBC, "_$$DATE^BGP3UTL($P(BGPLFT,U,2))_" LFT"  ;NA MEDS AND HAS CBC,LFT
 .I BGPCREAT S BGPIRV("A")=BGPIRV("A")_$$DATE^BGP3UTL($P(BGPCREAT,U,2))_" CREAT"
 .I BGPCBC S BGPIRV("A")=BGPIRV("A")_$S(BGPIRV("A")]"":", ",1:"") S BGPIRV("A")=BGPIRV("A")_$$DATE^BGP3UTL($P(BGPCBC,U,2))_" CBC"
 .I BGPLFT S BGPIRV("A")=BGPIRV("A")_$S(BGPIRV("A")]"":", ",1:"") S BGPIRV("A")=BGPIRV("A")_$$DATE^BGP3UTL($P(BGPLFT,U,2))_" LFT"
 I $P(BGPV,U,3) D
 .S BGPGOLD=$$GOLDLAB^BGP3D864(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,4) D
 .S BGPCBC=$$CBC4^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,5) D
 .S BGPCBC=$$CBC6^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 ...
 .S BGPSERUM=$$SERUM6^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 ...
 .S BGPLFT=$$LFT6^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,7) D
 .S BGPCBC=$$CBC^BGP3D861(DFN,$$FMADD^XLFDT(BGPEDATE,-180),BGPEDATE)
 ...
 .S BGPUP=$$UP4^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,12) D
 .S BGPGLU=$$GLUCOSE^BGP3D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPIRZ("K")=0,BGPIRV("K")="Glucocorticoids: "
 .I BGPGLU S BGPIRZ("K")=1,BGPIRV("K")=BGPIRV("K")_$$DATE^BGP3UTL($P(BGPGLU,U,2))_" Glucose"
...
TDAP(P,EDATE) ;EP
 ...
 ;F BGPIMM=115 S R=$$IMMREF^BGP3D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
TD ;
 ...
 F BGPZ=9,113 S X=$$ANCONT^BGP3D31(P,BGPZ,EDATE) Q:X]""
 ...
 ;now check Refusals in imm pkg
 ;F BGPIMM=9,113 S R=$$IMMREF^BGP3D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
