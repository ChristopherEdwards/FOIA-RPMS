BGP3DADB ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 09 Apr 2013 10:03 AM ; 23 Jun 2013  12:38 PM
...
INTRO ;
 D EXIT
 W !,"IHS 2013 Area GPRA Dashboard"
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP3DADB",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
EXIT ;
 D ^%ZISC
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP3DADB",XBRX="EXIT^BGP3DADB",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
