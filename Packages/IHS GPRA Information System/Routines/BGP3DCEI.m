BGP3DCEI ; IHS/CMI/LAB - calculate HEDIS measures ;
...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIH(BGPIC,1)) X ^BGPELIH(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIH("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIH(BGPI,1)
 ..X ^BGPELIIH(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIH(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90551.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIH(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90551.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..I BGPDEN'="NO" D S(BGPRPT,BGPGBL,N,P,BGPDEN)
 .K BGPNUMV
 .I $D(BGPLIST(BGPIC)) D STMP^BGP3EUTL
