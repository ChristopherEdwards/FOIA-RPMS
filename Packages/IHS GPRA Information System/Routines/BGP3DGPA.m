BGP3DGPA ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP3DGPA",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D EXIT Q
 Q
 ;
 K IOP,%ZIS I BGPROT="D",BGPDELT="F" D NODEV,EXIT Q
 K IOP,%ZIS W !! S %ZIS=$S(BGPDELT'="S":"PQM",1:"PM") D ^%ZIS
...
EXIT ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP3DGPA",XBRX="EXIT^BGP3DGPA",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
