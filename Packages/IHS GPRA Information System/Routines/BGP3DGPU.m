BGP3DGPU ; IHS/CMI/LAB - IHS AREA CLIN 05 REPORT DRIVER ;
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP3DGPU",XBRX="XIT^BGP3DGPU",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP3DGPU",ZTDTH="",ZTDESC="NATIONAL GPRA GPU REPORT 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
