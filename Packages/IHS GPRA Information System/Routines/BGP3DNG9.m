BGP3DNG9 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM 31 Jul 2013 11:21 AM 13 Aug 2013 5:44 PM ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2014 National GPRA/GPRAMA Report",80)
INTRO ;
 D XIT
 W !!,"This will produce a National GPRA/GPRAMA report for the 2014 GPRA year using"
 W !,"the same performance measure definitions from CRS Version 13.0."
 W !!,"You will be asked to provide the community taxonomy to determine which patients"
 W !,"will be included.  This report will be run for the Report Period July 1, 2013"
 W !,"through June 30, 2014 with a Baseline Year of July 1, 1999 through"
...
ZIS ;call to XBDBQUE
 ...
 I BGPRPT="" D XIT Q
 I BGPEXPT D
 .W !!,"A file will be created called BG130",$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT," and will reside",!,"in the ",BGPUF," directory.",!
...
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP3DNG9",XBRX="XIT^BGP3DNG9",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP3DNG9",ZTDTH="",ZTDESC="GPRA AND PART REPORT 11 for 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
