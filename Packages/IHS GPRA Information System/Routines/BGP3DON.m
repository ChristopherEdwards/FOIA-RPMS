BGP3DON ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ...
 W:$D(IOF) @IOF
 D XIT
 W !,$$CTR("IHS 2013 Other National Measures Report",80)
CHOICE ;
...
INTRO ;
 ...
 .W !,"This report will be run for the Report Period July 1, 2012 through "
 .W !,"June 30, 2013 with a Baseline Year of July 1, 1999 through June 30, 2000."
...
ZIS ;call to XBDBQUE
 ...
 I BGPRPT="" D XIT Q
 I BGPEXPT D
 .W !!,"A file will be created called BG130",$P(^AUTTLOC(DUZ(2),0),U,10)_".ONM"_BGPRPT," and will reside",!,"in the ",BGPUF," directory.",!
...
DRIVER ;
 D ^BGP3D1
 ;I $D(BGPSEAT) D ^BGP3D10
 U IO
 D ^BGP3DP
 D ^%ZISC
 I BGPEXPT D GS^BGP3UTL
 ;I $G(BGPEXCEL) D EXCELGS^BGP3UTL
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP3DON",XBRX="XIT^BGP3DON",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP3DON",ZTDTH="",ZTDESC="Other National Measures REPORT 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
