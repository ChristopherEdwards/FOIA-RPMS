BGP3DP11 ; IHS/CMI/LAB - print ind 1 ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0)  D H3^BGP3DPH
...
PR ; 
 I $Y>(BGPIOSL-13) I '$G(BGPSUMON) D HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0) D H3^BGP3DPH
...
BL ;
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0) D H3^BGP3DPH
