BGP3DP19 ; IHS/CMI/LAB - print ind 1 03 Jul 2010 7:40 AM ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0)  D H9^BGP3DPH
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF="013.B.1"_BGPX S BGPPC=$O(^BGPINDHC("C",BGPF,0))
 ...
 I BGPF="013.B.1A"!(BGPF="013.B.1B") D GPRANT1^BGP3DP1C
 Q
I1AGE2 ;
 S D=D+1
 S BGPF="013.B.2"_BGPX S BGPPC=$O(^BGPINDHC("C",BGPF,0))
...
PR ; 
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0) D H9^BGP3DPH
...
BL ;
 D:'$G(BGPSUMON) HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0) D H9^BGP3DPH
