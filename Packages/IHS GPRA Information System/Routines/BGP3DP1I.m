BGP3DP1I ; IHS/CMI/LAB - print ind 1 ;
...
SNDPG ;EP
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,2) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,3) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,4) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,5) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,6) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,7) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,8) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,9) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,10) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAC(X),U,11) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 S BGPYSTP=1
 Q
PR ;EP
 I '$G(BGPSUMON),BGPPTYPE="P" D HEADER^BGP3DPH Q:BGPQUIT  D W^BGP3DP(^BGPINDH(BGPIC,53,1,0),0,1,BGPPTYPE) D:$D(^BGPINDH(BGPIC,53,2,0)) W^BGP3DP(^BGPINDH(BGPIC,53,2,0),0,1,BGPPTYPE) D AH^BGP3DP1H
 ...
 D W^BGP3DP(BGPHD2,0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S V=$P(BGPDAP(X),U) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="P" D W^BGP3DP("# w/HIV screening-No",0,2,BGPPTYPE)
 D W^BGP3DP($S(BGPPTYPE="P":" Refusals (GPRA Dev.)",1:"# w/HIV screening-No Refusals (GPRA Dev.)"),0,$S(BGPPTYPE="P":1,1:2),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S V=$P(BGPDAP(X),U,2) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="P" D W^BGP3DP("% w/HIV screening-No",0,1,BGPPTYPE)
 D W^BGP3DP($S(BGPPTYPE="P":" Refusals (GPRA Dev.)",1:"% w/HIV screening-No Refusals (GPRA Dev.)"),0,$S(BGPPTYPE="P":1,1:1),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S V=$P(BGPDAP(X),U,3) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP3DP("A. # w/ positive result w/ % of Total Screened",0,2,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP3DP("A. # w/ positive result w/",0,2,BGPPTYPE),W^BGP3DP(" % of Total Screened",0,1,BGPPTYPE)
 ...
 I BGPPTYPE="P" D W^BGP3DP("# w/HIV screening",0,2,BGPPTYPE)
 D W^BGP3DP($S(BGPPTYPE="P":" Refusal",1:"# w/HIV screening Refusal"),0,$S(BGPPTYPE="P":1,1:2),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S V=$P(BGPDAP(X),U,10) D W^BGP3DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="P" D W^BGP3DP("% w/HIV screening",0,1,BGPPTYPE)
 D W^BGP3DP($S(BGPPTYPE="P":" Refusal",1:"% w/HIV screening Refusal"),0,$S(BGPPTYPE="P":1,1:1),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S V=$P(BGPDAP(X),U,11) D W^BGP3DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ;percentage changes
 D W^BGP3DP("CHANGE FROM PREVIOUS YR %",0,2,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP3DP("# w/HIV screening-No",0,2,BGPPTYPE)
 D W^BGP3DP($S(BGPPTYPE="P":" Refusals (GPRA Dev.)",1:"# w/HIV screening-No Refusals (GPRA Dev.)"),0,$S(BGPPTYPE="P":1,1:2),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAP(X),U,3) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP3DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP3DP("A. # w/ positive result w/ % of Total Screened",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP3DP("A. # w/ positive result w/",0,1,BGPPTYPE),W^BGP3DP(" % of Total Screened",0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAP(X),U,5) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP3DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP3DP("B. # w/ negative result w/ % of Total Screened",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP3DP("B. # w/ negative result w/",0,1,BGPPTYPE),W^BGP3DP(" % of Total Screened",0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,7),O=$P(BGPDAP(X),U,7) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP3DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP3DP("C. # w/ No result w/ % of Total Screened",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP3DP("C. # w/ No result w/",0,1,BGPPTYPE),W^BGP3DP(" % of Total Screened",0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,9),O=$P(BGPDAP(X),U,9) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP3DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="P" D W^BGP3DP("% w/HIV screening",0,1,BGPPTYPE)
 D W^BGP3DP($S(BGPPTYPE="P":" Refusal",1:"% w/HIV screening Refusal"),0,$S(BGPPTYPE="P":1,1:1),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAP(X),U,11) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP3DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 Q
BL ;EP
 D BL^BGP3DP1K
 Q
