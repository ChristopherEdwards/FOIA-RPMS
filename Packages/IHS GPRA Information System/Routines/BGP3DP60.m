BGP3DP60 ; IHS/CMI/LAB - print ind H ;
...
PR ; 
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP3DPH Q:BGPQUIT  W:'$G(BGPSUMON) !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0) D H3
...
PB ;
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPINDH(BGPIC,53,1,0) W:$D(^BGPINDH(BGPIC,53,2,0)) !,^BGPINDH(BGPIC,53,2,0) D H3
 ;percentage changes
