BGP3DP7 ; IHS/CMI/LAB - print ind 10 ;
...
PI1 ;
 ...
 I BGPRTYPE'=4,BGPINDH="G",$P(^BGPINDHC(BGPPC,0),U,5)'=1 Q
 I BGPRTYPE=4,$P($G(^BGPINDHC(BGPPC,21)),U,2)=1 Q
 I BGPINDH="D",$P(^BGPINDHC(BGPPC,0),U,12)'=1 Q
 I BGPINDH="C",$P(^BGPINDHC(BGPPC,0),U,13)'=1 Q
 I BGPINDH="W",$P($G(^BGPINDHC(BGPPC,12)),U,2)'=1 Q
 I BGPINDH="E",$P($G(^BGPINDHC(BGPPC,12)),U,3)'=1 Q
