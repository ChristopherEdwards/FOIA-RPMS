BGP3EL12 ; IHS/CMI/LAB - print ind ;
...
I1AGE7 ;
 S I=I+1
 S BGPF="ELD."_$P(BGPX,".")_"."_($P(BGPX,".",2)+32) S BGPPC=$O(^BGPELIIH("C",BGPF,0))
 ;
 S BGPNF=$P(^BGPELIIH(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90551.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE9 ;
 S J=J+1
 S BGPF="ELD."_$P(BGPX,".")_"."_($P(BGPX,".",2)+28) S BGPPC=$O(^BGPELIIH("C",BGPF,0))
 ;
 S BGPNF=$P(^BGPELIIH(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90551.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
