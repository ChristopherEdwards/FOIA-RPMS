BGP3EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS =>55",BGPHD2="# Active Diabetics"
 D HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPELIH(BGPIC,53,1,0)  D H3^BGP3EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP3DPH Q:BGPQUIT  W !,^BGPELIH(BGPIC,53,1,0) D H3^BGP3EL12
