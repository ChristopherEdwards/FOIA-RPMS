BGP3EL1Q ; IHS/CMI/LAB - print ind ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
I1AGEP ;EP
PR ; 
 D HEADER^BGP3DPH W !,^BGPELIH(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3^BGP3EL1P S X=" " D S(X,1,1)
...
S(Y,F,P) ;set up array
 ;Q:BGPQUIT
 ;I $Y>(IOSL-5) D HEADER^BGP3DPH Q:BGPQUIT
 ;W !,^BGPELIH(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 I $G(F) F J=1:1:F W !
