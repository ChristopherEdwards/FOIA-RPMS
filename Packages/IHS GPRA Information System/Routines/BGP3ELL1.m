BGP3ELL1 ; IHS/CMI/LAB - print ind 1 ;
...
EFR ;EP
 D H1
 S BGPPC0=$P(^BGPELIH(BGPIC,0),U,6)
...
PI ;EP
 S BGPDENP=0
 S BGPPC2=0 F  S BGPPC2=$O(^BGPELIIH("ABC",BGPPC1,BGPPC2)) Q:BGPPC2=""  S BGPPC=$O(^BGPELIIH("ABC",BGPPC1,BGPPC2,0)) D PI1
 ;S BGPPC2=0 F  S BGPPC2=$O(^BGPELIIH("AB",BGPPC1,BGPPC2)) Q:BGPPC2=""  S BGPPC=$O(^BGPELIIH("AB",BGPPC1,BGPPC2,0)) D PI1
 Q
PI1 ;
 ...
 .Q:$G(BGPNODEN)
 .S Y=$P(^BGPELIIH(BGPPC,0),U,17) D S(Y,1,1)
 .I $P(^BGPELIIH(BGPPC,0),U,18)]"" D
 ..D S($P(^BGPELIIH(BGPPC,0),U,18),1,1)
 .I $P(^BGPELIIH(BGPPC,0),U,21)]"" D
 ..D S($P(^BGPELIIH(BGPPC,0),U,21),1,1)
 ...
 S Y=" " D S(Y,1,1)
 S Y=$P(^BGPELIIH(BGPPC,0),U,15) D S(Y,1,1)
 I $P(^BGPELIIH(BGPPC,0),U,16)]"" S Y=$P(^BGPELIIH(BGPPC,0),U,16) D S(Y,1,1)
