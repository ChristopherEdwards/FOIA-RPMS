BGP3ELP1 ; IHS/CMI/LAB - print ind 1 ;
...
I1A1 ;001.A, 001.B, 001.C
 ...
 Q
I2 ;EP
 I $Y>(BGPIOSL-13) D HEADER^BGP3DPH Q:BGPQUIT  W !!,^BGPELIH(BGPIC,53,1,0)
 D H1^BGP3DPH
...
IRAA ;EP
 D H1^BGP3DPH
 F BGPPC1=$P(^BGPELIH(BGPIC,0),U,6)_".1" Q:BGPQUIT  D PI
 D I1AGE^BGP3EL1N
 Q
AWV ;EP
 D H1^BGP3DPH
...
PCV ;EP
 ...
 D HEADER^BGP3DPH Q:BGPQUIT  W !!,^BGPELIH(BGPIC,53,1,0) D H1^BGP3DPH
...
PI1 ;
 ...
 .I $Y>(BGPIOSL-13) D HEADER^BGP3DPH Q:BGPQUIT  W !!,^BGPELIH(BGPIC,53,1,0) D H1^BGP3DPH
 .W !!,$P(^BGPELIIH(BGPPC,0),U,17)
 .I $P(^BGPELIIH(BGPPC,0),U,18)]"" D
 ..W !,$P(^BGPELIIH(BGPPC,0),U,18)
 .I $P(^BGPELIIH(BGPPC,0),U,21)]""  D
 ..W !,$P(^BGPELIIH(BGPPC,0),U,21)
 ...
 D SETN
 ;write header
 I $Y>(IOSL-5) D HEADER^BGP3DPH Q:BGPQUIT  W !!,^BGPELIH(BGPIC,53,1,0) D H1^BGP3DPH
 I $P(^BGPELIIH(BGPPC,0),U,22) W !
 W !,$P(^BGPELIIH(BGPPC,0),U,15)
 I $P(^BGPELIIH(BGPPC,0),U,16)]"" W !?1,$P(^BGPELIIH(BGPPC,0),U,16)
 I $P(^BGPELIIH(BGPPC,0),U,19)]"" W !?1,$P(^BGPELIIH(BGPPC,0),U,19)
 D H2^BGP3DPH
 Q
