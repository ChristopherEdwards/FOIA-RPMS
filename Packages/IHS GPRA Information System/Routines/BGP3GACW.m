BGP3GACW ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT 01 Jul 2010 7:57 PM ;
...
TESTCHW ;
 ...
 D EP(.ERR,1,2522,"BGP 13 AREA GPRA","A",.BGPSUL,$$NOW^XLFDT)
 W !,ERR
 Q
...
NT ;
 ...
 ;S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP3DCHA(BGPBBD)_$$D^BGP3DCHA(BGPED)_BGPNOW_"_001_of_001"_".TXT"
 S BGPASUF=$P(^AUTTLOC(DUZ(2),0),U,10)
 S BGPDELT=""
 ...
 S X=BGPFILE
 S DIC="^BGPGUIH(",DIC(0)="L",DIADD=1,DLAYGO=90549.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///"_$G(BGPROT)_";1///"_$G(BGPFN)
...
TSKMN ;
 ;S ZTIO=""
 ;K ZTSAVE S ZTSAVE("*")=""
 ;S ZTCPU=$G(IOCPU),ZTRTN="AOCHW^BGP3GACW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI CHILDHOOD HT/WT EXPORT" D ^%ZTLOAD Q
 D AOCHW
 Q
AOCHW ;
 K ^TMP($J,"BGPGUI")
