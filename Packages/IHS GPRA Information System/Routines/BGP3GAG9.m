BGP3GAG9 ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
EP1 ;
 ...
 D TSKMN
 S BGPRET=BGPGIEN
 S BGPFN=$G(BGPFGNT1)_","_$G(BGPFGNT2)_","_$G(BGPFGNT3)_","_$G(BGPFDEV1)_","_$G(BGPFDEV2)
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP3GAG9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI GPRA REPORT 11 FOR 10" D ^%ZTLOAD Q
 Q
AOAGP ;
 K ^TMP($J,"BGPGUI")
