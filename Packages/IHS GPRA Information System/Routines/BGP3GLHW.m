BGP3GLHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM 05 Oct 2013 9:58 AM ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 13 LOCAL HT/WT",597,"","O","P",$$NOW^XLFDT,"lori ht/wt file")
 W !,ERR
 Q
...
NT ;
 ...
 S BGPINDH="G",BGPHWNOW=$$NOW^XLFDT
 S BGPHOME=$P($G(^BGPSITE(DUZ(2),0)),U,2)
 S BGPYWCHW=2
...
CHW ;
 S BGPYWCHW=2
 S BGPHWNOW=$$NOW^XLFDT() S BGPHWNOW=$P(BGPHWNOW,".")_"."_$$RZERO^BGP3UTL($P(BGPHWNOW,".",2),6)
 S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP3UTL(BGPBD)_$$D^BGP3UTL(BGPED)_$$D^BGP3UTL(BGPHWNOW)_"_001_of_001"_".TXT"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLLHW^BGP3GLHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT" D ^%ZTLOAD Q
 Q
NTLLHW ;
 D ^BGP3D1
 K ^TMP($J,"BGPGUI")
 ...
 ;D HWSF^BGP3DHW
 ;D KITM^BGP3DHW
 D GUIR^BGPXBLM("PRINT^BGP3DHW","^TMP($J,""BGPGUI"",")
