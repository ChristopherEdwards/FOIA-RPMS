BGP3GLTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 13 LAB TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP3GLTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LAB TAXONOMY REPORT" D ^%ZTLOAD Q
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP3DLT",BGPRT=7:"ONM^BGP3DLT",BGPRT=2:"CRS^BGP3DLT",BGPRT=4:"ELDER^BGP3DLT",BGPRT=3:"HEDIS^BGP3DLT",BGPRT=5:"CMS^BGP3DLT",BGPRT=8:"EO^BGP3DLT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP3DLT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP")  ;done in LABTAXC^BGP3GU
 S:$D(ZTQUEUED) ZTREQ="@"
