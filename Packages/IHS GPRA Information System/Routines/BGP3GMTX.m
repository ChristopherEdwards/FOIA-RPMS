BGP3GMTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 13 MED TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIH(",DIC(0)="L",DIADD=1,DLAYGO=90549.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP3GMTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI MEDICATION TAXONOMY REPORT" D ^%ZTLOAD Q
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP3DMT",BGPRT=7:"ONM^BGP3DMT",BGPRT=2:"CRS^BGP3DMT",BGPRT=4:"ELDER^BGP3DMT",BGPRT=3:"HEDIS^BGP3DMT",BGPRT=5:"CMS^BGP3DMT",BGPRT=8:"EO^BGP3DMT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP3DMT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP") done in MEDTAXC^BGP3GU
 S:$D(ZTQUEUED) ZTREQ="@"
