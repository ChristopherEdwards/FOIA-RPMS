BGP3GNST ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP3GNPL",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT LISTS 05" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP3D1
 K ^TMP($J,"BGPGUI")
