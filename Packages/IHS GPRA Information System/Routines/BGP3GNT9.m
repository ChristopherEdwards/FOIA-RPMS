BGP3GNT9 ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
...
NT ;
 ...
 I $G(BGPEXPT) S BGPFILEN="BG130"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
 ;I BGPYWCHW=2 D
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP3GNT9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATL GPRA RPT 10 FOR 11" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP3D1
 K ^TMP($J,"BGPGUI")
 ...
 ;I $G(BGPYWCHW)=2 D HWSF^BGP3DNG9
 D ENDLOG
 D XIT
 Q
 ;
