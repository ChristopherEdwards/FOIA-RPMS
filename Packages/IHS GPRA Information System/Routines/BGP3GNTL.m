BGP3GNTL ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 13 NATIONAL GPRA REPORT",597,0,"B",$$NOW^XLFDT,,0)
 W !,ERR
 Q
...
NT ;
 ...
 ;.S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP3UTL(BGPBD)_$$D^BGP3UTL(BGPED)_$$D^BGP3UTL(BGPNOW)_"_000001"_".TXT"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP3GNTL",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 06" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP3D1
 K ^TMP($J,"BGPGUI")
