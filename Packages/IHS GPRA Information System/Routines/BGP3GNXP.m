BGP3GNXP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 13 NATL EXPORT",597,1,1,,$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPRTYPE=1,BGPXPRP=1,BGPXPFYY=2013,BGPXPFYI=312
 S BGPXPHD=3120701,BGPXPEDT=3130630
 K BGPTAX S X=0
...
HOME ;
 ...
 S BGPFN="CRSCNT"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP3UTL(BGPXPHD)_$$D^BGP3UTL(BGPXPEDT)_$$D^BGP3UTL(BGPNOW)_"_001_of_001.TXT"
 ;CREATE REPORT ENTRY
 ...
 S BGPGFNM=X
 S DIC="^BGPGUIA(",DIC(0)="L",DIADD=1,DLAYGO=90549.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP3GNXP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT 11" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE1
 K ^TMP($J,"BGPGUI")
 ...
 S ^BGPGUIA(BGPGIEN,11,0)="^90549.1911^"_C_"^"_C_"^"_DT
 K ^TMP($J,"BGPGUI")
 D ENDLOG
 D XIT
 Q
