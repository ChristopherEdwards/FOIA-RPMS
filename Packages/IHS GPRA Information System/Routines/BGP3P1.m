BGP3P1 ; IHS/CMI/LAB - v11.0 patch 1 env routine 08 Dec 2010 3:10 PM ;
...
POST ;EP - called from kids build
 ...
 S BGPX=0 F  S BGPX=$O(^BGPGPDCH(BGPX)) Q:BGPX'=+BGPX  D
 .I '$D(^BGPGPDCH(BGPX,1.1)) S DA=BGPX,DIK="^BGPGPDCH(" D ^DIK S DA=BGPX,DIK="^BGPGPDPH(" D ^DIK S DA=BGPX,DIK="^BGPGPDBH(" D ^DIK
 Q
