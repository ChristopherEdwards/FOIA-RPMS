BGP3PDL0 ; IHS/CMI/LAB - print ind 1 01 Jul 2010 8:03 PM ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
IC1 ;EP
 S BGPXXX=$P(^BGPINDH(BGPIC,12),U,6)
 I BGPINDH'="D" D:'$G(BGPSUMON) H1^BGP3PDL1
 I BGPINDH'="D" F BGPPC1=BGPXXX_".1",BGPXXX_".2",BGPXXX_".3" D PI^BGP3PDL1
 I BGPINDH'="D" D:'$G(BGPSUMON) H1^BGP3PDL1
 I BGPINDH'="D" F BGPPC1=BGPXXX_".4",BGPXXX_".5",BGPXXX_".6" D PI^BGP3PDL1
 D:'$G(BGPSUMON) H1^BGP3PDL1
 F BGPPC1=BGPXXX_".7",BGPXXX_".8",BGPXXX_".9" D PI^BGP3PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPINDH="D"
 ...
 S X=^BGPINDH(BGPIC,53,1,0) D S(X,1,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
