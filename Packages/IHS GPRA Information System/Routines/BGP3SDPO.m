BGP3SDPO ; IHS/CMI/LAB - IHS summary page ; 17 May 2013  9:52 AM
...
START ;
 ...
 ...D W^BGP3DP($P(^BGPINDHC(BGPPC,19),U,4),0,2,BGPPTYPE)
 ...I $P(^BGPINDHC(BGPPC,19),U,7)]"" D W^BGP3DP($P(^BGPINDHC(BGPPC,19),U,7),0,1,BGPPTYPE)
 ...I $P(^BGPINDHC(BGPPC,19),U,12)]"" D W^BGP3DP($P(^BGPINDHC(BGPPC,19),U,12),0,1,BGPPTYPE)
 ...
 ...D W^BGP3DP($P(^BGPINDHC(BGPPC,19),U,2),0,0,BGPPTYPE,,55)
 ...;D W^BGP3DP($P(^BGPINDHC(BGPPC,19),U,3),0,0,BGPPTYPE,,65)
 ...I $P(^BGPINDHC(BGPPC,19),U,9)]""!($P(^BGPINDHC(BGPPC,19),U,10)]"")!($P(^BGPINDHC(BGPPC,19),U,11)]"") D
 ....D W^BGP3DP($TR($P(^BGPINDHC(BGPPC,19),U,10),"$","^"),0,0,BGPPTYPE,,55) ;,W^BGP3DP($P(^BGPINDHC(BGPPC,19),U,11),0,0,BGPPTYPE,,65)
 ...
 .....D W^BGP3DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U),7,0),0,0,BGPPTYPE,,20)
 .....D W^BGP3DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,2),7,0),0,0,BGPPTYPE,,29)
 .....D W^BGP3DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,3),7,0),0,0,BGPPTYPE,,38)
 ....E  D
 .....I $Y>(BGPIOSL-3) D HEADER Q:BGPQUIT
 .....D W^BGP3DP(BGPSASU,0,1,BGPPTYPE,,2),W^BGP3DP($E(BGPSNAM,1,12),0,0,BGPPTYPE,,8)
 .....D W^BGP3DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U),7,1)_"%",0,0,BGPPTYPE,,20)
 .....D W^BGP3DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,2),7,1)_"%",0,0,BGPPTYPE,,29)
 .....D W^BGP3DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,3),7,1)_"%",0,0,BGPPTYPE,,38)
 ..I BGPPTYPE="D" D
 ...D W^BGP3DP("",0,1,BGPPTYPE)
 ...S XX=" "_$P(^BGPINDHC(BGPPC,19),U,4)
 ...I $P(^BGPINDHC(BGPPC,19),U,7)]"" D W^BGP3DP(XX,0,1,BGPPTYPE) S XX=" "_$P(^BGPINDHC(BGPPC,19),U,7)
 ...I $P(^BGPINDHC(BGPPC,19),U,12)]"" D W^BGP3DP(XX,0,1,BGPPTYPE) S XX=" "_$P(^BGPINDHC(BGPPC,19),U,12)
 ...
 ...S $P(XX,U,6)=$P(^BGPINDHC(BGPPC,19),U,2) ;,$P(XX,U,7)=$P(^BGPINDHC(BGPPC,19),U,3)
 ...
 ....;S Y="" I $P(^BGPINDHC(BGPPC,19),U,9)]""!($P(^BGPINDHC(BGPPC,19),U,10)]"") S $P(Y,U,6)=$TR($P(^BGPINDHC(BGPPC,19),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDHC(BGPPC,19),U,10),"$","^")
 ....S Y="" I $P(^BGPINDHC(BGPPC,19),U,9)]""!($P(^BGPINDHC(BGPPC,19),U,10)]"")!($P(^BGPINDHC(BGPPC,19),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDHC(BGPPC,19),U,9),"$","^") D
 .....;S $P(Y,U,8)=$P(^BGPINDHC(BGPPC,19),U,11)
...
HEADER ;EP
 ...
 Q
H1 ;
 S X="SELECTED OTHER NATIONAL MEASURES CLINICAL PERFORMANCE DETAIL" D W^BGP3DP(X,0,1,BGPPTYPE)
 ...
 D W^BGP3DP("Current",0,1,BGPPTYPE,2,22),W^BGP3DP("Prev",0,0,BGPPTYPE,3,32),W^BGP3DP("Base",0,0,BGPPTYPE,4,40),W^BGP3DP("Current",0,0,BGPPTYPE,5,46),W^BGP3DP("2012",0,0,BGPPTYPE,6,55) ;,W^BGP3DP("Target",0,0,BGPPTYPE,8,66)
