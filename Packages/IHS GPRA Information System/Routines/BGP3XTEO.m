BGP3XTEO ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2013 Executive Order Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP3XTEO",XBNS="",XBRX="XIT^BGP3XTEO"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
GUICHK ;EP
 ...
 .Q:'$D(^BGPTAXH(BGPY,12,"B",8))  ;8 IS SET OF CODES FOR EO REPORT
