BGP3XTHE ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY07 HEDIS REPORT ;
 ;;13.0;IHS CLINICAL REPORTING;;NOV 20, 2012;Build 81
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2013 HEDIS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP3XTHE",XBNS="",XBRX="XIT^BGP3XTHE"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
