...
PROC ;EP
 ...
 D XTMP^BGP4UTL("BGP28CPL","National GPRA Comp List")
 D XTMP^BGP4UTL("BGP4DNP","National GPRA Patient List")
 D XTMP^BGP4UTL("BGP4D","CRS Local Patient List")
 ...
 .;I DUZ=5634,DFN'=14486 Q
 .;I DUZ=5634 Q:DFN'=116831
 .;I DUZ=5634 Q:$$HRN^AUPNPAT(DFN,DUZ(2))'=161336
 .Q:'$D(^AUPNPAT(DFN,0))
...
PROCCY ;EP - current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDCB(",BGPRTYPE=5:"^BGPELDCJ(",BGPRTYPE=8:"^BGPEOCB(",1:"^BGPGPDCJ(")
 S BGP365=BGPBDATE
 ...
 I $G(BGPIISO) D ISS^BGP4DPA1 K ^TMP($J,"A") Q  ;SCHEDULING OPTION
 D CALCIND
 K ^TMP($J,"A")
 Q
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDPB(",BGPRTYPE=5:"^BGPELDPJ(",BGPRTYPE=8:"^BGPEOPB(",1:"^BGPGPDPJ(")
 S BGP365=BGPBDATE
 ...
 S BGPAGEE=$$AGE^AUPNPAT(DFN,BGPEDATE)
 S BGPSEX=$P(^DPT(DFN,0),U,2)
 ;I $$V2IHD^BGP4D9(DFN,BGP365,BGPEDATE),$$FIRSTIHD^BGP4D9(DFN,BGPEDATE) S BGPIHD=1
 S BGPDM1=$$DM(DFN,,BGPEDATE) ;dm diagnosis ever?
 S BGPDM2=$$DM(DFN,BGP365,BGPEDATE) ;dm diagnosis in past year
 I BGPDM1 D  ;set up 4 dm demoninators
 .S BGPFDMD=$$FIRSTDM(DFN,BGPEDATE) ;1 OR 0 FIRST DX BEFORE BEG
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDBB(",BGPRTYPE=5:"^BGPELDBJ(",BGPRTYPE=8:"^BGPEOBB(",1:"^BGPGPDBJ(")
 S BGP365=BGPBDATE
 ...
 Q
CALCIND ;
 I BGPRTYPE=5 D CALCIND^BGP4DCEI Q
 D CALCIND^BGP4DCI
 Q
...
ACTCLBH(P,BDATE,EDATE) ;EP - clinical user
 ...
 .Q:B=""
 .I 'G,$D(^BGPCTRL($O(^BGPCTRL("B",2014,0)),11,"B",B)) S G=V  ;must be a primary clinic S G=V
 .I V'=G,$D(^BGPCTRL($O(^BGPCTRL("B",2014,0)),95,"B",B)) S S=1
 .I G,S S F=1
 .Q
 Q $S(F:1,1:0)
FIRSTDM(P,EDATE) ;
