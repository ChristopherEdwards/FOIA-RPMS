BGP4D1 ; IHS/CMI/LAB - calc indicators ;
...
PROCCY ;current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDCF(",1:"^BGPGPDCF(")
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDPF(",1:"^BGPGPDPF(")
 S BGP365=$$FMADD^XLFDT(BGPEDATE,-365)
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDBF(",1:"^BGPGPDBF(")
 S BGP365=$$FMADD^XLFDT(BGPEDATE,-365)
 ...
 Q
CALCIND ;
 I BGPRTYPE=3 D CALCIND^BGP4DCHI Q
 D CALCIND^BGP4DCI
 Q
...
ACTCL(P,BDATE,EDATE) ;EP - clinical user
 ...
 .Q:B=""
 .I 'G,$D(^BGPCTRL(2,11,"B",B)) S G=V  ;must be a primary clinic S G=V
 .I V'=G,$D(^BGPCTRL(2,12,"B",B)) S S=1
 .I G,S S F=1
 .Q
 Q $S(F:1,1:0)
 ;
