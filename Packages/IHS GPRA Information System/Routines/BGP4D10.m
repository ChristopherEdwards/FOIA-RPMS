BGP4D10 ; IHS/CMI/LAB - calc indicators ;
...
PROC ;EP
 ...
 S DFN=0 F  S DFN=$O(^DIBT(BGPSEAT,1,DFN)) Q:DFN'=+DFN  D PROCCY,PROCPY,PROCBY
 S BGPET=$H
 Q
 ;
PROCCY ;current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL="^BGPGPDCF("
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL="^BGPGPDPF("
 S BGP365=$$FMADD^XLFDT(BGPEDATE,-365)
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPAGEB=$$AGE^AUPNPAT(DFN,BGPBDATE)
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL="^BGPGPDBF("
 S BGP365=$$FMADD^XLFDT(BGPEDATE,-365)
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPAGEB=$$AGE^AUPNPAT(DFN,BGPBDATE)
