BGP4D2 ; IHS/CMI/LAB - indicator 1,2,3,4 ;
...
I1 ;EP - indicator 1 general processing
 ...
 S BGPVALUE=$$DATE^BGP4UTL($P(BGPG(1),U))_" "_$P(BGPG(1),U,2)
 Q
 ;
I2 ;EP
 ...
 S BGPVALUE=$S(BGPDMD1:"UP",1:"")_$S(BGPDMD2:",AD",1:"")_$S(BGPDMD3:",AAD",1:"")_"; "_$$DATE^BGP4UTL($P(BGPLHGB,U,3))_" "_$P(BGPLHGB,U,4)
...
I4 ;EP
 ...
 S BGPVALUE=$S(BGPDMD1:"UP",1:"")_$S(BGPDMD2:",AD",1:"")_$S(BGPDMD3:",AAD",1:"")_"; "_$S(BGPN1:"LP; ",1:" ")_$$DATE^BGP4UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
