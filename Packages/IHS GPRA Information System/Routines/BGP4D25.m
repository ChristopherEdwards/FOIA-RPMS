...
DEP(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(2)) S BGPDEP((9999999-$P(BGPG(1),U)))="",BGPDEP((9999999-$P(BGPG(2),U)))="" Q 1_U_$$DATE^BGP4UTL($P(BGPG(2),U))_" POV "_$P(BGPG(2),U,2)_" + "_$$DATE^BGP4UTL($P(BGPG(1),U))_" POV "_$P(BGPG(1),U,2)
