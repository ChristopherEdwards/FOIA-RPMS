BGP4D28 ; IHS/CMI/LAB - measure I2 ;
...
IAA ;EP  - ASTHMA ASSESSMENTS
 ...
 I BGPAMP]"" S BGPN1=1
 S BGPASD=$$SEV^BGP4D31(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
 I BGPASD]"" S BGPN2=1
...
SFD(P,BD,ED) ;
 ...
 I G="" Q ""
 Q "Symptom Free Days: "_$$DATE^BGP4UTL(G)_" ["_H_"]"_U_H
 ;
 ;
 ;
ADM(P,BD,ED) ;
 ...
 ..S G=(9999999-E),H=$P(^AUPNVMSR(X,0),U,4)
 I G="" Q ""
 Q "Days Missed: "_$$DATE^BGP4UTL(G)_" ["_H_"]"_U_H
 ;
 ;
ACON(P,BD,ED,F) ;EP - return last ASTHMA CONTROL recorded
 ...
 .S G=D
 I G="" Q ""
 I F=1 Q "Control: "_$$DATE^BGP4UTL(G)
 ;
 Q ""
 ;
