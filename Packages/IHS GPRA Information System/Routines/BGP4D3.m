BGP4D3 ; IHS/CMI/LAB - measure 11 17 Oct 2009 12:40 PM ;
...
I10 ;EP
 ...
 S (BGPSEAL,BGPSEALD)=""
 K BGPSEALS,BGPSELDS
 D SEAL^BGP4D3A(DFN,BGPBDATE,BGPEDATE) ;this is for the number of sealants only
 S BGPN1=$P(BGPSEAL,U)
...
I101 ;
 ;get new sealant definition 2014 gpra dev
 S BGPSEALD=""
 I 'BGPN1 S BGPSEALD=$$SEALDEV^BGP4D3A(DFN,BGPBDATE,BGPEDATE)
 ...
 I BGPN1 S BGPVALUE=BGPVALUE_"; "_+BGPN1_" sealants" S X=0 F  S X=$O(BGPSEALS(X)) Q:X'=+X  S D=0 F  S D=$O(BGPSEALS(X,D)) Q:D'=+D  S BGPVALUE=BGPVALUE_$S(X=1:"",1:"; ")_$$DATE^BGP4UTL(D)_" "_BGPSEALS(X,D)
 K BGPSEAL,BGPSEALD
 Q
I11 ;EP
 ...
 S BGPFLUOR=$$TF^BGP4D3A(DFN,BGPBDATE,BGPEDATE)
...
I111 ;
 ...
 I +BGPN1 S BGPVALUE=BGPVALUE_": " F X=2:1:5 I $P(BGPFLUOR,U,X)]"" S BGPVALUE=BGPVALUE_$S(X>2:", ",1:"")_$$DATE^BGP4UTL($P($P(BGPFLUOR,U,X),"|",1))_" "_$P($P(BGPFLUOR,U,X),"|",2)
 ;I BGPN2 S BGPVALUE=BGPVALUE_": "_$$DATE^BGP4UTL($P(BGPFLUOR,U,2))_" "_$P(BGPFLUOR,U,3)
 S BGPVALUD="UP|||"
 I +BGPN1 S BGPVALUD=BGPVALUD_+BGPN1_" topical fluoride" I +BGPN1 S BGPVALUD=BGPVALUD_": " F X=2:1:5 I $P(BGPFLUOR,U,X)]"" S BGPVALUD=BGPVALUD_$S(X>2:", ",1:"")_$$DATE^BGP4UTL($P($P(BGPFLUOR,U,X),"|",1))_" "_$P($P(BGPFLUOR,U,X),"|",2)
 ;I BGPN2 S BGPVALUD=BGPVALUD_": "_$$DATE^BGP4UTL($P(BGPFLUOR,U,2))_" "_$P(BGPFLUOR,U,3)
 K ^TMP($J,"A"),BGPFLUOR
 Q
I12 ;EP
 NEW BGPHR,V
 ...
 S BGPHR=$$HIGHR^BGP4D3A(DFN,BGPEDATE)
 ...
 .I BGPD4 S BGPDV=BGPDV_$S(BGPDV]"":",AD",1:"AD")
 .I BGPHR S BGPDV=BGPDV_$S(BGPDV]"":",HR",1:"HR")
 I BGPRTYPE'=1 S BGPVALUE=BGPDV_"|||"_$$DATE^BGP4UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2)
 I BGPRTYPE=1 D
 .S BGPDV=BGPDV_"|||"
 .I BGPN7 S BGPVALUE=BGPDV_$$DATE^BGP4UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2) Q
 .S BGPVALUE=BGPDV
...
PN ;EP - called from elder
 ...
 .I BGPN1 S BGPVALH=BGPVALUE,BGPVALUE=BGPDV_"|||" I BGPVALH]"" S BGPVALUE=BGPVALUE_"Pneumo: "_$$DATE^BGP4UTL($P(BGPVALH,U,1))_" "_$P(BGPVALH,U,2)_$S(BGPVALH]""&($P(BGPVALH,U,2)'["Ref"):" (ever)",1:"") Q
 .S BGPVALUE=BGPDV_"|||"
 I BGPRTYPE=4 D
 .S BGPDV="UP"
 ...
 D
 .I BGPRTYPE'=1 S BGPVALH=BGPVALUE,BGPVALUE=BGPDV_"|||" I BGPVALH]"" S BGPVALUE=BGPVALUE_"Pneumo: "_$$DATE^BGP4UTL($P(BGPVALH,U,1))_" "_$P(BGPVALH,U,2)_$S(BGPVALH]""&($P(BGPVALH,U,2)'["Ref"):" (ever)",1:"")_" "_$S(BGPN8:" (up-to-date)",1:"")
 .S BGPVALUD="AC"_"|||"
 .I BGPN4 S BGPVALUD=BGPVALUD_"Pneumo: "_$$DATE^BGP4UTL($P(BGPVALH,U,1))_" "_$P(BGPVALH,U,2)_$S(BGPVALH]""&($P(BGPVALH,U,2)'["Ref"):" (ever)",1:"")_" "
...
I15 ;EP
 ...
 ;I BGPRTYPE=1 S BGPVALUE=$S(BGPI7DA:"UP",1:"")_$S(BGPI7DB:",AC",1:"")_"|||" I BGPN3 S BGPVALUE=BGPVALUE_$$DATE^BGP4UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3)
 ;I BGPRTYPE=3 S BGPVALUE="AC|||"_$$DATE^BGP4UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3)
 I BGPN4 S BGPVALUE=BGPVALUE_$$DATE^BGP4UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3)
 I BGPN5 S BGPVALUE=BGPVALUE_"PAP: "_$$DATE^BGP4UTL($P(BGPPAP6,U,2))_" "_$P(BGPPAP6,U,3)_"; HPV: "_$$DATE^BGP4UTL($P(BGPHPV,U,2))_" "_$P(BGPHPV,U,3)
...
HPV(P,EDATE,YEARS) ;EP
 ...
 K BGP
 S T="BGP HPV DXS"
 S X=$$LASTDX^BGP4UTL1(P,T,BDATE,EDATE) I X,$P(BGPLPAP,U,2)<$P(X,U,3) S BGPLPAP="1^"_$P(X,U,3)_"^POV "_$P(X,U,2)
...
PAP(P,EDATE,YEARS,REFUSAL) ;EP
 ...
 S X=$$LASTDX^BGP4UTL1(P,T,BDATE,EDATE) I X,$P(BGPLPAP,U,2)<$P(X,U,3) S BGPLPAP="1^"_$P(X,U,3)_"^POV "_$P(X,U,2)
 K BGP S BGP(1)=$$LASTPRC^BGP4UTL1(P,"BGP PAP PROCEDURES",BDATE,EDATE)
 ...
 S T=$$REFUSAL^BGP4UTL1(P,60,$O(^LAB(60,"B","PAP SMEAR",0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 ...
 .Q:'Y
 .S T=$$REFUSAL^BGP4UTL1(P,60,Y,$$FMADD^XLFDT(EDATE,-365),EDATE)
 I T Q 1_"^"_$P(T,U,2)_"^Refused Lab "
 ;add cpt Refusals v11.1
 S T=$$CPTREFT^BGP4UTL1(P,$$FMADD^XLFDT(EDATE,-365),EDATE,$O(^ATXAX("B","BGP CPT PAP",0)))
...
HYSTER(P,EDATE) ;EP 
 I '$G(P) Q ""
 NEW X,T
 S X=$$LASTPRC^BGP4UTL1(P,"BGP HYSTERECTOMY PROCEDURES",$$DOB^AUPNPAT(P),EDATE)
 I X Q 1
 S T="HYSTERECTOMY",T=$O(^BWPN("B",T,0))
 I T D  I X]"" Q 1
 .S X=$$WH^BGP4DU(P,$$DOB^AUPNPAT(P),EDATE,T,2)
 S T=$O(^ATXAX("B","BGP HYSTERECTOMY CPTS",0))
 I T D  I X]"" Q 1
 .S X=$$CPT^BGP4DU(P,$P(^DPT(P,0),U,3),EDATE,T,3) I X]"" Q
 .S X=$$TRAN^BGP4DU(P,$P(^DPT(P,0),U,3),EDATE,T,3)
 S X=$$LASTDX^BGP4UTL1(P,"BGP HYSTERECTOMY DXS",$$DOB^AUPNPAT(P),EDATE)
 I X Q 1
 S X=$$PLTAX^BGP4DU(P,"BGP HYSTERECTOMY DXS")
 I X Q 1
 Q ""
