...
I14 ;EP
 ...
 S (BGPI1,BGPI2,BGPI3,BGPI4,BGPI5,BGPI6,BGPI7,BGPN28,BGPN29,BGP40N,BGPN30,BGPN31,BGPN32,BGPN33,BGPN34,BGPN40,BGPN41,BGPN42)=0
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$DTAP^BGP4D34(DFN,BGPEDATE)  ;1 IS had immunizations, 3 is had Refusal, 4 is disease or NMI or Contraindication
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$OPV^BGP4D33(DFN,BGPEDATE)
 ...
 S BGPVAL=$$MMR^BGP4D33(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 ;S BGPVAL=$$HIB^BGP4D35(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$PNEUMO^BGP4D35(DFN,BGPEDATE,4)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$PNEUMO^BGP4D35(DFN,BGPEDATE,3)
 ...
 I BGPRTYPE='3,$P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$HEPA^BGP4D37(DFN,BGPEDATE)
 I $P(BGPVAL,U,1)=1!($P(BGPVAL,U,1)=4) S BGPN60=1  ;any hit
 I $P(BGPVAL,U,1)=3 S BGPN61=1 ;REFUSAL
 I $P(BGPVAL,U,1)=4 S BGPN62=1  ;CONTRA
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$ROTA2^BGP4D37(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 I 'BGPN70 D
 .S BGPVAL=$$ROTA3^BGP4D37(DFN,BGPEDATE)
 .I $P(BGPVAL,U,1)=1!($P(BGPVAL,U,1)=4) S BGPN70=1  ;any hit
 ...
 .I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 .I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$INFLU^BGP4D38(DFN,BGPEDATE)
