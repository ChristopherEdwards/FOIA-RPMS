...
CHEL ;EP - called from elder care
 ...
 I BGPVALUE]"" S V=V_"CHOL: "_$$DATE^BGP4UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 I $P(BGPLDL,U) S V=V_$S(BGPVALUE]"":"; ",1:"") S V=V_"LDL: "_$$DATE^BGP4UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
 S BGPVALUE=V
