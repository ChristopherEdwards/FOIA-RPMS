BGP4D732 ; IHS/CMI/LAB - measure AHR.A ;
...
ACECONT(P,BDATE,EDATE) ;EP does patient have an ACEI Contraidication
 ...
 I $D(BGPG(1)) Q 1_U_"ACEI Contra POV:  "_$$DATE^BGP4UTL($P(BGPG(1),U))_$P(BGPG(1),U,2)_" "_$$VAL^XBDIQ1(9000010.07,+$P(BGPG(1),U,4),.04)
 ;
 ...
 .Q
 I BGPG Q BGPG
 S X=$$CPTI^BGP4DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8029"))
 I X Q 1_U_"arb Contra CPT code G8029: "_$$DATE^BGP4UTL($P(X,U,2))
 S X=$$TRANI^BGP4DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8029"))
 I X Q 1_U_"arb Contra Tran Code G8029: "_$$DATE^BGP4UTL($P(X,U,2))
 Q ""
...
STATALG(P,BDATE,EDATE) ;EP
 ...
 .I N["STATIN"!(N["STATINS") S BGPC="Alg Statin POV:  "_$$DATE^BGP4UTL($P(BGPG(X),U))_"  ["_$P(BGPG(X),U,2)_"]  "_N
 ...
 .I N["STATIN"!(N["STATINS") S BGPC=1_U_"alg statin POV:  "_$$DATE^BGP4UTL($P(BGPG(X),U))_$P(BGPG(X),U,2)_" "_N
 I BGPC Q BGPC
