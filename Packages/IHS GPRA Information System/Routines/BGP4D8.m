...
IE2 ;EP
 ...
 I BGPACTCL,BGPSEX="F",$$PREG^BGP4D7(DFN,$$FMADD^XLFDT(BGPEDATE,-608),BGPEDATE,1,1),BGPNO2="" S BGPD1=1
 ...
 S BGPCD4=""
 I BGPFIRST D
 .S D=$P(BGPFIRST,U,3) S BGPCD4=$$CD4RES^BGP4D84(DFN,$$FMADD^XLFDT(D,-90),$$FMADD^XLFDT(D,90),1)
 .Q:'BGPCD4
 .S BGPN9=1
 .S R=$P(BGPCD4,U,3)
 .I R="" S BGPN14=1 Q
 ...
 S BGPN7=0
 ;
 S BGPHIVR=$$HIVTEST1^BGP4D812(DFN,BGPBDATE,$S(BGPHIVD:BGPHIVD,1:BGPEDATE))  ;FOR GPRA DEV RESULT ONLY
 S BGPDAFT=""
...
IE1 ;EP
 ...
 S BGPCD4=$$CD4^BGP4D812(DFN,BGPBDATE,BGPEDATE)
 S BGPPCR=$$PCR^BGP4D811(DFN,BGPBDATE,BGPEDATE)
 S BGPRX=$$ART^BGP4D811(DFN,BGPBDATE,BGPEDATE)
 I BGPCD4,'BGPPCR S BGPN1=1
 I BGPPCR,'BGPCD4 S BGPN2=1
 I BGPPCR,BGPCD4 S BGPN3=1
 I (BGPN1+BGPN2+BGPN3) S BGPN4=1
 I BGPRX S BGPN5=1
 S BGPVALUE="UP|||"_$S(BGPN3:"BOTH: ",1:"")_$S(BGPCD4:"CD4: "_$$DATE^BGP4UTL($P(BGPCD4,U,2))_" "_$P(BGPCD4,U,3),1:"")
 I $P(BGPVALUE,"|||",2)]"" S BGPVALUE=BGPVALUE_"; "
 S BGPVALUE=BGPVALUE_$S(BGPPCR:"Viral Load: "_$$DATE^BGP4UTL($P(BGPPCR,U,2))_" "_$P(BGPPCR,U,3),1:"")
 I $P(BGPVALUE,"|||",2)]"" S BGPVALUE=BGPVALUE_"; "
...
PHYACT ;EP
 ...
 I BGPEXER S BGPN2=1,BGPVALUE=BGPVALUE_"; EXER ED: "_$$DATE^BGP4UTL($P(BGPEXER,U,1))_" "_$P(BGPEXER,U,2)
...
EXER(P,BDATE,EDATE) ;
 ...
 I $D(BGPG(1)) Q $P(BGPG(1),U)_U_$P(BGPG(1),U,2)_U_$$DATE^BGP4UTL($P(BGPG(1),U,1))
 S Y="BGPALLED("
...
FIRSTHF(P,BDATE,EDATE,CAT) ;EP
 ...
 S D=$O(O(0))
 I D="" Q D
 Q 1_U_D_U_$$DATE^BGP4UTL(D)_U_$$VAL^XBDIQ1(9000010.23,O(D),.01)
 ;
...
HIVTEST(P,BDATE,EDATE) ;
 ...
 ....I '$D(BGPA((9999999-D))) S BGPC=BGPC+1,BGPC(BGPC)=1_U_$$DATE^BGP4UTL((9999999-D))_" Lab"_U_$P(^AUPNVLAB(X,0),U,4)_U_D,BGPA((9999999-D))="" Q
 ...Q:'T
 ...
 ....I $$ICD^BGP4UTL2($P(^AUPNVCPT(X,0),U),T,1) I '$D(BGPA((9999999-$P(ED,".")))) S BGPC=BGPC+1,BGPC(BGPC)=1_U_$$DATE^BGP4UTL((9999999-$P(ED,".")))_" CPT "_$$VAL^XBDIQ1(9000010.18,X,.01)_U_U_$P(ED,"."),BGPA((9999999-$P(ED,".")))=""
 ....Q
 ...Q
 ..Q
 ...
 .S T=$$REFUSAL^BGP4UTL1(P,60,BGPT1,BDATE,EDATE) I $P(T,U)=1 S G=2_U_$$DATE^BGP4UTL($P(T,U,2))_" Refused Lab"_U_U_$$DATE^BGP4UTL($P(T,U,2))_" Refused Lab"
 Q G
V2HIV(P,BDATE,EDATE) ;
 I '$G(P) Q ""
 I '$D(^AUPNVSIT("AC",P)) Q ""
...
FIRSTDX(P,BDATE,EDATE) ;EP - any HIV dx
 ...
 .S G=1_U_"First DX: "_$$DATE^BGP4UTL($P(BGPG(1),U,1))_U_$P(BGPG(1),U,1)
 S T=$O(^ATXAX("B","BGP HIV/AIDS DXS",0))
 S X=0,G="" F  S X=$O(^AUPNPROB("AC",P,X)) Q:X'=+X!(G]"")  D
 .Q:$P(^AUPNPROB(X,0),U,12)="D"
 .Q:$P(^AUPNPROB(X,0),U,12)="I"
