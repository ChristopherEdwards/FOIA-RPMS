BGP4DADB ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 09 Apr 2014 10:03 AM ; 23 Jun 2014  12:38 PM
...
INTRO ;
 D EXIT
 W !,"IHS 2014 Area GPRA Dashboard"
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DADB",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
EXIT ;
 D ^%ZISC
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP4DADB",XBRX="EXIT^BGP4DADB",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
