...
EISSEX ;
 ...
 .S BGPFONN1="CRSONMNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2014063000000000_$$D^BGP4UTL(BGPNOW)_"_"_$$LZERO^BGP4UTL(BGPC,6)_".TXT"
 .S BGPFONN2="CRSONMNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2014063000000000_$$D^BGP4UTL(BGPNOW)_"_"_$$LZERO^BGP4UTL(BGPC,6)_".TXT"
 .S BGPFONN3="CRSONMNT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_2014063000000000_$$D^BGP4UTL(BGPNOW)_"_"_$$LZERO^BGP4UTL(BGPC,6)_".TXT"
 .S BGPFONN4="CRSONMNT4"_$P(^AUTTLOC(DUZ(2),0),U,10)_2014063000000000_$$D^BGP4UTL(BGPNOW)_"_"_$$LZERO^BGP4UTL(BGPC,6)_".TXT"
 .S BGPFONN5="CRSONMNT5"_$P(^AUTTLOC(DUZ(2),0),U,10)_2014063000000000_$$D^BGP4UTL(BGPNOW)_"_"_$$LZERO^BGP4UTL(BGPC,6)_".TXT"
 .Q
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DARO",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP4DARO",XBRX="EXIT^BGP4DARO",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
