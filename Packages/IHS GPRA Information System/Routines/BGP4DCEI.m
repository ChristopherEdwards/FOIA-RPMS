BGP4DCEI ; IHS/CMI/LAB - calculate HEDIS measures ;
...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIJ(BGPIC,1)) X ^BGPELIJ(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIJ("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIJ(BGPI,1)
 ..X ^BGPELIIJ(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIJ(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90553.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIJ(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90553.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..I BGPDEN'="NO" D S(BGPRPT,BGPGBL,N,P,BGPDEN)
 .K BGPNUMV
 .I $D(BGPLIST(BGPIC)) D STMP^BGP4EUTL
