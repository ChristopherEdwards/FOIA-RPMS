BGP4DL ; IHS/CMI/LAB - IHS GPRA 10 SELECTED REPORT DRIVER 21 May 2010 12:10 PM ; 05 Oct 2013  8:52 AM
 ;;14.0;IHS CLINICAL REPORTING;;NOV 14, 2013;Build 101
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2014 CRS - Clinical Performance Measure Report (Selected Measures)",80)
INTRO ;
 D XIT
...
SUM ;display summary of this report
 ...
 W !!,"These performance measures will be calculated: " S X=0 F  S X=$O(BGPIND(X)) Q:X'=+X  W $P(^BGPINDJ(X,0),U,3)," ; "
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DL",ZTDTH="",ZTDESC="CRS 14 COM REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
