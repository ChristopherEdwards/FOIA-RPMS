BGP4DNDB ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ; 17 Apr 2014  11:15 AM
...
AI ;gather all gpra measures
 ;F X=1:100 I $D(^BGPINDJ("GPRA",1,X)) S BGPIND(X)=""
...
ZIS ;call to XBDBQUE
 ...
 .S DA=BGPRPT,DIK="^BGPGPDPJ(" D ^DIK K DIK
 .S DA=BGPRPT,DIK="^BGPGPDBJ(" D ^DIK K DIK
 I POP,BGPRPF="P" D  D XIT Q
 .W !,"Report Aborted."
 .S BGPXX=0 F  S BGPXX=$O(BGPDESGP(BGPXX)) Q:BGPXX'=+BGPXX  S BGPRPT=BGPDESGP(BGPXX) D
 ..S DA=BGPRPT,DIK="^BGPGPDCJ(" D ^DIK K DIK
 ..S DA=BGPRPT,DIK="^BGPGPDPJ(" D ^DIK K DIK
 ..S DA=BGPRPT,DIK="^BGPGPDBJ(" D ^DIK K DIK
 I $D(IO("Q")) G TSKMN
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP4DNDB",XBRX="XIT^BGP4DNDB",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DNDB",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
