BGP4DNG ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
...
ZIS ;call to XBDBQUE
 ...
 I POP W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDCJ(" D ^DIK K DIK
 I POP W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDPJ(" D ^DIK K DIK
 I POP W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDBJ(" D ^DIK K DIK
 I POP D XIT Q
 I $D(IO("Q")) G TSKMN
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP4DNG",XBRX="XIT^BGP4DNG",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DNG",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
