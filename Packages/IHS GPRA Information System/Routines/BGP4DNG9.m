BGP4DNG9 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM 31 Jul 2014 11:21 AM 13 Aug 2014 5:44 PM ;
...
INTRO ;
 ...
 W !,"will be included.  This report will be run for the Report Period July 1, 2014"
...
ZIS ;call to XBDBQUE
 ...
 I BGPRPT="" D XIT Q
 I BGPEXPT D
 .W !!,"A file will be created called BG140",$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT," and will reside",!,"in the ",BGPUF," directory.",!
...
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP4DNG9",XBRX="XIT^BGP4DNG9",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DNG9",ZTDTH="",ZTDESC="GPRA AND PART REPORT 11 for 11" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
