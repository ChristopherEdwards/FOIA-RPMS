BGP4DNGP ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ...
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2014 National GPRA/GPRAMA Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP4DNGP",XBRX="XIT^BGP4DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP4DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA/GPRAMA REPORT 11 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
