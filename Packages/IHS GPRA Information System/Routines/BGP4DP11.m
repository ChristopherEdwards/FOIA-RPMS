...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0)  D H3^BGP4DPH
...
PR ; 
 I $Y>(BGPIOSL-13) I '$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H3^BGP4DPH
...
BL ;
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H3^BGP4DPH
