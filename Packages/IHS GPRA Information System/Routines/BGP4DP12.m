BGP4DP12 ; IHS/CMI/LAB - print ind 19 AGE DIST ;
 ;;14.0;IHS CLINICAL REPORTING;;NOV 14, 2013;Build 101
 ;
 ;
I1AGE ;EP  special age tallies
 Q:$G(BGPSUMON)
 ;I BGPRTYPE=7 D ^BGP4DP13 Q
...
I1AGE4 ;
 S F=F+1
 S BGPF=BGPX_"D" S BGPPC=$O(^BGPINDJC("OR",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPINDJC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90552.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
PR ; 
 I '$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H4^BGP4DPH
