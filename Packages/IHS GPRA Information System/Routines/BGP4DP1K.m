BGP4DP1K ; IHS/CMI/LAB - print ind 1 ;
...
BL ;EP
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAB(X),U) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAB(X),U,2) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAB(X),U,3) D W^BGP4DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAB(X),U,10) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+9
 ...
 S T=28 F X=9:1:13 S V=$P(BGPDAB(X),U,11) D W^BGP4DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+9
 ;
 D W^BGP4DP("CHANGE FROM BASELINE YR %",0,2,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP4DP("# w/HIV screening-No",0,2,BGPPTYPE)
 D W^BGP4DP($S(BGPPTYPE="P":" Refusals (GPRA Dev.)",1:"# w/HIV screening-No Refusals (GPRA Dev.)"),0,$S(BGPPTYPE="P":1,1:2),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAB(X),U,3) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP4DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP4DP("A. # w/ positive result w/ % of Total Screened",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP4DP("A. # w/ positive result w/",0,1,BGPPTYPE),W^BGP4DP(" % of Total Screened",0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAB(X),U,5) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP4DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP4DP("B. # w/ negative result w/ % of Total Screened",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP4DP("B. # w/ negative result w/",0,1,BGPPTYPE),W^BGP4DP(" % of Total Screened",0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,7),O=$P(BGPDAB(X),U,7) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP4DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="D" D W^BGP4DP("C. # w/ No result w/ % of Total Screened",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP4DP("C. # w/ No result w/",0,1,BGPPTYPE),W^BGP4DP(" % of Total Screened",0,1,BGPPTYPE)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,9),O=$P(BGPDAB(X),U,9) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP4DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 I BGPPTYPE="P" D W^BGP4DP("% w/HIV screening",0,1,BGPPTYPE)
 D W^BGP4DP($S(BGPPTYPE="P":" Refusal",1:"% w/HIV screening Refusal"),0,$S(BGPPTYPE="P":1,1:1),BGPPTYPE,1,1)
 S T=28 F X=9:1:13 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAB(X),U,11) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP4DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+9
 Q
C(X,X2,X3) ;
 D COMMA^%DTC
 Q X
