BGP4DP1T ; IHS/CMI/LAB - print ind 1 12 Nov 2010 7:38 AM ;
...
I1AGEP ;
 ...
 Q
I1AGEP1 ;
 S T=30 F X=1:1:2 S V=$P(@BGPARR@(X),U) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+11
 D W^BGP4DP("# w/comprehensive assessment",0,2,BGPPTYPE)
 S T=31 F X=1:1:2 S V=$P(@BGPARR@(X),U,2) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+11
 D W^BGP4DP("% w/comprehensive assessment",0,1,BGPPTYPE)
 S T=30 F X=1:1:2 S V=$P(@BGPARR@(X),U,3) D W^BGP4DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+11
 D W^BGP4DP("# w/BMI documented",0,2,BGPPTYPE)
 S T=31 F X=1:1:2 S V=$P(@BGPARR@(X),U,4) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+11
 D W^BGP4DP("% w/BMI documented",0,1,BGPPTYPE)
 S T=30 F X=1:1:2 S V=$P(@BGPARR@(X),U,5) D W^BGP4DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+11
 D W^BGP4DP("% w/nutrition counseling",0,2,BGPPTYPE)
 S T=31 F X=1:1:2 S V=$P(@BGPARR@(X),U,6) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+11
 D W^BGP4DP("% w/nutrition counseling",0,1,BGPPTYPE)
 S T=30 F X=1:1:2 S V=$P(@BGPARR@(X),U,7) D W^BGP4DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+11
 ...
 S T=31 F X=1:1:2 S V=$P(@BGPARR@(X),U,8) D W^BGP4DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+11
 ...
 S T=30 F X=1:1:2 S V=$P(@BGPARR@(X),U,9) D W^BGP4DP($S(BGPPTYPE="P":$J(V,6,1),1:$$SB($J(V,6,1))),0,0,BGPPTYPE,X+1,T) S T=T+11
...
PBY ;
 ...
 S T=30 F X=1:1:2 S N=$P(BGPDAC(X),U,P),O=$P(@BGPARR@(X),U,3) S:N="" N=0 S:O="" O=0 S Y=$S(BGPPTYPE="P":$J($FN((N-O),"+,",1),6),1:$$SB($J((N-O),6,1))) D W^BGP4DP(Y,0,0,BGPPTYPE,X+1,T) S T=T+11
 Q
C(X,X2,X3) ;
 D COMMA^%DTC
 Q X
