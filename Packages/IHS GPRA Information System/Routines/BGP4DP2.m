BGP4DP2 ; IHS/CMI/LAB - print ind 10 02 Jul 2010 9:25 AM ;
...
I10 ;EP
 ...
 D H1^BGP4DPH
 S BGPORDP=$P(^BGPINDJ(BGPIC,12),U,6) F BGPORDP1=1:1:$P(^BGPINDJ(BGPIC,0),U,13) S BGPPC1=BGPORDP_"."_BGPORDP1 Q:BGPQUIT  D PI^BGP4DP1
 S BGPNODEN=1
 F BGPPC1=$P(^BGPINDJ(BGPIC,12),U,6)_".6" D PI Q:BGPQUIT
 Q
I11 ;EP
 S BGPORXX=$P(^BGPINDJ(BGPIC,12),U,6)
 D H1 S BGPNODEN=1
 F BGPPC1=BGPORXX_".1" D PI^BGP4DP1C Q:BGPQUIT
 ;I '$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !!,^BGPINDJ(BGPIC,53,1,0)
 S BGPNODEN=1
...
ISTI ;EP
 ...
 Q:BGPQUIT
 I $Y>(BGPIOSL-13),'$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !!,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H1
 S BGPNODEN=1
 F BGPPC1=BGPORXX_".4",BGPORXX_".5",BGPORXX_".6" D PI Q:BGPQUIT
 Q:BGPQUIT
 ;
 K BGPNODEN
 F BGPPC1=BGPORXX_".7" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 ;Q:BGPRTYPE=7
 F BGPPC1=BGPORXX_".8",BGPORXX_".9" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".10",BGPORXX_".11",BGPORXX_".12" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".13",BGPORXX_".14",BGPORXX_".15" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".16",BGPORXX_".17",BGPORXX_".18" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".19",BGPORXX_".20",BGPORXX_".21" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 ;USER POP
 I $Y>(BGPIOSL-13),'$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !!,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H1
 S BGPNODEN=1
 ...
 K BGPNODEN
 F BGPPC1=BGPORXX_".28",BGPORXX_".29",BGPORXX_".30" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".31",BGPORXX_".32",BGPORXX_".33" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".34",BGPORXX_".35",BGPORXX_".36" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".37",BGPORXX_".38",BGPORXX_".39" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1=BGPORXX_".40",BGPORXX_".41",BGPORXX_".42" D PI^BGP4DP1 Q:BGPQUIT
 Q:BGPQUIT
 Q
IPC ;EP
 S BGPORXX=$P(^BGPINDJ(BGPIC,12),U,6)
 ...
 S BGPORDP=$P(^BGPINDJ(BGPIC,12),U,6) F BGPORDP1=9:1:17 S BGPPC1=BGPORDP_"."_BGPORDP1 Q:BGPQUIT  D PI^BGP4DP1
 Q
PI ;EP
 S BGPDENP=0
 K BGPDHOLD
...
SETSUM ;EP
 ...
 ;I $P(^BGPINDJC(BGPPC,0),U,4)="E-2.B.3",BGPROT="D"!(BGPROT="P") D SETSUM^BGP4PDL2
 Q
H2 ;EP
 Q:$G(BGPSUMON)
