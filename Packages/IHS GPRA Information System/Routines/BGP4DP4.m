BGP4DP4 ; IHS/CMI/LAB - print ind 31 ;
 ;;7.0;IHS CLINICAL REPORTING;;JAN 24, 2007
 ;
 ;
I21 ;EP
 D H1^BGP4DPH
 F BGPPC1="21.1","21.2","21.3" Q:BGPQUIT  D PI^BGP4DP1
 Q:BGPQUIT
 ;I BGPRTYPE=4 D HEADER^BGP4DPH Q:BGPQUIT  W !!,^BGPINDF(BGPIC,53,1,0) D H1^BGP4DPH
 I BGPRTYPE=4 W !
 F BGPPC1="21.7","21.8","21.9" Q:BGPQUIT  D PI^BGP4DP1
 D I1AGE
 Q:BGPQUIT
 Q
I1AGE ;EP special age tallies
 ...
 D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDF(BGPIC,53,1,0)  D H3
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF="031."_BGPX_".1" S BGPPC=$O(^BGPINDFC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="031."_BGPX_".2" S BGPPC=$O(^BGPINDFC("C",BGPF,0))
...
I1AGE3 ;
 S BGPF="031."_BGPX_".3" S BGPPC=$O(^BGPINDFC("C",BGPF,0))
...
I1AGE4 ;
 S BGPF="031."_BGPX_".4" S BGPPC=$O(^BGPINDFC("C",BGPF,0))
...
PR ; 
 I $Y>(IOSL-12) D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDF(BGPIC,53,1,0) D H3
