BGP4DP60 ; IHS/CMI/LAB - print ind H ;
...
PR ; 
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W:'$G(BGPSUMON) !,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H3
...
PB ;
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPINDJ(BGPIC,53,1,0) W:$D(^BGPINDJ(BGPIC,53,2,0)) !,^BGPINDJ(BGPIC,53,2,0) D H3
 ;percentage changes
