BGP4EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;14.1;IHS CLINICAL REPORTING;;MAY 29, 2014;Build 114
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS =>55",BGPHD2="# Active Diabetics"
 D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPELIJ(BGPIC,53,1,0)  D H3^BGP4EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP4DPH Q:BGPQUIT  W !,^BGPELIJ(BGPIC,53,1,0) D H3^BGP4EL12
