...
I1AGE ;EP
 ...
 D HEADER^BGP4DPH W !,^BGPELIJ(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 K BGPDAC,BGPDAP,BGPDAB
...
I1AGE1 ;
 S C=C+1
 S BGPF="EDA."_BGPX_"."_BGPZ S BGPPC=$O(^BGPELIIJ("C",BGPF,0))
