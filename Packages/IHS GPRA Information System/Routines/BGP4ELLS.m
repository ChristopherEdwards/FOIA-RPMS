BGP4ELLS ; IHS/CMI/LAB - print ind 01 Jul 2010 7:56 PM 20 May 2014 4:45 PM ;
...
I1AGEP ;
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,15) S Y=$$SB^BGP4ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,17) S Y=$$SB^BGP4ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,19) S Y=$$SB^BGP4ELL2($J(V,6,1)) D S(Y,,X+1)
 ;
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,29) S Y=$$SB^BGP4ELL2($J(V,6,1)) D S(Y,,X+1)
 ;
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,41) S Y=$$SB^BGP4ELL2($J(V,6,1)) D S(Y,,X+1)
 D I1AGEP^BGP4ELLT
 Q
