BGP4GLHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM 05 Oct 2014 9:58 AM ;
 ;;14.1;IHS CLINICAL REPORTING;;MAY 29, 2014;Build 114
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 14 LOCAL HT/WT",597,"","O","P",$$NOW^XLFDT,"lori ht/wt file")
 W !,ERR
 Q
...
CHW ;
 S BGPYWCHW=2
 S BGPHWNOW=$$NOW^XLFDT() S BGPHWNOW=$P(BGPHWNOW,".")_"."_$$RZERO^BGP4UTL($P(BGPHWNOW,".",2),6)
 S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP4UTL(BGPBD)_$$D^BGP4UTL(BGPED)_$$D^BGP4UTL(BGPHWNOW)_"_001_of_001"_".TXT"
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIJ(",DIC(0)="L",DIADD=1,DLAYGO=90552.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///"_$G(BGPROT)_";1///"_BGPFN
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLLHW^BGP4GLHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT" D ^%ZTLOAD Q
 Q
NTLLHW ;
 D ^BGP4D1
 K ^TMP($J,"BGPGUI")
 ...
 ;D HWSF^BGP4DHW
 ;D KITM^BGP4DHW
 D GUIR^BGPXBLM("PRINT^BGP4DHW","^TMP($J,""BGPGUI"",")
