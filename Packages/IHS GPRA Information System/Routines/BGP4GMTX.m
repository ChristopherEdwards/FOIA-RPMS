BGP4GMTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;14.1;IHS CLINICAL REPORTING;;MAY 29, 2014;Build 114
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 14 MED TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIJ(",DIC(0)="L",DIADD=1,DLAYGO=90552.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP4GMTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI MEDICATION TAXONOMY REPORT" D ^%ZTLOAD Q
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP4DMT",BGPRT=7:"ONM^BGP4DMT",BGPRT=2:"CRS^BGP4DMT",BGPRT=4:"ELDER^BGP4DMT",BGPRT=3:"HEDIS^BGP4DMT",BGPRT=5:"CMS^BGP4DMT",BGPRT=8:"EO^BGP4DMT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP4DMT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP") done in MEDTAXC^BGP4GU
 S:$D(ZTQUEUED) ZTREQ="@"
