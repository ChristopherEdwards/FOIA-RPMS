BGP4GNXP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM ;
 ;;14.1;IHS CLINICAL REPORTING;;MAY 29, 2014;Build 114
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 14 NATL EXPORT",597,1,1,,$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPRTYPE=1,BGPXPRP=1,BGPXPFYY=2014,BGPXPFYI=312
...
HOME ;
 ...
 S BGPFN="CRSCNT"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP4UTL(BGPXPHD)_$$D^BGP4UTL(BGPXPEDT)_$$D^BGP4UTL(BGPNOW)_"_001_of_001.TXT"
 ;CREATE REPORT ENTRY
 ...
 S BGPGFNM=X
 S DIC="^BGPGUIA(",DIC(0)="L",DIADD=1,DLAYGO=90552.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP4GNXP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT 11" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE1
 K ^TMP($J,"BGPGUI")
 ...
 S ^BGPGUIA(BGPGIEN,11,0)="^90552.1911^"_C_"^"_C_"^"_DT
 K ^TMP($J,"BGPGUI")
 D ENDLOG
 D XIT
 Q
