BGP4HEHH ; IHS/CMI/LAB - cover page for HEDIS ;
 ...
 S X="*** IHS FY04 HEDIS Clinical Performance Indicators ***" D S(X,1,1)
 ...
 S X=" " D S(X,1,1)
 I $G(BGPEXPT) D
 .S X="A file will be created called BG04"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"." D S(X,1,1) S X="It will reside in the public/export directory.  This file should be sent to your Area Office." D S(X,1,1)
 I BGPROT'="P" D
...
AREACP ;EP - area cover page
 ...
 S X=" " D S(X,1,1)
 I $G(BGPEXPT) D
 .S X="A file will be created called BG04"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"." D S(X,1,1) S X="It will reside in the public/export directory." D S(X,1,1) S X="This file should be sent to your Area Office." D S(X,1,1)
 I BGPROT'="P" D
 ...
 .D S(X,1,1)
 .S X="Communities: " S X=0,N=0,Y="" F  S X=$O(^BGPHEDCF(BGPX,9999,X)) Q:X'=+X  S N=N+1,Y=Y_$S(N=1:"",1:";")_$P(^BGPHEDCF(BGPX,9999,X,0),U)
