BGP4HES ; IHS/CMI/LAB - IHS gpra print ;
...
START ;
 ...
 .S BGPCNT=10
GO .;
 .W !,$P(^BGPHEIF(BGPL,0),U,3),!
 .W !,"Denominator(s):"
 .S BGPX=0 F  S BGPX=$O(^BGPHEIF(BGPL,61,"B",BGPX)) Q:BGPX'=+BGPX!(BGPQUIT)  D
 ..S BGPY=0 F  S BGPY=$O(^BGPHEIF(BGPL,61,"B",BGPX,BGPY)) Q:BGPY'=+BGPY!(BGPQUIT)  D
 ...I $P(^BGPHEIF(BGPL,61,BGPY,0),U,2)'[BGPRTYPE Q  ;not a denom def for this report
 ...S BGPZ=0 F  S BGPZ=$O(^BGPHEIF(BGPL,61,BGPY,1,BGPZ)) Q:BGPZ'=+BGPZ!(BGPQUIT)  D
 ....I $Y>(IOSL-3) D HEADER^BGP4DPH Q:BGPQUIT
 ....W !,^BGPHEIF(BGPL,61,BGPY,1,BGPZ,0)
 ....Q
 ...;W !
 ...Q
 ..Q
 .I $Y>(IOSL-3) D HEADER^BGP4DPH Q:BGPQUIT
 .W !!,"Numerator(s):"
 .S BGPX=0 F  S BGPX=$O(^BGPHEIF(BGPL,62,"B",BGPX)) Q:BGPX'=+BGPX!(BGPQUIT)  D
 ..S BGPY=0 F  S BGPY=$O(^BGPHEIF(BGPL,62,"B",BGPX,BGPY)) Q:BGPY'=+BGPY!(BGPQUIT)  D
 ...I $P(^BGPHEIF(BGPL,62,BGPY,0),U,2)'[BGPRTYPE Q  ;not a denom def for this report
 ...S BGPZ=0 F  S BGPZ=$O(^BGPHEIF(BGPL,62,BGPY,1,BGPZ)) Q:BGPZ'=+BGPZ!(BGPQUIT)  D
 ....I $Y>(IOSL-3) D HEADER^BGP4DPH Q:BGPQUIT
 ....W !,^BGPHEIF(BGPL,62,BGPY,1,BGPZ,0)
 ....Q
 ...;W !
 ...Q
 ..Q
 .W ! S BGPX=0 F  S BGPX=$O(^BGPHEIF(BGPL,11,BGPX)) Q:BGPX'=+BGPX  D
 ..I $Y>(IOSL-3) D HEADER^BGP4DPH Q:BGPQUIT
 ..W !,^BGPHEIF(BGPL,11,BGPX,0)
 .W ! S BGPX=0 F  S BGPX=$O(^BGPHEIF(BGPL,51,BGPX)) Q:BGPX'=+BGPX  D
 ..I $Y>(IOSL-3) D HEADER^BGP4DPH Q:BGPQUIT
 ..W !,^BGPHEIF(BGPL,51,BGPX,0)
 .W ! S BGPX=0 F  S BGPX=$O(^BGPHEIF(BGPL,52,BGPX)) Q:BGPX'=+BGPX  D
 ..I $Y>(IOSL-3) D HEADER^BGP4DPH Q:BGPQUIT
 ..W !,^BGPHEIF(BGPL,52,BGPX,0)
 .W !!,$P(^BGPHEIF(BGPL,0),U,5),!
 .D H1
...
PRINTL ;print one line
 ...
 .S X=0 F  S X=$O(^BGPHEIF(BGPL,72,X)) Q:X'=+X  W !,^BGPHEIF(BGPL,72,X,0)
 .D H1
