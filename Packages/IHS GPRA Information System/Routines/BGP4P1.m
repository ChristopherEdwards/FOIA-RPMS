BGP4P1 ; IHS/CMI/LAB - v11.0 patch 1 env routine 08 Dec 2010 3:10 PM ;
...
POST ;EP - called from kids build
 ...
 S BGPX=0 F  S BGPX=$O(^BGPGPDCJ(BGPX)) Q:BGPX'=+BGPX  D
 .I '$D(^BGPGPDCJ(BGPX,1.1)) S DA=BGPX,DIK="^BGPGPDCJ(" D ^DIK S DA=BGPX,DIK="^BGPGPDPJ(" D ^DIK S DA=BGPX,DIK="^BGPGPDBJ(" D ^DIK
 Q
