BGP4PDL0 ; IHS/CMI/LAB - print ind 1 01 Jul 2010 8:03 PM ;
 ;;14.1;IHS CLINICAL REPORTING;;MAY 29, 2014;Build 114
 ;
 ;
IC1 ;EP
 S BGPXXX=$P(^BGPINDJ(BGPIC,12),U,6)
 I BGPINDJ'="D" D:'$G(BGPSUMON) H1^BGP4PDL1
 I BGPINDJ'="D" F BGPPC1=BGPXXX_".1",BGPXXX_".2",BGPXXX_".3" D PI^BGP4PDL1
 I BGPINDJ'="D" D:'$G(BGPSUMON) H1^BGP4PDL1
 I BGPINDJ'="D" F BGPPC1=BGPXXX_".4",BGPXXX_".5",BGPXXX_".6" D PI^BGP4PDL1
 D:'$G(BGPSUMON) H1^BGP4PDL1
 F BGPPC1=BGPXXX_".7",BGPXXX_".8",BGPXXX_".9" D PI^BGP4PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPINDJ="D"
 ...
 S X=^BGPINDJ(BGPIC,53,1,0) D S(X,1,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
