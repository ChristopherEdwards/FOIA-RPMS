BGP4PDL4 ; IHS/CMI/LAB - print ind 1 ;
 ;;7.0;IHS CLINICAL REPORTING;;JAN 24, 2007
 ;
 ;
I21 ;EP
 D H1^BGP4PDL1
 F BGPPC1="21.1","21.2","21.3" D PI^BGP4PDL1
 F BGPPC1="21.7","21.8","21.9" D PI^BGP4PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPRTYPE'=4
 ...
 S X=^BGPINDF(BGPIC,53,1,0) D S(X,1,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
