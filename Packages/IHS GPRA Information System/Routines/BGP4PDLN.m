BGP4PDLN ; IHS/CMI/LAB - IHS gpra print ;
...
NONSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDJC(BGPPC,15),U,4)
 ...I $P(^BGPINDJC(BGPPC,15),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDJC(BGPPC,15),U,7)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDJC(BGPPC,15),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDJC(BGPPC,15),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDJC(BGPPC,15),U,9)]""!($P(^BGPINDJC(BGPPC,15),U,10)]"")!($P(^BGPINDJC(BGPPC,15),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDJC(BGPPC,15),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDJC(BGPPC,15),U,11)
 ...I X]"" D S(X,1,1)
 S X=" " D S(X,1,1)
...
H1 ;
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="2013",$P(X,U,6)="Target" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
H2 ;
 S X=" " D S(X,2,1)
 S X="SELECTED NON-GPRA MEASURES CLINICAL PERFORMANCE DETAIL" D S(X,2,1)
 S X="",$P(X,U,2)=" Site",$P(X,U,3)=" Site",$P(X,U,4)=" Site",$P(X,U,5)="Area",$P(X,U,6)="Nat'l",$P(X,U,7)="2014" D S(X,1,1)
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="Current",$P(X,U,6)="2013",$P(X,U,7)="Target" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
SDP ;EP
 I BGPRTYPE'=1 Q  ;national gpra only
 ...
 ..I $P(^BGPINDJC(BGPPC,15),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDJC(BGPPC,15),U,7)
 ..I $P(^BGPINDJC(BGPPC,15),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDJC(BGPPC,15),U,12)
 ...
 ....S Y="" I $P(^BGPINDJC(BGPPC,15),U,9)]""!($P(^BGPINDJC(BGPPC,15),U,10)]"")!($P(^BGPINDJC(BGPPC,15),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDJC(BGPPC,15),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDJC(BGPPC,15),U,10),"$","^") D
