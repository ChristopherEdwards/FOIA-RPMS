BGP4SDPO ; IHS/CMI/LAB - IHS summary page ; 17 May 2014  9:52 AM
...
START ;
 ...
 ...D W^BGP4DP($P(^BGPINDJC(BGPPC,19),U,4),0,2,BGPPTYPE)
 ...I $P(^BGPINDJC(BGPPC,19),U,7)]"" D W^BGP4DP($P(^BGPINDJC(BGPPC,19),U,7),0,1,BGPPTYPE)
 ...I $P(^BGPINDJC(BGPPC,19),U,12)]"" D W^BGP4DP($P(^BGPINDJC(BGPPC,19),U,12),0,1,BGPPTYPE)
 ...
 ...D W^BGP4DP($P(^BGPINDJC(BGPPC,19),U,2),0,0,BGPPTYPE,,55)
 ...;D W^BGP4DP($P(^BGPINDJC(BGPPC,19),U,3),0,0,BGPPTYPE,,65)
 ...I $P(^BGPINDJC(BGPPC,19),U,9)]""!($P(^BGPINDJC(BGPPC,19),U,10)]"")!($P(^BGPINDJC(BGPPC,19),U,11)]"") D
 ....D W^BGP4DP($TR($P(^BGPINDJC(BGPPC,19),U,10),"$","^"),0,0,BGPPTYPE,,55) ;,W^BGP4DP($P(^BGPINDJC(BGPPC,19),U,11),0,0,BGPPTYPE,,65)
 ...
 .....D W^BGP4DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U),7,0),0,0,BGPPTYPE,,20)
 .....D W^BGP4DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,2),7,0),0,0,BGPPTYPE,,29)
 .....D W^BGP4DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,3),7,0),0,0,BGPPTYPE,,38)
 ....E  D
 .....I $Y>(BGPIOSL-3) D HEADER Q:BGPQUIT
 .....D W^BGP4DP(BGPSASU,0,1,BGPPTYPE,,2),W^BGP4DP($E(BGPSNAM,1,12),0,0,BGPPTYPE,,8)
 .....D W^BGP4DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U),7,1)_"%",0,0,BGPPTYPE,,20)
 .....D W^BGP4DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,2),7,1)_"%",0,0,BGPPTYPE,,29)
 .....D W^BGP4DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE OTHER",BGPC,BGPO,BGPPC,BGPSN),U,3),7,1)_"%",0,0,BGPPTYPE,,38)
 ..I BGPPTYPE="D" D
 ...D W^BGP4DP("",0,1,BGPPTYPE)
 ...S XX=" "_$P(^BGPINDJC(BGPPC,19),U,4)
 ...I $P(^BGPINDJC(BGPPC,19),U,7)]"" D W^BGP4DP(XX,0,1,BGPPTYPE) S XX=" "_$P(^BGPINDJC(BGPPC,19),U,7)
 ...I $P(^BGPINDJC(BGPPC,19),U,12)]"" D W^BGP4DP(XX,0,1,BGPPTYPE) S XX=" "_$P(^BGPINDJC(BGPPC,19),U,12)
 ...
 ...S $P(XX,U,6)=$P(^BGPINDJC(BGPPC,19),U,2) ;,$P(XX,U,7)=$P(^BGPINDJC(BGPPC,19),U,3)
 ...
 ....;S Y="" I $P(^BGPINDJC(BGPPC,19),U,9)]""!($P(^BGPINDJC(BGPPC,19),U,10)]"") S $P(Y,U,6)=$TR($P(^BGPINDJC(BGPPC,19),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDJC(BGPPC,19),U,10),"$","^")
 ....S Y="" I $P(^BGPINDJC(BGPPC,19),U,9)]""!($P(^BGPINDJC(BGPPC,19),U,10)]"")!($P(^BGPINDJC(BGPPC,19),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDJC(BGPPC,19),U,9),"$","^") D
 .....;S $P(Y,U,8)=$P(^BGPINDJC(BGPPC,19),U,11)
...
HEADER ;EP
 ...
 Q
H1 ;
 S X="SELECTED OTHER NATIONAL MEASURES CLINICAL PERFORMANCE DETAIL" D W^BGP4DP(X,0,1,BGPPTYPE)
 ...
 D W^BGP4DP("Current",0,1,BGPPTYPE,2,22),W^BGP4DP("Prev",0,0,BGPPTYPE,3,32),W^BGP4DP("Base",0,0,BGPPTYPE,4,40),W^BGP4DP("Current",0,0,BGPPTYPE,5,46),W^BGP4DP("2013",0,0,BGPPTYPE,6,55) ;,W^BGP4DP("Target",0,0,BGPPTYPE,8,66)
