BGP4TXCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ;
 ;;7.0;IHS CLINICAL REPORTING;;JAN 24, 2007
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the FY 04 GPRA Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP4TXCH",XBNS="",XBRX="XIT^BGP4TXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
