...
ICDOP(C,D,I) ;EP - GET CODE
 I $D(^ICDS(0)) Q $$ICDOP^ICDEX(C,$G(D))
...
RCIS(P,BDATE,EDATE,ICDC,CPTC) ;EP
 ...
 Q 1_"^"_$P($P(^BMCREF(G,0),U),".")_"^"_$$DATE^BGP4UTL($P($P(^BMCREF(G,0),U),"."))_"^"_"RCIS referral"_"^"_X_"^"_"90001"_"^"_G
 ;
