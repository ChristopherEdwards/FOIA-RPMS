BGP5AU1A ; IHS/CMI/LAB - BUILD CRS* FILES ;
...
EN(BGPBEGDT,BGPENDDT,BGPEND,BGPAUF) ;EP
 ...
 N BGPNODEL,BGPAREAA,BGPEXCEL,BGPRPT,BGPROT,BGPINDK,BGPUF,BGPSUL,BGPF
 ...
 S BGPNODEL=1 ;USED IN BGP5PARP SO IT WON'T DO SAVEDEL^BGP5PDL
 S BGPAREAA=1
 S BGPEXCEL=1
 S BGPRPT=0
 S BGPROT="D"
 ...
 ;
 S BGPNOW=$$NOW^XLFDT()
 S BGPNOW=$P(BGPNOW,".")_"."_$$RZERO^BGP5UTL($P(BGPNOW,".",2),6)
 ;
 ...
 S BGPFGNT1="CRSGPRANT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFGNT2="CRSGPRANT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFGNT3="CRSGPRANT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFGNT4="CRSGPRANT4"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFDEV1="CRSGPRADEVNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFDEV2="CRSGPRADEVNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFDEV3="CRSGPRADEVNT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 S BGPFDEV4="CRSGPRADEVNT4"_$P(^AUTTLOC(DUZ(2),0),U,10)_BGPEND_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BGPC,6)_".TXT"
 ;
 S BGPAUEX=1
 D SETEXCEL^BGP5DP
 D PRINT^BGP5PARP
...
SUL(BGPBEGDT,BGPEND,BGPSUL) ;
 ...
 ;
 S BGPD0=0
 F  S BGPD0=$O(^BGPGPDCK("B",BGPBEGDT,BGPD0)) Q:'BGPD0  D
 . S BGPSUL(BGPD0)=""
 . S BGPEND=$P($G(^BGPGPDCK(BGPD0,0)),U,2)
 Q
