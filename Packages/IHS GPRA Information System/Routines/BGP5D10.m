BGP5D10 ; IHS/CMI/LAB - calc indicators ;
...
PROCCY ;current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL="^BGPGPDCV("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL="^BGPGPDPV("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPAGEB=$$AGE^AUPNPAT(DFN,BGPBDATE)
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL="^BGPGPDBV("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPAGEB=$$AGE^AUPNPAT(DFN,BGPBDATE)
