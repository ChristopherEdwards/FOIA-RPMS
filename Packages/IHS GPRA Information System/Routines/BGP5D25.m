...
DEPEP ;EP - called from elder
 ...
 S BGPN11=0 S BGPSBHC=$$DEPSCRBH^BGP5D27(DFN,BGPBDATE,BGPEDATE) I $P(BGPSBHC,U)=1 S BGPN11=1
 I BGPN2 S BGPN1=1
 I BGPN3 S BGPN1=1
 S BGPREF=""
...
DEPSCR(P,BDATE,EDATE) ;EP
 ...
 S Y=$$CPT^BGP5DU(DFN,BDATE,EDATE,$O(^ATXAX("B","BGP DEPRESSION SCREEN CPTS",0)),5)
 I Y,$P(BGPDEPS,U,4)<$P(Y,U,1) S BGPDEPS=1_U_"CPT "_$P(Y,U,2)_U_$$DATE^BGP5UTL($P(Y,U,1))_U_$P(Y,U,1)_U_"CPT "_$P(Y,U,2)
...
BHSCR ;
 ...
 ..Q:'BGPP
 ..Q:'$$ICD^BGP5UTL2(BGPP,$O(^ATXAX("B","BGP DEPRESSION SCREEN CPTS",0)),1)
 ..S BGPC=1_U_"BH CPT: "_$P(^ICPT(BGPP,0),U,1)_U_$$DATE^BGP5UTL(9999999-D)_U_(9999999-D)_U_"BH CPT "_$P(^ICPT(BGPP,0),U,1)
