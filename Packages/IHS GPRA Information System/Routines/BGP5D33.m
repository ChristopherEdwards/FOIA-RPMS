...
OPV(P,EDATE) ;EP
 ...
 K BGPG ;D SETPRC^BGP5UTL1(P,$$DOB^AUPNPAT(P),EDATE,"BGP IPV IZ PROCS",.BGPG)
 ...
 I $$PLTAX^BGP5DU(P,"BGP OPV EVID DISEASE") Q 4_U_"Evid Polio"
 ...
 ;I $$PLTAX^BGP5DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"Contra Polio"
 ;F BGPZ=2,89 S X=$$ANCONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
 ;I X]"" Q 4_U_"Contra Polio"
 F BGPZ=2,10,89,110,120,130,132,146 S X=$$ANNECONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"Contra Polio"
 ;now go to Refusals
 ...
 ;F BGPIMM=2,89,10,110,120,130,132,146 S R=$$IMMREF^BGP5D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
MMRC ;K BGPG S %=P_"^LAST DX [BGP MMR CONTRAINDICATIONS;DURING "_$$DOB^AUPNPAT(P)_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 ...
 ;I $$PLTAX^BGP5DU(P,"BGP MMR CONTRAINDICATIONS") Q 4_U_"Contra MMR"
 F BGPZ=3,94 S X=$$MMRCONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"Contra MMR"
MRC ;
 F BGPZ=4 S X=$$ANCONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
...
MEX ;
 ...
 I $$PLTAX^BGP5DU(P,"BGP MEASLES EVIDENCE") S BGPME=4
 I BGPME=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=5 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPZ=5 S X=$$MMRCONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPME=4
MUX ;
 ...
 I $$PLTAX^BGP5DU(P,"BGP MUMPS EVIDENCE") S BGPMU=4
 I BGPMU=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=7 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPZ=7 S X=$$ANCONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPMU=4
RUBX ;
 ...
 I $$PLTAX^BGP5DU(P,"BGP RUBELLA EVIDENCE") S BGPRUB=4
 I BGPRUB=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=6 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPZ=6 S X=$$ANCONT^BGP5D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPRUB=4
