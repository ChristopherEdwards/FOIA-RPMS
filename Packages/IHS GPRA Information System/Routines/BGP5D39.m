...
COVERAGE(P,BDATE,EDATE,MTAX,NTAX,TYPE) ;
 ...
 I TYPE="RASA"!(TYPE="DMALL"),$$ESRD^BGP5D211(DFN,$P(^DPT(DFN,0),U,3),BGPEDATE) Q ""
 I TYPE="ANTICOAG" I $$HADWARF(DFN,BDATE,EDATE) Q ""  ;HAD WARFARIN IN TIME PERIOD
 K BGPMEDS1
 D GETMEDS^BGP5UTL2(P,BDATE,EDATE,MTAX,NTAX,,,.BGPMEDS1)
 ...
 S C=1_U_PER_U_$S(GAP:1,1:"")_U_TYPE_": IXRD: "_$$DATE^BGP5UTL(BGPISD)_" ["_BGPMP_"] Days="_DAYS
...
HADWARF(P,BDATE,EDATE) ;
 NEW BGPMEDS1,C,A,M
 K BGPMEDS1
 D GETMEDS^BGP5UTL2(P,BDATE,EDATE,"BGP PQA WARFARIN MEDS","BGP PQA WARFARIN NDC",,,.BGPMEDS1)
