BGP5D3B ; IHS/CMI/LAB - PNEUMO REMINDER ; 
...
I13 ;EP - PN
 ...
 S (BGPN13,BGPN14,BGPN15,BGPN16,BGPN17,BGPN18,BGPN19,BGPN20,BGPN21,BGPN22,BGPN23,BGPN24,BGPN25,BGPN26,BGPN27,BGPN28,BGPN29)=0
...
PN ;EP - called from elder
 ...
 S BGPN7=0,BGPA65="" I BGPAGEB>65 S BGPA65=$$PNEU^BGP5D31(DFN,$$FMADD^XLFDT($$DOB^AUPNPAT(DFN),+(65*365)),BGPEDATE) I $P(BGPA65,U,3)=1!($P(BGPA65,U,3)=3) S BGPN4=1,BGPN7=1 ;over 65 and had one after 65
 I BGPAGEB<65,BGPN1 S BGPN4=1  ;anyone under and had 1 ever  ;BGPN4 IS UP TO DATE
 ;NATIONAL GPRA
 S BGPN8=0
 I BGPAGEB<66,BGPN1 S BGPN8=1  ;GPRA DEV UP TO DATE
 I BGPAGEB>65,BGPN1,(BGPN4+BGPN7) S BGPN8=1  ;IF UNDER 66 HAD 1 EVER, IF OVER 65 HAD ONE IN PAST 5 YEARS OR AFTER AGE 65
 ;GPRA DEV V15.0
 D
 .S BGPPNEU=$$PNEUD(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) ;set to date of PNEU shot
 ...
 .I $P(BGPPNEUD,U,3)=1!($P(BGPPNEUD,U,3)=3) S BGPN25=1  ;HAD IN PAST 5 YEARS SO "UP TO DATE"
 .I $P(BGPPNEUD,U,3)=3 S BGPN26=1  ;NMI PAST 5 YRS
 .S BGPN27=0,BGPA65="" I BGPAGEB>65 S BGPA65=$$PNEUD(DFN,$$FMADD^XLFDT($$DOB^AUPNPAT(DFN),+(65*365)),BGPEDATE) I $P(BGPA65,U,3)=1!($P(BGPA65,U,3)=3) S BGPN25=1,BGPN27=1 ;over 65 and had one after 65
 .I BGPAGEB<65,BGPN23 S BGPN25=1  ;anyone under and had 1 ever  ;BGPN4 IS UP TO DATE
 ;GPRA DEV
 S BGPN28=0
 I BGPAGEB<66,BGPN23 S BGPN28=1  ;GPRA DEV UP TO DATE
 I BGPAGEB>65,BGPN23,(BGPN25+BGPN27) S BGPN28=1  ;IF UNDER 66 HAD 1 EVER, IF OVER 65 HAD ONE IN PAST 5 YEARS OR AFTER AGE 65
 S BGPDV=""
 ...
 .S BGPVALUD="AC"_"|||"
 .I BGPN23 S BGPVALUD=BGPVALUD_"Pneumo: "_$$DATE^BGP5UTL($P(BGPPNEU,U,1))_" "_$P(BGPPNEU,U,2)_$S(BGPPNEU]"":" (ever)",1:"")_" "
 .S BGPVALUD=BGPVALUD_$S(BGPN28:"(up-to-date)",1:"")
