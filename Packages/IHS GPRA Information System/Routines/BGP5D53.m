BGP5D53 ; IHS/CMI/LAB - measure calc ;
...
CHL(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)) Q 1_U_$$DATE^BGP5UTL($P(BGPG(1),U))_U_$P(BGPG(1),U,2)
 ;check cpt taxonomy
 S T=$O(^ATXAX("B","BGP CHLAMYDIA CPTS",0))
 I T D  I X Q 1_U_"CPT "_$P(X,U,3)_U_$$DATE^BGP5UTL($P(X,U,2))
 .S X=$$CPT^BGP5DU(P,BDATE,EDATE,T,6) I X]"" Q
 .S X=$$TRAN^BGP5DU(P,BDATE,EDATE,T,6)
 ...
 ...Q:'$D(^AUPNVLAB(X,0))
 ...I BGPLT,$P(^AUPNVLAB(X,0),U),$D(^ATXLAB(BGPLT,21,"B",$P(^AUPNVLAB(X,0),U))) S BGPC=1_U_"Lab test"_U_$$DATE^BGP5UTL((9999999-D)) Q
 ...Q:'T
 ...S J=$P($G(^AUPNVLAB(X,11)),U,13) Q:J=""
 ...Q:'$$LOINC(J,T)
 ...S R=$P(^AUPNVLAB(X,0),U,4)
 ...S BGPC=1_U_"Lab Test "_U_$$DATE^BGP5UTL((9999999-D))
 ...Q
 I BGPC Q BGPC
 ...
 ...Q:'$D(^AUPNVMIC(X,0))
 ...I BGPLT,$P(^AUPNVMIC(X,0),U),$D(^ATXLAB(BGPLT,21,"B",$P(^AUPNVMIC(X,0),U))) S BGPC=1_U_"Micro test"_U_$$DATE^BGP5UTL((9999999-D)) Q
 ...Q:'T
 ...S J=$P($G(^AUPNVMIC(X,11)),U,13) Q:J=""
 ...Q:'$$LOINC(J,T)
 ...S R=$P(^AUPNVMIC(X,0),U,4)
 ...S BGPC=1_U_"Micro Test "_U_$$DATE^BGP5UTL((9999999-D))
 ...Q
 Q BGPC
LOINC(A,B) ;
 NEW %
