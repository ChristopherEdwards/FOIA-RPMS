...
I031 ;EP
 ...
 S BGPXPHV=$$SB^BGP5PDL1($J($P(BGPBMI,U),6,2)) S:BGPXPHV="0.00" BGPXPHV=""
 ...
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP5PDL1($J($P(BGPBMI,U),6,2)),1:"")_$S(BGPN2:" [OVERWEIGHT]",1:"")_$S(BGPN3:" [OBESE]",1:"")
 I BGPRTYPE'=1,BGPN5 S BGPVALUE=BGPVALUE_"Refused " ;_$P(BGPREF,U,2)_" "_$$DATE^BGP5UTL($P(BGPREF,U,3))_" "_$P(BGPREF,U,5)_" "_$$DATE^BGP5UTL($P(BGPREF,U,6))
...
I031A ;
 ...
 I $P(BGPBMI,U)]"" S BGPVALUE=BGPVALUE_"|||"_" Age at BMI: "_A_"; "_$$DATE^BGP5UTL($P(BGPBMI,U,2))_" "_$P(BGPBMI,U)
...
WT(P,BDATE,EDATE) ;EP
 ...
 ...I $$ICD^BGP5UTL2($P(^AUPNVPOV(BGPLD,0),U,1),$O(^ATXAX("B","BGP PREGNANCY DIAGNOSES 2",0)),9) Q
 ...;I $E(ICD,1,3)="V22" Q
 ...;I $E(ICD,1,3)="V23" Q
 ...;I $E(ICD,1,3)="V27" Q
 ...;I $E(ICD,1,3)="V28" Q
...
REF(P,BDATE,EDATE,AGE) ;EP - get ht/wt Refusal in past year, same date for 18 and under
 S R=""
 I AGE<19 G AGE18R
 S X=$$REFUSAL^BGP5UTL1(P,9999999.07,$O(^AUTTMSR("B","HT",0)),BDATE,EDATE) I X S R=1_U_"HT"_U_$P(X,U,2)
 S Y=$$REFUSAL^BGP5UTL1(P,9999999.07,$O(^AUTTMSR("B","WT",0)),BDATE,EDATE) I Y S $P(R,U,4)=1,$P(R,U,5)="WT",$P(R,U,6)=$P(Y,U,2)
 I X="",Y="" Q ""
 Q R
AGE18R ;
 K H,W
