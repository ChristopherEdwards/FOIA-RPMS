BGP5D9 ; IHS/CMI/LAB - indicator J ;
...
I28 ;EP
 ...
 S BGPVALUE=$S(BGPD1:"HTN PT",1:"")_"|||"_$S($P(BGPVALUE,U,2)="":"",1:$P(BGPVALUE,U))
 K ^TMP($J,"A")
 Q
I40 ;EP
...
MEDPED(P,BDATE,EDATE) ;
 ...
 .I $P(T,"-",2)="M"!(T="M-I")!(T="M-DI")!(T="M-FU")!(T="M-L")!(T="DMC-IN") S E=1,$P(%,U,1)=$P(BGPG(1),U),$P(%,U,2)=T Q
 Q %
 ;
MED(P,BDATE,EDATE) ;
 K ^TMP($J,"A")
...
ESRD(P,EDATE) ;
 K BGPG
 S Y="BGPG("
 S X=P_"^LAST DX 585.;DURING "_$$DOB^AUPNPAT(P)_"-"_EDATE S E=$$START1^APCLDF(X,Y)
 I $D(BGPG(1)) Q 1
 S E=+$$CODEN^ICPTCOD(90921),X=$$CPTI^BGPDU(P,$$DOB^AUPNPAT(P),EDATE,E)
 I $P(X,U) Q 1
 S E=+$$CODEN^ICPTCOD(90925),X=$$CPTI^BGPDU(P,$$DOB^AUPNPAT(P),EDATE,E)
 I $P(X,U) Q 1
 Q ""
FIRSTIHD(P,EDATE) ;EP
 I $G(P)="" Q ""
