...
DRIVER ;
 U IO
 D PRINT^BGP5PARP
 I BGPRPTT="A",BGPIFTR=1,BGPEXCEL D GNT1^BGP5UTL
 D ^%ZISC
 D EXIT
 Q
 ;
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP5DAR",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
EXIT ;
 D ^%ZISC
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP5DAR",XBRX="EXIT^BGP5DAR",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
