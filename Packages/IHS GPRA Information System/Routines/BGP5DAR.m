...
ASU ;
 ...
 I C=1 S BGPRPTT="F",BGPSUCNT=1,Y=$O(BGPSUL(0)),X=$P(^BGPGPDCV(Y,0),U,9),X=$O(^AUTTLOC("C",X,0)) I X S BGPSUNM=$P(^DIC(4,X,0),U)
ZIS ;call to XBDBQUE
EISSEX ;
 S BGPEXCEL=""
 S BGPUF=""
 ...
 .S BGPFN="GPRANT"_$P(^AUTTLOC(DUZ(2),0),U,10)_2005063000000000_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BDWC,6)_".TXT"
 .S BGPFNEIS="GPRAEX"_$P(^AUTTLOC(DUZ(2),0),U,10)_2005063000000000_$$D^BGP5UTL(BGPNOW)_"_"_$$LZERO^BGP5UTL(BDWC,6)_".TXT"
 .Q
 I BGPRPTT="F" S BGPEXCEL=0 ;D
 ;.S DIR(0)="Y",DIR("A")="Do you wish to create an EISS output file for this set of facilites",DIR("B")="N" KILL DA D ^DIR KILL DIR
 ;.I $D(DIRUT) Q
 ;.I Y S BGPEXCEL=1
