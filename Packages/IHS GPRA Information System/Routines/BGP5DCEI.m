BGP5DCEI ; IHS/CMI/LAB - calculate HEDIS indicators ;
...
CALCIND ;EP
 ...
 .I $D(^BGPELIV(BGPIC,1)) X ^BGPELIV(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIV("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIV(BGPI,1)
 ..X ^BGPELIIV(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIV(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90373.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIV(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90373.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..I BGPDEN'="NO" D S(BGPRPT,BGPGBL,N,P,BGPDEN)
 .I $D(BGPLIST(BGPIC)) D STMP^BGP5EUTL
 Q
 ;
S(R,G,N,P,V) ;
