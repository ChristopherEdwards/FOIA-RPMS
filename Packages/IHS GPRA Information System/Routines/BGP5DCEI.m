BGP5DCEI ; IHS/CMI/LAB - calculate HEDIS measures ;
...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIK(BGPIC,1)) X ^BGPELIK(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIK("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIK(BGPI,1)
 ..X ^BGPELIIK(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIK(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90555.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIK(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90555.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
