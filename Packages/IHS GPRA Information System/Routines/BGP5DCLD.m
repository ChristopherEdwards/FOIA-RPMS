BGP5DCLD ; IHS/CMI/LAB - IHS gpra print ;
...
PRINTL ;print one line
 ...
 D S(W,,6),S(Z,,7)
 S A=$$LAST^BGP5DCLP(DFN,BGPED) D S(A,,8)
 Q
 ;
HEADER ;EP
 S X="**** CONFIDENTIAL PATIENT INFORMATION, COVERED BY THE PRIVACY ACT *****" D S(X,1,1)
 S X="***  IHS 2015 Comprehensive National GPRA Patient List ***" D S(X,1,1)
