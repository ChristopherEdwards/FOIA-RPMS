...
N1 I $G(BGPEXCEL),'$G(BGPYGPU),BGPRTYPE=1 D
 .D W^BGP5DP("GPRA Developmental filenames:  ",0,2,BGPPTYPE),W^BGP5DP(BGPFDEV1,0,1,BGPPTYPE,1,15),W^BGP5DP(BGPFDEV2,0,1,BGPPTYPE,1,15),W^BGP5DP(BGPFDEV3,0,1,BGPPTYPE,1,15)
 .D W^BGP5DP("National GPRA filenames:  ",0,2,BGPPTYPE),W^BGP5DP(BGPFGNT1,0,1,BGPPTYPE,1,15),W^BGP5DP(BGPFGNT2,0,1,BGPPTYPE,1,15),W^BGP5DP(BGPFGNT3,0,1,BGPPTYPE,1,15)
 ...
 ..D W^BGP5DP("MFI Visit Locations: ",0,2,BGPPTYPE,1,5) S BGPXX=0,BGPXN=0,BGPXY="" F  S BGPXX=$O(^BGPGPDCK(BGPX,1111,BGPXX)) Q:BGPXX'=+BGPXX  S BGPXN=BGPXN+1,BGPXY=BGPXY_$S(BGPXN=1:"",1:";")_$P(^BGPGPDCK(BGPX,1111,BGPXX,0),U)
 ..S BGPX1=0,C=0 F BGPX1=1:3:BGPXN D
 ...D W^BGP5DP($E($P(BGPXY,";",BGPX1),1,20),0,1,BGPPTYPE,1,10)
 ...D W^BGP5DP($E($P(BGPXY,";",(BGPX1+1)),1,20),0,0,BGPPTYPE,2,30)
 ...D W^BGP5DP($E($P(BGPXY,";",(BGPX1+2)),1,20),0,0,BGPPTYPE,3,60)
