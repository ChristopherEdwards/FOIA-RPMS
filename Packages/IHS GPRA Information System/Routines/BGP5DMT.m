BGP5DMT ; IHS/CMI/LAB - national patient list 20 Dec 2004 9:24 AM ; 17 Sep 2014  5:07 PM
...
QUE ;
 ...
 S ZTRTN="PRINT^BGP5DMT",ZTDESC="BGP 15 MED TAX REPORT",ZTIO=ION,ZTDTH=""
 D ^%ZTLOAD
 D HOME^%ZIS
 D XIT
 Q
...
N ;GATHER UP AND DISPLAY ALL NATIONAL GPRA
 ...
 .Q:$P(^BGPTAXK(BGPTIEN,0),U,2)'="M"  ;only DRUG/MEDICATION taxonomies in this report
 .S (G,X)=0 F  S X=$O(^BGPTAXK(BGPTIEN,12,"B",X)) Q:X'=+X!(G)  I $D(BGPRT(X)) S G=1
 .Q:'G
...
INTROT ;introductory text
 ...
 ;;CRS 2015.  The report is organized by (1) taxonomies included in the
