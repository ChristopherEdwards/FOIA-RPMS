BGP5DNGP ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;15.0;IHS CLINICAL REPORTING;;NOV 18, 2014;Build 134
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2015 National GPRA/GPRAMA Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
ZIS ;call to XBDBQUE
 ...
 ..W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDPK(" D ^DIK K DIK
 ..W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDBK(" D ^DIK K DIK
 I $D(IO("Q")) G TSKMN
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP5DNGP",XBRX="XIT^BGP5DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP5DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA/GPRAMA REPORT 11 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
