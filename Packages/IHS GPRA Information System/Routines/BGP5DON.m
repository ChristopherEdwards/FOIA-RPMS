BGP5DON ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ...
 W:$D(IOF) @IOF
 D XIT
 W !,$$CTR("IHS 2015 Other National Measures Report",80)
CHOICE ;
...
INTRO ;
 ...
 .W !,"This report will be run for the Report Period July 1, 2014 through "
 .W !,"June 30, 2015 with a Baseline Year of July 1, 2009 through June 30, 2010."
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP5DON",XBRX="XIT^BGP5DON",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP5DON",ZTDTH="",ZTDESC="Other National Measures REPORT 15" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
