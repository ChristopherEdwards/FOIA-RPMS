...
I18 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.8.1E",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.8.3E",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.9.1E",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.9.3E",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.10.1E",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.10.3E",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.8.1F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.8.3F",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.9.1F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.9.3F",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.10.1F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.10.3F",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 I BGPRTYPE=4,BGPINDT="E" D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.8.1F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.8.2F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.8.3F",0)) D PI1^BGP5DP1
 .S BGPPC=$O(^BGPINDVC("OR","18.8.4F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.8.5F",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.9.1F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.9.2F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.9.3F",0)) D PI1^BGP5DP1
 .S BGPPC=$O(^BGPINDVC("OR","18.9.4F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.9.5F",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","18.10.1F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.10.2F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.10.3F",0)) D PI1^BGP5DP1
 .S BGPPC=$O(^BGPINDVC("OR","18.10.4F",0)) D PI1^BGP5DP1 S BGPPC=$O(^BGPINDVC("OR","18.10.5F",0)) D PI1^BGP5DP1
 .Q:BGPQUIT
 F BGPPC1="18.1","18.2","18.3" Q:BGPQUIT  D PI^BGP5DP1
 Q:BGPQUIT
 ;I BGPRTYPE=4 D HEADER^BGP5DPH
 F BGPPC1="18.4" Q:BGPQUIT  D PI^BGP5DP1
 Q:BGPQUIT
 I BGPRTYPE=4 D HEADER^BGP5DPH W !,^BGPINDV(BGPIC,53,1,0)
 I BGPRTYPE'=1 D H1^BGP5DPH
 F BGPPC1="18.5","18.6","18.7" Q:BGPQUIT  D PI^BGP5DP1
 Q:BGPQUIT
 D I1AGE
 Q
