...
PR ; 
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP5DPH Q:BGPQUIT  W:'$G(BGPSUMON) !,^BGPINDK(BGPIC,53,1,0) W:$D(^BGPINDK(BGPIC,53,2,0)) !,^BGPINDK(BGPIC,53,2,0) D H3
...
PB ;
 I $Y>(BGPIOSL-12),'$G(BGPSUMON) D HEADER^BGP5DPH Q:BGPQUIT  W !,^BGPINDK(BGPIC,53,1,0) W:$D(^BGPINDK(BGPIC,53,2,0)) !,^BGPINDK(BGPIC,53,2,0) D H3
 ;percentage changes
