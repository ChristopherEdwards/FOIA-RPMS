BGP5EL12 ; IHS/CMI/LAB - print ind ;
...
I1AGE7 ;
 S I=I+1
 S BGPF="ELD."_$P(BGPX,".")_"."_($P(BGPX,".",2)+32) S BGPPC=$O(^BGPELIIK("C",BGPF,0))
 ;
 S BGPNF=$P(^BGPELIIK(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90555.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE9 ;
 S K=K+1
 S BGPF="ELD."_$P(BGPX,".")_"."_($P(BGPX,".",2)+28) S BGPPC=$O(^BGPELIIK("C",BGPF,0))
 ;
 S BGPNF=$P(^BGPELIIK(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90555.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
