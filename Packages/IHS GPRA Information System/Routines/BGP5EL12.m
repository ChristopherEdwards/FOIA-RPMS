BGP5EL12 ; IHS/CMI/LAB - print ind 1 ;
...
I1AGE8 ;
 S J=J+1
 S BGPF="ELD."_$P(BGPX,".")_"."_($P(BGPX,".",2)+28) S BGPPC=$O(^BGPELIIV("C",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPELIIV(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90373.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGEP ;
 ...
 W !,"# w/HbA1c done w/",!," or w/o result"
