BGP5EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;15.1;IHS CLINICAL REPORTING;;MAY 06, 2015;Build 143
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS =>55",BGPHD2="# Active Diabetics"
 D HEADER^BGP5DPH Q:BGPQUIT  W !,^BGPELIK(BGPIC,53,1,0)  D H3^BGP5EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP5DPH Q:BGPQUIT  W !,^BGPELIK(BGPIC,53,1,0) D H3^BGP5EL12
