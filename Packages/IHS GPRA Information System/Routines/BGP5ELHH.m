BGP5ELHH ; IHS/CMI/LAB - cover page for ELDER 25 Jun 2010 10:20 AM ;
 ...
 S X="*** IHS 2015 Elder Care Report ***" D S(X,1,1)
...
AREACP ;EP - area cover page
 ...
 S X=" " D S(X,1,1)
 I BGPROT'="P",'$D(BGPGUI) D
 .S X="A delimited output file called "_BGPDELF D S(X,1,1) S X="has been placed in the "_$$GETDEDIR^BGP5UTL2()_" directory for your use in Excel or some" D S(X,1,1) D
 ...
 .S X=$P(^BGPELDCK(BGPX,0),U,9),X=$O(^AUTTLOC("C",X,0)) S X=$S(X:$P(^DIC(4,X,0),U),1:"?????")
 .S BGPC=BGPC+1,X=BGPC_".  "_$S($P(^BGPELDCK(BGPX,0),U,17):"*",1:"")_X D S(X,1,1)
 .Q
 S X=" " D S(X,1,1)
 ...
 .S X="Community Taxonomy Name: "_$P(^BGPELDCK(BGPX,0),U,18) D S(X,1,1)
 .;W !?5,"Communities: " 
