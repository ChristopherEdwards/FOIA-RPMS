...
I21 ;EP
 D H1
 F BGPPC1="21.1" D PI
 S BGPNODEN=1 S BGPPC1="21.2" D PI K BGPNODEN
 D I1AGE^BGP5ELLM
 Q
I22 ;EP
 D I22^BGP5ELLN
...
PI1 ;
 ...
 .Q:$G(BGPNODEN)
 .S Y=$P(^BGPELIIV(BGPPC,0),U,17) D S(Y,1,1)
 .I $P(^BGPELIIV(BGPPC,0),U,18)]"" D
 ..D S($P(^BGPELIIV(BGPPC,0),U,18),1,1)
 .I $P(^BGPELIIV(BGPPC,0),U,21)]"" D
 ..D S($P(^BGPELIIV(BGPPC,0),U,21),1,1)
 ...
 S Y=" " D S(Y,1,1) S Y=$P(^BGPELIIV(BGPPC,0),U,15) D S(Y,1,1)
 I $P(^BGPELIIV(BGPPC,0),U,16)]"" S Y=$P(^BGPELIIV(BGPPC,0),U,16) D S(Y,1,1)
