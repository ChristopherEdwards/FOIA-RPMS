BGP5ELLH ; IHS/CMI/LAB - print ind 07 Jun 2015 4:19 PM ;
...
I1AGE5 ;
 S G=G+1
 S BGPF="ELD."_$P(BGPX,".")_"."_($P(BGPX,".",2)+14) S BGPPC=$O(^BGPELIIK("C",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPELIIK(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90555.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGEP ;
 ...
 S X="% w/BMI calculated - No Refusals" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAC(X),U,3) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:2 S V=$P(BGPDAC(X),U,5) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="B. # Obese" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAC(X),U,6) S Y=V D S(Y,,X+1)
 S X="B. % Obese w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAC(X),U,7) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:2 S V=$P(BGPDAC(X),U,9) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:2 S V=$P(BGPDAC(X),U,11) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
PR ; 
 ...
 S X="% w/BMI calculated - No Refusals" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,3) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="A. # Overweight" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,4) S Y=V D S(Y,,X+1)
 S X="A. % Overweight w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,5) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="B. # Obese" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,6) S Y=V D S(Y,,X+1)
 S X="B. % Obese w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,7) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="C. # Overweight or Obese" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,8) S Y=V D S(Y,,X+1)
 S X="C. % Overweight or Obese w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,9) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="# w/BMI refusal (no BMI)" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,10) S Y=V D S(Y,,X+1)
 S X="% w/BMI refusal (no BMI)" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAP(X),U,11) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 ;percentage changes
 S X=" " D S(X,1,1) S X="CHANGE FROM PREV YR %" D S(X,1,1)
 S X="w/BMI calculated - No Refusals" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAP(X),U,3) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="A. % Overweight w/ % Total BMI" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAP(X),U,5) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="B. % # Obese w/ % Total BMI" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,7),O=$P(BGPDAP(X),U,7) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="C. % Overweight or Obese w/ % of Total BMI" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,9),O=$P(BGPDAP(X),U,9) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="# w/BMI refusal (no BMI)" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAP(X),U,11) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
BL ;
 ...
 S X="% w/BMI calculated - No Refusals" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,3) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="A. # Overweight" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,4) S Y=V D S(Y,,X+1)
 S X="A. % Overweight w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,5) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="B. # Obese" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,6) S Y=V D S(Y,,X+1)
 S X="B. % Obese w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,7) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="C. # Overweight or Obese" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,8) S Y=V D S(Y,,X+1)
 S X="C. % Overweight or Obese w/% Total BMI" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,9) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 S X="  " D S(X,1,1) S X="# w/BMI refusal (no BMI)" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,10) S Y=V D S(Y,,X+1)
 S X="% w/BMI refusal (no BMI)" D S(X,1,1)
 F X=1:1:2 S V=$P(BGPDAB(X),U,11) S Y=$$SB^BGP5ELL2($J(V,6,1)) D S(Y,,X+1)
 ;percentage changes
 S X=" " D S(X,1,1) S X="CHANGE FROM BASE YR %" D S(X,1,1)
 S X="w/BMI calculated - No Refusals" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAB(X),U,3) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="A. % Overweight w/ % of Total BMI" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAB(X),U,5) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="B. % # Obese w/ % of Total BMI" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,7),O=$P(BGPDAB(X),U,7) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="C. % # Overweight or Obese w/ % Total BMI" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,9),O=$P(BGPDAB(X),U,9) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="# w/BMI refusal (no BMI)" D S(X,1,1)
 F X=1:1:2 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAB(X),U,11) S Y=$$SB^BGP5ELL2($J((N-O),6,1)) D S(Y,,X+1)
 Q
