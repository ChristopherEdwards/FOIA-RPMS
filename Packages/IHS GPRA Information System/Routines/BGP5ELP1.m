...
I1A1 ;001.A, 001.B, 001.C
 ...
 Q
I2 ;EP
 I $Y>(BGPIOSL-13) D HEADER^BGP5DPH Q:BGPQUIT  W !!,^BGPELIK(BGPIC,53,1,0)
 D H1^BGP5DPH
...
IRAA ;EP
 D H1^BGP5DPH
 F BGPPC1=$P(^BGPELIK(BGPIC,0),U,6)_".1" Q:BGPQUIT  D PI
 D I1AGE^BGP5EL1N
 Q
AWV ;EP
 D H1^BGP5DPH
...
PCV ;EP
 ...
 D HEADER^BGP5DPH Q:BGPQUIT  W !!,^BGPELIK(BGPIC,53,1,0) D H1^BGP5DPH
...
PI1 ;
 ...
 .I $Y>(BGPIOSL-13) D HEADER^BGP5DPH Q:BGPQUIT  W !!,^BGPELIK(BGPIC,53,1,0) D H1^BGP5DPH
 .W !!,$P(^BGPELIIK(BGPPC,0),U,17)
 .I $P(^BGPELIIK(BGPPC,0),U,18)]"" D
 ..W !,$P(^BGPELIIK(BGPPC,0),U,18)
 .I $P(^BGPELIIK(BGPPC,0),U,21)]""  D
 ..W !,$P(^BGPELIIK(BGPPC,0),U,21)
 ...
 D SETN
 ;write header
 I $Y>(IOSL-5) D HEADER^BGP5DPH Q:BGPQUIT  W !!,^BGPELIK(BGPIC,53,1,0) D H1^BGP5DPH
 I $P(^BGPELIIK(BGPPC,0),U,22) W !
