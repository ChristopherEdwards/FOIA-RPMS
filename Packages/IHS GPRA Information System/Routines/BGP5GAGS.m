BGP5GAGS ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
TESTNTL ;
 ...
 S BGPSUL(3)=""
 S BGPSUL(2)=""
 D EP(.ERR,1,2522,"BGP 15 AREA GPRA","A",.BGPSUL,"B",1,$$NOW^XLFDT,1)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP5GAGS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI AREA GPRA REPORT 11" D ^%ZTLOAD
...
AOAGP ;
 ...
 I BGPRPTT="A",'$G(BGPSUMON) D GNT1^BGP5UTL
 D ENDLOG
 D XIT
 Q
 ;
