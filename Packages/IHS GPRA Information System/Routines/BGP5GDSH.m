BGP5GDSH ; IHS/CMI/LAB - GPRA DASHBOARD GUI
 ;;15.1;IHS CLINICAL REPORTING;;MAY 06, 2015;Build 143
 ;
 ;
TESTDSH ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 15 NATIONAL DASHBOARD",597,"B",$$NOW^XLFDT,,"LORITESTGUI")
 W !,ERR
 Q
...
NT ;
 ...
 S BGPEXCEL=""
 I $G(BGPDESGP)="" D REPORT^BGP5UTL G NT1
 N DESDDA
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP5GDSH",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL DASHBOARD REPORT" D ^%ZTLOAD
...
NTLGP ;
 ...
 ..Q
P ;
 ;D ^BGP5D1  ;cmi/maw 05/20/2014 commented out as it is already being called at NTLGP+1
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
