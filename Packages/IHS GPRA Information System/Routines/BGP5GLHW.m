BGP5GLHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM 05 Oct 2015 9:58 AM ;
 ;;15.0;IHS CLINICAL REPORTING;;NOV 18, 2014;Build 134
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 15 LOCAL HT/WT",597,"","O","P",$$NOW^XLFDT,"lori ht/wt file")
 W !,ERR
 Q
...
CHW ;
 S BGPYWCHW=2
 S BGPHWNOW=$$NOW^XLFDT() S BGPHWNOW=$P(BGPHWNOW,".")_"."_$$RZERO^BGP5UTL($P(BGPHWNOW,".",2),6)
 S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP5UTL(BGPBD)_$$D^BGP5UTL(BGPED)_$$D^BGP5UTL(BGPHWNOW)_"_001_of_001"_".TXT"
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIK(",DIC(0)="L",DIADD=1,DLAYGO=90554.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///"_$G(BGPROT)_";1///"_BGPFN
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLLHW^BGP5GLHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT" D ^%ZTLOAD
...
NTLLHW ;
 ...
 ;D HWSF^BGP5DHW
 ;D KITM^BGP5DHW
 D GUIR^BGPXBLM("PRINT^BGP5DHW","^TMP($J,""BGPGUI"",")
