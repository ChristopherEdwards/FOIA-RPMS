BGP5P1 ; IHS/CMI/LAB - v11.0 patch 1 env routine 08 Dec 2010 3:10 PM ;
...
POST ;EP - called from kids build
 ...
 .I '$D(^BGPGPDCK(BGPX,1.1)) S DA=BGPX,DIK="^BGPGPDCK(" D ^DIK S DA=BGPX,DIK="^BGPGPDPK(" D ^DIK S DA=BGPX,DIK="^BGPGPDBK(" D ^DIK
 Q
