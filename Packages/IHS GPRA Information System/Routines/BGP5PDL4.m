BGP5PDL4 ; IHS/CMI/LAB - print ind 1 ;
...
I23 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.4.3D",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.5.3D",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.6.3D",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.4.3E",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.5.3E",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.6.3E",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.4.3F",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.5.3F",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.6.3F",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.4.3G",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.5.3G",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.6.3G",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.4.3H",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.5.3H",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.6.3H",0)) D PI1^BGP5PDL1
 I BGPINDT="E",BGPRTYPE=4 D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.4.1H",0)) D PI1^BGP5PDL1 S BGPPC=$O(^BGPINDVC("OR","23.4.2H",0)) D PI1^BGP5PDL1 S BGPPC=$O(^BGPINDVC("OR","23.4.3H",0)) D PI1^BGP5PDL1
 .S BGPPC=$O(^BGPINDVC("OR","23.4.4H",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.5.1H",0)) D PI1^BGP5PDL1 S BGPPC=$O(^BGPINDVC("OR","23.5.2H",0)) D PI1^BGP5PDL1 S BGPPC=$O(^BGPINDVC("OR","23.5.3H",0)) D PI1^BGP5PDL1
 .S BGPPC=$O(^BGPINDVC("OR","23.5.4H",0)) D PI1^BGP5PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDVC("OR","23.6.1H",0)) D PI1^BGP5PDL1 S BGPPC=$O(^BGPINDVC("OR","23.6.2H",0)) D PI1^BGP5PDL1 S BGPPC=$O(^BGPINDVC("OR","23.6.3H",0)) D PI1^BGP5PDL1
 .S BGPPC=$O(^BGPINDVC("OR","23.6.4H",0)) D PI1^BGP5PDL1
 F BGPPC1="23.1","23.2","23.3" D PI^BGP5PDL1
 F BGPPC1="23.7","23.8","23.9" D PI^BGP5PDL1
 D I1AGE
 Q
I1AGE ;EP
 ;Q:BGPRTYPE'=4
...
I1AGEP ;
 ...
 S X="% Obese w/ % of Total BMI" D S(X,1,1)
