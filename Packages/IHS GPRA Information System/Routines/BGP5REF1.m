BGP5REF1 ; IHS/CMI/LAB - measure AHR.A ;
...
BETA ;EP
 ...
 ...S G=1_U_"Beta Blocker Refusal "_$$DATE^BGP5UTL(Y)
 ..Q
 .Q
 Q G
 ;
ASA ;EP
 ...
 ..S N=0 F  S N=$O(^AUPNPREF("AA",P,50,X,D,N)) Q:N'=+N!(G)  D
 ...Q:$P($G(^AUPNPREF(N,0)),U,7)'="R"
 ...S G=1_U_"Aspirin Refusal "_$$DATE^BGP5UTL(Y)
 ..Q
 .Q
 I G Q G
 ...
 ..S N=0 F  S N=$O(^AUPNPREF("AA",P,50,X,D,N)) Q:N'=+N!(G)  D
 ...Q:$P($G(^AUPNPREF(N,0)),U,7)'="R"
 ...S G=1_U_"Anti-Platelet Refusal "_$$DATE^BGP5UTL(Y)
 ..Q
 .Q
 Q G
ACEI ;EP
