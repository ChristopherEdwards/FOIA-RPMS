BGP5SDPN ; IHS/CMI/LAB - IHS summary page ;
...
START ;
 ...
 ...D W^BGP5DP($P(^BGPINDKC(BGPPC,15),U,4),0,2,BGPPTYPE)
 ...I $P(^BGPINDKC(BGPPC,15),U,7)]"" D W^BGP5DP($P(^BGPINDKC(BGPPC,15),U,7),0,1,BGPPTYPE)
 ...I $P(^BGPINDKC(BGPPC,15),U,12)]"" D W^BGP5DP($P(^BGPINDKC(BGPPC,15),U,12),0,1,BGPPTYPE)
 ...
 ...D W^BGP5DP($P(^BGPINDKC(BGPPC,15),U,2),0,0,BGPPTYPE,,55)
 ...;D W^BGP5DP($P(^BGPINDKC(BGPPC,15),U,3),0,0,BGPPTYPE,,65)
 ...I $P(^BGPINDKC(BGPPC,15),U,9)]""!($P(^BGPINDKC(BGPPC,15),U,10)]"")!($P(^BGPINDKC(BGPPC,15),U,11)]"") D
 ....D W^BGP5DP($TR($P(^BGPINDKC(BGPPC,15),U,10),"$","^"),0,0,BGPPTYPE,,55) ;,W^BGP5DP($P(^BGPINDKC(BGPPC,15),U,11),0,0,BGPPTYPE,,65)
 ...
 .....D W^BGP5DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE NON",BGPC,BGPO,BGPPC,BGPSN),U),7,0),0,0,BGPPTYPE,,20)
 .....D W^BGP5DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE NON",BGPC,BGPO,BGPPC,BGPSN),U,2),7,0),0,0,BGPPTYPE,,29)
 .....D W^BGP5DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE NON",BGPC,BGPO,BGPPC,BGPSN),U,3),7,0),0,0,BGPPTYPE,,38)
 ....E  D
 .....I $Y>(BGPIOSL-3) D HEADER Q:BGPQUIT
 .....D W^BGP5DP(BGPSASU,0,1,BGPPTYPE,,2),W^BGP5DP($E(BGPSNAM,1,12),0,0,BGPPTYPE,,8)
 .....D W^BGP5DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE NON",BGPC,BGPO,BGPPC,BGPSN),U),7,1)_"%",0,0,BGPPTYPE,,20)
 .....D W^BGP5DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE NON",BGPC,BGPO,BGPPC,BGPSN),U,2),7,1)_"%",0,0,BGPPTYPE,,29)
 .....D W^BGP5DP($J($P(^TMP($J,"SUMMARY DETAIL PAGE NON",BGPC,BGPO,BGPPC,BGPSN),U,3),7,1)_"%",0,0,BGPPTYPE,,38)
 ..I BGPPTYPE="D" D
 ...D W^BGP5DP("",0,1,BGPPTYPE)
 ...S XX=" "_$P(^BGPINDKC(BGPPC,15),U,4)
 ...I $P(^BGPINDKC(BGPPC,15),U,7)]"" D W^BGP5DP(XX,0,1,BGPPTYPE) S XX=" "_$P(^BGPINDKC(BGPPC,15),U,7)
 ...I $P(^BGPINDKC(BGPPC,15),U,12)]"" D W^BGP5DP(XX,0,1,BGPPTYPE) S XX=" "_$P(^BGPINDKC(BGPPC,15),U,12)
 ...
 ...S $P(XX,U,6)=$P(^BGPINDKC(BGPPC,15),U,2) ;,$P(XX,U,7)=$P(^BGPINDKC(BGPPC,15),U,3)
 ...
 .....;S $P(X,U,5)=$P(^BGPINDKC(BGPPC,15),U,2),$P(X,U,6)=$P(^BGPINDKC(BGPPC,15),U,3)
 .....;I BGPCNT=1 D S(XX,1,1) D
 ....I BGPCNT=1 D W^BGP5DP(XX,0,1,BGPPTYPE,1)
 ....;S Y="" I $P(^BGPINDKC(BGPPC,15),U,9)]""!($P(^BGPINDKC(BGPPC,15),U,10)]"") S $P(Y,U,6)=$TR($P(^BGPINDKC(BGPPC,15),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDKC(BGPPC,15),U,10),"$","^")
 ....S Y="" I $P(^BGPINDKC(BGPPC,15),U,9)]""!($P(^BGPINDKC(BGPPC,15),U,10)]"")!($P(^BGPINDKC(BGPPC,15),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDKC(BGPPC,15),U,9),"$","^") D
 .....S $P(Y,U,8)=$P(^BGPINDKC(BGPPC,15),U,11)
...
HEADER ;EP
 ...
 Q
H1 ;
 I BGPRTYPE=1 S X="SELECTED NON-GPRA MEASURES CLINICAL PERFORMANCE DETAIL" D W^BGP5DP(X,1,1,BGPPTYPE)
 ...
 D W^BGP5DP("Current",0,1,BGPPTYPE,2,21),W^BGP5DP("Prev",0,0,BGPPTYPE,3,32),W^BGP5DP("Base",0,0,BGPPTYPE,4,40),W^BGP5DP("Current",0,0,BGPPTYPE,5,46),W^BGP5DP("2014",0,0,BGPPTYPE,6,55) ;,W^BGP5DP("Target",0,0,BGPPTYPE,7,66)
