BGP5TXEL ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;7.0;IHS CLINICAL REPORTING;;JAN 24, 2007
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2005 Elder Care Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP5TXEL",XBNS="",XBRX="XIT^BGP5TXEL"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
