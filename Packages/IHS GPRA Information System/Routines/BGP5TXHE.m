BGP5TXHE ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY05 HEDIS REPORT ;
 ;;7.0;IHS CLINICAL REPORTING;;JAN 24, 2007
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2005 HEDIS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP5TXHE",XBNS="",XBRX="XIT^BGP5TXHE"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
