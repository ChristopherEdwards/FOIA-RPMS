...
SETPRC(P,BDATE,EDATE,T,BGPG) ;EP
 ...
 .Q:BGPDX3=""  ;bad
 .Q:'$$ICD^BGP5UTL2(BGPDX3,BGPTX5,0)
 .S BGPDX4=BGPDX4+1,BGPG(BGPDX4)=$$VD^APCLV($P(^AUPNVPRC(BGPDX1,0),U,3))_"^"_$P($$ICDOP^BGP5UTL2(BGPDX3),U,2)_"^"_$P($$ICDOP^BGP5UTL2(BGPDX3),U,2)_"^"_BGPDX1_";AUPNVPRC"_"^"_$P(^AUPNVPRC(BGPDX1,0),U,3)
 .Q
 Q
 ;
LASTDX(P,T,BDATE,EDATE) ;EP
 ...
 ..Q:BGPDX3=""  ;bad xref
 ..Q:'$D(^ICD9(BGPDX3))
 ..Q:'$$ICD^BGP5UTL2(BGPDX3,BGPTX5,9)
 ..S BGPDX4=1_"^"_$P($$ICDDX^BGP5UTL2(BGPDX3),U,2)_"^"_(9999999-BGPDX1)_"^"_BGPDX3_"^"_BGPDX2
 ..Q
 .Q
 Q BGPDX4
...
LASTPRC(P,T,BDATE,EDATE) ;EP
 ...
 ..Q:BGPDX3=""  ;bad xref
 ..Q:'$$ICD^BGP5UTL2(BGPDX3,BGPTX5,0)
 ..S BGPDX4=1_"^"_$P($$ICDOP^BGP5UTL2(BGPDX3),U,2)_"^"_(9999999-BGPDX1)_"^"_BGPDX3_"^"_BGPDX2
 ..Q
 .Q
 Q BGPDX4
 ;
LASTPRCI(P,T,BDATE,EDATE) ;EP
 ...
 S BGPTX5=+$$CODEN^BGP5UTL2(T,80.1)
...
FIRSTPRC(P,T,BDATE,EDATE) ;EP
 ...
 .Q:D<BDATE
 .Q:D>EDATE
 .S BGPDX4=1_"^"_$P($$ICDOP^BGP5UTL2(BGPDX3),U,2)_"^"_D_"^"_BGPDX3_"^"_BGPX
 .Q
 Q BGPDX4
FIRSTCPT(P,T,BDATE,EDATE) ;EP
 ...
 .Q:'$$ICD^BGP5UTL2(C,BGPT,1)  ;not a code of interest
...
I1() ;EP
 I BGPVALUE="" Q 0
 I BGPINDK="E",BGPVALUE]"",BGPAGEB>64 Q 1
 I BGPINDK="E",BGPVALUE]"",BGPAGEB<65 Q 0
 I BGPVALUE]"" Q 1
 Q 0
I12() ;EP
 I BGPINDK="D" Q 1
 I BGPINDK="D",'BGPD4 Q 0
 I BGPINDK="E",(BGPD3+BGPD7) Q 1
 I BGPINDK="E",'(BGPD3+BGPD7) Q 0
 I BGPACTUP Q 1
 Q 0
I13() ;EP
 I BGPINDK="D",BGPD2 Q 1
 I BGPINDK="D",'BGPD2 Q 0
 I BGPINDK="E",(BGPD3+BGPD1) Q 1
 I BGPINDK="E",'(BGPD3+BGPD1) Q 0
...
IA() ;EP
 ...
 NEW X
 S X=BGPN1
 I BGPINDK="D",BGPD7,'X Q 1
 I BGPINDK="D",BGPD7,X Q 1   ;XXXX CHANGE TO Q 0 AFTER TESTING
 I BGPINDK="D",'BGPD7 Q 0
 I BGPINDK="C",BGPD8,'X Q 1
 I BGPINDK="C",BGPD8,X Q 1  ;XXXX CHANGE TO Q 0
 I BGPINDK="C",'BGPD8 Q 0
 I BGPINDK="S" I (BGPD1+BGPD2+BGPD3+BGPD4+BGPD5+BGPD6+BGPD7+BGPD8) Q $S(X:1,1:1)  ;LORI **** CHANGE x:1 TO x:0 AFTER TESTING
 Q 0
I17() ;EP
 I 'BGPD1 Q 0
 I BGPINDK="W" Q $S(BGPSEX="F":1,1:0)
 Q 1
I25() ;EP
 I BGPINDK="D" Q BGPDMD2
 I 'BGPD1 Q 0
 I BGPINDK="W" Q $S(BGPSEX="F":1,1:0)
 Q 1
LASTECOD(P,T,BDATE,EDATE) ;EP
 ...
 ...Q:BGPDX3=""  ;no ecode
 ...I $$ICD^BGP5UTL2(BGPDX3,BGPTX5,9) S BGPDX4=1_"^"_$P($$ICDDX^BGP5UTL2(BGPDX3),U,2)_"^"_(9999999-BGPDX1)_"^"_BGPDX3_"^"_BGPDX2
 ..Q
 .Q
 Q BGPDX4
...
PRCREFT(P,BDATE,EDATE,T) ;EP - return ien of proc
 ...
 ..Q:'$$ICD^BGP5UTL2(I,T,0)
 ..S G="1^"_D_"^"_$P(^AUPNPREF(Y,0),U,7)_"^"_$P($$ICDOP^BGP5UTL2(I),U,2)
 .Q
 Q G
STI16A() ;EP
 I 'BGPACTCL Q 0
