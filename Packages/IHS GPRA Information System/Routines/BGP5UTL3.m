BGP5UTL3 ; IHS/CMI/LAB - 27 Apr 2009 11:01 PM 30 Aug 2009 10:16 AM 30 Jun 2010 4:58 PM 05 Aug 2015 11:40 AM 26 Mar 2015 2:40 PM ;
...
ONN4 ;EP
 ...
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,25)
...
ONN5 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,26)
