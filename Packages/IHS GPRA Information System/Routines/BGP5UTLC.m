BGP5UTLC ; IHS/CMI/LAB - 27 Apr 2009 11:01 PM 30 Aug 2009 10:16 AM 30 Jun 2010 4:58 PM ;
...
GNT3 ;EP - area export file
 ...
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,27)
...
GNT4 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,29)
...
DEV ;EP - area export file
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,22)
...
DEV2 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,23)
...
DEV3 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,24)
...
GNT6 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2015",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,28)
