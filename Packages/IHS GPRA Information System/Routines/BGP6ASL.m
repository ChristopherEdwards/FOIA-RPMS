...
EN ;EP -- main entry point for APCH HMR DISPLAY
 D EN^VALM("BGP 06 AREA SELECT SITES")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
NGR ;
 ...
 S BGPX=0 F  S BGPX=$O(^BGPGPDCS(BGPX)) Q:BGPX'=+BGPX  S V=$G(^BGPGPDCS(BGPX,0)) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .I $G(BGP6GPU),$P(V,U,12)'=9 Q
 .I '$G(BGP6GPU),$P(V,U,12)'=1 Q
 .I $G(BGPCHWE) Q:'$O(^BGPGPDCS(BGPX,88888,0))
 .Q:$P(V,U,5)'=BGPBBD
 .Q:$P(V,U,6)'=BGPBED
 .Q:$P(V,U,14)'=BGPBEN
 ...
 .S $E(Y,15)=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPGPDCS(BGPX,0),U,17):"+",1:"")
...
ELD ;
 K BGPTIND S BGPHIGH=""
 S BGPSUCNT=0,BGPSU="",BGPSUC=0
 S BGPX=0 F  S BGPX=$O(^BGPELDCS(BGPX)) Q:BGPX'=+BGPX  I BGPX S V=$G(^BGPELDCS(BGPX,0)) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=5
 ...
 .S Y=""
 .S $E(Y,4)=$E($$SU($P(V,U,11)),1,10)
 .S $E(Y,15)=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPELDCS(BGPX,0),U,17):"+",1:"")
 .S $E(Y,30)=$$DATE^BGP6UTL($P(V,U))
 .S $E(Y,40)=$$DATE^BGP6UTL($P(V,U,2))
 .S $E(Y,50)=$$DATE^BGP6UTL($P(V,U,5))
 .S $E(Y,60)=$$DATE^BGP6UTL($P(V,U,6))
...
HED ;
 K BGPTIND S BGPHIGH=""
 S BGPSUCNT=0,BGPSU="",BGPSUC=0
 S BGPX=0 F  S BGPX=$O(^BGPHEDCS(BGPX)) Q:'BGPX  I BGPX S V=$G(^BGPHEDCS(BGPX,0)) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=3
 ...
 .S Y=""
 .S $E(Y,4)=$E($$SU($P(V,U,11)),1,10)
 .S $E(Y,15)=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPHEDCS(BGPX,0),U,17):"+",1:"")
 .S $E(Y,30)=$$DATE^BGP6UTL($P(V,U))
 .S $E(Y,40)=$$DATE^BGP6UTL($P(V,U,2))
 .S $E(Y,50)=$$DATE^BGP6UTL($P(V,U,5))
 .S $E(Y,60)=$$DATE^BGP6UTL($P(V,U,6))
...
G1 ;
 ...
 S BGPPER=3060000,BGPQTR=3,BGPBEN=1
 ...
 S BGPFILE=90374.03
 S BGPX=0 F  S BGPX=$O(^BGPGPDCS(BGPX)) Q:BGPX'=+BGPX  S V=^BGPGPDCS(BGPX,0) D
 ...
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPGPDCS(BGPX,0),U,17):" (CHS ONLY)",1:"")
...
G3 ;
 ...
 S BGPFILE=90375.03
 S BGPX=0 F  S BGPX=$O(^BGPHEDCS(BGPX)) Q:'BGPX  I BGPX S V=^BGPHEDCS(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=3
 ...
 .Q:$P(V,U,14)'=BGPBEN
 . S BGPSU=$E($$SU($P(V,U,11)),1,10)
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPHEDCS(BGPX,0),U,17):" (CHS ONLY)",1:"")
 . S BGPEBD=$$DATE^BGP6UTL($P(V,U))
 . S BGPEED=$$DATE^BGP6UTL($P(V,U,2))
 . S BGPEBBD=$$DATE^BGP6UTL($P(V,U,5))
 . S BGPEBED=$$DATE^BGP6UTL($P(V,U,6))
...
G5 ;
 ...
 S BGPBED=BGPED-X,BGPBED=$E(BGPBED,1,3)_$E(BGPED,4,7)
 S BGPFILE=90376.03
 S BGPX=0 F  S BGPX=$O(^BGPELDCS(BGPX)) Q:'BGPX  I BGPX S V=^BGPELDCS(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=5
 ...
 .Q:$P(V,U,14)'=BGPBEN
 . S BGPSU=$E($$SU($P(V,U,11)),1,10)
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPELDCS(BGPX,0),U,17):" (CHS ONLY)",1:"")
 . S BGPEBD=$$DATE^BGP6UTL($P(V,U))
 . S BGPEED=$$DATE^BGP6UTL($P(V,U,2))
 . S BGPEBBD=$$DATE^BGP6UTL($P(V,U,5))
 . S BGPEBED=$$DATE^BGP6UTL($P(V,U,6))
...
G9 ;
 ...
 S BGPBBD=BGPBD-X,BGPBBD=$E(BGPBBD,1,3)_$E(BGPBD,4,7)
 S BGPBED=BGPED-X,BGPBED=$E(BGPBED,1,3)_$E(BGPED,4,7)
 S BGPX=0 F  S BGPX=$O(^BGPGPDCS(BGPX)) Q:'BGPX  I BGPX S V=^BGPGPDCS(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=9
