BGP6D1 ; IHS/CMI/LAB - calc measures 29 Apr 2006 7:38 PM 01 May 2006 3:25 PM ; 
...
PROC ;EP
 ...
 D XTMP^BGP6UTL("BGP06CPL","National GPRA Comp List")
 D XTMP^BGP6UTL("BGP6DNP","National GPRA Patient List")
 D XTMP^BGP6UTL("BGP6D","CRS Local Patient List")
 ...
 I BGPRTYPE=1,$G(BGPEXPT),'$G(BGP6GPU) S ^BGPGPDCS(BGPRPT,88888,0)="^90374.0388888A^"_BGPCHWC_"^"_BGPCHWC
 S BGPET=$H
 Q
 ;
PROCCY ;current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDCS(",BGPRTYPE=5:"^BGPELDCS(",1:"^BGPGPDCS(")
 S BGP365=BGPBDATE
 ...
 D CALCIND
 I BGPRTYPE=1,$G(BGPYWCHW),'$G(BGP6GPU) D
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDPS(",BGPRTYPE=5:"^BGPELDPS(",1:"^BGPGPDPS(")
 S BGP365=BGPBDATE
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL=$S(BGPRTYPE=3:"^BGPHEDBS(",BGPRTYPE=5:"^BGPELDBS(",1:"^BGPGPDBS(")
 S BGP365=BGPBDATE
 ...
 Q
CALCIND ;
 I BGPRTYPE=3 D CALCIND^BGP6DCHI Q
 I BGPRTYPE=5 D CALCIND^BGP6DCEI Q
 D CALCIND^BGP6DCI
 Q
