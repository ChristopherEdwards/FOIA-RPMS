BGP6D211 ; IHS/CMI/LAB - measure 6 19 Sep 2014 8:12 AM ; 
...
JVN ;EP
 ...
 I Y S $P(BGPVAL,U,1)="JVN: "_$$DATE^BGP6UTL(D)_" Cl "_R
 ;OPHTHALMOLOGY
 ...
 I Y S $P(BGPVAL,U,2)="Ophth: "_$$DATE^BGP6UTL(D)_" Cl/Prv "_R_"/"_J
 ;I 'Y D
 ...
 .I J'="08",J'=24 Q
 .S Y=1,D=$P(^TMP($J,"A",X),U)
 I Y S $P(BGPVAL,U,3)="Optom: "_$$DATE^BGP6UTL(D)_" Cl/Prv "_R_"/"_J
 Q BGPVAL
DNKA(V) ;EP
 NEW D,N
...
QUANTUP(P,BDATE,EDATE) ;EP
 ...
 S %="",E=+$$CODEN^ICPTCOD(82043),%=$$TRANI^BGP6DU(P,BDATE,EDATE,E)
...
OCPT(V) ;is there a 82570 on this visit?
 ...
 S E=+$$CODEN^ICPTCOD("82570"),%=$$CPTI^BGP6DU(P,D,D,E)
 ...
 S E=+$$CODEN^ICPTCOD("82570"),%=$$TRANI^BGP6DU(P,D,D,E)
 I % Q 1
 Q ""
LOINC(A,B) ;EP 
 NEW %
...
AWV ;EP
 ...
 S BGPN1=$P(BGPVAL,U)
 S BGPVALUE="AC|||" I BGPN1 S BGPVALUE=BGPVALUE_$$DATE^BGP6UTL($P(BGPVAL,U,2))_" CPT "_$P(BGPVAL,U,3)
 K BGPVAL
 Q
 ;
AWV1(P,BDATE,EDATE) ;EP
 ...
 I 'T Q ""
 S X=$$CPT^BGP6DU(P,BDATE,EDATE,T,6)
 I 'X S X=$$TRAN^BGP6DU(P,BDATE,EDATE,T,6)
 Q X
