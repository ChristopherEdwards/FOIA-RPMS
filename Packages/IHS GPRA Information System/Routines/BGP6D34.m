...
DTAP(P,EDATE) ;EP
 ...
 ...I Y=90700!(Y=90721)!(Y=90723)!(Y=90701)!(Y=90711)!(Y=90720)!(Y=90702)!(Y=90718)!(Y=90719)!(Y=90703)!(Y=90698)!(Y=90749)!(Y=90715)!(Y=90703) S ^TMP($J,"CPT",9999999-$P(ED,"."),Y)=""
 ...
 S C="20^50^106^107^110^1^22^102^115"
 ...
 .I Y=90700!(Y=90721)!(Y=90723)!(Y=90701)!(Y=90711)!(Y=90720)!(Y=90749)!(Y=90698)!(Y=90715) S BGPDTAP(D)=""
 D CNTDTAP  ;count to see if there are 4
...
EVIDTET ;
 ...
 I $$PLCODE^BGP6DU(P,"037.") S BGPEVTD=1
 D RESETD
...
EVIDPER ;
 ...
 I $$PLTAX^BGP6DU(P,"BGP PERTUSSIS EVIDENCE") S BGPEVPER=1
 D RESETD
...
EVIDDIP ;
 ...
 I $$PLTAX^BGP6DU(P,"BGP DIPHTHERIA EVIDENCE") S BGPEVDIP=1
 D RESETD
...
REF ;
 ...
 F BGPIMM=20,50,106,107,110,1,22,102,115  D
 ...
 F BGPIMM=20,50,106,107,110,1,22,102,115 Q:R  S R=$$IMMREF^BGP6D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ...
 ;now check refusals in imm pkg
 S R=""
 F BGPIMM=9 S R=$$IMMREF^BGP6D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
