...
I16 ;EP
 ...
 I BGPRTYPE'=3 S BGPVALUE=$S(BGPI8DA:"UP",1:"")_$S(BGPI8DB:";AC",1:"")_"|||"_$$DATE^BGP6UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
...
MAM(P,EDATE,YEARS) ;EP
 ...
 .S X=$$CPT^BGP6DU(P,$$FMADD^XLFDT(EDATE,-(2*365)),EDATE,T,3)
 S T="MAMMOGRAM SCREENING",T=$O(^BWPN("B",T,0))
 I T D  I X]"" Q "1^"_X_"^WH"
 .S X=$$WH^BGP6DU(P,$$FMADD^XLFDT(EDATE,-(2*365)),EDATE,T,3)
 ...
 I T D  I X]"" Q "1^"_X_"^WH"
 .S X=$$WH^BGP6DU(P,$$FMADD^XLFDT(EDATE,-(2*365)),EDATE,T,3)
 S T="" F BGPT=76091,76092,76090 D  Q:$P(T,U)=1
 .S C=+$$CODEN^ICPTCOD(BGPT) Q:C=""
 .S T=""
 .S T=$$REFUSAL^BGP6UTL1(P,71,$O(^RAMIS(71,"D",C,0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
