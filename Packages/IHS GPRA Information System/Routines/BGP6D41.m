...
I0302A ;EP
 ...
 I BGPACTCL,$$V2IHD^BGP6D9(DFN,BGP365,BGPEDATE),$$FIRSTIHD^BGP6D9(DFN,BGPEDATE) S BGPIHD=1,BGPD4=1
 I '(BGPD1+BGPD2+BGPD3+BGPD4) S BGPSTOP=1 Q
 S BGPBP=$$MEANBP(DFN,$$FMADD^XLFDT(BGPEDATE,-(2*365)),BGPEDATE)
 S BGPN1=$S($P(BGPBP,U,2):1,1:0)
 S BGPLDL=$$LDL^BGP6D2(DFN,$$FMADD^XLFDT(BGPEDATE,-(5*365)),BGPEDATE) ;date^value
 ...
 S %=$S($P(BGPLDL,U,2):"LDL: "_$$DATE^BGP6UTL($P(BGPLDL,U,2)),1:"")
 ...
 I %]"" S BGPVALUE=BGPVALUE_" "_%
 S %=$S($P(BGPLIFE,U):"LIFE: "_$$DATE^BGP6UTL($P(BGPLIFE,U,2))_":"_$P(BGPLIFE,U,3),1:"")
 I %]"" S BGPVALUE=BGPVALUE_" "_%
...
I0302 ;EP
 ...
 I BGPACTCL,$$V2IHD^BGP6D9(DFN,BGP365,BGPEDATE),$$FIRSTIHD^BGP6D9(DFN,BGPEDATE) S BGPIHD=1,BGPD3=1
...
DEP(P,BDATE,EDATE) ;EP
 S X=$$DEP^BGP6D21(P,BDATE,EDATE) I $P(X,U) Q X
 S X=$$DEPSCR^BGP6D21(P,BDATE,EDATE) I $P(X,U) Q X
 Q ""
LIFE(P,BDATE,EDATE) ;EP
 S X=$$MEDNUTR^BGP6D71(P,BDATE,EDATE) I X]"" Q 1_U_X
 S X=$$SPECNUTR^BGP6D71(P,BDATE,EDATE) I X]"" Q 1_U_X
 S X=$$SPECEX^BGP6D71(P,BDATE,EDATE) I X]"" Q 1_U_X
 S X=$$OTHREL^BGP6D71(P,BDATE,EDATE) I X]"" Q 1_U_X
 Q ""
