...
TEST ;
 S DFN=138866
 S BGPAGEB=16,BGPAGEE=17
 S BGP365=$$FMADD^XLFDT(3050901,-365)
 S BGPEDATE=3050901
 D I031
 W BGPVALE
 Q
I031 ;EP
 ...
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP6PDL1($J($P(BGPBMI,U),6,2)),1:"")_$S(BGPN2:" OW",1:"")_$S(BGPN3:" OB",1:"")
...
I031A ;
 ...
 I $P(BGPBMI,U)]"" S BGPVALUE=BGPVALUE_"|||"_$P(BGPBMI,U)_":"_$$DATE^BGP6UTL($P(BGPBMI,U,2))_" Age at BMI: "_A
