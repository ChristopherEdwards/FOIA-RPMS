...
IC1 ;EP
 ...
 S BGPVALUE=$$DATE^BGP6UTL($P(BGPMN,U))_" "_$P(BGPMN,U,2)_$S(BGPMN]"":";",1:"")
 S BGPVALUE=BGPVALUE_$$DATE^BGP6UTL($P(BGPSN,U))_" "_$P(BGPSN,U,2)_$S(BGPSN]"":";",1:"")
 S BGPVALUE=BGPVALUE_$$DATE^BGP6UTL($P(BGPSPEX,U))_" "_$P(BGPSPEX,U,2)_$S(BGPSPEX]"":";",1:"")
 S BGPVALUE=BGPVALUE_$$DATE^BGP6UTL($P(BGPOTH,U))_" "_$P(BGPOTH,U,2)
...
I19 ;EP
 ...
 S BGPVALUE=BGPVALUE_"|||"_$S($P(BGPTC,U):"PT ED: "_$$DATE^BGP6UTL($P(BGPTC,U))_" "_$P(BGPTC,U,2),1:"")
 I BGPN2,BGPRTYPE'=3 S BGPVALUE=BGPVALUE_";QUIT: "_$P(BGPTOB,U)_" "_$P(BGPTOB,U,2)_$S(+BGPSDX="305.13":" DX: 305.13"_$$DATE^BGP6UTL($P(BGPSDX,U,2)),1:"")
...
MEDNUTR(P,BDATE,EDATE) ;EP
 K ^TMP($J),BGPG,BGPC
 S E=+$$CODEN^ICPTCOD(97802),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802 MN"
 S E=+$$CODEN^ICPTCOD(97803),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)-"^97803 MN"
 S E=+$$CODEN^ICPTCOD(97804),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804 MN"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270 MN"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271 MN"
