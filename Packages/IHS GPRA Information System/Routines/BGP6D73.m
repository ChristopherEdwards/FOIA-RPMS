BGP6D73 ; IHS/CMI/LAB - measure 31 ;
...
CHEL ;EP - called from elder care
 ...
 I BGPVALUE]"" S V=V_"CHOL: "_$$DATE^BGP6UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 I $P(BGPLDL,U) S V=V_$S(BGPVALUE]"":"; ",1:"") S V=V_"LDL: "_$$DATE^BGP6UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
 S BGPVALUE=V
...
CHOL(P,BDATE,EDATE,NORES) ;EP
 ...
 S E=+$$CODEN^ICPTCOD(82465),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q 1_U_$P(%,U,2)_"^CPT 82465"
 S E=+$$CODEN^ICPTCOD(82465),%=$$TRANI^BGP6DU(P,BDATE,EDATE,E) I %]"" Q 1_U_$P(%,U,2)_"^TRAN 82465"
 Q ""
 ;
LOINC(A,B) ;
 NEW %
