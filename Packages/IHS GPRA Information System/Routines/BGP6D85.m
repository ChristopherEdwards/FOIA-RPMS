BGP6D85 ; IHS/CMI/LAB - measure C 09 Jun 2016 5:18 PM ;
...
I28 ;EP
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$TDAP^BGP6D86(DFN,BGPEDATE)
 ...
 ;S BGPVAL=$$MMR^BGP6D811(DFN,BGPEDATE)
 ...
 ;I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$MEN^BGP6D36(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$HPV^BGP6D36(DFN,BGPEDATE)
 ...
 K BGPTET,BGPDTAP,BGPDT,BGPTD,BGPPER,BGPDIP,BGPMU,BGPME,BGPMMR,BGPMR,BGPRM,BGPOPV,BGPRUB,BGPHIB,BGPHEB,BGPVAR,BGPI1,BGPI2,BGPI3,BGPI4,BGPI5,BGPI6,BGPVAL,BGP6ADOL
 Q
