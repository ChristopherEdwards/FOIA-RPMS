BGP6D86 ; IHS/CMI/LAB - measure C 06 Nov 2009 2:26 PM ;
...
IRAR ;EP
 ...
 .I BGPCBC,BGPLFT,BGPCREAT S BGPIRZ("A")=1 ;,BGPIRV("A")=BGPIRV("A")_$$DATE^BGP6UTL($P(BGPCREAT,U,2))_" CREAT, "_$$DATE^BGP6UTL($P(BGPCBC,U,2))_" CBC, "_$$DATE^BGP6UTL($P(BGPLFT,U,2))_" LFT"  ;NA MEDS AND HAS CBC,LFT
 .I BGPCREAT S BGPIRV("A")=BGPIRV("A")_$$DATE^BGP6UTL($P(BGPCREAT,U,2))_" CREAT"
 .I BGPCBC S BGPIRV("A")=BGPIRV("A")_$S(BGPIRV("A")]"":", ",1:"") S BGPIRV("A")=BGPIRV("A")_$$DATE^BGP6UTL($P(BGPCBC,U,2))_" CBC"
 .I BGPLFT S BGPIRV("A")=BGPIRV("A")_$S(BGPIRV("A")]"":", ",1:"") S BGPIRV("A")=BGPIRV("A")_$$DATE^BGP6UTL($P(BGPLFT,U,2))_" LFT"
 I $P(BGPV,U,3) D
 .S BGPGOLD=$$GOLDLAB^BGP6D864(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,12) D
 .S BGPGLU=$$GLUCOSE^BGP6D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPIRZ("K")=0,BGPIRV("K")="Glucocorticoids: "
 .I BGPGLU S BGPIRZ("K")=1,BGPIRV("K")=BGPIRV("K")_$$DATE^BGP6UTL($P(BGPGLU,U,2))_" Glucose"
...
TDAP(P,EDATE) ;EP
 ...
 ;F BGPIMM=115 S R=$$IMMREF^BGP6D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
