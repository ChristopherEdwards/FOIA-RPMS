BGP6D88 ; IHS/CMI/LAB - measure C 03 Jul 2010 7:05 AM ;
...
HIV1 ;EP
 ...
 Q:$$HIVDX^BGP6D8(DFN,BGPEDATE)  ;has HIV so quit
 Q:'$$PREG^BGP6D7(DFN,$$FMADD^XLFDT(BGPEDATE,-609),BGPEDATE,1)  ;not pregnant
 S BGPD1=1
...
HIVTEST(P,BDATE,EDATE) ;
 ...
 ...I BGPLT,$P(^AUPNVLAB(X,0),U),$D(^ATXLAB(BGPLT,21,"B",$P(^AUPNVLAB(X,0),U))) S BGPC=BGPC+1,BGPC(BGPC)=1_U_$$DATE^BGP6UTL((9999999-D))_" Lab"_U_$P(^AUPNVLAB(X,0),U,4)_U_D,BGPA((9999999-D))="" Q
 ...Q:'T
...
MA ;now check for abortion or miscarriage
 ...
 S BGPG=$$LASTPRC^BGP6UTL1(P,"BGP ABORTION PROCEDURES",BDATE,EDATE)
 I BGPG Q 0
