BGP6DAR ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 09 Apr 2016 10:03 AM 17 Nov 2014 10:36 AM ; 
...
EISSEX ;
 ...
 I BGPEXCEL=1 D
 .S BGPNOW=$$NOW^XLFDT() S BGPNOW=$$NOW^XLFDT() S BGPNOW=$P(BGPNOW,".")_"."_$$RZERO^BGP6UTL($P(BGPNOW,".",2),6)
 ...
 .S BGPFGNT1="CRSGPRANT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFGNT2="CRSGPRANT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFDEV1="CRSGPRADEVNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFDEV2="CRSGPRADEVNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFDEV3="CRSGPRADEVNT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFDEV4="CRSGPRADEVNT4"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFGNT3="CRSGPRANT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .S BGPFGNT4="CRSGPRANT4"_$P(^AUTTLOC(DUZ(2),0),U,10)_2016063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BGPC,6)_".TXT"
 .Q
...
DRIVER ;
 U IO
 D PRINT^BGP6PARP
 I BGPRPTT="A",BGPIFTR=1,BGPEXCEL D GNT1^BGP6UTL
 D ^%ZISC
 D EXIT
 Q
 ;
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP6DAR",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
EXIT ;
 D ^%ZISC
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP6DAR",XBRX="EXIT^BGP6DAR",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
