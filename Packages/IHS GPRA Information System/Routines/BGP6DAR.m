BGP6DAR ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM ;
...
ASU ;
 ...
 ;I C=1 S BGPRPTT="F",BGPSUCNT=1,Y=$O(BGPSUL(0)),X=$P(^BGPGPDCS(Y,0),U,9),X=$O(^AUTTLOC("C",X,0)) I X S BGPSUNM=$P(^DIC(4,X,0),U)
ZIS ;call to XBDBQUE
EISSEX ;
 S BGPEXCEL=1
 S BGPUF=""
 ...
 .S BGPFN="CRSNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2006063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BDWC,6)_".TXT"
 .S BGPFN2="CRSNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2006063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BDWC,6)_".TXT"
 .S BGPFNEIS="GPRANT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2006063000000000_$$D^BGP6UTL(BGPNOW)_"_"_$$LZERO^BGP6UTL(BDWC,6)_".TXT"
 .Q
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP6DAR",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D EXIT Q
 Q
 ;
EXIT ;
 D EN^XBVK("BGP")
