...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIM(BGPIC,1)) X ^BGPELIM(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIM("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIM(BGPI,1)
 ..X ^BGPELIIM(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIM(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90557.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIM(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90557.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
