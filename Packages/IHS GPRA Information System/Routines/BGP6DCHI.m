BGP6DCHI ; IHS/CMI/LAB - calculate HEDIS measures ;
...
CALCIND ;EP
 ...
 .I $D(^BGPHEIS(BGPIC,1)) X ^BGPHEIS(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPHEIIS("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPHEIIS(BGPI,1)
 ..X ^BGPHEIIS(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPHEIIS(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90375.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPHEIIS(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90375.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..I BGPDEN'="NO" D S(BGPRPT,BGPGBL,N,P,BGPDEN)
 .I $D(BGPLIST(BGPIC)) D STMP^BGP6HUTL
 Q
 ;
S(R,G,N,P,V) ;
