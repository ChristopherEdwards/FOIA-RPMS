BGP6DGPA ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP6DGPA",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D EXIT Q
 Q
 ;
FAC(S) ;
...
DISP ;
 ...
 W !,BGPC,?4,$$DATE^BGP6UTL($P(BGP0,U,1)),?13,$$DATE^BGP6UTL($P(BGP0,U,2)),?22,$$DATE^BGP6UTL($P(BGP0,U,5)),?32,$$DATE^BGP6UTL($P(BGP0,U,6)),?42,$E($$SU($P(BGP0,U,11)),1,15),?59,$E($$FAC($P(BGP0,U,9)),1,20)
 Q
