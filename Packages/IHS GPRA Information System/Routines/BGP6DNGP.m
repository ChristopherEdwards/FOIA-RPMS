BGP6DNGP ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2016 National GPRA/GPRAMA Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
ZIS ;call to XBDBQUE
 ...
 ..W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDPM(" D ^DIK K DIK
 ..W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDBM(" D ^DIK K DIK
 I $D(IO("Q")) G TSKMN
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP6DNGP",XBRX="XIT^BGP6DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP6DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA/GPRAMA REPORT 11 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
