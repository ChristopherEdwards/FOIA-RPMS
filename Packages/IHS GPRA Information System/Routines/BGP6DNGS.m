BGP6DNGS ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2016 National GPRA/GPRAMA Report Clinical Performance Summaries",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP6DNGS",XBRX="XIT^BGP6DNGS",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP6DNGS",ZTDTH="",ZTDESC="NATIONAL GPRA/GPRAMA REPORT 11 SUM ONLY" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
