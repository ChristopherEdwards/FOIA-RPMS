...
I1AGE ;EP  special age tallies
 ...
 D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPINDS(BGPIC,53,1,0)  D H4^BGP6DPH
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF="H.BA."_BGPX S BGPPC=$O(^BGPINDSC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="H.BA."_(BGPX+3) S BGPPC=$O(^BGPINDSC("C",BGPF,0))
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPINDS(BGPIC,53,1,0) D H4^BGP6DPH
