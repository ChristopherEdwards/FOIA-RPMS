BGP6DP1M ; IHS/CMI/LAB - print ind 1 12 Nov 2010 7:38 AM ; 04 Feb 2016  2:34 PM
...
I1AGE1 ;
 ...
 Q
AGES ;
 S BGPF="MTA.B."_BGPXX_BGPZ S BGPPC=$O(^BGPINDMC("C",BGPF,0))
 D
...
I1AGEP ;
 ...
 ;I '$G(BGPSUMON),BGPPTYPE="P" D HEADER^BGP6DPH Q:BGPQUIT  D W^BGP6DP(^BGPINDM(BGPIC,53,1,0),0,1,BGPPTYPE) D:$D(^BGPINDM(BGPIC,53,2,0)) W^BGP6DP(^BGPINDM(BGPIC,53,2,0),0,1,BGPPTYPE) D AH
 I '$G(BGPSUMON),BGPPTYPE="P" D W^BGP6DP(" ",0,2,BGPPTYPE)
 I BGPPTYPE'="P" D W^BGP6DP("",0,2,BGPPTYPE) D AH
...
I1AGEP1 ;
 ...
 .I BGPPTYPE="P" D W^BGP6DP("# w/ 2+ Inhaled",0,1,BGPPTYPE) S L=" Steroid Rx",P=5 D PBY
...
AH ;EP
 Q:$G(BGPSUMON)
 I BGPPTYPE="D" D W^BGP6DP(BGPHD1,1,2,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP6DP(BGPHD2,1,2,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP6DP(BGPHD3,1,1,BGPPTYPE)
