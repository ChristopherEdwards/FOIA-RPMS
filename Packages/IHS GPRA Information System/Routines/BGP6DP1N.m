BGP6DP1N ; IHS/CMI/LAB - print ind 1 12 Nov 2010 7:38 AM ;
...
I1AGE1 ;
 ...
 Q
AGES ;
 S BGPF="MTA.C."_BGPXX_BGPZ S BGPPC=$O(^BGPINDMC("C",BGPF,0))
 D
...
I1AGEP1 ;
 ...
 I BGPPTYPE="D" D W^BGP6DP("# w/o 2+ Inhaled Steroid Rx",0,2,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP6DP("# w/o 2+ Inhaled",0,2,BGPPTYPE),W^BGP6DP(" Steroid Rx",0,1,BGPPTYPE)
 S T=31 F X=1:1:4 S V=$P(@BGPARR@(X),U,2) D W^BGP6DP($S(BGPPTYPE="P":$$C(V,0,6),1:$S(V:V,1:0)),0,0,BGPPTYPE,X+1,T) S T=T+11
 I BGPPTYPE="D" D W^BGP6DP("% w/o 2+ Inhaled Steroid Rx",0,1,BGPPTYPE)
 I BGPPTYPE="P" D W^BGP6DP("% w/o 2+ Inhaled",0,1,BGPPTYPE),W^BGP6DP(" Steroid Rx",0,1,BGPPTYPE)
 ...
 .I BGPPTYPE="P" D W^BGP6DP("# w/o 2+ Inhaled",0,1,BGPPTYPE) S L=" Steroid Rx",P=3 D PBY
