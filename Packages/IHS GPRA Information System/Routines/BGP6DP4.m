BGP6DP4 ; IHS/CMI/LAB - print ind 31 ;
...
I031 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.7.3D",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.8.3D",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.9.3D",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.7.3E",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.8.3E",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.9.3E",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.7.3F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.8.3F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.9.3F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.7.3G",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.8.3G",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.9.3G",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.7.3H",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.8.3H",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","27.9.3H",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 F BGPPC1="27.1","27.2","27.3" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 I BGPRTYPE=4 W !
 F BGPPC1="27.4","27.5","27.6" Q:BGPQUIT  D PI^BGP6DP1C
 D I1AGE
 Q:BGPQUIT
 Q
I1AGE ;EP special age tallies
 ...
 D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPINDS(BGPIC,53,1,0)  D H3
