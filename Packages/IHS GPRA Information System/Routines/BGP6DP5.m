...
I023 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.8.1E",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.8.3E",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.9.1E",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.9.3E",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.10.1E",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.10.3E",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.8.1F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.8.3F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.9.1F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.9.3F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.10.1F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.10.3F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 I BGPRTYPE=4,BGPINDT="E" D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.8.1F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.8.2F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.8.3F",0)) D PI1^BGP6DP1C
 .S BGPPC=$O(^BGPINDSC("OR","21.8.4F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.8.5F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.9.1F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.9.2F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.9.3F",0)) D PI1^BGP6DP1C
 .S BGPPC=$O(^BGPINDSC("OR","21.9.4F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.9.5F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDSC("OR","21.10.1F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.10.2F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.10.3F",0)) D PI1^BGP6DP1C
 .S BGPPC=$O(^BGPINDSC("OR","21.10.4F",0)) D PI1^BGP6DP1C S BGPPC=$O(^BGPINDSC("OR","21.10.5F",0)) D PI1^BGP6DP1C
 .Q:BGPQUIT
 F BGPPC1="21.1","21.2","21.3" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 ;I BGPRTYPE=4 D HEADER^BGP6DPH
 F BGPPC1="21.4" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 I BGPRTYPE=4 D HEADER^BGP6DPH W !,^BGPINDS(BGPIC,53,1,0)
 I BGPRTYPE'=1 D H1^BGP6DPH
 F BGPPC1="21.5","21.6" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 I BGPRTYPE=4 D HEADER^BGP6DPH W !,^BGPINDS(BGPIC,53,1,0)
 I BGPRTYPE'=1 D H1^BGP6DPH
 F BGPPC1="21.7" Q:BGPQUIT  D PI^BGP6DP1C
 D I1AGE
 Q
