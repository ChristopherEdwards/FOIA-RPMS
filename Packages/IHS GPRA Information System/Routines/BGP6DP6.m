BGP6DP6 ; IHS/CMI/LAB - print ind H ;
 ...
 ;
IC1 ;EP
 I $Y>(BGPIOSL-16) D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPINDS(BGPIC,53,1,0)
 D H1^BGP6DPH
 F BGPPC1="29.1","29.2","29.3" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 D HEADER^BGP6DPH
 F BGPPC1="29.7","29.8","29.9" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 D HEADER^BGP6DPH
 F BGPPC1="29.13","29.14","29.15" Q:BGPQUIT  D PI^BGP6DP1C
 Q:BGPQUIT
 D I1AGE
 Q
