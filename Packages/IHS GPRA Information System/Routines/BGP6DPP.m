BGP6DPP ; IHS/CMI/LAB - IHS GPRA 16 SELECTED REPORT DRIVER ALL PATIENTS 29 Apr 2016 8:36 PM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("2016 Clinical Performance Measure Report (Selected Measures)",80)
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP6DPP",ZTDTH="",ZTDESC="GPRA 16 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
