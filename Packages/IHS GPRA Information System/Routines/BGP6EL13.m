BGP6EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS 55+",BGPHD2="Active Diabetic Patients"
 D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPELIM(BGPIC,53,1,0)  D H3^BGP6EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPELIM(BGPIC,53,1,0) D H3^BGP6EL12
