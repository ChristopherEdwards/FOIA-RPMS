BGP6EL1P ; IHS/CMI/LAB - print ind 01 Jul 2010 7:55 PM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
I1AGE ;EP
 S BGPHD1="ACTIVE CLINICAL PTS 65+",BGPHD2="Active Clinical Pts 65+"
 D HEADER^BGP6DPH
 W !,^BGPELIM(BGPIC,53,1,0)
 S X=" " D S(X,1,1)
 D H3 S X=" " D S(X,1,1)
 ...
 D HEADER^BGP6DPH W !,^BGPELIM(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 K BGPDAC,BGPDAP,BGPDAB
...
S(Y,F,P) ;set up array
 ;Q:BGPQUIT
 ;I $Y>(IOSL-5) D HEADER^BGP6DPH Q:BGPQUIT
 ;W !,^BGPELIM(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 I $G(F) F J=1:1:F W !
