BGP6EL1T ; IHS/CMI/LAB - print ind 1 ;
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPELIM(BGPIC,53,1,0) D H3
...
BL ;
 I $Y>(BGPIOSL-18) D HEADER^BGP6DPH Q:BGPQUIT  W !,^BGPELIM(BGPIC,53,1,0) D H3
