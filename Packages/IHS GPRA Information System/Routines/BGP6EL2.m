BGP6EL2 ; IHS/CMI/LAB - measure 1,2,3,4 17 Jan 2010 6:49 AM ;
...
I1 ;EP - measure 1 general processing
 ...
 S BGPVALUE="UP|||"_$$DATE^BGP6UTL($P(BGPG(1),U))_" "_$P(BGPG(1),U,2)
 Q
 ;
I2 ;EP
...
STAT ;EP
 ...
 S BGPEXL1=$$STATALG^BGP6D212(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,BGPBDATE,BGPEDATE) I BGPEXL1 S BGPSTOP=1 Q  ;excl 1
 ;ALCOHOL HEP
 S BGPEXL1=$$ALCHEP^BGP6D212(DFN,BGPBDATE,BGPEDATE) I BGPEXL1 S BGPSTOP=1 Q
 ;NMI
 S BGPEXL1=$$STATNMI^BGP6D212(DFN,BGPBDATE,BGPEDATE) I BGPEXL1 S BGPSTOP=1 Q
 ;PREGNANCY
 S BGPEXL2=$$PREG^BGP6D7(DFN,BGPBDATE,BGPEDATE,1,1,1) I BGPEXL2 S BGPSTOP=1 Q
 ;BREASTFEEDING
 S BGPEXL2=$$BF^BGP6D21(DFN,BGPBDATE,BGPEDATE) I BGPEXL2 S BGPSTOP=1 Q
 ;cirrhosis of liver
 S BGPEXL6=$$CLIVER^BGP6D213(DFN,BGPPBD,BGPEDATE) I BGPEXL6 S BGPSTOP=1 Q
 ;PALLIATIVE
 S BGPEXL3=$$LASTDX^BGP6UTL1(DFN,"BGP PALLIATIVE CARE DXS",BGPBDATE,BGPEDATE) I BGPEXL3 S BGPSTOP=1 Q
 ;ESRD
 S BGPEXL4=$$ESRD^BGP6D211(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPEXL4 S BGPSTOP=1 Q  ;excl 4 ESRD
 ;EXCL 5
 NEW BGPSTAT
 S BGPSTAT=$$STATIN^BGP6D214(DFN,BGPBDATE,BGPEDATE,0)
 S BGPEXL5=$$LASTLDLV^BGP6D212(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPEXL5,'$P(BGPCVDL,U,3),'BGPSTAT S BGPSTOP=1 Q   ;excl 5
 I BGPAGEB>75 S BGPCVDL=$$CHDLDL^BGP6D212(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)  ;CHD OR LDL^CHD^LDL
...
LDL(P,BDATE,EDATE) ;EP
 K BGPG,BGPT,BGPC
 S BGPC=0
 S %="",E=+$$CODEN^ICPTCOD(83721),%=$$CPTI^BGP6DU(P,BDATE,EDATE,E)
 I %]"" S BGPC=BGPC+1,BGPT(9999999-$P(%,U,2),BGPC)=""
 S %="",E=+$$CODEN^ICPTCOD(83721),%=$$TRANI^BGP6DU(P,BDATE,EDATE,E)
 I %]"" S BGPC=BGPC+1,BGPT(9999999-$P(%,U,2),BGPC)=""
 ;now get all loinc/taxonomy tests
