BGP6EL2 ; IHS/CMI/LAB - measure 1,2,3,4 17 Jan 2006 6:49 AM ;
...
I2 ;EP
 ...
 S BGPVALUE="AD"_"||| "_$$DATE^BGP6UTL($P(BGPLHGB,U,3))_" "_$P(BGPLHGB,U,4)
...
I4 ;EP
 ...
 S BGPVALUE="AD"_"|||"
 I $P(BGPLP,U) S BGPVALUE=BGPVALUE_$S($P(BGPLP,U):"LP: "_$$DATE^BGP6UTL($P(BGPLP,U,2))_" "_$P(BGPLP,U,3),1:"")
 I '$P(BGPLP,U),BGPTRI,BGPHDL,BGPLDL S BGPVALUE=BGPVALUE_"TRI:"_$$DATE^BGP6UTL($P(BGPTRI,U,2))_" HDL:"_$$DATE^BGP6UTL($P(BGPHDL,U,2))_" LDL:"_$$DATE^BGP6UTL($P(BGPLDL,U,2))
 I $P(BGPVALUE,"|||",2)]"" S BGPVALUE=BGPVALUE_" ; "
 I BGPLDL]"" S BGPVALUE=BGPVALUE_"LDL DONE: "_$$DATE^BGP6UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
...
I5 ;EP
 ...
 S BGPVALUE="AD"_"|||"_$$DATE^BGP6UTL($P(BGPUP,U,4))_" "_$P(BGPUP,U,2)_" "_$P(BGPUP,U,3)_"  "_$S(BGPGFR:"GFR",1:"")
...
I6 ;EP
 ...
 S BGPVALUE="AD"_"|||"_$$DATE^BGP6UTL($P(BGPEYE,U,2))_" "_$P(BGPEYE,U,3)
 K ^TMP($J,"A")
 K BGPUP,BGPGFR,BGPX,BGPY,BGPC,BGPG
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F
 Q
