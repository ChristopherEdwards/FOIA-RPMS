BGP6EL3 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2006 1:44 PM ;
...
I9 ;EP
 ...
 S BGPVALUE=$$FLU^BGP6D3(DFN,BGPEDATE) ;set to date of flu shot
...
I10 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$PNEU^BGP6D31(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
 S BGPN1=0 I BGPVALUE]"" S BGPN1=1
 S BGPN2=0 I BGPVALUE["Refus" S BGPN2=1
 S BGPVALUE="AC"_"|||"_BGPVALUE
...
I11 ;EP
 ...
 I $$MAS^BGP6D4(DFN,BGPEDATE) S BGPSTOP=1 Q
 S BGPD1=1
 I BGPAGEB>54,BGPAGEB<65 S BGPD2=1
 I BGPAGEB>64,BGPAGEB<75 S BGPD3=1
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPMAM=$$MAM^BGP6D4(DFN,BGPEDATE,2)
 S BGPN1=0 I $P(BGPMAM,U)=1 S BGPN1=1
 S BGPN2=0 I $P(BGPMAM,U,3)="ref" S BGPN2=1
 S BGPVALUE="AC"_"|||"_$$DATE^BGP6UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,J,K,G,I,L,T,BGPLHGB
...
I12 ;EP
 ...
 I BGPAGEB<55 S BGPSTOP=1 Q
 I 'BGPACTCL S BGPSTOP=1 Q
 I $$CRC^BGP6D61(DFN,BGPEDATE) S BGPSTOP=1 Q  ;has colorectal cancer
 S BGPD1=1
 I BGPAGEB>54,BGPAGEB<65 S BGPD2=1
 I BGPAGEB>64,BGPAGEB<75 S BGPD3=1
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPFOB=$$FOB^BGP6D61(DFN,BGPBDATE,BGPEDATE)
 S BGPRECT=$$RECT^BGP6D61(DFN,BGPEDATE)
 I BGPFOB]"" S BGPN3=1,BGPN1=1
 I BGPRECT]"" S BGPN4=1
 S BGPOTH=""
 I BGPN1=0 S BGPOTH=$$IBH^BGP6D61(DFN,BGPEDATE)
 I BGPOTH]"" S BGPN1=1
 S BGPREF="" I 'BGPN1 S BGPREF=$$REF^BGP6D61(DFN,$$FMADD^XLFDT(BGPEDATE,-365),BGPEDATE) I BGPREF S BGPN1=1,BGPN2=1
 S BGPVALUE=""
 ...
 I BGPREF]"" S BGPVALUE=BGPVALUE_$P(BGPREF,U,3)_":"_$$DATE^BGP6UTL($P(BGPREF,U,2))
 S BGPDV="AC"
...
I13 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPTOB=$$TOBACCO^BGP6D7(DFN,BGP365,BGPEDATE)
 S BGPN1=$S(BGPTOB]"":1,1:0)
 S BGPSDX=$$DX^BGP6D7(DFN,BGP365,BGPEDATE)
 S BGPXPED=$$PED^BGP6D7(DFN,BGP365,BGPEDATE)
 S BGP1320=$$DENT^BGP6D7(DFN,BGP365,BGPEDATE)
 I BGPSDX]"" S BGPN1=1
 I BGPXPED]"" S BGPN1=1
 I BGP1320]"" S BGPN1=1
 S F=$P(BGPTOB,U)
 ...
 I BGP1320]"" S S=S_" 1320 ADA "_$$DATE^BGP6UTL($P(BGP1320,U,2))
 I BGPSDX]"" S S=S_" DX "_$S($P(BGPSDX,U,1)="305.13":"quit",1:"Cur smk")_" "_$$DATE^BGP6UTL($P(BGPSDX,U,2))
 I BGPXPED]"" S S=S_" PtEd "_$P(BGPXPED,U)_" "_$$DATE^BGP6UTL($P(BGPXPED,U,2))
 S BGPVALUE=V_" "_S
...
I14 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPDVEX=$$DVEX^BGP6D5(DFN,BGP365,BGPEDATE) I $P(BGPDVEX,U)=1 S BGPN2=1
 S BGPDVDX=$$DVDX^BGP6D5(DFN,BGP365,BGPEDATE) I $P(BGPDVDX,U)=1 S BGPN3=1
 S BGPDVPED=$$DVPED^BGP6D5(DFN,BGP365,BGPEDATE) I $P(BGPDVPED,U)=1 S BGPN4=1
 I BGPN2 S BGPN1=1
 I BGPN3 S BGPN1=1
 I BGPN4 S BGPN1=1
 I 'BGPN1 S BGPDVREF=$$REFDV^BGP6D5(DFN,BGP365,BGPEDATE) I $P(BGPDVREF,U)=1 S BGPN5=1
 I BGPN5 S BGPN1=1
 S BGPVALUE="AC|||"
 I $P(BGPDVEX,U)=1 S BGPVALUE=BGPVALUE_$P(BGPDVEX,U,3)_" "_$$DATE^BGP6UTL($P(BGPDVEX,U,2))
 I $P(BGPDVDX,U)=1 S BGPVALUE=BGPVALUE_$P(BGPDVDX,U,3)_" "_$$DATE^BGP6UTL($P(BGPDVDX,U,2))
 I $P(BGPDVPED,U)=1 S BGPVALUE=BGPVALUE_$P(BGPDVPED,U,3)_" "_$$DATE^BGP6UTL($P(BGPDVPED,U,2))
 I $P(BGPDVREF,U)=1 S BGPVALUE=BGPVALUE_$P(BGPDVREF,U,3)_" "_$$DATE^BGP6UTL($P(BGPDVREF,U,2))
...
I15 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPN3=0 S BGPDEP=$$DEP^BGP6D21(DFN,BGP365,BGPEDATE) I $P(BGPDEP,U)=1 S BGPN3=1
 S BGPN2=0 S BGPDEPS=$$DEPSCR^BGP6D21(DFN,BGP365,BGPEDATE) I $P(BGPDEPS,U)=1 S BGPN2=1
 S BGPN5=0 S BGPDEDU=$$DEPEDU^BGP6D21(DFN,BGP365,BGPEDATE) I $P(BGPDEDU,U)=1 S BGPN5=1
 I BGPN2 S BGPN1=1
 I BGPN3 S BGPN1=1
 S BGPREF=""
 S BGPN4=0 I 'BGPN1 S BGPREF=$$DEPREF^BGP6D21(DFN,BGP365,BGPEDATE) I $P(BGPREF,U)=1 S BGPN4=1
 I BGPN4 S BGPN1=1
 S BGPVALUE=""
...
I16 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPBMI=$$BMI^BGP6D6(DFN,BGPEDATE,BGPAGEE),BGPN1=$S(BGPBMI]"":1,1:0)
 S BGPN2=$$OW^BGP6D6(DFN,BGPBMI,BGPAGEE)
 S BGPN3=$$OB^BGP6D6(DFN,BGPBMI,BGPAGEE)
 I BGPN2!(BGPN3) S BGPN4=1
 I 'BGPN1 S BGPREF=$$REF^BGP6D6(DFN,BGP365,BGPEDATE,BGPAGEB) I $P(BGPREF,U)=1 S BGPN5=1
 I BGPN5 S BGPN1=1
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP6PDL1($J($P(BGPBMI,U),6,2)),1:"")_" "_$S(BGPN2:"OW",1:"")_" "_$S(BGPN3:"OB",1:"")
 I BGPN5 S BGPVALUE=BGPVALUE_"ref "_$P(BGPREF,U,2)_" "_$$DATE^BGP6UTL($P(BGPREF,U,3))_" "_$P(BGPREF,U,5)_" "_$$DATE^BGP6UTL($P(BGPREF,U,6))
...
IELDFSA ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$FUNCTION^BGP6EL4(DFN,BGPBDATE,BGPEDATE)
...
IELDASA ;EP
 ...
 I BGPAGEB>84 S BGPD5=1
 S BGPHOSPL=""
 S BGPN1=$$V2ASTH^BGP6D31(DFN,BGP365,BGPEDATE)
 I BGPN1 S BGPHOSPL=$$HOSP^BGP6D31(DFN,BGP365,BGPEDATE) I BGPHOSPL S BGPN2=1
 S BGPVALUE="AC"_"|||"_$S(BGPN1:$$LAST^BGP6D31(DFN,BGP365,BGPEDATE),1:"")_" "_$S(BGPHOSPL:"H "_$$DATE^BGP6UTL($P(BGPHOSPL,U,2)),1:"")
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,T,BGPG
 Q
IELDPHA ;EP - PHN
 S (BGPD1,BGPD2,BGPD3,BGPD4,BGPD5)=0
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$PHNV^BGP6EL4(DFN,BGP365,BGPEDATE,BGPHOME)
 S BGPN1=BGPVALUE
...
IRAO ;EP
 ...
 S BGPPAP=$$OSTEOSCR^BGP6D42(DFN,$$FMADD^XLFDT(BGPBDATE,-(365*2)),BGPEDATE)
 I BGPPAP S BGPN1=1
 I $P(BGPPAP,U)=3 S BGPN2=1
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$P(BGPPAP,U,2)_" "_$$DATE^BGP6UTL($P(BGPPAP,U,3))_$S($P(BGPPAP,U,1)=3:" (refused)",1:"")
 K BGPPAP,X
 Q
 ;
IRAA ;EP
...
FRACTURE(P,BDATE,EDATE) ;EP
 ...
 ;
 K BGPG S Y="BGPG("
 S BGPG=$$FIRSTPRC^BGP6UTL1(P,"BGP FRACTURE PROCEDURES",BDATE,EDATE)
 I $P(BGPG,U)=1 D
 .S D=$P(BGPG,U,3)
 ...
 ;n
 ;
 S BGPX=$$TXBMD^BGP6EL4(P,$$FMADD^XLFDT(BGPISD,-365),$$FMADD^XLFDT(BGPISD,-1)) I $P(BGPX,U) S $P(BGPV(BGPISD,BGPISV),U,5)=$P(BGPX,U,2) Q ""
...
FRACT(P,FBD,FED) ;
 ...
 I BGPG Q 1
 ;
 S BGPG=$$FIRSTPRC^BGP6UTL1(P,"BGP FRACTURE PROCEDURES",FBD,FED)
 I $P(BGPG,U)=1 Q 1
 Q ""
