BGP6EL3 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2010 1:44 PM 20 Mar 2016 7:52 AM ; 
...
I9 ;EP
 ...
 S BGPVALUE="AC"_"|||"_$$DATE^BGP6UTL($P(BGPVALUE,U,1))_" "_$P(BGPVALUE,U,2)
...
I12 ;EP
 ...
 I BGPAGEB<55 S BGPSTOP=1 Q
 I 'BGPACTCL S BGPSTOP=1 Q
 I $$CRC^BGP6D62(DFN,BGPEDATE) S BGPSTOP=1 Q  ;has colorectal cancer
 S BGPD1=1
 I BGPAGEB>54,BGPAGEB<65 S BGPD2=1
 I BGPAGEB>64,BGPAGEB<75 S BGPD3=1
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
...
IRAO ;EP
 ...
 S BGPPAP=$$OSTEOSCR^BGP6D42(DFN,B,BGPEDATE)
 I BGPPAP S BGPN1=1
 ;I 'BGPN1 S BGPPAP=$$OSTEOREF^BGP6D42(DFN,BGPBDATE,BGPEDATE) I BGPPAP S BGPN2=1  ;Refusal
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$$DATE^BGP6UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3) ;$P(BGPPAP,U,2)_" "_$$DATE^BGP6UTL($P(BGPPAP,U,3))_$S($P(BGPPAP,U,1)=3:" (Refused)",1:"")
 K BGPPAP,X
 Q
 ;
IRAA ;EP
...
FRACTURE(P,BDATE,EDATE) ;EP
 ...
 ;n
 ;
 S BGPX=$$TXBMD^BGP6EL4(P,$$FMADD^XLFDT(BGPISD,-720),$$FMADD^XLFDT(BGPISD,-1)) I $P(BGPX,U) S $P(BGPV(BGPISD,BGPISV),U,5)=$P(BGPX,U,2) Q ""
