BGP6ELL8 ; IHS/CMI/LAB - print ind ;
...
I1AGEP ;
 ...
 S X="# w/dental visit in past yr" D S(X,1,1)
...
CALC(N,O) ;
 ...
 Q Z
H3 ;EP
 S X="Diabetes: Access to Dental Services" D S(X,1,1) S Y=" " D S(Y,1,1) S X=BGPHD1 D S(X,1,1) S Y=" " D S(Y,1,1)
