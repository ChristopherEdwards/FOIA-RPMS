BGP6ELLB ; IHS/CMI/LAB - print ind ;
...
I1AGEP ;
 ...
 S X="# w/Pneumovax documented (GPRA)" D S(X,1,1)
...
CALC(N,O) ;
 ...
 Q Z
H3 ;EP
 S X="Adult Immunizations: Pneumovax" D S(X,1,1) S Y=" " D S(Y,1,1) S X=BGPHD1 D S(X,1,1) S Y=" " D S(Y,1,1)
