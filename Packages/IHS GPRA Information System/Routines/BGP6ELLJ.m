...
I1AGEP ;
 ...
 S X="% w/ Total Cholesterol screen w/in 5 yrs (GPRA)" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAC(X),U,3) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,13) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,15) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
PR ; 
 ...
 S X="% w/ Total Cholesterol screen w/in 5 yrs (GPRA)" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,3) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="A. # w/ High Chol =>240 w/ % of Total Chol Screen" D S(X,1,1)
 ...
 S X="C. % w/ LDL 131-160 w/ % of Total LDL Screen" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,13) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="D. # w/ LDL >160 w/ % of Total LDL Screen" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,14) S Y=V D S(Y,,X+1)
 S X="D. % w/ LDL >160 w/ % of Total LDL Screen" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,15) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="CHANGE FROM PREV YR %" D S(X,1,1)
 S X="w/ Total Cholesterol screen w/in 5 yrs (GPRA)" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAP(X),U,3) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="A. # w/ High Chol =>240 w/ % of Total Chol Screen" D S(X,1,1)
 ...
 S X="C. # w/ LDL 131-160 w/ % of Total LDL Screen" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,13),O=$P(BGPDAP(X),U,13) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="D. # w/ LDL >160 w/ % of Total LDL Screen" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,15),O=$P(BGPDAP(X),U,15) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
BL ;
 D BL^BGP6ELLV
 Q
V(T,R,N,P) ;
