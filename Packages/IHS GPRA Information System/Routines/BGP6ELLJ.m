BGP6ELLJ ; IHS/CMI/LAB - print ind ;
...
I1AGEP ;
 ...
 S X=" " D S(X,1,1) S X="# High Chol =>240" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAC(X),U,4) S Y=V D S(Y,,X+1)
 S X="% High Chol =>240" D S(X,1,1)
