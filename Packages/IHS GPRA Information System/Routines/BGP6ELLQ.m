BGP6ELLQ ; IHS/CMI/LAB - print ind ;
...
I1AGEP ;EP
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,17) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAC(X),U,18) S Y=V D S(Y,,X+1)
 S X="% w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAC(X),U,19) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
PR ; 
 ...
 S X="% w/ A1c <7" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,17) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,18) S Y=V D S(Y,,X+1)
 S X="% w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,19) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 ;
 ...
 S X="w/ A1c <7" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,17),O=$P(BGPDAP(X),U,17) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,19),O=$P(BGPDAP(X),U,19) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
BL ;
 ...
 S X="% w/ A1c <7" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,17) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,18) S Y=V D S(Y,,X+1)
 S X="% w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,19) S Y=$$SB^BGP6ELL2($J(V,6,1)) D S(Y,,X+1)
 ;
 ...
 S X="w/ A1c <7" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,17),O=$P(BGPDAB(X),U,17) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/ A1c w/o result" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,19),O=$P(BGPDAB(X),U,19) S Y=$$SB^BGP6ELL2($J((N-O),6,1)) D S(Y,,X+1)
 Q
SETN ;
