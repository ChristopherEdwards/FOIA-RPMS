BGP6GCMS ; IHS/CMI/LAB - GUI CMS REPORT 27 Apr 2006 10:30 PM ; 
...
TESTNTL ;
 ...
 D EP(.ERR,1,2522,"BGP 06 CMS PERF RPT",2522,.LORIND,1,3020000,$$NOW^XLFDT)
 W !,ERR
 Q
EP(BGPRET,BGPUSER,BGPDUZ2,BGPOPTN,BGPHOSP,BGPIND,BGPQTR,BGPPER,BGPRTIME,BGPUDBD,BGPED) ;EP - called from GUI to produce COM REPORT CI05-RPT-LOC-CMS
 ; SEE ROUTINE BGP6DC if you have questions about any of these variables
 ;  BGPUSER - DUZ
 ;  BGPDUZ2 - DUZ(2)
 ;  BGPOPTN - OPTION NAME
 ;  BGPHOSP - IEN OF HOSPITAL FROM LOCATION FILE
 ;
 ;  BGPIND - array of iens from items selected from ^BGPCMSIS GLOBAL
 ;
...
EP1 ;
 ...
 S BGPGUI=1
 S IOM=80,BGPIOSL=55
 I BGPQTR=1 S BGPBD=$E(BGPED,1,3)_"0101",BGPED=$E(BGPED,1,3)_"1231"
 I BGPQTR=2 S BGPBD=($E(BGPED,1,3)-1)_"0401",BGPED=$E(BGPED,1,3)_"0331"
 I BGPQTR=3 S BGPBD=($E(BGPED,1,3)-1)_"0701",BGPED=$E(BGPED,1,3)_"0630"
 I BGPQTR=4 S BGPBD=($E(BGPED,1,3)-1)_"1001",BGPED=$E(BGPED,1,3)_"0930"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LOCCMS^BGP6GCMS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI 06 CMS LIST" D ^%ZTLOAD Q
 Q
LOCCMS ;
 D ^BGP6C1
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D GUIR^XBLM("^BGP6CP","^TMP($J,""BGPGUI"",")
