BGP6GLHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM 05 Oct 2016 9:58 AM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 16 LOCAL HT/WT",597,"","O","P",$$NOW^XLFDT,"lori ht/wt file")
 W !,ERR
 Q
...
CHW ;
 S BGPYWCHW=2
 S BGPHWNOW=$$NOW^XLFDT() S BGPHWNOW=$P(BGPHWNOW,".")_"."_$$RZERO^BGP6UTL($P(BGPHWNOW,".",2),6)
 S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP6UTL(BGPBD)_$$D^BGP6UTL(BGPED)_$$D^BGP6UTL(BGPHWNOW)_"_001_of_001"_".TXT"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLLHW^BGP6GLHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT" D ^%ZTLOAD
...
NTLLHW ;
 ...
 ;D HWSF^BGP6DHW
 ;D KITM^BGP6DHW
 D GUIR^BGPXBLM("PRINT^BGP6DHW","^TMP($J,""BGPGUI"",")
