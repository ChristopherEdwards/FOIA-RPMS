BGP6GMTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 16 MED TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIM(",DIC(0)="L",DIADD=1,DLAYGO=90556.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP6GMTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI MEDICATION TAXONOMY REPORT" D ^%ZTLOAD
 D UPLOG^BGP6GUA(BGPGIEN,ZTSK)
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP6DMT",BGPRT=7:"ONM^BGP6DMT",BGPRT=2:"CRS^BGP6DMT",BGPRT=4:"ELDER^BGP6DMT",BGPRT=3:"HEDIS^BGP6DMT",BGPRT=5:"CMS^BGP6DMT",BGPRT=8:"EO^BGP6DMT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP6DMT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP") done in MEDTAXC^BGP6GU
 S:$D(ZTQUEUED) ZTREQ="@"
