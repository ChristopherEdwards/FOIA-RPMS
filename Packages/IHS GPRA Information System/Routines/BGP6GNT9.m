BGP6GNT9 ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
...
NT ;
 ...
 I $G(BGPEXPT) S BGPFILEN="BG161"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
 ;I BGPYWCHW=2 D
 ;.S BGPNOW=$$NOW^XLFDT() S BGPNOW=$P(BGPNOW,".")_"."_$$RZERO^BGP6UTL($P(BGPNOW,".",2),6)
 ;.S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP6UTL(BGPBD)_$$D^BGP6UTL(BGPED)_$$D^BGP6UTL(BGPNOW)_"_000001"_".TXT"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP6GNT9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATL GPRA RPT 10 FOR 11" D ^%ZTLOAD
...
NTLGP ;
 ...
 ;I $G(BGPYWCHW)=2 D HWSF^BGP6DNG9
 D ENDLOG
 D XIT
 Q
 ;
