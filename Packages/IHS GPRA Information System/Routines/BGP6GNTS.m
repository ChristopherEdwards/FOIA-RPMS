BGP6GNTS ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
TESTNTL ;
 S ERR=""
 D EPSUM(.ERR,1,2582,"BGP 16 NATIONAL GPRA RPT SUM",597,0,"B",$$NOW^XLFDT)
 W !,ERR
 Q
...
NT ;
 ...
 S BGPFILEN="BG161"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP6GNTS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11 SUM" D ^%ZTLOAD
