BGP6GNXP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 16 NATL EXPORT",597,1,1,,$$NOW^XLFDT)
 W !,ERR
 Q
...
HOME ;
 ...
 S BGPFN="CRSCNT"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP6UTL(BGPXPHD)_$$D^BGP6UTL(BGPXPEDT)_$$D^BGP6UTL(BGPNOW)_"_001_of_001.TXT"
 ;CREATE REPORT ENTRY
 ...
 S BGPGFNM=X
 S DIC="^BGPGUIA(",DIC(0)="L",DIADD=1,DLAYGO=90556.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///P"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP6GNXP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT 15" D ^%ZTLOAD
...
NTXP ;
 ...
 S ^BGPGUIA(BGPGIEN,11,0)="^90556.1911^"_C_"^"_C_"^"_DT
 K ^TMP($J,"BGPGUI")
 D ENDLOG
 D XIT
 Q
