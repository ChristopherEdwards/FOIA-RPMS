BGP6GPP ; IHS/CMI/LAB - GUI PP REPORT ;
...
TESTNTL ;
 ...
 S BGPND(4)="",BGPND(3)=""
 S BGPLIST(3)=""
 D EP(.ERR,1,2522,"BGP 16 SEL PATIENT PANEL",338,"D",.BGPND,1,3040000,3000000,1801,"A",.BGPLIST,"","","B",$$NOW^XLFDT)
 W !,ERR
 Q
EP(BGPRET,BGPUSER,BGPDUZ2,BGPOPTN,BGPINDM,BGPIND,BGPQTR,BGPPER,BGPVDT,BGPSEAT,BGPLSTT,BGPLIST,BGPLPRV,BGPLPROV,BGPROT,BGPRTIME,BGPFILE,BGPDNT) ;EP - called from GUI to produce PP REPORT CI05-RPT-LOC-PP
 ; SEE ROUTINE BGP6DL if you have questions about any of these variables
 ;  BGPUSER - DUZ
 ;  BGPDUZ2 - DUZ(2)
 ;  BGPOPTN - OPTION NAME
 ;  BGPTAXI - IEN OF COMMUNITY TAXONOMY NAME
 ;  BGPINDM - $E (1st character) of the answer to the following DIR call:
 ...
 ;           so if BGPINDM="S" pass this array
...
EP1 ;
 ...
 I $G(BGPINDM)="" S BGPRET=0_"^INDICATOR TYPE NOT PASSED" Q
 I "DCWESIPA"'[BGPINDM S BGPRET=0_"^INDICATOR TYPE INVALID" Q
 I BGPINDM="S",'$D(BGPIND) S BGPRET=0_"^INDICATOR ARRAY NOT PASSED" Q
 I BGPINDM="S",'$O(BGPIND(0)) S BGPRET=0_"^INDICATOR ARRAY NOT PASSED" Q
 ...
 I BGPINDM="D" K BGPIND D DI
 I BGPINDM="C" K BGPIND D CI
 I BGPINDM="W" K BGPIND D WI
 I BGPINDM="E" K BGPIND D EI
 I BGPINDM="I" K BGPIND D II^BGP6DL
 I BGPINDM="P" K BGPIND D PI^BGP6DL
 I BGPINDM="A" K BGPIND D AI^BGP6DL
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LOCPP^BGP6GPP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT COM 05" D ^%ZTLOAD
