BGP6HEH ; IHS/CMI/LAB - cover page for HEDIS ;
 ;;7.0;IHS CLINICAL REPORTING;;JAN 24, 2007
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("Cover Page",80)
 W:BGPRTYPE=3 !!,$$CTR("*** IHS 2006 HEDIS Clinical Performance Report ***",80)
 ...
 I BGPRTYPE=3 W !!,"Measures: HEDIS Measures"
 ...
 D ENDTIME
 D HEDISHDR
 I $G(BGPEXPT) W !!,"A file will be created called BG06",$P(^AUTTLOC(DUZ(2),0),U,10)_".HE"_BGPRPT,".",!,"It will reside in the public/export directory.",!,"This file should be sent to your Area Office.",!
...
AREACP ;EP - area cover page
 ...
 .W !?3,BGPC,".  ",$S($P(^BGPHEDCS(BGPX,0),U,17):"*",1:""),X
 ...
 .S X=$P(^BGPHEDCS(BGPX,0),U,9),X=$O(^AUTTLOC("C",X,0)) S X=$S(X:$P(^DIC(4,X,0),U),1:"?????")
 .W !!?3,BGPC,".  ",$S($P(^BGPHEDCS(BGPX,0),U,17):"*",1:""),X
 .W !?5,"Communities: " S BGPXX=0,BGPXN=0,BGPXY="" F  S BGPXX=$O(^BGPHEDCS(BGPX,9999,BGPXX)) Q:BGPXX'=+BGPXX  S BGPXN=BGPXN+1,BGPXY=BGPXY_$S(BGPXN=1:"",1:";")_$P(^BGPHEDCS(BGPX,9999,BGPXX,0),U)
 ...
 ..W !!?5,"MFI Visit Locations: " S BGPXX=0,BGPXN=0,BGPXY="" F  S BGPXX=$O(^BGPHEDCS(BGPX,1111,BGPXX)) Q:BGPXX'=+BGPXX  S BGPXN=BGPXN+1,BGPXY=BGPXY_$S(BGPXN=1:"",1:";")_$P(^BGPHEDCS(BGPX,1111,BGPXX,0),U)
