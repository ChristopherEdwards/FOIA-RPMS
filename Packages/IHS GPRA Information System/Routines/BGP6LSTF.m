BGP6LSTF ; IHS/CMI/LAB - List 'BG08' files in pub ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
 W:$D(IOF) @IOF
 W !,"This option is used to list all CRS 2016 files that are in a directory.",!,"These files begin with BG161.",!,"You must specify the directory in which the CRS 2016 data files reside.",!
FILE ;
 D HOME^%ZIS
DIR ;
 K DIR
 ...
 S BGPDIR=Y
 ;
 K BGPLIST S BGPLIST="",X=$$LIST^%ZISH(BGPDIR,"BG161*",.BGPLIST)
 I $O(BGPLIST(""))="" W !!,"There are no files in that directory." D EOP^BGP6DH D EN^XBVK("BGP") Q
 W !!,"The following CRS 2016 files reside in the ",BGPDIR," directory."
