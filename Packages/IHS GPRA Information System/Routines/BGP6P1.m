BGP6P1 ; IHS/CMI/LAB - v11.0 patch 1 env routine 08 Dec 2010 3:10 PM ;
...
POST ;EP - called from kids build
 ...
 .I '$D(^BGPGPDCM(BGPX,1.1)) S DA=BGPX,DIK="^BGPGPDCM(" D ^DIK S DA=BGPX,DIK="^BGPGPDPM(" D ^DIK S DA=BGPX,DIK="^BGPGPDBM(" D ^DIK
 Q
