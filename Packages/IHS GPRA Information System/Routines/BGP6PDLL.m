BGP6PDLL ; IHS/CMI/LAB - print ind 1 ;
...
I1AGE3 ;
 ...
 S BGPNF=$P(^BGPINDMC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90556.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 S $P(BGPDAC(E),U,7)=$$V^BGP6DP1C(1,BGPRPT,N,P),$P(BGPDAC(E),U,8)=$S($P(BGPDAC(E),U,6):($P(BGPDAC(E),U,7)/$P(BGPDAC(E),U,6)*100),1:"")
 S $P(BGPDAP(E),U,7)=$$V^BGP6DP1C(2,BGPRPT,N,P),$P(BGPDAP(E),U,8)=$S($P(BGPDAP(E),U,6):($P(BGPDAP(E),U,7)/$P(BGPDAP(E),U,6)*100),1:"")
 S $P(BGPDAB(E),U,7)=$$V^BGP6DP1C(3,BGPRPT,N,P),$P(BGPDAB(E),U,8)=$S($P(BGPDAB(E),U,6):($P(BGPDAB(E),U,7)/$P(BGPDAB(E),U,6)*100),1:"")
 Q
 ;
I1AGEP ;
