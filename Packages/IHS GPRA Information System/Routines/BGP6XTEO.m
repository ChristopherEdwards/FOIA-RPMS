BGP6XTEO ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;16.1;IHS CLINICAL REPORTING;;MAR 22, 2016;Build 170
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2016 Executive Order Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP6XTEO",XBNS="",XBRX="XIT^BGP6XTEO"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
GUICHK ;EP
 ...
 .Q:'$D(^BGPTAXM(BGPY,12,"B",8))  ;8 IS SET OF CODES FOR EO REPORT
