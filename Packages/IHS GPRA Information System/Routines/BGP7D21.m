...
I9 ;EP
 ...
 S BGPVALUD="" I BGPN3 S BGPVALUD="UP w/exam "_$$DATE^BGP7UTL($P(BGPV1,U,2))_" "_$P(BGPV1,U,3)
 S BGPVALUD=BGPVALUD_$S(BGPD10:",PREG",1:"")
 S BGPVALUD=BGPVALUD_"|||"
 I BGPTC S BGPVALUD=BGPVALUD_"TC: "_$$DATE^BGP7UTL($P(BGPTC,U,2))_" "_$P(BGPTC,U,3)
...
PREG(P,BDATE,EDATE) ;EP
 ...
 S X=$$PREG^BGP7D7(P,$$FMADD^XLFDT(EDATE,-608),EDATE,1,1)
