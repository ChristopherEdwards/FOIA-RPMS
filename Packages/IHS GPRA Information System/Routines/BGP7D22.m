...
IOMW ;EP
 ...
 S BGPFRAC=$$FRACTURE^BGP7EL3(DFN,$$FMADD^XLFDT(BGPBDATE,-182),$$FMADD^XLFDT(BGPBDATE,182))
 ...
 S BGPVALUE=BGPVALUE_" FX: "_$$DATE^BGP7UTL($P(BGPFRAC,U,2))_" "_Y_"|||"_$S($P(BGPBMD,U,2)]"":"TX: "_$P(BGPBMD,U,2),1:"")
