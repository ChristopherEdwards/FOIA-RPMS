...
OPV(P,EDATE) ;EP
 ...
 ...S Y=$P(^AUPNVTC(X,0),U,7) Q:'Y  S Y=$P($$CPT^ICPTCOD(Y),U,2) I Y=90712!(Y=90698)!(Y=90711)!(Y=90713)!(Y=90723) S BGPOPV(9999999-$P(ED,"."))="",BGPAPOV(9999999-$P(ED,"."))=""
 ...
 I $$PLTAX^BGP7DU(P,"BGP OPV EVID DISEASE") Q 4_U_"evid opv"
 ...
 I $$PLTAX^BGP7DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"contra opv"
 ;now go to refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
 F BGPIMM=2,89,10,110,120 D
 ...
 F BGPIMM=2,89,10,110,120 S R=$$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q 3_U_"ref OPV"
 Q ""
MMR(P,EDATE) ;EP
 K BGPC,BGPG,BGPX
