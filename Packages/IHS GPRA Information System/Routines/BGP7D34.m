...
DTAP(P,EDATE) ;EP
 ...
 ...I Y=90700!(Y=90721)!(Y=90723)!(Y=90701)!(Y=90711)!(Y=90720)!(Y=90702)!(Y=90718)!(Y=90719)!(Y=90703)!(Y=90698)!(Y=90749)!(Y=90715)!(Y=90714) S ^TMP($J,"CPT",9999999-$P(ED,"."),Y)=""
 ...
 S C="20^50^106^107^110^1^22^102^115^120"
...
EVIDTET ;
 ...
 I $$PLCODE^BGP7DU(P,"037.") S BGPEVTD=1
 D RESETD
...
EVIDPER ;
 ...
 I $$PLTAX^BGP7DU(P,"BGP PERTUSSIS EVIDENCE") S BGPEVPER=1
 D RESETD
...
EVIDDIP ;
 ...
 I $$PLTAX^BGP7DU(P,"BGP DIPHTHERIA EVIDENCE") S BGPEVDIP=1
 D RESETD
...
REF ;
 ...
 F BGPIMM=20,50,106,107,110,1,22,102,115,120 Q:R  S R=$$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
