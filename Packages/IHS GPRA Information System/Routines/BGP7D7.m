...
DX(P,BDATE,EDATE) ;EP
 ...
 ;I BGPG(1)]"" Q $P(^ICD9($P(BGPG(1),U,4),0),U)_U_$P(BGPG(1),U,3)
 I BGPG(1)]"" Q $P($$ICDDX^ICDCODE($P(BGPG(1),U,4),$P(BGPG(1),U,1)),U,4)_U_$P(BGPG(1),U,3)
...
TOBACCO0 ;lookup in health status
 ...
 S Y=$P(^AUTTHF(Y,0),U)
 S BGPTOB=Y_"^"_$$DATE^BGP7UTL(9999999-E)
 K Y,E,X
 Q
 ;
