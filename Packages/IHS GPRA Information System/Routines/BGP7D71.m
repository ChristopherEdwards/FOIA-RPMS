...
IC1 ;EP
 ...
 S BGPVALUE=$$DATE^BGP7UTL($P(BGPMN,U))_" "_$P(BGPMN,U,2)_$S(BGPMN]"":";",1:"")
 S BGPVALUE=BGPVALUE_$$DATE^BGP7UTL($P(BGPSN,U))_" "_$P(BGPSN,U,2)_$S(BGPSN]"":";",1:"")
 S BGPVALUE=BGPVALUE_$$DATE^BGP7UTL($P(BGPSPEX,U))_" "_$P(BGPSPEX,U,2)_$S(BGPSPEX]"":";",1:"")
 S BGPVALUE=BGPVALUE_$$DATE^BGP7UTL($P(BGPOTH,U))_" "_$P(BGPOTH,U,2)
...
I19 ;EP
 ...
 I BGPD1,BGPAGEB>12,BGPAGEB<18 S BGPD4=1
 ...
 S BGPTQ="" I $P(BGPTOB,U)["PREVIOUS"!(+BGPSDX="305.13") S BGPN2=1
 S BGPVALUE=$S(BGPRTYPE=3:"",BGPD2:"UP",1:"")_$S(BGPD1:";AC",1:"")
 S BGPVALUE=BGPVALUE_"|||"_$S($P(BGPTC,U):"COUNSELING: "_$$DATE^BGP7UTL($P(BGPTC,U))_" "_$P(BGPTC,U,2),1:"")
 I BGPN2,BGPRTYPE'=3 S BGPVALUE=BGPVALUE_";QUIT: "_$P(BGPTOB,U)_" "_$P(BGPTOB,U,2)_$S(+BGPSDX="305.13":" DX: 305.13"_$$DATE^BGP7UTL($P(BGPSDX,U,2)),1:"")
...
MEDNUTR(P,BDATE,EDATE) ;EP
 K ^TMP($J),BGPG,BGPC
 S E=+$$CODEN^ICPTCOD(97802),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802 MN"
 S E=+$$CODEN^ICPTCOD(97803),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)-"^97803 MN"
 S E=+$$CODEN^ICPTCOD(97804),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804 MN"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270 MN"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271 MN"
 ;TRAN CODES
 S E=+$$CODEN^ICPTCOD(97802),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802 MN TRAN"
 S E=+$$CODEN^ICPTCOD(97803),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)-"^97803 MN TRAN"
 S E=+$$CODEN^ICPTCOD(97804),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804 MN TRAN"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270 MN TRAN"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271 MN TRAN"
...
PED(P,BDATE,EDATE) ;EP
 ...
 ..Q:'$D(^AUTTEDT(T,0))
 ..S T=$P(^AUTTEDT(T,0),U,2)
 ..I $P(T,"-")="TO" S %=$P(BGPALLED(X),U)_U_T Q
 ...
 .Q
 I G]"" Q G
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0375")) I G Q $P(G,U,2)_U_"CPT G0375"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0376")) I G Q $P(G,U,2)_U_"CPT G0376"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0375")) I G Q $P(G,U,2)_U_"TRAN G0375"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0376")) I G Q $P(G,U,2)_U_"TRAN G0376"
