...
IAHRA ;EP
 ...
 I 'BGPN10 S BGPACE("CONTRA")=$$ACECONT^BGP7D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,BGPBDATE,BGPEDATE) I BGPACE("CONTRA") S BGPN12=1 ;beta contraindication
 ...
 I 'BGPN14 S BGPSTAT("REF")=$$STATREF^BGP7D722(DFN,BGPBDATE,BGPEDATE) I BGPSTAT("REF") S BGPN15=1
...
BETACONT(P,BDATE,EDATE,NMIBD,NMIED) ;EP - BETA BLOCKER CONTRAINDICATION
 ...
 S BGPG=$$LASTDXI^BGP7UTL1(P,"427.81",BDATE,EDATE)
...
ASAC2 ;now check for dx 459
 K BGPG S BGPG=$$LASTDXI^BGP7UTL1(P,"459.0",$$DOB^AUPNPAT(P),EDATE)
 I BGPG Q 1_U_"asa contra 459.0 "_$$DATE^BGP7UTL($P(BGPG,U,3))
 ;
...
ASAALLEG(P,EDATE) ;EP
 K BGPG
 D ASAALLEG^BGP7C1(P,EDATE,.BGPG)
 S X=$O(BGPG(X))
 I 'X Q 0
 Q 1_U_"asa alleg: "_BGPG(X)
 ;
