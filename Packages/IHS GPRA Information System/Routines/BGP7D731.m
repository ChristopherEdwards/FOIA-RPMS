...
IPAMT ;EP
 ...
 I 'BGPN10 S BGPACE("CONTRA")=$$ACECONT^BGP7D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,$P(BGPAMI,U,2),$$FMADD^XLFDT(BGPADDAT,180)) I BGPACE("CONTRA") S BGPN12=1 ;beta contraindication
 ...
 I 'BGPN14 S BGPSTAT("REF")=$$STATREF^BGP7D722(DFN,$P(BGPAMI,U,2),$$FMADD^XLFDT(BGPADDAT,180)) I BGPSTAT("REF") S BGPN15=1
 I 'BGPN14 S BGPSTAT("CONTRA")=$$STATCON^BGP7D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,BGPADDAT,$$FMADD^XLFDT(BGPADDAT,180)) I BGPSTAT("CONTRA") S BGPN16=1 ;beta contraindication
...
WAR71 .;
 ...
 K BGPG S BGPG=$$LASTDXI^BGP7UTL1(P,"459.0",BDATE,EDATE)
