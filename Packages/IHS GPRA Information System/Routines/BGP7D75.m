...
IAMT ;EP
 ...
 I 'BGPN2 S BGPBETA("CONTRA")=$$BETACONT^BGP7D721(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,$P(BGPAMI,U,2),$P(BGPAMI,U,4)) I BGPBETA("CONTRA") S BGPN4=1 ;beta contraindication
 ...
 I 'BGPN10 S BGPACE("CONTRA")=$$ACECONT^BGP7D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPACE("CONTRA") S BGPN12=1 ;beta contraindication
 ...
 I 'BGPN14 S BGPSTAT("REF")=$$STATREF^BGP7D722(DFN,$P(BGPAMI,U,2),$$FMADD^XLFDT($P(BGPAMI,U,4),7)) I BGPSTAT("REF") S BGPN15=1
