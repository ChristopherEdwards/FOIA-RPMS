...
IRAR ;EP
 ...
 .I BGPCBC,BGPLFT,BGPCREAT S BGPIRZ("A")=1,BGPIRV("A")=BGPIRV("A")_" CREAT: "_$$DATE^BGP7UTL($P(BGPCREAT,U,2))_"CBC: "_$$DATE^BGP7UTL($P(BGPCBC,U,2))_" LFT: "_$$DATE^BGP7UTL($P(BGPLFT,U,2))  ;NA MEDS AND HAS CBC,LFT
