BGP7DAP ; IHS/CMI/LAB - IHS GPRA 04 SELECTED REPORT DRIVER ALL PATIENTS ;
 ...
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2007 Clinical Performance Measure Report (Selected Measures)",80)
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP7DL",ZTDTH="",ZTDESC="GPRA 07 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
