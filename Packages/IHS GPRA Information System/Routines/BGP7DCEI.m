...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIA(BGPIC,1)) X ^BGPELIA(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIA("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIA(BGPI,1)
 ..X ^BGPELIIA(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIA(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90532.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIA(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90532.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
