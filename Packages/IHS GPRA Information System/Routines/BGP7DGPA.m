...
DISP ;
 ...
 W !,BGPC,?4,$$DATE^BGP7UTL($P(BGP0,U,1)),?13,$$DATE^BGP7UTL($P(BGP0,U,2)),?22,$$DATE^BGP7UTL($P(BGP0,U,5)),?32,$$DATE^BGP7UTL($P(BGP0,U,6)),?42,$E($$SU($P(BGP0,U,11)),1,15),?59,$E($$FAC($P(BGP0,U,9)),1,20)
 Q
