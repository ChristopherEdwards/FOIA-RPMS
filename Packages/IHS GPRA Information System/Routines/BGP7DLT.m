...
INTRO ;
 ...
 I 'Y D XIT Q
ZIS ;call to XBDBQUE
 ;S XBRC="",XBRP="PRINT^BGP7DLT",XBRX="XIT^BGP7DLT",XBNS="BGP"
 ;D ^XBDBQUE
 K ZTSK
...
QUE ;
 ...
 S ZTRTN="PRINT^BGP7DLT",ZTDESC="BGP 07 LAB TAX REPORT",ZTIO=ION,ZTDTH=""
 D ^%ZTLOAD
 D HOME^%ZIS
 D XIT
 Q
...
N ;GATHER UP AND DISPLAY ALL NATIONAL GPRA
 ...
 .Q:$P(^BGPTAXA(BGPTIEN,0),U,2)'="L"  ;only lab taxonomies in this report
...
INTROT ;introductory text
 ...
 ;;
 ;;This will produce a report of all site-populated lab taxonomies for CRS 2007.
