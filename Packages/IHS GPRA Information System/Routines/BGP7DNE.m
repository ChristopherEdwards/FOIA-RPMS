BGP7DNE ; IHS/CMI/LAB - NATL COMP EXPORT 17 Jul 2008 9:28 AM ; 
...
INTRO ;
 ...
 D TAXCHK^BGP7XTCN
TP ;
 S BGPRTYPE=1,BGPXPRP=1,BGPXPFYY=2007,BGPXPFYI=307
 S BGPXPBD=2990701,BGPXPEDT=3070630
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP7DNE",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 07" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
