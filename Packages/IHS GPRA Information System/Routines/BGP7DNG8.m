BGP7DNG8 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;  [ 02/21/2007  1:35 PM ]
...
INTRO ;
 ...
 W !,"will be included.  This report will be run for the time period July 1, 2007"
 W !,"through June 30, 2008 with a baseline period of July 1, 1999 through"
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP7DNG8",XBRX="XIT^BGP7DNG8",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP7DNG8",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 07 FOR GPRA YEAR 2008" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
