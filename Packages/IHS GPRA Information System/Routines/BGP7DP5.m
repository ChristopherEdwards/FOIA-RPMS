...
I023 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.8.1E",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.2E",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.3E",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.9.1E",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.2E",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.3E",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.10.1E",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.2E",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.3E",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.8.1F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.2F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.3F",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.9.1F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.2F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.3F",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.10.1F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.2F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.3F",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 I BGPRTYPE=4,BGPINDT="E" D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.8.1F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.2F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.3F",0)) D PI1^BGP7DP1C
 .S BGPPC=$O(^BGPINDAC("OR","21.8.4F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.8.5F",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.9.1F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.2F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.3F",0)) D PI1^BGP7DP1C
 .S BGPPC=$O(^BGPINDAC("OR","21.9.4F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.9.5F",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.10.1F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.2F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.3F",0)) D PI1^BGP7DP1C
 .S BGPPC=$O(^BGPINDAC("OR","21.10.4F",0)) D PI1^BGP7DP1C S BGPPC=$O(^BGPINDAC("OR","21.10.5F",0)) D PI1^BGP7DP1C
 .Q:BGPQUIT
 F BGPPC1="21.1","21.2","21.3" Q:BGPQUIT  D PI^BGP7DP1C
 Q:BGPQUIT
 ;I BGPRTYPE=4 D HEADER^BGP7DPH
 F BGPPC1="21.4" Q:BGPQUIT  D PI^BGP7DP1C
 Q:BGPQUIT
 I BGPRTYPE=4 D HEADER^BGP7DPH W !,^BGPINDA(BGPIC,53,1,0)
 I BGPRTYPE'=1 D H1^BGP7DPH
 F BGPPC1="21.5","21.6" Q:BGPQUIT  D PI^BGP7DP1C
 Q:BGPQUIT
 I BGPRTYPE=4 D HEADER^BGP7DPH W !,^BGPINDA(BGPIC,53,1,0)
 I BGPRTYPE'=1 D H1^BGP7DPH
 F BGPPC1="21.7" Q:BGPQUIT  D PI^BGP7DP1C
 D I1AGE
 Q
...
I1AGE1 ;
 ;gather up all #'s
 S C=C+1
 S BGPF="032."_BGPX_".1" S BGPPC=$O(^BGPINDAC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="032."_BGPX_".2" S BGPPC=$O(^BGPINDAC("C",BGPF,0))
...
I1AGE3 ;
 S BGPF="032."_BGPX_".3" S BGPPC=$O(^BGPINDAC("C",BGPF,0))
...
I1AGE4 ;
 S BGPF="032."_BGPX_".4" S BGPPC=$O(^BGPINDAC("C",BGPF,0))
...
I1AGE5 ;
 G I1AGE6
 S BGPF="032."_BGPX_".5" S BGPPC=$O(^BGPINDAC("C",BGPF,0))
...
I1AGE6 ;
 S BGPF="032."_BGPX_".6" S BGPPC=$O(^BGPINDAC("C",BGPF,0))
