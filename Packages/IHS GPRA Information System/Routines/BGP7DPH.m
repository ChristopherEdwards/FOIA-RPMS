BGP7DPH ; IHS/CMI/LAB - AREA REPORT HEADER ;
...
HEADER1 ;
 ...
 I BGPRTYPE=1,'$G(BGP7GPU) W $$CTR("*** IHS 2007 National GPRA Clinical Performance Measure Report ***",80),!
 I BGPRTYPE=1,$G(BGP7GPU) W $$CTR("*** IHS GPRA Performance Report ***",80),!
 W:BGPRTYPE=3 $$CTR("*** IHS 2007 HEDIS Clinical Performance ***",80),!
 W:BGPRTYPE=5 $$CTR("*** IHS 2007 ELDER CARE Clinical Performance ***",80),!
