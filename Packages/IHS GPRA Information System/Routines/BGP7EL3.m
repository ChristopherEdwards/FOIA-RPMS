...
I19 ;EP
 ...
 I $P(BGPFRAC,U,3)'="H" S BGPBMD=$$TXBMD^BGP7EL4(DFN,BGPISD,$$FMADD^XLFDT(BGPISD,182))
...
IRAO ;EP
 ...
 S BGPPAP=$$OSTEOSCR^BGP7D42(DFN,B,BGPEDATE)
 I BGPPAP S BGPN1=1
 ;I 'BGPN1 S BGPPAP=$$OSTEOREF^BGP7D42(DFN,BGPBDATE,BGPEDATE) I BGPPAP S BGPN2=1  ;Refusal
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$$DATE^BGP7UTL($P(BGPPAP,U,2))_" "_$P(BGPPAP,U,3) ;$P(BGPPAP,U,2)_" "_$$DATE^BGP7UTL($P(BGPPAP,U,3))_$S($P(BGPPAP,U,1)=3:" (Refused)",1:"")
 K BGPPAP,X
 Q
 ;
IRAA ;EP
...
FRACTURE(P,BDATE,EDATE) ;EP
 ...
 ;n
 ;
 S BGPX=$$TXBMD^BGP7EL4(P,$$FMADD^XLFDT(BGPISD,-720),$$FMADD^XLFDT(BGPISD,-1)) I $P(BGPX,U) S $P(BGPV(BGPISD,BGPISV),U,5)=$P(BGPX,U,2) Q ""
