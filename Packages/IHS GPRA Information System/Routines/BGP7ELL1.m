BGP7ELL1 ; IHS/CMI/LAB - print ind 1 ;
...
PI1 ;
 ...
 .Q:$G(BGPNODEN)
 .S Y=$P(^BGPELIIA(BGPPC,0),U,17) D S(Y,1,1)
 .I $P(^BGPELIIA(BGPPC,0),U,18)]"" D
 ..D S($P(^BGPELIIA(BGPPC,0),U,18),1,1)
 .I $P(^BGPELIIA(BGPPC,0),U,21)]"" D
 ..D S($P(^BGPELIIA(BGPPC,0),U,21),1,1)
 ...
 S Y=" " D S(Y,1,1) S Y=$P(^BGPELIIA(BGPPC,0),U,15) D S(Y,1,1)
 I $P(^BGPELIIA(BGPPC,0),U,16)]"" S Y=$P(^BGPELIIA(BGPPC,0),U,16) D S(Y,1,1)
