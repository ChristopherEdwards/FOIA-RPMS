...
PI1 ;
 ...
 D SETN
 S X=$P(^BGPELIIA(BGPPC,0),U,15) D S(X,1,1)
 I $P(^BGPELIIA(BGPPC,0),U,16)]"" S X=$P(^BGPELIIA(BGPPC,0),U,16) D S(X,1,1)
 I $P(^BGPELIIA(BGPPC,0),U,19)]"" S Y=$P(^BGPELIIA(BGPPC,0),U,19) D S(Y,1,1)
 D H2
 Q
H2 ;
