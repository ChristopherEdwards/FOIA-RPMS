...
I1AGE1 ;
 S C=C+1
 S BGPF="EFR."_BGPX S BGPPC=$O(^BGPELIIA("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="EFR."_$P(BGPX,".")_"."_($P(BGPX,".",2)+3) S BGPPC=$O(^BGPELIIA("C",BGPF,0))
...
I1AGE3 ;
 S E=E+1
 S BGPF="EFR."_$P(BGPX,".")_"."_($P(BGPX,".",2)+6) S BGPPC=$O(^BGPELIIA("C",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPELIIA(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90532.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE4 ;
 S F=F+1
 S BGPF="EFR."_$P(BGPX,".")_"."_($P(BGPX,".",2)+9) S BGPPC=$O(^BGPELIIA("C",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPELIIA(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90532.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE5 ;
 S G=G+1
 S BGPF="EFR."_$P(BGPX,".")_"."_($P(BGPX,".",2)+12) S BGPPC=$O(^BGPELIIA("C",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPELIIA(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90532.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE6 ;
 S H=H+1
 S BGPF="EFR."_$P(BGPX,".")_"."_($P(BGPX,".",2)+15) S BGPPC=$O(^BGPELIIA("C",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPELIIA(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90532.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
PR ; 
 ...
 S X="D. w/ abnormal gait" D S(X,1,1)
 F X=1:1:3 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAP(X),U,11) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 S X="E. w/ refusal" D S(X,1,1)
 F X=1:1:3 S N=$P(BGPDAC(X),U,13),O=$P(BGPDAP(X),U,13) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
BL ;
 ...
 S X="D. w/ abnormal gait" D S(X,1,1)
 F X=1:1:3 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAB(X),U,11) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 S X="E. w/ refusal" D S(X,1,1)
 F X=1:1:3 S N=$P(BGPDAC(X),U,13),O=$P(BGPDAB(X),U,13) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 Q
