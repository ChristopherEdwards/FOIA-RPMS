BGP7ELLS ; IHS/CMI/LAB - print ind ;
...
I1AGE ;EP
 ...
 S (C,D,E,F,G,H,I,J,K)=0 S BGPX="D",C=0 F BGPZZ=1,2,3 D
 .S BGPZ=BGPZZ D I1AGE1
 .S BGPP=4,BGPP1=5,BGPZ=BGPZZ+3 D I1AGE2
 .S BGPP=6,BGPP1=7,BGPZ=BGPZZ+6 D I1AGE2
 .S BGPP=8,BGPP1=9,BGPZ=BGPZZ+9 D I1AGE2
 .S BGPP=10,BGPP1=11,BGPZ=BGPZZ+12 D I1AGE2
 .S BGPP=12,BGPP1=13,BGPZ=BGPZZ+15 D I1AGE2
 .S BGPP=14,BGPP1=15,BGPZ=BGPZZ+18 D I1AGE2
 .S BGPP=16,BGPP1=17,BGPZ=BGPZZ+21 D I1AGE2
 .S BGPP=18,BGPP1=19,BGPZ=BGPZZ+24 D I1AGE2
 .S BGPP=20,BGPP1=21,BGPZ=BGPZZ+27 D I1AGE2
 .S BGPP=22,BGPP1=23,BGPZ=BGPZZ+30 D I1AGE2
 .S BGPP=24,BGPP1=25,BGPZ=BGPZZ+33 D I1AGE2
 .S BGPP=26,BGPP1=27,BGPZ=BGPZZ+36 D I1AGE2
 .S BGPP=28,BGPP1=29,BGPZ=BGPZZ+39 D I1AGE2
 .S BGPP=30,BGPP1=31,BGPZ=BGPZZ+42 D I1AGE2
 .S BGPP=32,BGPP1=33,BGPZ=BGPZZ+45 D I1AGE2
 .S BGPP=34,BGPP1=35,BGPZ=BGPZZ+48 D I1AGE2
 .S BGPP=36,BGPP1=37,BGPZ=BGPZZ+51 D I1AGE2
 .S BGPP=38,BGPP1=39,BGPZ=BGPZZ+54 D I1AGE2
 .S BGPP=40,BGPP1=41,BGPZ=BGPZZ+57 D I1AGE3
 D I1AGEP
 ;MALE
 S BGPHD1="MALE ACTIVE CLINICAL PTS 65+",BGPHD2="# Male Active Clinical Pts 65+"
 S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 K BGPDAC,BGPDAP,BGPDAB
 S (C,D,E,F,G,H,I,J,K)=0 S BGPX="E",C=0 F BGPZZ=1,2,3 D
 .S BGPZ=BGPZZ D I1AGE1
 .S BGPP=4,BGPP1=5,BGPZ=BGPZZ+3 D I1AGE2
 .S BGPP=6,BGPP1=7,BGPZ=BGPZZ+6 D I1AGE2
 .S BGPP=8,BGPP1=9,BGPZ=BGPZZ+9 D I1AGE2
 ...
 S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 K BGPDAC,BGPDAP,BGPDAB
 S (C,D,E,F,G,H,I,J,K)=0 S BGPX="F",C=0 F BGPZZ=1,2,3 D
 .S BGPZ=BGPZZ D I1AGE1
 .S BGPP=4,BGPP1=5,BGPZ=BGPZZ+3 D I1AGE2
 .S BGPP=6,BGPP1=7,BGPZ=BGPZZ+6 D I1AGE2
 .S BGPP=8,BGPP1=9,BGPZ=BGPZZ+9 D I1AGE2
...
I1AGE1 ;
 S C=C+1
 S BGPF="EDA."_BGPX_"."_BGPZ S BGPPC=$O(^BGPELIIA("C",BGPF,0))
...
I1AGEP ;
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,11) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,13) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,15) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,17) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,19) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,21) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,23) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,25) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,27) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,29) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,31) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,33) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,35) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,37) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,39) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,41) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 D I1AGEP^BGP7ELLT
 Q
