BGP7GNXP ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2007 10:56 PM ; 
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP7GNXP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE
 K ^TMP($J,"BGPGUI")
 ...
 D GUIR^XBLM("PRINT^BGP7DNE","^TMP($J,""BGPGUI"",")
