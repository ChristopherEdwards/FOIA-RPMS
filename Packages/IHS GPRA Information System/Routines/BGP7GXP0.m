BGP7GXP0 ; IHS/CMI/LAB - BGP 07 XP FOR 2009 GUI
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP7GXP0",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT 2010" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE9
 K ^TMP($J,"BGPGUI")
