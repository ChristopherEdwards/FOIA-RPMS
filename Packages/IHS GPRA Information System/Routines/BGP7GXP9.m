BGP7GXP9 ; IHS/CMI/LAB - BGP 07 XP FOR 2009 GUI
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTXP^BGP7GXP9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA EXPORT 2009" D ^%ZTLOAD Q
 Q
NTXP ;
 D PROC^BGP7DNE9
 K ^TMP($J,"BGPGUI")
 ...
 D GUIR^XBLM("PRINT^BGP7DNE9","^TMP($J,""BGPGUI"",")
