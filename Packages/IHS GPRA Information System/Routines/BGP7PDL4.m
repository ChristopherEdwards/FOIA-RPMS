BGP7PDL4 ; IHS/CMI/LAB - print ind 1 ;
...
I031 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.7.3D",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.8.3D",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.9.3D",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.7.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.8.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.9.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.7.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.8.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.9.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.7.3G",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.8.3G",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.9.3G",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.7.3H",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.8.3H",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","27.9.3H",0)) D PI1^BGP7PDL1
 F BGPPC1="27.1","27.2","27.3" D PI^BGP7PDL1
 F BGPPC1="27.4","27.5","27.6" D PI^BGP7PDL1
 D I1AGE
 Q
I1AGE ;EP
 ;Q:BGPRTYPE'=4
 ...
 S X=^BGPINDA(BGPIC,53,1,0) D S(X,1,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
