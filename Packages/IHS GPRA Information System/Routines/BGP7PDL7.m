...
I023 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.8.1E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.2E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.9.1E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.2E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.10.1E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.2E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.8.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.9.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.10.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.3F",0)) D PI1^BGP7PDL1
 I BGPRTYPE=4,BGPINDT="E" D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.8.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.3F",0)) D PI1^BGP7PDL1
 .S BGPPC=$O(^BGPINDAC("OR","21.8.4F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.8.5F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.9.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.3F",0)) D PI1^BGP7PDL1
 .S BGPPC=$O(^BGPINDAC("OR","21.9.4F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.9.5F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDAC("OR","21.10.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.3F",0)) D PI1^BGP7PDL1
 .S BGPPC=$O(^BGPINDAC("OR","21.10.4F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDAC("OR","21.10.5F",0)) D PI1^BGP7PDL1
 F BGPPC1="21.1","21.2","21.3","21.4" D PI^BGP7PDL1
 F BGPPC1="21.5","21.6","21.7" D PI^BGP7PDL1
 ;F BGPPC1="21.4" D PI^BGP7PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPRTYPE'=4
