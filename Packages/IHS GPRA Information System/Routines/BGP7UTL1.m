BGP7UTL1 ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED ;
...
LASTDXI(P,T,BDATE,EDATE) ;EP
 I '$G(P) Q ""
 ;RETURN BGPDX4=1 or 0^dx code^date found^IEN OF ICD CODE^IEN OF V POV
 NEW BGPDX1,BGPDX2,BGPDX3,BGPDX5,BGPTX5
 S (BGPDX1,BGPDX2,BGPDX3,BGPDX4,BGPTX5)=""
 I $G(BDATE)="" S BDATE=$P(^DPT(P,0),U,3)  ;if no date then set to DOB
 I $G(EDATE)="" S EDATE=DT  ;if no end date then set to today
...
IA() ;EP
 ...
 I BGPINDT="D",BGPD5,BGPN1 Q 1   ;XXXX CHANGE TO Q 0 AFTER TESTING
 I BGPINDT="D",'BGPD5 Q 0
 I BGPINDT="C",BGPD6,'BGPN1 Q 1
 I BGPINDT="C",BGPD6,BGPN1 Q 1  ;XXXX CHANGE TO Q 0
 I BGPINDT="C",'BGPD6 Q 0
 I BGPINDT="S" I (BGPD1+BGPD2+BGPD3+BGPD4+BGPD5+BGPD6) Q $S(BGPN1:0,1:1)  ;LORI **** CHANGE :1 TO :0 AFTER TESTING
 Q 0
I17() ;EP
 I 'BGPD1 Q 0
