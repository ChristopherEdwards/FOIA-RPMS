BGP7XTCN ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;7.0;IHS CLINICAL REPORTING;**1**;JAN 24, 2007
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the ",$S('$G(BGP7GPU):"National GPRA Report. ",1:"GPRA Performance Report. "),!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP7XTCN",XBNS="",XBRX="XIT^BGP7XTCN"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 ...
 K BGPQUIT
GUICHK ;EP
 W !,"Checking for Taxonomies to support the ",$S('$G(BGP7GPU):"National GPRA Report...",1:"GPRA Performance Report..."),!
