...
EN ;EP -- main entry point
 D EN^VALM("BGP 08 AREA SELECT SITES")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
G1 ;
 ...
 S BGPBEN=1
 S BGPFILE=90533.03
 S BGPX=0 F  S BGPX=$O(^BGPGPDCE(BGPX)) Q:BGPX'=+BGPX  S V=^BGPGPDCE(BGPX,0) D
 ...
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPGPDCE(BGPX,0),U,17):" (CHS ONLY)",1:"")
...
G3 ;
 ...
 S BGPFILE=90534.03
 S BGPX=0 F  S BGPX=$O(^BGPHEDCE(BGPX)) Q:'BGPX  I BGPX S V=^BGPHEDCE(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=3
 ...
 .Q:$P(V,U,14)'=BGPBEN
 . S BGPSU=$E($$SU($P(V,U,11)),1,10)
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPHEDCE(BGPX,0),U,17):" (CHS ONLY)",1:"")
 . S BGPEBD=$$DATE^BGP8UTL($P(V,U))
 . S BGPEED=$$DATE^BGP8UTL($P(V,U,2))
 . S BGPEBBD=$$DATE^BGP8UTL($P(V,U,5))
 . S BGPEBED=$$DATE^BGP8UTL($P(V,U,6))
...
G5 ;
 ...
 S BGPBED=BGPED-X,BGPBED=$E(BGPBED,1,3)_$E(BGPED,4,7)
 S BGPFILE=90535.03
 S BGPX=0 F  S BGPX=$O(^BGPELDCE(BGPX)) Q:'BGPX  I BGPX S V=^BGPELDCE(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=5
 ...
 .Q:$P(V,U,14)'=BGPBEN
 . S BGPSU=$E($$SU($P(V,U,11)),1,10)
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPELDCE(BGPX,0),U,17):" (CHS ONLY)",1:"")
 . S BGPEBD=$$DATE^BGP8UTL($P(V,U))
 . S BGPEED=$$DATE^BGP8UTL($P(V,U,2))
 . S BGPEBBD=$$DATE^BGP8UTL($P(V,U,5))
 . S BGPEBED=$$DATE^BGP8UTL($P(V,U,6))
...
G6 ;
 ...
 S BGPBED=BGPED-X,BGPBED=$E(BGPBED,1,3)_$E(BGPED,4,7)
 S BGPFILE=90535.03
 S BGPX=0 F  S BGPX=$O(^BGPPEDCE(BGPX)) Q:'BGPX  I BGPX S V=^BGPPEDCE(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,5)'=BGPBBD
...
G9 ;
 ...
 S BGPBBD=BGPBD-X,BGPBBD=$E(BGPBBD,1,3)_$E(BGPBD,4,7)
 S BGPBED=BGPED-X,BGPBED=$E(BGPBED,1,3)_$E(BGPED,4,7)
 S BGPX=0 F  S BGPX=$O(^BGPGPDCE(BGPX)) Q:'BGPX  I BGPX S V=^BGPGPDCE(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=9
...
G8 ;childhood weight
 ...
 S BGPBBD=BGPBD-X,BGPBBD=$E(BGPBBD,1,3)_$E(BGPBD,4,7)
 S BGPBED=BGPED-X,BGPBED=$E(BGPBED,1,3)_$E(BGPED,4,7)
 S BGPX=0 F  S BGPX=$O(^BGPEOCE(BGPX)) Q:'BGPX  I BGPX S V=^BGPEOCE(BGPX,0) D
 .Q:$P(V,U)'=BGPBD
 .Q:$P(V,U,2)'=BGPED
 .Q:$P(V,U,7)'=BGPPER
 .Q:$P(V,U,12)'=8
 .;Q:'$O(^BGPEOCE(BGPX,88888,0))
 .Q:$P(V,U,5)'=BGPBBD
 .Q:$P(V,U,6)'=BGPBED
 .Q:$P(V,U,14)'=BGPBEN
 . S BGPSU=$E($$SU($P(V,U,11)),1,10)
 . S BGPFAC=$E($$FAC($P(V,U,9)),1,13)_$S($P(^BGPEOCE(BGPX,0),U,17):" (CHS ONLY)",1:"")
 . S BGPEBD=$$DATE^BGP8UTL($P(V,U))
 . S BGPEED=$$DATE^BGP8UTL($P(V,U,2))
 . S BGPEBBD=$$DATE^BGP8UTL($P(V,U,5))
 . S BGPEBED=$$DATE^BGP8UTL($P(V,U,6))
