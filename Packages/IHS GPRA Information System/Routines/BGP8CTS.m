...
EN ;EP -- main entry point for 
 D EN^VALM("BGP 08 CRS TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2008 "_BGPRPTT2_" REPORTING"
 Q
 ;
INIT ;EP -- init variables and list array
 ...
 .Q:$P(^BGPTAXE(BGPY,0),U,4)'=1
 .I BGPRPTT1=9 Q:'$O(^BGPTAXE(BGPY,12,0))
 .I BGPRPTT1'=9,'$D(^BGPTAXE(BGPY,12,"B",BGPRPTT1)) Q
...
ADD ;EP - add an item to the selected list - called from a protocol
 ...
 S BGPTAXI=$P(BGPTAX("IDX",Y,Y),U,1),BGPTAXT=$P(BGPTAX("IDX",Y,Y),U,2),BGPTAXE=$P(BGPTAX("IDX",Y,Y),U,3),BGPEDIT=$P(^BGPTAXE(BGPTAXE,0),U,4)
