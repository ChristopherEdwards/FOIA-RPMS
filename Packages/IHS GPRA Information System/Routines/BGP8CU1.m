BGP8CU1 ; IHS/CMI/LAB - calc CMS measures 26 Sep 2004 11:28 AM 04 May 2008 2:38 PM 30 Oct 2007 11:26 AM ; 
...
WARRX(P,BDATE,EDATE,EXP,BGPY) ;EP
 ...
 S BGPC=0
 K BGPY
 D GETMEDS^BGP8CU(P,BDATE,EDATE,"BGP CMS WARFARIN MEDS","BGP CMS WARFARIN MEDS NDC","BGP CMS WARFARIN MEDS CLASS",EXP,EDATE,"WARFARIN",0)
 Q
 ;
...
ALLALG1(P,EDATE,DSCH,BGPY) ;EP
 ...
 .Q:D>EDATE
 .I Z=2 D  Q
 ..S BGPC=BGPC+1,BGPY(BGPC)="NO ALLERGY NOTED ON "_$$DATE^BGP8UTL(D)
 .S N=$P(^AUTNPOV(+$P(^AUPNPROB(X,0),U,5),0),U,1)
 .I N="" S N="???"
 .S BGPC=BGPC+1,BGPY(BGPC)="["_I_"]  "_N_"  "_$$DATE^BGP8UTL(D)
 .Q
 K BGPG
...
EJECFRAC(P,BDATE,EDATE,BGPY,BGPC) ;EP - now get all measurements CEF
 ...
 ..I V<BDATE Q
 ..I V>EDATE Q  ;after discharge
 ..S BGPC=BGPC+1,BGPY(BGPC)="CEF CPT:  "_$$DATE^BGP8UTL(V)_"  ["_Y_"]  "_$P($$CPT^ICPTCOD(I),U,3)
 Q
