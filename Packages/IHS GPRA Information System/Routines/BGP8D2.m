...
DMGC ;EP - called from elder care 
 ...
 S BGPVALUE=$S(BGPDMD1:"UP",1:"")_$S(BGPDMD2:",AD",1:"")_$S(BGPDMD3:",AAD",1:"")_"||| "_$$DATE^BGP8UTL($P(BGPLHGB,U,3))_" "_$P(BGPLHGB,U,4)
...
DMLDL ;EP - called from elder care
 ...
 ;I $P(BGPLP,U) S BGPVALUE=BGPVALUE_$S($P(BGPLP,U):"LP: "_$$DATE^BGP8UTL($P(BGPLP,U,2))_" "_$P(BGPLP,U,3),1:"")
 ;I '$P(BGPLP,U),BGPTRI,BGPHDL,BGPLDL S BGPVALUE=BGPVALUE_"TRI:"_$$DATE^BGP8UTL($P(BGPTRI,U,2))_" HDL:"_$$DATE^BGP8UTL($P(BGPHDL,U,2))_" LDL:"_$$DATE^BGP8UTL($P(BGPLDL,U,2))
 I $P(BGPVALUE,"|||",2)]"" S BGPVALUE=BGPVALUE_" ; "
 I BGPLDL]"" S BGPVALUE=BGPVALUE_"LDL DONE: "_$$DATE^BGP8UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
