...
I2 ;EP
 ...
 S BGPLHGB=$$HGBA1C^BGP8D2(DFN,BGP365,BGPEDATE)
 S BGPN1=$P(BGPLHGB,U)
 S BGPVALUE=""
...
BPS ;
 ...
 ;I 'BGPN2 S BGPBP=$$BPCPT^BGP8D2(DFN,BGP365,BGPEDATE) I BGPBP]"" S BGPN2=1
 ;I BGPN2 S BGPVALUE=BGPVALUE_";BPs: "_$P(BGPBP,U)
 ;S BGPN7=$S($P(BGPBP,U,2)=2:1,1:0)
23 ;
 S BGPLDL=$$LDL^BGP8D2(DFN,BGP365,BGPEDATE,1)
 S BGPN3=$P(BGPLDL,U)
 I BGPN3 S BGPVALUE=BGPVALUE_";LDL: "_$$DATE^BGP8UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
...
24 ;micro or pos urine AND GFR
 ...
 ;S BGPGFR=$$GFR^BGP8D21(DFN,BGP365,BGPEDATE)
...
25 ;
 ...
 I BGPN5 S BGPVALUE=BGPVALUE_";EYE: "_$$DATE^BGP8UTL($P(BGPEYE,U,2))_" "_$P(BGPEYE,U,3)
 K BGPG
 K ^TMP($J,"A")
26 ;FOOT EXAM
 S BGPFOOT=$$FOOT(DFN,BGPBDATE,BGPEDATE)
 S BGPN8=$P(BGPFOOT,U)
 I BGPN8 S BGPVALUE=BGPVALUE_";FOOT EXAM: "_$$DATE^BGP8UTL($P(BGPFOOT,U,2))_" "_$P(BGPFOOT,U,3)
...
IOMW ;EP
 ...
 S BGPFRAC=$$FRACTURE^BGP8EL3(DFN,$$FMADD^XLFDT(BGPBDATE,-180),$$FMADD^XLFDT(BGPBDATE,180))
 I '$P(BGPFRAC,U) S BGPSTOP=1 Q
 I BGPACTCL S BGPD1=1
 I BGPACTUP S BGPD2=1
 S BGPISD=$P(BGPFRAC,U,2),BGPISV=$P(BGPFRAC,U,3),BGPISV=$P(BGPFRAC,U,4)
 S BGPBMD=""
 I $P(BGPFRAC,U,3)="H" S BGPBMD=$$TXBMD^BGP8EL4(DFN,$P($P(^AUPNVSIT(BGPISV,0),U),"."),$$DSCHDATE^APCLV(BGPISV,"I"),1)
 I $P(BGPFRAC,U,3)'="H" S BGPBMD=$$TXBMD^BGP8EL4(DFN,BGPISD,$$FMADD^XLFDT(BGPISD,180))
 I $P(BGPBMD,U) S BGPN1=1
 S BGPVALUE=$S(BGPRTYPE=3:"AC",BGPD1:"UP,AC",1:"UP")
 S Y=""
 F X=5,6,7 S V=$P(BGPFRAC,U,X) I V]"" S:Y]"" Y=Y_";" S Y=Y_V
 S BGPVALUE=BGPVALUE_" Fracture: "_Y_" on "_$$DATE^BGP8UTL($P(BGPFRAC,U,2))_"|||"_$P(BGPBMD,U,2)
...
IL ;EP
 ...
 I $P(BGPGFR,U) S BGPVALUE=BGPVALUE_"GFR: "_$$DATE^BGP8UTL($P(BGPGFR,U,3))_" "_$P(BGPGFR,U,2)
 K BGPGFR
 Q
...
ASSEV(P,EDATE) ;NOW CHECK ASTHMA PACKAGE SEVERITY
 ...
 ..I S>1 S G="1^Severity > 1 in V Asthma "_$$DATE^BGP8UTL((9999999-D))
 Q G
NDC(A,B) ;
 ;a is drug ien
 ;b is taxonomy ien
...
FOOT(P,BDATE,EDATE) ;
 ...
 S X=0,Y=0 F  S X=$O(^TMP($J,"A",X)) Q:X'=+X!(Y)  S R=$$CLINIC^APCLV($P(^TMP($J,"A",X),U,5),"C") I R=65,'$$DNKA^BGP8D21($P(^TMP($J,"A",X),U,5)) S Y=1,D=$P(^TMP($J,"A",X),U)
 I Y Q 1_"^"_D_"^Cl: "_R
 ...
 S G=$$CPTI^BGP8DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("2028F"))
 I G Q G_"^CPT: 2028F"
