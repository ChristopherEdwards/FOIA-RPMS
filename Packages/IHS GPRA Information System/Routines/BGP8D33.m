...
OPV(P,EDATE) ;EP
 ...
 I $$PLTAX^BGP8DU(P,"BGP OPV EVID DISEASE") Q 4_U_"evid opv"
 ...
 I $$PLTAX^BGP8DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"contra opv"
 F BGPZ=2,89 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - OPV"
 F BGPZ=10,89,110,120 S X=$$ANNECONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=2,89,10,110,120 S R=$$IMMREF^BGP8D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q 3_U_"ref OPV"
 Q ""
MMR(P,EDATE) ;EP
 K BGPC,BGPG,BGPX
