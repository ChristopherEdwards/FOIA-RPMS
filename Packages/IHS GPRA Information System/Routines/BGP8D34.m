...
EVIDTET ;
 ...
 I $$PLCODE^BGP8DU(P,"037.") S BGPEVTD=1
 D RESETD
...
EVIDPER ;
 ...
 I $$PLTAX^BGP8DU(P,"BGP PERTUSSIS EVIDENCE") S BGPEVPER=1
 D RESETD
...
EVIDDIP ;
 ...
 I $$PLTAX^BGP8DU(P,"BGP DIPHTHERIA EVIDENCE") S BGPEVDIP=1
 D RESETD
...
REF ;
 ...
 F BGPIMM=20,50,106,107,110,1,22,102,115,120 Q:R  S R=$$IMMREF^BGP8D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ...
 F BGPZ=20,80,106,107,110,120 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
