BGP8D36 ; IHS/CMI/LAB - measure C 06 Nov 2007 2:03 PM ; 
...
MEN(P,EDATE) ;EP
 ...
 F BGPZ=32,108,114 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=32,108,114 S R=$$IMMREF^BGP8D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
HPV(P,EDATE) ;EP
 ...
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"ref")_" HPV"
 F BGPZ=62,118 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
