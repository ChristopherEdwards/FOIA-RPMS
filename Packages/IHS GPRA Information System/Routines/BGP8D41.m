...
I0302A ;EP
 ...
 S BGPIHD=$$IHD^BGP8D721(DFN,BGPBDATE,BGPEDATE)
...
I0302ASC ;EP
 ...
 S %=$S($P(BGPLDL,U,2):"LDL: "_$$DATE^BGP8UTL($P(BGPLDL,U,2)),1:"")
 ...
 I %]"" S BGPVALUE=BGPVALUE_" "_%
 S %=$S($P(BGPLIFE,U):"LIFE: "_$$DATE^BGP8UTL($P(BGPLIFE,U,2))_":"_$P(BGPLIFE,U,3),1:"")
 I %]"" S BGPVALUE=BGPVALUE_" "_%
...
I0302 ;EP
 ...
 I BGPACTCL,$$IHD^BGP8D721(DFN,BGP365,BGPEDATE) S BGPIHD=1,BGPD3=1
...
BPCV ;EP - called from elder care routine
 ...
 I BGPVALUE["unknown" S BGPVALUE=$$BPCPT^BGP8D22(DFN,$$FMADD^XLFDT(BGPEDATE,-(2*365)),BGPEDATE) I BGPVALUE]"" S BGPN1=1,BGPVALUE=$P(BGPVALUE,U,2) G V  ;CPTS COUNT IN NUMERATOR 1 ONLY
