...
I031 ;EP
 ...
 S BGPXPNV=$$SB^BGP8PDL1($J($P(BGPBMI,U),6,2)) S:BGPXPNV="0.00" BGPXPNV=""
 ...
 S BGPVALUE=BGPVALUE_"|||"_$S(BGPBMI]"":$$SB^BGP8PDL1($J($P(BGPBMI,U),6,2)),1:"")_$S(BGPN2:" OW",1:"")_$S(BGPN3:" OB",1:"")
...
I031A ;
 ...
 I $P(BGPBMI,U)]"" S BGPVALUE=BGPVALUE_"|||"_$P(BGPBMI,U)_":"_$$DATE^BGP8UTL($P(BGPBMI,U,2))_" Age at BMI: "_A
