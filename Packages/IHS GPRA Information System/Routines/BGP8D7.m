...
TA ;EP - called from elder
 ...
 I BGP1320]"" S S=S_" 1320 ADA "_$$DATE^BGP8UTL($P(BGP1320,U,2))
 I BGPSDX]"" S S=S_" DX "_$S($P(BGPSDX,U,1)="305.13":"quit",$P(BGPSDX,U,1)="V15.82":"V15.82",1:"Cur smk")_" "_$$DATE^BGP8UTL($P(BGPSDX,U,2))
 I BGPXPED]"" S S=S_" PtEd "_$P(BGPXPED,U)_" "_$$DATE^BGP8UTL($P(BGPXPED,U,2))
 I BGPSCPT]"" S S=S_" CPT "_$P(BGPSCPT,U)_" "_$$DATE^BGP8UTL($P(BGPSCPT,U,2))
 S BGPVALUE=V_" "_S
...
CPTSM(P,BDATE,EDATE) ;EP - did pat have smoking cpt?
 NEW X
 S X=$$CPT^BGP8DU(P,BDATE,EDATE,$O(^ATXAX("B","BGP SMOKING CPTS",0)),5)
 I X]"" Q $P(X,U,2)_U_$P(X,U,1)
 ;S X=$$CPTI^BGP8DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("1034F"))
 ;I X Q "1034F"_U_$P(X,U,2)
 ;S X=$$CPTI^BGP8DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("1035F"))
 ;I X Q "1035F"_U_$P(X,U,2)
 ;S X=$$CPTI^BGP8DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("1036F"))
