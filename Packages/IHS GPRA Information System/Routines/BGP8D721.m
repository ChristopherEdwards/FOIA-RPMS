...
IAHRA ;EP
 ...
 I 'BGPN10 S BGPACE("CONTRA")=$$ACECONT^BGP8D722(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,BGPBDATE,BGPEDATE) I BGPACE("CONTRA") S BGPN12=1 ;beta contraindication
 ...
 I 'BGPN14 S BGPSTAT("REF")=$$STATREF^BGP8D722(DFN,BGPBDATE,BGPEDATE) I BGPSTAT("REF") S BGPN15=1
