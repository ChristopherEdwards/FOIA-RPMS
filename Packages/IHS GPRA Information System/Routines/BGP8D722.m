BGP8D722 ; IHS/CMI/LAB - measure AHR.A ;
...
ACECONT(P,BDATE,EDATE,NMIB,NMIE) ;EP does patient have an ACEI contraidication
 ...
 .Q
 I BGPG Q BGPG
 ;S X=$$CPTI^BGP8DU(P,NMIB,NMIE,+$$CODEN^ICPTCOD("G8029"))
 ;I X Q 1_U_"arb contra CPT code G8029: "_$$DATE^BGP8UTL($P(X,U,2))
 ;S X=$$TRANI^BGP8DU(P,NMIB,NMIE,+$$CODEN^ICPTCOD("G8029"))
...
STATALG(P,BDATE,EDATE,RPB,RPE) ;EP
 ...
 .I N["STATIN"!(N["STATINS") S BGPC=BGPC+1,BGPY(BGPC)=1_U_"alg statin POV:  "_$$DATE^BGP8UTL($P(BGPG(X),U))_"  ["_$P(BGPG(X),U,2)_"]  "_N
 I BGPC Q BGPC
