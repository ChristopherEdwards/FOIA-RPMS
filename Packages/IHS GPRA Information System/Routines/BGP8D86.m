BGP8D86 ; IHS/CMI/LAB - measure C 06 Nov 2007 2:26 PM ; 
...
IRAR ;EP
 ...
 I '$$RHEUAR^BGP8D862(DFN,BGPBDATE,BGPEDATE) S BGPSTOP=1 Q  ;no OSTEOARTHRITIS
 S BGPV=$$MEDSPRE^BGP8D863(DFN,BGPBDATE,BGPEDATE)
 ...
 K BGPIRZ,BGPIRV
 I $P(BGPV,U,2) D
 .S BGPCBC=$$CBC^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPLFT=$$LFT^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 .S BGPCREAT=$$CREAT^BGP8D22(DFN,BGPBDATE,BGPEDATE)
 .S BGPIRZ("A")=0,BGPIRV("A")="Has NSAID: "
 .I BGPCBC,BGPLFT,BGPCREAT S BGPIRZ("A")=1,BGPIRV("A")=BGPIRV("A")_" CREAT: "_$$DATE^BGP8UTL($P(BGPCREAT,U,2))_"CBC: "_$$DATE^BGP8UTL($P(BGPCBC,U,2))_" LFT: "_$$DATE^BGP8UTL($P(BGPLFT,U,2))  ;NA MEDS AND HAS CBC,LFT
 .I 'BGPCREAT S BGPIRV("A")=BGPIRV("A")_"No CREAT"
 .I 'BGPCBC S BGPIRV("A")=BGPIRV("A")_" No CBC"
 .I 'BGPLFT S BGPIRV("A")=BGPIRV("A")_" No LFT"
 I $P(BGPV,U,3) D
 .S BGPGOLD=$$GOLDLAB^BGP8D864(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,4) D
 .S BGPCBC=$$CBC4^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,5) D
 .S BGPCBC=$$CBC6^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 ...
 .S BGPSERUM=$$SERUM6^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 ...
 .S BGPLFT=$$LFT6^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,7) D
 .S BGPCBC=$$CBC^BGP8D861(DFN,$$FMADD^XLFDT(BGPEDATE,-180),BGPEDATE)
 ...
 .S BGPUP=$$UP4^BGP8D861(DFN,BGPBDATE,BGPEDATE)
 ...
 I $P(BGPV,U,12) D
 .S BGPGLU=$$GLUCOSE^BGP8D861(DFN,BGPBDATE,BGPEDATE)
...
TD ;
 ...
 F BGPZ=9,113 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
