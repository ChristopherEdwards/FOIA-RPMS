BGP8D87 ; IHS/CMI/LAB - measure calc ;
...
LSV(P,BDATE,EDATE,ADMDATE) ;
 ...
 I BGPG Q 1_"^"_$P(BGPG,U,3)_"^"_$$DATE^BGP8UTL($P(BGPG,U,3))_"^"_"Procedure: "_$P(BGPG,U,2)_"^^"_9000010.08_"^"_$P(BGPG,U,5)_"^"_$P(^AUPNVPRC($P(BGPG,U,5),0),U,3)
...
CEFMEAS(P,BDATE,EDATE) ;
 ...
 I $D(BGPX(1)) Q 1_"^"_$P(BGPX(1),U)_"^"_$$DATE^BGP8UTL($P(BGPX(1),U))_"^"_"CEF Measurement"_"^"_$P(BGPX(1),U,2)_"^"_9000010.01_"^"_+$P(BGPX(1),U,4)_"^"_$P(BGPX(1),U,5)
 Q ""
