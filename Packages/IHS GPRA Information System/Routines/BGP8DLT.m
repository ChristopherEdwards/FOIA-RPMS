...
START ;EP
 ...
 . S BGPPAGE=1
 . S BGPSUBH="Lab Taxonomies for the "_BGPRPTN_" Report"
 I '$G(BGPGUI) W:$D(IOF) @IOF  ;cmi/maw added 1/14/08
 W !,$$CTR("Lab Taxonomy Report",80)
 W !,$$CTR($$RPTVER^BGP8BAN,80)
INTRO ;
 W !!,"Site populated Lab Taxonomy Report for the ",BGPRPTN," Report",!
 S BGPSUBH="Lab Taxonomies for the "_BGPRPTN_" Report"
...
QUE ;
 ...
 S ZTRTN="PRINT^BGP8DLT",ZTDESC="BGP 08 LAB TAX REPORT",ZTIO=ION,ZTDTH=""
 D ^%ZTLOAD
 D HOME^%ZIS
 D XIT
 Q
...
N ;GATHER UP AND DISPLAY ALL NATIONAL GPRA
 ...
 .Q:$P(^BGPTAXE(BGPTIEN,0),U,2)'="L"  ;only lab taxonomies in this report
