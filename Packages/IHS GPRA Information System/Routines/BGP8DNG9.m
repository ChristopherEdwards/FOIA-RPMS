BGP8DNG9 ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;8.0;IHS CLINICAL REPORTING;**3**;MAR 12, 2008
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2009 National GPRA Report",80)
INTRO ;
 D XIT
 W !!,"This will produce a National GPRA report for the 2009 GPRA year."
 W !,"You will be asked to provide the community taxonomy to determine which patients"
 W !,"will be included.  This report will be run for the Report Period July 1, 2008"
 W !,"through June 30, 2009 with a Baseline Year of July 1, 1999 through"
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP8DNG9",XBRX="XIT^BGP8DNG9",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP8DNG9",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 08 for 09" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
