BGP8DP19 ; IHS/CMI/LAB - print ind 1 ; 03 Jul 2008  7:40 AM
 ;;8.0;IHS CLINICAL REPORTING;**2**;MAR 12, 2008
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="TOTAL USER POPULATION",BGPHD2="Total # User Pop"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDE(BGPIC,53,1,0)  D H9^BGP8DPH
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDE(BGPIC,53,1,0) D H9^BGP8DPH
