BGP8DPA4 ; IHS/CMI/LAB - COMP NATIONAL GPRA FOR PTS W/APPT 01 Oct 2007 2:53 PM ; 
...
EYE(P,BDATE,EDATE,FORECAST) ;EP
 ...
 .S X=$$CPT^BGP8DU(P,BDATE,EDATE,T,5) I X]"" Q
 .S X=$$TRAN^BGP8DU(P,BDATE,EDATE,T,5)
 S X=$$LASTPRCI^BGP8UTL1(P,"95.02",BDATE,EDATE) I X]"",$P(BGPLEYE,U,2)<$P(X,U,1) S BGPLEYE=3_U_$P(X,U,3)_U_"PROC: 95.02"
 Q BGPLEYE
