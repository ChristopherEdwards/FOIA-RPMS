BGP8DPAW ; IHS/CMI/LAB - COMP NATIONAL GPRA FOR PTS W/APPT 01 Oct 2007 1:20 PM ; 13 Aug 2008  11:32 AM
...
CPRINT ;
 ...
 .....D HEADER Q:$D(BGPQ)
 .....D SUB
 .....S BGPIC=0 F  S BGPIC=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"APPTS",BGPCLN,BGPD,BGPADT,BGPNAME,DFN,BGPIC)) Q:BGPIC'=+BGPIC!($D(BGPQ))  D
 ......S BGPI=0 F  S BGPI=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"APPTS",BGPCLN,BGPD,BGPADT,BGPNAME,DFN,BGPIC,BGPI)) Q:BGPI'=+BGPI!($D(BGPQ))  D
 .......I $Y>(IOSL-3) D HEADER Q:$D(BGPQ)  D SUB
 .......S Y=^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"APPTS",BGPCLN,BGPD,BGPADT,BGPNAME,DFN,BGPIC,BGPI)
 .......D WRITE
 .......;S BGPX=$P(Y,U,2)
...
DPRINT1 ;
 ...
 .....D HEADER Q:$D(BGPQ)
 .....D SUB
 .....S BGPIC=0 F  S BGPIC=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"APPTS",BGPDIVI,BGPCLN,BGPD,BGPADT,BGPNAME,DFN,BGPIC)) Q:BGPIC'=+BGPIC!($D(BGPQ))  D
 ......S BGPI=0 F  S BGPI=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"APPTS",BGPDIVI,BGPCLN,BGPD,BGPADT,BGPNAME,DFN,BGPIC,BGPI)) Q:BGPI'=+BGPI!($D(BGPQ))  D
 .......I $Y>(IOSL-3) D HEADER Q:$D(BGPQ)  D SUB
 .......S Y=^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"APPTS",BGPDIVI,BGPCLN,BGPD,BGPADT,BGPNAME,DFN,BGPIC,BGPI)
 .......D WRITE
 .......;
 .......;S BGPX=$P(Y,U,2)
 .......;S BGPT=$P(Y,U,1),BGPT1=$P(Y,U,4)
...
PPRINT ;
 ...
 .....D HEADER Q:$D(BGPQ)
 .....D SUB
 .....S BGPIC=0 F  S BGPIC=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"PATS",BGPNAME,DFN,BGPD,BGPCLN,BGPADT,BGPIC)) Q:BGPIC'=+BGPIC!($D(BGPQ))  D
 ......S BGPI=0 F  S BGPI=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"PATS",BGPNAME,DFN,BGPD,BGPCLN,BGPADT,BGPIC,BGPI)) Q:BGPI'=+BGPI!($D(BGPQ))  D
 .......I $Y>(IOSL-3) D HEADER Q:$D(BGPQ)  D SUB
 .......S Y=^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"PATS",BGPNAME,DFN,BGPD,BGPCLN,BGPADT,BGPIC,BGPI)
 .......D WRITE
 .......;
 .......;S BGPT=$P(Y,U,1),BGPT1=$P(Y,U,4)
 .......;W !,BGPT
...
WP ;
 K ^UTILITY($J,"W")
 S BGPZ=0
 S DIWL=28,DIWR=78,DIWF="" F  S BGPZ=$O(^BGPINDEC(BGPI,$S($G(BGPNGR09):1601,1:16),BGPZ)) Q:BGPZ'=+BGPZ  D
 .S X=^BGPINDEC(BGPI,$S($G(BGPNGR09):1601,1:16),BGPZ,0) D ^DIWP
 .Q
WPS ;
...
APRINT ;
 ...
 ..D HEADER Q:$D(BGPQ)
 ..D SUB
 ..S BGPIC=0 F  S BGPIC=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"ANY",BGPNAME,DFN,BGPIC)) Q:BGPIC'=+BGPIC!($D(BGPQ))  D
 ...S BGPI=0 F  S BGPI=$O(^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"ANY",BGPNAME,DFN,BGPIC,BGPI)) Q:BGPI'=+BGPI!($D(BGPQ))  D
 ....I $Y>(IOSL-3) D HEADER Q:$D(BGPQ)  D SUB
 ....S Y=^XTMP("BGP8DPA",BGPGPRAJ,BGPGPRAH,"ANY",BGPNAME,DFN,BGPIC,BGPI)
 ....D WRITE
 ....;S BGPX=$P(Y,U,2)
 ....;S BGPT=$P(Y,U,1),BGPT1=$P(Y,U,4)
 ....;W !,BGPT
