...
START ;
 ...
 ...W !?1,$P(^BGPINDEC(BGPPC,15),U,4)
 ...I $P(^BGPINDEC(BGPPC,15),U,7)]"" W !?1,$P(^BGPINDEC(BGPPC,15),U,7)
 ...
 ...W ?57,$P(^BGPINDEC(BGPPC,15),U,2),?68,$P(^BGPINDEC(BGPPC,15),U,3)
 ..E  D
 ...W !?1,$P(^BGPINDEC(BGPPC,15),U,4)
 ...I $P(^BGPINDEC(BGPPC,15),U,7)]"" W !?1,$P(^BGPINDEC(BGPPC,15),U,7)
 ...
 ...W ?57,$TR($P(^BGPINDEC(BGPPC,15),U,2),"$","^"),?68,$P(^BGPINDEC(BGPPC,15),U,3)
 ...I $P(^BGPINDEC(BGPPC,15),U,9)]""!($P(^BGPINDEC(BGPPC,15),U,10)]"")!($P(^BGPINDEC(BGPPC,15),U,11)]"") W !?57,$TR($P(^BGPINDEC(BGPPC,15),U,10),"$","^"),?68,$P(^BGPINDEC(BGPPC,15),U,11)
