BGP8DSPO ; IHS/CMI/LAB - IHS summary page ;
...
START ;
 ...
 ...W !?1,$P(^BGPINDEC(BGPPC,19),U,4)
 ...I $P(^BGPINDEC(BGPPC,19),U,7)]"" W !?1,$P(^BGPINDEC(BGPPC,19),U,7)
 ...
 ...W ?57,$P(^BGPINDEC(BGPPC,19),U,2),?68,$P(^BGPINDEC(BGPPC,19),U,3)
 ..E  D
 ...W !?1,$P(^BGPINDEC(BGPPC,19),U,4)
 ...I $P(^BGPINDEC(BGPPC,19),U,7)]"" W !?1,$P(^BGPINDEC(BGPPC,19),U,7)
 ...
 ...W ?57,$TR($P(^BGPINDEC(BGPPC,19),U,2),"$","^"),?68,$P(^BGPINDEC(BGPPC,19),U,3)
 ...I $P(^BGPINDEC(BGPPC,19),U,9)]""!($P(^BGPINDEC(BGPPC,19),U,10)]"")!($P(^BGPINDEC(BGPPC,19),U,11)]"") W !?57,$TR($P(^BGPINDEC(BGPPC,19),U,10),"$","^"),?68,$P(^BGPINDEC(BGPPC,19),U,11)
...
H1 ;
 ...
 W !?26,"Current",?34,"Previous",?43,"Baseline",?57,"2007",?68,"Goal"
 W !,$TR($J("",80)," ","-")
 Q
