BGP8EL1J ; IHS/CMI/LAB - print ind 1 ;
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIE(BGPIC,53,1,0) D H3
...
BL ;
 I $Y>(BGPIOSL-18) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIE(BGPIC,53,1,0) D H3
