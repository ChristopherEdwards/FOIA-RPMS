BGP8EL3 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2008 1:44 PM ;
...
IRAO ;EP
 ...
 I 'T W BGPBOMB Q
 I $$LASTDX^BGP8UTL1(DFN,"BGP OSTEOPOROSIS DXS",$P(^DPT(DFN,0),U,3),BGPEDATE) S BGPSTOP=1 Q  ;had osteoporosis dx
 S BGPPAP=$$OSTEOSCR^BGP8D42(DFN,$$FMADD^XLFDT(BGPBDATE,-(365*2)),BGPEDATE)
 I BGPPAP S BGPN1=1
 I $P(BGPPAP,U)=3 S BGPN2=1
 S BGPVALUE="AC"
 S BGPVALUE=BGPVALUE_"|||"_$P(BGPPAP,U,2)_" "_$$DATE^BGP8UTL($P(BGPPAP,U,3))_$S($P(BGPPAP,U,1)=3:" (refused)",1:"")
 K BGPPAP,X
 Q
 ;
IRAA ;EP
...
FRACTURE(P,BDATE,EDATE) ;EP
 ...
 K BGPG S Y="BGPG("
 S BGPG=$$FIRSTPRC^BGP8UTL1(P,"BGP FRACTURE PROCEDURES",BDATE,EDATE)
 I $P(BGPG,U)=1 D
 .S D=$P(BGPG,U,3)
 ...
 ;n
 ;
 S BGPX=$$TXBMD^BGP8EL4(P,$$FMADD^XLFDT(BGPISD,-365),$$FMADD^XLFDT(BGPISD,-1)) I $P(BGPX,U) S $P(BGPV(BGPISD,BGPISV),U,5)=$P(BGPX,U,2) Q ""
...
FRACT(P,FBD,FED) ;
 ...
 I BGPG Q 1
 ;
 S BGPG=$$FIRSTPRC^BGP8UTL1(P,"BGP FRACTURE PROCEDURES",FBD,FED)
 I $P(BGPG,U)=1 Q 1
 Q ""
