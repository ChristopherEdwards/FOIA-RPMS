BGP8EL31 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2008 1:44 PM ;
...
IELDASA ;EP
 ...
 S BGPVALUE="AC"_"|||"_$S(BGPN1:$$LAST^BGP8D31(DFN,BGP365,BGPEDATE),1:"")_" "_$S(BGPHOSPL:"H "_$$DATE^BGP8UTL($P(BGPHOSPL,U,2)),1:"")
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,T,BGPG
 Q
IELDPHA ;EP - PHN
 S (BGPD1,BGPD2,BGPD3,BGPD4,BGPD5)=0
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$PHNV^BGP8EL4(DFN,BGP365,BGPEDATE,BGPHOME)
 S BGPN1=BGPVALUE
