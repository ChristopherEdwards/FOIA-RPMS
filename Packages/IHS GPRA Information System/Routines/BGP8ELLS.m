BGP8ELLS ; IHS/CMI/LAB - print ind ; 01 Jul 2008  7:56 PM
...
I1AGEP ;
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,21) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,23) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,25) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,27) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,31) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,33) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,35) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,37) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAC(X),U,39) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
