...
BL ; 
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,21) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,23) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,25) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,27) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,31) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,33) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,35) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,37) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:3 S V=$P(BGPDAB(X),U,39) S Y=$$SB^BGP8ELL2($J(V,6,1)) D S(Y,,X+1)
