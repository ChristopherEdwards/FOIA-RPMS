BGP8GR2 ; IHS/CMI/LAB - BGPG Visual CRS Reports 12/30/2004 12:29:35 PM 27 Apr 2008 10:30 PM ;
 ;;8.0;IHS CLINICAL REPORTING;**2**;MAR 12, 2008
 ;
DEBUG(RETVAL,BGPSTR) ;
 D DEBUG^%Serenji("CMS^BGP8GR(.RETVAL,.BGPSTR)")
 Q
 ;
 ;
...
XP(RETVAL,BGPSTR) ;EP
 ...
 S BGPOPT="CR 08 COMPREHENSIVE NATIONAL EXPORT"
...
PED(RETVAL,BGPSTR) ;EP
 ...
 S BGPOPT="CRS 08 PATIENT EDUCATION REPORT"
 ...
 S RETVAL="^BGPTMP("_$J_")"
 S ^BGPTMP($J,BGPI)="T00250DATA"_$C(30)
 D EP^BGP8GPED(.BGPERR,DUZ,DUZ(2),BGPOPT,BGPCT,BGPTP,.BGPIND,BGPQTR,BGPRE,BGPBAS,BGPPATT,BGPLIST,.BGPLIST,BGPPRV,BGPPROV,BGPEXP,BGPOT,BGPRDT,BGPMFITI)
 S BGPI=BGPI+1
 S ^BGPTMP($J,BGPI)=+$G(BGPERR)_$C(30)
 S ^BGPTMP($J,BGPI+1)=$C(31)
 D EN^XBVK("BGP")
