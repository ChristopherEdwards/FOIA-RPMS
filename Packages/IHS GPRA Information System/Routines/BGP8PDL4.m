BGP8PDL4 ; IHS/CMI/LAB - print ind 1 ; 01 Jul 2008  8:04 PM
...
I031 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".7.3D",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".8.3D",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".9.3D",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".7.3E",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".8.3E",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".9.3E",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".7.3F",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".8.3F",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".9.3F",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".7.3G",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".8.3G",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".9.3G",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".7.3H",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".8.3H",0)) D PI1^BGP8PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDEC("OR",BGPORXX_".9.3H",0)) D PI1^BGP8PDL1
