BGP8PDLB ; IHS/CMI/LAB - print ind ; 03 Jul 2008  12:41 PM
...
I1AGE ;EP
 ...
 D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G)=0 F BGPX="22.17.1","22.17.2","22.17.3" D I1AGE1,I1AGE2,I1AGE3,I1AGE4,I1AGE5
 D I1AGEP
FEM ;
...
I1AGE1 ;
 S C=C+1
 S BGPF=BGPX_"A" S BGPPC=$O(^BGPINDEC("OR",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF=BGPX_"B" S BGPPC=$O(^BGPINDEC("OR",BGPF,0))
...
I1AGE3 ;
 S E=E+1
 S BGPF=BGPX_"C" S BGPPC=$O(^BGPINDEC("OR",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPINDEC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90533.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE4 ;
 S F=F+1
 S BGPF=BGPX_"D" S BGPPC=$O(^BGPINDEC("OR",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPINDEC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90533.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE5 ;
 S G=G+1
 S BGPF=BGPX_"E" S BGPPC=$O(^BGPINDEC("OR",BGPF,0))
 ;set 4th piece to numerator and 5th to %
 S BGPNF=$P(^BGPINDEC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90533.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
