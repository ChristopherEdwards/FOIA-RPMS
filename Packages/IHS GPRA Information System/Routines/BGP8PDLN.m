...
NONSUM ;EP
 ...
 ...S X=" "_$P(^BGPINDEC(BGPPC,15),U,4)
 ...I $P(^BGPINDEC(BGPPC,15),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDEC(BGPPC,15),U,7)
 ...
 ...S $P(X,U,5)=$P(^BGPINDEC(BGPPC,15),U,2),$P(X,U,6)=$P(^BGPINDEC(BGPPC,15),U,3)
 ...D S(X,1,1)
 ..E  D
 ...S X=" "_$P(^BGPINDEC(BGPPC,15),U,4)
 ...I $P(^BGPINDEC(BGPPC,15),U,7)]"" D S(X,1,1) S X=" "_$P(^BGPINDEC(BGPPC,15),U,7)
 ...
 ...S $P(X,U,5)=$TR($P(^BGPINDEC(BGPPC,15),U,2),"$","^"),$P(X,U,6)=$P(^BGPINDEC(BGPPC,15),U,3)
 ...D S(X,1,1)
 ...S X="" I $P(^BGPINDEC(BGPPC,15),U,9)]""!($P(^BGPINDEC(BGPPC,15),U,10)]"")!($P(^BGPINDEC(BGPPC,15),U,11)]"") S $P(X,U,5)=$TR($P(^BGPINDEC(BGPPC,15),U,10),"$","^") D
 ....S $P(X,U,6)=$P(^BGPINDEC(BGPPC,15),U,11)
 ...I X]"" D S(X,1,1)
 S X=" " D S(X,1,1)
...
SDP ;EP
 ...
 ..S X=" " D S(X,1,1)
 ..S XX=" "_$P(^BGPINDEC(BGPPC,15),U,4)
 ..I $P(^BGPINDEC(BGPPC,15),U,7)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDEC(BGPPC,15),U,7)
 ..I $P(^BGPINDEC(BGPPC,15),U,12)]"" D S(XX,1,1) S XX=" "_$P(^BGPINDEC(BGPPC,15),U,12)
 ...
 ..S $P(XX,U,6)=$P(^BGPINDEC(BGPPC,15),U,2),$P(XX,U,7)=$P(^BGPINDEC(BGPPC,15),U,3)
 ...
 ....;S Y="" I $P(^BGPINDEC(BGPPC,15),U,9)]""!($P(^BGPINDEC(BGPPC,15),U,10)]"") S $P(Y,U,6)=$TR($P(^BGPINDEC(BGPPC,15),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDEC(BGPPC,15),U,10),"$","^")
 ....S Y="" I $P(^BGPINDEC(BGPPC,15),U,9)]""!($P(^BGPINDEC(BGPPC,15),U,10)]"")!($P(^BGPINDEC(BGPPC,15),U,11)]"") S $P(Y,U,6)=$TR($P(^BGPINDEC(BGPPC,15),U,9),"$","^"),$P(Y,U,7)=$TR($P(^BGPINDEC(BGPPC,15),U,10),"$","^") D
 .....S $P(Y,U,8)=$P(^BGPINDEC(BGPPC,15),U,11)
 ....I Y]"" D S(Y,1,1)
 ...D S(X,1,1)
 S X=" " D S(X,1,1)
 S X=" * Non-GPRA measure included in the IHS GPRA report submitted to OMB to" D S(X,1,1)
