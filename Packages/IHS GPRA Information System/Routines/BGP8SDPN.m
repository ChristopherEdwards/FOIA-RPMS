...
START ;
 ...
 ..I $Y>(BGPIOSL-3) D HEADER Q:BGPQUIT
 ..W !!,$P(^BGPINDEC(BGPPC,15),U,4)
 ..I $P(^BGPINDEC(BGPPC,15),U,7)]"" W !,$P(^BGPINDEC(BGPPC,15),U,7)
 ..I $P(^BGPINDEC(BGPPC,15),U,12)]"" W !,$P(^BGPINDEC(BGPPC,15),U,12)
 ...
 ..W ?55,$P(^BGPINDEC(BGPPC,15),U,2),?65,$P(^BGPINDEC(BGPPC,15),U,3)
 ..I $P(^BGPINDEC(BGPPC,15),U,9)]""!($P(^BGPINDEC(BGPPC,15),U,10)]"")!($P(^BGPINDEC(BGPPC,15),U,11)]"") W !?55,$TR($P(^BGPINDEC(BGPPC,15),U,10),"$","^"),?65,$P(^BGPINDEC(BGPPC,15),U,11)
