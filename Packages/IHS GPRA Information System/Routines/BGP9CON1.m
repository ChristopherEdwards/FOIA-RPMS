BGP9CON1 ; IHS/CMI/LAB - measure AHR.A 30 May 2008 9:32 AM ; 
...
BETA ;EP - BETA BLOCKER CONTRAINDICATION/NMI REFUSAL
 ...
 S X=$$CPTI^BGP9DU(P,NMIB,NMIE,+$$CODEN^ICPTCOD("G8011"))
 I X Q "1^Beta Blocker contra CPT code G8011: "_$$DATE^BGP9UTL($P(X,U,2))
 S X=$$TRANI^BGP9DU(P,NMIB,NMIE,+$$CODEN^ICPTCOD("G8011"))
...
WAR71 .;
 ...
 S X=$$CPTI^BGP9DU(P,NMIB,NMIE,+$$CODEN^ICPTCOD("G8008"))
 I X Q 1_U_"asa contra CPT code G8008: "_$$DATE^BGP9UTL($P(X,U,2))
 S X=$$TRANI^BGP9DU(P,NMIB,NMIE,+$$CODEN^ICPTCOD("G8008"))
...
STATIN ;EP does patient have an STATIN contraidication
 ...
 .I T="BF-BC" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-BP" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-CS" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-EQ" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-FU" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-HC" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-ON" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-M" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-MK" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
 .I T="BF-N" S %=T_" "_$$DATE^BGP9UTL($P(BGPG(X),U)) Q
