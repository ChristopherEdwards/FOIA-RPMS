BGP9CU5 ; IHS/CMI/LAB - calc CMS measures 26 Sep 2004 11:28 AM 04 May 2008 2:38 PM ;
...
POSTINF(P,PD,PP) ;EP
 ...
 S X=$$LASTDX^BGP9UTL1(P,"BGP CMS POST-OPERATIVE INF DXS",PD,$$FMADD^XLFDT(PD,DAYS))
 I X Q $P(X,U,2)_" "_$$VAL^XBDIQ1(9000010.07,$P(X,U,5),.04)_"  "_$$DATE^BGP9UTL($P(X,U,3))
 Q ""
