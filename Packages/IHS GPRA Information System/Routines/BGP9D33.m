...
OPV(P,EDATE) ;EP
 ...
 I $$PLTAX^BGP9DU(P,"BGP OPV EVID DISEASE") Q 4_U_"evid opv"
 ...
 I $$PLTAX^BGP9DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"contra opv"
 F BGPZ=2,89 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"contra - OPV"
 F BGPZ=10,89,110,120,130 S X=$$ANNECONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=2,89,10,110,120 S R=$$IMMREF^BGP9D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q 3_U_"ref OPV"
 Q ""
MMR(P,EDATE) ;EP
 K BGPC,BGPG,BGPX
...
MRC ;
 F BGPZ=4 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
...
RMC ;
 F BGPZ=38 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
...
MEX ;
 ...
 F BGPZ=5 S X=$$MMRCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPME=4
MUX ;
 ...
 F BGPZ=7 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPMU=4
RUBX ;
 ...
 F BGPIMM=6 I $$IMMREF^BGP9D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE) S BGPRUB=3
 F BGPZ=6 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPRUB=4
