...
VAR(P,EDATE) ;EP
 ...
 I $$PLTAX^BGP9DU(P,"BGP VARICELLA EVIDENCE") Q 4_U_"evid var"
 ...
 I $$PLTAX^BGP9DU(P,"BGP VARICELLA CONTRA") Q 4_U_"contra var"
 F BGPZ=21,94 S X=$$MMRCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""
 ...
 F BGPIMM=21,94 S R=$$IMMREF^BGP9D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
HEP(P,EDATE) ;EP
 ...
 I $$PLTAX^BGP9DU(P,"BGP HEP EVIDENCE") Q 4_U_"evid hep"
 ;now go to refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
 ...
 ;now check refusals in imm pkg
 F BGPIMM=8,42,43,44,45,51,102,104,110 S R=$$IMMREF^BGP9D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"ref")_" hep"
 F BGPZ=8,42,43,44,45,51,102,104,110 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""  ;cmi/maw 12/17/07 missing edate
...
HIB(P,EDATE) ;EP
 ...
 ;I $$PLTAX^BGP9DU(P,"BGP HIB EVIDENCE") Q 4_U_"evid HIB"
 ;now go to refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
 ...
 ;now check refusals in imm pkg
 F BGPIMM=17,22,46,47,48,49,50,51,102,120 S R=$$IMMREF^BGP9D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"ref")_" hib"
 F BGPZ=17,22,46,47,48,49,50,51,102,120 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""  ;cmi/maw 12/17/07 missing edate
...
PNEUMO(P,EDATE) ;EP
 ...
 ;now check refusals in imm pkg
 F BGPIMM=33,100,109 S R=$$IMMREF^BGP9D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"ref")_" Pneumo"
 F BGPZ=33,100,109 S X=$$ANCONT^BGP9D31(P,BGPZ,EDATE) Q:X]""  ;cmi/maw 12/17/07 missing edate
