BGP9D51 ; IHS/CMI/LAB - measure I2 ;
...
ICRSAMM ;EP
 ...
 S BGPN2=$$EAPT^BGP9D52(DFN,$P(BGPC2,U),$$FMADD^XLFDT($P(BGPC2,U),114),84,30,114)
 S BGPN3=$$EAPT^BGP9D52(DFN,$P(BGPC2,U),$$FMADD^XLFDT($P(BGPC2,U),231),180,51,231)
 ...
 S BGPVALUE=BGPVALUE_" IESD: "_$$DATE^BGP9UTL($P(BGPC1,U,2))_"|||"_BGPV
