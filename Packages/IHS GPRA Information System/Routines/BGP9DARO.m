BGP9DARO ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM 01 Jul 2008 11:43 AM ; 
...
EISSEX ;
 ...
 .S BGPFONN1="CRSONMNT1"_$P(^AUTTLOC(DUZ(2),0),U,10)_2009063000000000_$$D^BGP9UTL(BGPNOW)_"_"_$$LZERO^BGP9UTL(BGPC,6)_".TXT"
 .S BGPFONN2="CRSONMNT2"_$P(^AUTTLOC(DUZ(2),0),U,10)_2009063000000000_$$D^BGP9UTL(BGPNOW)_"_"_$$LZERO^BGP9UTL(BGPC,6)_".TXT"
 .S BGPFONN3="CRSONMNT3"_$P(^AUTTLOC(DUZ(2),0),U,10)_2009063000000000_$$D^BGP9UTL(BGPNOW)_"_"_$$LZERO^BGP9UTL(BGPC,6)_".TXT"
 .Q
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP9DARO",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP9DARO",XBRX="EXIT^BGP9DARO",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
