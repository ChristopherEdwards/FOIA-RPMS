BGP9DCL ; IHS/CMI/LAB - national patient list 20 Dec 2004 9:24 AM ; 
...
SI ;
 ...
 ;get report type
 I $D(DIRUT) G XIT
 D RT^BGP9DSL I '$D(BGPLIST)!($D(BGPQUIT)) G XIT
 ;BEGIN TEST STUFF
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP9DCL",XBRX="XIT^BGP9DCL",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP9DCL",ZTDTH="",ZTDESC="COMPREHENSIVE PT LIST GPRA 06" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
...
ENDDATE ;
 ...
 W !,"January 4, 2008 and you type in 6/30/06 the system will assume the year"
 W !,"as 1906 since that is a date in the past.  You must type 6/30/2008 if you"
