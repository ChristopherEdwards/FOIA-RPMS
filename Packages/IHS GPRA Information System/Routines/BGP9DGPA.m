BGP9DGPA ; IHS/CMI/LAB - ihs area GPRA 02 Sep 2004 1:11 PM ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP9DGPA",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D EXIT Q
 Q
 ;
 K IOP,%ZIS I BGPROT="D",BGPDELT="F" D NODEV,EXIT Q
 K IOP,%ZIS W !! S %ZIS=$S(BGPDELT'="S":"PQM",1:"PM") D ^%ZIS
...
EXIT ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP9DGPA",XBRX="EXIT^BGP9DGPA",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
DISP ;
 ...
 W !,BGPC,?4,$$DATE^BGP9UTL($P(BGP0,U,1)),?13,$$DATE^BGP9UTL($P(BGP0,U,2)),?22,$$DATE^BGP9UTL($P(BGP0,U,5)),?32,$$DATE^BGP9UTL($P(BGP0,U,6)),?42,$E($$SU($P(BGP0,U,11)),1,15),?59,$E($$FAC($P(BGP0,U,9)),1,20)
 Q
