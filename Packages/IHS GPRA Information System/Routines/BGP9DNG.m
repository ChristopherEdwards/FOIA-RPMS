BGP9DNG ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ; 
 ;;9.0;IHS CLINICAL REPORTING;**1**;JUL 01, 2009
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2009 National GPRA & PART Report",80)
INTRO ;
 D XIT
...
ONEF ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP9DNG",XBRX="XIT^BGP9DNG",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP9DNG",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 09" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
