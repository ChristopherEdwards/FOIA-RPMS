BGP9DNGP ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ; 
 ;;9.0;IHS CLINICAL REPORTING;;JUL 1, 2009
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2009 National GPRA & PART Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
TP ;get time period
 D XIT
 S BGPRTYPE=1,BGP9RPTH="",BGPDESGP=""
DESG ;
 W !!
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP9DNGP",XBRX="XIT^BGP9DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP9DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA & PART REPORT 09 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
