BGP9DNGS ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ; 
 ;;9.0;IHS CLINICAL REPORTING;;JUL 1, 2009
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2009 National GPRA & PART Report Clinical Performance Summaries",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
TP ;get time period
 D XIT
 S BGPRTYPE=1,BGP9RPTH="",BGPSUMON=1
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP9DNGS",XBRX="XIT^BGP9DNGS",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP9DNGS",ZTDTH="",ZTDESC="NATIONAL GPRA & PART REPORT 09 SUM ONLY" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
