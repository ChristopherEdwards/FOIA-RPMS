BGP9DP11 ; IHS/CMI/LAB - print ind 1 ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP9DPH Q:BGPQUIT  W !,^BGPINDN(BGPIC,53,1,0) W:$D(^BGPINDN(BGPIC,53,2,0)) !,^BGPINDN(BGPIC,53,2,0)  D H3^BGP9DPH
...
PR ; 
 I $Y>(BGPIOSL-13) I '$G(BGPSUMON) D HEADER^BGP9DPH Q:BGPQUIT  W !,^BGPINDN(BGPIC,53,1,0) W:$D(^BGPINDN(BGPIC,53,2,0)) !,^BGPINDN(BGPIC,53,2,0) D H3^BGP9DPH
...
BL ;
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP9DPH Q:BGPQUIT  W !,^BGPINDN(BGPIC,53,1,0) W:$D(^BGPINDN(BGPIC,53,2,0)) !,^BGPINDN(BGPIC,53,2,0) D H3^BGP9DPH
