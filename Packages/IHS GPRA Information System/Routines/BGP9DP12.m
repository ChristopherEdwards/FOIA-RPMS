BGP9DP12 ; IHS/CMI/LAB - print ind 19 AGE DIST ;
 ;;9.0;IHS CLINICAL REPORTING;;JUL 1, 2009
 ;
 ;
I1AGE ;EP  special age tallies
 Q:$G(BGPSUMON)
 I BGPRTYPE=7 D ^BGP9DP13 Q
...
PR ; 
 I '$G(BGPSUMON) D HEADER^BGP9DPH Q:BGPQUIT  W !,^BGPINDN(BGPIC,53,1,0) W:$D(^BGPINDN(BGPIC,53,2,0)) !,^BGPINDN(BGPIC,53,2,0) D H4^BGP9DPH
