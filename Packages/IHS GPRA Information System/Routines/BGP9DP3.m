BGP9DP3 ; IHS/CMI/LAB - print ind 1 ;
...
I023 ;EP
 ...
 D H1 S BGPNODEN=1
 F BGPPC1=BGPORXX_".1" D PI^BGP9DP1C Q:BGPQUIT
 Q:BGPQUIT
...
PI ;EP
 ...
 .;I BGPRTYPE'=1 W !!,$P(^BGPINDNC(BGPPC,0),U,15)
 .;I BGPRTYPE=1 W !!
 .W:'$G(BGPSUMON) !! D
 ...
 .;I BGPRTYPE'=4,$P(^BGPINDNC(BGPPC,0),U,19)]"",$P(^BGPINDNC(BGPPC,0),U,19)'["GPRA" W !?1,$P(^BGPINDNC(BGPPC,0),U,19)
 .D H2
 Q
H2 ;EP
 Q:$G(BGPSUMON)
