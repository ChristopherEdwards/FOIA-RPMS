BGP9EL13 ; IHS/CMI/LAB - print ind 1 ;
 ;;9.0;IHS CLINICAL REPORTING;;JUL 1, 2009
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE DIABETIC PATIENTS =>55",BGPHD2="# Active Diabetics"
 D HEADER^BGP9DPH Q:BGPQUIT  W !,^BGPELIN(BGPIC,53,1,0)  D H3^BGP9EL12
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP9DPH Q:BGPQUIT  W !,^BGPELIN(BGPIC,53,1,0) D H3^BGP9EL12
