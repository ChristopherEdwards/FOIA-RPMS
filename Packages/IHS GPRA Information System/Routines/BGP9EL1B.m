BGP9EL1B ; IHS/CMI/LAB - print ind 1 ;
...
I1AGEP ;
 ...
 S BGPL1="w/ CRC Screening",BGPL2="(GPRA)",P1=2,P2=3 D DSP
 S BGPL1="A. Refusals w/ of",BGPL2="Total CRC",P1=4,P2=5 D DSP
...
PR ; 
 ...
 S BGPL1="w/ CRC Screening",BGPL2="(GPRA)",P1=2,P2=3 D DSPP
 S BGPL1="A. Refusals w/ of",BGPL2="Total CRC",P1=4,P2=5 D DSPP
...
BL ;
 ...
 S BGPL1="w/ CRC Screening",BGPL2="(GPRA)",P1=2,P2=3 D DSPB
 S BGPL1="A. Refusals w/ of",BGPL2="Total CRC",P1=4,P2=5 D DSPB
