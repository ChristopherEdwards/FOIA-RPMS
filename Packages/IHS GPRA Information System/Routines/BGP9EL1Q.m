BGP9EL1Q ; IHS/CMI/LAB - print ind ;
 ;;9.0;IHS CLINICAL REPORTING;;JUL 1, 2009
 ;
I1AGEP ;EP
PR ; 
 D HEADER^BGP9DPH W !,^BGPELIN(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3^BGP9EL1P S X=" " D S(X,1,1)
...
S(Y,F,P) ;set up array
 ;Q:BGPQUIT
 ;I $Y>(IOSL-5) D HEADER^BGP9DPH Q:BGPQUIT
 ;W !,^BGPELIN(BGPIC,53,1,0) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 I $G(F) F J=1:1:F W !
