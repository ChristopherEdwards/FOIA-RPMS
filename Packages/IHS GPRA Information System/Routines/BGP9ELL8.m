BGP9ELL8 ; IHS/CMI/LAB - print ind ;
...
I1AGE ;EP
 ...
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="DDB.1","DDB.2","DDB.3","DDB.4" D I1AGE1,I1AGE2
 D I1AGEP
 Q
I1AGE1 ;
 S C=C+1
...
I1AGEP ;
 ...
 S X="# w/dental visit or refusal in past yr" D S(X,1,1)
