BGP9ELLA ; IHS/CMI/LAB - print ind ;
...
I1AGE ;EP
 ...
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="IIB.1","IIB.2","IIB.3","IIB.4" D I1AGE1,I1AGE2,I1AGE3
 D I1AGEP
 Q
I1AGE1 ;
 S C=C+1
...
PR ; 
 ...
 S X="% B. w/ Contraind/NMI Ref w/ % of Total IZ" D S(X,1,1)
