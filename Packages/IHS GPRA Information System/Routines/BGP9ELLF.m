BGP9ELLF ; IHS/CMI/LAB - print ind ;
...
I1AGEP ;
 ...
 S X="# w/IPV/DV screening or refusal (GPRA)" D S(X,1,1)
 ...
 S X=" " D S(X,1,1)
 S X="D. # documented refusal" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAC(X),U,10) S Y=V D S(Y,,X+1)
 S X="% D. documented refusal w/ % of total screened" D S(X,1,1)
...
PR ; 
 ...
 S X=" " D S(X,1,1) S X="D. # documented refusal" D S(X,1,1)
