BGP9GACW ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT 01 Jul 2008 7:57 PM ; 
...
TESTCHW ;
 ...
 D EP(.ERR,1,2522,"BGP 09 AREA GPRA","A",.BGPSUL,$$NOW^XLFDT)
 W !,ERR
 Q
...
EP1 ;
 ...
 S BGPRTYPE=1,BGPBEN=1,BGP9RPTH="",BGPCHWE=1
 ...
 S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP9DCHA(BGPBBD)_$$D^BGP9DCHA(BGPED)_BGPNOW_".TXT"
 S BGPASUF=$P(^AUTTLOC(DUZ(2),0),U,10)
 S BGPDELT=""
...
TSKMN ;
 ;S ZTIO=""
 ;K ZTSAVE S ZTSAVE("*")=""
 ;S ZTCPU=$G(IOCPU),ZTRTN="AOCHW^BGP9GACW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI CHILDHOOD HT/WT EXPORT" D ^%ZTLOAD Q
 D AOCHW
 Q
AOCHW ;
 K ^TMP($J,"BGPGUI")
