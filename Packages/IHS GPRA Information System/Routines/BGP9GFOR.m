BGP9GFOR ; IHS/CMI/LAB - GUI Patient Forecast Report ;
...
EP1 ;
 ...
 S DIC="^BGPGUIN(",DIC(0)="L",DIADD=1,DLAYGO=90537.08,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///"_$G(BGPROT)_";.08///"_$G(BGPFILE)
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="GUIP^BGP9GFOR",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI GPU GPRA REPORT 06" D ^%ZTLOAD Q
 Q
GUIP ;
 D PROC^BGP9DPA
 K ^TMP($J,"BGP9DPA")
