BGP9GNT9 ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2008 10:56 PM 13 Dec 2006 7:35 AM ;
...
EP1 ;
 ...
 S BGPGUI=1
 S IOM=80,BGPIOSL=55
 S BGPRTYPE=1,BGP9RPTH="",BGPNGR09=1
 ...
 S BGPFILEN="BG09"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
 I BGPYWCHW=2 D
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP9GNT9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATL GPRA RPT 09 FOR 10" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP9D1
 K ^TMP($J,"BGPGUI")
 ...
 ;I $G(BGPYWCHW)=2 D HWSF^BGP9DNG9
 D ENDLOG
 D XIT
 Q
 ;
