BGP9GNTL ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2008 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;9.0;IHS CLINICAL REPORTING;**1**;JUL 01, 2009
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 09 NATIONAL GPRA REPORT",597,0,"B",$$NOW^XLFDT,,0)
 W !,ERR
 Q
...
NT ;
 ...
 S BGPEXCEL=""
 I BGPEXPT S BGPYWCHW=$S($P($G(^BGPSITE(DUZ(2),0)),U,11)=0:0,1:1)
 ...
 .S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP9UTL(BGPBD)_$$D^BGP9UTL(BGPED)_$$D^BGP9UTL(BGPNOW)_"_000001"_".TXT"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP9GNTL",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 06" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP9D1
 K ^TMP($J,"BGPGUI")
