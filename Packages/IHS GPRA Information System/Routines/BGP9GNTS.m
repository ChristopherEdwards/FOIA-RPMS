BGP9GNTS ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2008 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;9.0;IHS CLINICAL REPORTING;**1**;JUL 01, 2009
 ;
 ;
TESTNTL ;
 S ERR=""
 D EPSUM(.ERR,1,2582,"BGP 09 NATIONAL GPRA RPT SUM",597,0,"B",$$NOW^XLFDT)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP9GNTS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 09 SUM" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP9D1
 K ^TMP($J,"BGPGUI")
