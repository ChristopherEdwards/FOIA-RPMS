BGP9PDL2 ; IHS/CMI/LAB - print ind 1 ;
...
ISTI ;EP
 ...
 ;
 K BGPNODEN
 F BGPPC1=BGPORXX_".7",BGPORXX_".8",BGPORXX_".9" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".10",BGPORXX_".11",BGPORXX_".12" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".13",BGPORXX_".14",BGPORXX_".15" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".16",BGPORXX_".17",BGPORXX_".18" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".19",BGPORXX_".20",BGPORXX_".21" D PI^BGP9PDL1 ;
 ;
 ;USER POP
 D S(" ",1,1)
 S BGPNODEN=1
 ...
 K BGPNODEN
 F BGPPC1=BGPORXX_".28",BGPORXX_".29",BGPORXX_".30" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".31",BGPORXX_".32",BGPORXX_".33" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".34",BGPORXX_".35",BGPORXX_".36" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".37",BGPORXX_".38",BGPORXX_".39" D PI^BGP9PDL1 ;
 ;
 F BGPPC1=BGPORXX_".40",BGPORXX_".41",BGPORXX_".42" D PI^BGP9PDL1 ;
 ;
 Q
IPC ;EP
 S BGPORXX=$P(^BGPINDN(BGPIC,0),U,6)
...
PI1 ;EP
 ...
 ;S X=$P(^BGPINDNC(BGPPC,0),U,15) D S(X,1,1)
 ;I $P(^BGPINDNC(BGPPC,0),U,16)]"" S X=$P(^BGPINDNC(BGPPC,0),U,16) D S(X,1,1)
 ;I $P(^BGPINDNC(BGPPC,0),U,19)]"" S Y=$P(^BGPINDNC(BGPPC,0),U,19) D S(Y,1,1)
