BGP9ULF1 ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED 02 Jul 2008 9:38 AM ; 
...
PROCEO ;EP
 ...
 ;add entry
 L +^BGPEOCN:10 I '$T W !!,"unable to lock global. TRY LATER" D EOJ^BGP9ULF Q
 L +^BGPEOPN:10 I '$T W !!,"unable to lock global. TRY LATER" D EOJ^BGP9ULF Q
 L +^BGPEOBN:10 I '$T W !!,"unable to lock global. TRY LATER" D EOJ^BGP9ULF Q
 D GETIEN^BGP9EOUT
 I 'BGPIEN W !!,"error in file creation...call programmer." D EOJ^BGP9ULF Q
ELCY ;
 S DINUM=BGPIEN,X=$P(BGP0,U),DLAYGO=90538.1,DIC="^BGPEOCN(",DIC(0)="L"
 K DD,D0,DO
 D FILE^DICN
 I Y=-1 W !,"error uploading file......" H 4 D EOJ^BGP9ULF Q
 S BGPIEN=+Y
 D ^XBFMK
