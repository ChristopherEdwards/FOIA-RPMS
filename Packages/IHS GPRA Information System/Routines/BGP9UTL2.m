BGP9UTL2 ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED ; 30 Jun 2009  9:01 AM
...
RCIS(P,BDATE,EDATE,ICDC,CPTC) ;EP
 ...
 Q 1_"^"_$P($P(^BMCREF(G,0),U),".")_"^"_$$DATE^BGP9UTL($P($P(^BMCREF(G,0),U),"."))_"^"_"RCIS referral"_"^"_X_"^"_"90001"_"^"_G
