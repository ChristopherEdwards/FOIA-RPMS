BGP9XTEO ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 CRS REPORT ;
 ;;9.0;IHS CLINICAL REPORTING;;JUL 1, 2009
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2009 Executive Order Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP9XTEO",XBNS="",XBRX="XIT^BGP9XTEO"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
GUICHK ;EP
 ...
 .Q:'$D(^BGPTAXN(BGPY,12,"B",8))  ;8 IS SET OF CODES FOR EO REPORT
