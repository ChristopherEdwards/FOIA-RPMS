BGPMUAP1 ; IHS/MSC/MGH - MU EP  measures NQF0421 and NQF0013 ;22-Mar-2011 10:06;DU
 ;;16.0;IHS CLINICAL REPORTING;;NOV 09, 2015;Build 159
...
421(TF) ;Get the numbers for this measure
 ...
 I NNUM1=0 S (PC1,PC14)=0  ;/IHS/BEM/RAM
 I DEN1>0 D
 .S:NNUM1'=0 PC1=$$ROUND^BGPMUA01((NUM1/NNUM1),3)*100
 .S PC11=$$ROUND^BGPMUA01((NNUM1/DEN1),3)*100
 .S PC13=$$ROUND^BGPMUA01((EXC1/DEN1),3)*100
 .S:NNUM1'=0 PC14=$$ROUND^BGPMUA01((NOT1/NNUM1),3)*100
 I DEN2=0 S (PC2,PC21,PC23,PC24)=0
 I NNUM2=0 S (PC2,PC24)=""
 I DEN2>0 D
 .S:NNUM2'=0 PC2=$$ROUND^BGPMUA01((NUM2/NNUM2),3)*100
 .S PC21=$$ROUND^BGPMUA01((NNUM2/DEN2),3)*100
 .S PC23=$$ROUND^BGPMUA01((EXC2/DEN2),3)*100
 .S:NNUM2'=0 PC24=$$ROUND^BGPMUA01((NOT2/NNUM2),3)*100
