BGPMUFD9 ; IHS/MSC/MGH - MU EP measures NQF0052 ;02-Mar-2011 11:26;DU
...
P1 ;Write individual measure
 ...
 S STRING2=$$NUM52("P")
 S STRING3=$$NUM52("B")
 D SUMMARY1^BGPMUFP9(STRING1,STRING2,STRING3)
 ;population
 ...
 D S^BGPMUDEL(X,2,1)
 S X="Pts 18-49 w/low back pain"_U_$P(STRING1,U,1)_U_U_$P(STRING2,U,1)_U_U_U_$P(STRING3,U,1)
 D S^BGPMUDEL(X,1,1)
 S X="# w/o spinal imaging"_U_$P(STRING1,U,2)_U_$J($P(STRING1,U,5),5,1)_U_$P(STRING2,U,2)_U_$J($P(STRING2,U,5),5,1)_U_$FN(PRD1,",+",1)_U_$P(STRING3,U,2)_U_$J($P(STRING3,U,5),5,1)_U_$FN(PRN1,",+",1)
 D S^BGPMUDEL(X,2,1)
 S X="# w/spinal imaging"_U_$P(STRING1,U,8)_U_$J($P(STRING1,U,9),5,1)_U_$P(STRING2,U,8)_U_$J($P(STRING2,U,9),5,1)_U_$FN(PRD7,",+",1)_U_$P(STRING3,U,8)_U_$J($P(STRING3,U,9),5,1)_U_$FN(PRN7,",+",1)
 D S^BGPMUDEL(X,1,1)
...
P2 ;Do the Details
 ...
 S X="Patients 18-49 with a primary diagnosis of low back pain and who had an" D S^BGPMUDEL(X,1,1)
 S X="emergency department, outpatient, orthopedic, or chiropractic encounter with" D S^BGPMUDEL(X,1,1)
 S X="the EP during the reporting period and who DID NOT HAVE an imaging study" D S^BGPMUDEL(X,1,1)
 S X="within 28 days of the FIRST diagnosis of low back pain during the reporting" D S^BGPMUDEL(X,1,1)
 ...
 S X="The following are the abbreviations used in the denominatorcolumns:" D S^BGPMUDEL(X,2,1)
 S X="LBP=Low Back Pain Diagnosis" D S^BGPMUDEL(X,1,1)
