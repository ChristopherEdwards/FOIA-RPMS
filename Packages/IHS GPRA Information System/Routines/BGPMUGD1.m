BGPMUGD1 ; IHS/MSC/MMT - MU EP measures NQF0086 ;10-Aug-2011 11:26;DU
...
P1 ;Write individual measure
 ...
 S STRING2=$$NUM86("P")
 S STRING3=$$NUM86("B")
 D SUMMARY1^BGPMUGP1(STRING1,STRING2,STRING3)
 ;population
 ...
 D S^BGPMUDEL(X,2,1)
 S X="Pts 18+ w/POAG"_U_$P(STRING1,U,1)_U_U_$P(STRING2,U,1)_U_U_U_$P(STRING3,U,1) D S^BGPMUDEL(X,1,1)
 S X="# Excluded (Exc)"_U_$P(STRING1,U,4)_U_U_$P(STRING2,U,4)_U_U_U_$P(STRING3,U,4)
 D S^BGPMUDEL(X,1,1)
 S X="Pts 18+ w/POAG less Exc"_U_$P(STRING1,U,3)_U_U_$P(STRING2,U,3)_U_U_U_$P(STRING3,U,3)
 D S^BGPMUDEL(X,1,1)
 S X="# w/optic nerve head evaluation"_U_$P(STRING1,U,2)_U_$J($P(STRING1,U,5),5,1)_U_$P(STRING2,U,2)_U_$J($P(STRING2,U,5),5,1)_U_$FN(PRD1,",+",1)_U_$P(STRING3,U,2)_U_$J($P(STRING3,U,5),5,1)_U_$FN(PRN1,",+",1)
 D S^BGPMUDEL(X,2,1)
 S X="# w/o optic nerve head evaluation"_U_$P(STRING1,U,8)_U_$J($P(STRING1,U,9),5,1)_U_$P(STRING2,U,8)_U_$J($P(STRING2,U,9),5,1)_U_$FN(PRD7,",+",1)_U_$P(STRING3,U,8)_U_$J($P(STRING3,U,9),5,1)_U_$FN(PRN7,",+",1)
 D S^BGPMUDEL(X,1,1)
...
P2 ;Do the Details
 ...
 S X="Patients 18+ with a diagnosis of POAG and at least 2 domiciliary, nursing" D S^BGPMUDEL(X,1,1)
 S X="facility, office & outpatient consulting, or ophthalmological service" D S^BGPMUDEL(X,1,1)
 S X="encounters with the EP during the reporting period and who had an optic nerve" D S^BGPMUDEL(X,1,1)
 S X="head evaluation during one of these encounters, if any." D S^BGPMUDEL(X,1,1)
 ...
 S X="POAG=Primary Open Angle Glaucoma Diagnosis" D S^BGPMUDEL(X,1,1)
...
DATA(NODE) ;GET DATA
 ...
 S DEN=$P(NODE,U,2)
 S NUM=$P(NODE,U,3)
 S NUM1=$P(NUM,";",1),NUM2=$$DATE^BGPMUUTL($P($P(NUM,";",2),".",1))
