BGPMUGD3 ; IHS/MSC/MMT - MU EP measures NQF0001 ;20-Aug-2011 11:26;DU
...
P1 ;Write individual measure
 ...
 S STRING2=$$NUM01("P")
 S STRING3=$$NUM01("B")
 D SUMMARY1^BGPMUGP3(STRING1,STRING2,STRING3)
 ;population
 ...
 D S^BGPMUDEL(X,2,1)
 S X="Pts 5-40 w/asthma"_U_$P(STRING1,U,1)_U_U_$P(STRING2,U,1)_U_U_U_$P(STRING3,U,1)
 D S^BGPMUDEL(X,1,1)
 S X="# w/evaluated symptoms"_U_$P(STRING1,U,2)_U_$J($P(STRING1,U,5),5,1)_U_$P(STRING2,U,2)_U_$J($P(STRING2,U,5),5,1)_U_$FN(PRD1,",+",1)_U_$P(STRING3,U,2)_U_$J($P(STRING3,U,5),5,1)_U_$FN(PRN1,",+",1)
 D S^BGPMUDEL(X,2,1)
 S X="# w/o evaluated symptoms"_U_$P(STRING1,U,8)_U_$J($P(STRING1,U,9),5,1)_U_$P(STRING2,U,8)_U_$J($P(STRING2,U,9),5,1)_U_$FN(PRD7,",+",1)_U_$P(STRING3,U,8)_U_$J($P(STRING3,U,9),5,1)_U_$FN(PRN7,",+",1)
 D S^BGPMUDEL(X,1,1)
...
P2 ;Do the Details
 ...
 S X="Patients aged 5-40 years with a diagnosis of asthma who had at least 2" D S^BGPMUDEL(X,1,1)
 S X="office visits with the EP during the reporting period and who were" D S^BGPMUDEL(X,1,1)
 S X="evaluated during at least 1 office visit during the reporting period for" D S^BGPMUDEL(X,1,1)
 S X="the frequency (numeric) of daytime and nocturnal asthma symptoms, if any." D S^BGPMUDEL(X,1,1)
 ...
 S X="AC=Asthma Control" D S^BGPMUDEL(X,1,1)
 S X="CL=Asthma Classification" D S^BGPMUDEL(X,1,1)
 S X="CPT code=Asthma Symptons Evaluated" D S^BGPMUDEL(X,1,1)
