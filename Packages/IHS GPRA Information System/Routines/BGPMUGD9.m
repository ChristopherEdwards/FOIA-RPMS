BGPMUGD9 ; IHS/MSC/MMT - MU EP measures NQF0089 ;09-Sept-2011 11:26;DU
...
P1 ;Write individual measure
 ...
 S STRING2=$$NUM89("P")
 S STRING3=$$NUM89("B")
 D SUMMARY1^BGPMUGP9(STRING1,STRING2,STRING3)
 ;population
 ...
 D S^BGPMUDEL(X,2,1)
 S X="Pts 18+ w/diabetic retinopathy and macular or fundus exam"_U_$P(STRING1,U,1)_U_U_$P(STRING2,U,1)_U_U_U_$P(STRING3,U,1)
 D S^BGPMUDEL(X,1,1)
 S X="# Excluded (Exc)"_U_$P(STRING1,U,4)_U_U_$P(STRING2,U,4)_U_U_U_$P(STRING3,U,4)
 D S^BGPMUDEL(X,1,1)
 S X="Pts 18+ w/diabetic retinopathy and macular or fundus exam less Exc"_U_$P(STRING1,U,3)_U_U_$P(STRING2,U,3)_U_U_U_$P(STRING3,U,3)
 D S^BGPMUDEL(X,1,1)
 S X="# w/provider communication"_U_$P(STRING1,U,2)_U_$J($P(STRING1,U,5),5,1)_U_$P(STRING2,U,2)_U_$J($P(STRING2,U,5),5,1)_U_$FN(PRD1,",+",1)_U_$P(STRING3,U,2)_U_$J($P(STRING3,U,5),5,1)_U_$FN(PRN1,",+",1)
 D S^BGPMUDEL(X,2,1)
 S X="# w/o provider communication"_U_$P(STRING1,U,8)_U_$J($P(STRING1,U,9),5,1)_U_$P(STRING2,U,8)_U_$J($P(STRING2,U,9),5,1)_U_$FN(PRD7,",+",1)_U_$P(STRING3,U,8)_U_$J($P(STRING3,U,9),5,1)_U_$FN(PRN7,",+",1)
 D S^BGPMUDEL(X,1,1)
...
P2 ;Do the Details
 ...
 S X="Patients 18+ with 2 or more office & outpatient consultation," D S^BGPMUDEL(X,1,1)
 ...
 S X="AND who had a dilated macular or fundus exam performed with documented" D S^BGPMUDEL(X,1,1)
 S X="communication to the provider who manages the ongoing care of the diabetic" D S^BGPMUDEL(X,1,1)
 S X="patient regarding the findings of the macular or fundus exam at least once" D S^BGPMUDEL(X,1,1)
 ...
 S X="COMM=Exam Results Communicated to Provider Managing Diabetes Care" D S^BGPMUDEL(X,1,1)
