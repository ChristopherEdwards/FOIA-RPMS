BGPMUHD5 ; IHS/MSC/SAT - Delimited MU measure VTE1 and VTE2;07-Apr-2011 13:15;DU
 ...
 ;Delimited output for VTE Measure 0371
VTE1 ;EP
 D P1B
 K ^TMP("BGPMU0371")
 Q
P1B ;Write individual measure
 ...
 S BGPPROV=""
 S BGPPTYPE="D"
 S STRING1=$$371^BGPMUHP6("C")
 S STRING2=$$371^BGPMUHP6("P")
 S STRING3=$$371^BGPMUHP6("B")
 D SUM371
 ...
 D S^BGPMUDEL(X,1,1)
 S X="# Inpatient discharges"_U_$P(STRING1,U,1)_U_U_$P(STRING2,U,1)_U_U_U_$P(STRING3,U,1)_U_U
 D S^BGPMUDEL(X,1,1)
 S X="# Excluded (Exc)"_U_$P(STRING1,U,4)_U_U_$P(STRING2,U,4)_U_U_U_$P(STRING3,U,4)
 D S^BGPMUDEL(X,1,1)
 S X="# Inpatient discharges Less Exc"_U_($P(STRING1,U,1)-$P(STRING1,U,4))_U_U_($P(STRING2,U,1)-$P(STRING2,U,4))_U_U_U_($P(STRING3,U,1)-$P(STRING3,U,4))
 D S^BGPMUDEL(X,1,1)
 S X="# w/received VTE prophylaxis"_U_$P(STRING1,U,2)_U_$J($P(STRING1,U,5),5,1)_U_$P(STRING2,U,2)_U_$J($P(STRING2,U,5),5,1)_U_$FN(PRD2,",+",1)_U_$P(STRING3,U,2)_U_$J($P(STRING3,U,5),5,1)_U_$FN(PRD3,",+",1)
 D S^BGPMUDEL(X,2,1)
 S X="# w/o VTE prophylaxis"_U_$P(STRING1,U,3)_U_$J($P(STRING1,U,6),5,1)_U_$P(STRING2,U,3)_U_$J($P(STRING2,U,6),5,1)_U_$FN(PRD4,",+",1)_U_$P(STRING3,U,3)_U_$J($P(STRING3,U,6),5,1)_U_$FN(PRD5,",+",1)
 D S^BGPMUDEL(X,1,1)
...
TC ;Do the Details
 ...
 S X="This measure assesses the number of patients who received VTE prophylaxis or" D S^BGPMUDEL(X,2,1)
 S X="have documentation why no VTE prophylaxis was given the day of or the day after" D S^BGPMUDEL(X,1,1)
 S X="hospital admission or surgery end date for surgeries that start the day of or" D S^BGPMUDEL(X,1,1)
 S X="the day after hospital admission, if any." D S^BGPMUDEL(X,1,1)
 ...
 S X="ADM=Inpatient Admission" D S^BGPMUDEL(X,1,1)
 S X="MED=Medication Date" D S^BGPMUDEL(X,1,1)
 S X="REF=Refusals" D S^BGPMUDEL(X,1,1)
 S X="NMI=Not Medically Indicated" D S^BGPMUDEL(X,1,1)
 ...
 Q
 ;
 ;Delimited output for VTE Measure 0372
VTE2 ;EP
 D P1
 K ^TMP("BGPMU0372")
 Q
P1 ;Write individual measure
 ...
 S BGPPROV=""
 S BGPPTYPE="D"
 S STRING1=$$372^BGPMUHP6("C")
 S STRING2=$$372^BGPMUHP6("P")
 S STRING3=$$372^BGPMUHP6("B")
 D SUM372
 S PRD1=$P(STRING1,U,1)-$P(STRING2,U,1)
 S PRD2=$P(STRING1,U,5)-$P(STRING2,U,5)
 S PRD3=$P(STRING1,U,5)-$P(STRING3,U,5)
 ...
 S X=U_"REPORT PERIOD"_U_"%"_U_"PREV YR PERIOD"_U_"%"_U_"CHG FROM PREV YR"_U_"BASE YR"_U_"%"_U_"CHG FROM BASE %"
 D S^BGPMUDEL(X,1,1)
 S X="# Inpatient discharges w/ICU LOS => 1 day"_U_$P(STRING1,U,1)_U_U_$P(STRING2,U,1)_U_U_U_$P(STRING3,U,1)_U_U
 D S^BGPMUDEL(X,1,1)
 S X="# Excluded (Exc)"_U_$P(STRING1,U,4)_U_U_$P(STRING2,U,4)_U_U_U_$P(STRING3,U,4)
 D S^BGPMUDEL(X,1,1)
 S X="# Inpatient discharges w/ICU LOS => 1 day Less Exc"_U_($P(STRING1,U,1)-$P(STRING1,U,4))_U_U_($P(STRING2,U,1)-$P(STRING2,U,4))_U_U_U_($P(STRING3,U,1)-$P(STRING3,U,4))
 D S^BGPMUDEL(X,1,1)
 S X="# w/received VTE prophylaxis"_U_$P(STRING1,U,2)_U_$J($P(STRING1,U,5),5,1)_U_$P(STRING2,U,2)_U_$J($P(STRING2,U,5),5,1)_U_$FN(PRD2,",+",1)_U_$P(STRING3,U,2)_U_$J($P(STRING3,U,5),5,1)_U_$FN(PRD3,",+",1)
 D S^BGPMUDEL(X,2,1)
 S X="# w/o VTE prophylaxis"_U_$P(STRING1,U,3)_U_$J($P(STRING1,U,6),5,1)_U_$P(STRING2,U,3)_U_$J($P(STRING2,U,6),5,1)_U_$FN(PRD4,",+",1)_U_$P(STRING3,U,3)_U_$J($P(STRING3,U,6),5,1)_U_$FN(PRD5,",+",1)
...
TC1 ;Do the Details
 ...
 S X="This measure assesses the number of patients who received VTE prophylaxis or" D S^BGPMUDEL(X,2,1)
 S X="have documentation why no VTE prophylaxis was given the day of or the day after" D S^BGPMUDEL(X,1,1)
 S X="the initial admission (or transfer) to the Intensive Care Unit (ICU) or surgery" D S^BGPMUDEL(X,1,1)
 S X="end date for surgeries that start the day of or the day after ICU admission" D S^BGPMUDEL(X,1,1)
 S X="(or transfer), if any." D S^BGPMUDEL(X,1,1)
 ...
 S X="MED=Medication Date" D S^BGPMUDEL(X,1,1)
 S X="REF=Refusals" D S^BGPMUDEL(X,1,1)
 S X="NMI=Not Medical Indicated" D S^BGPMUDEL(X,1,1)
...
D371(NODE) ;GET DATA
 ...
 S NUM=$P(NODE,U,3)
 S CODE=$P(NODE,U,4)
 S X=NAME_U_HRN_U_COMM_U_SEX_U_AGE_U_"ADM "_$$FMTE^XLFDT(DEN,2)_$S($L($P(NODE,"U",2),";")>1:";",1:"")_U_$S(NUM'="":"M:"_CODE_" "_$$FMTE^XLFDT($P(NUM,".",1),2)_$S($L($P(NODE,"U",2),";")>1:";",1:""),1:"NM:")
 D S^BGPMUDEL(X,1,1)
 Q
...
DEXC371(NODE) ;GET DATA
 ...
 Q
 ;
SUM371 ;Populate "BGPMU SUMMARY" for VTE Measure 0371
 ;Initialize iCare/summary global
 N BGPDNCNT,BGPSSTR,J,N
 S J=$J
 S BGPDNCNT=0
 K ^TMP("BGPMU SUMMARY",J,BGPIC)
 S ^TMP("BGPMU SUMMARY",J,BGPIC)="0371"_U_"VTE-1"
 S N=1 ;only 1 numerator
 ;Setup summary page/iCare ^TMP global
 S CDEN1CT=+$G(^TMP("BGPMU0371",J,"C","DEN"))                 ;current
 S CNUM1CT=+$G(^TMP("BGPMU0371",J,"C","NUM"))
 S CEXC1CT=+$G(^TMP("BGPMU0371",J,"C","EXC"))
 S CMP=$S((CDEN1CT-CEXC1CT)>0:$$ROUND^BGPMUA01(CNUM1CT/(CDEN1CT-CEXC1CT),3)*100,1:0)
 S PDEN1CT=+$G(^TMP("BGPMU0371",J,"P","DEN"))                 ;previous
 S PNUM1CT=+$G(^TMP("BGPMU0371",J,"P","NUM"))
 S PEXC1CT=+$G(^TMP("BGPMU0371",J,"P","EXC"))
 S PMP=$S((PDEN1CT-PEXC1CT)>0:$$ROUND^BGPMUA01(PNUM1CT/(PDEN1CT-PEXC1CT),3)*100,1:0)
 S BDEN1CT=+$G(^TMP("BGPMU0371",J,"B","DEN"))                 ;baseline
 S BNUM1CT=+$G(^TMP("BGPMU0371",J,"B","NUM"))
 S BEXC1CT=+$G(^TMP("BGPMU0371",J,"B","EXC"))
 S BMP=$S((BDEN1CT-BEXC1CT)>0:$$ROUND^BGPMUA01(BNUM1CT/(BDEN1CT-BEXC1CT),3)*100,1:0)
 S BGPDNCNT=BGPDNCNT+1
 S BGPSSTR="MU.EP.0371."_N_U_"# w/received VTE prophylaxis"_U_CEXC1CT_U_CDEN1CT_U_CNUM1CT_U_CMP_U_U_U_U
 ; 11 12 13 14
 ...
 Q
SUM372 ;Populate "BGPMU SUMMARY" for VTE Measure 0372
 ;Initialize iCare/summary global
 N BGPDNCNT,BGPSSTR,J,N
 S J=$J
 S BGPDNCNT=0
 K ^TMP("BGPMU SUMMARY",J,BGPIC)
 S ^TMP("BGPMU SUMMARY",J,BGPIC)="0372"_U_"VTE-2"
 S N=1 ;only 1 numerator
 ;Setup summary page/iCare ^TMP global
 S CDEN1CT=+$G(^TMP("BGPMU0372",J,"C","DEN"))                 ;current
 S CNUM1CT=+$G(^TMP("BGPMU0372",J,"C","NUM"))
 S CEXC1CT=+$G(^TMP("BGPMU0372",J,"C","EXC"))
 S CMP=$S((CDEN1CT-CEXC1CT)>0:$$ROUND^BGPMUA01(CNUM1CT/(CDEN1CT-CEXC1CT),3)*100,1:0)
 S PDEN1CT=+$G(^TMP("BGPMU0372",J,"P","DEN"))                 ;previous
 S PNUM1CT=+$G(^TMP("BGPMU0372",J,"P","NUM"))
 S PEXC1CT=+$G(^TMP("BGPMU0372",J,"P","EXC"))
 S PMP=$S((PDEN1CT-PEXC1CT)>0:$$ROUND^BGPMUA01(PNUM1CT/(PDEN1CT-PEXC1CT),3)*100,1:0)
 S BDEN1CT=+$G(^TMP("BGPMU0372",J,"B","DEN"))                 ;baseline
 S BNUM1CT=+$G(^TMP("BGPMU0372",J,"B","NUM"))
 S BEXC1CT=+$G(^TMP("BGPMU0372",J,"B","EXC"))
 S BMP=$S((BDEN1CT-BEXC1CT)>0:$$ROUND^BGPMUA01(BNUM1CT/(BDEN1CT-BEXC1CT),3)*100,1:0)
 S BGPDNCNT=BGPDNCNT+1
 S BGPSSTR="MU.EP.0372."_N_U_"# w/received VTE prophylaxis"_U_CEXC1CT_U_CDEN1CT_U_CNUM1CT_U_CMP_U_U_U_U
 ; 11 12 13 14
 S BGPSSTR=BGPSSTR_U_PEXC1CT_U_PDEN1CT_U_PNUM1CT_U_PMP
 ; 15 16 17 18
 S BGPSSTR=BGPSSTR_U_BEXC1CT_U_BDEN1CT_U_BNUM1CT_U_BMP
 ...
 Q
 ;
XML0371 ;XML output for VTE Measure 0371
 ; BGPXML(i)=Population Number^Numerator Number^Denominator Count
 N STRING
 S STRING=$$371^BGPMUHP6("C")
 S BGPXML(1)="NQF_0371"_U_U_+$P(STRING,U,1)_U_+$P(STRING,U,2)
 K ^TMP("BGPMU0371",$J)
 Q
 ;
XML0372 ;XML output for VTE Measure 0372
 ; BGPXML(i)=Population Number^Numerator Number^Denominator Count
 N STRING
 S STRING=$$372^BGPMUHP6("C")
 S BGPXML(1)="NQF_0372"_U_U_+$P(STRING,U,1)_U_+$P(STRING,U,2)
 K ^TMP("BGPMU0372",$J)
 Q
