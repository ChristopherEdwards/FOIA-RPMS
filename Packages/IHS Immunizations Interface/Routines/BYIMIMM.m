...
DEX D HEADER
 ...
 .I $P(^BYIMPARA(DUZ(2),0),U,10),'+$G(^BIP(DFN,2)) Q
...
PATH ;EP;SET PATH
 ...
 S BYIM("MSH41")=$P(X0,U,7)
 S BYIM("MSH31")=$P(X1,U,3)
 S BYIM("MSH32")=$P(X1,U,4)
 S BYIM("MSH33")=$P(X1,U,5)
 S BYIM("MSH42")=$P(X1,U,6)
 S BYIM("MSH43")=$P(X1,U,7)
