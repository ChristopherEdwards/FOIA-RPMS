BMEMADD ; IHS/PHXAO/TMJ - Print ADDSs to Master List for a specific Log ; 
...
PRINT ;PRINT CLOSED DISCLOSURES BY DATE
 ;W !
 S BMEBY=$S(BMEBY=0:"[BME NEW ADDS - ALL]",1:"@INTERNAL(#.02)")
 S FLDS="[BME MASTER ADD]",BY=BMEBY,DIC="^BMEMASTR(",L=0
