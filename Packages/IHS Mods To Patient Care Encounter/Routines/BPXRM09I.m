BPXRM09I ;IHS/MSC/MGH - Create cross-references. ;02-Nov-2012 15:53;DU
...
CVLAB ;Create cross-reference for V LAB.
 ...
 ;
 ;===============================================================
CVMEA ;Create cross-reference for V MEASUREMENTS
 N MSG,RESULT,XREF
...
SXREFVF(XREF,ITEM) ;Set XREF array nodes common for all V files.
 ...
 I XREF("FILE")=9000010.01 S XREF("VAL",3)=1201
 E  S XREF("VAL",3)=.03
