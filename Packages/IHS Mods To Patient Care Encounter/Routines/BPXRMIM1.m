BPXRMIM1 ; IHS/CIA/MGH - Handle computed findigs for immunizations. ;16-Apr-2012 16:34;DU
 ;;1.5;CLINICAL REMINDERS;**1002,1003,1004,1005,1006,1008**;Jun 19, 2000;Build 25
 ;=================================================================
...
FLU(DFN,TEST,DATE,VALUE,TEXT) ;EP
 ...
 S BPXREM="" S BPXREM=$O(^PXD(811.9,"B",BPXNAME,BPXREM))
 Q:BPXREM=""
 S BPXTRM="" S BPXTRM=$O(^PXRMD(811.5,"B","IHS-INFLUENZA 2011",BPXTRM))
 I BPXTRM=""  S TEST=0,TEXT="Reminder term does not exist" Q
 D GETVAR^BPXRMIM2(BPXTRM)
 Q
