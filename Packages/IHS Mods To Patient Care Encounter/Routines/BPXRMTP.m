BPXRMTP ; IHS/MSC/MGH - Computed Findings for Treatment prompt reminders. ;11-Apr-2012 20:46;DU
...
WAR(DFN,TEST,DATE,VALUE,TEXT) ;EP
 ...
 S X="TODAY" D ^%DT S TODAY=Y
 S APCHSPAT=DFN
 S BPXRESLT=$$ACTWARF^APCHSTP1(APCHSPAT,$$FMADD^XLFDT(DT,-120),DT)
 I $P(BPXRESLT,U,1)=1 S TEST=1,VALUE=$P(BPXRESLT,U,4),TEXT="Warfarin prescription found",DATE=$P(BPXRESLT,U,2)
