BJPC2P14 ; IHS/CMI/LAB - PCC Suite v2.0 patch 3 environment check ;   
 ;;2.0;IHS PCC SUITE;**14**;MAY 14, 2009;Build 12
 ;
 ;
 ...
 ;BJPC 2.0 PATCH 13
 I '$$INSTALLD("BJPC*2.0*13") D MES^XPDUTL($$CJ^XLFSTR("Requires bjpc V2.0 patch 13.  Not installed.",80)) D SORRY(2)
