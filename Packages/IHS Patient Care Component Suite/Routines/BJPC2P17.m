BJPC2P17 ; IHS/CMI/LAB - PCC Suite v2.0 P15 ;   
 ...
 ;BJPC 2.0 PATCH 13
 I '$$INSTALLD("BJPC*2.0*16") D MES^XPDUTL($$CJ^XLFSTR("Requires bjpc V2.0 patch 16.  Not installed.",80)) D SORRY(2)
 ;I '$$INSTALLD("ATX*5.1*13") D MES^XPDUTL($$CJ^XLFSTR("Requires atx (taxonomy) v5.1 patch 13.  Not installed.",80)) D SORRY(2)
 ;
 Q
 ;
PRE ;
 I '$D(^DD(9000010.43,1100)) S DIU(0)="DT"
 I $D(^DD(9000010.43,1100)) S DIU(0)=""
 S DIU=9000010.43 D EN^DIU2
 Q
POST ;
 Q
