AG71A3 ;IHS/SD/EFG - Patient Registration 7.1 PATCH 3 PRE/POST INSTALL ;   
 ;;7.1;PATIENT REGISTRATION;**2,3**;AUG 25,2005
 ;
 Q
PRE ;EP - From KIDS.
...
MAIL ;Send install mail message.
 ...
 K ^TMP("AG71MS",$J)
 S ^TMP("AG71MS",$J,1)=" --- AG v 7.1 Patch 3 has been installed into this uci ---"
 S ^TMP("AG71MS",$J,2)=" "
 S CNT=3
 K AGERRLST
 S %=0
