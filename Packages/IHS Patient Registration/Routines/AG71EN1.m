AG71EN1 ;IHS/SD/EFG - Patient Registration 7.1 PATCH 1 ENVIRONMENT CHECKER ;   
...
CONT ;EP
 ...
 I $P(X,U)<16 W !,$$CJ^XLFSTR("AUPN v99.1 Patch 16 NOT INSTALLED",IOM) S AGQUIT=2
 ;
 I '$$VCHK("AUT","98.1",2) S AGQUIT=2
 ;
 S X=$$LAST^XPDUTL("IHS DICTIONARIES (POINTERS)","98.1")
 I $P(X,U)<18 W !,$$CJ^XLFSTR("AUT v98.1 Patch 18 NOT INSTALLED",IOM) S AGQUIT=2
 ;
 NEW DA,DIC
