AG71EN5 ;IHS/SD/EFG - Patient Registration 7.1 PATCH 5 ENVIRONMENT CHECKER ;   
 ;;7.1;PATIENT REGISTRATION;**1,2,3,4,5**;APR 23,2009
 ;
...
CONT ;EP
 ...
 I $P(X,U)<18 W !,$$CJ^XLFSTR("AUPN v99.1 Patch 18 NOT INSTALLED",IOM) S AGQUIT=2
 ;
