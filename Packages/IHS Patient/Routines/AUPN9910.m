AUPN9910 ;IHS/CMI/LAB,GTH,EFG,SDR - AUPN 99.1 PATCH 10 ; [ 06/11/2003  12:20 PM ]
 ;;99.1;IHS DICTIONARIES (PATIENT);**10**;JUN 13, 2003;Build 9
 ;
...
MAIL ; Send install mail message.
 D BMES^XPDUTL("Delivering AUPN*99.1*10 install message to select users...")
 NEW DIFROM,XMSUB,XMDUZ,XMTEXT,XMY
 KILL ^TMP("AUPN9910",$J)
 S ^TMP("AUPN9910",$J,1)=" --- AUPN v 99.1, Patch 10, has been installed into this uci ---"
 S %=0
