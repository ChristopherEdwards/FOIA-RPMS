AUPN9915 ;IHS/CMI/LAB,GTH,EFG,SDR - AUPN 99.1 PATCH 15 ; [ 07/11/05  3:41 PM ]
 ;;99.1;IHS DICTIONARIES (PATIENT);**15**;JUL 16, 2003;Build 9
 ;
...
PRE ;EP - From KIDS.
 NEW DIK
 S DIK="^DD(9000010,",DA=1501,DA(1)=9000010 D ^DIK
 ;NEED TO DELETE FIELD 1501 FROM VISIT
 Q
 ;
POST ;
 ;remove identifiers from v med
 F AUPNFILE=9000010:.01:9000010.99,9000022 I $D(^DD(AUPNFILE)) D
 .K ^DD(AUPNFILE,0,"ID",.02)
 .K ^DD(AUPNFILE,0,"ID",.03)
 ;REINDEX V PATIENT EDUCATION AAVA XREF
 D BMES^XPDUTL("Re-indexing a cross reference on V Patient Education....Please be patient..")
 NEW DIK S DIK="^AUPNVPED(",DIK(1)=".01^AAVA" D ENALL^DIK
