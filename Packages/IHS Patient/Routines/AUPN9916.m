AUPN9916 ;IHS/CMI/LAB,GTH,EFG,SDR - AUPN 99.1 PATCH 15 ; [ 01/03/06  10:07 AM ]
 ;;99.1;IHS DICTIONARIES (PATIENT);**16**;JUL 16, 2003;Build 9
 ;
...
VCHK(AUPNPRE,AUPNVER,AUPNQUIT) ; Check versions needed.
 ...
 ;
PRE ;EP - From KIDS.
 S N=9000010.11,DIU(0)="",DIU=N W !?6,N D EN^DIU2
 S N=9000010.12,DIU(0)="",DIU=N W !?6,N D EN^DIU2
 K DIU
 Q
 ;
POST ;
