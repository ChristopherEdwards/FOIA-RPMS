 ;BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest.1
 ;(C)InterSystems, generated for class BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest.  Do NOT edit. 10/22/2016 08:43:39AM
 ;;47716A6D;BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest
 ;
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BPHR.PMQueryServiceHttpsSoap11Endpoint.queryRequest",top,format,namespacePrefix,input,refOnly,.schema)
