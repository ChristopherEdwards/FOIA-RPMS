BJPN2P06 ;GDIT/HS/BEE-Prenatal Care Module 2.0 Patch 6 Post Install ; 08 May 2012  12:00 PM
 ;;2.0;PRENATAL CARE MODULE;**6**;Feb 24, 2015;Build 14
 ;
ENV ;EP - Environmental Checking Routine
 ;
 N VERSION,EXEC,BMWDT
 ;
 ;Check for BJPN*2.0*5
 I '$$INSTALLD("BJPN*2.0*5") D BMES^XPDUTL("Version 2.0 Patch 5 of BJPN is required!") S XPDQUIT=2 Q
 ;
 Q
 ;
...
OBJ ;;
 ;;FILE:BEHPOVCVG.DLL;BEHPovCvg;1.0.5910.29697;BEHPovCvg.dll;;;;0;1;0;0;1;0;0;0;;0;;;;;;
 ;;IHS.PN.EHR.PRENATALPICKLIST.PRENATALPICKLISTCOMPONENT;Prenatal Pick List;2.0.6.7;IHS.PN.EHR.PrenatalPickList.dll;;;IHS.PN.EHR.PrenatalPickList.chm;0;1;0;0;0;0;0;0;;1;;;;{0A2C8481-DB1A-4D80-A8E0-CEBF70E6F705};300;600
 ;;IHS.PN.EHR.PRENATALPROBLEMLIST.PIPCOMPONENT;Pregnancy Issues and Problems List;2.0.6.7;IHS.PN.EHR.PrenatalProblemList.dll;;;IHS.PN.EHR.PrenatalProblemList.chm;0;1;0;0;0;0;0;0;;1;;;;{B5416178-ECD8-4515-A700-2980BCAA6CAA};300;640
 ;;END;
 ;;
 ;
INSTALLD(BJPNSTAL) ;EP - Determine if patch BJPNSTAL was installed, where
 ;BJPNSTAL is the name of the INSTALL.  E.g "BJPN*2.0*5".
 ;
 NEW DIC,X,Y,D
 S X=$P(BJPNSTAL,"*",1)
