BCHRP3 ; IHS/TUCSON/LAB - All visit report driver ;  [ 04/02/01  9:36 AM ]
...
PROG1 ;enter program
 ...
 S BCHPRG=+Y
ZIS ;CALL TO XBDBQUE
 S XBRP="^BCHRP3P",XBRC="^BCHRP31",XBRX="XIT^BCHRP3",XBNS="BCH"
 D ^XBDBQUE
 D XIT
 Q
...
XIT ;
 ...
 K BCHSU,BCHX,BCHACTOT,BCHATOT,BCHACTN,BCHLOCN,BCHPROB
 K DIR,DIRUT,DTOUT,DUOUT,X,X1,X2,Y
 Q
 ;
INFORM ;
 W:$D(IOF) @IOF
 W !,"****** ACTIVITY BY HEALTH PROBLEM REPORT  ******",!
 W !,"This report will tally problems by Program, activity location, CHR,",!,"and activity.  ",!
 Q
 ;
 ;
