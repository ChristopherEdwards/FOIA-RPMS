BRN2ND ; IHS/PHXAO/TMJ - ROI CLOSED DISCLOSURES FOR 2ND & 3RD REQUESTS ;  
...
PRINT ;PRINT CLOSED DISCLOSURES BY DATE
 ...
 ;S FLDS="[BRN ADDITIONAL REQUEST]",BY="@(#.01),2ND REQUEST DATE'=""""",DIC="^BRNREC(",L=0
 ;S FR=BRNBD,TO=BRNED
 S FLDS="[BRN ADDITIONAL REQUEST]",BY="FACILITY,@(#.01),2ND REQUEST DATE'=""""",DIC="^BRNREC(",L=0
