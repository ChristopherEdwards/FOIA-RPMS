BRNMLOG ; IHS/PHXAO/TMJ - ROI MASTER LOG (BY DATE RANGE) ;  
...
PRINT ;PRINT MASTER DISCLOSURE LOG
 ...
 ;S FLDS="[BRN GS PRINT DISCLOSURE LOG]",BY="@INTERNAL(#.01)",DIC="^BRNREC(",L=0
 ;S FR=BRNBD,TO=BRNED
 S FLDS="[BRN GS PRINT DISCLOSURE LOG]",BY="FACILITY,@INTERNAL(#.01)",DIC="^BRNREC(",L=0
