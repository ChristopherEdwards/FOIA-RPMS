BRNPAGE ; IHS/PHXAO/TMJ - ROI REPRODUCTION COSTS (BY DATE RANGE) ;  
...
PRINT ;PRINT CLOSED DISCLOSURES BY DATE
 ...
 ;S FLDS="[BRN REPRODUCTION COST]",BY="@INTERNAL(#.01)",DIC="^BRNREC(",L=0
 ;S FR=BRNBD,TO=BRNED
 S FLDS="[BRN REPRODUCTION COST]",BY="FACILITY,@INTERNAL(#.01)",DIC="^BRNREC(",L=0
 I BRNFAC=0 S FR="@,"_BRNBD,TO="ZZZ,"_BRNED,DHD="REPRODUCTION COSTS FOR ALL FACILITIES"
 E  S FR=BRNFACN_","_BRNBD,TO=BRNFACN_","_BRNED,DHD="REPRODUCTION COSTS FOR "_BRNFACN
