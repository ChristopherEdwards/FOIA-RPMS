BHLRLABQ ; cmi/anchorage/maw - BHL ORU/R01 Ref Lab inbound Lab Message ; 
 ;;3.01;BHL IHS Interfaces with GIS;**13,14,15,16**;AUG 01, 2004
 ;
 ;QUEST INBOUND
 ;
 ;this routine will file the inbound QUEST lab message.
 ;
...
OBR ;-- parse the OBR segment
 ...
 . ;cmi/anch/maw modified at DKR request 8/30/2006
...
MAP(BHLTYPC) ;-- map the necessary incoming items to rpms
 ...
 ;cmi/maw 2/28/2008 NPI addition
...
CPT ;-- let's build the cpt string
 ...
 S BHLIO="A"  ;make the visit ambulatory 9/8/07 cmi/maw
 Q:$G(BHLPSEQ)
 Q:'$G(BHLCLT)
