BUD1RP7 ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B 12 Dec 2011 6:51 AM 30 Dec 2011 8:19 PM 27 Aug 2011 12:41 PM ; 
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD1RP7",ZTDTH="",ZTDESC="UDS 11 REPORT TABLE 7" D ^%ZTLOAD D EOJ Q
 Q
EOJ ;
 D EN^XBVK("BUD")
 Q
...
PROC ;EP - called from taskman
 S BUDJ=$J,BUDH=$H
 S ^XTMP("BUD1RP7B",0)=$$FMADD^XLFDT(DT,14)_"^"_DT_"^BUD TABLE 7 LISTS"
 ;NOW LOOP THROUGH PATIENT FILE  for imms and paps
 S DFN=0 F  S DFN=$O(^AUPNPAT(DFN)) Q:DFN'=+DFN  D
 .;I DUZ=5634 Q:'$D(^DIBT(4734,1,DFN))
 .;I DUZ=5634 Q:$$HRN^AUPNPAT(DFN,DUZ(2))'=123029
 .;I '$D(^DIBT(4752,1,DFN)) Q
 .;Q:DFN'=10
 .K ^TMP($J)
 .Q:'$D(^AUPNPAT(DFN,0))
 .Q:'$D(^DPT(DFN,0))
 ...
 .D PRGHLST^BUD1RP7A
 .D PRGRLST^BUD1RP7A
 .;I $G(BUDPRGEL) D PRGELST^BUD1RP7A
 .D HTN^BUD1RP7B
 .D DM^BUD1RP7C
 Q
 ;
...
GENI ;general introductions
 ...
 W !,"of care indicators during the time period January 1 - December 31, 2011."
