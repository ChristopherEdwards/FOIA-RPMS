BUD1RPT1 ; IHS/CMI/LAB - UDS REPORT DRIVER 12 Dec 2011 8:11 AM 06 Oct 2011 1:48 PM ; 
...
EN ;EP
EN1 ;
 I $G(BUDT6B) W !,"Table 6B:" D PRENATT^BUD1RP6B
 I $G(BUDT7) W !,"Table 7:" D PRENATT^BUD1RP7
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD1RPT1",ZTDTH="",ZTDESC="UDS 11 REPORT" D ^%ZTLOAD D EOJ Q
 Q
...
T9 ;EP
 ...
 G EN1
T9I ;
 W !!,"TABLE 9:  Patient-Related Revenue (Delimited Report)"
