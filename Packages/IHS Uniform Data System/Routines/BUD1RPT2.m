BUD1RPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER 02 Dec 2007 11:27 AM 12 Dec 2011 8:12 AM ;
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDLSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUD1RPTP",XBRC="PROC^BUD1RPTC",XBRX="EOJ^BUD1RPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
ZIS ;call to XBDBQUE
 K IOP,%ZIS
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD1RPT2",ZTDTH="",ZTDESC="UDS 11 REPORT" D ^%ZTLOAD D EOJ Q
 Q
M ;EP - called from option
 ...
 W !?5,"10   All Patients by Selected Primary Diagnosis (Table 6A)"
