...
DMR4L ;EP
 ...
 D DMR4H Q:BUDQUIT
 I '$D(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4")) W !!,"No patients to report." Q
 D DMR4L1
...
DMR4L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D DMR4L2
 Q
DMR4L2 ;
 S BUDSTOT=0
 S BUDRACEL=$$RACEL^BUD2RP7I(BUDRACE,BUDETH)
 W !,BUDRACEL
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE,BUDETH,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE,BUDETH,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDALL=^XTMP("BUD2RP7",BUDJ,BUDH,"DMR4",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"^",1)
 ....W ?5,$P(BUDALL,"^",2),!
...
DMR3L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D DMR3H Q:BUDQUIT
 I '$D(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3")) W !!,"No patients to report." Q
 D DMR3L1
...
DMR3L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D DMR3L2
 Q
DMR3L2 ;
 S BUDSTOT=0
 S BUDRACEL=$$RACEL^BUD2RP7I(BUDRACE,BUDETH)
 W !,BUDRACEL
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDETH,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDETH,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDHISV=$$HISP^BUD2RPTC(DFN)
 ....W ?24,$P(BUDHISV,U,3)," (",$P(BUDHISV,U,2),")",!
 ....S BUDALL=^XTMP("BUD2RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"^",1)
 ....W ?5,$P(BUDALL,"^",2),!
 ....F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 .....I $Y>(IOSL-3) D DMR3H Q:BUDQUIT  W !,BUDRACEL,!
