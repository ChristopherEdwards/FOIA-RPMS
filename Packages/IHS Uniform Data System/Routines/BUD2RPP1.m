BUD2RPP1 ; IHS/CMI/LAB - UDS PRINT TABLE 6 05 Dec 2007 6:26 AM 30 Dec 2012 10:42 AM ;
 ;;10.0;IHS/RPMS UNIFORM DATA SYSTEM;;FEB 04, 2016;Build 50
T6 ;EP
 S BUDPG=0,BUDQUIT="",BUDFNP=1,BUDTYPE="D"
 D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH
 K BUDFNP
 ...
 I $Y>(IOSL-3) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-4) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-3) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-13) D HEADER^BUD2RPTP Q:BUDQUIT  D T6SH1
 ...
 W !?6,"Varicella, ",?33,"33,100,109,133,01,09,11"
...
T6SH ;
 ...
 W !,$TR($J("",80)," ","-")
 W !,?35,"Applicable",?54,"Visits with",?69,"Total Pts"
 W !?35,"ICD-9-CM",?54,"diagnosis",?69,"w/diagnosis"
 W !?35,"code",?54,"Regardless",?70,"Regardless"
 W !?54,"of primacy",?70,"of primacy"
