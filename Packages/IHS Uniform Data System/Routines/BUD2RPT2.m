BUD2RPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER  ;
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDRSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUD2RPTP",XBRC="PROC^BUD2RPTC",XBRX="EOJ^BUD2RPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
ZIS ;call to XBDBQUE
 K IOP,%ZIS
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD2RPT2",ZTDTH="",ZTDESC="UDS 12 REPORT" D ^%ZTLOAD D EOJ Q
 Q
