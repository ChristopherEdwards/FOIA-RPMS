BUDARP7G ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDARPTP Q:BUDQUIT  D T7H^BUDARP7F
 ...
 D LINE^BUDARP7F
 I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T7H^BUDARP7F
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDARPTP Q:BUDQUIT  D T7H1^BUDARP7F
 ...
 D LINE^BUDARP7F
 I $Y>(IOSL-16) D HEADER^BUDARPTP Q:BUDQUIT  D T7H1^BUDARP7F
 W ?69,"|",!
 ...
 D LINE1^BUDARP7F
 I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T7H1^BUDARP7F
