BUDARP7O ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDARPTP Q:BUDQUIT  D T7H^BUDARP71
 ...
 D LINE^BUDARP71
 I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T7H^BUDARP71
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDARPTP Q:BUDQUIT  D T7H1^BUDARP71
 ...
 D LINE4^BUDARP71
 I $Y>(IOSL-16) D HEADER^BUDARPTP Q:BUDQUIT  D T7H1^BUDARP71
 W ?69,"|",!
 ...
 D LINE5^BUDARP71
 I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T7H1^BUDARP71
