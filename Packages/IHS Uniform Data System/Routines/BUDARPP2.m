BUDARPP2 ; IHS/CMI/LAB - UDS REPORT PRINT 30 Dec 2013 10:44 AM 22 Oct 2013 12:16 PM ; 
...
T4 ;EP
 S BUDPG=0
 S BUDTABI=$O(^BUDQCNTL("B","TABLE 4 LINE LABELS",0))
 D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 ;print out each line
 ;
 I $Y>(IOSL-6) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 W !!,"CHARACTERISTIC",?60,"NUMBER OF PATIENTS",!?66,"(a)"
 W !,BUD80L
 W !,"INCOME AS PERCENT OF POVERTY LEVEL"
 W !,BUD80L
 F BUDX=1,2,3,4,5,6 Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDQCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,2),?63,$$C(BUDT4V(BUDX))
 .W !,BUD80L
 I $Y>(IOSL-22) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 W !!,"PRINCIPAL THIRD PARTY MEDICAL INSURANCE SOURCE",?50,"0-17 YEARS",?65,"18 AND OLDER",!?52,"OLD (a)",?70,"(b)"
 W !,BUD80L
 F BUDX=7,"8a","8b",8,9,"10a","10b",10,11,12 Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDQCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,2),?50,$$C($P(BUDT4V(BUDX),U,1)),?65,$$C($P(BUDT4V(BUDX),U,2))
 .W !,BUD80L
 D HEADER^BUDARPTP Q:BUDQUIT
 D T4SH
 ...
 .I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDQCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,2),!,?7,$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,3) ;,?50,$$C($P(BUDT4V(BUDX),U,1)),?65,$$C($P(BUDT4V(BUDX),U,2))
 .W !,BUD80L
 I $Y>(IOSL-28) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 W !,"CHARACTERISTICS - SPECIAL POPULATIONS",?60,"NUMBER OF PATIENTS",!?65," - (a)"
 W !,BUD80L
 F BUDX=14:1:25 Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER^BUDARPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDQCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,2) W:$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,3)]"" !?7,$P(^BUDQCNTL(BUDTABI,11,BUDY,0),U,3) W ?63,$$C(BUDT4V(BUDX))
 .W !,BUD80L
 W !
 Q
C(X,Y) ;
...
T9 ;EP
 S BUDPG=0
 D HEADER^BUDARPTP Q:BUDQUIT  D T9SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDARPTP Q:BUDQUIT  D T9SH
 W !,BUD80L
...
4 ;
 ...
 ;W !,BUD80L
7 ;
 I $Y>(IOSL-13) D HEADER^BUDARPTP Q:BUDQUIT  D T9SH
 W !,BUD80L
...
13 ;
 ...
 W !,BUD80L
PAGE2 ;
 D HEADER^BUDARPTP Q:BUDQUIT  D T92SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDARPTP Q:BUDQUIT  D T92SH
 W !,BUD80L
 W !?5,"Medicaid Non-Managed",!,"1.   Care"
 W !,BUD80L
 W !?5,"Medicaid Managed Care",!,"2a.  (capitated)"
...
24 ;
 ...
 ;W !,BUD80L
27 ;
 I $Y>(IOSL-13) D HEADER^BUDARPTP Q:BUDQUIT  D T92SH
 W !,BUD80L
 W !?5,"Other Public including"
 W !,"7.   Non-Medicaid CHIP (Non"
 W !?5,"Managed Care)"
...
213 ;
 ...
 W !,BUD80L
PAGE3 ;
 D HEADER^BUDARPTP Q:BUDQUIT  D T93SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDARPTP Q:BUDQUIT  D T93SH
 W !,BUD80L
 W !?5,"Medicaid Non-Managed",!,"1.   Care"
 W !,BUD80L
 W !?5,"Medicaid Managed Care",!,"2a.  (capitated)"
...
34 ;
 ...
 ;W !,BUD80L
37 ;
 I $Y>(IOSL-13) D HEADER^BUDARPTP Q:BUDQUIT  D T93SH
 W !,BUD80L
 W !?5,"Other Public including"
 W !,"7.   Non-Medicaid CHIP (Non"
 W !?5,"Managed Care)"
