BUDARPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER  ;
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDQSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUDARPTP",XBRC="PROC^BUDARPTC",XBRX="EOJ^BUDARPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
ZIS ;call to XBDBQUE
 K IOP,%ZIS
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDARPT2",ZTDTH="",ZTDESC="UDS 13 REPORT" D ^%ZTLOAD D EOJ Q
 Q
