BUDAXTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ; 24 Dec 2013  7:56 AM
 ;;10.0;IHS/RPMS UNIFORM DATA SYSTEM;;FEB 04, 2016;Build 50
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2013 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUDATXCH",XBNS="",XBRX="XIT^BUDATXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2013 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
