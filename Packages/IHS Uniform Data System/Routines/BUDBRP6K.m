BUDBRP6K ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ; 
...
IVD1L ;EP
 ...
 D IVD1H Q:BUDQUIT
 I '$D(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD1")) W !!,"No patients to report.",! Q
 D IVD1L1
...
IVD1L1 ;
 ...
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD1",BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 .S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD1",BUDAGE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ..S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD1",BUDAGE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD1",BUDAGE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D IVD1H Q:BUDQUIT
 ...
 ....S BUDTOT=BUDTOT+1
 ....S BUDALL=^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD1",BUDAGE,BUDNAME,BUDCOM,DFN)
...
IVD2L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D IVD2H Q:BUDQUIT
 I '$D(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD2")) W !!,"No patients to report.",! Q
 D IVD2L1
...
IVD2L1 ;
 ...
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD2",BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 .S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD2",BUDAGE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ..S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD2",BUDAGE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD2",BUDAGE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D IVD2H Q:BUDQUIT
 ....W !,$E($P(^DPT(DFN,0),U,1),1,25),?29,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2)),?41,$E(BUDCOM,1,25),?70,$P(^DPT(DFN,0),U,2),?75,BUDAGE,!
 ....S BUDTOT=BUDTOT+1
 ....S BUDALL=^XTMP("BUDBRP6B",BUDJ,BUDH,"IVD2",BUDAGE,BUDNAME,BUDCOM,DFN)
 ....W ?5,$P(BUDALL,U,1),?30,$P(BUDALL,U,2)
 Q
IVD2H ;
 G:'BUDGPG IVD2H1
