BUDBRP7 ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B 12 Dec 2014 6:51 AM 30 Dec 2014 8:19 PM 27 Aug 2014 12:41 PM ; 21 Jan 2014  2:52 PM
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDBRP7",ZTDTH="",ZTDESC="UDS 14 REPORT TABLE 7" D ^%ZTLOAD D EOJ Q
 Q
EOJ ;
 D EN^XBVK("BUD")
 Q
...
MDM ;EP
 ...
 W !?5,"3   All Patients w/A1c >=8 & <=9 by Race and Hispanic or Latino Identity"
 W !?5,"4   All Patients w/DM and A1c >9 or No Test by Race and Hispanic or Latino Identity"
...
PROC ;EP - called from taskman
 S BUDJ=$J,BUDH=$H
 S ^XTMP("BUDBRP7B",0)=$$FMADD^XLFDT(DT,14)_"^"_DT_"^BUD TABLE 7 LISTS"
 ...
 .;;I DUZ=5634 Q:'$$IWTO^BUDBRPTC(DFN)  G LORIN
...
LORIN .;DO NOT COUNT BASED ON CLASSIFICATION IN V6.0
 ...
 .D PRGHLST^BUDBRP7A
 .D PRGRLST^BUDBRP7A
 .;I $G(BUDPRGEL) D PRGELST^BUDBRP7A
 .D HTN^BUDBRP7B
 .D DM^BUDBRP7C
 Q
 ;
...
GENI ;general introductions
 ...
 W !,"of care indicators during the time period January 1 - December 31, 2014."
