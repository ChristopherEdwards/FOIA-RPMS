BUDBRP7F ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B 03 Dec 2014 6:10 AM 30 Dec 2014 8:12 PM ;
...
PRINT ;EP
 ...
 D LINE1
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H
 ...
 D LINE1
 ;SECTION B
 I $Y>(IOSL-16) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H
 W ?69,"|",!
 ...
 D LINE1
 D DMRACE1^BUDBRP7G  ;rest of page 1
NEXT ;second page of sections a,b
 D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1
 W ?29,"|",?41,"NON-HISPANIC/LATINO (2)",?69,"|",!
 ...
 D LINE1
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1
 ...
 D LINE1
 ;SECTION B
 I $Y>(IOSL-16) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1
 W ?69,"|",!
