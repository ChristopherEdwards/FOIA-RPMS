BUDBRP7G ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDBRPTP Q:BUDQUIT  D T7H^BUDBRP7F
 ...
 D LINE^BUDBRP7F
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H^BUDBRP7F
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1^BUDBRP7F
 ...
 D LINE^BUDBRP7F
 I $Y>(IOSL-16) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1^BUDBRP7F
 W ?69,"|",!
 ...
 D LINE1^BUDBRP7F
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1^BUDBRP7F
