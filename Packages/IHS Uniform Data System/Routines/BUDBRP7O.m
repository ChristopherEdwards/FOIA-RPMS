BUDBRP7O ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDBRPTP Q:BUDQUIT  D T7H^BUDBRP71
 ...
 D LINE^BUDBRP71
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H^BUDBRP71
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1^BUDBRP71
 ...
 D LINE4^BUDBRP71
 I $Y>(IOSL-16) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1^BUDBRP71
 W ?69,"|",!
 ...
 D LINE5^BUDBRP71
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T7H1^BUDBRP71
