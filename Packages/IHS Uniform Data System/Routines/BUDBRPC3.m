BUDBRPC3 ; IHS/CMI/LAB - UDS TABLE 6 ;
...
ZIPINS(DFN,BUDLASTV) ;EP - ZIP INSURANCE
 NEW BUDHAS
 S BUDHAS=0
 S BUDHAS=$$PI^BUDBRPC2(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "e"
 S BUDHAS=$$MCR^BUDBRPC2(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "d"
 ;S BUDHAS=$$OPI(DFN,$$VD^APCLV(BUDLASTV),"W")
 ;I BUDHAS=1 D TINS(BUDAGE,"10a") Q
 S BUDHAS=$$RR^AUPNPAT(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "c"
 S BUDHAS=$$OPI^BUDBRPC2(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "c"
 S BUDHAS=$$OPIC^BUDBRPC2(DFN,$$VD^APCLV(BUDLASTV),"K")
 I BUDHAS=1 Q "c"
 S BUDHAS=$$MCD^BUDBRPC2(DFN,$$VD^APCLV(BUDLASTV),"D")
 I BUDHAS=1 Q "c"
 S BUDHAS=$$MCD^BUDBRPC2(DFN,$$VD^APCLV(BUDLASTV),"K")
 I BUDHAS=1 Q "c"
 ;now check workman's comp and 3rd party liability
 S BUDHAS=$$WC^BUDBRPC2(DFN,BUDBD,BUDED)
 I BUDHAS=1 Q "c"
 S BUDHAS=$$TPL^BUDBRPC2(DFN,BUDBD,BUDED)
 I BUDHAS=1 Q "c"
