BUDBRPP1 ; IHS/CMI/LAB - UDS PRINT TABLE 6 05 Dec 2007 6:26 AM 30 Dec 2014 10:42 AM ;
 ;;10.0;IHS/RPMS UNIFORM DATA SYSTEM;;FEB 04, 2016;Build 50
T6 ;EP
 S BUDPG=0,BUDQUIT="",BUDFNP=1,BUDTYPE="D"
 D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH
 K BUDFNP
 ...
 W !," 1-2(a).  Newly diagnosed HIV",?35,$$CTR("042,079.53,V08",15),?56,$$C($P(BUDT6("V"),U,2)),?70,$$C($P(BUDT6("P"),U,2)),!,BUD80L
 W !," 3.  Tuberculosis",?35,$$CTR("010.xx-018.xx",15),?56,$$C($P(BUDT6("V"),U,3)),?70,$$C($P(BUDT6("P"),U,3)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-4) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
 W !,"23.  Pap Test",?33,"CPT-4: 88141-88155, 88164-88167, ",?33,"88174-88175"
 W !?33,"ICD-9: V72.3, V72.31, V72.32, V76.2",!?33,"VLab Pap Smear; WH Pap Smear; "
 W !?33,"LOINC & site",!,?33,"defined taxonomies",?56,$$C($P(BUDT6("V"),U,23)),?70,$$C($P(BUDT6("P"),U,23)),!,BUD80L
 I $Y>(IOSL-13) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
 ...
 W !?6,"Varicella, ",?33,"146,33,100,109,133,01,09,11"
 W !?6,"Hepatitis B Child",?33,"20,22,28,50,106,107,110,113",!?33,"115,130,132,138,139,03-07"
 W !?33,"38,94,02,10,89,21,94,08,42",!?33,"43,44,45,152"
 W ?56,$$C($P(BUDT6("V"),U,24)),?70,$$C($P(BUDT6("P"),U,24)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
 W !,"24a. Seasonal Flu vaccine",?33,"CPT-4: 90654-90662, 90672-90673",!?33,"90685-90688 CVX: 15, 16, 111",!?33,"135, 140, 141, 144, 149, 150",!?33,"151, 153, 155, 158, 161",?56,$$C($P(BUDT6("V"),U,65)),?70,$$C($P(BUDT6("P"),U,65)),!,BUD80L
 ;I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
...
DENT ;
 ...
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
 W !,"31.      Fluoride treatment - ",?34,"ADA: 1206, 1208",!?10,"adult or child",?34,"CPT-4: D1206, D1208",?56,$$C($P(BUDT6("V"),U,31)),?70,$$C($P(BUDT6("P"),U,31)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUDBRPTP Q:BUDQUIT  D T6SH1
...
T6SH ;
 ...
 W !,$TR($J("",80)," ","-")
 W !,?35,"Applicable",?54,"Number of",?69,"Number of"
 W !?35,"ICD-9-CM",?54,"Visits by",?69,"Patients"
 W !?35,"Code",?54,"Diagnosis",?69,"with"
 W !?54,"regardless",?69,"Diagnosis"
 W !?54,"of primacy",?69,"regardless"
 W !?69,"of primacy"
 I BUDTYPE="D" W !,"Diagnostic Category",?58,"(A)",?73,"(B)"
...
T6SH1 ;
 ...
 W $$CTR("SELECTED DIAGNOSES AND SERVICES RENDERED",80)
 W !,$TR($J("",80)," ","-")
 W !,?37,"Applicable",?56,"Number of",?70,"Number of"
 W !?37,"ICD-9-CM or",?56,"Visits",?70,"patients"
 W !?37,"CPT-4 code(s)"
 I BUDTYPE="D" W !,"Diagnostic Category",?58,"(A)",?73,"(B)"
 I BUDTYPE="S" W !,"Service Category",?61,"(A)",?75,"(B)"
 W !,$TR($J("",80)," ","-"),!
