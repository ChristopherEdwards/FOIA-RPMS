BUDBXTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ; 19 Dec 2014  3:12 PM
 ;;9.0;IHS/RPMS UNIFORM DATA SYSTEM;;FEB 02, 2015;Build 42
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2014 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUDBTXCH",XBNS="",XBRX="XIT^BUDBTXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2014 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
