BUDCBAN ; IHS/CMI/LAB - Banner routine for UDS package ; 06 Nov 2015  8:16 AM
...
TEXTM ;manager utilities
 ;;**************************************
 ;;**  RPMS UNIFORM DATA SYSTEM (UDS)  **
 ;;**      2015 Manager Utilities      **
 ;;**************************************
 ;;QUIT
TEXTL ;;
 ;;**************************************
 ;;**  RPMS UNIFORM DATA SYSTEM (UDS)  **
 ;;** 2015 Patient and Provider Lists  **
 ;;**************************************
 ;;QUIT
TEXTA ;;
 ;;*******************************************************
 ;;**           RPMS UNIFORM DATA SYSTEM (UDS)          **
 ;;**          2015 Patient and Provider List           **
