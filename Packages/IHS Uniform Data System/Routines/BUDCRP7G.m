BUDCRP7G ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDCRPTP Q:BUDQUIT  D T7H^BUDCRP7F
 ...
 D LINE^BUDCRP7F
 I $Y>(IOSL-3) D HEADER^BUDCRPTP Q:BUDQUIT  D T7H^BUDCRP7F
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDCRPTP Q:BUDQUIT  D T7H1^BUDCRP7F
 ...
 D LINE^BUDCRP7F
 I $Y>(IOSL-16) D HEADER^BUDCRPTP Q:BUDQUIT  D T7H1^BUDCRP7F
 W ?69,"|",!
 ...
 D LINE1^BUDCRP7F
 I $Y>(IOSL-3) D HEADER^BUDCRPTP Q:BUDQUIT  D T7H1^BUDCRP7F
