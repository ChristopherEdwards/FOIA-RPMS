BUDCRP7O ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDCRPTP Q:BUDQUIT  D T7H^BUDCRP71
 ...
 D LINE^BUDCRP71
 I $Y>(IOSL-3) D HEADER^BUDCRPTP Q:BUDQUIT  D T7H^BUDCRP71
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDCRPTP Q:BUDQUIT  D T7H1^BUDCRP71
 ...
 D LINE4^BUDCRP71
 I $Y>(IOSL-16) D HEADER^BUDCRPTP Q:BUDQUIT  D T7H1^BUDCRP71
 W ?69,"|",!
 ...
 D LINE5^BUDCRP71
 I $Y>(IOSL-3) D HEADER^BUDCRPTP Q:BUDQUIT  D T7H1^BUDCRP71
