BUDCRPC4 ; IHS/CMI/LAB - UDS TABLE 6 ; 15 Dec 2015  12:41 PM
...
T9 ;EP
 ...
 ..S BUDCILLF=0  ;BUD*2.6*8 HEAT47191
 ...
 ..S BUDP("BDFN")=0
 ..F  S BUDP("BDFN")=$O(^ABMDBILL(BUDDUZ2,"AV",BUDVDFN,BUDP("BDFN"))) Q:'BUDP("BDFN")  D  Q:BUDCILLF  ;BUD*2.6*8 HEAT47191
 ...
 ...D GETITYPE
 ...I BUDLINE="" Q
 ...S (BUDCILLN,BUDSAV)=$P($G(^ABMDBILL(BUDDUZ2,BUDP("BDFN"),0)),U)
 ...;F  S BUDCILLN=$O(^BARBL(BUDPAR,"B",BUDCILLN)) Q:$G(BUDCILLN)=""!(BUDCILLN'[BUDSAV)  D  ;BUD*2.6*8 HEAT47191
 ...F  S BUDCILLN=$O(^BARBL(BUDPAR,"B",BUDCILLN)) Q:$G(BUDCILLN)=""!(BUDCILLN'[BUDSAV)  D  Q:BUDCILLF  ;BUD*2.6*8 HEAT47191
 ....S BUDARIEN=0
 ....S BUDHOLD=DUZ(2)
 ....S DUZ(2)=BUDPAR
 ....F  S BUDARIEN=$O(^BARBL(DUZ(2),"B",BUDCILLN,BUDARIEN)) Q:'BUDARIEN  D   Q:BUDCILLF  ;BUD*2.6*8 HEAT47191
 ...
 .....;I BUDLINE=3 W !,DFN,":",BUDCILLN,":",BUDARIEN,":",$$VAL^XBDIQ1(90050.01,BUDARIEN,13)
 .....;S D0=BUDARACT
 ...
 .....F  S BUDTRIEN=$O(^BARTR(DUZ(2),"AC",BUDARIEN,BUDTRIEN)) Q:'BUDTRIEN  D  Q:BUDCILLF  ;BUD*2.6*8 HEAT47191
