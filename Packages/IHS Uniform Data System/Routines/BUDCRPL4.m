BUDCRPL4 ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
T3BR ;EP
 ...
 D T3BRH Q:BUDQUIT
 I '$D(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR")) D
...
T3BRL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D T3BRL2
 Q
T3BRL2 ;
 S BUDSTOT=0
 ...
 S BUDA="" F  S BUDA=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 .S BUDSEX="" F  S BUDSEX=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH,BUDA,BUDSEX)) Q:BUDSEX=""!(BUDQUIT)  D
 ..S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH,BUDA,BUDSEX,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH,BUDA,BUDSEX,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDV=0,BUDC=0 F  S BUDV=$O(^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH,BUDA,BUDSEX,BUDCOM,DFN,BUDV)) Q:BUDV'=+BUDV!(BUDQUIT)  D
 .....S BUDC=BUDC+1
 .....S BUDI=^XTMP("BUDCRPT1",BUDJ,BUDH,"3BR",BUDRACE,BUDETH,BUDA,BUDSEX,BUDCOM,DFN,BUDV),BUDI=$P(BUDI,"|||",3)
 .....I BUDROT="P",$Y>(IOSL-3) D T3BRH Q:BUDQUIT  I BUDROT="P" W !,BUDRACEL,!
 .....I BUDROT="P",BUDC=1 W ?60,$S(BUDI:"YES",1:"NO")
