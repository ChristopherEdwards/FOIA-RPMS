BUDCRPT1 ; IHS/CMI/LAB - UDS REPORT DRIVER 12 Dec 2015 8:11 AM 06 Oct 2015 1:48 PM ; 21 Nov 2015  10:44 AM
...
EN ;EP
EN1 ;
 I $G(BUDT6B) W !,"Table 6B:" D PRENATT^BUDCRP6B
 I $G(BUDT7) W !,"Table 7:" D PRENATT^BUDCRP7
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDCRPT1",ZTDTH="",ZTDESC="UDS 15 REPORT" D ^%ZTLOAD D EOJ Q
 Q
M ;EP - called from option
 ...
 W !?5,"3   Table 3B: Patients by Hisp/Latino Ethnicity/Race/Linguistic Barriers"
...
T3AI ;intro for table 3A
 ...
 W !,"and gender.  Patients must have at least one visit during the selected reporting"
 W !,"period.  Age is calculated as of June 30th of the year you select.",!
 Q
...
T3B ;EP
 ...
 G EN1
T3BI ;
 W !!,"TABLE 3B:  USERS BY HISPANIC OR LATINO ETHNICITY/RACE/LINGUISTIC",!,"BARRIERS TO CARE"
 W !,"This report will produce UDS Table 3B, an itemization of users"
 W !,"by Hispanic or Latino Ethnicity/Race/Linguistic Barriers to Care."
