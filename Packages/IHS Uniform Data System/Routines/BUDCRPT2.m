BUDCRPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER  ;
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDCSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUDCRPTP",XBRC="PROC^BUDCRPTC",XBRX="EOJ^BUDCRPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
 D PT^BUDCRPTE
 I BUDROT="" G EN1
...
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BUDCRPT2",XBRX="EOJ^BUDCRPT2",XBNS="BUD"
 D ^XBDBQUE
 Q
NODEV1 ;
 D PROC^BUDCRPTC
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDCRPT2",ZTDTH="",ZTDESC="UDS 15 REPORT" D ^%ZTLOAD D EOJ Q
 Q
