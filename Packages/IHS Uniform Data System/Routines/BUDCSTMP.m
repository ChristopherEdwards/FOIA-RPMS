...
SETRECS ;EP - Set Entries into Template
 ;
 S BUDDFN=0 F  S BUDDFN=$O(^XTMP("BUDVL",BUDJOB,BUDCTH,"PATIENTS",BUDDFN)) Q:BUDDFN'=+BUDDFN  D
 .I '$D(^XTMP("BUDVL",BUDJOB,BUDCTH)) W !!,"NO DATA TO REPORT.",! D PAUSE^BUDCUPVL W:$D(IOF) @IOF
