BUDCXTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ; 19 Dec 2015  3:12 PM
 ;;10.0;IHS/RPMS UNIFORM DATA SYSTEM;;FEB 04, 2016;Build 50
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2015 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUDCTXCH",XBNS="",XBRX="XIT^BUDCTXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2015 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
