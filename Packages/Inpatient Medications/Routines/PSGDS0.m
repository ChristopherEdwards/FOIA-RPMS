PSGDS0 ;BIR/CML3-GATHER INFO FOR DISCHARGE SUMMARY ;08-Sep-2004 07:53;PLS
 ;;5.0; INPATIENT MEDICATIONS ;**4,8,24,58**;16 DEC 97
 ;
 ;Reference to ^PS(55 is supported by DBIA 2191
 ;Reference to ^PSDRUG is supported by DBIA 2192
 ;
 ; Modified - IHS/CIA/PLS - 08/29/04 - PAT+5
...
PAT ;
 ...
 ; IHS/CIA/PLS - 09/29/04 - Changed patient identifier from SSN to HRN.
 ...
 S ^TMP("PSG",$J,PSGAPWDN,PN)=$P(PSJPSEX,U,2)_U_$E($P(PSJPDOB,U,2),1,10)_";"_PSJPAGE_U_$G(PSJPPID)_U_PSJPDX_U_$S(PSJPRB]"":PSJPRB,1:"*NF*")_U_$E($P(PSJPAD,U,2),1,10)_U_$E($P(PSJPTD,U,2),1,10)_U_$E(PSGOD,1,8)_U_SC_U_+PSJPWT,^(PN,0)=ELIG
 Q
 ;
GDT ;
