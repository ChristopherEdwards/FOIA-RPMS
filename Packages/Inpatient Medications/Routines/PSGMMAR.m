PSGMMAR ;BIR/CML3-MULTIPLE DAY MARS - MAIN DRIVER ;24-May-2012 13:20;PLS
 ;;5.0; INPATIENT MEDICATIONS ;**15,20,1014**;16 DEC 97;Build 5
 ; Modified - IHS/MSC/PLS - 05/24/2012 - Line DONE+11
...
DATE ;
 ...
 I '$D(PSGMAROF),'$D(PSGOENOF) S (PSGP,PSGPAT,PSGMARWD)=0,PSGSSH="MAR" D ^PSGSEL G:"^"[PSGSS OUT D @PSGSS G:$G(PSJSTOP) OUT
...
DONE ;
 ...
 K APSPATS  ;IHS/MSC/PLS - 05/24/2012
 Q
 ;
G ;
 S DIC="^PS(57.5,",DIC(0)="QEAMI",DIC("A")="Select WARD GROUP: " W ! D ^DIC K DIC S PSGMARWG=+Y I +Y'>0 S PSJSTOP=1 Q
 D RBPPN^PSJMDIR
 Q
 ;
W ;
