PSGMMAR0 ;BIR/CML3-GATHERS INFO FOR MD CMR ;03-Apr-2012 10:34;PLS
 ;;5.0; INPATIENT MEDICATIONS ;**8,15,20,1013,111,145,196,1014**;16 DEC 97;Build 62
 ;
 ; Reference to ^PS(55 supported by DBIA #2191.
 ; Reference to ^PS(59.7 supported by DBIA #2181.
 ;
 ; Modified - IHS/MSC/PLS - 11/11/2011 - Line OS+5
...
OS ; order record set
 ...
 ;IHS/MSC/MGH patch 1013 put sort into uppercase
 ;NEW MARX D DRGDISP^PSJLMUT1(PSGP,+ON_"U",20,0,.MARX,1) S DRG=MARX(1)_$E(SD,2,7)_U_+ON_"U"
 NEW MARX D DRGDISP^PSJLMUT1(PSGP,+ON_"U",20,0,.MARX,1) S DRG=$$UP^XLFSTR(MARX(1))_$E(SD,2,7)_U_+ON_"U"
