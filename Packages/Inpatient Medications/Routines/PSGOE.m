PSGOE ;BIR/CML3-PROFILE AND ORDER ENTRY (MAIN DRIVER) ;24 Feb 99 / 10:40 AM
 ;;5.0; INPATIENT MEDICATIONS ;**22,29,56,72,95,80**;16 DEC 97
 ;
...
DONE ;
 ...
 G:($G(PSGPXN)&'$$DEFON^PSGPER1) ^PSGPER1 D ENKV^PSGSETU K ND1,PSG25,PSG26,PSGEB,PSBEBN,PSGNODE,PSGOAT,PSGSTAT,DDN,I2 Q
 Q
 ;
