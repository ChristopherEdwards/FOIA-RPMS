PSGPER ;BIR/CML3-PRINTS PRE-EXCHANGE NEEDS REPORT ;04 JAN 95 / 5:08 PM
 ;;5.0; INPATIENT MEDICATIONS ;**95,115**;16 DEC 97
 ;
 S PSGPERRF=0
DEV ;
 S PSGION=ION
DEV1 ;
 S D=$G(PSGPXDEV)
 S:'D D=$P(PSJSYSW0,U,29) Q:D=""  S IOP=$S(D:"`"_D,1:D) K %ZIS S %ZIS="NQ" D ^%ZIS S D=$S(ION]"":ION,1:"HOME")
...
DONE ;
 ...
 ;
OUT ;
 K PSGPERRF,PSGPXN N PSJSYSW0,PSGVBW,PSJPWD,PSJSYSL D  Q
