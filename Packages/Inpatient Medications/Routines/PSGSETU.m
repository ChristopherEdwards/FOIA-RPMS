PSGSETU ;BIR/CML3-PACKAGE UTILITIES ;10 Mar 99 / 10:53 AM
 ;;5.0; INPATIENT MEDICATIONS ;**3,11,26,39,58,115**;16 DEC 97
 ;
...
ENIVKV ; kill IV variables
 K CHK,PSIVPL,PSIVPR,PSIVSITE,PSIVSN
 ;
ENKV ; when exiting package
 ...
 K PSGDT,PSGID,PSGION,PSGOD,Q,QQ,PSJSYSL,PSJSYSW0,PSJSYSW,PSJSYSP,PSJSYSP0,PSJSYSU,PSJOCNT,PSJRNF,PSJIRNF,PSJITECH
 Q
 ;
ENCV ; check for (and set) package variables
 ...
 ;S DIC="^PS(53.45,",DIC(0)="LZ",DLAYGO=53.45,X=DUZ,D="B" D IX^DIC I Y'>0 D FILE^DICN
 ...
 ;S $P(PSJSYSU,";",4)=+PSJSYSU=3!$P(PSJSYSP0,"^",2),PSJSYSL=$P(PSJSYSP0,"^",7)]""_"^"_$P(PSJSYSP0,"^",7)
