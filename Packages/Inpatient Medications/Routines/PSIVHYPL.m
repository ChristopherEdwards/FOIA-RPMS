PSIVHYPL ;BIR/PR-PRINT OUT LABELS ;02-Apr-2004 11:56;PLS
...
HYP ;
 ...
 S X=$S($D(^PS(I,PSIVA,0)):$P(^(0),U),1:"Undefined "_$S(I=50.4:"electrolyte",I=52.7:"solution",1:"additive"))_" "_(X+.005\.01/100)_" "_$P($P(HYPL(I,PSIV,$O(HYPL(I,PSIV,""))),U)," ",2)
 D PRNTL
 Q
