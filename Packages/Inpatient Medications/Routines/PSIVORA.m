PSIVORA ;BIR/MLM-MAIN DRIVER FOR IV FLUIDS - OE/RR INTERFACE ;17-Oct-2011 11:31;PLS
 ;;5.0; INPATIENT MEDICATIONS ;**29,41,1013**;16 DEC 97;Build 33
 ;
 ; Reference to ^PS(55 is supported by DBIA 2191
 ;
 ; Modified - IHS/MSC/PLS - 10/17/2011 - Line HL+6
 ;
...
DC ; DC order from Pharmacy complete function.
 I PSJORD["V" N PSIVREA S ON55=PSJORD,X=$G(^PS(55,DFN,"IV",+ON55,0)),P(3)=$P(X,U,3),P(17)=$P(X,U,17),PSIVREA="D",PSIVALT=2,PSIVALCK="STOP" D D^PSIVOPT2 D HL Q
...
HL ;
 ...
 S PSJTX=$S($L($G(INCOM)):INCOM_"-",1:"")_PSJTX  ;IHS/MSC/PLS - 10/17/2011
