PSIVSTAT ;BIR/PR-BUILD COST TRANS NODE, ENTER COMPILE ;07-May-2008 21:35;SM
 ;;5.0; INPATIENT MEDICATIONS ;**3,18,84,81,104,1006**;16 DEC 97
 ;
 ...
 ;
 ; Modified - IHS/MSC/PLS - 05/07/08 - Line NOCOST+2
...
DSS ; Update DSS for IV extract
 ...
 .S ECUD=DFN_U_+ON_U_DDRG_U_PSIVNOW_U_PSIVC_U_ADSTR_U_ADUNITS_U_+SOLSTR_U_PROV_U_TYP_U_DCST S ^TMP($J,DFN,ON,DDRG)=ECUD_U_$G(^PS(55,DFN,"IV",+ON,"DSS"))_U_START D ^ECXPIV1
...
NOCOST ;Send message if the drug is missing a unit cost.
 ;
 ;IHS/MSC/PLS - 05/07/08 - ^TMP global reference was reversed resulting in MailMan message not getting sent.
