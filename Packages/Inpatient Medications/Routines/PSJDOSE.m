PSJDOSE ;BIR/MV-POSSIBLE DOSES UTILITY ;16 Jan 2001  1:53 PM
 ;;5.0; INPATIENT MEDICATIONS ;**50,65,106**;16 DEC 97
 ;
 ; Reference to ^PSSORPH is supported by DBIA #3234.
 ; Reference to ^VALM1 is supporetd by DBIA #10116.
 ;
...
EDITDD ;Editing DDs
 NEW DA,DR,DIE
 ;S DIE="^PS(53.45,",DA=PSJSYSP,DR=2,DR(2,53.4502)=".01;.02//1" D ^DIE
...
DOSECHK1 ;
 ...
 . ;Quit if no dose or it is local possible dose
 . ;I $P(PSJXDOX(1),U)=""!(+PSJXDOX(1)=-1) S PSJXFLG=1 Q
...
ONEDD ;
 ...
 . I +PSJXDOX(X)=+PSGDO,(PSJXUNIT=$P(PSJXDOX(X),U,2)),$S(PSJXDUP=$P(PSJXDOX(X),U,3):1,1:PSJXDUP=$P(PSJXDOX(X),U,12)) S PSJDSFLG=0
 Q
BCMAUPD(PSJDD) ;
 ;PSJDD = DD IEN
 NEW PSJCNT
 ...
 . Q:'+$P(PSJXDOX(X),U,12)
 . S PSJCNT=+$G(PSJCNT)+1
 . ;S PSJBCMA(+PSJDD,$P(PSJXDOX(X),U,12))=PSJCNT
