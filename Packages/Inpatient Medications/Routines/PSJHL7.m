PSJHL7 ;BIR/LDT-ACTIONS ON HL7 MESSAGES FROM OE/RR (CONT) ;29 AUG 96 / 11:18 AM
 ;;5.0; INPATIENT MEDICATIONS ;**42,47,50,70,82**;16 DEC 97
 ;
...
RENEW ;Renew orders from OE/RR
 ...
 S F="^PS(53.1,"_NEWORDER_",",@(F_"0)")=ND,^(.2)=OIDRG_U_PSGDO_U_ORDCON_U_PRIORITY_U_DOSE_U_UNIT,^(2)=ND2 S:$G(PSGSI)]"" ^(6)=PSGSI
 I $D(DRUGS) D
 .I $D(@(F_"1,0)")) K @(F_"1)")
