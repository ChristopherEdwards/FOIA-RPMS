PSJLIFNI ;BIR/MV-U/D ORDER FINISHES AS IV ;13 Jan 98 / 11:32 AM
 ;;5.0; INPATIENT MEDICATIONS ;**1,29,34,37,50,94,116**;16 DEC 97
 ;
IV(PSJORD,OI) ; Prompt for missing data to be finished as IV.
 ...
 I $$SCHREQ^PSJLIVFD(.P),(P(9))]"" N PSGOES,X,PSGS0XT,PSJNSS S PSJNSS=1,PSGOES=1,X=P(9),PSGS0XT=P(15) D Q2^PSGS0
