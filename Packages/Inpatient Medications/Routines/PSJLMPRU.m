PSJLMPRU ;BIR/MLM-INPATIENT LISTMAN UD PROFILE UTILITIES ;27 Aug 98 / 8:45 AM
 ;;5.0; INPATIENT MEDICATIONS ;**16,58,85**;16 DEC 97
 ;
...
PUD(DFN,ON,PSJF,DN) ; Setup LM profile view for UD
 ...
 ..S PSJL=PSJL_PSGID1_"  "_SD1_"  "_$E(STAT,1)
 ..I NF!WS!SM!PF S PSJL=$$SETSTR^VALM1($S(NF:"NF ",WS:"WS ",SM:$E("HSM",SM,3),1:""),PSJL,71,3) S:PF PSJL=$$SETSTR^VALM1("*",PSJL,79,1)
