PSJLMUDE ;BIR/MLM-SHOW FIELDS FOR EDIT (LISTMAN STYLE) ;01 JUNE 00 / 2:40 PM
 ;;5.0; INPATIENT MEDICATIONS ;**7,47,50,63,64,58,80,116**;16 DEC 97
...
INIT(PSGP,PSGORD) ;
 ...
 S PSJL=$$SETSTR^VALM1($S($D(PSGEFN(3)):$E(" *",PSGEFN(3)+1)_"(3)",1:"    ")_"Start: "_$P(PSGSDN,U,2),PSJL,54,26) D:$G(PSGOEEF(10)) HILITE(3) D SETTMP
 S PSJL=$S($D(PSGEFN(4)):$E(" *",PSGEFN(4)+1)_"(4)",1:"    "),PSJL=$$SETSTR^VALM1("Med Route: "_PSGMRN,PSJL,10,35) D:$G(PSGOEEF(3)) HILITE(4)
 I $G(PSJORD)["P",$G(PSGRDTX) D
 ...
 D SETTMP
 ;S PSJL=" "_$S($D(PSGEFN(4)):$E(" *",PSGEFN(4)+1)_"(4)",1:"    "),PSJL=$$SETSTR^VALM1("Med Route: "_PSGMRN,PSJL,10,35) D:$G(PSGOEEF(3)) HILITE(4)
 I PSGORD]"" S PSJBCMA=$$BCMALG^PSJUTL2(PSGP,PSGORD)
 I $G(PSJBCMA)]"" S PSJL=$$SETSTR^VALM1(PSJBCMA,PSJL,1,52)
 ;I $G(PSJORD)["P",$G(PSGRDTX(+$G(PSJORD),"PSGFD")) S PSGFDN=$$ENDD^PSGMI(PSGRDTX(+PSJORD,"PSGFD"))
 ...
 D SETTMP
 ;S PSJL=" "_$S($D(PSGEFN(6)):$E(" *",PSGEFN(6)+1)_"(6)",1:"    "),PSJL=$$SETSTR^VALM1("Schedule Type: "_PSGSTN,PSJL,6,45) D:$G(PSGOEEF(7)) HILITE(6)
 S PSGSMN=$P("NO^YES",U,PSGSM+1)
 ;S PSJL=$S($D(PSGEFN(8)):$E(" *",PSGEFN(8)+1)_"(8)",1:"   "),PSJL=$$SETSTR^VALM1("Schedule: "_PSGSCH,PSJL,11,68) D SETTMP D:$G(PSGOEEF(26)) HILITE(8)
 ...
 S PSJL=$S($D(PSGEFN(10)):$E(" *",PSGEFN(10)+1)_"(10)",1:"   "),PSJL=$$SETSTR^VALM1("Provider: "_PSGPRN,PSJL,11,68) D:$G(PSGOEEF(1)) HILITE(10)
 ...
 S PSJL=$$SETSTR^VALM1("DURATION: "_$G(PSJDUR),PSJL,55,25) D SETTMP
 ...
 ;I $O(^PS(53.45,PSJSYSP,1,0)) D SETTMP S PSJL=$S($D(PSGEFN(13)):$E("*",PSGEFN(13)+1)_"(13)",1:"     ")_" Comments:"
