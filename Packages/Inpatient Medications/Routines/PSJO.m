PSJO ;BIR/CML3,PR-GET AND PRINT INPATIENT ORDERS ;28 Jun 99 / 10:20 AM
 ;;5.0; INPATIENT MEDICATIONS ;**31,58**;16 DEC 97
 ;
...
ON ;
 ...
 .S PSJON=PSJON+1 S:'PSJDEV ^TMP("PSJON",$J,PSJON)=PSJO W !,$J(PSJON,4),?5 D @$S(PSJO["V":"PIV^PSIVUTL(PSJO)",PSJO["P":"PIV^PSIVUTL(PSJO)",1:"PUD")
 Q
 ;
PUD ; print unit dose
...
TF ;
 ...
 S LN2=$S(PSJC="A":"A C T I V E",PSJC["CC":"P E N D I N G   R E N E W A L S",PSJC["C":"P E N D I N G ",PSJC["B":"N O N - V E R I F I E D",1:"N O N - A C T I V E")
