PSJORPOE ;BIR/MLM,LDT-MISC. PROCEDURE CALLS FOR OE/RR 3.0 ;24 Feb 99 / 10:43 AM
 ;;5.0; INPATIENT MEDICATIONS ;**50,56,92,80**;16 DEC 97
 ;
...
STARTSTP(PSGP,SCH,OI,PSJPWD,PSGORD) ;
 ...
 N STRING S STRING=PSGNESD_U_PSGNEFD_U_$G(PSGSCH)_U_$G(PSGST)_U_$G(OI)
...
ADMIN ; Get admin times associated with schedule
 ...
 S ZZ=$O(LYN("DILIST",2,ZZ)) I ZZ S ZZ=+LYN("DILIST",2,ZZ) I ZZ S ZZND=$G(^PS(51.1,ZZ,0)) S PSGST=$P(ZZND,U,5),PSGS0XT=$P(ZZND,U,3)
