PSJVINIT ;BIR/-APR-1994;
 ...
 S U="^",DIFQ=0,DIFROM="4.5T3" W !,"This version (#4.5T3) of 'PSJVINIT' was created on 26-APR-1994"
 W !?9,"(at BIRMINGHAM, by VA FileMan V.20.0)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="PSJVINIS" X ^%ZOSF("TEST") D:$T PAC^PSJVINIS($T(IXF),.DIFROM)
