IBDX96 ; GENERATED FROM 'IBD CREATE FORM TRACKING' INPUT TEMPLATE(#2640), FILE 357.96;11/29/04
 D DE G BEGIN
...
BEGIN S DNM="IBDX96",DQ=1
 ...
 M DIEZAR=^DIE(2640,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2640,U="^"
