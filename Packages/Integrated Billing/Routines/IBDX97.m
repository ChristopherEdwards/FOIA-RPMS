IBDX97 ; GENERATED FROM 'IBD EDIT FORM TRACKING STATUS' INPUT TEMPLATE(#2641), FILE 357.96;11/29/04
 D DE G BEGIN
...
BEGIN S DNM="IBDX97",DQ=1
 ...
 M DIEZAR=^DIE(2641,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2641,U="^"
