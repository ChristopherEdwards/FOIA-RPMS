IBXEXI ; GENERATED FROM 'IB INACTIVATE EXEMPTION' INPUT TEMPLATE(#2574), FILE 354.1;11/29/04
 D DE G BEGIN
...
BEGIN S DNM="IBXEXI",DQ=1
 ...
 M DIEZAR=^DIE(2574,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2574,U="^"
