IBXEXS ; GENERATED FROM 'IB CURRENT STATUS' INPUT TEMPLATE(#2573), FILE 354;11/29/04
 D DE G BEGIN
...
BEGIN S DNM="IBXEXS",DQ=1
 ...
 M DIEZAR=^DIE(2573,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2573,U="^"
