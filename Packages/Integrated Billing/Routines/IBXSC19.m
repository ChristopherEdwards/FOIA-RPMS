...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=2,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 I $D(^(.11)) S %Z=^(.11) S %=$P(%Z,U,2) S:%]"" DE(1)=% S %=$P(%Z,U,3) S:%]"" DE(3)=% S %=$P(%Z,U,4) S:%]"" DE(4)=% S %=$P(%Z,U,5) S:%]"" DE(5)=% S %=$P(%Z,U,12) S:%]"" DE(6)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
C1F1 N X,X1,X2 S DIXR=23 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".11;3",DV="Fa",DU="",DLB="STREET ADDRESS [LINE 3]",DIFLD=.113
 S DE(DW)="C3^IBXSC19",DE(DW,"INDEX")=1
 G RE
...
C3F1 N X,X1,X2 S DIXR=24 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW=".11;4",DV="Fa",DU="",DLB="CITY",DIFLD=.114
 S DE(DW)="C4^IBXSC19",DE(DW,"INDEX")=1
 G RE
C4 G C4S:$D(DE(4))[0 K DB
 D ^IBXSC110
C4S S X="" G:DG(DQ)=X C4F1 K DB
 D ^IBXSC111
C4F1 N X,X1,X2 S DIXR=25 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
...
X4 K:$L(X)>15!($L(X)<2) X
 ...
 Q
 ;
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW=".11;5",DV="P5'a",DU="",DLB="STATE",DIFLD=.115
 S DE(DW)="C5^IBXSC19",DE(DW,"INDEX")=1
 S DU="DIC(5,"
 G RE
...
C5S S X="" G:DG(DQ)=X C5F1 K DB
 D ^IBXSC113
C5F1 N X,X1,X2 S DIXR=26 D C5X1(U) K X2 M X2=X D C5X1("O") K X1 M X1=X
 D
...
C5F2 Q
X5 Q
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW=".11;12",DV="FXOa",DU="",DLB="ZIP+4",DIFLD=.1112
 S DQ(6,2)="S Y(0)=Y D ZIPOUT^VAFADDR"
 S DE(DW)="C6^IBXSC19",DE(DW,"INDEX")=1
 G RE
C6 G C6S:$D(DE(6))[0 K DB
 D ^IBXSC114
C6S S X="" G:DG(DQ)=X C6F1 K DB
 D ^IBXSC115
C6F1 N X,X1,X2 S DIXR=22 D C6X1(U) K X2 M X2=X D C6X1("O") K X1 M X1=X
 D
...
C6X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C6F2 S DIXR=50 D C6X2(U) K X2 M X2=X D C6X2("O") K X1 M X1=X
 D
...
C6X2(DION) K X
 ...
 Q
C6F3 Q
X6 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>20!($L(X)<5) X I $D(X) D ZIPIN^VAFADDR
 I $D(X),X'?.ANP K X
 Q
 ;
7 D:$D(DG)>9 F^DIE17 G ^IBXSC116
