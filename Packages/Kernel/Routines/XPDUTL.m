XPDUTL ;SFISC/RSD - KIDS utilities ;10/15/2008
 ;;8.0;KERNEL;**21,28,39,81,100,108,137,181,275,491,511,559,1018**;Jul 10, 1995;Build 8
...
PATCH(X) ;return 1 if patch X was installed, X=aaaa*nn.nn*nnn
 ;Q:X'?1.4UN1"*"1.2N1"."1.2N.1(1"V",1"T").2N1"*"1.3N 0  ;XU*8.0*1018 - IHS/OIT/FBD - ORIGINAL LINE - COMMENTED OUT
 Q:X'?1.4UN1"*"1.2N1"."1.2N.1(1"V",1"T").2N1"*"1.6N 0  ;XU*8.0*1018 - IHS/OIT/FBD - EXPAND PATCH FORMAT TO aaaa*nn.nn*nnnnnn
 N %,I,J
 S I=$$LKPKG($P(X,"*")) Q:'I 0
