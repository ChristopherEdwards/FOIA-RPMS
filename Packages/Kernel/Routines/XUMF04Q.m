XUMF04Q ;BP/RAM - INSTITUTION QUERY ;06/28/00
 ;;8.0;KERNEL;**549,1018**;Jul 10, 1995;Build 12
 ;
 ;;IHS/OIT/FBD - 6/4/2015 - AS PART OF IHS PATCH XU*8.0*1018, ADDED LINE EN+2
 ;                          SKIP VA QUERY/RESPONSE ON IHS INSTITUTION FILE
 Q
 ;
EN ; -- QUERY and PROCESS RESPONSE
 ;
 Q:$G(DUZ("AG"))="I"  ;XU*8.0*1018
