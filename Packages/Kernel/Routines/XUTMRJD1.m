XUTMRJD1 ;SEA/RDS - TaskMan: Option, XURESJOB Exit Action, Part 2 ;11/8/94  09:12
 ...
 ;THIS ROUTINE CONTAINS IHS MODIFICATIONS BY IHS/ANMC/LJF 7/15/98
HELP1A ;
...
S2B1 ;
 ...
 .I ZTR2="" Q                        ;IHS/ANMC/LJF 7/15/98
 .;S ZTR1=$O(^TMP($J,"XUTMT",ZTSK))  ;IHS/ANMC/LJF 7/15/98
 .S ZTR1=$O(^TMP($J,"XUTMT",ZTR2,0)) ;IHS/ANMC/LFJ 7/15/98
 .I ZTR1="" Q
 .I ZTR1>ZTSK Q
 .S ZTCOUNT=ZTCOUNT+1
 .S ^TMP($J,"XUTMRJD",ZTSK)=""
