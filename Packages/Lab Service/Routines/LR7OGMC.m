LR7OGMC ;VA/DALOI/STAFF- Interim report rpc memo chem ;JUL 06, 2010 3:14 PM
 ;;5.2;LAB SERVICE;**1027,1028**;NOV 01, 1997;Build 46
 ;;5.2;LAB SERVICE;**187,230,312,286,356,372**;NOV 01, 1997;Build 11
 ;
...
CH(LRDFN,IDT,ALL,OUTCNT,FORMAT,DONE) ; from LR7OGM
 ...
 . I 'FORMAT D PRINT^BLR7OGMP(.OUTCNT)
 . K ^TMP("LR7OG",$J,"TP")
 Q
 ;
 ;
