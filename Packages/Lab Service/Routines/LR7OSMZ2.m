...
ANTI ;from LR7OSMZ1
 ...
 . S B=0
 . F  S B=$O(^LR(LRDFN,"MI",LRIDT,14,B)) Q:B<1  S X=^(B,0) D LINE S ^TMP("LRC",$J,GCNT,0)=$$S^LR7OS(1,CCNT,$P(X,U))_$$S^LR7OS(20,CCNT,$P(X,U,3))_$$S^LR7OS(42,CCNT,$S($P(X,U,2)="P":"PEAK",$P(X,U,2)="T":"TROUGH",1:""))
 Q
BACT ;from LR7OSMZ1
