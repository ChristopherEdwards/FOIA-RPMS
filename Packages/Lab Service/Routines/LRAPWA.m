LRAPWA ; IHS/DIR/FJE - GETP AP ACCESSION FOR WORKLOAD 13:01 ; [ 8/3/91 ]
 ;;5.2;LR;;NOV 01, 1997
 ;
 ...
 W !,LRP,"  ID: ",HRCN S LRI=$P(^LRO(68,LRAA,1,LRAD,1,LRAN,3),"^",5),LRA=^LR(LRDFN,LRSS,LRI,0),LRRC=$P(LRA,"^",10)  ;IHS/ANMC/CLS 11/1/95
