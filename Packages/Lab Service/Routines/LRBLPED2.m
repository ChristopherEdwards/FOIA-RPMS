LRBLPED2 ; IHS/DIR/FJE - PROCESS PEDIATRIC UNIT 2/4/93 12:07 ;
 ;;5.2;LR;;NOV 01, 1997
 ;
 ...
 S DA=+Y,DR=".02///SELF;.03///00;.04///^S X=LRP;.05///^S X=LRK;.06////^S X=LRE(1);.07///^S X=LRABO;.08///^S X=LRRH;.09////^S X=DUZ;.11///^S X=LRV(1)" D ^DIE D:LRCAPA ^LRBLW
