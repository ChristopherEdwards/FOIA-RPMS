LREXPD ;SLC/RWF-EXPLODE A LRTEST LIST ;DEC 09, 2008 8:30 AM
...
TREE I '$D(^LAB(60,X,0)) Q  ;BAD LRTEST NUMBER
 ...
 ; ----- BEGIN IHS/OIT/MKK LR*5.2*1025 MODIFICATION -- LRTSTS Variable can be null
 I $P(^LAB(60,X,0),U,5)]"" Q:$D(^TMP("LR",$J,"T",X))  S LRTSTS=1+$G(LRTSTS),LRORD(LRTSTS)=X,^TMP("LR",$J,"T",X)=^LAB(60,X,0) X:$D(LREXPD) LREXPD Q  ;ADD TO LIST
