LRGVP ;VA/SLC/CJS - GROUP DATA REVIEW DISPLAY ; 13-Aug-2013 09:16 ; MKK
 ;;5.2;LR;**112,1013,411,1033**;NOV 1, 1997
 ;
EP ; EP
...
PRINT Q:'$D(^LRO(68,LRAA,1,LRAD,1,LRAN,0))  S LRDFN=+^(0),LRORD=$S($D(^(.1)):^(.1),1:0),LRODT=$S($P(^(0),U,4):$P(^(0),U,4),1:$P(^(0),U,3)),LRLLOC=$P(^(0),U,7),LRSN=$P(^(0),U,5) Q:LRSN<1
 ...
 W !!,PNM,?30,"HRCN: ",HRCN,?50,"WARD: ",$S(LRDPF=2&($L(LRWRD)):LRWRD,1:LRLLOC) W:LRORD !,"ORDER NUMBER: ",LRORD    ;IHS/ANMC/CLS 08/18/96
