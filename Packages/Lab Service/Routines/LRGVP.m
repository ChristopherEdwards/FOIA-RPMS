LRGVP ; IHS/DIR/FJE - GROUP DATA REVIEW DISPLAY 2/5/91 13:29 ;
...
PRINT Q:'$D(^LRO(68,LRAA,1,LRAD,1,LRAN,0))  S LRDFN=+^(0),LRORD=$S($D(^(.1)):^(.1),1:0),LRODT=$S($P(^(0),U,4):$P(^(0),U,4),1:$P(^(0),U,3)),LRSN=$P(^(0),U,5) Q:LRSN<1
 ...
 W !!,PNM,?30,"HRCN: ",HRCN,?50,"WARD: ",$S(LRDPF=2&($L(LRWRD)):LRWRD,$D(^LR(LRDFN,.1)):^(.1),1:"") W:LRORD !,"ORDER NUMBER: ",LRORD  ;IHS/ANMC/CLS 08/18/96
