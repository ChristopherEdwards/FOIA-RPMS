LRKUR ;SLC/RWF- KEYBOARD URINE COUNTER ; 2/14/89  17:08 ; [ 10/14/90  8:59 PM ]
...
PR W !!,"Patine name: ",PNM,"  HRCN: ",HRCN,"  Acc: ",LRACC  ;IHS/ANMC/CLS 10/14/90 HRCN
...
END S LRAN=-1 Q
 Q
INT K KEY F I=0:0 S I=$O(^UTILITY("LA",$J,I)) Q:I'>0  S J=I+29\30-1,I3=^(I,3),I4=^(4),X=^(0) D INT2
 S ^UTILITY("LA",$J,99)="" Q
INT2 S I1=$P(^LAB(60,X,.1),U,1),DA=+^(.2),DD=^DD(63.04,DA,0),^UTILITY("LA",$J,I,.1)=I1,^("DD")=DD
 I $D(KEY(J,I4)) W *7,!!,">> The same KEY (",I4,") is set for more than one TEST (",I1," screen ",$S(J=0:"main",J=1:"cast",1:"crystal"),")<<",!!,*7 Q
