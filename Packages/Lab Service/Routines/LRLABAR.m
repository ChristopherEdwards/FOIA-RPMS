LRLABAR ; IHS/DIR/FJE - LABEL BAR CODE DOWN LOAD FORMAT ;
 ;;5.2;LR;;NOV 01, 1997
 ;
...
TEST ;
 ...
 S PNM="PATIENTS,NAME",HRCN="12-34-56",LRURG="ROUTINE",LRAN=50,LRINFW="SICK GUY",LRCE=1100,LRTXT="GLU,NA,CO2,CL,K",LRTOP="RED",LRACC="CH 0521 50",LRLLOC="SICU" D F3,F2  ;IHS/ANMC/CLS 11/1/95
 Q
F3 ;D ENQ U IO W *2,*27,"E3",*24,PNM_"  "_$P(SSN,"-",3),!,LRINFW,!,LRTXT,!,LRACC_"   "_LRURG_"   "_LRLLOC,!,"CH",!,$E("00000",$L(LRAN),5)_LRAN,*30,1,*23,*3 D ENQ
 D ENQ U IO W *2,*27,"E3",*24,PNM_"  "_HRCN,!,LRINFW,!,LRTXT,!,LRACC_"   "_LRURG_"   "_LRLLOC,!,"CH",!,$E("00000",$L(LRAN),5)_LRAN,*30,1,*23,*3 D ENQ  ;IHS/ANMC/CLS 11/1/95
 Q
F2 ;D ENQ U IO W *2,*27,"E2",*24,PNM_"  "_$P(SSN,"-",3),!,LRINFW,!,LRTXT,!,LRACC_"   "_LRURG_"   "_LRLLOC,!,"RED TOP ORD:#   RM/BED ",*30,1,*23,*3
 D ENQ U IO W *2,*27,"E2",*24,PNM_"  "_HRCN,!,LRINFW,!,LRTXT,!,LRACC_"   "_LRURG_"   "_LRLLOC,!,"RED TOP ORD:#   RM/BED ",*30,1,*23,*3  ;IHS/ANMC/CLS 11/1/95
