LRMISEZ1 ; IHS/DIR/FJE - MICROBIOLOGY INFECTION CONTROL DATA 4/17/91 14:29 ;
 ;;5.2;LR;**1013,1024**;May 02, 2008
 ;
...
SET S LRDFN=+LRND Q:'$D(^LR(LRDFN,"MI",LRIDT,3,0))
 ...
 S LROR=0,LRMY=$E(LRTK,1,5),LRLLOC=$E($P(LRND,U,7),1,7) S:'$L(LRLLOC) LRLLOC="" S:LRLLOC["DIED" LRLLOC="EXPIRED"  ;IHS/ANMC/CLS 08/18/96
 ; ----- BEGIN IHS/OIT/MKK MODIFICATION -- LR*5.2*1024
 I $G(LRLLOC)="" S LRLLOC="UNKNOWN"
 ; ----- END IHS/OIT/MKK MODIFICATION -- LR*5.2*1024
 D ^LRMISEZB
 Q
