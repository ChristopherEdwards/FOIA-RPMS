LRORDK ;VA/SLC/FHS - CLEAN UP AFTER ACCESSIONING PROCESS ; 11-Dec-2014 15:39 ; MAW
 ;;5.2;LAB SERVICE;**61,100,1010,121,153,201,1018,1025,1034**;NOV 01, 1997;Build 88
EN ;
KILL K LRSD,LRXDFN,LRXDPF,LR696IEN,LABTEST
 ...
 ;----- BEGIN IHS/OIT/MKK MODIFICATIONS LR*5.2*1025
 K HRCN
 K BLRINS,BLRDXS,BLRINSS,AGINS,AGINS1,AGINSNN,BLRRL,BLRRLCLA  ;cmi/7/1/2010 reference lab ledi variables
 K BLRASFLG  ;ihs/cmi/maw 12/10/2014 p1034
 D:'$G(BLRGUI) ^%ZISC
 ;----- END IHS/OIT/MKK MODIFICATIONS
 Q
 ;
