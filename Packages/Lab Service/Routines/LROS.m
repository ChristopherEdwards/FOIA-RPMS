LROS ;SLC/CJS/DALOI/FHS-LAB ORDER STATUS ; 22-Oct-2013 09:22 ; MKK
 ;;5.2;LR;**1003,1004,1015,1018,1030,1033**;NOV 01, 1997
...
WRITE ;
 ...
 ;
 ; ----- BEGIN IHS/MSC/MKK - LR*5.2*1033 - Changed 'Sign or Symptom'
 W:$L($G(^LRO(69,LRODT,1,LRSN,2,LRACN,9999999))) !,?2,"Clinical Indication: ",$G(^LRO(69,LRODT,1,LRSN,2,LRACN,9999999))
 ; I $L($G(^LRO(69,LRODT,1,LRSN,2,LRACN,9999999))) D
 ; . W !,?2,"Clinical Indication: ",$$GET1^DIQ(69.03,LRACN_","_LRSN_","_LRODT,"PROVIDER NARRATIVE")
 ; . W !,?15,"SNOMED: ",$$GET1^DIQ(69.03,LRACN_","_LRSN_","_LRODT,"SNOMED")
 ; . W !,?18,"ICD: ",$$GET1^DIQ(69.05,"1,"_LRACN_","_LRSN_","_LRODT,.01)
