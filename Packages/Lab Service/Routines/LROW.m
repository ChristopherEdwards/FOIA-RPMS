LROW ; IHS/DIR/MJL - LAB ORDER ENTRY, WARD 8/11/97 ;  [ 07/22/2002  1:34 PM ]
 ;;5.2;LR;**1003,1009,1013**;JUL 15, 2002
 ;;5.2;LAB SERVICE;**100,121**;Sep 27, 1994
W10 D ^LRPARAM K X3,LRNATURE S U="^" D DT^LRX I $D(LRADDTST) Q:LRADDTST=""
...
MORE ;from LROR
 K T,TT,LRCOM,LRTCOM,LROT,LRTMAX,LRDTST,LRDMAX
 S DA=0 F  S DA=$O(^LRO(69,LRODT,1,"AA",LRDFN,DA)) Q:DA<1  I $S($D(^LRO(69,LRODT,1,DA,1)):$P(^(1),U,4)'="U",1:1) S LRSAMP=$P(^(0),U,3) D Q12A
 S LRCCOM="" D ^LROW1 Q:$D(DIROUT)  I $D(LRADDTST),$P(LRADDTST,U,2)="OUT" G NOMORE
 G W10:LRTSTN=0
NOMORE ;from LROR
 ...
 D LROW^LRORDD
 ;D REST^LROW2 D:BLRLOG ^BLRSLTL("C","O",$G(BLROPT)) K LRORIFN Q:$D(LRADDTST)  ;IHS/OIRM TUC/AAB 11/14/96
