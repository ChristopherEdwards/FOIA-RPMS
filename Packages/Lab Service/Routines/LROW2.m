LROW2 ; IHS/DIR/AAB - TEST & SAMPLE VERIFICATION 8/11/97 ; [ 11/19/2002  8:37 AM ]
 ;;5.2;LR;**1003,1011,1015,1018,1030**;NOV 01, 1997
 ;;5.2;LAB SERVICE;**121**;Sep 27, 1994
COL S $P(^LRO(69,LRODT,1,LRSN,0),U,2)=DUZ Q
REST ;from LRFAST, LROE1, LROW
 D:+$P($G(^BLRSITE($G(DUZ(2)),0)),U,10) ENTRYAUD^BLRUTIL("REST^LROW2 0.0")
 ...
 D ORDER
PAST ; EP
 D:+$P($G(^BLRSITE($G(DUZ(2)),0)),U,10) ENTRYAUD^BLRUTIL("PAST^LROW2 0.0")
...
ORDER ;from LRMIBL, LROE1, LRORD1, LRQCLOG
 D:+$P($G(^BLRSITE($G(DUZ(2)),0)),U,10) ENTRYAUD^BLRUTIL("ORDER^LROW2 0.0")
 N LRYR
 S LRYR=$E(DT,1,3)_"0000" I '$D(^LRO(69,LRYR,2)) S ^LRO(69,LRYR,0)=LRYR,^(2)=0,^LRO(69,"B",LRYR,LRYR)="" ;HAPPY NEW YEAR!
NEXT ; EP
 D:+$P($G(^BLRSITE($G(DUZ(2)),0)),U,10) ENTRYAUD^BLRUTIL("NEXT^LROW2 0.0")
