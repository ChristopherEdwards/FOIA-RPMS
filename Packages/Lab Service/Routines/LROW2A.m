LROW2A ; IHS/HQT/MJL - CONTINUING TEST & SAMPLE VERIFICATION ; [ 02/20/2003  7:51 AM ]
 ;;5.2;LR;**1010,1015**;NOV 18, 2002
 ;;5.2;LAB SERVICE;**20,40,100,107,121**;Sep 27, 1994
...
DUP L +^LRO(69,LRODT,1) S LRSN=1+$S($D(^LRO(69,LRODT,1,0)):$P(^(0),"^",3),1:0)
 ...
 .;I $D(^LRO(69,LRODT,1,LRSN,2,0)) D:'$G(BLRGUI) ADDTST^BLRDIAG(LRODT,LRSN,+LRTEST(LRI))  ;IHS/ITSC/TPF 11/12/02 **1015*
 ...
 ;D:BLRLOG ^BLRSLTL("C","O",$G(BLROPT)) ;IHS/DIR/MJL 09/20/99
 D:BLRLOG ^BLREVTQ("C","O",$G(BLROPT),,LRODT_","_LRSN)
 ;
 I $D(^LRO(69,LRODT,1,LRSN,2,0)) D:'$G(BLRGUI) ADDTST^BLRDIAG(LRODT,LRSN,+$G(^LRO(69,LRODT,1,LRSN,2,LRTN,0)))  ;IHS/ITSC/TPF 11/06/02 'SIGN OR SYMPTOM' LAB POV **1015** CALL ONLY IF THIS IS NOT A PATIENT CHART GUI SESSION
