LRRP ;DALOI/RWF/BA - PROCESS DATA FOR INTERIM REPORTS ; 24-Nov-2014 09:20 ; MKK
 ;;5.2;LAB SERVICE;**195,221,283,286,1027,1034**;NOV 01, 1997;Build 88
 ;
...
SETUP Q:'LRTSTS  Q:'$D(^LAB(60,LRTSTS,.1))  S X=^(.1)
 ...
 Q:'$D(^LR(LRDFN,LRSS,LRIDT,LRDN))  Q:'$L($P($G(^(LRDN)),U))    ; IHS/MSC/MKK - LR*5.2*1034
 ;
