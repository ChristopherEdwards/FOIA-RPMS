LRTSTJAM ;SLC/CJS - JAM TESTS ONTO (OR OFF) ACCESSIONS ;8/11/97 [ 04/14/2003  1:52 PM ]
...
END I $G(LRAA),$G(LRAD),$G(LRAN) L -^LRO(68,LRAA,1,LRAD,1,LRAN)
 ...
 ;----- BEGIN IHS MODIFICSTIONS LR*5.2*1018
 K %,A,AGE,DD,DFN,DIC,DIE,DO,DOB,DR,I,K,LRAA,LRAD,LRACD,LRAN,LRCCOM,LRDFN,LRDPF,LREND,LRIDT,LRODT,LRSN,LRSS,LRTNM,LRTS,LRWRD,PNM,SEX,SSN,HRCN,X,Y,Z,LRUSNM  ;IHS/ANMC/CLS 08/18/96
 ;----- END IHS MODIFICATIONS
