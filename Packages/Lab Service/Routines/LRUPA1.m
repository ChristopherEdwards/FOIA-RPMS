LRUPA1 ; IHS/DIR/FJE - LAB ACCESSION LIST COND'T 3/3/94 10:07 ;
 ;;5.2;LR;;NOV 01, 1997
 ;
...
V D:$Y>(IOSL-8) H^LRUPA Q:LR("Q")  W ! I A(3)<LRAD W $E(A(3),4,5),"/",$E(A(3),6,7)
 ...
 W ?5,$J(N,5) S (X,Z)=^LR(LRDFN,0),(DFN,Y)=$P(X,"^",3),(LRDPF,X)=$P(X,"^",2),P(0)=$P(^DIC(X,0),"^"),X=^DIC(X,0,"GL")  ;IHS/ANMC/CLS 08/18/96
 ...
 W ?12 W:P(0)'="VA PATIENT" "#" W $E(LRP,1,14),?27,HRCN,?34,$E(A(7),1,5) I LRSS="BB" D:$Y>(IOSL-8) H^LRUPA Q:LR("Q")  W !?7,HRCN," ",$P(Z,"^",5)," ",$P(Z,"^",6)  ;IHS/ANMC/CLS 08/18/96
...
H D H^LRUPA Q:LR("Q")  W ! I A(3)<LRAD W $E(A(3),4,5),"/",$E(A(3),6,7)
 ...
 W ?5,$J(N,5),?12 W:P(0)'="VA PATIENT" "#" W $E(LRP,1,14),?27,HRCN,?34,$E(A(7),1,5) W:LRSS="BB" ?40,LRA Q  ;IHS/ANMC/CLS 08/18/96
