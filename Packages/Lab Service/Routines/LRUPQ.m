LRUPQ ; IHS/DIR/FJE - LAB RESULTS BY ACCESSION AREA 2/18/93 13:12 ;
 ;;5.2;LR;;NOV 01, 1997
 ;
...
H I $D(LR("F")),IOST?1"C".E D M^LRU Q:LR("Q")
 ...
 W !,"Acc #",?7,"Patient",?28,"HRCN",?35,"LOC",?41,"Specimen",?56,"Received",?68,"Verified",!,LR("%") Q  ;IHS/ANMC/CLS 08/18/96
 ;
