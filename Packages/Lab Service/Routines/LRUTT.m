LRUTT ;AVAMC/REG - LAB TEST TURNAROUND TIME; 12/23/88 12:45 ;6/12/93  12:22 ; [ 04/15/2003  10:01 AM ]
...
W D:$Y>(IOSL-6) H1 Q:LR("Q")
 ;W !?3,LRT(T),?33,$E(B,4,5)_"/"_$E(B,6,7)_"/"_$E(B,2,3),?43 S X(1)=^TMP($J,A,T,B,C,E),X=+X(1),Y=X\60,X=X#60 W:Y $J(Y,3)," hr" W:X ?50,$J(X,2)," min" W ?60,"Arr time:" S X=$P(X(1),"^",2) W $E(X,1,2)_":"_$E(X,3,4) Q
 ;----- BEGIN IHS MODIFICATIONS LR*5.2*1018
...
H1 ;D H Q:LR("Q")  W !,LRP,?31,SSN Q
 ;----- BEGIN IHS MODIFICASTIONS LR*5.2*1018
 D H Q:LR("Q")  W !,LRP,?31,HRCN Q  ;IHS/ANMC/CLS 08/18/96
 ;----- END IHS MODIFICATIONS
 ;
END D V^LRU Q
