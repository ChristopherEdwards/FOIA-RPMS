...
XREF ;from COM1^LRVER4 and VER^LRVER3A
 ...
 ;----- BEGIN IHS/OIT/MKK - LR*5.2*1030 - Put back in after VA patch
...
IHS ; 
 ...
 ;----- END IHS MODIFICATION -- IHS/OIT/MKK - LR*5.2*1030
...
REQ ;
 ...
 ;----- BEGIN IHS MODIFICATION LR*5.2*1018 -- IHS/OIT/MKK - LR*5.2*1030 - Put back in after VA patch
 ;      Original Comments:
