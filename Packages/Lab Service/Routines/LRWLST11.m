LRWLST11 ;DALOI/CJS,RWF/FHS - ACCESSION SETUP ;JUL 06, 2010 3:14 PM
 ;;5.2;LAB SERVICE;**121,128,153,202,286,1027**;NOV 01, 1997
...
SLRSS ;
 ...
 ; REPLACED $D WITH $G -- AFTER INSTALL OF OE/RR 3.0, LRSPEC NOT SET RIGHT
 S H8=$S($G(LRSPEC):LRSPEC,1:X)_U_$S("CYEMSPAU"[LRSS:LRACC,1:LRACC)_U_$S(LRSS="MI":LRPRAC,1:"")_U_$S(LRSS="MI":LRLLOC,1:"")_"^^"_$S(LRSS="CH":LRPRAC,1:"")_"^"_$S(LRSS="MI":$P(LRSAMP,";",1),LRSS="CH":LRLLOC,1:"")
