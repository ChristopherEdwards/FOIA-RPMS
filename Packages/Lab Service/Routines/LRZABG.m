LRZABG ;SLC/RWF- PULMONARY LAB DATA DISPLAY ; 8/25/87  08:27 ; [ 09/03/90  8:32 AM ]
 ;;V~4.08~
 ;
PR ;PRINT
 ...
 K %IS D ^%ZIS Q:POP  U IO
PALL S LRDPF=$P(^LR(LRDFN,0),U,2),DFN=$P(^(0),U,3) D PT^LRX
 D HEAD^LRZABG1 S U="^",LRLDT=0,LREND=0
 S LRPQ="11^17^24^31^37^45^52^59^66^74",LRPJ="1^1^1^1^2^1^1^1^1^"
 S LRXW="IF $L(LRZZ) W ?$P(LRPQ,U,I),$S(I=1:$J(LRZZ,3,$P(LRPJ,U,I)),LRZZ#1:$J(LRZZ,5,$P(LRPJ,U,I)),1:$J(LRZZ,5))"
 G ^LRZABG1  ;IHS/ANMC/CLS 08/31/90
