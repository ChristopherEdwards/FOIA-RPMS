LEX2I03E ;IHS/OIT/FCJ - LEX*2.0*1003 Env Check FOR IHS patch 1003 ;07/01/2011
...
ENV ;               
 ...
 D ENDR^%ZISS
CHK ;
 ;I $$INSTALLD("LEX*2.0*1003") W !,"LEX*2.0 has already been installed." S XPDQUIT=2 Q
 ;I '$$INSTALLD("ICPT*6.0*1003") S XPDQUIT=2
 ;I '$$INSTALLD("ICD*18.0*1003") S XPDQUIT=2
 I '$$INSTALLD("LEX*2.0*1002") S XPDQUIT=2
 I $$VCHK("DI","22.0",2,"<")
 I $$VCHK("XU","8.0",2,"<")
 ...
 D HELP^XBHELP("INTROE","LEX2I03E")
 I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2) Q
 I $G(XPDENV)=1 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0 D HELP^XBHELP("INTROI","LEX2I03E") I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2)
 Q
 ;
SORRY(X) ;
 KILL DIFQ
...
INTROE ; Intro text during KIDS Environment check.
 ;; Distribution contains VA Lexicon patches 79 and 82.
 ;;
 ;;
 ;;###
 ;
