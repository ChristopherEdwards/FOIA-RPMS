AZAMED ; IHS/PHXAO/TMJ - ACTUAL UPDATES OF AHCCCS MEDICAID RECORDS [ 06/18/03  10:34 AM ]
...
A ; -- BEGIN $O THRU AZAGMED(GLOBAL CREATED BY AZAGMED
 ...
 . I MLNAME'=SLNAME&(MNAMEMAT'=1) S SSNCT=SSNCT+1 S SSNMATCH="Y" N N,MSSN,MNUM D ^AZAMED0 Q  ; Quit if no match on Med Name or Last Name ;*** TESTING - AEF *** ADDED ADDITIONAL SPACE AFTER QUIT TO PREVENT <SYNTAX> ERROR 
...
MED ; -- add eligiblity date(s)/data
 ...
 Q:$P($G(^AUPNMCD(IEN,0)),U,4)'=3   ;*** TESTING - AEF *** DON'T UPDATE IF NOT AZ
 ...
 . S DR=".01///"_EBD_";.03////"_CT ; Add Beginning DT Only ;*** TESTING - AEF *** REMOVE EXTRA QUOTE TO PREVENT <SYNTAX> ERROR
...
NEW ; -- create new entry in medicaid eligible
 ...
 S DIC("DR")=".02////"_INS_";.03////"_MNUM_";.04////"_3_";2101////"_MFULNAME
