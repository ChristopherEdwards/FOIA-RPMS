AZANUPDT ; IHS/PHXAO/TMJ - Print Updates to Master List for a specific Log [ 02/03/03  11:55 AM ]
...
PRINT ;PRINT CLOSED DISCLOSURES BY DATE
 ;W !
 S AZAMBY=$S(AZAMBY=0:"[AZAM MASTER UPDATE]",1:"@INTERNAL(#.03)")
 S FLDS="[AZAM MASTER UPDATE]",BY=AZAMBY,DIC="^AZAMASTR(",L=0
