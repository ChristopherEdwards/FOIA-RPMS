AZHNINIT ; ; 05-AUG-1998
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="4.1T4" W !,"This version (#4.1T4) of 'AZHNINIT' was created on 05-AUG-1998"
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="AZHNINIS" X ^%ZOSF("TEST") D:$T PAC^AZHNINIS($T(IXF),.DIFROM)
...
PKG S X=$P($T(IXF),";",3),DIC="^DIC(9.4,",DIC(0)="",DIC("S")="I $P(^(0),U,2)="""_$P(X,U,2)_"""",X=$P(X,U) D ^DIC S DIFROM(0)=+Y K DIC
 Q
 ;
IXF ;;AZHN DALE'S WORK PACKAGE^AZHN;12
