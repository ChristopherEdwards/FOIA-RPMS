AZQ2RXP1 ;IHS/ASU/RPL;PRINT PVT INS. AND PRESCRIPTION INFO; ; 8/31/89  10:33 AM [ 09/18/90  1:45 PM ]
 ;Version 1.1
 ;Called from AZQ2RXP
START ;
 S AZQ280D="--------------------------------------------------------------------------------" ;80 DASHES
...
PRNT I $Y>(IOSL-5) D HEAD Q:$D(AZQ2QUIT)
 S AZQ2N0=^PSRX(AZQ2PDFN,0),AZPRX=$P(AZQ2N0,"^"),AZQ2DDFN=$P(AZQ2N0,"^",6),AZQ2QTY=$P(AZQ2N0,"^",7) ;FCJ PAO 9/12/90
 S Y=AZQ2DT X ^DD("DD")
 W !,AZPRX,?8,Y ;FCJ PAO 9/12/90
...
HEAD1 W @IOF
 ...
 W !!,?2,"HRN",?8,"Patient Name",?40,"DOB",!! ;,?8,"Insurer",?40,"Policy Number",!,?8,"Name of Insured",?40,"Relationship"
 W !,AZQ280D
 Q
SUBHD I $Y>(IOSL-8) D HEAD Q:$D(AZQ2QUIT)
 W !,"RX #",?8,"Fill Date",?21,"Drug",?50,"NDC Code",?66,"Cost",?74,"Bill",!,"----",?8,"-----------",?21,"---------------------------",?50,"------------",?64,"------",?72,"------"
 Q
