MCAROPA ; GENERATED FROM 'MCAROPA' PRINT TEMPLATE (#3713) ; 11/29/04 ; (FILE 698.2, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 S X=$G(^MCAR(698.2,D0,3)) S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^VA(200,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,35)
