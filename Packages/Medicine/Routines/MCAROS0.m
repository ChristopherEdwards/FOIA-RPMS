MCAROS0 ; GENERATED FROM 'MCARSR' PRINT TEMPLATE (#3717) ; 11/29/04 ; (FILE 694.5, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 S X=$G(^MCAR(694.5,D0,1)) D T Q:'DN  S DIWL=67,DIWR=80 S Y=$P(X,U,17) S:Y]"" Y=$S($D(DXS(15,Y)):DXS(15,Y),1:Y) S X=Y D ^DIWP
 D 0^DIWW
 D ^DIWW
