MCOBEP ; GENERATED FROM 'MCAREPBRPR' PRINT TEMPLATE (#3746) ; 11/29/04 ; (FILE 691.8, MARGIN=80)
 G BEGIN
N W !
...
B1R ;
 ...
 S X=$G(^MCAR(691.8,D0,15)) S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^VA(200,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,35)
