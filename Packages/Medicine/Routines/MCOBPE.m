MCOBPE ; GENERATED FROM 'MCARPULMBRPR' PRINT TEMPLATE (#3752) ; 11/29/04 ; (FILE 699, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 S X=$G(^MCAR(699,D0,0)) S Y=$P(X,U,2) S Y=$S(Y="":Y,$D(^MCAR(690,Y,0))#2:$P(^(0),U),1:Y) S Y=$S(Y="":Y,$D(^DPT(Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
...
A1R ;
 ...
 G B1R
B1 ;
 S X=$G(^MCAR(699,D0,10,D1,0)) S DIWL=14,DIWR=68 S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^MCAR(695.5,Y,0))#2:$P(^(0),U),1:Y) S X=Y D ^DIWP
 D 0^DIWW
 D ^DIWW
 Q
B1R ;
 ...
 G C1R
C1 ;
 S X=$G(^MCAR(699,D0,11,D1,0)) S DIWL=18,DIWR=72 S Y=$P(X,U,1) S Y=$S(Y="":Y,$D(^MCAR(699.83,Y,0))#2:$P(^(0),U),1:Y) S X=Y D ^DIWP
 D 0^DIWW
 D ^DIWW
 Q
C1R ;
...
E1R ;
 ...
 S X=$G(^MCAR(699,D0,12)) D T Q:'DN  S DIWL=3,DIWR=57 S Y=$P(X,U,1) S X=Y D ^DIWP
 D 0^DIWW
 D ^DIWW
...
F1R ;
 ...
 S X=$G(^MCAR(699,D0,0)) S Y=$P(X,U,8) S Y=$S(Y="":Y,$D(^VA(200,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,35)
 ...
 S DIWL=26,DIWR=80 S Y=$P(X,U,2) S X=Y D ^DIWP
 D 0^DIWW
 D ^DIWW
