MCOPRG ; GENERATED FROM 'MCBUILDGENERIC' INPUT TEMPLATE(#2735), FILE 697.2;11/29/04
 D DE G BEGIN
...
BEGIN S DNM="MCOPRG",DQ=1
 ...
 M DIEZAR=^DIE(2735,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2735,U="^"
...
16 S D=0 K DE(1) ;1000
 S DIFLD=1000,DGO="^MCOPRG1",DC="1^697.21PA^CPT^",DV="697.21MP81'",DW="0;1",DOW="CPT",DLB="Select "_DOW S:D DC=DC_D
 S DU="ICPT("
