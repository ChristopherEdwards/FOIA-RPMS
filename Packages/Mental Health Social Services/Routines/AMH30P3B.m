AMH30P3B ; IHS/BJI/GRL - Routine to create bulletin [ 09/14/04  6:56 AM ]
 ;;3.0;IHS BEHAVIORAL HEALTH;**3**;JAN 27, 2003
...
WRITEMSG ;
 ...
 ;;+++++++++++++++++++++ end of announcement +++++++++++++++++++++++
 ;;
 ;; - adds 5 new activity codes:
 ;;   85 - Art Therapy
 ;;   86 - Recreation Activities
 ;;   87 - Outreach
 ;;   88 - Acupuncture
 ;;   89 - Methadone Maintenance
 ;;
 ;; - adds triggers to populate the new designated specialty provider
 ;;   package.
 ;;
 ;; - changed the code for unable to screen for IPV/DV to UAS
 ;; - the system now prevents users from selecting inactive
 ;;   locations as the location of encounter.
 ;;
 ;; Previous patches made the following modifications:
 ;;
