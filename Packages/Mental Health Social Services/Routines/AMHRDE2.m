...
DEMO ;
 ...
 I AMHDEMO=-1 G LIST
ZIS ;
 S XBRP="PRINT^AMHRDE2P",XBRC="PROC^AMHRDE2",XBRX="XIT^AMHRDE2",XBNS="AMHR"
 D ^XBDBQUE
 D XIT
 Q
XIT ;
...
BHSCR(V) ;EP - is there a screening?  return in R
 ...
 .I M="PHQ2"!(M="PHQ9") S R=$$BHRT^AMHRDE1(V,M,$P(^AMHRMSR(X,0),U,4),P,$$VALI^XBDIQ1(9002011.12,X,1204))
 I R]"" Q R
 ;get exam
