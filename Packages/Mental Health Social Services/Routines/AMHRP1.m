...
PRINTB ;
 ...
 W ?57,$P(^AMHPROB($P(^AMHRPRO(AMHP,0),U),0),U) W:$P(^AMHRPRO(AMHP,0),U,4) ?66,$E($P(^AUTNPOV($P(^AMHRPRO(AMHP,0),U,4),0),U),1,15) D
 .F  S AMHP=$O(^AMHRPRO("AD",AMHR,AMHP)) Q:AMHP'=+AMHP   W !?57,$P(^AMHPROB($P(^AMHRPRO(AMHP,0),U),0),U) W:$P(^AMHRPRO(AMHP,0),U,4) ?66,$E($P(^AUTNPOV($P(^AMHRPRO(AMHP,0),U,4),0),U),1,13)
 .Q
 Q
 ;
...
SEX .W ?86,$P(^DPT($P(AMHR0,U,8),0),U,2)
 ...
 W ?93,$P(^AMHPROB($P(^AMHRPRO(AMHP,0),U),0),U) W:$P(^AMHRPRO(AMHP,0),U,4) ?102,$E($P(^AUTNPOV($P(^AMHRPRO(AMHP,0),U,4),0),U),1,30) D
 .F  S AMHP=$O(^AMHRPRO("AD",AMHR,AMHP)) Q:AMHP'=+AMHP   W !?93,$P(^AMHPROB($P(^AMHRPRO(AMHP,0),U),0),U) W:$P(^AMHRPRO(AMHP,0),U,4) ?102,$E($P(^AUTNPOV($P(^AMHRPRO(AMHP,0),U,4),0),U),1,29)
 .Q
 Q
HEADER ;
 D HEADER^AMHRP11
