AFSLRTTX ;IHS/OIRM/OKCRDC/JDM - PROGRAM TO RE-EXPORT TREASURY TAPE #2;  [ 09/27/2005  5:29 PM ]
 ;;1.0V1;1166 APPROVALS FOR PAYMENT;**3,19**;MAY 06, 1994
 ;Re-export U.S. treasury tape - part 2
 ;ACR*2.1*19.05 IM16848 - RENAME LINE TAG ON FIRST LINE
...
ASK ;fy and payment type prompts
 ...
 ;S AFSLFY=$E(Y,2,3)
 S AFSLFY=$E(Y,1,3)+1700 ;Y2000;AEF;ACR*2.0T1*3
 ;End Y2K fix block
EDAT ;
 K DIR("?")
