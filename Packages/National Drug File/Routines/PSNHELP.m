PSNHELP ;BIR/CCH&WRT-Help text routine ;23-Apr-2007 11:05;SM
 ;;4.0; NATIONAL DRUG FILE;**60,84,93,1002**; 30 Oct 98
 ;IA 2352 - ^PSDRUG(
 ;IA 2613 - ^PS(59.7
 ;IA 3621 - DRG^PSSHUIDG(DA)
 ;IA 4394 - DRG^PSSDGUPD(DA)  V.2.4 dispensing machines
 ;IA 1976 - ^PS(59
 ; Modified - IHS/MSC/PLS - 04/23/07 - Line REMTCH+11
TRD1 ; TRADE NAME
...
REMTCH ; REMATCH PROMPT
 ...
 ; IHS/MSC/PLS - 04/23/07 - The following four lines commented out
 ; for PSN patch 1002.
