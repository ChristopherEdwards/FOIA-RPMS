OCXOZ03 ;SLC/RJS,CLA - Order Check Scan ;JUN 15,2011 at 12:58
...
CHK12 ; Look through the current environment for valid Event/Elements for this patient.
 ...
 I $$LIST(OCXDF(1),"NW,SN"),$L(OCXDF(34)) S OCXDF(148)=$P($$FOODDRG(OCXDF(34)),"^",1) I $L(OCXDF(148)),(OCXDF(148)),$L(OCXDF(37)) D CHK271^OCXOZ0B
