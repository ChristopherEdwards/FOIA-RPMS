OCXOZ0Y ;SLC/RJS,CLA - Order Check Scan ;JUN 15,2011 at 12:58
...
R63R1B ; Send Order Check, Notication messages and/or Execute code for  Rule #63 'GLUCOPHAGE - CONTRAST MEDIA'  Relation #1 'IF PROC USES NON-BARIUM MEDIA AND PATIENT TAKING G...'
 ...
 ;
 N OCXNMSG,OCXCMSG,OCXPORD,OCXFORD,OCXDATA,OCXNUM,OCXDUZ,OCXQUIT,OCXLOGS,OCXLOGD
 I ($G(OCXOSRC)="CPRS ORDER PRESCAN") S OCXCMSG=(+OCXPSD)_"^23^^Procedure uses non-barium contrast media and patient is taking glucophage." I 1
 E  S OCXCMSG="Procedure uses non-barium contrast media and patient is taking glucophage."
 S OCXNMSG=""
 ;
 Q:$G(OCXOERR)
 ;
...
MCE91() ; Verify Event/Element: PATIENT WITH GLUCOPHAGE MED
 ...
 S OCXRES(91)=0,OCXDF(103)=$P($$TAKEMED^ORKPS(OCXDF(37),"^GLUCOPHAGE^METFORMIN"),"^",1) I $L(OCXDF(103)) S OCXRES(91,103)=OCXDF(103) I (OCXDF(103))
 E  Q 0
