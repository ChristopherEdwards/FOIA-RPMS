OCXOZ10 ;SLC/RJS,CLA - Order Check Scan ;JUN 15,2011 at 12:58
...
R70R1A ; Verify all Event/Elements of  Rule #70 'NO ALLERGY ASSESSMENT'  Relation #1 'NO ALLERGY ASSESSMENT AND (RADIOLOGY ORDER OR PHAR...'
 ;  Called from EL28+5^OCXOZ0H, and EL135+5^OCXOZ0I, and EL136+5^OCXOZ0I, and EL137+5^OCXOZ0I.
 ;
 Q:$G(OCXOERR)
 ;
 ;      Local Extrinsic Functions
 ...
 ;
 I $$MCE136 D 
 .I $$MCE28 D R70R1B^OCXOZ11
 .I $$MCE137 D R70R1B^OCXOZ11
 .I $$MCE135 D R70R1B^OCXOZ11
 Q
 ;
