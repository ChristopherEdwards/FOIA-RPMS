OCXRU3 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*96) ;JAN 30,2001 at 11:16
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^OCXRU2(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^OCXRU2(+OCXDD,.DA,1)
 ;
 D DIE^OCXRU2(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
