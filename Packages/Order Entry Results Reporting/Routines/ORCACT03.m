ORCACT03 ;SLC/MKB-Validate order actions cont ;31-Jul-2012 17:59;PLS
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**243,1010**;Dec 17, 1997;Build 47
 ;
 ; Modified - IHS/MSC/JS - 07/31/2012 - Line MEDOK+15
...
MEDOK() ; -- Returns 1 or 0, if med OI usage=Y
 ...
 I Y,$G(OI) S Y=$$OI^APSPMULT(OI,+$G(DFN))  ;IHS/MSC/JS - 07/31/2012
 Q Y
 ;
