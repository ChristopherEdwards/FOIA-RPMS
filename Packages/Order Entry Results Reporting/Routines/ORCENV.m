...
LIST ; list of packages and patches to check
 ...
 ;;Consult/Request Tracking^GMRC^^^                     ;;IHS/PLS 05/18/2001    ;2.5*^14
 ;;CMOP^PSX^2.0*^3^^^^OPTIONAL
 ;;Dietetics^FH^5.0^
 ;;Vitals^GMRV^3.0^3-5
 ;;Health Level Seven^HL^1.6^8-9,17-18,21
 ;;Health Summary^GMTS^2.7^^          ;;IHS/PLS 05/18/2001  ;^3,7-9,12-13
 ;;Kernel^XU^8.0^49,59
 ;;Laboratory^LR^5.2^121^
 ;;OE/RR^OR^2.5*^49^                    ;;IHS/PLS 05/18/2001   ;46,49
 ;;Patient Care Encounter^PX^1.0^^          ;;IHS/PLS 05/18/2001  ;1-5,7-9,15
 ;;Outpatient Pharmacy^PSO^6*^^
 ;;Inpatient Pharmacy^PSJ^3.2^^                 ;;IHS/PLS 05/18/2001   ;4.5*^42
 ;;Radiology^RA^4.5^3-6,8-11
 ;;Registration^DG^5.0^^                 ;IHS/PLS 05/18/2001   ;5.3^57,73,77-80,82,84-85,87-90,92-101,103-105,107,109-112,121,124
 ;;Scheduling (including PCMM)^SD^5.0^^            ;IHS/PLS 05/18/2001   ;5.3^27,39,41,42,44-49,53-61,63-65,67-75,78,79,84-88,93
 ;;RPC Broker^XWB^1.1
 ;;Text Integration Utility^TIU^1.0^1,3,4,7
 ;;VA FileMan^DI^21.0^8,12,15,18-20,24-25,27,31,33,36
 ;;Visit Tracking^VSIT^2.0^^                      ;IHS/PLS 05/18/2001    ;1
 ;;QUIT
 ;
 ;
