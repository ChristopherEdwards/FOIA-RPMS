ORCSEND ;SLC/MKB-Release orders ;16-May-2012 15:02;DU
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**4,27,45,79,92,141,165,1006,195,228,243,303,296,1010**;Dec 17, 1997;Build 47
 ;
 ;Modified - IHS/MSC/PLS - 06/03/2010 - Line RQ
 ;MODIFIED - IHS/MSC/PLS - 08/09/10 - CANCEL+1,VA EP
...
CANCEL(IFN) ; -- Cancel any outstanding actions for order IFN
 ...
 N I S I=0
 F  S I=$O(^OR(100,IFN,8,I)) Q:I'>0  D
 .I $P(^(I,0),U,15)=11 D
 ..S $P(^(0),U,15)=13
 ..D:$P(^(0),U,4)=2 SIGN^ORCSAVE2(IFN,"","",5,I) ; cancelled, sig not reqd now
 .I $P(^OR(100,IFN,8,1,0),U,2)="VA" D
 ..N FDA
 ..S FDA(100.008,"1,"_IFN_",",2)=""
 ..D UPDATE^DIE("","FDA","","")
 Q
 ;
HD ; -- Hold order ORIFN
...
READY(IFN,ACT) ; -- Ready to release?
 ...
 ;IHS/MSC/PLS - 06/03/2010 - Next line commented out
...
VA ;EP - IHS/MSC/REC/PLS - 08/09/10
 D STATUS^ORCSAVE2($G(ORIFN),6)
 D NW  ;release order
 Q
