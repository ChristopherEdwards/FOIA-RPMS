ORCSEND1 ;SLC/MKB-Release cont ;15-Mar-2012 09:02;PLS
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**4,29,45,61,79,94,116,138,158,149,187,215,243,282,1010**;Dec 17, 1997;Build 47
 ;
...
LR1 N ORLASTC  S ORS1=0 F  S ORS1=$O(ORX(ORS1)) Q:ORS1'>0  D
 ...
 . F P=ORPITEM,ORPSAMP,ORPSPEC,ORPURG,ORPCOMM,ORPTYPE,ORIND,ORIND2 S ORDIALOG(P,1)=$G(ORX(ORS1,P)) ;set values to next instance
