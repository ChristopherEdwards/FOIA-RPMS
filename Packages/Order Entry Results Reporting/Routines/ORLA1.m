ORLA1 ; slc/dcm,cla - Order activity alerts ;11/7/95 10:00 [5/15/00 10:44am]
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**11,82**;Dec 17, 1997
BUILD ;
 D PARAM^ORU1
...
C0 ;
 ...
 S ORCNT=0,ORJ=ORCSTRT
 F  S ORJ=$O(^SC(+ORCLIN,"S",ORJ)) Q:ORJ<1!(ORJ>ORCEND)  S ORK=0,ORCLDT=ORJ F  S ORK=$O(^SC(+ORCLIN,"S",ORJ,1,ORK)) Q:ORK<1  S DFN=+^(ORK,0),ORX="" D C1
 K ORCLDT,ORI,ORJ,ORK,ORURMBD,ORUVP,ORVP,ORX,ORY
