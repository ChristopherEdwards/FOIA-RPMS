ORPRS04 ; slc/dcm - Print Order summaries (SHRIVELED) ;12-Apr-2011 13:39;DU
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**11,69,92,121,1008**;Dec 17, 1997;Build 47
 ; Modified - IHS/MSC/PLS - 04/12/11 - PRT+8
EN ;Print orders
...
PRT ;Print order line
 N ORDIA,NVA,ORDIAI,ORXPND,OACTION,ORIFN,ORASTS,ORSTS,ORTX,ORODT,ORSTOP,ORUSER,ORSTRT,ORMD,OREL,ORFLAG,ORNAT
 ...
 ;IHS/MSC/MGH Added change for requestor to null for NVA meds
 S ORDIA=$P(X,"^",5),ORDIAI=$P(ORDIA,";",1)
 S NVA=$O(^ORD(101.41,"B","PSH OERR",""))
 ...
 ;IHS/MSC/MGH added change for requestor to null for NVA meds
 I ORDIAI=NVA S ORREQ="N/A",ORREQ("TIT")=" ",ORREQ("TIT",0)=""
