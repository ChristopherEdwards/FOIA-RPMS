ORQ12 ; slc/dcm - Get patient orders in context ;21-Nov-2011 11:46;PLS
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**12,27,78,92,116,190,220,215,243,1010**;Dec 17, 1997;Build 47
 ;Modified - IHS/MSC/PLS - 06/22/2010 - Line TEXT+8
...
TEXT(ORTX,ORIFN,WIDTH) ; -- Returns text of order ORIFN in ORTX(#)
 ...
 S ORTX=1,ORTX(1)=""
 I $P($G(OR0),U,11)'="",($P(^ORD(100.98,$P(OR0,U,11),0),U)="NON-VA MEDICATIONS") S X="Outside Med" D ADD  ;IHS/MSC/PLS - 06/22/2010
 G:$G(ORIGVIEW)>1 T1
