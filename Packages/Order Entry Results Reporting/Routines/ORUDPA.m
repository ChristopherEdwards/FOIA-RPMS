ORUDPA ; slc/dcm,RWF - Object (patient) lookup ;10/7/91  15:21 ;
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**16**;Dec 17, 1997
ENT ;
...
GPD ;
 ...
 I $D(^GMRD(120.51)) S X="GMRVUTL" X ^%ZOSF("TEST") I $T D EN4^GMRVUTL S ORPD=+X\1
 S:ORPD'>0 ORPD="NF"
 K ORSEQ
 Q
HOMO ;
 ...
 S ORCNV=$$OTF^OR3CONV(+ORVP) Q:'ORCNV
 I ORCNV>0 W !,"DONE" H 1 Q
