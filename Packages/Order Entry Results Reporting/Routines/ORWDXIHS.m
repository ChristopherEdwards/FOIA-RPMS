ORWDXIHS ; IHS/CIA/DKM - Order dialog utilities for IHS ;03-Apr-2013 15:50;DU
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**1002,1008,1010,1011**;Dec 17, 1997;Build 41
 ;
...
ADDIND(SUB,ITM,ICD) ;
 N CODE
 I $$AICD^BGOUTL2 S CODE=$P($$ICDDX^ICDEX(ICD,$$NOW^XLFDT),U,2)
 E  S CODE=$$GET1^DIQ(80,ICD,.01)
 Q:CODE=".9999"
 I '$L(ITM) D
 .I $$AICD^BGOUTL2 S ITM=$P($$ICDDX^ICDEX(ICD,$$NOW^XLFDT),U,4)
