ORWGAPIR ; SLC/STAFF - Graph API Router ;08-Feb-2012 17:06;PLS
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**215,260,243,1010**;Dec 17, 1997;Build 47
 ;
 ;Modified - IHS/MSC/MGH - 02/08/2012 - Line DATA+16, ITEMS+6, STD+24
DATA(DATA,ITEM,FILE,START,DFN,CNT,TMP,BACKTO) ; from ORWGAPI
 ...
 I FILE=9000010.01 D MEAS^ORWGAPI4(.DATA,ITEM,START,DFN,.CNT,TMP,BACKTO) Q
...
ITEMS(ITEMS,DFN,TYPE,FMT,OLDEST,NEWEST,CNT,TMP) ; from ORWGAPI
 ...
 ;IHS/MSC/MGH Added lookup for V measurments
 I TYPE=9000010.01 D STD(.ITEMS,DFN,TYPE,FMT,OLDEST,NEWEST,.CNT,TMP) Q
...
STD(ITEMS,DFN,FILE,FMT,OLDEST,NEWEST,CNT,TMP) ;
 ...
 I FILE=9000010.01 D BMIITEMS^ORWGAPIX(.ITEMS,.CNT,TMP) Q
 Q
 ;
