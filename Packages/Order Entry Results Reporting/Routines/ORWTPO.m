ORWTPO ; SLC/STAFF Personal Preference - Order Checks ;5/1/01  12:27
...
CSARNGD(INFO) ; RPC
 ...
 S INFO=$$GET^XPAR("DIV^SYS^PKG","ORQQVS SEARCH RANGE START",1,"I")_U
 S INFO=INFO_$$GET^XPAR("DIV^SYS^PKG","ORQQAP SEARCH RANGE STOP",1,"I")
 Q
 ;
CSARNG(VAL,USER) ; from ORWTPP
 ; get user's appt date range defaults
 S VAL=$$GET^XPAR("USR.`"_USER_"^SRV.`"_+$G(ORSRV)_"^DIV^SYS^PKG","ORQQVS SEARCH RANGE START",1,"I")_U
 S VAL=VAL_$$GET^XPAR("USR.`"_USER_"^SRV.`"_+$G(ORSRV)_"^DIV^SYS^PKG","ORQQAP SEARCH RANGE STOP",1,"I")
 Q
 ;
SAVECS(OK,INFO,USER) ; from ORWTPP
 ...
 D EN^XPAR(USER_";VA(200,","ORQQVS SEARCH RANGE START",1,START)
 D EN^XPAR(USER_";VA(200,","ORQQAP SEARCH RANGE START",1,START)
 D EN^XPAR(USER_";VA(200,","ORQQVS SEARCH RANGE STOP",1,STOP)
 D EN^XPAR(USER_";VA(200,","ORQQAP SEARCH RANGE STOP",1,STOP)
