ORY0070 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1007) ;NOV 5,2010 at 13:55
...
WARN(RTN,MSG,LINES) ;
 ...
 W !!,"--------------",MSG,DASH
 ;
 W !,RTN,?10,"[DEMO.MEDSPHERE.COM] -> [",$$NETNAME^OCXSEND,"] Line"
 ;
