ORY00703 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1007) ;NOV 5,2010 at 13:55
...
DATA ;
 ...
 ;;KEY^863.3:^PATIENT.ALLERGIES UNASSESSIBLE
 ;;R^"863.3:",.01,"E"
 ;;D^PATIENT.ALLERGIES UNASSESSIBLE
 ;;R^"863.3:",.02,"E"
 ;;D^PATIENT
 ;;R^"863.3:",.05,"E"
 ...
 ;;KEY^860.8:^ALLERGIES UNASSESSIBLE
 ;;R^"860.8:",.01,"E"
 ;;D^ALLERGIES UNASSESSIBLE
 ;;R^"860.8:",.02,"E"
 ;;D^ALUNASS
 ;;R^"860.8:",1,1
 ;;D^This function checks to see if the patient was in inassessible assessment on 
 ;;R^"860.8:",1,2
 ;;D^file. If yes, a "0" (zero) is returned.  If the patient is assessable, a "1" is returned. 
 ;;R^"860.8:",1,3
 ;;D^ 
 ;;R^"860.8:",100,1
 ;;D^   ;ALUNASS(ORPT)   ; determine if pt was unable to be assessed
 ;;R^"860.8:",100,2
 ;;D^   ; ; rtn 0 if unable to assessment, 1 otherwise
 ;;R^"860.8:",100,3
 ;;D^   ; N ORALASS 
 ;;R^"860.8:",100,4
 ;;D^   ; S ORALASS=$$UNASS^GMRAOR1(ORPT)
 ;;R^"860.8:",100,5
 ;;D^   ; Q:ORALASS=0 0
 ;;R^"860.8:",100,6
 ;;D^   ; Q 1
