ORY0071 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1007) ;NOV 5,2010 at 13:55
...
MULT(CREF,OCXDD) ;
 ...
 ...S QUIT=$$LOADWORD^ORY0072(RREF,OCXDD,OCXFLD,OCXSUB)
 .;
...
DSPFLD(CREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 ;
 W:($D(@RREF@(OCXFLD,OCXSUB))) !,?(5+(($L(OCXDDPTH,",")+2)*4)),"(R) DEMO.MEDSPHERE.COM: ",@RREF@(OCXFLD,OCXSUB)
