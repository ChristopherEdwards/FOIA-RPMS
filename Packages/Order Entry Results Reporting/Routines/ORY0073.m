ORY0073 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1007) ;NOV 5,2010 at 13:55
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^ORY0072(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^ORY0072(+OCXDD,.DA,1)
 ;
 D DIE^ORY0072(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
