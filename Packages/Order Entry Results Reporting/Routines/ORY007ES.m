ORY007ES ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1007) ;NOV 5,2010 at 13:55
...
S ;
 ...
 W !," Created: NOV 5,2010 at 13:55  at  DEMO.MEDSPHERE.COM"
 W !," Current Date: ",$$NOW^ORY0070,"  at  ",$$NETNAME^OCXSEND,!!
...
RUN ;
 ...
 ..;
 ..I OPCODE="KEY" D DOT S LOCAL="",D0=$$GETFILE^ORY0070(+$P(TEXT,U,1),$P(TEXT,U,2),.LOCAL) S QUIT=(D0=(-10)) Q
 ..I OPCODE="R" S REF="REMOTE("_$P(TEXT,":",1)_":"_D0_$P(TEXT,":",2,99)_")" Q
 ..I OPCODE="D",$D(REF) S @REF=$P(TEXT,U,1,999) K REF Q
 ..;
 ..I OPCODE="EOR" S QUIT=$$COMPARE^ORY0071(.LOCAL,.REMOTE) K LOCAL,REMOTE Q
 ...
 ..;
 ..W !,"Unknown OpCode: ",OPCODE,"  in: ",TEXT S QUIT=$$PAUSE^ORY0070 W !
 ;
 K ^TMP("OCXRULE",$J)
 ;
 I $D(^OCXS) D
