ORY01103 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1011) ;APR 8,2013 at 18:46
...
DATA ;
 ...
 ;;D^ORD
 ;;EOR^
 ;;KEY^863.3:^PATIENT.SS.REFILL.REQUEST
 ;;R^"863.3:",.01,"E"
