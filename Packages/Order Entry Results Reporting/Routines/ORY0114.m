ORY0114 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*1011) ;APR 8,2013 at 18:46
...
EDITFLD(OCXCREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 .S OCXGREF=$$GETREF^ORY0112(+OCXDD,.OCXDA,OCXLVL-1) Q:'$L(OCXGREF)
 .D DIE^ORY0112(OCXDD,OCXGREF,OCXFLD,@OCXCREF@(OCXDD,OCXFLD,"E"),.OCXDA,OCXLVL-1)
 ;
 Q QUIT
 ;
DELFLD(OCXCREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 S OCXGREF=$$GETREF^ORY0112(+OCXDD,.OCXDA,OCXLVL-1) Q:'$L(OCXGREF)
 D DIE^ORY0112(OCXDD,OCXGREF,OCXFLD,"@",.OCXDA,OCXLVL-1)
 ;
 Q QUIT
 ;
CREATE(OCXCREF,OCXDD,OCXDA,OCXLVL) ;
 ...
 N OCXFLD,OCXGREF
 ;
 S OCXGREF=$$GETREF^ORY0112(+OCXDD,.OCXDA,OCXLVL) Q:'$L(OCXGREF)  S:'OCXDA OCXDA=$O(@(OCXGREF_"""@"")"),-1)+1
 ;
 I '$D(@(OCXGREF_"0)")) S @(OCXGREF_"0)")=U_$$FILEHDR^OCXSENDD(+OCXDD)_U_U
 ;
 S OCXFLD=0 F  S OCXFLD=$O(@OCXCREF@(OCXDD,OCXFLD)) Q:'OCXFLD  Q:(OCXFLD[":")  I '$$EXFLD^ORY0111(+OCXDD,OCXFLD) D
 .I $L($G(@OCXCREF@(OCXDD,OCXFLD,"E"))) D DIE^ORY0112(OCXDD,OCXGREF,OCXFLD,@OCXCREF@(OCXDD,OCXFLD,"E"),.OCXDA,OCXLVL)
 ;
 D PUSH(.OCXDA)
