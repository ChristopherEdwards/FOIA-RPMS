ORY1053 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*105) ;OCT 16,2001 at 15:39
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^ORY1052(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^ORY1052(+OCXDD,.DA,1)
 ;
 D DIE^ORY1052(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
