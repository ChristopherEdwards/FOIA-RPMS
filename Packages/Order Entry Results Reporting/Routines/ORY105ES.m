ORY105ES ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*105) ;OCT 16,2001 at 15:39
...
S ;
 ...
 W !," Created: OCT 16,2001 at 15:39  at  DEVCUR.ISC-SLC.VA.GOV"
 W !," Current Date: ",$$NOW^ORY1050,"  at  ",$$NETNAME^OCXSEND,!!
...
RUN ;
 ...
 ..;
 ..I OPCODE="KEY" D DOT S LOCAL="",D0=$$GETFILE^ORY1050(+$P(TEXT,U,1),$P(TEXT,U,2),.LOCAL) S QUIT=(D0=(-10)) Q
 ..I OPCODE="R" S REF="REMOTE("_$P(TEXT,":",1)_":"_D0_$P(TEXT,":",2,99)_")" Q
 ..I OPCODE="D",$D(REF) S @REF=$P(TEXT,U,1,999) K REF Q
 ..;
 ..I OPCODE="EOR" S QUIT=$$COMPARE^ORY1051(.LOCAL,.REMOTE) K LOCAL,REMOTE Q
 ...
 ..;
 ..W !,"Unknown OpCode: ",OPCODE,"  in: ",TEXT S QUIT=$$PAUSE^ORY1050 W !
 ;
 K ^TMP("OCXRULE",$J)
 ;
 I $D(^OCXS) D
