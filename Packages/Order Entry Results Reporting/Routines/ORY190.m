...
SETVAL ; Set package-level values for params
 ...
 D PUT^XPAR("PKG","ORWD NONVA REASON",1,"Outside medication not recommended by provider.")
 D PUT^XPAR("PKG","ORWD NONVA REASON",2,"Outside medication recommended by provider.")
 D PUT^XPAR("PKG","ORWD NONVA REASON",3,"Patient buys OTC/herbal product without medical advice.")
 D PUT^XPAR("PKG","ORWD NONVA REASON",4,"Medication prescribed by another provider.")
 ;
