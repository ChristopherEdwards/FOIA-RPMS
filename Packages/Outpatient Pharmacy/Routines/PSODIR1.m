PSODIR1 ;IHS/DSD/JCM - ASKS DATA FOR RX ORDER ENTRY CONT. ;13-May-2011 12:50;PLS
 ;;7.0;OUTPATIENT PHARMACY;**23,46,78,102,121,131,146,166,1005,1008,1011**;DEC 1997;Build 17
...
REFILL(PSODIR) ;
 ...
 ;IHS/MSC/PLS - 05/13/2011 - When PSOX resolves to null FileMan displays maximum refills as 999999999999
 ;S DIR(0)="N^"_$S($G(RFTT):RFTT,1:0)_":"_PSOX,DIR("A")="# OF REFILLS"
 S DIR(0)="N^"_$S($G(RFTT):RFTT,1:0)_":"_+PSOX,DIR("A")="# OF REFILLS"
