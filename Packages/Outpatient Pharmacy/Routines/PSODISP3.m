PSODISP3 ;ISC-BHAM/SAB rx speed release ; 08/30/95 10:24
 ;;7.0;OUTPATIENT PHARMACY;**15,13**;DEC 1997
...
SEL N VALMCNT I '$G(PSOCNT) S VALMSG="This patient has no Prescriptions!" S VALMBCK="" Q
 ...
 .D ASK Q:$G(QFLG)  S PSOLIST=0
 .F ORD=1:1:$L(LST,",") Q:$P(LST,",",ORD)']""  K ISUF,IFN S ORN=$P(LST,",",ORD),RXP=$P(PSOLST($P(LST,",",ORD)),"^",2),POERR=1 D:+PSOLST(ORN)=52 FULL^VALM1,BC1^PSODISP S PSOLIST=PSOLIST+1 I PSOLIST=5 D
 ..K DIR,DIRUT S DIR(0)="E",DIR("A",1)="",DIR("A")="Press Return to Continue"
 ..D ^DIR K DIR,DIRUT S PSOLIST=0
 ...
 ..K DIR,DIRUT S DIR(0)="E",DIR("A",1)="",DIR("A")="Press Return to Continue" D ^DIR K DIR,DIRUT
