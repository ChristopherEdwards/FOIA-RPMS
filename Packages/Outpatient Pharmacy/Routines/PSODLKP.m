...
DIE ;Enter here from PSODLKP,PSODEDT. Edit the DUE Answer sheet
 S DIE="^PS(50.0731,",DA=PSA,DR="[PSOD DUE EDIT]" L +^PS(50.0731,DA):0 I '$T W !,"Entry is being edited by another user. Try Later!" K DA,DR,DIE,PSA Q
...
ASK S PZPOP=0
 ...
 Q
 ;
NEW L +^PS(50.0731,0):3 E  W $C(7),!,"Trying to Lock ^PS(50.0731,0)" G NEW
