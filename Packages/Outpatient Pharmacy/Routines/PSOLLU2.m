PSOLLU2 ;BIR/JLC - BUILD CONTROL CODES ;20-Jun-2005 23:42;SM
 ;;7.0;OUTPATIENT PHARMACY;**120,138,141,135,1001,1003**;DEC 1997
 ;
 ;Read-only reference to %ZIS(2 supported by DBIA 3435
 ;Reference to %ZIS(2 supported by DBIA 3884
 ;
 ; Modified - IHS/CIA/PLS - 10/27/2004
 ;            IHS/CIA/PLS - 06/20/2005 - Line TYPE+27
 N IO,IOST
IO D ^%ZIS
...
TYPE W !,"HP or LexMark: " R TYPE:60 W "  " I TYPE="" Q
 ...
 ; IHS/CIA/PLS - 10/27/04 - Adjusted section length to allow barcode to print without printer wrap.
 ;S AB="PMII",NAME="PMI SECTION INITIALIZATION",CODE="S PSOX=0,PSOY=1350,PSOYI=50,PSOFONT=""F10"",PSOYM=3899" D FILE
 S AB="PMII",NAME="PMI SECTION INITIALIZATION",CODE="S PSOX=0,PSOY=1350,PSOYI=50,PSOFONT=""F10"",PSOYM=3819" D FILE
 ...
 ; IHS/CIA/PLS - 06/20/2005 - Adjust vertical position of the first warning label.
 ;S AB="WLI",NAME="WARNING LABEL INITIALIZATION",CODE="S PSOX=1050,PSOY=55" D FILE
 S AB="WLI",NAME="WARNING LABEL INITIALIZATION",CODE="S PSOX=1050,PSOY=45" D FILE
