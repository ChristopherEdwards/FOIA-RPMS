PSOMGCM1 ;BHAM ISC/JMB,SAB - management data compile/recompile ;21-Mar-2007 16:14;SM
 ;;7.0;OUTPATIENT PHARMACY;**20,28,175,1005**;DEC 1997
 ;Ref. to $$RXSUM^FBRXUTL supp. by IA# 4395
 ;Ref. to ^PSDRUG(, supp. by IA# 221
 ; Modified - IHS/MSC/PLS - 3/28/06 - Added Line FBA+4
...
FBA S (STN,DV)=0 S:'$G(DT) DT=$$DT^XLFDT
 ...
 S X="FBRXUTL" X ^%ZOSF("TEST") Q:'$T  ;IHS/MSC/PLS - 03/28/06 Call not used in IHS
