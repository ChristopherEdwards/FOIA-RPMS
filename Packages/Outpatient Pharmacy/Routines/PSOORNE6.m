...
ORCHK ;
 ...
 Q:$G(PSONEW("DFLG"))=1
 ; IHS/CIA/PLS - 05/17/04 - Fixed issue with QTY<1 and QTY>0
QTY ;I PSONEW("QTY")'=+PSONEW("QTY") W !,"Quantity must be ALL numeric!",! D 9^PSOORNEW Q:$G(PSONEW("DFLG"))=1  G QTY
 I PSONEW("QTY")'=+PSONEW("QTY"),PSONEW("QTY")'?1"0.".N W !,"Quantity must be ALL numeric!",! D 9^PSOORNEW Q:$G(PSONEW("DFLG"))=1  G QTY
