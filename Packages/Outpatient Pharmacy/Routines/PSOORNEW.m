PSOORNEW ;BIR/SAB-display orders from oerr ;31-Oct-2011 10:57;PLS
 ;;7.0;OUTPATIENT PHARMACY;**11,23,27,32,55,46,71,90,94,106,131,133,1005,1008,1013**;DEC 1997;Build 33
 ;^PS(50.7 -2223
 ;^PSDRUG -221
 ;^PS(50.606 -2174
 ;^PS(55 -2228
...
ACP S (PSODIR("DFLG"),PSORX("DFLG"),PSODIR("QFLD"))=0,ACP=1 D ORCHK
 ...
 S PSONEW("POE")=1 D EN^PSON52(.PSONEW) G:$G(PSONEW("DFLG")) ABORT
