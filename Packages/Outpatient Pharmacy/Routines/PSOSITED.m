PSOSITED ;BHAM ISC/SAB - ENTER/EDIT OUTPATIENT SITE PARAMETERS ; 09/18/92 9:11
 ;;7.0;OUTPATIENT PHARMACY;**24,65**;DEC 1997
...
1 W ! K DIC S DIC("A")="Select SITE NAME: ",(DIC,DIE)="^PS(59,",DIC(0)="QEALM",DLAYGO=59
 ...
 W !!,"Outpatient System Parameters",! S DA=1,DIE=59.7,DR="40;40.1;40.19;40.14;40.15" L +^PS(59.7,DA):0 I '$T W !,"Another person is editing this entry.  Try Later!",! K DA,DIE,DR G 1
 D ^DIE L -^PS(59.7,DA)
