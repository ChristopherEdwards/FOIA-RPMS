...
ASK R !!,"Select PHARMACIST: ",X:DTIME S:'$T X="^" G:"^"[X EX D PHASK:X["?" S DIC=200,DIC(0)="EQMZ" D ^DIC G PSOSUP:X="?"!(Y<0) S PHARM=$P(Y(0),"^"),PSN=+Y
 S DA=PSN,DIC(0)="EQMZ",(DIE,DIC)=200 D ^DIC I Y>0 S DA=+Y,DIE=DIC,DR="51///PSORPH",DR(51,200.051)=".01///PSORPH;1////"_$S($G(DUZ):DUZ,1:"")_";2///"_DT L +^VA(200,DA):0 D ^DIE L -^VA(200,DA)
