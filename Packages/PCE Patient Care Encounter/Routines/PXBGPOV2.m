PXBGPOV2 ;ISL/JVS - DOUBLE ?? GATHERING OF DIAGNOSES ;11/5/96  14:19
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**1,5,11**;Aug 12, 1996
 ;
...
FILTER ;--FILTER OUT DUPLICATES
 ...
 .S ^TMP("PXBOTAL",$J,$G(^TMP("PXBTOTAL",$J,"DILIST","ID",I,.01)),$E($G(^TMP("PXBTOTAL",$J,"DILIST","ID",I,10)),1,60),$G(^TMP("PXBTOTAL",$J,"DILIST",2,I)))=""
 K ^TMP("PXBTOTAL",$J)
...
SETUP ;-SETP VARIABLES
 S FILE=80,FIRST=.01,SECOND=10 D
