...
DRIVER ;EP entry point for taskman
 ...
 K ^XTMP("APCDCAFT",APCDJOB,APCDBT)
 D PROCESS^APCDCAFV
 S APCDET=$H
 Q
XIT ;
...
INFORM ;inform user what this report is all about
 ...
 W !!,"This report will produce a count of all visits with a chart audit "
 W !,"status of incomplete or blank.  The visits can be selected and sorted"
 W !,"by date, primary provider, chart audit status. "
