...
DEL2 ;;
 ...
 E  S APCDTABL($O(^ICD0("BA",APCD("HI"))))=APCDTABL(APCDVAL)_U_APCDSYS K APCDTABL(APCDVAL)
 S APCDDONE=1
 Q
 ;
DEL3 ;;
DEL6 ;;
 S APCDTABL($O(^ICD0("BA",APCD("HI"))))=APCDTABL(APCDVAL)_U_APCDSYS K APCDTABL(APCDVAL)
 S APCDDONE=1
 Q
 ;
DEL4 ;;
...
DEL9 ;;
 D @$S($E(APCDTABL(APCDVAL))?1N:"NUMBER",1:"LETTER")
 S APCDTABL($O(^ICD0("BA",APCD("HI"))))=APCDTABL(APCDVAL)_U_APCDSYS
 S APCDTABL(APCDVAL)=APCD("NEWHI")_U_APCDSYS
 S APCDDONE=1
 Q
 ;
