APCDONIT ; IHS/CMI/TUCSON - NO DESCRIPTION PROVIDED ;
 ;;2.0;IHS RPMS/PCC Data Entry;;MAR 09, 1999
 ;
 K DIF,DIK,DDF,DDT,DTO,D0,DLAYGO,DIC,DIR,DA,ORVROM,DFR,DTN,DIX,DZ
 S DIFQ=0,ORVROM=22 W !!,"This version of 'APCDONIT' was created on 09-MAR-1999"
 W !?9,"(at TUSCON ISD, by OE/RR V.2.5)",!
 G Q:DIFQ D ^APCDONI1 G Q:'$D(DIFQ) S DIK(0)="B"
 D ^APCDONI2,^APCDONI3
