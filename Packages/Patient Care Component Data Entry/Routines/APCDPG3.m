...
GATHER ;EP
 ...
 S APCDX=$$SETSTR^VALM1("DX:",APCDX,28,3),APCDX=$$SETSTR^VALM1($P($$ICDDX^ICDCODE($P(APCDP0,U)),U,2),APCDX,33,6),X="Status: "_$$VAL^XBDIQ1(9000093,APCDP,.12),APCDX=$$SETSTR^VALM1(X,APCDX,41,25)
