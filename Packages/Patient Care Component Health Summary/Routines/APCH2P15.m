...
POST ;EP
 ...
 S DA=$O(^DIC(19,"B","APCHPSUM",0)) I DA S DIK="^DIC(19," D ^DIK
 K DA,DIK
 S X=$$ADD^XPDMENU("APCHMENU","APCHSPMH","PWH")
 ...
 I '$O(^APCHSCMP("B","WELL CHILD EXAM",0)) D
 .D ^XBFMK S DIC="^APCHSCMP(",X="WELL CHILD EXAM",DIC("DR")="2////N",DIC(0)="L" K DD,DO,D0 D FILE^DICN
 .I Y=-1 W !!,"adding health summary component WELL CHILD EXAM failed." D ^XBFMK Q
 .S $P(^APCHSCMP(+Y,0),U,2)="WCE;APCHS6B"
