...
DISPHM ;
 ...
 S APCHGIEN=0 F  S APCHGIEN=$O(^APCHSURV(APCHHMR,11,APCHGIEN)) Q:APCHGIEN'=+APCHGIEN!(APCHQUIT)  S APCHSEX=$P(^APCHSURV(APCHHMR,11,APCHGIEN,0),U),APCHSEXR=$S(APCHSEX="F":"FEMALE",APCHSEX="M":"MALE",APCHSEX="B":"BOTH GENDERS",1:"") D
