APCHS6 ; IHS/CMI/LAB - PART 6 OF APCHS -- SUMMARY PRODUCTION COMPONENTS 18 Jun 2008 10:07 AM ; 
...
HOSDSP S APCHSN=^AUPNVPRC(APCHSDFN,0)
 ...
 S APCHSNRQ=$P(APCHSN,U,4)
 I APCHSNRQ D GETNARR^APCHSUTL
 ;I APCHSNRQ="" S APCHSNRQ=$P(^ICD0($P(APCHSN,U,1),0),U,4)  cmi/anch/maw orig line
 I APCHSNRQ="" S APCHSNRQ=$P($$ICDOP^ICDCODE($P(APCHSN,U,1),+^AUPNVSIT($P(APCHSN,U,3),0)\1),U,5)  ;cmi/anch/maw 8/28/2007 CSV
