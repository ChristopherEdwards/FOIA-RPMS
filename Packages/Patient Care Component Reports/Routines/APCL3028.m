APCL3028 ; IHS/CMI/LAB - environment check ;
...
POST ;
 ...
 S X=$$ADD^XPDMENU("APCL M MAN QUALITY ASSURANCE","APCLSILI ILI EXPORT LIST","ILXL")
 I 'X W !,"Attempt to add ILI EXPORT LIST option failed.." H 3
 S X=$$ADD^XPDMENU("APCL M MAN QUALITY ASSURANCE","APCLSILI LAB EXPORT LIST","LABL")
 I 'X W !,"Attempt to add LAB EXPORT LIST option failed.." H 3
 S DA=$O(^DIC(19,"B","APCL SURVEILLANCE AGG REPORT",0))
 I DA S DIE="^DIC(19,",DR="1///Aggregate ILI Surveillance Report" D ^DIE K DA,DR,DIE
 D ^APCLP28
