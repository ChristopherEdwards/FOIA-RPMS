...
DISPLAY ;EP - SHOW CODES IN RANGE SELECTED
 ...
 W !!,"ICD codes in this range =>",!! W $P(APCL("LOW")," ") S APCLDFN=$O(^ICD9("BA",APCL("LOW"),"")) W ?9,$P($$ICDDX^ICDCODE(APCLDFN),U,4)  ;cmi/anch/maw 9/10/2007 csv
 ...
 S APCL=APCL("LOW"),APCLCNT=IOSL-2 F  S APCL=$O(^ICD9("BA",APCL)) Q:APCL]APCL("HI")  S APCLDFN=$O(^(APCL,"")) W !,$P(APCL," "),?9,$P($$ICDDX^ICDCODE(APCLDFN),U,4) S APCLCNT=APCLCNT-1 I APCLCNT=0 S APCLCNT=IOSL-2 D  I APCLR=U Q  ;cmi/maw csv
