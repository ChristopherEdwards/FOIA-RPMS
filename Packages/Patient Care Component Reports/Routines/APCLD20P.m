APCLD20P ; IHS/CMI/LAB - 2000 DIABETES AUDIT PRINT ; 13 Oct 2009  7:36 AM
 ...
 S APCLPD=0 F  S APCLPD=$O(^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD)) Q:APCLPD'=+APCLPD!(APCLQUIT)  D
 .W:$D(IOF) @IOF
 .W !,$$CTR("ASSESSMENT OF DIABETES CARE, 2000",80)
...
CUML ;
 I APCLPREP=4!(APCLPREP=3) D CUML^APCLD204
DONE ;
 K ^TMP($J)
 K ^XTMP("APCLDM20",APCLJOB,APCLBTH),APCLJOB,APCLBTH
 Q
I(I) ;
 Q ^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD,I)
 ;
PAGE ;
