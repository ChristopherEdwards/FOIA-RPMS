APCLD31P ; IHS/CMI/LAB - 2003 DIABETES AUDIT PRINT ;
 ...
 S APCLPD=0 F  S APCLPD=$O(^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD)) Q:APCLPD'=+APCLPD!(APCLQUIT)  D
 .W:$D(IOF) @IOF
 .W !,$$CTR("ASSESSMENT OF DIABETES CARE, 2003         DATE AUDIT RUN: "_$$FMTE^XLFDT(APCLRED),80)
...
CUML ;
 I APCLPREP=4!(APCLPREP=3) D CUML^APCLD314
DONE ;
 K ^TMP($J)
 K ^XTMP("APCLDM31",APCLJOB,APCLBTH),APCLJOB,APCLBTH
 Q
I(I) ;
 Q ^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD,I)
 ;
PAGE ;
