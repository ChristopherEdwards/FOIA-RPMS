APCLDE4P ; IHS/CMI/LAB - list refusals ; 
...
PRINT1 ;
 ...
 I '$D(^XTMP("APCLDE4",APCLJ,APCLH)) D HEADER W !!,"No data to report.",! G DONE
 D HEADER
 S APCLPTOT=$$PTOT
...
RES ;
 ...
 K APCLRES S X=0 F  S X=$O(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X)) Q:X'=+X  D
 .S APCLY=^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X)  ;S D=$O(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X,""),-1) S APCLY=^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X,D)
...
DATE ;
 ...
 K ^TMP($J) S X=0 F  S X=$O(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X)) Q:X'=+X  D
 .S APCLY=^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X)  ;S D=$O(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X,""),-1) S APCLY=^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X,D)
...
TOT() ;
 NEW C,X
 S C=0
 S X=0 F  S X=$O(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",X)) Q:X'=+X  S C=C+1
 Q C
PTOT() ;
 NEW C,X
 S C=0
...
LIST ;EP - called from xbdbque
 ...
 K ^TMP($J)
 ;resort by sort item
 S DFN=0 F  S DFN=$O(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",DFN)) Q:DFN'=+DFN  S APCLY=^XTMP("APCLDE4",APCLJ,APCLH,"PTS",DFN) D
 .D @APCLSORT
 ...
 .Q:$D(^XTMP("APCLDE4",APCLJ,APCLH,"PTS",DFN))
 .Q:$$END
