...
DP ;
 ...
 S APCLDP=Y
ZIS ;
 S XBRP="PRINT^APCLDV4P",XBRC="PROC^APCLDV4",XBRX="XIT^APCLDV4",XBNS="APCL"
 D ^XBDBQUE
 D XIT
 Q
XIT ;
...
PROC ;
 ...
 D XTMP^APCLOSUT("APCLDV4","IPV SCREENING REPORT")
 ...
 .S ^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE)="EX"_U_$$PPV(APCLVIEN)_U_APCLRES_U_$$VAL^XBDIQ1(9000010.13,APCLEIEN,81101)_U_$$AGE^AUPNPAT(DFN,APCLDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_APCLDATE_U_APCLEIEN
 .S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,9)=$$VAL^XBDIQ1(9000010,APCLVIEN,.08)
 .S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,15)=APCLVIEN
 .S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,16)=$$SPRV(APCLEIEN)
 .S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 ...
 .S ^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE)="REF"_U_"UNKNOWN"_U_APCLRES_U_$$VAL^XBDIQ1(9000022,APCLRIEN,1101)_U_$$AGE^AUPNPAT(DFN,APCLDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_APCLDATE_U_APCLRIEN_U
 .S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,16)=$$PRVREF(APCLRIEN)
 .S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 ;now go through BH
 ...
 ..S ^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE)="BH"_U_$$BHPPNAME(APCLBIEN)_U_APCLRES_U_$$VAL^XBDIQ1(9002011,APCLBIEN,1501)_U_$$AGE^AUPNPAT(DFN,APCLDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_APCLDATE_U_APCLBIEN
 ..S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,9)=$$VAL^XBDIQ1(9002011,APCLBIEN,.25)
 ..S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,15)=APCLBIEN
 ..S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,16)=$$VAL^XBDIQ1(9002011,APCLBIEN,1402)
 ..S $P(^XTMP("APCLDV4",APCLJ,APCLH,"PTS",DFN,APCLDATE),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 Q
 ;
