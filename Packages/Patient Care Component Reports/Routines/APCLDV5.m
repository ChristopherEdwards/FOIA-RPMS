APCLDV5 ; IHS/CMI/LAB - list refusals ;
...
LIST1 ;
 ...
 S APCLSORT=Y
ZIS ;
 S XBRP="PRINT^APCLDV5P",XBRC="PROC^APCLDV5",XBRX="XIT^APCLDV5",XBNS="APCL"
 D ^XBDBQUE
 D XIT
 Q
XIT ;
...
PROC ;
 ...
 D XTMP^APCLOSUT("APCLDV5","IPV SCREENING REPORT")
 ...
 .S ^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT)="EX"_U_$$PPV(APCLVIEN)_U_APCLRES_U_$$VAL^XBDIQ1(9000010.13,APCLEIEN,81101)_U_$$AGE^AUPNPAT(DFN,APCLDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_APCLDATE_U_APCLEIEN_U_DFN
 .S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,10)=$$VAL^XBDIQ1(9000010,APCLVIEN,.08)
 .S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,15)=APCLVIEN
 .S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,16)=$$SPRV(APCLEIEN)
 .S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 .S ^XTMP("APCLDV5",APCLJ,APCLH,"PTS",DFN,APCLDATE)=APCLCNT
 ...
 .S APCLCNT=APCLCNT+1
 .S ^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT)="REF"_U_"UNKNOWN"_U_APCLRES_U_$$VAL^XBDIQ1(9000022,APCLRIEN,1101)_U_$$AGE^AUPNPAT(DFN,APCLDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_APCLDATE_U_APCLRIEN_U_DFN_U
 .S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,16)=$$PRVREF(APCLRIEN)
 .S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 .S ^XTMP("APCLDV5",APCLJ,APCLH,"PTS",DFN,APCLDATE)=APCLCNT
 ;now go through BH
 ...
 ..I APCLCOMT="O",$$COMMRES^AUPNPAT(DFN,"I")'=APCLCOMT("ONE") Q  ;not in community
 ..I APCLCOMT="S" S X=$$COMMRES^AUPNPAT(DFN,"E") I '$D(APCLTAX(X)) Q  ;not in comm taxonomy
 ..I $D(^XTMP("APCLDV5",APCLJ,APCLH,"PTS",DFN,APCLDATE)) Q
 ..S APCLCNT=APCLCNT+1
 ...
 ..S ^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT)="BH"_U_$$BHPPNAME(APCLBIEN)_U_APCLRES_U_$$VAL^XBDIQ1(9002011,APCLBIEN,1501)_U_$$AGE^AUPNPAT(DFN,APCLDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_APCLDATE_U_APCLBIEN_U_DFN
 ..S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,10)=$$VAL^XBDIQ1(9002011,APCLBIEN,.25)
 ..S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,15)=APCLBIEN
 ..S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,16)=$$VAL^XBDIQ1(9002011,APCLBIEN,1402)
 ..S $P(^XTMP("APCLDV5",APCLJ,APCLH,"VSTS",APCLCNT),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
