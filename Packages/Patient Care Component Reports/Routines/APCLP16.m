APCLP16 ; IHS/BJI/GRL - Routine to create bulletin  [ 01/16/05  2:03 PM ]
 ;;3.0;IHS PCC REPORTS;**16,17**;FEB 15, 1997
 ;;
...
LAB1 ;
 ...
 I APCLDA S $P(^ATXLAB(APCLDA,0),U,4)="n",$P(^ATXLAB(APCLDA,0),U,22)=0  Q  ;taxonomy already exisits, set nodelete and ready only
...
TAX ;
 ...
 ;;DM AUDIT DEPRESSIVE DISORDERS|0|APCL*BDM
