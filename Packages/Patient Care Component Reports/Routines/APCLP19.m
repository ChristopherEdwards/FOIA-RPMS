APCLP19 ; IHS/BJI/GRL - Routine to create bulletin  [ 01/16/05  2:03 PM ]
...
OPT ;add new options
 NEW X
 S X=$$ADD^XPDMENU("APCL M MAN APC REPORTS/PCC","APCL P APC PCC 1A - MULT FACS","A1M")
 I 'X W "Attempt to add 1A MULT FACILITIES report option failed.." H 3
 ...
 S X=$$ADD^XPDMENU("APCL M MAN PATIENT LISTINGS","APCL M INFANT FEEDING","IF")
 I 'X W "Attempt to add INFANT FEEDING REPORTS menu option failed.." H 3
 S APCLX="APCL P BILL THIRD PARTY",APCLY="TPR"
 S X=$$ADD^XPDMENU("APCL M MAN BILLING REPORTS",APCLX,APCLY)
 S X=$$ADD^XPDMENU("APCLMENU","APCLLT CUSTOM LETTER MGT","CLM")
 ;S X=$$ADD^XPDMENU("APCL M MAIN DM MENU","APCL DM2006 AUDIT MENU","DM06",1)
 ;I 'X W "Attempt to add 2006 DM AUDIT menu option failed.." H 3
 S X=$$DELETE^XPDMENU("APCLMENU","APCL P DATA FETCHER")
 S X=$$DELETE^XPDMENU("APCLMENU","APCL M REPORT TEMPLATE")
 S X=$$DELETE^XPDMENU("APCLMENU","APCL P QA DELETE REP DEF")
 S X=$$ADD^XPDMENU("APCLMENU","APCL M OTHER REPORTS","OTH")
 S X=$$ADD^XPDMENU("APCL M MAN PATIENT LISTINGS","APCL P PRESCRIPTION COST","PCR")
 S X=$$ADD^XPDMENU("APCL M MAIN DM MENU","APCL DM2007 AUDIT MENU","DM07",1)
 S X=$$ADD^XPDMENU("APCL M MAN PATIENT LISTINGS","APCL M SCREENING REPORTS","SCR")
 S X=$$DELETE^XPDMENU("APCL M MAN PATIENT LISTINGS","APCL M DV REPORTS")
 ;
