...
SUM1 ;
 ...
 I APCMPTYP="D" D
 .D W^APCM11EH("Indian Health Service RPMS Suite (BCER) v1.0",0,2,APCMPTYP)
 .S X="STAGE 1 "_$S(APCMRPTT=1:"EP ",1:"HOSPITAL ")_"MEANINGFUL USE PERFORMANCE REPORT SUMMARY" D W^APCM11EH(X,0,1,APCMPTYP)
 ...
 .I APCMRPTT=1 S X=$S(APCMCM="M":"MENU SET MEASURES (EPs must meet 5 out of 10 including at least one public health",1:"CORE SET MEASURES (EPs must meet all 15)") D W^APCM11EH(X,0,2,APCMPTYP)
 .I APCMRPTT=1 S X=$S(APCMCM="M":"measure (*))",1:"") D W^APCM11EH(X,0,1,APCMPTYP)
 .I APCMRPTT=2 S X=$S(APCMCM="M":"MENU SET MEASURES (EHs/CAHs must meet 5 out of 10 including at least one public health",1:"CORE SET MEASURES (EHs/CAHs must meet all 14)") D W^APCM11EH(X,0,2,APCMPTYP)
 ...
 ..I APCMRPTT=1 S X=$S(APCMCM="M":"MENU SET MEASURES (EPs must meet 5 out of 10 including at least one public",1:"CORE SET MEASURES (EPs must meet all 15)") D W^APCM11EH(X,0,2,APCMPTYP)
 ..I APCMRPTT=1 S X=$S(APCMCM="M":"health measure (*))",1:"") D W^APCM11EH(X,0,1,APCMPTYP)
 ..I APCMRPTT=2 S X=$S(APCMCM="M":"MENU SET MEASURES (EHs/CAHs must meet 5 out of 10 including at least one public",1:"CORE SET MEASURES (EHs/CAHs must meet all 14)") D W^APCM11EH(X,0,2,APCMPTYP)
...
SUMH1 ;
 ...
 I APCMRPTT=1 S X=$S(APCMCM="M":"MENU SET MEASURES (EPs must meet 5 out of 10 including at least one public",1:"CORE SET MEASURES (EPs must meet all 15)") D W^APCM11EH(X,0,1,APCMPTYP)
 I APCMRPTT=1 S X=$S(APCMCM="M":"health measure (*))",1:"") D W^APCM11EH(X,0,1,APCMPTYP)
 I APCMRPTT=2 S X=$S(APCMCM="M":"MENU SET MEASURES (EHs/CAHs must meet 5 out of 10 including at least one public",1:"CORE SET MEASURES (EHs/CAHs must meet all 14)") D W^APCM11EH(X,0,1,APCMPTYP)
 I APCMRPTT=2 S X=$S(APCMCM="M":"health measure (*))",1:"") D W^APCM11EH(X,0,1,APCMPTYP)
 Q
