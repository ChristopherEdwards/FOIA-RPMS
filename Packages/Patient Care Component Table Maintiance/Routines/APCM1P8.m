APCM1P8 ;IHS/CMI/LAB - MU V1.0 PATCH 1 ENV; ; 03 Feb 2015  10:13 AM
 ...
 I '$$INSTALLD("APCM*1.0*7") D SORRY(2)
 ;
 Q
 ;
PRE ;
 ...
 S DA=0 F  S DA=$O(^APCM25OB(DA)) Q:DA'=+DA  S DIK="^APCM15OB(" D ^DIK
 S DA=0 F  S DA=$O(^APCMM25L(DA)) Q:DA'=+DA  S DIK="^APCMM25L(" D ^DIK
 Q
POST ;
 Q
