APCM24EB ;IHS/CMI/LAB - IHS MU;  ; 30 Jul 2013  8:15 AM
...
EPRES ;EP - CALCULATE EPRESCRIBING
 ...
 .I $D(APCM100R(APCMP,APCMTIME)) S F=$P(^APCM24OB(APCMIC,0),U,11) D  G D
 ..D S^APCM24E1(APCMRPT,APCMIC,"Provider is excluded from this measure as he/she had < 100 prescriptions issued during the EHR reporting period.",APCMP,APCMRPTT,APCMTIME,F,1)
 .I $G(APCMADDQ("ANS",APCMIC,24,APCMP))="No",$G(APCMADDQ("ANS",APCMIC,25,APCMP))="No" S F=$P(^APCM24OB(APCMIC,0),U,11) D
 ..D S^APCM24E1(APCMRPT,APCMIC,"Provider may be eligible for an exclusion on this measure as they not have an onsite pharmacy and do not have a pharmacy within 10 miles accepting electronic prescriptions.",APCMP,APCMRPTT,APCMTIME,F,1)
