APCM25E1 ; IHS/CMI/LAB - IHS MU 24 Feb 2015 10:32 AM ; 28 Jul 2016  11:39 AM
...
PROC ;EP
 ...
 .I '$P(APCMX,U,3) S APCM25ON(X,1)=""  ;smk status excl
 .I '$P(APCMX,U,1) S APCMOFFV(X,1)=""  ;
...
N1 ;
 ...
 .I 'APCMX S APCM25BR(X)=""  ;EXCL FROM PAT REMINDERS
 ;
PROC1 ;
