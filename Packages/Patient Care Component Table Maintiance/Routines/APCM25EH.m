...
HDR1 ;
 ...
 I APCMHPG'=1 D W^APCM25EH(" ",0,2,APCMPTYP) Q
 I APCMRPTT=2 D W^APCM25EH(" ",0,2,APCMPTYP) Q
 ...
 F  S X=$O(K(X)) Q:X=""  D
 .I Y="" S $E(Y,3)=$$SN(X) Q
 .I Y]"" S $E(Y,40)=$$SN(X) D W^APCM25EH(Y,0,1,APCMPTYP) S Y=""
 I Y]"" D W^APCM25EH(Y,0,1,APCMPTYP)
 ;D ENDTIME
 Q
SN(N) ;EP
 Q $P(N,",",1)_", "_$P(N,",",2)
