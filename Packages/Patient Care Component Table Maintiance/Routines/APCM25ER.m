...
WSUM ;write out line
 ...
 ..D W^APCM25EH("     2015",0,1,APCMPTYP),W^APCM25EH($P($G(^APCM25OB(APCMIC,12)),U,1),0,0,APCMPTYP,,35) D NUMRATE
 ..I $P(^APCM25OB(APCMIC,0),U,1)'="S2.026.EP" D
 ...D W^APCM25EH("     2016",0,1,APCMPTYP),W^APCM25EH($P($G(^APCM25OB(APCMIC,12)),U,2),0,0,APCMPTYP,,35) D NUMRATE
 ...D W^APCM25EH("     2017",0,1,APCMPTYP),W^APCM25EH($P($G(^APCM25OB(APCMIC,12)),U,3),0,0,APCMPTYP,,35) D RATE
 .;TARGET
...
D I APCMPTYP="D" D
 ...
 .I $P($G(^APCM25OB(APCMIC,12)),U,4) D  Q
 ..D W^APCM25EH(APCMX,0,2,APCMPTYP,1)
 ..S APCMX="" S $P(APCMX,U,1)="     2015"_U_$P($G(^APCM25OB(APCMIC,12)),U,1) S R=1 D NUMRATED
 ..I $P(^APCM25OB(APCMIC,0),U,1)'="S2.026.EP" D
 ...S APCMX="" S $P(APCMX,U,1)="     2016"_U_$P($G(^APCM25OB(APCMIC,12)),U,2) S R=1 D NUMRATED
 ...S APCMX="" S $P(APCMX,U,1)="     2017"_U_$P($G(^APCM25OB(APCMIC,12)),U,3) S R=1 D RATED
 ..I $P(^APCM25OB(APCMIC,0),U,1)="S2.026.EP" D
