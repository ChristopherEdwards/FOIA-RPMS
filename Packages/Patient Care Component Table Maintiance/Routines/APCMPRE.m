APCMPRE ;IHS/CMI/LAB - MU V1.0 PATCH 1 ENV; ; 03 Feb 2015  10:13 AM
 ...
 I '$$INSTALLD("APCM*1.0*5") D SORRY(2)
 ;
 Q
 ;
PRE ;
 ...
 S DA=0 F  S DA=$O(^APCM14OB(DA)) Q:DA'=+DA  S DIK="^APCM14OB(" D ^DIK
 S DA=0 F  S DA=$O(^APCM24OB(DA)) Q:DA'=+DA  S DIK="^APCM24OB(" D ^DIK
 S DA=0 F  S DA=$O(^APCMM14L(DA)) Q:DA'=+DA  S DIK="^APCMM14L(" D ^DIK
 S DA=0 F  S DA=$O(^APCMM24L(DA)) Q:DA'=+DA  S DIK="^APCMM24L(" D ^DIK
 Q
POST ;
 Q
