BPCBHRP1 ; IHS/OIT/MJL - behavioral health display for GUI ;
 ;;1.5;BPC;;MAY 26, 2005
 ;
 ;
 ;
TEST ;
 D TPREV(.RETVAL,"01/01/1900","12/31/2003","A","")
 Q
TPREV(BGUARRAY,BPCBD,BPCED,BPCOA,BPCTHER) ;EP - BPCBH RPT TP NEED REVIEWED
TPREV1 S JOB=$J,BPCGUI=1,XWBWRAP=1
 S ZTIO="",ZTQUEUED=1
 ...
 D ^XBKSET
 D PROC^AMHLETR1
 S ZTRTN="TSK^BPCBHRP1",ZTIO="",ZTDESC="BPC TP REV REPORT",ZTSAVE("AMH*")="",ZTSAVE("JOB")="",ZTDTH=$H D ^%ZTLOAD
...
TSK ;
 ...
 D GUIR^XBLM("PRINT^AMHLETR1","^XTMP(""BPCRPT"",JOB)")
