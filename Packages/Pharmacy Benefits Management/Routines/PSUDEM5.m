...
PDMAIL ;EN  Mail patient demographics message
 ...
 S XMDUZ=DUZ
 S XMSUB="V. 3.0P1 PBMPD"_" "_PSUMON_" "_PSUM_"/"_PSUMC_" "_PSUST_" "_PSUSTNM
 S XMCHAN=1
...
PROV ;EN  Mail Provider message
 ...
 S XMCHAN=1
 S XMDUZ=DUZ
 S XMSUB="V. 3.0P1 PBMPRO"_" "_PSUMON_" "_PSUM_"/"_PSUMC_" "_PSUST_" "_PSUSTNM
 S XMTEXT="^XTMP(""PSU_""_PSUJOB,""PSUXMD"",PSUM,"
 I PSUMASF!PSUDUZ!PSUPBMG D
 .I 'PSUSMRY M XMY=PSUXMYH D   ;Detailed message to Hines and self
 .D ^XMD
...
OPV ;EN  Outpatient encounter message
 ...
 ;
 S XMDUZ=DUZ
 S XMSUB="V. 3.0P1 PBMOV"_" "_PSUMON_" "_PSUM_"/"_PSUMC_" "_PSUST_" "_PSUSTNM
 S XMCHAN=1
 S XMTEXT="^XTMP(""PSU_""_PSUJOB,""PSUXMD"",PSUM,"
 I PSUMASF!PSUDUZ!PSUPBMG D
 .I 'PSUSMRY M XMY=PSUXMYH D   ;Detailed message to Hines and self
...
PTF ;EN  INPATIENT RECORD MESSAGE
 ...
 ;
 S XMDUZ=DUZ
 S XMSUB="V. 3.0P1 PBMPTF"_" "_PSUMON_" "_PSUM_"/"_PSUMC_" "_PSUST_" "_PSUSTNM
 S XMCHAN=1
 S XMTEXT="^XTMP(""PSU_""_PSUJOB,""PSUXMD"",PSUM,"
 I PSUMASF!PSUDUZ!PSUPBMG D
 .I 'PSUSMRY M XMY=PSUXMYH D   ;Detailed message to Hines and self
...
PRSUM ;EN  Provider summary message
 ...
 S XMDUZ=DUZ
 S XMCHAN=1
 S XMSUB="V. 3.0P1 PBMPRO"_" "_PSUMON_" "_PSUST_" "_PSUSTNM
...
PDSUM ;EN  Pt. demographics summary message
 ...
 S XMDUZ=DUZ
 S XMCHAN=1
 S XMSUB="V. 3.0P1 PBMPD"_" "_PSUMON_" "_PSUST_" "_PSUSTNM
