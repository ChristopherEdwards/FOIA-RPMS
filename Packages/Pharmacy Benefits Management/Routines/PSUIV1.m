PSUIV1 ;BIR/CFL - Extract Data of PBM IV Module ;25 AUG 1998
 ;;3.0;PHARMACY BENEFITS MANAGEMENT;**1,3,14,16,19**;Oct 15, 1998
 ;DBIAs
...
IVDATA ;Loop through IV data
 ...
 K PSUSSNA,PSUORDA
 ;
 F  S PSUIVDT=$O(^PS(55,"AIVS",PSUIVDT)) Q:'PSUIVDT!(PSUIVDT\1>PSUEDT)  D
 .S PSUPDA=""
 .F  S PSUPDA=$O(^PS(55,"AIVS",PSUIVDT,PSUPDA)) Q:'PSUPDA  D
 ..S ^XTMP("PSU_"_PSUJOB,"PSUPIEN",PSUPDA)=""     ;Patient IEN's
 ..S PSUODA=""
 ..F  S PSUODA=$O(^PS(55,"AIVS",PSUIVDT,PSUPDA,PSUODA)) Q:'PSUODA  D
 ...S ^XTMP("PSU_"_PSUJOB,"PSUHLD",PSUODA)=""   ;should be the D0's for file 55
 ...S COUNT=0
 ...S PSUDIV=""
 ...K PSUIV
 ...
 ...I PSUIV(.03)'=""&(PSUIV(.03)<PSUSDT) Q  ;Quit if the IV stop date does not fall within the date range
...
ICN ;Find patient ICN 
 ...
 ...I PSUPICN1'[-1 S PSUICN=$TR(PSUPICN1,"V","^") D
 ....S ^XTMP("PSU_"_PSUJOB,"PSUPICN")=$P(PSUICN,U,1)
 ...I PSUPICN1[-1 S ^XTMP("PSU_"_PSUJOB,"PSUPICN")=""
 Q
 ;
 ;
OCCAMT ;Calculate the number of dispensing occurrences
 S (PSUFND,PSUDISP,PSUPULL,OCC)=0
 ...
 .I PSUOCC(1)<PSUSDT!(PSUOCC(1)>PSUEDT) Q
 .S PSUFND=1
