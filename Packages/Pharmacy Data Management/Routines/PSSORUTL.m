PSSORUTL ;BIR/RSB/RTR-CPRS Dosage call ;12-Aug-2010 09:12;SM
 ;;1.0;PHARMACY DATA MANAGEMENT;**34,38,49,53,69,1009**;9/30/97
...
DOSE(PSSX,PD,TYPE,PSSDFN) ;
 ...
 .Q:'$$SCREEN^APSPMULT(DLOOP,,1)  ;IHS/MSC/JDS/PLS - 08/12/10
