PSSQOC ;BIR/MLM-CONVERT PSJ 4.5 QUICK ORDERS FOR USE IN OE/RR 3.0 [ 07/16/97  2:24 PM ]; 09/09/97 8:14
...
1 ; Convert IV Fluid Quick Order
 ...
 .S UNITS=$P("ML^LITER^MCG^MG^GM^UNITS^IU^MEQ^MM^MU^THOUU",U,+$P(Y,U,3))
 .I OI]"" S CNT=CNT+1
