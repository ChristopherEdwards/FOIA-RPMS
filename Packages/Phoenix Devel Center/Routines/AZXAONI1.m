AZXAONI1 ; IHS/PHXAO/TMJ - NO DESCRIPTION PROVIDED ;
 ;;2.0;RELEASE OF INFORMATION;;FEB 21, 2002
 ; LOADS
 ;
 I $S('$D(DUZ)#2:1,'$D(DUZ(0))#2:1,1:0) W !,"DUZ and DUZ(0) must be defined to continue." K DIFQ Q
 K DIF,DIK,D,DDF,DDT,DTO,D0,DLAYGO,DIC,DIR,DA,DFR,DTN,DIX,DZ D DT^AZXAONI2 S %=1,U="^",DSEC=1
 ...
 D DT^AZXAONI2 K ^UTILITY(U,$J),^UTILITY("DIK",$J) W !,"...OK, this may take a while, hold on please..." F R=1001:1:1001 D @("^AZXAO"_$E(R,2,4)) W "."
