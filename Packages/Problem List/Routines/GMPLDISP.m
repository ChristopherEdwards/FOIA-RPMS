GMPLDISP ; SLC/MKB -- Problem List detailed display ; 04/15/2002
 ;;2.0;Problem List;**21,26**;Aug 25, 1994
 ;
 ; External References
 ;   DBIA  3106  ^DIC(49
...
PROB ; Display problem GMPIFN
 ...
 F I=11,12,13,15,16 S:+$P(GMPL1,U,I) SP=SP_$S(I=11:"AGENT ORANGE",I=12:"RADIATION",I=13:"ENV CONTAMINANTS",I=15:"HEAD/NECK CANCER",1:"MIL SEXUAL TRAUMA")_U
