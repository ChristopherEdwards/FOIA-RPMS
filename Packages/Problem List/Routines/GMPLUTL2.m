GMPLUTL2 ; SLC/MKB/KER -- PL Utilities (OE/TIU)             ;05-May-2011 18:10;PLS
 ;;2.0;Problem List;**10,18,21,26,1001**;Aug 25, 1994
 ;
 ; External References
 ;   DBIA   348  ^DPT(  file #2
 ...
 ;
 ; Modified - IHS/MSC/MGH  - 05/05/2011 - Line LIST+29
 ;
LIST(GMPL,GMPDFN,GMPSTAT,GMPCOMM) ; Returns list of Problems for Patient
 ...
 . ;IHS/MSC/MGH quit for deleted problems
 . Q:ST="D"
 . S CNT=CNT+1
