AQAOT06 ; GENERATED FROM 'AQAO PROV ACTION EDIT' INPUT TEMPLATE(#1157), FILE 9002166.7;05/13/96
 D DE G BEGIN
DE S DIE="^AQAOCC(7,",DIC=DIE,DP=9002166.7,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^AQAOCC(7,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,6) S:%]"" DE(2)=%,DE(6)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
SET I X'?.ANP S DDER=1 Q 
 ...
 Q
BEGIN S DNM="AQAOT06",DQ=1
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIEZ=1157,U="^"
