AQAOT41 ; GENERATED FROM 'AQAO GENERAL EDIT' INPUT TEMPLATE(#1176), FILE 9002166.4;05/13/96
 D DE G BEGIN
...
SET I X'?.ANP S DDER=1 Q 
 ...
 Q
BEGIN S DNM="AQAOT41",DQ=1
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIEZ=1176,U="^"
1 S DW="0;2",DV="NJ4,0",DU="",DLB="OCCURRENCE REVIEW LIMIT",DIFLD=.02
 G RE
X1 K:+X'=X!(X>9999)!(X<1)!(X?.E1"."1N.N) X
 Q
 ;
2 G 0^DIE17
