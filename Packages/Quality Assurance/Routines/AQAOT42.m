AQAOT42 ; GENERATED FROM 'AQAO PROCEDURE FIRST' INPUT TEMPLATE(#1171), FILE 9002166.9;05/13/96
 D DE G BEGIN
...
SET I X'?.ANP S DDER=1 Q 
 ...
 Q
BEGIN S DNM="AQAOT42",DQ=1
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIEZ=1171,U="^"
