AQAOT652 ; GENERATED FROM 'AQAO LONG DISPLAY' PRINT TEMPLATE (#1271) ; 05/13/96 ; (continued)
 G BEGIN
N W !
...
BEGIN ;
 ...
 X DXS(24,9) K DIP K:DN Y W X
 D N:$X>8 Q:'DN  W ?8 W "Final Finding: "
 X DXS(25,9.2) S X=$P(DIP(101),U,2) S D0=I(0,0) K DIP K:DN Y W X
