...
ASK K DIC S DIC(0)="AEQM",DIC="^RA(72,"
 ...
 S DIC("S")="I $P(^(0),U,3)'=9,($P(^(0),U,3)'=0),($P(^(0),U,3)'=1),($P(^(0),U,7)=+$O(^RA(79.2,""B"",RAIMGTY,0)))"  ;IHS/ITSC/CLS 04/07/2005 don't allow override to complete from waiting for exam
 ...
 S X1=DT,X2=-0 D C^%DTC S DIR(0)="D^:"_X D ^DIR G EXIT:$D(DIRUT) S RAECDTI=9999999-Y D DD^%DT S RAECDTE=Y  ;IHS/ITSC/CLS 11/18/2004
 ...
 ;G DQ  ;IHS/ITSC/CLS 04/05/05  DEBUG
