BMCRCRV ; IHS/PHXAO/TMJ - list patients for which medical and/or cost data has not been received ;  
 ;;4.0;REFERRED CARE INFO SYSTEM;;JAN 09, 2006
 ;
 ;
 ;
 W !?10,"********  CASE REVIEW DATE LISTING  ********",!
 W !!,"This report will print a list of all referrals for a Case Review Date ",!,"range entered by the user.  This report can be used by the"
...
ZIS ;call to XBDBQUE
 ...
 S XBRP="^BMCRCRVP",XBRC="^BMCRCRV1",XBRX="XIT^BMCRR14",XBNS="BMC"
 D ^XBDBQUE
 D XIT
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""^BMCRCRVP"")"
 S XBRC="^BMCRCRV1",XBRX="XIT^BMCRCRV",XBIOP=0 D ^XBDBQUE
 Q
