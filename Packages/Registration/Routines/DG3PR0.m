DG3PR0 ;ALB/JDS - 10-10I ;01 JAN 1987
 ;;5.3;Registration;**26,69**;Aug 13, 1993
START K ^UTILITY($J) S (N(1),N(0),DG(1),DG(0))="" D ALL^IBCNS1(DFN,"DGIBINS",1) F I=0:0 S I=$O(DGIBINS(I)) Q:'I  S L=DGIBINS(I,0),M=$P(L,U,6),M=$S(M']"":0,1:M),^UTILITY($J,M,I)=L
