DGBLRV ;ALB/BOK - PATIENT ADMISSION FORM/BILL REVIEW ; 18 SEP 86  11:00
 ;;5.3;Registration;**26,570,1015**;Aug 13, 1993;Build 21
 ;
...
EN1 S DIC="^DGPM(",BY="@.01",L=0,FLDS="[DGPMBLRV]",DHD="@"
 S DIS(0)="S DFN=$P(^DGPM(D0,0),U,3) I $P(^(0),""^"",2)=1,$D(^DPT(DFN,""VET"")),($P(^(""VET""),""^"",1)=""Y"")"  ;,$$INSUR^IBBAPI(DFN,"""",""A"")" ihs/cmi/maw 02/08/2012 patch 1014 no IB
