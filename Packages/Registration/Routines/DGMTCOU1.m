DGMTCOU1 ;ALB/REW,LD,JAN,AEG - COPAY UTILITIES ; 03/22/02
 ;;5.3;Registration;**33,45,54,335,358,401,436,445**;Aug 13, 1993
AUTO(DFN,AUTOEX) ;
...
AUTOINFO(DFN) ;
 ...
 ; OUTPUT: (SC>50%^REC.A&A^REC.HB^REC.PEN^DOM PATIENT^NON.VET^INPATIENT)
 ;  Piece: (   1  ^   2   ^   3  ^   4   ^    5      ^   6   ^   7     )
 ;  PIECES =1 IF TRUE
 ;
 N DGALLEL,DGDOM,DGEL,DGNODE,DGX,DGYR,VADMVT
 S DGX=""
 ...
 I $P(DGNODE,U,12)["Y"!(DGALLEL["^2^") S $P(DGX,U,2)=1 G QTAUTO ;A&A
 I $P(DGNODE,U,13)["Y"!(DGALLEL["^15^") S $P(DGX,U,3)=1 G QTAUTO ;HB
 I $P(DGNODE,U,14)["Y"!(DGALLEL["^4^") S $P(DGX,U,4)=1 G QTAUTO ;PENSION
