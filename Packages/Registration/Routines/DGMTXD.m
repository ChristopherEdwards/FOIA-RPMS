DGMTXD ; GENERATED FROM 'DGMT ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#2442), FILE 408.22;10/15/12
 D DE G BEGIN
DE S DIE="^DGMT(408.22,",DIC=DIE,DP=408.22,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGMT(408.22,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,6) S:%]"" DE(19)=% S %=$P(%Z,U,9) S:%]"" DE(12)=% S %=$P(%Z,U,10) S:%]"" DE(21)=% S %=$P(%Z,U,18) S:%]"" DE(14)=%,DE(17)=% S %=$P(%Z,U,19) S:%]"" DE(23)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
