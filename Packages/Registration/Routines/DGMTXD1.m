...
BEGIN S DNM="DGMTXD1",DQ=1
1 S DW="0;11",DV="SX",DU="",DLB="DID CHILD HAVE ANY INCOME",DIFLD=.11
 S DE(DW)="C1^DGMTXD1"
 S DU="1:YES;0:NO;"
 G RE
...
X2 S:'X Y="@998"
 Q
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW="0;12",DV="SX",DU="",DLB="WAS THE CHILD'S INCOME AVAILABLE TO YOU",DIFLD=.12
 S DE(DW)="C3^DGMTXD1"
 S DU="1:YES;0:NO;"
 G RE
