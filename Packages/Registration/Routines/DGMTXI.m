DGMTXI ; GENERATED FROM 'DGMT ENTER/EDIT ANNUAL INCOME' INPUT TEMPLATE(#2443), FILE 408.21;10/15/12
 D DE G BEGIN
...
BEGIN S DNM="DGMTXI",DQ=1
 ...
 M DIEZAR=^DIE(2443,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2443,U="^"
