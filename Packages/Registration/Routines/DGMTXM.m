DGMTXM ; GENERATED FROM 'DGMT ENTER/EDIT MARITAL STATUS' INPUT TEMPLATE(#2441), FILE 408.22;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGMTXM",DQ=1
 ...
 M DIEZAR=^DIE(2441,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2441,U="^"
