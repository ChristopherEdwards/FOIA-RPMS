DGMTXN ; GENERATED FROM 'DGMT ENTER/EDIT NET WORTH' INPUT TEMPLATE(#2450), FILE 408.21;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGMTXN",DQ=1
 ...
 M DIEZAR=^DIE(2450,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2450,U="^"
