DGPMX1 ; GENERATED FROM 'DGPM ADMIT' INPUT TEMPLATE(#1834), FILE 405;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPMX1",DQ=1
 ...
 M DIEZAR=^DIE(1834,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1834,U="^"
