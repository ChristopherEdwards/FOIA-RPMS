DGPMX2 ; GENERATED FROM 'DGPM TRANSFER' INPUT TEMPLATE(#2427), FILE 405;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPMX2",DQ=1
 ...
 M DIEZAR=^DIE(2427,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2427,U="^"
