...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="USR;3",DV="RP200'a",DU="",DLB="LAST EDITED BY",DIFLD=102
 S DE(DW)="C1^DGPMX27"
 S DU="VA(200,"
 S X=DUZ
 S Y=X
...
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW="USR;4",DV="RD",DU="",DLB="LAST EDITED ON",DIFLD=103
