DGPMX3 ; GENERATED FROM 'DGPM DISCHARGE' INPUT TEMPLATE(#1835), FILE 405;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPMX3",DQ=1
 ...
 M DIEZAR=^DIE(1835,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1835,U="^"
