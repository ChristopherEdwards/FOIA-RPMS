DGPMX4 ; GENERATED FROM 'DGPM CHECK-IN LODGER' INPUT TEMPLATE(#1837), FILE 405;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPMX4",DQ=1
 ...
 M DIEZAR=^DIE(1837,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1837,U="^"
