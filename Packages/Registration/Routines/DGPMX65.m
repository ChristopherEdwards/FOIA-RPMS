...
BEGIN S DNM="DGPMX65",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;19",DV="R*P200'",DU="",DLB="ATTENDING PHYSICIAN",DIFLD=.19
 S DE(DW)="C1^DGPMX65"
 S DU="VA(200,"
 G RE
...
C1F1 Q
X1 S DIC("S")="I $$SCREEN^DGPMDD(Y,DA,+$G(^DGPM(DA,0)))" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
