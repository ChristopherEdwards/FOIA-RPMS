...
X3 S:DGPMP=^DGPM(DA,0) Y=""
 Q
4 S DW="USR;3",DV="RP200'a",DU="",DLB="LAST EDITED BY",DIFLD=102
 S DE(DW)="C4^DGPMX66"
 S DU="VA(200,"
 S X=DUZ
 S Y=X
...
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW="USR;4",DV="RD",DU="",DLB="LAST EDITED ON",DIFLD=103
