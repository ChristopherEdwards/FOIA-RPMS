...
TSPEC ;
 I DGPTTSC'?2N S DGPTERC=506 D ERR G:DGPTEDFL EXIT
 ...
 I '$$ACTIVE^DGACT(42.4,DGPTTSC,DGPTTDTS) S DGPTERC=506,DGPTSER(DGPTTDTS_535)=1 D ERR G:DGPTEDFL EXIT
LSPEC ;
 I DGPTTLC'?2N S DGPTERC=506 D ERR G:DGPTEDFL EXIT
 ...
 ;-- If not active treat spec, set 535 flag to print error msg during
 ;-- PTF close-out error display at WRER^DGPTAEE
 I '$$ACTIVE^DGACT(42.4,DGPTTLC,DGPTTDTS) S DGPTERC=506,DGPTSER(DGPTTDTS_5351)=1 D ERR G:DGPTEDFL EXIT
LVPAS ;
