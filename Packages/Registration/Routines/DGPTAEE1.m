DGPTAEE1 ;ALB/MTC - Austin Edits EAL Listing Continued ; 14 DEC 92
 ;;5.3;Registration;**338**;Aug 13, 1993
 ;
H101(REC) ;-- 101 header
 ...
 S VALMCNT=VALMCNT+1,^TMP("AD",$J,VALMCNT,0)=X
 S X="BIRTHDATE    POS AGO ION ST-CNTY  ZIP   MT INCOME MST"
 S VALMCNT=VALMCNT+1,^TMP("AD",$J,VALMCNT,0)=X
 S X=$E(REC,57,58)_SP_$E(REC,59,60)_SP_$E(REC,61,64)_"   "_$E(REC,65,66)_"    "_$E(REC,67)_"   "_$E(REC,68)_"  "_$E(REC,69,73)_"  "_$E(REC,74,78)_"  "_$E(REC,79,80)_SP_$E(REC,81,86)_"  "_$E(REC,87)
 S VALMCNT=VALMCNT+1,^TMP("AD",$J,VALMCNT,0)=X
