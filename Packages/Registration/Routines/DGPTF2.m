DGPTF2 ;ALB/JDS - PTF CORRECTIONS ; 18 SEP 84 @1500
 ;;5.3;Registration;**37,342**;Aug 13, 1993
EN Q:'$D(^UTILITY("DG",$J))  S Q=0,DG2=""
 F DG9=101,401,501,701,"HEADER" D @DG9 F I1=0:0 S I1=$O(^UTILITY("DG",$J,DG9,I1)) Q:I1'>0!(Q)  S DG45="",DGJ=^(I1) F J=2:1 S K=$P(DGJ,U,J) Q:'K  D SET Q:Q  I '$P(DGJ,U,J+1) D @($S(DG9=401!(DG9=501)!(DG9=601):"D5",1:"DO1")) Q:Q
