DGPTFJ ;ALB/MRL - JUMP BETWEEN PTF SCREENS ; 27 MAR 84  20:55
 ;;5.3;Registration;**58**;Aug 13, 1993
 ;
TEST K S,M G Q^DGPTF:X="^" S Z="^101^401^501^601^701^MAS^CDR",X1=X,X=$P($E(X,2,99),"-",1) G QUES:X1?1"^?".E Q:X=""  D IN^DGHELP G QUES:%=-1
 ...
 K M,L1,T G @($P(Z,";",3))
 ;
HELP W !!,"PTF Screens are: ",! F I=1,5,4,6,7,"M","C" S T=$T(@I) Q:T=""  W !?5,I,?10,$P(T,";",4)
 Q
