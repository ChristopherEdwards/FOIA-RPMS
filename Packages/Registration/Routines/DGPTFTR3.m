DGPTFTR3 ;ALB/MJK - TRANSMISSION OF PTF/CENSUS ; 01 DEC 87 @0800
 ;;5.3;Registration;;Aug 13, 1993
 ;
BULL ;CREATE BULLETIN
 G BULLQ:DGTR<1
 S Y=DT D DTS^SDUTL S ^UTILITY($J,"DGPTSTAT",1,0)="                           RUN DATE: "_Y,Y=DGSD
 D DTS^SDUTL S %="        RELEASE DATE RANGE SELECTED: "_Y_" - " S Y=$P(DGED,".") D DTS^SDUTL S ^UTILITY($J,"DGPTSTAT",2,0)=%_Y
