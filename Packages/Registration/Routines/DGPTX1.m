DGPTX1 ; GENERATED FROM 'DG101' INPUT TEMPLATE(#2410), FILE 45;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPTX1",DQ=1
 ...
 M DIEZAR=^DIE(2410,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2410,U="^"
