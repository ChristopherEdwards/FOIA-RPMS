...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG(DA)
C1F1 N X,X1,X2 S DIXR=332 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
X9 I +DGJUMP>2&(+DGJUMP<5) S Y="@"_+DGJUMP_1
 Q
10 G 1^DIE17
