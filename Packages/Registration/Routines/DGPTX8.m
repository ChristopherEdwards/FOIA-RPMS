DGPTX8 ; GENERATED FROM 'DG801' INPUT TEMPLATE(#3346), FILE 46.1;03/21/13
 D DE G BEGIN
...
BEGIN S DNM="DGPTX8",DQ=1
 ...
 M DIEZAR=^DIE(3346,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=3346,U="^"
