DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#2425), FILE 45;10/15/12
 D DE G BEGIN
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=366,367,368,369,370,371,372,373,374,375,376,377,378,379,390 S DIEZRXR(45,DIXR)=""
 Q
X1 Q
