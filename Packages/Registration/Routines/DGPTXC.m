DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#2425), FILE 45;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPTXC",DQ=1
 ...
 M DIEZAR=^DIE(2425,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2425,U="^"
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,D=0 K DE(1) ;50
 S DIFLD=50,DGO="^DGPTXC1",DC="35^45.02AI^M^",DV="45.02MNJ6,1X",DW="0;1",DOW="MOVEMENT RECORD",DLB="Select "_DOW S:D DC=DC_D
