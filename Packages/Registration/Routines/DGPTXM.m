DGPTXM ; GENERATED FROM 'DG PTF ADD MESSAGE' INPUT TEMPLATE(#2429), FILE 45.5;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGPTXM",DQ=1
 ...
 M DIEZAR=^DIE(2429,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2429,U="^"
