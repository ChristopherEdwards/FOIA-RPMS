DGREGE ;ALB/JDS - EDIT REGISTRATIONS/DISPOSITIONS ; 26 AUG 84  14:50
 ;;5.3;Registration;**24,161,151**;Aug 13, 1993
 N SDISHDL
...
W1 S SDISHDL=$$HANDLE^SDAMEVT(3) D BEFORE^DGDIS(DFN,9999999-DFN1,9,SDISHDL) S DA=DFN1,DA(1)=DFN,L=^DPT(DFN,"DIS",DFN1,0),DP=2.101,DR=$S($P(L,U,6):"[DGREGE]",1:"[DGREGEO]")
 S DIE="^DPT(",DA=DFN D ^DIE K DE,DQ,DIE,DR S DIE="^DPT("_DFN_",""DIS"",",DGXXXD=0 D EL
 I "^0^1^"[("^"_$P($G(^DPT(DFN,"DIS",DFN1,0)),"^",2)_"^"),$P(^(0),"^",6) D CO(DFN,9999999-DFN1,SDISHDL)
