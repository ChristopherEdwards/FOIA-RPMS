DGRPCE ;ALB/MRL,KV - CONSISTENCY CHECKER, EDIT INCONSISTENCIES ;11/15/2000
 ;;5.3;Registration;**121,122,175,297,342**;Aug 13, 1993
 ;
 ...
 S DGEK=0 F I=9,10,11,12,13,14,18,19,20,21,22,24,36,51 Q:DGEK  I DGER[(","_I_",") S DGEK=1 Q
...
ELDR S DGASK=DGASK_"9,10,11,12,13,14,18,19,20,22,24,29,30,31,34,36,37,38,43,44,45,"
...
26 ;;.32101;S:X'="Y" Y="@26";I DGVTYN'="Y" W !,"Patient not a veteran-can't claim VIETNAM SVC" S Y=.32101;.32104;.32105;@26;
27 ;;.32102;S:X'="Y" Y="@27";I DGVTYN'="Y" W !,"Patient not a veteran-can't claim AO EXPOSURE" S Y=.32102;.32107;.3211;.32109;.3213;@27;
28 ;;.32103;S:X'="Y" Y="@28";I DGVTYN'="Y" W !,"Patient not a veteran-can't claim RADIATION EXPOSURE" S Y=.32103;32111;.3212;@28;
...
33 ;;.36265;S:X'="Y" Y="@33";I DGVTYN'="Y" W !,"Patient not a veteran-can't claim GI INSURANCE" S Y=.36265;.3626;@33;
34 ;;.525;S:X'="Y" Y="@34";I DGVTYN'="Y" W !,"Patient not a veteran-can't claim POW STATUS" S Y=.525;.526:.528;@34;
35 ;;.5291;S:X'="Y" Y="@35";I DGVTYN'="Y" W !,"Patient not a veteran-can't claim COMBAT" S Y=.5291;.5292:.5294;@35;
...
43 ;;.36205;S:X'="Y" Y="@43";.36295;@43;
44 ;;.36215;S:X'="Y" Y="@44";.36295;@44;
45 ;;.36235;S:X'="Y" Y="@45";.36295;@45;
46 ;;
47 ;;
