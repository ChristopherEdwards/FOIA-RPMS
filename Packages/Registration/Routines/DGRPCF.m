DGRPCF ;ALB/MRL - CONSISTENCY OF PATIENT DATA (FILE/EDIT) ;25 AUG 88@0901
 ;;5.3;Registration;**250**;Aug 13, 1993
 ;
...
EN I '$D(DGCT) G KVAR^DGRPCE
 ...
 F DGD=0:0 S DGD=$O(^DGIN(38.5,DFN,"I",DGD)) Q:'DGD  K ^DGIN(38.5,DFN,"I",DGD)
