...
C4S S X="" G:DG(DQ)=X C4F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 ;
C4F1 N X,X1,X2 S DIXR=323 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
...
C6S S X="" G:DG(DQ)=X C6F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG(DA)
C6F1 N X,X1,X2 S DIXR=332 D C6X1(U) K X2 M X2=X D C6X1("O") K X1 M X1=X
 D
