...
C1F1 N X,X1,X2 S DIXR=24 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C4F1 N X,X1,X2 S DIXR=22 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
...
C4X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C4F2 S DIXR=50 D C4X2(U) K X2 M X2=X D C4X2("O") K X1 M X1=X
 D
...
C7S S X="" G:DG(DQ)=X C7F1 K DB
 D ^DGRPTX8
C7F1 N X,X1,X2 S DIXR=26 D C7X1(U) K X2 M X2=X D C7X1("O") K X1 M X1=X
 D
