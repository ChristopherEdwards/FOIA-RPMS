...
X6 S DFN=DA D AAC^DGLOCK2
 ...
 ;
7 S D=0 K DE(1) ;361
 S DIFLD=361,DGO="^DGRPX710",DC="3^2.0361IP^E^",DV="2.0361M*P8'X",DW="0;1",DOW="ELIGIBILITY",DLB="Select "_DOW S:D DC=DC_D
 S DU="DIC(8,"
...
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,D=0 K DE(1) ;.3731
 S DIFLD=.3731,DGO="^DGRPX711",DC="2^2.05A^.373^",DV="2.05MFX",DW="0;1",DOW="SERVICE CONNECTED CONDITIONS",DLB="Select "_DOW S:D DC=DC_D
