DGRPXC ; GENERATED FROM 'DG CONSISTENCY CHECKER' INPUT TEMPLATE(#2408), FILE 2;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGRPXC",DQ=1
 ...
 M DIEZAR=^DIE(2408,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2408,U="^"
