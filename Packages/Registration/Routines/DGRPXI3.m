...
BEGIN S DNM="DGRPXI3",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;16",DV="NJ8,2X",DU="",DLB="WORKERS COMP. OR BLACK LUNG",DIFLD=.16
 S DE(DW)="C1^DGRPXI3"
 G RE
...
X3 S:DGDR'[910 Y="@998"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="0;17",DV="NJ9,2X",DU="",DLB="ALL OTHER INCOME",DIFLD=.17
 S DE(DW)="C4^DGRPXI3"
 G RE
