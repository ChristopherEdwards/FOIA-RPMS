DGRPXR ; GENERATED FROM 'DGRP COLLATERAL REGISTER' INPUT TEMPLATE(#2409), FILE 2;10/29/04
 D DE G BEGIN
...
BEGIN S DNM="DGRPXR",DQ=1
 ...
 M DIEZAR=^DIE(2409,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2409,U="^"
1 S DW="VET;1",DV="RSX",DU="",DLB="VETERAN (Y/N)?",DIFLD=1901
 S DE(DW)="C1^DGRPXR"
 S DU="Y:YES;N:NO;"
 S X="N"
 S Y=X
