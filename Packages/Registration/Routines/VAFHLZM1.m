VAFHLZM1 ;BAY/JAT - Create HL7 Military History segment (ZMH); ; 9/20/00 11:51am
 ...
 Q
ENTER ;        
 ; build as many segments as are requested in VAFTYPE         
 F VAFX=1:1 S VAFZ=$P(VAFTYPE,",",VAFX) Q:VAFZ=""  D
 .S VAFINDX=VAFINDX+1
 .S VAFY=""
 .S $P(VAFY,VAFHLS,1)=VAFINDX  ; set ID
 .S VAFTAG=$S(VAFZ=1:"SL",VAFZ=2:"SNL",VAFZ=3:"SNNL",VAFZ=4:"POW",VAFZ=5:"COMB",VAFZ=6:"VIET",VAFZ=7:"LEBA",VAFZ=8:"GREN",VAFZ=9:"PANA",VAFZ=10:"GULF",VAFZ=11:"SOMA",VAFZ=12:"YUGO",VAFZ=13:"PH",1:"NOSEG")
 .D @VAFTAG
 .S @VAFARRAY@(VAFINDX,0)="ZMH"_VAFHLS_$G(VAFY)
 Q
 ;
 ;
SL ; last Service branch
 S $P(VAFY,VAFHLS,2)="SL"
 N VAF325,VAF328,VAF324,VAF326,VAF327
 I VAFSTR[",3," D
...
SNL ; next to last Service branch
 ...
 N VAF3291,VAF3294,VAF329,VAF3292,VAF3293
 I VAFSTR[",3," D
...
SNNL ; next to next to last Service branch
 ...
 N VAF3296,VAF3299,VAF3295,VAF3297,VAF3298
 I VAFSTR[",3," D
