...
BLD(SCLIST,SCPTTPA,SCPTTPA0) ; build list
 ...
 S @SCLIST@(0)=SCN
 ;S @SCLIST@(SCN)=DFN_U_$P($G(^DPT(DFN,0)),U,1)_U_SCPTTPA_U_$P(SCPTTPA0,U,3)_U_$P(SCPTTPA0,U,4)_U_$P($G(^DPT(DFN,.36)),U,3)  ;IHS/ANMC/LJF 12/06/2000
 S @SCLIST@(SCN)=DFN_U_$P($G(^DPT(DFN,0)),U,1)_U_SCPTTPA_U_$P(SCPTTPA0,U,3)_U_$P(SCPTTPA0,U,4)_U_$$HRCN^BDGF2(DFN,+$G(DUZ(2)))   ;IHS/ANMC/LJF 12/06/2000
