SCRPW15 ;RENO/KEITH - Encounter Activity Report (Cont.) ;06/19/99
 ;;5.3;Scheduling;**139,144,166,180**;AUG 13, 1993
...
DX ;Print diagnosis information
 ...
 ;
DX1 D:$Y>(IOSL-6) HDR(),DXHD Q:SDOUT  S SDD0=^ICD9(SDD,0),SDT1=+$G(^TMP("SCRPW",$J,SDIV,1,SDS,"DX",SDD,"PRI")),SDT2=+$G(^TMP("SCRPW",$J,SDIV,1,SDS,"DX",SDD,"SEC")),SDTOT1=SDTOT1+SDT1,SDTOT2=SDTOT2+SDT2,SDTOT=SDTOT+SDT1+SDT2
