SCRPW16 ;RENO/KEITH - Encounter 'Action Required' Report ; 01 Jan 99  9:27 PM
 ;;5.3;Scheduling;**139,144,155,161**;AUG 13, 1993
...
EVAL S SDSTOP=SDSTOP+1 I SDSTOP#3000=0 D STOP Q:SDOUT
 ...
 I $D(SDX) S SDI=0 F  S SDI=$O(SDX(SDI)) Q:'SDI  I $P(SDX(SDI),U,2)="" S SDX=$S(SDI=1:"Agent Orange",SDI=2:"Ionizing Radiation",SDI=3:"Service Connected",1:"Environmental Contaminants")_" classification required" D SET(SDX)
