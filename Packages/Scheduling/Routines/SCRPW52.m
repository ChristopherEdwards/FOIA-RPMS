SCRPW52 ;RENO/KEITH - Encounters by DSS Identifier/DSS ID by Frequency (OP0, OP1, OP2) (cont.) ; 15 Jul 98  02:38PM
 ...
 S SDTIT(1)="<*>  DSS ID BY FREQUENCY (OP2)  <*>" F SDI=0:1:7 S SDRTOT(SDI)=0
...
EXIT I $E(IOST)="C",'SDOUT N DIR S DIR(0)="E" D ^DIR
 ...
 K SDPNOW,SDPS,SDPSC,SDRTOT,SDSC,SDSCN,SDSSC,SDSTOP,SDT,SDTCT,SDTIT,SDUNI,SDIV,SDVCT,SDX,SDYMO,X,Y Q
