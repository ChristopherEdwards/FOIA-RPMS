SCRPW54 ;RENO/KEITH - Means Test Summary of Visits & Uniques (OP3, OP4, OP5) ; 5/21/01 3:32pm
 ;;5.3;Scheduling;**144,258**;AUG 13, 1993
 D RQUE^SCRPW50("START^SCRPW54","Means Test Summary of Visits & Uniques (OP3, OP4, OP5)",1) Q
 ;
START ;Print report
 ...
 ..Q
 .D AA(SDIV) Q
 G:SDOUT EXIT S SDLINE="",$P(SDLINE,"-",(IOM+1))="" D NOW^%DTC S Y=% X ^DD("DD") S SDPNOW=$P(Y,":",1,2),SDTIT(1)="<*>  MEANS TEST SUMMARY OF VISITS & UNIQUES (OP3, OP4, OP5)  <*>",SDPG=0 D:$E(IOST)="C" DISP0^SCRPW23
...
EXIT I $E(IOST)="C",'SDOUT N DIR S DIR(0)="E" D ^DIR
 K ^TMP("SCRPW",$J),%,%H,%I,DFN,DIR,SD,SDAGE,SDDIV,SDFAA,SDFTOT,SDFV,SDH,SDI,SDIV,SDIVN,SDLAB,SDLINE,SDLT,SDMD,SDMO,SDMOTO,SDMT,SDOE,SDOE0
...
VALID() ;Check encounter record
 I SDIV,$$DIV(),$P(SDOE0,U),$P(SDOE0,U,2),'$P(SDOE0,U,6),$P(SDOE0,U,12)=2,$P(SDOE0,U,10),$P(SDOE0,U,13) Q 1
 Q 0
 ;
DIV() ;Check division
