SCRPW56 ;RENO/KEITH - Most Frequent 50 CPT Codes (OP6) ;06/22/99
 ;;5.3;Scheduling;**144,180**;AUG 13, 1993
 ;06/22/99 ACS - Added CPT modifier API calls
 ;
 D RQUE^SCRPW50("START^SCRPW56","Most Frequent 50 CPT Codes (OP6)",1) Q
 ;
START ;Print report
 ...
 G:SDOUT EXIT S SDLINE="",$P(SDLINE,"-",(IOM+1))="" D NOW^%DTC S Y=% X ^DD("DD") S SDPNOW=$P(Y,":",1,2),SDTIT(1)="<*>  MOST FREQUENT 50 CPT CODES (OP6)  <*>",SDPG=0 D:$E(IOST)="C" DISP0^SCRPW23
