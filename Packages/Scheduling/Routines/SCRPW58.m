SCRPW58 ;RENO/KEITH - Most Frequent 20 Practitioner Types (OP8) ; 15 Jul 98  8:28 PM
 ;;5.3;Scheduling;**144**;AUG 13, 1993
 ;Most Frequent 20 Practitioner Types (OP8)
 D RQUE^SCRPW50("START^SCRPW58","Most Frequent 20 Practitioner Types (OP8)",1) Q
 ;
START ;Print report
 ...
 G:SDOUT EXIT S SDLINE="",$P(SDLINE,"-",(IOM+1))="" D NOW^%DTC S Y=% X ^DD("DD") S SDPNOW=$P(Y,":",1,2),SDTIT(1)="<*>  MOST FREQUENT 20 PRACTITIONER TYPES (OP8)  <*>",SDPG=0 D:$E(IOST)="C" DISP0^SCRPW23
...
EXIT I $E(IOST)="C",'SDOUT N DIR S DIR(0)="E" D ^DIR
 K ^TMP("SCRPW",$J),%,%H,%I,DIR,SD,SDARY,SDCD,SDDIV,SDI,SDII,SDIV,SDIVN,SDLINE,SDMD,SDOE,SDOE0,SDOUT,SDPAGE,SDPC,SDPG,SDPNOW,SDSPE,SDSTOP,SDSUB,SDT,SDTIT,SDV,SDVCT,SDX,X,Y Q
 ;
