SDCLAV ;ALB/LDB - ROUTINE TO OUTPUT PATTERNS ; [ 01/09/2004  9:58 AM ]
...
DIV D ASK2^SDDIV G:Y<0 END S VAUTNI=2 D CLINIC^VAUTOMA
 I VAUTC=0 D EXPNDPC^BSDU(2,.VAUTC)    ;expand principle clinics;IHS/ITSC/LJF 1/9/2004
...
A1 W !!,"FOR INDIVIDUAL APPOINTMENT LISTINGS:"
 ;W:$D(SDCI) !?39,"* --APPTS CANCELLED WHEN CLINIC WAS",!?43,"CANCELLED",!?38,"**",?40," --NO-SHOW"  ;IHS/ANMC/LJF 10/5/2000
 W:$D(SDCI) !?39,"* --APPTS CANCELLED",!?38,"**",?40," --NO-SHOW"  ;IHS/ANMC/LJF 10/5/2000
