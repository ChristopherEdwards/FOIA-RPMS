SDL1 ;BSN/GRR,ALB/LDB - PRE-APPOINTMENT LETTERS ; [ 09/13/2001  2:28 PM ]
 ;;5.3;Scheduling;**106**;Aug 13, 1993
...
LST F L=0:0 S L=$O(^UTILITY($J,L)) Q:'L  F A=0:0 S A=$O(^UTILITY($J,L,A)) Q:'A  S SDLET=L D ^SDLT,APP
