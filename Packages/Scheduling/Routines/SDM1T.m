SDM1T ; GENERATED FROM 'SDM1' INPUT TEMPLATE(#2459), FILE 2;10/29/04
 D DE G BEGIN
...
C1F1 N X,X1,X2 S DIXR=21 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C3F1 N X,X1,X2 S DIXR=23 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
...
C5S S X="" G:DG(DQ)=X C5F1 K DB
 D ^SDM1T2
C5F1 N X,X1,X2 S DIXR=24 D C5X1(U) K X2 M X2=X D C5X1("O") K X1 M X1=X
 D
...
C6S S X="" G:DG(DQ)=X C6F1 K DB
 D ^SDM1T4
C6F1 N X,X1,X2 S DIXR=25 D C6X1(U) K X2 M X2=X D C6X1("O") K X1 M X1=X
 D
