SDM2 ;SF/GFT - MAKE APPOINTMENT ; [ 11/09/2001  10:59 AM ]
 ;;5.3;Scheduling;**32,132,168**;Aug 13, 1993
 ;IHS/ANMC/LJF 10/18/2000 added check: user have access to princ clin?
 ;
...
PROT K SDPROT
 ;I $D(^SC(I,"SDPROT")),$P(^("SDPROT"),U)="Y",'$D(^SC(I,"SDPRIV",DUZ)) D  Q  ;IHS/ANMC/LJF 10/18/2000
 I $D(^SC(I,"SDPROT")),$P(^("SDPROT"),U)="Y",'$D(^SC(I,"SDPRIV",DUZ)),'$D(^SC($$PC^BSDU(I),"SDPRIV",DUZ)) D  Q   ;IHS/ANMC/LJF 10/18/2000
 .W !!,"You may not delete the other appointment!"  ;IHS/ANMC/LJF 10/18/2000
