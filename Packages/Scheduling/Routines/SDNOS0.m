SDNOS0 ;ALB/LDB - NO SHOW REPORT ; [ 09/13/2001  2:36 PM ]
 ;;5.3;Scheduling;**20,194**;Aug 13, 1993
...
CHK1 S SD="SD" F SDCHK=1,2,10,12,14 S @(SD_SDCHK)=$P(^DPT(SDPAT,"S",SDBEG1,0),U,SDCHK)
 ...
 I SD2["N",$$NOSHOW(SDPAT,SDBEG1,SDCL,$G(^DPT(SDPAT,"S",SDBEG1,0)),SDAPP) D SET,TOTAL Q
