SDXACSE ; GENERATED FROM 'SDXACSE' INPUT TEMPLATE(#2138), FILE 409.5;02/09/12
...
BEGIN S DNM="SDXACSE",DQ=1
 ...
 M DIEZAR=^DIE(2138,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2138,U="^"
...
X2 I '$S($D(SDUZ):1,$D(DUZ):1,1:0) W !,*7,"User not defined." S Y="@89"
 Q
3 S D=0 K DE(1) ;10
 S DIFLD=10,DGO="^SDXACSE1",DC="15^409.51P^CS^",DV="409.51P40.7'",DW="0;1",DOW="CLINIC STOP CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),":") S:D DC=DC_D
 S DU="DIC(40.7,"
