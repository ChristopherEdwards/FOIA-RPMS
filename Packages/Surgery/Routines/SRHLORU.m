SRHLORU ;B'HAM ISC/DLR - Surgery Interface Receiver of ORU messages ; [ 05/06/98   7:14 AM ]
 ;;3.0; Surgery ;**41**;24 Jun 93
 ; Per VHA Directive 10-93-142, this routine SHOULD NOT be modified.
REC N HLCOMP,HLREP,HLSUB,HLFS,HLECH,II,SG,SRERR,SRI,SSN,TYPE,SROP,SRNON,SRHL
 K HLMID,PID,SRHL S SRHL("E")=+$G(SRHL("E"))
