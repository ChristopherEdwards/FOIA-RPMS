...
MORE ; print CPT description and get cases
 ...
 S TYPE=0,X=$$CPT^ICPTCOD(CPT),CPT1=$P(X,"^",2)_"  "_$P(X,"^",3)
...
DESC ; print description
 ...
 K SRDESC S X=$$CPTD^ICPTCOD(CPT,"SRDESC") F I=1:1:X S Y=$S(I=1:"DESCRIPTION: "_SRDESC(I),1:SRDESC(I)) W !,?(132-$L(Y)\2),Y
 W !! F LINE=1:1:132 W "-"
 Q
