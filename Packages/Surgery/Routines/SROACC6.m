SROACC6 ;BIR/MAM - CPT ACCURACY ONE CODE ; [ 05/14/99  11:41 AM ]
 ;;3.0; Surgery ;**37,50,88**;24 Jun 93
 ;
 ...
 S TYPE=0,X=$$CPT^ICPTCOD(SRCPT),CPT1=$P(X,"^",2)_"  "_$P(X,"^",3)
...
DESC ; print description
 Q:SRSOUT  I '$O(^TMP("SR",$J,TYPE,0)) Q
 D LINE W !!,?(132-$L(CPT1)\2),CPT1
 I TYPE=1 W !,?50,"PRINCIPAL PROCEDURES"
 I TYPE=2 W !,?54,"OTHER PROCEDURES"
 K SRDESC S X=$$CPTD^ICPTCOD(SRCPT,"SRDESC") F I=1:1:X S Y=$S(I=1:"DESCRIPTION: "_SRDESC(I),1:SRDESC(I)) W !,?(132-$L(Y)\2),Y
 W !! F LINE=1:1:132 W "-"
 Q
