SROALM ;BIR/ADM - List of Assessments Missing Information ; [ 05/26/99   2:33 PM ]
 ;;3.0; Surgery ;**38,50,88**;24 Jun 93
...
PRINT ; print assessments
 ...
 S CNT=1 W ?5,"Missing information:" F  S SRFLD=$O(SRX(SRFLD)) Q:SRFLD=""  D:$Y+5>IOSL PAGE Q:SRSOUT  W !,$J(CNT_". ",8),SRX(SRFLD) S CNT=CNT+1
