SROALSS ;B'HAM ISC/AM - ALL CASES BY SPECIALTY ; [ 07/27/98   2:33 PM ]
...
CASE ; print a case
 ...
 I SREXCL'="" W ! W:$D(SROPS(2)) ?20,SROPS(2) W ?55,SREXCL I $D(SROPS(3)) W !,?20,SROPS(3) I $D(SROPS(4)) W !,?20,SROPS(4)
...
HDR ; print heading
 ...
 W !!,"CASE #",?20,"PATIENT",?55,"ASSESSMENT STATUS",!,"OPERATION DATE",?20,"PRINCIPAL OPERATIVE PROCEDURE",?55,"ANESTHESIA TECHNIQUE",!,?55,"EXCLUSION CRITERIA",! F L=1:1:80 W "="
 W ! Q
