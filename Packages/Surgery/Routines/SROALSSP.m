SROALSSP ;B'HAM ISC/AM - ASSESSMENTS BY SPECIALTY (PRINTER) ; [ 07/27/98   2:33 PM ]
 ;;3.0; Surgery ;**32,47,50**;24 Jun 93
...
CASE ; print a case
 ...
 W !,SRTN,?20,SRANM_"  "_VA("PID"),?67,STATUS,?107,SRTECH,!,SRDT,?20,SROPS(1)
 I SREXCL'="" W ?65,SREXCL I $D(SROPS(2)) W !,?20,SROPS(2) I $D(SROPS(3)) W !,?20,SROPS(3) I $D(SROPS(4)) W !,?20,SROPS(4)
...
HDR ; print heading
 ...
 W !!,"CASE #",?20,"PATIENT",?67,"ASSESSMENT STATUS",?107,"ANESTHESIA TECHNIQUE",!,"OPERATION DATE",?20,"PRINCIPAL OPERATIVE PROCEDURE",?65,"EXCLUSION CRITERIA",! F L=1:1:132 W "="
 Q
