SROALST ;B'HAM ISC/MAM - ALL ASSESSMENTS ; [ 07/27/98   2:33 PM ]
 ;;3.0; Surgery ;**38,47,50**;24 Jun 93
...
SET ; print assessments
 ...
 W !,SRTN,?20,SRANM_" "_VA("PID"),?55,$P(SRSS,"("),!,SRDT,?20,SROPS(1),?55,SRTECH,!,STATUS W:$D(SROPS(2)) ?20,SROPS(2)
 I SREXCL'="" W ?55,SREXCL I $D(SROPS(3)) W !,?20,SROPS(3) I $D(SROPS(4)) W !,?20,SROPS(4)
...
HDR S SRHD="ALL SURGICAL CASES"
 ...
 W !!,"CASE #",?20,"PATIENT",?55,"SURGICAL SPECIALTY",!,"OPERATION DATE",?20,"PRINCIPAL OPERATION",?55,"ANESTHESIA TECHNIQUE",!,"ASSESSMENT STATUS",?55,"EXCLUSION CRITERIA",! F LINE=1:1:80 W "="
 Q
