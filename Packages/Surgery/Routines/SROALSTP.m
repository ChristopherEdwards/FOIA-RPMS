SROALSTP ;B'HAM ISC/MAM - ALL CASES ; [ 07/27/98   2:33 PM ]
...
SET ; print assessments
 ...
 W !,SRTN,?20,SRANM_" "_VA("PID"),?67,$P(SRSS,"("),?107,SRTECH,!,SRDT,?20,SROPS(1),?65,STATUS,?105,SREXCL
...
HDR ; print heading
 ...
 W !!,"CASE #",?20,"PATIENT",?67,"SURGICAL SPECIALTY",?107,"ANESTHESIA TECHNIQUE",!,"OPERATION DATE",?20,"PRINCIPAL OPERATIVE PROCEDURE",?65,"ASSESSMENT STATUS",?105,"EXCLUSION CRITERIA",! F LINE=1:1:132 W "="
 Q
