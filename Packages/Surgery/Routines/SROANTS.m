SROANTS ;B'HAM ISC/MAM - INCOMPLETE ASSESSMENTS ; [ 07/27/98   2:33 PM ]
...
SET ; print assessments
 ...
 W !,SRTN,?20,SRANM_" "_VA("PID"),?55,SRTECH,!,SRDT,?20,SROPS(1) S SRAO=1 F  S SRAO=$O(SROPS(SRAO)) Q:'SRAO  W !,?20,SROPS(SRAO)
 W ! F LINE=1:1:80 W "-"
 Q
...
HDR W @IOF,!!,?26,"INCOMPLETE RISK ASSESSMENTS",!,?(80-$L(SRFRTO)\2),SRFRTO,!!,"ASSESSMENT #",?20,"PATIENT",?55,"ANESTHESIA TECHNIQUE",!,"OPERATION DATE",?20,"PRINCIPAL OPERATION",! F LINE=1:1:80 W "="
 Q
