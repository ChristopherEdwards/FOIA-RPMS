SROANTSP ;B'HAM ISC/MAM - INCOMPLETE ASSESSMENTS (PRINTER) ; [ 07/27/98   2:33 PM ]
 ;;3.0; Surgery ;**32,50**;24 Jun 93
...
SET ; print assessments
 ...
 W !,SRTN,?20,SRANM_" "_VA("PID"),?67,SROPS(1),?107,SRTECH,!,SRDT I $D(SROPS(2)) W ?65,SROPS(2) S SRAO=2 F L=0:0 S SRAO=$O(SROPS(SRAO)) Q:'SRAO  W !,?65,SROPS(SRAO)
 W ! Q
...
HDR ; print heading
 ...
 W !!,"ASSESSMENT #",?20,"PATIENT",?67,"PRINCIPAL OPERATIVE PROCEDURE",?107,"ANESTHESIA TECHNIQUE",!,"OPERATION DATE",! F LINE=1:1:132 W "="
 Q
