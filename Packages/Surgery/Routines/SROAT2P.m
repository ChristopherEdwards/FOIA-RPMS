SROAT2P ;B'HAM ISC/MAM - ATTENDING SURGEON REPORT (CONT.) ; [ 09/22/98  11:29 AM ]
...
SET ; print case
 ...
 S SRCODE=$S(SRATC=0:"0. STAFF",SRATC=1:"1. ATTENDING IN O.R.",SRATC=2:"2. ATTENDING IN O.R. SUITE",SRATC=3:"3. ATTEND NOT PRESENT, BUT AVAILABLE",1:"ATTENDING CODE NOT ENTERED")
...
OPS S SROPER=$P(^SRF(SRTN,"OP"),"^"),OPER=0 F I=0:0 S OPER=$O(^SRF(SRTN,13,OPER)) Q:OPER=""  D OTHER
 ...
 W !!,SRDT,?12,VADM(1),?50,SRDIAG,?112,SRSUR,!,SRTN,?12,VA("PID"),?50,SROP(1),?112,SRFST,! W:$P($G(^SRF(SRTN,30)),"^") "ABORTED" W ?12,SRCODE W:$D(SROP(2)) ?50,SROP(2) W ?112,SRTWO
 I $D(SROPS(3)) W !,?40,SROPS(3) I $D(SROPS(4)) W !,?40,SROPS(4)
 Q
