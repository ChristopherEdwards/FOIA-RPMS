SROATM1 ;BIR/MAM - NON CARDIAC TRANSMISSION ; [ 04/20/00  2:12 PM ]
 ;;3.0; Surgery ;**27,38,47,60,62,81,88,93,95**;24 Jun 93
 ;
 ; Reference to ^DIC(45.3 supported by DBIA #218
 ;
 N SRINTUB F I=0,200 S SRA(I)=$G(^SRF(SRTN,I))
 ...
 S NYUK=$P(SRA(200),"^",2) D ONE S SHEMP=SHEMP_MOE,NYUK=$P(SRA(200),"^",3) D ONE S SHEMP=SHEMP_MOE,NYUK=$P(SRA(200),"^",4) D ONE S SHEMP=SHEMP_MOE,NYUK=$P(SRA(200),"^",5) D ONE S SHEMP=SHEMP_MOE
