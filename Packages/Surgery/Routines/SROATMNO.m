SROATMNO ;BIR/MAM - TRANSMIT NO ASSESSMENT ; [ 08/14/00  2:12 PM ]
 ;;3.0; Surgery ;**27,38,47,62,68,79,83,81,88,93,95,97**;24 Jun 93
 ;
...
SET I $P($G(^SRF(SRTN,.4)),"^",2)="T" K ^SRF("AQ",TDATE,SRTN) Q
 ...
 S SRTEMP="@"_$J(SRASITE,3)_$J(SRTN,7)_SRNODE_DATE_$J(SRTECH,3)_$J(EMERG,1)_$J(SPEC,3)_$J(CPT,5)_$J(EXC,1)_$J(VA("PID"),20)_$J(SRDIV,6)_$J(SRATTEND,1)
 ...
 S ^TMP("SRA",$J,SRAMNUM,SRACNT,0)=SRTEMP_$J(SRINTUB,1)_SR95PO,SRACNT=SRACNT+1
 I SRACNT>100 S SRACNT=1,SRAMNUM=SRAMNUM+1
 S SRATOT=SRATOT+1
 S X=$E($P(^SRF(SRTN,0),"^",9),1,5)_"00",^TMP("SRWL",$J,X)=""
 K DATE,ANES,EMERG,EXC,SPEC,SRADMIT,SRADMT,SRATTEND,SRBLANK,SRCC,SRDIV,SRDTHUR,SRIO,SRMAJMIN,SRTEMP,SRTMP,SRZ,SR14,CPT
 Q
