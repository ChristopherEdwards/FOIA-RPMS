SROCL1 ;BIR/SJA - LOAD CARDIAC LAB DATA ; [ 12/01/99  2:34 PM ]
...
START S SRALR=$S($D(^DPT($P(^SRF(SRTN,0),"^"),"LR")):$P(^("LR"),"^"),1:"")
 ...
 S X1=SRAOP,X2=+90 D C^%DTC S SRST=9999999-X
 S X1=SRAOP,X2=-90 D C^%DTC S SREND=9999999-X
SRAT ; Get test and data name(s) for test from file 139.2.
 ...
 F II=5,14,21:1:24 S SRAT=$S(II=5:23,II=14:24,II=23:25,II=24:26,1:II) D SP
