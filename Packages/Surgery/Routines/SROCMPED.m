SROCMPED ;B'HAM ISC/MAM - ENTER/EDIT OCCURRENCES ; 30 MAR 1992 11:45 am
 ;;3.0; Surgery ;**26,38,47**;24 Jun 93
...
START I '$D(^SRF(SRTN,SRTYPE,SRENTRY)) K SRENTRY S SRSOUT=0 Q
 D HDR^SROAUTL W ! S SRSOUT=0,SR=^SRF(SRTN,SRTYPE,SRENTRY,0)
...
DISP W !,"1. Occurrence: ",?26,$P(SRO(1),"^"),!,"2. Occurrence Category: ",?26,$P(SRO(2),"^"),!,"3. ICD Diagnosis Code:",?26,$P(SRO(3),"^"),!,"4. Treatment Instituted:",?26,$P(SRO(4),"^"),!,"5. Outcome to Date:",?26,$P(SRO(5),"^")
 ...
 S SRZ=X K DIE,DA,DR S DA(1)=SRTN,DA=SRENTRY,DIE="^SRF("_SRTN_","_SRTYPE_",",DR=$P(SRO(X),"^",2)_"T" D ^DIE K DR,DA D:SRZ=2 PRESS G START
 Q
