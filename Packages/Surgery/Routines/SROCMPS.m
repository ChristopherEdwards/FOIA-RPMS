SROCMPS ;B'HAM ISC/MAM - ENTER/EDIT OCCURRENCES ; 25 Aug 94 / 11:26 AM
 ;;3.0; Surgery ;**14,32,38,95,102**;24 Jun 93
...
ICD W !!,"Since you have selected one of the 'OTHER' occurrence categories, an ICD",!,"Diagnosis Code should be entered for this occurrence."
 W ! K DIC S DIC=80,DIC("A")="Select ICD Diagnosis Code: ",DIC(0)="QEAMZ" D ^DIC I +Y>0 S SRICD=+Y,SRCOM=$P(Y(0),"^",3)
 Q
