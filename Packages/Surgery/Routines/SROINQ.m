SROINQ ;B'HAM ISC/MAM  - OPERATION INQUIRY ; 7 Nov 1988  12:44 PM
 ;;3.0; Surgery ;**38,48**;24 Jun 93
 ...
 S:SRANE SRANE=$P(^VA(200,SRANE,0),"^") S X=$P(S(.1),"^",16),SRTACD=$S(X=0:"0. STAFF",X=1:"1. ATTENDING IN O.R.",X=2:"2. ATTENDING IN O.R. SUITE",X=3:"3. ATTENDING NOT PRESENT, BUT AVAILABLE",1:"")
...
PRINT ; print inquiry
 ...
 W !,"Attending Surgeon: "_SRATT,?50,"Operation Time: "_SRTIME I SRTIME W " Minutes",!,"Attending Code: "_SRTACD,!,SRLINE
