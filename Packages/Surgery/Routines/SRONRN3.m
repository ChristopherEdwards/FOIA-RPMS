SRONRN3 ;B'HAM ISC/MAM - NURSE INTRAOP REPORT (FORMAT 0) ; [ 11/24/98  10:23 AM ]
 ;;3.0; Surgery ;**25,48,86**;24 Jun 93
 ;
 ; Reference to ^PSDRUG supported by DBIA #221
 ;
 I $O(^SRF(SRTN,41,0))!($O(^SRF(SRTN,9,0))) D UL W !,"Material Sent to Laboratory for Analysis:"
 I $O(^SRF(SRTN,9,0)) W !,"Specimens: " S SRSP=0 F  S SRSP=$O(^SRF(SRTN,9,SRSP)) Q:'SRSP!SRSOUT  D
 ...
 I $O(^SRF(SRTN,41,0)) W !,"Cultures: " S SRSP=0 F  S SRSP=$O(^SRF(SRTN,41,SRSP)) Q:'SRSP!SRSOUT  D
 .I $Y+10>IOSL D FOOT Q:SRSOUT  I $E(IOST)="P" D HDR,UL Q:SRSOUT
 ...
 S SR(3)=$G(^SRF(SRTN,3)),X=$P(SR(3),"^") I X'="" D UL W !,"Tubes and Drains: ",!,?2,X
