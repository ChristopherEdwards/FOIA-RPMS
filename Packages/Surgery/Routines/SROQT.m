SROQT ;B'HAM ISC/ADM - QTRLY RPT MESSAGE TO SERVER ; [ 08/07/00  12:48 PM ]
 ;;3.0; Surgery ;**38,43,62,67,70,77,50,95**;24 Jun 93
 ;
 ;** NOTICE: This routine is part of an implementation of a nationally
 ;**         controlled procedure.  Local modifications to this routine
 ;**         are prohibited.
 ;
 S SRD=^XMB("NETNAME"),ISC=0 I $E(SRD,1,3)="ISC"!(SRD["ISC-")!(SRD["ISC.")!(SRD["FORUM")!(SRD["TST") S ISC=1
...
MSG ; create mail message to server
 ...
 I 'ISC S (XMY("S.SRCOSERV@ISC-CHICAGO.VA.GOV"),XMY("G.SRCOSERV@ISC-CHICAGO.VA.GOV"))=""
