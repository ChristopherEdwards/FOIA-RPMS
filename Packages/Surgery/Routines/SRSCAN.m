SRSCAN ;B'HAM ISC/MAM - CANCEL SCHEDULED OPERATION ; 20 Dec 1988  8:31 AM
...
ASK R !!,"Select Number: ",SRNUM:DTIME I '$T!("^"[SRNUM) G END
 ...
 I $D(^SRF(SRTN,.2)),$P(^(.2),"^",2)'="" W !!,*7,"This operation already has a start time and cannot be cancelled.",!!,"Press RETURN to continue  " R X:DTIME G END
