SRSRQST ;BIR/MAM,ADM - MAKE OPERATION REQUESTS; [ 10/17/01  7:36 AM ]
 ;;3.0; Surgery ;**3,58,67,88,103,105**;24 Jun 93
...
IND K DR S DIE=130,DA=SRTN,DR="55T" D ^DIE I $D(DTOUT) S SRDUOUT=1
 ...
 I '$D(SRCC) D ^SRSRQST1
 Q
END I SRSOUT W !!,"No request has been entered.",! S:'$D(SRCC) SRSOUT=0
 Q
