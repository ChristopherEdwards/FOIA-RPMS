AUM101EN ;IHS/ASDST/DMJ,SDR,GTH - ICD 9 CODES FOR FY 2010 ; [ 09/17/2002  12:40 PM ]
 ...
 ;
 I $$VCHK("AUM","9.1",2)
 S X=$$LAST("ICD UPDATE","9.1")
 I $P(X,U)'=4 W !,$$CJ^XLFSTR("AUM*9.1*4 NOT INSTALLED",IOM) S XPDQUIT=2  ;need AUM*9.1*4 installed
 ;
 NEW DA,DIC
