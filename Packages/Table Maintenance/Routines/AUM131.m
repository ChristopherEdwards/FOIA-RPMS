AUM131 ;IHS/OIT/NKD - ICD 9 UPDATE 08/30/2012 ;
 ;;13.0;TABLE MAINTENANCE;;AUG 30,2012;Build 1
 ;
 Q
...
UPDDX(YEAR) ; ICD9 DIAGNOSIS FILE DRIVER
 N TYPE,ICDCNT
 F TYPE="REV"  D
 . D RSLT^AUM13EN("ICD 9 DIAGNOSIS, "_YEAR_" "_$S(TYPE="NEW":TYPE,TYPE="REV":"REVISED",TYPE="INA":"INACTIVATED",1:"")_" CODES:",1)
 . D RSLT^AUM13EN($J("",4)_"CODE"_$J("",6)_"DIAGNOSIS"_$J("",18)_"NEW"_$J("",1)_"SHORT"_$J("",1)_"LONG"_$J("",1)_"SEX"_$J("",1)_"AGE"_$J("",1)_"CC")
 . D RSLT^AUM13EN($J("",4)_"----"_$J("",6)_"---------"_$J("",18)_"---"_$J("",1)_"-----"_$J("",1)_"----"_$J("",1)_"---"_$J("",1)_"---"_$J("",1)_"--")
...
DXUPD(AUMDATA,TYPE) ; ICD9 DIAGNOSIS FILE UPDATE
 ...
 . I $D(ERR) D RSLT^AUM13EN("ERROR:  Lookup/Add of CODE '"_ICDCOD_"' FAILED.") Q
 ...
 . I $L(ICDRNG)<1 D RSLT^AUM13EN("ERROR:  Incorrect Age Range")
 ...
 ;
 S:ICDMOD["N" ICDMOD="N"
 I ICDMOD'=$J("",24) D RSLT^AUM13EN($J("",4)_ICDCOD_$J("",10-$L(ICDCOD))_$E(ICDDX,1,24)_$J("",27-$L($E(ICDDX,1,24)))_ICDMOD)
 ;
 Q
UPDPX(YEAR) ;ICD9 OPERATION/PROCEDURE FILE DRIVER
 N TYPE,ICDCNT
 F TYPE="REV"  D
 . D RSLT^AUM13EN("ICD 9 OPERATION/PROCEDURE, "_YEAR_" "_$S(TYPE="NEW":TYPE,TYPE="REV":"REVISED",TYPE="INA":"INACTIVATED",1:"")_" CODES:",1)
 . D RSLT^AUM13EN($J("",4)_"CODE"_$J("",6)_"DESCRIPTION"_$J("",16)_"NEW"_$J("",1)_"SHORT"_$J("",1)_"LONG"_$J("",1)_"SEX")
 . D RSLT^AUM13EN($J("",4)_"----"_$J("",6)_"-----------"_$J("",16)_"---"_$J("",1)_"-----"_$J("",1)_"----"_$J("",1)_"---")
 . S ICDCNT=0 F  S ICDCNT=$O(^AUMDATA(ICDCNT)) Q:'ICDCNT  D
...
PXUPD(AUMDATA,TYPE) ;ICD9 OPERATION/PROCEDURE FILE UPDATE
 ...
 ;
 S:ICDMOD["N" ICDMOD="N"
 I ICDMOD'=$J("",16) D RSLT^AUM13EN($J("",4)_ICDCOD_$J("",10-$L(ICDCOD))_$E(ICDPX,1,24)_$J("",27-$L($E(ICDPX,1,24)))_ICDMOD)
 ;
 Q
