AUM91 ;IHS/SD/DMJ,SDR - ICD 9 CODES FOR FY 2009 ; [ 08/18/2003  11:02 AM ]
 ;;10.2;TABLE MAINTENANCE;;MAR 09, 2010
START ;EP
 D CLEANALL^AUMPREX  ;check/removal of control characters; routine provided by Chris Saddler
 ;
SVARS ;;A,C,E,F,L,M,N,O,P,R,S,T,V;Single-character work variables.
 NEW DA,DIC,DIE,DINUM,DLAYGO,DR,@($P($T(SVARS),";",3))
 S U="^"
 D RSLT("Beginning FY 2009 ICD Update.")
...
DIE ;EP
 ...
 Q
E(L) I L="ICD9NEW" Q $P($P($T(@L^AUM91A),";",3),":",1)
 I L="ICD9VNEW" Q $P($P($T(@L^AUM91E),";",3),":",1)
 I L="ICD9ENEW" Q $P($P($T(@L^AUM91B),";",3),":",1)
 I L="ICD9REV" Q $P($P($T(@L^AUM91C),";",3),":",1)
 I L="ICD9DINA" Q $P($P($T(@L^AUM91D),";",3),":",1)
 I L="ICD9PNEW" Q $P($P($T(@L^AUM91D),";",3),":",1)
 I L="ICD9PREV" Q $P($P($T(@L^AUM91B),";",3),":",1)
 I L="ICD9PINA" Q $P($P($T(@L^AUM91E),";",3),":",1)
 I L="ICD9OINA" Q $P($P($T(@L^AUM91D),";",3),":",1)
 I L="ICD0OREV" Q $P($P($T(@L^AUM91C),";",3),":",1)
 I L="ICD9OREV" Q $P($P($T(@L^AUM91C),";",3),":",1)
