AUM93042 ; DSM/GTH - STANDARD TABLE UPDATES (2), 6APR93 MEMO ; [ 04/19/93  4:28 PM ]
...
COMMNEW ;
 ...
 F T=1:1 S L=$T(COMMNEW+T^AUM9304A) Q:'$P(L,";",3)  I $P(L,U,7) D ADDCOMM
 Q
 ;
ADDCOMM ;
 ...
 S P("O")=$$IEN^AUM93041("^AUTTCTY(",S_O) Q:'P("O")
 S P("A")=$$IEN^AUM93041("^AUTTAREA(",A) Q:'P("A")
 S P("V")=$$IEN^AUM93041("^AUTTSU(",A_V) Q:'P("V")
...
COMMMOD ;
 ...
 F T=1:2 S L=$T(COMMMOD+T^AUM9304A) Q:$P(L,";",3)="0"  S L("TO")=$T(COMMMOD+T+1^AUM9304A) I $P(L("TO"),U,8) D
