AUM9305 ; DSM/GTH - STANDARD TABLE UPDATES, 7MAY93 MEMO ; [ 05/11/93  10:16 AM ]
...
QUE ;
 ...
 S ZTRTN="START^AUM9305",ZTIO="",ZTDESC=$P($P($T(+1),";",2)," ",4,99)
 D ^%ZTLOAD,HOME^%ZIS
...
START ;EP - From Taskman
 ...
 K ^TMP($J)
 D START^AUM93051,START^AUM93052
...
INTRO ;
 ...
 ;;specified in the memo dated May 7, 1993.
