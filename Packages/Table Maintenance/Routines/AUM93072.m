AUM93072 ; DSD/GTH - STANDARD TABLE UPDATES (2), 08JUL93 MEMO ; [ 07/08/93  4:32 PM ]
...
COMMNEW ;
 ...
 F T=1:1 S L=$T(COMMNEW+T^AUM9307A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDCOMM
 Q
 ;
ADDCOMM ;
 ...
 S P("O")=$$IEN^AUM93071("^AUTTCTY(",S_O) Q:'P("O")
 S P("A")=$$IEN^AUM93071("^AUTTAREA(",A) Q:'P("A")
 S P("V")=$$IEN^AUM93071("^AUTTSU(",A_V) Q:'P("V")
...
COMMMOD ;
 ...
 F T=1:2 S L=$T(COMMMOD+T^AUM9307A) Q:$P(L,";",3)="END"  S L("TO")=$T(COMMMOD+T+1^AUM9307A) I $P(L("TO"),U,$L(L("TO"),U))="Y" D
...
CLINNEW ;
 ...
 F T=1:1 S L=$T(CLINNEW+T^AUM9307A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDCLIN
 Q
 ;
ADDCLIN ;
