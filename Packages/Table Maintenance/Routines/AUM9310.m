AUM9310 ; DSD/GTH - STANDARD TABLE UPDATES, 22OCT93 BANYAN ; [ 08/26/93  12:15 PM ]
...
QUE ;
 ...
 S ZTRTN="START^AUM9310",ZTIO="",ZTDESC=$P($P($T(+1),";",2)," ",4,99)
 D ^%ZTLOAD,HOME^%ZIS
...
START ;EP - From Taskman
 ...
 K ^TMP($J)
 D START^AUM93101,START^AUM93102
...
INTRO ;
 ...
 ;;specified in the memo dated August 25, 1993.
