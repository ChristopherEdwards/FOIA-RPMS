AUM93102 ; DSD/GTH - STANDARD TABLE UPDATES (2), 22OCT93 BANYAN ; [ 08/26/93  12:15 PM ]
...
COMMNEW ;
 ...
 F T=1:1 S L=$T(COMMNEW+T^AUM9310A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDCOMM
 Q
 ;
ADDCOMM ;
 ...
 S P("O")=$$IEN^AUM93101("^AUTTCTY(",S_O) Q:'P("O")
 S P("A")=$$IEN^AUM93101("^AUTTAREA(",A) Q:'P("A")
 S P("V")=$$IEN^AUM93101("^AUTTSU(",A_V) Q:'P("V")
...
COMMMOD ;
 ...
 F T=1:2 S L=$T(COMMMOD+T^AUM9310A) Q:$P(L,";",3)="END"  S L("TO")=$T(COMMMOD+T+1^AUM9310A) I $P(L("TO"),U,$L(L("TO"),U))="Y" D
...
CLINNEW ;
 ...
 F T=1:1 S L=$T(CLINNEW+T^AUM9310A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDCLIN
 Q
 ;
ADDCLIN ;
