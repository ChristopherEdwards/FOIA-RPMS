AUM94022 ; DSD/GTH - STANDARD TABLE UPDATES (2), 03/14FEB94 BANYANS ; [ 02/04/94  12:13 PM ]
...
COMMNEW ;
 ...
 F T=1:1 S L=$T(COMMNEW+T^AUM9402A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDCOMM
 Q
 ;
ADDCOMM ;
 ...
 S P("O")=$$IEN^AUM94021("^AUTTCTY(",S_O) Q:'P("O")
 S P("A")=$$IEN^AUM94021("^AUTTAREA(",A) Q:'P("A")
 S P("V")=$$IEN^AUM94021("^AUTTSU(",A_V) Q:'P("V")
...
COMMMOD ;
 ...
 F T=1:2 S L=$T(COMMMOD+T^AUM9402A) Q:$P(L,";",3)="END"  S L("TO")=$T(COMMMOD+T+1^AUM9402A) I $P(L("TO"),U,$L(L("TO"),U))="Y" D
