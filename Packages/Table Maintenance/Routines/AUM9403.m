AUM9403 ; DSD/GTH - STANDARD TABLE UPDATES, 31MAR94 BANYAN ; [ 04/08/94  1:06 PM ]
...
QUE ;
 ...
 S ZTRTN="START^AUM9403",ZTIO="",ZTDESC=$P($P($T(+1),";",2)," ",4,99)
 D ^%ZTLOAD,HOME^%ZIS
...
START ;EP - From Taskman
 ...
 K ^TMP($J)
 D START^AUM94031,START^AUM94032,START^AUM94033,START^AUM94034
...
INTRO ;
 ...
 ;;specified in the Banyan message time stamped 31Mar94@09:43:29 MST,
 ;;and other requests from the field. Please consult that memo, and
 ;;the mail message produced by this utility.
 Q
Q2 ;EP - From DIR
