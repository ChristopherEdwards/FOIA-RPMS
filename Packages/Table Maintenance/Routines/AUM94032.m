AUM94032 ; DSD/GTH - STANDARD TABLE UPDATES (2), 31MAR94 BANYAN ; [ 04/07/94  10:20 AM ]
...
START ;EP
 ...
 D COMMNEW,COMMMOD,COMMDEL,TRIBNEW,RESNEW
 Q
...
COMMNEW ;
 ...
 F T=1:1 S L=$T(COMMNEW+T^AUM9403A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDCOMM
 Q
 ;
ADDCOMM ;
 ...
 S P("O")=$$IEN^AUM94031("^AUTTCTY(",S_O) Q:'P("O")
 S P("A")=$$IEN^AUM94031("^AUTTAREA(",A) Q:'P("A")
 S P("V")=$$IEN^AUM94031("^AUTTSU(",A_V) Q:'P("V")
...
COMMMOD ;
 ...
 F T=1:2 S L=$T(COMMMOD+T^AUM9403A) Q:$P(L,";",3)="END"  S L("TO")=$T(COMMMOD+T+1^AUM9403A) I $P(L("TO"),U,$L(L("TO"),U))="Y" D
...
COMMDEL ;
 ...
 F T=1:1 S L=$T(COMMDEL+T^AUM9403A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D
 .S L=$P(L,";;",2),S=$P(L,U),O=$P(L,U,2),C=$P(L,U,3),N=$P(L,U,4),A=$P(L,U,5),V=$P(L,U,6),L=S_" "_O_" "_C_" "_N_" "_A_" "_V
 .S P=$O(^AUTTCOM("C",S_O_C,0))
...
TRIBNEW ;
 S E="New Tribe Codes"
 F T=1:1 S L=$T(TRIBNEW+T^AUM9403A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDTRIB
 Q
 ;
ADDTRIB ;
...
RESNEW ;
 ...
 F T=1:1 S L=$T(RESNEW+T^AUM9403A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDRES
 Q
 ;
ADDRES ;
 ...
 S P("A")=$$IEN^AUM94031("^AUTTAREA(",A) Q:'P("A")
 S P("S")=$$IEN^AUM94031("^DIC(5,",S) Q:'P("S")
