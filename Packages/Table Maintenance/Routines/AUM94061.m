AUM94061 ; DSD/GTH - STANDARD TABLE UPDATES (1), 06JUN94 BANYAN ; [ 06/06/94  12:57 PM ]
...
IEN(X,%,Y) ;EP
 S Y=$O(@(X_"""C"",%,0)"))
 I 'Y S Y=$T(@%^AUM9406M) I Y NEW Z S Z=E D  S:Y<0 Y="" S E=Z
...
AREANEW ;
 S E="New Area Codes"
 F T=1:1 S L=$T(AREANEW+T^AUM9406A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDAREA
 Q
 ;
ADDAREA ;
...
SUNEW ;
 ...
 F T=1:1 S L=$T(SUNEW+T^AUM9406A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDSU
 Q
 ;
ADDSU ;
...
LOCNEW ;
 ...
 F T=1:1 S L=$T(LOCNEW+T^AUM9406A) Q:$P(L,";",3)="END"  I $P(L,U,$L(L,U))="Y" D ADDLOC
 Q
 ;
ADDLOC ;
...
LOCMOD ;
 ...
 F T=1:2 S L=$T(LOCMOD+T^AUM9406A) Q:$P(L,";",3)="END"  S L("TO")=$T(LOCMOD+T+1^AUM9406A) I $P(L("TO"),U,$L(L("TO"),U))="Y" D
...
CNTYMOD ;
 ...
 F T=1:2 S L=$T(CNTYMOD+T^AUM9406A) Q:$P(L,";",3)="END"  S L("TO")=$T(CNTYMOD+T+1^AUM9406A) I $P(L("TO"),U,$L(L("TO"),U))="Y" D
