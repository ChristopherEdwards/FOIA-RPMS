AUM9412 ; DSD/GTH - STANDARD TABLE UPDATES, 05DEC94 BANYAN ; [ 12/06/94  10:40 AM ]
...
QUE ;
 ...
 S ZTRTN="START^AUM9412",ZTIO="",ZTDESC=$P($P($T(+1),";",2)," ",4,99)
 D ^%ZTLOAD,HOME^%ZIS
...
START ;EP - From Taskman
 ...
 K ^TMP($J)
 D START^AUM94121,START^AUM94122
...
INTRO ;
 ...
 ;;specified in the Banyan message time stamped 05Dec94@15:03:32 MST,
