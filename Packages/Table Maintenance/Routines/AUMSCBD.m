...
POST ; EP -- MAIN EP
 ...
 Q
ENTRY(AUMT,AUMA,L,AUMAIEN) ; MAIN UPDATE DRIVER
...
WP ; GENERIC WORD-PROCESSING DRIVER
 ...
 . I $$WPCHK(.AUMWP1,.AUMWP2) S AUML=AUML_$P(F3,"|",1)_U,AUMM=$S(AUMM]"":AUMM,1:"MOD :")
...
DISP ; EP - GENERIC DISPLAY DRIVER
 ...
 . . ; IHS/OIT/NKD - AUM*13.0*2 - TRANSFORM '-' TO '=' FOR DISPLAY
 . . ;D RSLT($TR($P(F2,"|",CNT),"ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890",$$REPEAT^XLFSTR("=",36)))
 . . D RSLT($TR($P(F2,"|",CNT),"ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890-",$$REPEAT^XLFSTR("=",37)))
 . . S HDR=HDR_@F1_U
 . D RSLT(AUMS)
 . S AUMP=1
 . ; IHS/OIT/NKD AUM*13.0*3 - BEGIN NEW CODE
 . I $D(AUMDEBUG),AUMM'["ERR",AUMM'["NEW",AUMM'["ADD" D
 . . Q:AUML']""
 . . F CNT=1:1:$L(AUML,U) I $P(AUML,U,CNT)[".28|" S $P(AUML,U,CNT)=""
 . . Q:AUML=U
 . . D RSLT($J("",4)_AUML)
 . ; IHS/OIT/NKD AUM*13.0*3 - END NEW CODE
 Q
...
WPCHK(AUMWP1,AUMWP2) ; COMPARE WP ARRAYS AND RETURN 1 IF NOT EQUAL
 ...
 E  F CNT=1:1:AUMTO S:$$CLEAN(AUMWP1(CNT))'=$$CLEAN(AUMWP2(CNT)) AUMRES=1
 Q AUMRES
