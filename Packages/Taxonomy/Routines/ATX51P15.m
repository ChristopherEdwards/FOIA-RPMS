ATX51P15 ; IHS/CMI/LAB - PCC Suite v5.1 patch 15 environment check ; 02 Nov 2015  2:41 PM
 ...
 I '$$INSTALLD("ATX*5.1*14") D SORRY(2)
...
POST ;
 ...
 I DA S DIE="^ATXAX(",DR=".07///@" D ^DIE K DIE,DA,DR
 D ^ATXF4
