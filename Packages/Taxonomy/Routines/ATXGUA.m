...
TAX(ATXRET,ATXSTR) ;
 ...
 N ATXGL,ATXGRF,ATXP
 S P="|"
 I $P(ATXSTR,P)="Lab" D LABTAX^ATXGE(.ATXRET,.ATXSTR) Q
 I $P(ATXSTR,P)="LAB" D LTAX^ATXGE(.ATXRET) Q
 K ^ATXTMP($J)
 S ATXRET="^ATXTMP("_$J_")"
 S ATXI=0
 S ATXERR=""
 S ^ATXTMP($J,ATXI)="T00080TAXONOMY"_$C(30)
 I $P(ATXSTR,P)="MED" D MEDBLD^ATXGE
...
GETTAX(ATXRET,ATXSTR) ;-- get tax
 ...
 .. S ^ATXTMP($J,ATXI)=ATXDA_"("_$P(ATXRO,U)_"/"_$P(ATXRO,U,2)_"/"_ATXIEN_"/"_$P(ATXRO,U,3)_")"_$C(30)
 S ^ATXTMP($J,ATXI+1)=$C(31)_$G(ATXERR)
 K ^ATXTMP("TAX",$J)
 Q
 ;
