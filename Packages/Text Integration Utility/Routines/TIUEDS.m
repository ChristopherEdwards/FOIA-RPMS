TIUEDS ; GENERATED FROM 'TIU ENTER/EDIT DS' INPUT TEMPLATE(#2510), FILE 8925;05/21/12
 D DE G BEGIN
...
BEGIN S DNM="TIUEDS",DQ=1
 ...
 M DIEZAR=^DIE(2510,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2510,U="^"
