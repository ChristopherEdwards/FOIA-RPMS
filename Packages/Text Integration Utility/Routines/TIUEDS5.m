...
X9 I +$$PROVIDER^TIUPXAP1(DUZ,DT)'>0 S Y="@9"
 Q
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW="12;9",DV="*P200'R",DU="",DLB="ATTENDING PHYSICIAN",DIFLD=1209
 S DU="VA(200,"
 G RE
X10 S DIC("S")="I '+$$ISTERM^USRLM(+Y),+$$PROVIDER^TIUPXAP1(+Y,DT)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
...
X11 S Y="@10"
 Q
12 S DQ=13 ;@9
13 S DW="12;9",DV="*P200'",DU="",DLB="ATTENDING PHYSICIAN",DIFLD=1209
 S DU="VA(200,"
 G RE
X13 S DIC("S")="I '+$$ISTERM^USRLM(+Y),+$$PROVIDER^TIUPXAP1(+Y,DT)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
14 S DQ=15 ;@10
...
C22F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=307 S DIEZRXR(8925,DIXR)=""
 Q
X22 Q
23 G 0^DIE17
