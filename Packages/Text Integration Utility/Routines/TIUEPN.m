TIUEPN ; GENERATED FROM 'TIU ENTER/EDIT PROGRESS NOTE' INPUT TEMPLATE(#2512), FILE 8925;11/17/04
 D DE G BEGIN
DE S DIE="^TIU(8925,",DIC=DIE,DP=8925,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^TIU(8925,DA,""))=""
 ...
 I $D(^(12)) S %Z=^(12) S %=$P(%Z,U,5) S:%]"" DE(8)=%
 I $D(^(13)) S %Z=^(13) S %=$P(%Z,U,1) S:%]"" DE(11)=%
...
BEGIN S DNM="TIUEPN",DQ=1
 ...
 M DIEZAR=^DIE(2512,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2512,U="^"
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="0;8",DV="DX",DU="",DLB="EPISODE END DATE/TIME",DIFLD=.08
 ...
 G RD:X="@",Z
X4 Q
5 S DW="14;1",DV="P405'",DU="",DLB="PATIENT MOVEMENT RECORD",DIFLD=1401
 S DU="DGPM("
 S X=$P($G(TIU("AD#")),U)
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
