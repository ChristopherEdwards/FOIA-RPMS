TIUFLF1 ; SLC/MAM - Library; File 8925.1 Related:  HASITEMS(FILEDA), ASKFLDS(FILEDA,FIELDS,PFILEDA,NEWSFLG,XFLG), BADNAP(NAP,FILEDA,OBJFLG) ;7/1/97  20:39
 ;;1.0;TEXT INTEGRATION UTILITIES;**2,12,17,64**;Jun 20, 1997
 ;
