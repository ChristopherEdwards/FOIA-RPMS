...
EDIT1 ; Single record edit
 ...
 NEW BTIUVSIT S BTIUVSIT=$$GET1^DIQ(8925,+TIUDA,.03,"I")   ;IHS/ITSC/LJF 02/26/2003 set IHS visit variable
...
PRINTN ; Loop through selected doc's & invoke print code
 ...
 . S TIUDATA=$G(^TMP("TIURIDX",$J,TIUI))
 . ;S TIUDA=+$P(TIUDATA,U,2),TIUTYP=$P(^TIU(8925,TIUDA,0),U)              ;IHS/ITSC/LJF 02/27/2003
 . S TIUDA=+$P(TIUDATA,U,2) Q:'TIUDA  S TIUTYP=$P(^TIU(8925,TIUDA,0),U)   ;IHS/ITSC/LJF 02/27/2003 check for TIUDA<1
 . S ARRAYDA(TIUDA)=""
