TIURD2 ; SLC/JER - Reassignment following signature ;02-Mar-2012 17:19;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**61,100,109,113,112,1006,1009**;Jun 20, 1997;Build 22
 ;IHS/MSC/MGH added retraction data to V note
...
STATUS(DA) ; Set original's status to "RETRACTED"
 ...
 D RETRACT^BTIURB(DA)
 D ALERTDEL^TIUALRT(DA),DELIRT^TIUDIRT(DA),DELSGNR^TIURB1(DA)
 Q
