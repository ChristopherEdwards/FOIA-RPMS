TIURE ; SLC/JER - Error handler actions ;11-Nov-2013 14:47;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**3,21,81,131,113,1009,184,1010,250,1013**;Jun 20, 1997;Build 33
 ;
...
FILERR(ERRDA) ; Resolve filing errors
 ...
 ;
 ;IHS/ITSC/LJF 02/27/2003 added lines to delete garbage entries
 I 'RETRY NEW DELETE D
 . S DELETE=$$READ^TIUU("YO","Would you like to DELETE this record completely","NO","^D DELHELP^BTIUH2")
 . I +DELETE D ALERTDEL^TIUPEVNT(+BUFDA),BUFPURGE^TIUPUTC(+BUFDA)
