TIURECL1 ; SLC/PKR,JER - Expand/collapse LM views ;08-Aug-2007 19:08;MGH
 ...
 ;IHS/MSC/MGH patch 1005 changed the HRCN lookup call for divisions
 ;
...
RESOLVE(DA,TSTART,FIRSTPFX,XIDDATA) ; Get document data for insertion
 ...
 ;NEW HRCN S DFN=$P(TIUD0,U,2) D PID^VADPT S TIULST4="#"_HRCN   ;IHS/ITSC/LJF 02/27/2003 use HRCN, not SSN
