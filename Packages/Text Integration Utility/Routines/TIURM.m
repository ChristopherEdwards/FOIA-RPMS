TIURM ; SLC/JER - MIS Document Review ;31-Dec-2012 15:22;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**74,79,58,100,113,1009,216,224,1011**;Jun 20, 1997;Build 13
 ;12/7/00 split TIURM into TIURM & TIURM1
 ;IHS/ITSC/LJF 02/27/2003 set default note status to ALL for providers
 ;                        made sure end date code goes to end of day
...
BUILD(TIUCLASS,STATUS,EARLY,LATE,NOWFLAG,TIUDI) ; Build List
 ...
 S LATE=LATE+.2400         ;IHS/ITSC/LJF 02/27/2003 go to end of day
...
DFLTSTAT(USER) ; Set default STATUS for current user
 ...
 S TIUY="ALL" Q TIUY        ;IHS/ITSC/LJF 02/27/2003 set default to ALL
