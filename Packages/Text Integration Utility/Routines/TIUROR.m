TIUROR ;SLC/JER - New PATIENT Review screen ; 9/5/01
 ...
 ;IHS/ITSC/LJF 7/11/2003 bypass patient if called by BTIURPT routines
 ;
...
INIT(CLASS,CONTEXT,DFN,TIUOCC) ; -- init variables and list array
 ...
 ;S DFN=$S(+$G(DFN):+$G(DFN),+$G(ORVP):+$G(ORVP),1:+$$PATIENT^TIULA)               ;IHS/ITSC/LJF 7/11/2003
 S DFN=$S(+$G(DFN):+$G(DFN),+$G(ORVP):+$G(ORVP),$G(BTIURPT):0,1:+$$PATIENT^TIULA)  ;IHS/ITSC/LJF 7/11/2003
