TIURTIT1 ; SLC/JER - Review Documents by TITLE ;01-Aug-2011 12:07;MGH
...
ADDELMNT(DA,TIUCNT,APPEND) ; Add each element to the list
 ...
 ;NEW HRCN S DFN=$P(TIUD0,U,2) D PID^VADPT S TIULST4="#"_$G(HRCN)   ;IHS/ITSC/LJF 02/27/2003 use HRCN, not SSN
