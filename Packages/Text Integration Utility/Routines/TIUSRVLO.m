TIUSRVLO ; SLC/JER - Server fns - lists for CPRS ;26-Feb-2010 11:45;MGH
 ;;1.0;TEXT INTEGRATION UTILITIES;**1,15,19,63,108,122,181,1007**;Jun 20, 1997;Build 5
...
CONTEXT(TIUY,CLASS,CONTEXT,DFN,EARLY,LATE,PERSON,OCCLIM,SEQUENCE,SHOWADD,INCUND) ; main
 ...
 I $G(CONTEXT)'>0 Q
 I $G(CLASS)'>0 Q
 ;IHS/MSC/MGH Patch 1007 Commented out since IHS does not use this package
 ;I $G(CONTEXT)=1 D STRT1^AWCMCPR1 ; IHS/MSC/MGH TIU*1.0*181
