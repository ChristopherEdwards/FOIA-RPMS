TIUSRVP ; SLC/JER - RPCs for CREATE & UPDATE ;22-Dec-2011 11:03;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**1,7,19,28,47,89,104,100,115,109,167,1003,1007,1009**;Jun 20, 1997;Build 22
...
MAKE(SUCCESS,DFN,TITLE,VDT,VLOC,VSIT,TIUX,VSTR,SUPPRESS,NOASF) ; New Document
 ...
 I '+$G(VSIT),+$G(VDT),+$G(VLOC) D
 . D EVENT^TIUSRVP1(.TIU,DFN,VDT,VLOC,VSTR)
 ;Add the institution lookup IHS/MGH/1009
