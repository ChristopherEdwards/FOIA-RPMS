ABMTPYMT ; IHS/SD/SDR - Tribal Payment Report ;
 ;;2.6;IHS 3P BILLING SYSTEM;**8,10,11**;NOV 12, 2009;Build 133
 ;
 K ABM,ABMY
 ;
SEL ;
...
INSTYPE ;
 ...
 .;S DIR(0)=DIR(0)_";C:CHAMPUS;F:FRATERNAL ORG;T:3P LIABILITY;G:GUARANTOR;MD:MCR PART D;MH:MEDICARE HMO;A:ALL"  ;abm*2.6*11 VMBP#11
 .S DIR(0)=DIR(0)_";C:CHAMPUS;F:FRATERNAL ORG;T:3P LIABILITY;G:GUARANTOR;MD:MCR PART D;MH:MEDICARE HMO;V:VETERANS ADMINISTRATION;A:ALL"  ;abm*2.6*11 VMBP#11
