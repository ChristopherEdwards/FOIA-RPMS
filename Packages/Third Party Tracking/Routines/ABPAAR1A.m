ABPAAR1A ;QUEUE PVT INS UTILIZATION REPORT; [ 05/24/91  12:44 PM ]
...
HEAD S ABPA("HD",1)=ABPATLE
 S ABPA("HD",2)="Print AREA UTILIZATION REPORT" D ^ABPAHD W !!
 Q
 ;
...
DEVICE S %IS="NP",IOP="Q" W !! D ^%ZIS
 ...
 Q
 ;
ZTLOAD S ZTRTN="R0^ABPAAR1B",ZTIO=""
 S ZTDESC="COMPILE PVT INS UTILIZATION REPORT"
