APC5INIT ; ; 09-JUL-2002
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="1.0" W !,"This version (#1.0) of 'APC5INIT' was created on 09-JUL-2002"
 W !?9,"(at TUSCON ISD, by VA FileMan V.21.0)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="APC5INIS" X ^%ZOSF("TEST") D:$T PAC^APC5INIS($T(IXF),.DIFROM)
...
PKG S X=$P($T(IXF),";",3),DIC="^DIC(9.4,",DIC(0)="",DIC("S")="I $P(^(0),U,2)="""_$P(X,U,2)_"""",X=$P(X,U) D ^DIC S DIFROM(0)=+Y K DIC
 Q
 ;
IXF ;;APC5 - PCC DATA ENTRY V2.0 P5^APC5;3
