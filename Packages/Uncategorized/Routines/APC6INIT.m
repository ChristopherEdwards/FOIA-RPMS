APC6INIT ; ; 04-FEB-2003 
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="2.0" W !,"This version (#2.0) of 'APC6INIT' was created on 04-FEB-2003"
 W !?9,"(at TUSCON ISD, by VA FileMan V.22.0)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="APC6INIS" X ^%ZOSF("TEST") D:$T PAC^APC6INIS($T(IXF),.DIFROM)
...
PKG S X=$P($T(IXF),";",3),DIC="^DIC(9.4,",DIC(0)="",DIC("S")="I $P(^(0),U,2)="""_$P(X,U,2)_"""",X=$P(X,U) D ^DIC S DIFROM(0)=+Y K DIC
 Q
 ;
IXF ;;PCC DATA ENTRY 2.0 PATCH 6^APC6;3
