APC7INIT ; ; 29-OCT-2002
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="2.0" W !,"This version (#2.0) of 'APC7INIT' was created on 29-OCT-2002"
 W !?9,"(at CMI IHS, by VA FileMan V.21.0)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="APC7INIS" X ^%ZOSF("TEST") D:$T PAC^APC7INIS($T(IXF),.DIFROM)
