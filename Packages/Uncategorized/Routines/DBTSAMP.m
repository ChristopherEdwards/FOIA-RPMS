DBTSAMP ;BAO/DMH  pull patient AMPUTATIONS DIAGNOSIS [ 11/16/1999  8:53 PM ]
 ;
 ;
 ;
START ;
 ;
AMP(DBTSGBL,DBTSP)          ;dbtsret is return value, dbtsp input value of patient ien
 ;
 ;
TEST ;
 K ^DBTSTEMP(1)
 ...
 S DBTS("IEN")=0
 I '$D(^DBTSEXDI("B","AMPUTATIONS")) S ^DBTSTEMP(1,1)="-2"_$C(13)_$C(10)   ;may want to chg.
EX ;
 ...
 .S DBTS("N")=$P($G(^AUTNPOV(DBTS("NAR"),0)),"^",1)
 ...
 .S ARRAY=ARRAY+1
 .;S DBTSRET(ARRAY)=DBTS("ID")_U_DBTS("LOC")_U_DBTS("AU")_U_DBTS("PAT")_U_"AMPUTATIONS"_U_DBTS("PRCCODE")_U_DBTS("PRCNAME")_U_DBTS("SIDE")_U_DBTS("VDATE")_U_DBTS("N")_U_DBTS("PNAR")
 .S DBTSRET(ARRAY)=DBTS("ID")_U_DBTS("LOC")_U_DBTS("AU")_U_DBTS("PAT")_U_"AMPUTATIONS"_U_DBTS("PRCCODE")_U_DBTS("PRCNAME")_U_DBTS("SIDE")_U_DBTS("VDATE")_U_DBTS("PNAR")_U_DBTS("VID")
 .S ^DBTSTEMP(1,ARRAY)=DBTSRET(ARRAY)_$C(13)_$C(10)
 .D LOG
 .Q
 I ARRAY=0 S DBTSRET(1)="-2" S ^DBTSTEMP(1,1)="-2"_$C(13)_$C(10)
 I $D(^DBTSPAT(DBTSP,"AMP")) S $P(^DBTSPAT(DBTSP,"AMP"),"^",2)=DT
 Q
AMPCK ;
 S DBTS("CFL")="N"
...
LTRT ;
 S DBTS("SIDE")="U"
 I DBTS("N")["LT " S DBTS("SIDE")="L" Q
 I DBTS("N")["LEFT" S DBTS("SIDE")="L" Q
 I DBTS("N")?1"L ".E S DBTS("SIDE")="L" Q
 I DBTS("N")?.E1" L" S DBTS("SIDE")="L" Q
 I DBTS("N")?.E1" LT" S DBTS("SIDE")="L" Q
 I DBTS("N")["RT " S DBTS("SIDE")="R" Q
 I DBTS("N")["RIGHT" S DBTS("SIDE")="R" Q
 I DBTS("N")?1"R ".E S DBTS("SIDE")="R" Q
 I DBTS("N")?.E1" R" S DBTS("SIDE")="R" Q
 I DBTS("N")?.E1" RT" S DBTS("SIDE")="R" Q
 Q
LL ;
MODCK ;
 S DBTS("OK")="Y"
 ...
 I $P(DBTS("MREC"),"^",2)="" Q     ;dmh added 11-16-99
