DBTSCARD ;BAO/DMH  pull patient CARDIO DIAGNOSIS [ 04/09/1999  4:18 PM ]
 ;
 ;
 ;
START ;
...
EX ;
 ...
 .S ARRAY=ARRAY+1
 .S DBTSRET(ARRAY)=DBTS("ID")_U_DBTS("LOC")_U_DBTS("AU")_U_DBTS("PAT")_U_"CARDIAC"_U_DBTS("ICD")_U_DBTS("ICDNAME")_U_DBTS("VDATE")_U_DBTS("PNAR")
 .D LOG
 .Q
