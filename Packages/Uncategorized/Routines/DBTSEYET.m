DBTSEYET ;BAO/DMH  pull patient EYE RETINOPATHY [ 03/18/1999  12:25 PM ]
 ;
 ;   copy of dbtseye to test on the new change of clinic of 18
 ;
 ;
START ;
 ;
...
MODCK ;
 S DBTS("OK")="Y"
 S DBTS("AU")="A"
 ;     for testing only 3/18/99 remove following quit after done w/test
 Q
 ;
 ;
