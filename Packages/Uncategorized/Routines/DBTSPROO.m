DBTSPROC ;BAO/DMH  pull patient PROCEDURE dates [ 10/08/1999  11:16 AM ]
 ;
 ;
 ;
START ;
 ;
PROC(DBTSRET,DBTSP)          ;dbtsret is return value, dbtsp input value of patient ien
 ;
 ;
TEST ;
 S ARRAY=0
...
EX ;
 ...
 .S ARRAY=ARRAY+1
 .Q:ARRAY>200
 .S DBTSRET(ARRAY)=DBTS("ID")_U_DBTS("LOC")_U_DBTS("AU")_U_DBTS("PAT")_U_"PRC"_U_DBTS("PROC")_U_DBTS("PROCNAME")_U_DBTS("VDATE")_U_DBTS("PNAR")_U_DBTS("VID")
 .D LOG
 .Q
 I ARRAY=0 S DBTSRET(1)="-2"
 S $P(^DBTSPAT(DBTSP,"PRC"),"^",2)=DT
 Q
EKGCK ;
 S DBTS("CFL")="N"
