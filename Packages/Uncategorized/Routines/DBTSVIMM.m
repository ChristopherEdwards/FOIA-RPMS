DBTSVIMM ;BAO/DMH  pull patient IMMUNIZTIONS  [ 11/16/1999  9:18 PM ]
 ;
 ;
 ;
START ;
 ;
IMM(DBTSGBL,DBTSP)          ;dbtsret is return value, dbtsp input value of patient ien
 ;
 ;
TEST ;
 K ^DBTSTEMP(1)
...
MEAS ;
 ...
 .S ARRAY=ARRAY+1
 .S DBTSRET(ARRAY)=DBTS("ID")_U_DBTS("LOC")_U_DBTS("AU")_U_DBTS("PAT")_U_DBTS("TY")_U_DBTS("CODE")_U_DBTS("VDATE")_U_DBTS("SRS")_U_DBTS("LOT")_U_DBTS("PNAR")_U_DBTS("VID")
 .S ^DBTSTEMP(1,ARRAY)=DBTSRET(ARRAY)_$C(13)_$C(10)
 .D LOG
 .Q
 I ARRAY=0 S DBTSRET(1)="-2" S ^DBTSTEMP(1,1)="-2"_$C(13)_$C(10)
 I $D(^DBTSPAT(DBTSP,"IMM")) S $P(^DBTSPAT(DBTSP,"IMM"),"^",2)=DT
 Q
MODCK ;
 S DBTS("OK")="Y"
 S DBTS("AU")="A"
 ...
 ;I $P(^DBTSPAT(DBTSP,"IMM"),"^",2)="" Q   ;11-16-99
