DBTSVIMM ;BAO/DMH  pull patient IMMUNIZTIONS  [ 02/05/1999  2:24 PM ]
 ;
 ;
 ;
START ;
...
TEST ;
 S ARRAY=0
 ;S DBTSP=22     ;uncomment if want to test with call to TEST directly
 S DBTSRET(1)="-1"
 ;
 D ^XBKVAR
...
MEAS ;
 ...
 .Q:DBTS("OK")="N"
 .S ARRAY=ARRAY+1
 .S DBTSRET(ARRAY)=DBTS("ID")_U_DBTS("LOC")_U_DBTS("AU")_U_DBTS("PAT")_U_DBTS("TY")_U_DBTS("CODE")_U_DBTS("VDATE")_U_DBTS("SRS")_U_DBTS("LOT")
 .D LOG
 .Q
