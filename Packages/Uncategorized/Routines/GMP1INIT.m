GMP1INIT ; ; 01-SEP-1995
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="2.0" W !,"This version (#2.0) of 'GMP1INIT' was created on 01-SEP-1995"
 W !?9,"(at DEMONSTRATION, by VA FileMan V.21.0)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="GMP1INIS" X ^%ZOSF("TEST") D:$T PAC^GMP1INIS($T(IXF),.DIFROM)
