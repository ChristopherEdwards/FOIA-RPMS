STD14 ;$O DPT B X-REF [ 06/26/2002  3:46 PM ]
 ;This routine will $o thru B X-ref of name
 ;set counter = for each  print each name - then start again
 ;
START ;
 ;
 ;THIS IS A NEW LINE OF CODE AND NOW EVERYTHING IS MOVED OVER WITH THE I INSERT COMMAND WITH AN O = INSERT COMMAND
 S TOTALCT=0
 S GRANDTOT=0
 D HEADING
