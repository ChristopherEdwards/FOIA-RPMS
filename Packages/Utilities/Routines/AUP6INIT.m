AUP6INIT ; ; 31-AUG-2004
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="93.2" W !,"This version (#93.2) of 'AUP6INIT' was created on 31-AUG-2004"
 W !?9,"(at RPMS/DSD, by VA FileMan V.22.0)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 I DIFROM,$D(^%ZTSK) S X="AUP6INIS" X ^%ZOSF("TEST") D:$T PAC^AUP6INIS($T(IXF),.DIFROM)
