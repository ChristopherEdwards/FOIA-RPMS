AUTP4PRE ; IHS/ASDST/GTH - AUT 98.1 PATCH 4 ENVIRON CHECK ; [ 12/17/1999  3:55 PM ]
 ;;98.1;IHS DICTIONARIES (POINTERS);**4**;MAR 04, 1998;Build 6
 ;
...
SORRY ;
 ...
 ;
AUTP4MSG ;
 ;;AUT*98.1*4, modify YTD PAID field in VENDOR file.
 ...
 ;;  
 ;; --- AUT v 98.1, Patch 4, has been installed into this uci ---
HELLO ;;  
 ;;AUT v 98.1, Patch 4, modifies the field definition of field
