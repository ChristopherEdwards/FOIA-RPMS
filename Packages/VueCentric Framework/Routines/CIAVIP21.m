CIAVIP21 ;MSC/IND/PLS - EHR v1.1p21 Inits;04-Aug-2016 14:58;PLS
...
EC ;EP - Environment check
 Q
PRE ;EP - Preinit
 D DEL^XPAR("SYS","BEHODMA SUBJECT TEXT")  ;Remove the existing entry so that it can be updated.
 Q
POST ;EP - Postinit
...
BEHMSR(X,Y) ;
 ...
 D FILE^DIE(,"FDA")
 Q
VER ;;BEHCCDA.CCDACTRL;1.0.6060.24877;9F7B28782A0A81A9CFB57B17A6CD157F
 ;;
CHM ;;BEHCCDA.CCDACTRL;BEHCCDA.CHM;2016.8.4.113900;3511513F09E945AC2DB807F6AE8478AA
 ;;
