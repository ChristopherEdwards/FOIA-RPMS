...
EN(DATA,PARMS) ; EP - BQI GET COMM ALERTS PATIENTS
 ...
 NEW PAT,QFL,RECORD,TEMP,VAL,VALUE,NAFLG,NAME,PDATA,DXCAT,PATNAM,NVAL,TCAT
...
SOR ; Sort out the alerts
 ...
 ...... S II=II+1,@DATA@(II)=$P(VALUE,"^",1,9)_U_TYPE_U_TCAT_U_$$FMTE^BQIUL1(OCDT)_U_$S(FILE=9000010:RECORD,1:"")_U_PAT_$C(30)
 ;
DONE ;
