...
PARMS(DATA,CDATA,FGLOB,PARMS,MPARMS,APARMS,MAPARMS) ;EP -  Execute Ad Hoc Search
 ...
 S LAB=$G(LAB,""),MED=$G(MED,""),CPT=$G(CPT,"")
 S LABTX=$G(LABTX,""),MEDTX=$G(MEDTX,""),CPTTX=$G(CPTTX,"")
 S LBOP=$G(LBOP,"!"),MDOP=$G(MDOP,"!"),CPOP=$G(CPOP,"!"),PROP=$G(PROP,"!"),EDUOP=$G(EDUOP,"!")
 S EMPL=$G(EMPL,"")
 ...
 .. S @DATA@(IEN)="" M @CDATA=@CRIT
 .. ;S CTYP="" F  S CTYP=$O(@CRIT@(CTYP)) Q:CTYP=""  M @CDATA@(CTYP)=@CRIT@(CTYP)
 ;
