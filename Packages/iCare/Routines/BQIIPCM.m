BQIIPCM ;VNGT/HS/ALA-Get IPC Monthly Data by Provider ; 17 Jun 2011  12:38 PM
 ...
 ;
 ;
RET(DATA,PROV) ;EP -- BQI GET IPC PROV MONTHLY
 NEW UID,II,HDR,C1,C2,C3,C4,NAME,HEAD,HX,PEC,SORT,QFL,PCT,CT,DDATA
 NEW CPER,PPER,TIT,BQMON,DATE,TAB,STAB,TNM,FAC
 ...
 F  S DATE=$O(^BQIFAC(FAC,30,"AB",DATE),-1) Q:DATE=""  D
 . S BQMON=$E(DATE,4,5)
...
RTE(PRV) ;EP
 ...
 . S DDATA=PRVR_U
 . S DATE="",FAC=$$HME^BQIGPUTL()
 . F  S DATE=$O(^BQIFAC(FAC,30,"AB",DATE)) Q:DATE=""  S Z(DATE)="N/A^Not Applicable"
 . ;B
 Q
 ;
