BQIMUDFH ;GDIT/HS/ALA-MU By Division Hover ; 22 Feb 2013  11:12 AM
 ;;2.3;ICARE MANAGEMENT SYSTEM;**3,4**;Apr 18, 2012;Build 66
 ;
PERF(DATA,REPORT,TMFRAME,PERIOD,DIV) ;EP -- BQI MU PERF BY DIV HOVER
 ...
 Q
 ;
CQM(DATA,TMFRAME,PERIOD,DIV) ;EP -- BQI MU CQM BY DIV HOVER
 NEW BQCDAR,BQPDAR,CDATA,CDEN,CEXC,CNUM,CPER,CQN,CRDT,CURDT,CURR,HDR,HEAD,HX,ID,IDN,II,PDATA
...
RCQ ;
 ...
 . I +CDEN'=0,+CNUM'=0 S CURR="Denominator: "_CDEN_" Numerator: "_CNUM
 . I +CDEN=0,+CNUM=0,CEXC'=0 S CURR="Excluded"
 . I +CDEN=0,+CNUM=0,CEXC=0 S CURR="N/A"
 . I CDEN="NDA" S CURR=CDEN
 . S PDEN=$P($G(BQPREV(ID)),U,1),PNUM=$P($G(BQPREV(ID)),U,2),PEXC=$P($G(BQPREV(ID)),U,3)
 . I +PDEN'=0,+PNUM'=0 S PREV="Denominator: "_PDEN_" Numerator: "_PNUM
 . I +PDEN=0,+PNUM=0,PEXC'=0 S PREV="Excluded"
 . I +PDEN=0,+PNUM=0,PEXC=0 S PREV="N/A"
 . I PDEN="NDA" S PREV="NDA"
