...
FILTER(OWNR,PLIEN,FPARMS) ;EP - Include filter description
 ...
 .. ;
 .. ;Save multiple value
 .. I VALUE]"" S FPARMS(PORD,FNAME,$$TRUNC^BQIPDSCM(VALUE))=""
 ;
 Q
 ;
GVAL(PTYP,FILN,IENS,SRC,NM) ; EP - Get value of parameter/filter
 ...
 ;Table
 I PTYP="T" D
 . S VALUE=$P($$GET1^DIQ(FILN,IENS,.03,"E"),";")
...
DEC ;EP - Format Patient status
 ...
 . ;
 . ;Deceased as of
 . S DECDT=$$GETVAL(OWNR,PLIEN,"DECDT")
 . I DECDT]"" S VALUE=VALUE_" as of "_$$FMTE^BQIUL1(DECDT) Q
 . ;
 . ;Deceased from date
