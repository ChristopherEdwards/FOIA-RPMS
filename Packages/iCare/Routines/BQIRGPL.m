...
PAT(DATA,OWNR,PLIEN,CARE,DFN) ;EP - Build record by patient
 ...
 NEW IEN,HDR,VALUE,HEADR,SENS,HDOB,Y,STVW,TEXT,ORD,GMET,GHDR,RGIEN,CRIEN,CTYP
 NEW GIEN,CIEN,ATAGN,ATAGNM,ATAGST,CRN,TYP,DIS
 S VALUE="",RGIEN=""
...
DEF ; Default list of fields
 ...
 . I $P(^BQI(90506.5,CRIEN,10,IEN,0),U,6)'="O" D
 . D CKO
 . S VALUE=VALUE_VAL_"^"
 . S HEADR=HEADR_HDR_"^"
 ...
 I ATAGN'="" D
 . S IEN=0
 . F  S IEN=$O(^BQI(90506.2,ATAGN,6,IEN)) Q:'IEN  D
 .. S STVCD=$P(^BQI(90506.2,ATAGN,6,IEN,0),U,1)
 .. I $P(^BQI(90506.2,ATAGN,6,IEN,0),U,6)'="O" D
 .. D CKO
 .. S VALUE=VALUE_VAL_"^"
 .. S HEADR=HEADR_HDR_"^"
 Q
...
CKO ; Check other
 ...
 . I 'RES S HDR="T00020"_STVCD,VAL=""
 . I DIS="D" S HDR="T00020"_STVCD,VAL=$$FMTE^BQIUL1($P(RES,U,2))
 . I DIS="R" S HDR="T00020"_STVCD,VAL=$P(RES,U,3)
 . I DIS="B" S HDR="T00020"_STVCD,VAL=$$FMTE^BQIUL1($P(RES,U,2))_" "_$P(RES,U,3)
