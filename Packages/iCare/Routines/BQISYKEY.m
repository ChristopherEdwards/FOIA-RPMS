...
RET(DATA,USER,ROLE) ; EP - BQI GET USER ROLES
 ...
 S HDR=HDR_"T00001BQIZCMED^T00001BQIZTXED^T00001BQIZMGR^T00001BTPWZCMGR^T00001BQIZBHUSR^T00001BQIZMUMGR"
 S @DATA@(II)=HDR_$C(30)
 ;
 K BQROLE
 ;
...
ROL(BUSER,BQROLE) ;EP - Assemble User Information Based on input User/Role
 ...
 . F POS=2:1:11 I $P(BQUSER(BUSR),U,POS)="" S $P(BQUSER(BUSR),U,POS)="N"
