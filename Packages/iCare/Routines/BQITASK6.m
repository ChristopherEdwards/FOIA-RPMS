...
UPH ;EP Update Hospital
 ...
 S BQTMN=DA
 Q
 ;I $G(^BQIFAC(FAC,60,0))="" S ^BQIFAC(FAC,60,0)="^90505.64^^"
 ;NEW DA,X,IENS,DIC,DLAYGO
 ;S DA(1)=FAC,DIC="^BQIFAC("_DA(1)_",60,",X=TMFRAME,DIC(0)="LNZ",DLAYGO=90505.64,DIC("P")=DLAYGO
 ;D ^DIC
 ;S DA=+Y I DA=-1 Q
 ;S IENS=$$IENS^DILF(.DA)
 ;S BQIUPD(90505.64,IENS,.02)=BEGDT,BQIUPD(90505.64,IENS,.03)=ENDT
 ;D FILE^DIE("","BQIUPD","ERROR")
 ;S BQTDT=TMFRAME
 ;Q
