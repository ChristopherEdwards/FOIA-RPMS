BQITRGLS ;VNGT/HS/ALA-Treatment Prompt Glossary ; 16 Sep 2008  3:04 PM
 ;;2.1;ICARE MANAGEMENT SYSTEM;;Feb 07, 2011
 ;
GLS(DATA,FAKE) ;EP - BQI GET TX PROMPT GLOSSARY
 NEW UID,II,TRIEN,CAT,TIT,SORT,RMK,REMARK,CT,NXT
 ;
 S UID=$S($G(ZTSK):"Z"_ZTSK,1:$J)
 S DATA=$NA(^TMP("BQITRGLS",UID))
 K @DATA
 ;
 S II=0
 ...
 . S RMK=0,REMARK=""
 . F  S RMK=$O(^BQI(90508.5,TRIEN,3,RMK)) Q:'RMK  D
 .. S REMARK=REMARK_^BQI(90508.5,TRIEN,3,RMK,0)_$C(10)
 ...
 . S RMK=0,REMARK=""
 . F  S RMK=$O(^APCHSURV(TRIEN,1,RMK)) Q:'RMK  D
 .. S REMARK=REMARK_^APCHSURV(TRIEN,1,RMK,0)_$C(10)
 . S REMARK=$$TKO^BQIUL1(REMARK,$C(10))
